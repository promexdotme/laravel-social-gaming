...
if (preg_match('~^/game/(CedarDice|CedarWheel|CedarPlinko|CedarMines|CedarCrash|RoyalSteps)/server$~', $path, $match)) {
...
if (preg_match('~^/game/(CedarDice|CedarWheel|CedarPlinko|CedarMines|CedarCrash|RoyalSteps)$~', $path, $match)) {
