            ...
            function get_($request, $game)
            {
                \DB::transaction(function() use ($request, $game)
                {
                    try
                    {
                        ...
                        {
                            $result_tmp = [];
                            if( $slotSettings->GetGameData('IrishLuckPTBonusStep') == 0 ) 
                            {
                                $WinArr = [
                                    2500, 
                                    2200, 
                                ...
                                shuffle($WinArr);
                                $slotSettings->SetGameData('IrishLuckPTBonusOpt', $WinArr);
                                $curWin = $WinArr[$postData['index']];
                                if( $curWin > 10 ) 
                                {
                                    $slotSettings->SetGameData('IrishLuckPTFreeGames', $slotSettings->GetGameData('IrishLuckPTFreeGames') + ($curWin / 100));
                                }
                                else
                                {
                                    $slotSettings->SetGameData('IrishLuckPTFreeMpl', $slotSettings->GetGameData('IrishLuckPTFreeMpl') + $curWin);
                                }
                                $result_tmp[] = '3:::{"data":{"prizes":[' . $curWin . '],"windowId":"2Hjr3k"},"ID":40251,"umid":474}';
                                $slotSettings->SetGameData('IrishLuckPTBonusStep', 1);
                            }
                            else if( $slotSettings->GetGameData('IrishLuckPTBonusStep') == 1 ) 
                            {
                                $WinArr = $slotSettings->GetGameData('IrishLuckPTBonusOpt');
                                $curWin = $WinArr[$postData['index']];
                                if( $curWin > 10 ) 
                                {
                                    $slotSettings->SetGameData('IrishLuckPTFreeGames', $slotSettings->GetGameData('IrishLuckPTFreeGames') + ($curWin / 100));
                                ...
                                $result_tmp[] = '3:::{"data":{"prizes":[' . $curWin . ',' . $WinArr[0] . ',' . $WinArr[1] . ',' . $WinArr[2] . ',' . $WinArr[3] . ',' . $WinArr[4] . '],"windowId":"2Hjr3k"},"ID":40251,"umid":474}';
                                $slotSettings->SetGameData('IrishLuckPTBonusStep', 2);
                            }
                            $umid = 0;
                        }
                        if( isset($postData['spinType']) ) 
                        {
                            ...
                            if( $postData['spinType'] == 'regular' ) 
                            {
                                ...
                                $bonusMpl = 1;
                                $slotSettings->SetGameData('IrishLuckPTBonusWin', 0);
                                $slotSettings->SetGameData('IrishLuckPTFreeGames', 0);
                                $slotSettings->SetGameData('IrishLuckPTCurrentFreeGame', 0);
                                $slotSettings->SetGameData('IrishLuckPTTotalWin', 0);
                                $slotSettings->SetGameData('IrishLuckPTFreeBalance', 0);
                                $slotSettings->SetGameData('IrishLuckPTFreeStartWin', 0);
                                $slotSettings->SetGameData('IrishLuckPTFreeMpl', $slotSettings->slotFreeMpl);
                            }
                            else if( $postData['spinType'] == 'free' ) 
                            {
                                $umid = '0';
                                $postData['slotEvent'] = 'freespin';
                                $slotSettings->SetGameData('IrishLuckPTCurrentFreeGame', $slotSettings->GetGameData('IrishLuckPTCurrentFreeGame') + 1);
                                $bonusMpl = $slotSettings->GetGameData('IrishLuckPTFreeMpl');
                            }
                            $linesId = [];
                            $linesId[0] = [
                                2, 
                                    ...
                                    for( $j = 0; $j < count($slotSettings->SymbolGame); $j++ ) 
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            if( $s[0] == $csym || in_array($s[0], $wild) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":1,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('IrishLuckPTBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":["none","none"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":2,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('IrishLuckPTBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":3,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('IrishLuckPTBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) && ($s[3] == $csym || in_array($s[3], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":4,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('IrishLuckPTBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) && ($s[3] == $csym || in_array($s[3], $wild)) && ($s[4] == $csym || in_array($s[4], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":5,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('IrishLuckPTBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":[' . ($linesId[$k][4] - 1) . ',"' . $s[4] . '"]}';
                                                }
                                            }
                                        }
                                    }
                            ...
                            if( $postData['slotEvent'] == 'freespin' ) 
                            {
                                $slotSettings->SetGameData('IrishLuckPTBonusWin', $slotSettings->GetGameData('IrishLuckPTBonusWin') + $totalWin);
                                $slotSettings->SetGameData('IrishLuckPTTotalWin', $totalWin);
                            }
                            else
                            {
                                $slotSettings->SetGameData('IrishLuckPTTotalWin', $totalWin);
                            ...
                            if( $scattersCount >= 3 ) 
                            {
                                if( $slotSettings->GetGameData('IrishLuckPTFreeGames') > 0 ) 
                                {
                                    $slotSettings->SetGameData('IrishLuckPTBonusWin', $totalWin);
                                    $slotSettings->SetGameData('IrishLuckPTFreeGames', $slotSettings->GetGameData('IrishLuckPTFreeGames') + $slotSettings->slotFreeCount);
                                }
                                else
                                {
                                    $slotSettings->SetGameData('IrishLuckPTBonusStep', 0);
                                    $slotSettings->SetGameData('IrishLuckPTFreeStartWin', $totalWin);
                                    $slotSettings->SetGameData('IrishLuckPTBonusWin', $totalWin);
                                    $slotSettings->SetGameData('IrishLuckPTFreeGames', $slotSettings->slotFreeCount);
                                }
                            }
                            $balanceInCents = sprintf('%01.2f', $slotSettings->GetBalance()) * 100;
                            ...
                            $response = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{"linesArr":[' . implode(',', $postData['lines']) . '],"slotLines":' . $lines . ',"slotBet":' . $betLine . ',"totalFreeGames":' . $slotSettings->GetGameData('IrishLuckPTFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('IrishLuckPTCurrentFreeGame') . ',"Balance":' . $slotSettings->GetBalance() . ',"afterBalance":' . $slotSettings->GetBalance() . ',"bonusWin":' . $slotSettings->GetGameData('IrishLuckPTBonusWin') . ',"FreeMpl":' . $slotSettings->GetGameData('IrishLuckPTFreeMpl') . ',"freeStartWin":' . $slotSettings->GetGameData('IrishLuckPTFreeStartWin') . ',"totalWin":' . $totalWin . ',"winLines":[' . $winString . '],"bonusInfo":' . $scattersStr . ',"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
                        ...
                        switch( $umid ) 
                        {
                            ...
                            case '40036':
                                ...
                                if( $lastEvent != 'NULL' ) 
                                {
                                    ...
                                    {
                                        $slotSettings->SetGameData($slotSettings->slotId . 'brokenGames', 'irl');
                                    }
                                }
