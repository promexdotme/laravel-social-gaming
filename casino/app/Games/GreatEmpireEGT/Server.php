                    ...
                    try
                    {
                        ...
                        switch( $aid ) 
                        {
                            ...
                            case 'subscribe':
                                ...
                                shuffle($hist);
                                $slotSettings->SetGameData('GreatEmpireEGTCards', $hist);
                                $lastEvent = $slotSettings->GetHistory();
                                $slotSettings->SetGameData('GreatEmpireEGTBonusWin', 0);
                                $slotSettings->SetGameData('GreatEmpireEGTFreeGames', 0);
                                $slotSettings->SetGameData('GreatEmpireEGTCurrentFreeGame', 0);
                                $slotSettings->SetGameData('GreatEmpireEGTTotalWin', 0);
                                $slotSettings->SetGameData('GreatEmpireEGTFreeBalance', 0);
                                ...
                                if( $lastEvent != 'NULL' ) 
                                {
                                    ...
                                    $slotSettings->SetGameData('GreatEmpireEGTCurrentSeq', $lastEvent->serverResponse->curSeq);
                                    $slotSettings->SetGameData('GreatEmpireEGTBankReserved', $lastEvent->serverResponse->BankReserved);
                                    ...
                                    $gtype = 1;
                                    if( $slotSettings->GetGameData('GreatEmpireEGTCurrentFreeGame') < $slotSettings->GetGameData('GreatEmpireEGTFreeGames') && $slotSettings->GetGameData('GreatEmpireEGTFreeGames') > 0 ) 
                                    {
                            ...
                            case 'ping':
                                ...
                                break;
                            case 'choice':
                                if( $slotSettings->GetGameData('GreatEmpireEGTBankReserved') > 0 ) 
                                {
                                    $slotSettings->SetBank('bonus', $slotSettings->GetGameData('GreatEmpireEGTBankReserved'));
                                    $slotSettings->SetGameData('GreatEmpireEGTBankReserved', 0);
                                }
                                else
                                {
                                ...
                                $lines = $slotSettings->GetGameData('GreatEmpireEGTLines');
                                $betline = $slotSettings->GetGameData('GreatEmpireEGTBetLine');
                                $slotSettings->SetGameData('GreatEmpireEGTFreeGames', $slotSettings->slotFreeCount);
                                $slotSettings->SetGameData('GreatEmpireEGTFreeHolds', $holds);
                                $curSeq = [];
                                $curSeqWin = 0;
                                $winLimitBonus = [
                                    500, 
                                ...
                                if( $wlb != 'NULL' ) 
                                {
                                    ...
                                    $slotSettings->SetGameData('GreatEmpireEGTCurrentSeq', $curSeq);
                                }
                                if( $curSeqWin > 0 ) 
                                {
                                    $slotSettings->SetBank('bonus', -1 * $curSeqWin);
                                }
                                $result_tmp[] = '{"complex":{"freespins":' . $slotSettings->slotFreeCount . ',"holdReels":[' . implode(',', $holds) . '],"gameCommand":"choice"},"state":"freespin","winAmount":' . ($slotSettings->GetGameData('GreatEmpireEGTBonusWin') * 100) . ',"gameIdentificationNumber":' . $postData['gameIdentificationNumber'] . ',"gameNumber":1786410455191,"sessionKey":"f5774618bc882d98fdf578c1ade432b4","msg":"success","messageId":"' . $postData['messageId'] . '","qName":"app.services.messages.response.GameEventResponse","command":"bet","eventTimestamp":' . time() . '}';
                                break;
                            case 'bet':
                                $linesId = [];
                                $linesId[0] = [
                                ...
                                if( $postData['slotEvent'] != 'freespin' ) 
                                {
                                    ...
                                    $slotSettings->SetGameData('GreatEmpireEGTCurrentFreeGame', 0);
                                    $slotSettings->SetGameData('GreatEmpireEGTTotalWin', 0);
                                    $slotSettings->SetGameData('GreatEmpireEGTFreeBalance', sprintf('%01.2f', $slotSettings->GetBalance()) * 100);
                                    $slotSettings->SetGameData('GreatEmpireEGTFreeHolds', []);
                                    $slotSettings->SetGameData('GreatEmpireEGTLines', $lines);
                                    $slotSettings->SetGameData('GreatEmpireEGTBetLine', $betline);
                                    $slotSettings->SetGameData('GreatEmpireEGTBankReserved', 0);
                                    $bonusMpl = 1;
                                }
                                else
                                {
                                    $slotSettings->SetGameData('GreatEmpireEGTCurrentFreeGame', $slotSettings->GetGameData('GreatEmpireEGTCurrentFreeGame') + 1);
                                ...
                                for( $i = 0; $i <= 2000; $i++ ) 
                                {
                                    ...
                                    if( $postData['slotEvent'] == 'freespin' ) 
                                    {
                                        $curSeq = (array)$slotSettings->GetGameData('GreatEmpireEGTCurrentSeq');
                                        $curSeq['result'] = (array)$curSeq['result'];
                                        $curSeq['result'][$slotSettings->GetGameData('GreatEmpireEGTCurrentFreeGame') - 1] = (array)$curSeq['result'][$slotSettings->GetGameData('GreatEmpireEGTCurrentFreeGame') - 1];
                                        $curSeq['result'][$slotSettings->GetGameData('GreatEmpireEGTCurrentFreeGame') - 1]['reels'] = (array)$curSeq['result'][$slotSettings->GetGameData('GreatEmpireEGTCurrentFreeGame') - 1]['reels'];
                                        $reels = $curSeq['result'][$slotSettings->GetGameData('GreatEmpireEGTCurrentFreeGame') - 1]['reels'];
                                    }
                                    $holds = $slotSettings->GetGameData('GreatEmpireEGTFreeHolds');
                                    if( $postData['slotEvent'] == 'freespin' ) 
                                    {
                                        for( $r = 0; $r < 5; $r++ ) 
                                        {
                                    ...
                                    else
                                    {
                                        ...
                                        else if( $scattersCount >= 3 && $winType == 'bonus' && $slotSettings->GetBank((isset($postData['slotEvent']) ? $postData['slotEvent'] : '')) < ($betline * 500 + $totalWin) ) 
                                        {
                                            $winType = 'none';
                                        }
                                ...
                                if( $postData['slotEvent'] == 'freespin' ) 
                                {
                                    $slotSettings->SetGameData('GreatEmpireEGTBonusWin', $slotSettings->GetGameData('GreatEmpireEGTBonusWin') + $totalWin);
                                    $slotSettings->SetGameData('GreatEmpireEGTTotalWin', $slotSettings->GetGameData('GreatEmpireEGTTotalWin') + $totalWin);
                                    $balanceInCents = $slotSettings->GetGameData('GreatEmpireEGTFreeBalance');
                                }
                                else
                                {
                                    $slotSettings->SetGameData('GreatEmpireEGTTotalWin', $totalWin);
                                }
                                $fs = 0;
                                if( $scattersCount >= 3 ) 
                                {
                                    if( $slotSettings->GetGameData('GreatEmpireEGTFreeGames') > 0 ) 
                                    {
                                        $slotSettings->SetGameData('GreatEmpireEGTFreeGames', $slotSettings->GetGameData('GreatEmpireEGTFreeGames') + $slotSettings->slotFreeCount);
                                    }
                                    else
                                    {
                                        $slotSettings->SetBank((isset($postData['slotEvent']) ? $postData['slotEvent'] : ''), -1 * ($betline * 500));
                                        $slotSettings->SetGameData('GreatEmpireEGTBankReserved', $betline * 500);
                                        $slotSettings->SetGameData('GreatEmpireEGTFreeHolds', [2]);
                                        $slotSettings->SetGameData('GreatEmpireEGTFreeStartWin', $totalWin);
                                        $slotSettings->SetGameData('GreatEmpireEGTBonusWin', $totalWin);
                                        $slotSettings->SetGameData('GreatEmpireEGTFreeGames', $slotSettings->slotFreeCount);
                                    }
                                    $fs = $slotSettings->GetGameData('GreatEmpireEGTFreeGames');
                                }
                                $winString = implode(',', $lineWins);
                                $jsSpin = '' . json_encode($reels) . '';
                                $jsJack = '' . json_encode($slotSettings->Jackpots) . '';
                                $response = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{"BankReserved":' . $slotSettings->GetGameData('GreatEmpireEGTBankReserved') . ',"curSeq":' . json_encode($curSeq) . ',"FreeHolds":[' . implode(',', $slotSettings->GetGameData('GreatEmpireEGTFreeHolds')) . '],"slotLines":' . $lines . ',"slotBet":' . $betline . ',"totalFreeGames":' . $slotSettings->GetGameData('GreatEmpireEGTFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('GreatEmpireEGTCurrentFreeGame') . ',"Balance":' . $balanceInCents . ',"afterBalance":' . $balanceInCents . ',"bonusWin":' . $slotSettings->GetGameData('GreatEmpireEGTBonusWin') . ',"totalWin":' . $totalWin . ',"winLines":[' . $winString . '],"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
                                $slotSettings->SaveLogReport($response, $allbet, $lines, $reportWin, $postData['slotEvent']);
                                $winstring = '';
                                $slotSettings->SetGameData('GreatEmpireEGTGambleStep', 5);
                                $hist = $slotSettings->GetGameData('GreatEmpireEGTCards');
                                $curReels = '' . rand(0, 6) . ',' . $reels['reel1'][0] . ',' . $reels['reel1'][1] . ',' . $reels['reel1'][2] . ',' . rand(0, 6);
                                $curReels .= (',' . rand(0, 6) . ',' . $reels['reel2'][0] . ',' . $reels['reel2'][1] . ',' . $reels['reel2'][2] . ',' . rand(0, 6));
                                $curReels .= (',' . rand(0, 6) . ',' . $reels['reel3'][0] . ',' . $reels['reel3'][1] . ',' . $reels['reel3'][2] . ',' . rand(0, 6));
                                $curReels .= (',' . rand(0, 6) . ',' . $reels['reel4'][0] . ',' . $reels['reel4'][1] . ',' . $reels['reel4'][2] . ',' . rand(0, 6));
                                ...
                                if( $jackRandom == 1 ) 
                                {
                                    $state = 'jackpot';
                                    $isJack = 'true';
                                    $slotSettings->SetGameData('GreatEmpireEGTJackSteps', [
                                        0, 
                                        0, 
                                        0, 
                                        0
                                ...
                                if( $postData['slotEvent'] == 'freespin' ) 
                                {
                                    $totalWin = $slotSettings->GetGameData('GreatEmpireEGTBonusWin');
                                    $state = 'freespin';
                                ...
                                break;
                            case 'collect':
                                $result_tmp[] = '{"complex":{"gameCommand":"collect"},"state":"idle","winAmount":' . ($slotSettings->GetGameData('GreatEmpireEGTTotalWin') * 100) . ',"gameIdentificationNumber":' . $postData['gameIdentificationNumber'] . ',"gameNumber":"","balance":' . $balanceInCents . ',"sessionKey":"41be9e65e0ff03a65e8c93576bf61130","msg":"success","messageId":"' . $postData['messageId'] . '","qName":"app.services.messages.response.GameEventResponse","command":"bet","eventTimestamp":' . time() . '}';
                                $slotSettings->SetGameData('GreatEmpireEGTTotalWin', 0);
                                break;
                            case 'jackpot':
                                $jackStep = $slotSettings->GetGameData('GreatEmpireEGTJackSteps');
                                $jackWinID = $slotSettings->GetGameData($slotSettings->slotId . 'JackWinID');
                                if( $jackStep[0] >= 3 || $jackStep[1] >= 3 || $jackStep[2] >= 3 || $jackStep[3] >= 3 || !$slotSettings->HasGameData('GreatEmpireEGTJackSteps') ) 
                                {
                                    exit();
                                }
                                $winAmount = 0;
                                ...
                                $slotSettings->SetGameData('GreatEmpireEGTJackSteps', $jackStep);
                                break;
                            case 'gamble':
                                $Balance = $slotSettings->GetBalance();
                                $isGambleWin = rand(1, $slotSettings->GetGambleSettings());
                                $dealerCard = '';
                                $totalWin = $slotSettings->GetGameData('GreatEmpireEGTTotalWin');
                                $gambleWin = 0;
                                $statBet = $totalWin;
                                $slotSettings->SetGameData('GreatEmpireEGTGambleStep', $slotSettings->GetGameData('GreatEmpireEGTGambleStep') - 1);
                                ...
                                else
                                {
                                    ...
                                    $totalWin = 0;
                                    $slotSettings->SetGameData('GreatEmpireEGTGambleStep', 0);
                                    if( $postData['bet']['color'] == '1' ) 
                                    {
                                        $tmpCards = [
                                            '1', 
                                ...
                                $gtype = 1;
                                $gtype0 = 1;
                                if( $slotSettings->GetGameData('GreatEmpireEGTBonusStart') == 1 ) 
                                {
                                    $gtype0 = 2;
                                }
                                $result_tmp[] = '{"complex":{"gambles":' . $slotSettings->GetGameData('GreatEmpireEGTGambleStep') . ',"card":' . $dealerCard . ',"jackpot":false,"gameCommand":"gamble"},"state":"' . $gambleState . '","winAmount":' . ($totalWin * 100) . ',"gameIdentificationNumber":' . $postData['gameIdentificationNumber'] . ',"gameNumber":"","sessionKey":"88e2b82e6537db4a339e4e1b5ce462cd","msg":"success","messageId":"' . $postData['messageId'] . '","qName":"app.services.messages.response.GameEventResponse","command":"bet","eventTimestamp":' . time() . '}';
                                break;
                        }
