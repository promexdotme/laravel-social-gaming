                    ...
                    try
                    {
                        ...
                        switch( $aid ) 
                        {
                            ...
                            case 'Act18':
                                ...
                                $result_tmp[0] = '{"action":"' . $aid . '","gameid":509,"serverResponse":' . json_encode($postData) . ',"nickName":"' . $slotSettings->username . '","currency":"' . $slotSettings->slotCurrency . '","Credit":' . $balanceInCents . ',"Denom":' . ($slotSettings->CurrentDenom * 100) . '}';
                                break;
                        }
