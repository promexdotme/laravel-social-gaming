                    ...
                    try
                    {
                        ...
                        if( $postData['slotEvent'] == 'getSettings' ) 
                        {
                            ...
                            if( $lastEvent != 'NULL' ) 
                            {
                                ...
                                $RingsOfFortuneGTMStacked = $lastEvent->serverResponse->stackedWilds;
                                for( $i = 0; $i < 5; $i++ ) 
                                {
                                    $slotSettings->SetGameData('RingsOfFortuneGTMStacked.' . $i, $RingsOfFortuneGTMStacked[$i]);
                                }
                                for( $r = 1; $r <= 5; $r++ ) 
                                {
                                    if( $slotSettings->GetGameData('RingsOfFortuneGTMStacked.' . ($r - 1)) > 0 ) 
                                    {
                                        $slotSettings->SetGameData('RingsOfFortuneGTMStacked.' . ($r - 1), -1);
                                    }
                                    if( $slotSettings->GetGameData('RingsOfFortuneGTMStacked.' . ($r - 1)) == 0 ) 
                                    {
                                        $slotSettings->SetGameData('RingsOfFortuneGTMStacked.' . ($r - 1), 1);
                        ...
                        else if( $postData['slotEvent'] == 'gamble5GetUserCards' ) 
                        {
                            ...
                            $dealerCard = $slotSettings->GetGameData('RingsOfFortuneGTMDealerCard');
                            $totalWin = $slotSettings->GetGameData('RingsOfFortuneGTMTotalWin');
                            $gambleWin = 0;
                            ...
                            $slotSettings->SetGameData('RingsOfFortuneGTMTotalWin', $totalWin);
                        ...
                        else if( $postData['slotEvent'] == 'gamble5GetDealerCard' ) 
                        {
                            ...
                            $slotSettings->SetGameData('RingsOfFortuneGTMDealerCard', $tmpDc);
                        ...
                        else if( $postData['slotEvent'] == 'bet' || $postData['slotEvent'] == 'freespin' ) 
                        {
                            ...
                            if( $postData['slotEvent'] != 'freespin' ) 
                            {
                                ...
                                $bonusMpl = 1;
                                $slotSettings->SetGameData('RingsOfFortuneGTMBonusWin', 0);
                                $slotSettings->SetGameData('RingsOfFortuneGTMFreeGames', 0);
                                $slotSettings->SetGameData('RingsOfFortuneGTMCurrentFreeGame', 0);
                                $slotSettings->SetGameData('RingsOfFortuneGTMTotalWin', 0);
                                $slotSettings->SetGameData('RingsOfFortuneGTMFreeBalance', 0);
                                $slotSettings->SetGameData('RingsOfFortuneGTMIsJack', 0);
                                for( $i = 0; $i < 5; $i++ ) 
                                {
                                    $slotSettings->SetGameData('RingsOfFortuneGTMStacked.' . $i, -1);
                                }
                            }
                            else
                            {
                                $slotSettings->SetGameData('RingsOfFortuneGTMCurrentFreeGame', $slotSettings->GetGameData('RingsOfFortuneGTMCurrentFreeGame') + 1);
                                $bonusMpl = $slotSettings->slotFreeMpl;
                                if( $slotSettings->GetGameData('RingsOfFortuneGTMStacked.0') > 0 && $slotSettings->GetGameData('RingsOfFortuneGTMStacked.1') > 0 && $slotSettings->GetGameData('RingsOfFortuneGTMStacked.2') > 0 && $slotSettings->GetGameData('RingsOfFortuneGTMStacked.3') > 0 && $slotSettings->GetGameData('RingsOfFortuneGTMStacked.4') > 0 ) 
                                {
                            ...
                            for( $i = 0; $i <= 2000; $i++ ) 
                            {
                                ...
                                if( isset($jackState) && $jackState['isJackPay'] ) 
                                {
                                    ...
                                    $slotSettings->SetGameData('RingsOfFortuneGTMIsJack', 1);
                                    $winType = 'win';
                                ...
                                for( $k = 0; $k < $postData['slotLines']; $k++ ) 
                                {
                                    ...
                                    for( $j = 0; $j < count($slotSettings->SymbolGame); $j++ ) 
                                    {
                                        ...
                                        if( $csym == $scatter || !isset($slotSettings->Paytable[$csym]) || $csym == 'P_1_1' || $csym == 'P_1_2' || $csym == 'P_1_3' ) 
                                        {
                                        }
                                        else
                                        {
                                            ...
                                            if( $s[0] == $csym || in_array($s[0], $wild) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":1,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('RingsOfFortuneGTMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":["none","none"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":2,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('RingsOfFortuneGTMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            $s[0] = $reels['reel1'][$linesId[$k][0] - 1];
                                            $s[1] = $reels['reel2'][$linesId[$k][1] - 1];
                                            ...
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":3,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('RingsOfFortuneGTMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            $s[0] = $reels['reel1'][$linesId[$k][0] - 1];
                                            $s[1] = $reels['reel2'][$linesId[$k][1] - 1];
                                            ...
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) && ($s[3] == $csym || in_array($s[3], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":4,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('RingsOfFortuneGTMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            $s[0] = $reels['reel1'][$linesId[$k][0] - 1];
                                            $s[1] = $reels['reel2'][$linesId[$k][1] - 1];
                                            ...
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) && ($s[3] == $csym || in_array($s[3], $wild)) && ($s[4] == $csym || in_array($s[4], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":5,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('RingsOfFortuneGTMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":[' . ($linesId[$k][4] - 1) . ',"' . $s[4] . '"]}';
                                                }
                                                if( $isSlotJack ) 
                                                {
                                                    $tmpStringWin = '';
                                ...
                                else
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        if( $scattersCount >= 3 && $winType == 'bonus' && $spinWinLimit < ($slotSettings->Paytable[$scatter][3] * $postData['slotBet'] * $postData['slotLines']) ) 
                                        {
                                            $winType = 'none';
                                        }
                            ...
                            if( $postData['slotEvent'] == 'freespin' && $slotSettings->GetGameData('RingsOfFortuneGTMFreeGames') <= $slotSettings->GetGameData('RingsOfFortuneGTMCurrentFreeGame') && $winType != 'bonus' && $slotSettings->GetGameData('RingsOfFortuneGTMTotalWin') + $totalWin > 0 ) 
                            {
                                $slotSettings->SetBalance($slotSettings->GetGameData('RingsOfFortuneGTMTotalWin') + $totalWin);
                            }
                            ...
                            if( $postData['slotEvent'] == 'freespin' ) 
                            {
                                $slotSettings->SetGameData('RingsOfFortuneGTMBonusWin', $slotSettings->GetGameData('RingsOfFortuneGTMBonusWin') + $totalWin);
                                $slotSettings->SetGameData('RingsOfFortuneGTMTotalWin', $slotSettings->GetGameData('RingsOfFortuneGTMTotalWin') + $totalWin);
                                $totalWin = $slotSettings->GetGameData('RingsOfFortuneGTMBonusWin');
                                $Balance = $slotSettings->GetGameData('RingsOfFortuneGTMFreeBalance');
                                for( $r = 1; $r <= 5; $r++ ) 
                                {
                                    for( $p = 0; $p <= 3; $p++ ) 
                                    {
                                        if( $reels['reel' . $r][$p] == 'P_1' ) 
                                        {
                                            $slotSettings->SetGameData('RingsOfFortuneGTMStacked.' . ($r - 1), 0);
                                        }
                                    }
                                }
                            }
                            ...
                            if( $scattersCount >= 3 ) 
                            {
                                if( $slotSettings->GetGameData('RingsOfFortuneGTMFreeGames') > 0 ) 
                                {
                                    $slotSettings->SetGameData('RingsOfFortuneGTMFreeBalance', $Balance);
                                    $slotSettings->SetGameData('RingsOfFortuneGTMBonusWin', $totalWin);
                                    $slotSettings->SetGameData('RingsOfFortuneGTMFreeGames', $slotSettings->GetGameData('RingsOfFortuneGTMFreeGames') + $slotSettings->slotFreeCount);
                                }
                                else
                                {
                                    $slotSettings->SetGameData('RingsOfFortuneGTMFreeBalance', $Balance);
                                    $slotSettings->SetGameData('RingsOfFortuneGTMBonusWin', $totalWin);
                                    $slotSettings->SetGameData('RingsOfFortuneGTMFreeGames', $slotSettings->slotFreeCount);
                                }
                            }
                            $RingsOfFortuneGTMStacked = [];
                            for( $i = 0; $i < 5; $i++ ) 
                            {
                                if( $slotSettings->HasGameData('RingsOfFortuneGTMStacked.' . $i) ) 
                                {
                                    $RingsOfFortuneGTMStacked[] = $slotSettings->GetGameData('RingsOfFortuneGTMStacked.' . $i);
                                }
                            }
                            $jsSpin = '' . json_encode($reels) . '';
                            $jsJack = '' . json_encode($slotSettings->Jackpots) . '';
                            $winString = implode(',', $lineWins);
                            $stackedWilds = '"stackedWilds":[' . implode(',', $RingsOfFortuneGTMStacked) . ']';
                            $response = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{' . $stackedWilds . ',"slotJackpot":' . $slotSettings->slotJackpot[0] . ',"slotLines":' . $postData['slotLines'] . ',"slotBet":' . $postData['slotBet'] . ',"totalFreeGames":' . $slotSettings->GetGameData('RingsOfFortuneGTMFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('RingsOfFortuneGTMCurrentFreeGame') . ',"Balance":' . $Balance . ',"afterBalance":' . $slotSettings->GetBalance() . ',"totalWin":' . $totalWin . ',"winLines":[' . $winString . '],"bonusInfo":' . $scattersStr . ',"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
