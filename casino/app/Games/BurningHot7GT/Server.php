                ...
                \DB::transaction(function() use ($request, $game)
                {
                    try
                    {
                        ...
                        else if( $postData['slotEvent'] == 'gamble5GetUserCards' ) 
                        {
                            ...
                            $dealerCard = $slotSettings->GetGameData('BurningHot7GTDealerCard');
                            $totalWin = $slotSettings->GetGameData('BurningHot7GTTotalWin');
                            $gambleWin = 0;
                            ...
                            $slotSettings->SetGameData('BurningHot7GTTotalWin', $totalWin);
                        ...
                        else if( $postData['slotEvent'] == 'gamble5GetDealerCard' ) 
                        {
                            ...
                            $slotSettings->SetGameData('BurningHot7GTDealerCard', $tmpDc);
                        ...
                        else if( $postData['slotEvent'] == 'bet' || $postData['slotEvent'] == 'freespin' ) 
                        {
                            ...
                            if( $postData['slotEvent'] != 'freespin' ) 
                            {
                                ...
                                $bonusMpl = 1;
                                $slotSettings->SetGameData('BurningHot7GTBonusWin', 0);
                                $slotSettings->SetGameData('BurningHot7GTFreeGames', 0);
                                $slotSettings->SetGameData('BurningHot7GTCurrentFreeGame', 0);
                                $slotSettings->SetGameData('BurningHot7GTTotalWin', 0);
                                $slotSettings->SetGameData('BurningHot7GTFreeBalance', 0);
                            }
                            else
                            {
                                $slotSettings->SetGameData('BurningHot7GTCurrentFreeGame', $slotSettings->GetGameData('BurningHot7GTCurrentFreeGame') + 1);
                                    ...
                                    for( $j = 0; $j < count($slotSettings->SymbolGame); $j++ ) 
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            if( $s[0] == $csym || in_array($s[0], $wild) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":1,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('BurningHot7GTBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":["none","none"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":2,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('BurningHot7GTBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            $s[0] = $reels['reel1'][$linesId[$k][0] - 1];
                                            $s[1] = $reels['reel2'][$linesId[$k][1] - 1];
                                            ...
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":3,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('BurningHot7GTBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                        }
                                    }
                            ...
                            if( $postData['slotEvent'] == 'freespin' && $slotSettings->GetGameData('BurningHot7GTFreeGames') <= $slotSettings->GetGameData('BurningHot7GTCurrentFreeGame') && $winType != 'bonus' && $slotSettings->GetGameData('BurningHot7GTTotalWin') + $totalWin > 0 ) 
                            {
                                $slotSettings->SetBalance($slotSettings->GetGameData('BurningHot7GTTotalWin') + $totalWin);
                            }
                            ...
                            if( $postData['slotEvent'] == 'freespin' ) 
                            {
                                $slotSettings->SetGameData('BurningHot7GTBonusWin', $slotSettings->GetGameData('BurningHot7GTBonusWin') + $totalWin);
                                $slotSettings->SetGameData('BurningHot7GTTotalWin', $slotSettings->GetGameData('BurningHot7GTTotalWin') + $totalWin);
                                $totalWin = $slotSettings->GetGameData('BurningHot7GTBonusWin');
                                $Balance = $slotSettings->GetGameData('BurningHot7GTFreeBalance');
                            }
                            else
                            {
                                $slotSettings->SetGameData('BurningHot7GTTotalWin', $totalWin);
                            ...
                            if( $scattersCount >= 3 ) 
                            {
                                if( $slotSettings->GetGameData('BurningHot7GTFreeGames') > 0 ) 
                                {
                                    $slotSettings->SetGameData('BurningHot7GTFreeBalance', $Balance);
                                    $slotSettings->SetGameData('BurningHot7GTBonusWin', $totalWin);
                                    $freeGamesCount = rand(14, 20);
                                    $slotSettings->SetGameData('BurningHot7GTFreeGames', $slotSettings->GetGameData('BurningHot7GTFreeGames') + $freeGamesCount);
                                }
                                else
                                {
                                    $freeGamesCount = rand(14, 20);
                                    $slotSettings->SetGameData('BurningHot7GTFreeBalance', $Balance);
                                    $slotSettings->SetGameData('BurningHot7GTBonusWin', $totalWin);
                                    $slotSettings->SetGameData('BurningHot7GTFreeGames', $freeGamesCount);
                                }
                            }
                            $X2Mode = 'false';
                            ...
                            $response = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{"slotLines":' . $postData['slotLines'] . ',"slotBet":' . $postData['slotBet'] . ',"selectedFreeCount":' . $freeGamesCount . ',"X2":' . $X2Mode . ',"totalFreeGames":' . $slotSettings->GetGameData('BurningHot7GTFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('BurningHot7GTCurrentFreeGame') . ',"Balance":' . $Balance . ',"afterBalance":' . $slotSettings->GetBalance() . ',"totalWin":' . $totalWin . ',"winLines":[' . $winString . '],"bonusInfo":' . $scattersStr . ',"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
