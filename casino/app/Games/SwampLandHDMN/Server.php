                    ...
                    try
                    {
                        ...
                        switch( $aid ) 
                        {
                            ...
                            case 'Act41':
                                ...
                                break;
                            case 'Act18':
                                if( isset($postData['reqDat']) && $postData['reqDat']['subaction'] == 'gamble' ) 
                                {
                                    $aid = 'Act21';
                                    ...
                                    $jsSet = '{"dealerCard":"' . $dealerCard . '","gambleState":"' . $gambleState . '","totalWin":' . ($totalWin / 2) . ',"afterBalance":' . $afterBalance . ',"Balance":' . $Balance . '}';
                                    ...
                                    for( $i = 0; $i <= 2000; $i++ ) 
                                    {
                                        ...
                                        for( $rl = 1; $rl <= 5; $rl++ ) 
                                        {
                                            for( $rs = 0; $rs <= 2; $rs++ ) 
                                            {
                                                ...
                                                if( $reels['reel' . $rl][$rs] == '7' ) 
                                                {
                                                    $scattersCount1++;
                                                }
                                                if( $reels['reel' . $rl][$rs] == '8' ) 
                                                {
                                                    $scattersCount2++;
                                                }
                                            }
                                        ...
                                        if( $scattersCount1 >= 3 ) 
                                        {
                                            ...
                                            shuffle($scattersWinArr);
                                            $scattersWin = $scattersWinArr[0] * $betline;
                                        }
                                        else if( $scattersCount2 >= 3 ) 
                                        {
                                            $scattersWinArr = [
                                                100, 
                                                150, 
                                        ...
                                        else
                                        {
                                            ...
                                            else if( ($scattersCount >= 3 || $scattersCount1 >= 3 || $scattersCount2 >= 3) && $winType != 'bonus' ) 
                                            {
                                            }
                                ...
                                $result_tmp[0] = '{"action":"' . $aid . '","gameid":69,"serverResponse":' . json_encode($postData) . ',"nickName":"' . $slotSettings->username . '","currency":"' . $slotSettings->slotCurrency . '","Credit":' . $balanceInCents . ',"Denom":' . ($slotSettings->CurrentDenom * 100) . '}';
                                break;
                        }
