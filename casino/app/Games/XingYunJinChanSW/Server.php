            ...
            function get_($request, $game)
            {
                \DB::transaction(function() use ($request, $game)
                {
                    try
                    {
                        ...
                        {
                            $slotSettings->SetGameData('XingYunJinChanSWBonusWin', 0);
                            $slotSettings->SetGameData('XingYunJinChanSWFreeGames', 0);
                            $slotSettings->SetGameData('XingYunJinChanSWCurrentFreeGame', 0);
                            $slotSettings->SetGameData('XingYunJinChanSWTotalWin', 0);
                            $slotSettings->SetGameData('XingYunJinChanSWStartBonusWin', 0);
                            $slotSettings->SetGameData('XingYunJinChanSWFreeBalance', 0);
                        ...
                        else if( $postData['slotEvent'] == 'gamble5GetUserCards' ) 
                        {
                            ...
                            $dealerCard = $slotSettings->GetGameData('XingYunJinChanSWDealerCard');
                            $totalWin = $slotSettings->GetGameData('XingYunJinChanSWTotalWin');
                            $gambleWin = 0;
                            ...
                            $slotSettings->SetGameData('XingYunJinChanSWTotalWin', $totalWin);
                        ...
                        else if( $postData['slotEvent'] == 'gamble5GetDealerCard' ) 
                        {
                            ...
                            $slotSettings->SetGameData('XingYunJinChanSWDealerCard', $tmpDc);
                        ...
                        else if( $postData['slotEvent'] == 'spin' || $postData['slotEvent'] == 'freespin' ) 
                        {
                            ...
                            if( $slotSettings->GetGameData('XingYunJinChanSWCurrentFreeGame') <= $slotSettings->GetGameData('XingYunJinChanSWFreeGames') && $slotSettings->GetGameData('XingYunJinChanSWFreeGames') > 0 ) 
                            {
                                $postData['slotEvent'] = 'freespin';
                            }
                            ...
                            {
                                $slotSettings->SetGameData('XingYunJinChanSWCurrentFreeGame', $slotSettings->GetGameData('XingYunJinChanSWCurrentFreeGame') + 1);
                            ...
                            if( $postData['slotEvent'] == 'freespin' ) 
                            {
                                $slotSettings->SetGameData('XingYunJinChanSWBonusWin', $slotSettings->GetGameData('XingYunJinChanSWBonusWin') + $totalWin);
                                $Balance = $slotSettings->GetGameData('XingYunJinChanSWFreeBalance');
                                $spinState = '"currentScene":"freeSpins","multiplier":1,"freeSpinsCount":' . ($slotSettings->GetGameData('XingYunJinChanSWFreeGames') - $slotSettings->GetGameData('XingYunJinChanSWCurrentFreeGame')) . ',"freeSpinsWin":' . $slotSettings->GetGameData('XingYunJinChanSWBonusWin') . ',"initialFreeSpinWin":' . $slotSettings->GetGameData('XingYunJinChanSWStartBonusWin') . ',"initialFreeSpinsCount":' . $slotSettings->slotFreeCount . ',"totalFreeSpinsCount":' . $slotSettings->GetGameData('XingYunJinChanSWFreeGames');
                                $spinEvent = '';
                                $roundEnded = 'false';
                                $curScene = 'freeSpins';
                                $reelSet = 'freeSpins';
                            ...
                            if( $scattersCount >= 3 ) 
                            {
                                ...
                                $slotSettings->SetGameData('XingYunJinChanSWStartBonusInfo', ',"reels":{"view":[' . $rpTmp . '],"positions":[' . implode(',', $reels['rp']) . ']}');
                                if( $slotSettings->GetGameData('XingYunJinChanSWFreeGames') > 0 ) 
                                {
                                    $slotSettings->SetGameData('XingYunJinChanSWFreeBalance', $Balance);
                                    $slotSettings->SetGameData('XingYunJinChanSWFreeGames', $slotSettings->GetGameData('XingYunJinChanSWFreeGames') + $slotSettings->slotFreeCount);
                                }
                                else
                                {
                                    $slotSettings->SetGameData('XingYunJinChanSWFreeBalance', $Balance);
                                    $slotSettings->SetGameData('XingYunJinChanSWStartBonusWin', $totalWin);
                                    $slotSettings->SetGameData('XingYunJinChanSWBonusWin', 0);
                                    $slotSettings->SetGameData('XingYunJinChanSWFreeGames', $slotSettings->slotFreeCount);
                                }
                            ...
                            if( $slotSettings->GetGameData('XingYunJinChanSWFreeGames') <= $slotSettings->GetGameData('XingYunJinChanSWCurrentFreeGame') && $slotSettings->GetGameData('XingYunJinChanSWCurrentFreeGame') > 0 ) 
                            {
