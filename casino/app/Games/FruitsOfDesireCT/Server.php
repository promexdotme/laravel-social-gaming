            ...
            function get_($request, $game)
            {
                \DB::transaction(function() use ($request, $game)
                {
                    try
                    {
                        ...
                        {
                            case 'create_session':
                                $slotSettings->SetGameData('FruitsOfDesireCTCards', [
                                    19, 
                                    44, 
                                    0, 
                                    37, 
                            ...
                            case 'init_game':
                                ...
                                $slotSettings->SetGameData('FruitsOfDesireCTBonusWin', 0);
                                $slotSettings->SetGameData('FruitsOfDesireCTFreeGames', 0);
                                $slotSettings->SetGameData('FruitsOfDesireCTCurrentFreeGame', 0);
                                $slotSettings->SetGameData('FruitsOfDesireCTCurrentFreeGame0', 0);
                                $slotSettings->SetGameData('FruitsOfDesireCTTotalWin', 0);
                                $slotSettings->SetGameData('FruitsOfDesireCTFreeBalance', 0);
                                ...
                                if( $lastEvent != 'NULL' ) 
                                {
                                    ...
                                    if( $slotSettings->GetGameData('FruitsOfDesireCTCurrentFreeGame') < $slotSettings->GetGameData('FruitsOfDesireCTFreeGames') && $slotSettings->GetGameData('FruitsOfDesireCTFreeGames') > 0 ) 
                                    {
                            ...
                            case 'poll':
                                ...
                                {
                                    $balanceInCents = sprintf('%01.2f', $slotSettings->GetBalance() - $slotSettings->GetGameData('FruitsOfDesireCTTotalWin')) * 100;
                                }
                            ...
                            case 'game_finished':
                                $slotSettings->SetGameData('FruitsOfDesireCTBonusWin', 0);
                                $slotSettings->SetGameData('FruitsOfDesireCTTotalWin', 0);
                                $responseData['game_finished'][0]['freeround_play'] = $slotSettings->GetGameData('FruitsOfDesireCTCurrentFreeGame0');
                            ...
                            case 'subgame_finished':
                                if( $slotSettings->GetGameData('FruitsOfDesireCTCurrentFreeGame0') < $slotSettings->GetGameData('FruitsOfDesireCTFreeGames') && $slotSettings->GetGameData('FruitsOfDesireCTFreeGames') > 0 ) 
                                {
                                    ...
                                    $response = '{"responseEvent":"spin","responseType":"freespin","serverResponse":{"result":' . json_encode($result) . ',"slotDenom":' . $slotSettings->GetGameData($slotSettings->slotId . 'Denom') . ',"slotLines":' . $lines . ',"slotBet":' . $betline . ',"totalFreeGames":' . $slotSettings->GetGameData('FruitsOfDesireCTFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('FruitsOfDesireCTCurrentFreeGame0') . ',"Balance":' . $slotSettings->GetGameData('FruitsOfDesireCTFreeBalance') . ',"afterBalance":' . $slotSettings->GetGameData('FruitsOfDesireCTFreeBalance') . ',"bonusWin":' . $slotSettings->GetGameData('FruitsOfDesireCTBonusWin') . ',"totalWin":' . $reportWin . ',"winLines":[],"Jackpots":[],"reelsSymbols":' . json_encode($slotSettings->GetGameData($slotSettings->slotId . 'Reels')) . '}}';
                                    if( $slotSettings->GetGameData('FruitsOfDesireCTFreeGames') <= $slotSettings->GetGameData('FruitsOfDesireCTCurrentFreeGame0') ) 
                                    {
                                        if( $reportWin > 0 ) 
                                        {
                                    ...
                                    $balanceInCents = $slotSettings->GetGameData('FruitsOfDesireCTFreeBalance');
                                    $responseData['subgame_finished'][0]['account_status']['credit'] = round($balanceInCents);
                                    $responseData['subgame_finished'][0]['freeround_play'] = $slotSettings->GetGameData('FruitsOfDesireCTCurrentFreeGame0');
                                    $responseData['subgame_finished'][1]['freeround_play'] = $slotSettings->GetGameData('FruitsOfDesireCTCurrentFreeGame0');
                            ...
                            case 'play':
                                ...
                                for( $spinLoop = 0; $spinLoop < $spinLoopLimit; $spinLoop++ ) 
                                {
                                    ...
                                    if( $postData['slotEvent'] != 'freespin' ) 
                                    {
                                        ...
                                        $slotSettings->SetGameData('FruitsOfDesireCTCurrentFreeGame0', 0);
                                        $slotSettings->SetGameData('FruitsOfDesireCTTotalWin', 0);
                                        $slotSettings->SetGameData('FruitsOfDesireCTFreeBalance', sprintf('%01.2f', $slotSettings->GetBalance()) * 100);
                                    ...
                                    {
                                        $slotSettings->SetGameData('FruitsOfDesireCTCurrentFreeGame', $slotSettings->GetGameData('FruitsOfDesireCTCurrentFreeGame') + 1);
                                    ...
                                    if( $postData['slotEvent'] == 'freespin' ) 
                                    {
                                        $slotSettings->SetGameData('FruitsOfDesireCTBonusWin', $slotSettings->GetGameData('FruitsOfDesireCTBonusWin') + $totalWin);
                                        $slotSettings->SetGameData('FruitsOfDesireCTTotalWin', $slotSettings->GetGameData('FruitsOfDesireCTTotalWin') + $totalWin);
                                        $balanceInCents = $slotSettings->GetGameData('FruitsOfDesireCTFreeBalance');
                                    }
                                    else
                                    {
                                        $slotSettings->SetGameData('FruitsOfDesireCTTotalWin', $totalWin);
                                    }
                                    $fs = 0;
                                    if( $scattersCount >= 3 ) 
                                    {
                                    ...
                                    $winstring = '';
                                    $slotSettings->SetGameData('FruitsOfDesireCTGambleStep', 5);
                                    $hist = $slotSettings->GetGameData('FruitsOfDesireCTCards');
                                    if( $postData['slotEvent'] == 'freespin' ) 
                                    {
                                        $state = 'freespin';
                                        ...
                                        if( $slotSettings->GetGameData($slotSettings->slotId . 'FreeGames') <= $slotSettings->GetGameData($slotSettings->slotId . 'CurrentFreeGame') && $slotSettings->GetGameData('FruitsOfDesireCTBonusWin') > 0 ) 
                                        {
                                            $responseData['play'][0]['result'][$spinLoop]['is_free'] = true;
                                    ...
                                    $responseData['play'][0]['result'][$spinLoop]['total_win'] = $slotSettings->GetGameData('FruitsOfDesireCTTotalWin') / $denom;
                                ...
                                $response = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{"result":' . json_encode($responseData['play'][0]['result']) . ',"slotDenom":' . $denom . ',"slotLines":' . $lines . ',"slotBet":' . $betline . ',"totalFreeGames":' . $slotSettings->GetGameData('FruitsOfDesireCTFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('FruitsOfDesireCTCurrentFreeGame0') . ',"Balance":' . $slotSettings->GetGameData($slotSettings->slotId . 'FreeBalance') . ',"afterBalance":' . $slotSettings->GetBalance() . ',"bonusWin":' . $slotSettings->GetGameData('FruitsOfDesireCTBonusWin') . ',"totalWin":' . $totalWin . ',"winLines":[],"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
                            ...
                            case 'gamble':
                                ...
                                $dealerCard = '';
                                $totalWin = $slotSettings->GetGameData('FruitsOfDesireCTTotalWin');
                                $gambleWin = 0;
                                $statBet = $totalWin;
                                ...
                                $hist = $slotSettings->GetGameData('FruitsOfDesireCTCards');
                                $slotSettings->SetGameData('FruitsOfDesireCTGambleStep', $slotSettings->GetGameData('FruitsOfDesireCTGambleStep') - 1);
                                if( $slotSettings->MaxWin < ($totalWin * $slotSettings->CurrentDenom) ) 
                                {
                                    $isGambleWin = 0;
                                }
                                ...
                                else
                                {
                                    ...
                                    $totalWin = 0;
                                    $slotSettings->SetGameData('FruitsOfDesireCTGambleStep', 0);
                                    if( $postData['continue_params']['double_key'] != 'red' && $postData['continue_params']['double_key'] != 'black' ) 
                                    {
                                        if( $postData['continue_params']['double_key'] == 'diamond' ) 
                                        {
                                ...
                                $slotSettings->SetGameData('FruitsOfDesireCTCards', $hist);
