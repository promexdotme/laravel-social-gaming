            ...
            function get_($request, $game)
            {
                \DB::transaction(function() use ($request, $game)
                {
                    try
                    {
                        ...
                        {
                            case 'create_session':
                                $slotSettings->SetGameData('BananaPartyCTCards', [
                                    19, 
                                    44, 
                                    0, 
                                    37, 
                            ...
                            case 'init_game':
                                ...
                                $slotSettings->SetGameData('BananaPartyCTBonusWin', 0);
                                $slotSettings->SetGameData('BananaPartyCTFreeGames', 0);
                                $slotSettings->SetGameData('BananaPartyCTCurrentFreeGame', 0);
                                $slotSettings->SetGameData('BananaPartyCTCurrentFreeGame0', 0);
                                $slotSettings->SetGameData('BananaPartyCTTotalWin', 0);
                                $slotSettings->SetGameData('BananaPartyCTFreeBalance', 0);
                                ...
                                if( $lastEvent != 'NULL' ) 
                                {
                                    ...
                                    if( $slotSettings->GetGameData('BananaPartyCTCurrentFreeGame') < $slotSettings->GetGameData('BananaPartyCTFreeGames') && $slotSettings->GetGameData('BananaPartyCTFreeGames') > 0 ) 
                                    {
                            ...
                            case 'poll':
                                ...
                                {
                                    $balanceInCents = sprintf('%01.2f', $slotSettings->GetBalance() - $slotSettings->GetGameData('BananaPartyCTTotalWin')) * 100;
                                }
                            ...
                            case 'game_finished':
                                $slotSettings->SetGameData('BananaPartyCTBonusWin', 0);
                                $slotSettings->SetGameData('BananaPartyCTTotalWin', 0);
                                $responseData['game_finished'][0]['freeround_play'] = $slotSettings->GetGameData('BananaPartyCTCurrentFreeGame0');
                            ...
                            case 'subgame_finished':
                                if( $slotSettings->GetGameData('BananaPartyCTCurrentFreeGame0') < $slotSettings->GetGameData('BananaPartyCTFreeGames') && $slotSettings->GetGameData('BananaPartyCTFreeGames') > 0 ) 
                                {
                                    ...
                                    $response = '{"responseEvent":"spin","responseType":"freespin","serverResponse":{"result":' . json_encode($result) . ',"slotDenom":' . $slotSettings->GetGameData($slotSettings->slotId . 'Denom') . ',"slotLines":' . $lines . ',"slotBet":' . $betline . ',"totalFreeGames":' . $slotSettings->GetGameData('BananaPartyCTFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('BananaPartyCTCurrentFreeGame0') . ',"Balance":' . $slotSettings->GetGameData('BananaPartyCTFreeBalance') . ',"afterBalance":' . $slotSettings->GetGameData('BananaPartyCTFreeBalance') . ',"bonusWin":' . $slotSettings->GetGameData('BananaPartyCTBonusWin') . ',"totalWin":' . $reportWin . ',"winLines":[],"Jackpots":[],"reelsSymbols":' . json_encode($slotSettings->GetGameData($slotSettings->slotId . 'Reels')) . '}}';
                                    if( $slotSettings->GetGameData('BananaPartyCTFreeGames') <= $slotSettings->GetGameData('BananaPartyCTCurrentFreeGame0') ) 
                                    {
                                        if( $reportWin > 0 ) 
                                        {
                                    ...
                                    $balanceInCents = $slotSettings->GetGameData('BananaPartyCTFreeBalance');
                                    $responseData['subgame_finished'][0]['account_status']['credit'] = round($balanceInCents);
                                    $responseData['subgame_finished'][0]['freeround_play'] = $slotSettings->GetGameData('BananaPartyCTCurrentFreeGame0');
                                    $responseData['subgame_finished'][1]['freeround_play'] = $slotSettings->GetGameData('BananaPartyCTCurrentFreeGame0');
                            ...
                            case 'play':
                                ...
                                for( $spinLoop = 0; $spinLoop < $spinLoopLimit; $spinLoop++ ) 
                                {
                                    ...
                                    if( $postData['slotEvent'] != 'freespin' ) 
                                    {
                                        ...
                                        $slotSettings->SetGameData('BananaPartyCTCurrentFreeGame0', 0);
                                        $slotSettings->SetGameData('BananaPartyCTTotalWin', 0);
                                        $slotSettings->SetGameData('BananaPartyCTFreeBalance', sprintf('%01.2f', $slotSettings->GetBalance()) * 100);
                                    ...
                                    {
                                        $slotSettings->SetGameData('BananaPartyCTCurrentFreeGame', $slotSettings->GetGameData('BananaPartyCTCurrentFreeGame') + 1);
                                    ...
                                    if( $postData['slotEvent'] == 'freespin' ) 
                                    {
                                        $slotSettings->SetGameData('BananaPartyCTBonusWin', $slotSettings->GetGameData('BananaPartyCTBonusWin') + $totalWin);
                                        $slotSettings->SetGameData('BananaPartyCTTotalWin', $slotSettings->GetGameData('BananaPartyCTTotalWin') + $totalWin);
                                        $balanceInCents = $slotSettings->GetGameData('BananaPartyCTFreeBalance');
                                    }
                                    else
                                    {
                                        $slotSettings->SetGameData('BananaPartyCTTotalWin', $totalWin);
                                    }
                                    $fs = 0;
                                    if( $scattersCount >= 3 ) 
                                    {
                                    ...
                                    $winstring = '';
                                    $slotSettings->SetGameData('BananaPartyCTGambleStep', 5);
                                    $hist = $slotSettings->GetGameData('BananaPartyCTCards');
                                    if( $postData['slotEvent'] == 'freespin' ) 
                                    {
                                        $state = 'freespin';
                                        ...
                                        if( $slotSettings->GetGameData($slotSettings->slotId . 'FreeGames') <= $slotSettings->GetGameData($slotSettings->slotId . 'CurrentFreeGame') && $slotSettings->GetGameData('BananaPartyCTBonusWin') > 0 ) 
                                        {
                                            $responseData['play'][0]['result'][$spinLoop]['is_free'] = true;
                                    ...
                                    $responseData['play'][0]['result'][$spinLoop]['total_win'] = $slotSettings->GetGameData('BananaPartyCTTotalWin') / $denom;
                                ...
                                $response = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{"result":' . json_encode($responseData['play'][0]['result']) . ',"slotDenom":' . $denom . ',"slotLines":' . $lines . ',"slotBet":' . $betline . ',"totalFreeGames":' . $slotSettings->GetGameData('BananaPartyCTFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('BananaPartyCTCurrentFreeGame0') . ',"Balance":' . $slotSettings->GetGameData($slotSettings->slotId . 'FreeBalance') . ',"afterBalance":' . $slotSettings->GetBalance() . ',"bonusWin":' . $slotSettings->GetGameData('BananaPartyCTBonusWin') . ',"totalWin":' . $totalWin . ',"winLines":[],"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
                            ...
                            case 'gamble':
                                ...
                                $dealerCard = '';
                                $totalWin = $slotSettings->GetGameData('BananaPartyCTTotalWin');
                                $gambleWin = 0;
                                $statBet = $totalWin;
                                ...
                                $hist = $slotSettings->GetGameData('BananaPartyCTCards');
                                $slotSettings->SetGameData('BananaPartyCTGambleStep', $slotSettings->GetGameData('BananaPartyCTGambleStep') - 1);
                                if( $slotSettings->MaxWin < ($totalWin * $slotSettings->CurrentDenom) ) 
                                {
                                    $isGambleWin = 0;
                                }
                                ...
                                else
                                {
                                    ...
                                    $totalWin = 0;
                                    $slotSettings->SetGameData('BananaPartyCTGambleStep', 0);
                                    if( $postData['continue_params']['double_key'] != 'red' && $postData['continue_params']['double_key'] != 'black' ) 
                                    {
                                        if( $postData['continue_params']['double_key'] == 'diamond' ) 
                                        {
                                ...
                                $slotSettings->SetGameData('BananaPartyCTCards', $hist);
