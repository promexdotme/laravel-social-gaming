                ...
                \DB::transaction(function() use ($request, $game)
                {
                    try
                    {
                        ...
                        else if( $postData['slotEvent'] == 'gamble5GetUserCards' ) 
                        {
                            ...
                            $dealerCard = $slotSettings->GetGameData('BookOfRaDXGTDealerCard');
                            $totalWin = $slotSettings->GetGameData('BookOfRaDXGTTotalWin');
                            $gambleWin = 0;
                            ...
                            $slotSettings->SetGameData('BookOfRaDXGTTotalWin', $totalWin);
                        ...
                        else if( $postData['slotEvent'] == 'gamble5GetDealerCard' ) 
                        {
                            ...
                            $slotSettings->SetGameData('BookOfRaDXGTDealerCard', $tmpDc);
                        ...
                        else if( $postData['slotEvent'] == 'bet' || $postData['slotEvent'] == 'freespin' ) 
                        {
                            ...
                            if( $postData['slotEvent'] != 'freespin' ) 
                            {
                                ...
                                $bonusMpl = 1;
                                $slotSettings->SetGameData('BookOfRaDXGTExpSymbol', 'NONE');
                                $slotSettings->SetGameData('BookOfRaDXGTBonusWin', 0);
                                $slotSettings->SetGameData('BookOfRaDXGTFreeGames', 0);
                                $slotSettings->SetGameData('BookOfRaDXGTCurrentFreeGame', 0);
                                $slotSettings->SetGameData('BookOfRaDXGTTotalWin', 0);
                                $slotSettings->SetGameData('BookOfRaDXGTFreeBalance', 0);
                            }
                            else
                            {
                                $slotSettings->SetGameData('BookOfRaDXGTCurrentFreeGame', $slotSettings->GetGameData('BookOfRaDXGTCurrentFreeGame') + 1);
                            ...
                            for( $i = 0; $i <= 2000; $i++ ) 
                            {
                                    ...
                                    for( $j = 0; $j < count($slotSettings->SymbolGame); $j++ ) 
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            if( ($s[0] == $csym || $s[0] == $wild) && ($s[1] == $csym || $s[1] == $wild) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":2,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('BookOfRaDXGTBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || $s[0] == $wild) && ($s[1] == $csym || $s[1] == $wild) && ($s[2] == $csym || $s[2] == $wild) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":3,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('BookOfRaDXGTBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || $s[0] == $wild) && ($s[1] == $csym || $s[1] == $wild) && ($s[2] == $csym || $s[2] == $wild) && ($s[3] == $csym || $s[3] == $wild) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":4,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('BookOfRaDXGTBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || $s[0] == $wild) && ($s[1] == $csym || $s[1] == $wild) && ($s[2] == $csym || $s[2] == $wild) && ($s[3] == $csym || $s[3] == $wild) && ($s[4] == $csym || $s[4] == $wild) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":5,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('BookOfRaDXGTBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":[' . ($linesId[$k][4] - 1) . ',"' . $s[4] . '"]}';
                                                }
                                            }
                                        }
                                    }
                                ...
                                if( $postData['slotEvent'] == 'freespin' ) 
                                {
                                    for( $e = 1; $e <= 5; $e++ ) 
                                    {
                                        if( $reels['reel' . $e][0] == $slotSettings->GetGameData('BookOfRaDXGTExpSymbol') || $reels['reel' . $e][1] == $slotSettings->GetGameData('BookOfRaDXGTExpSymbol') || $reels['reel' . $e][2] == $slotSettings->GetGameData('BookOfRaDXGTExpSymbol') ) 
                                        {
                                            $expReels[$e] = true;
                                            $expPayCnt++;
                                        }
                                    ...
                                    {
                                        $expPay += ($slotSettings->Paytable[$slotSettings->GetGameData('BookOfRaDXGTExpSymbol')][$expPayCnt] * $postData['slotBet']);
                                        $tmpStringWin = '{"lineWin":' . ($slotSettings->Paytable[$slotSettings->GetGameData('BookOfRaDXGTExpSymbol')][$expPayCnt] * $postData['slotBet']) . ',"Count":' . $expPayCnt . ',"Line":' . $ll . ',"Win":' . $expPay . ',"stepWin":' . ($expPay + $totalWin + $slotSettings->GetGameData('BookOfRaDXGTBonusWin'));
                                        for( $e = 1; $e <= 5; $e++ ) 
                                        {
                                            if( $expReels[$e] ) 
                                            {
                                                $tmpStringWin .= (',"winReel' . $e . '":[' . ($linesId[$ll][$e - 1] - 1) . ',"' . $slotSettings->GetGameData('BookOfRaDXGTExpSymbol') . '"]');
                                            }
                                            else
                                            {
                            ...
                            if( $postData['slotEvent'] == 'freespin' && $slotSettings->GetGameData('BookOfRaDXGTFreeGames') <= $slotSettings->GetGameData('BookOfRaDXGTCurrentFreeGame') && $winType != 'bonus' && $slotSettings->GetGameData('BookOfRaDXGTTotalWin') + $totalWin > 0 ) 
                            {
                                $slotSettings->SetBalance($slotSettings->GetGameData('BookOfRaDXGTTotalWin') + $totalWin);
                            }
                            ...
                            if( $postData['slotEvent'] == 'freespin' ) 
                            {
                                $slotSettings->SetGameData('BookOfRaDXGTBonusWin', $slotSettings->GetGameData('BookOfRaDXGTBonusWin') + $totalWin);
                                $slotSettings->SetGameData('BookOfRaDXGTTotalWin', $slotSettings->GetGameData('BookOfRaDXGTTotalWin') + $totalWin);
                                $totalWin = $slotSettings->GetGameData('BookOfRaDXGTBonusWin');
                                $Balance = $slotSettings->GetGameData('BookOfRaDXGTFreeBalance');
                            }
                            else
                            {
                                $slotSettings->SetGameData('BookOfRaDXGTTotalWin', $totalWin);
                            ...
                            if( $scattersCount >= 3 ) 
                            {
                                ...
                                if( $slotSettings->GetGameData('BookOfRaDXGTFreeGames') > 0 ) 
                                {
                                    $slotSettings->SetGameData('BookOfRaDXGTFreeBalance', $Balance);
                                    $slotSettings->SetGameData('BookOfRaDXGTBonusWin', $totalWin);
                                    $slotSettings->SetGameData('BookOfRaDXGTFreeGames', $slotSettings->GetGameData('BookOfRaDXGTFreeGames') + $slotSettings->slotFreeCount);
                                }
                                else
                                {
                                    $slotSettings->SetGameData('BookOfRaDXGTExpSymbol', $slotSettings->SymbolGameExp[0]);
                                    $slotSettings->SetGameData('BookOfRaDXGTFreeBalance', $Balance);
                                    $slotSettings->SetGameData('BookOfRaDXGTBonusWin', $totalWin);
                                    $slotSettings->SetGameData('BookOfRaDXGTFreeGames', $slotSettings->slotFreeCount);
                                }
                            }
                            ...
                            if( $slotSettings->GetGameData('BookOfRaDXGTExpSymbol') != 'NONE' ) 
                            {
                                $expSymbol = '"expSymbol":"' . $slotSettings->GetGameData('BookOfRaDXGTExpSymbol') . '",';
                            }
                            else
                            {
                                $expSymbol = '';
                            }
                            $response = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{"slotLines":' . $postData['slotLines'] . ',"slotBet":' . $postData['slotBet'] . ',' . $expLinesStr . ',"expPay":' . $expPay . ',' . $expReelsStr . ',' . $expSymbol . '"totalFreeGames":' . $slotSettings->GetGameData('BookOfRaDXGTFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('BookOfRaDXGTCurrentFreeGame') . ',"Balance":' . $Balance . ',"afterBalance":' . $slotSettings->GetBalance() . ',"totalWin":' . $totalWin . ',"winLines":[' . $winString . '],"bonusInfo":' . $scattersStr . ',"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
