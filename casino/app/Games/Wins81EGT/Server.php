                    ...
                    try
                    {
                        ...
                        switch( $aid ) 
                        {
                            ...
                            case 'subscribe':
                                ...
                                shuffle($hist);
                                $slotSettings->SetGameData('Wins81EGTCards', $hist);
                                $lastEvent = $slotSettings->GetHistory();
                                $slotSettings->SetGameData('Wins81EGTBonusWin', 0);
                                $slotSettings->SetGameData('Wins81EGTFreeGames', 0);
                                $slotSettings->SetGameData('Wins81EGTCurrentFreeGame', 0);
                                $slotSettings->SetGameData('Wins81EGTTotalWin', 0);
                                $slotSettings->SetGameData('Wins81EGTFreeBalance', 0);
                                if( $lastEvent != 'NULL' ) 
                                {
                                    ...
                                    $gtype = 1;
                                    if( $slotSettings->GetGameData('Wins81EGTCurrentFreeGame') < $slotSettings->GetGameData('Wins81EGTFreeGames') && $slotSettings->GetGameData('Wins81EGTFreeGames') > 0 ) 
                                    {
                                        $gtype = 2;
                                    }
                                }
                            ...
                            case 'bet':
                                    ...
                                    for( $j = 0; $j < count($slotSettings->SymbolGame); $j++ ) 
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            if( $wsym[0] > 0 && $wsym[1] > 0 && $wsym[2] > 0 ) 
                                            {
                                                ...
                                                {
                                                    $cWin = $tWin;
                                                    $tmpStringWin = '{"card":' . $csym . ',"len":3,"winAmount":' . ($cWin * 100) . ',"freespins":0,"cells":[' . implode(',', $cells) . '],"multipliersWinInfo":[{"count":' . $wildsymmpl . ',"winPerCount":' . ($tWin0 * 100) . ',"multiplier":' . $wildsymmpl . '}]}';
                                                }
                                            }
                                            if( $wsym[0] > 0 && $wsym[1] > 0 && $wsym[2] > 0 && $wsym[3] > 0 ) 
                                            {
                                                ...
                                                {
                                                    $cWin = $tWin;
                                                    $tmpStringWin = '{"card":' . $csym . ',"len":3,"winAmount":' . ($cWin * 100) . ',"freespins":0,"cells":[' . implode(',', $cells) . '],"multipliersWinInfo":[{"count":' . $sMpl . ',"winPerCount":' . ($tWin0 * 100) . ',"multiplier":' . $wildsymmpl . '}]}';
                                                }
                                            }
                                            $totalWin += $cWin;
                                            $cWins[$j] = $cWin;
                                ...
                                $response = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{"slotLines":' . $lines . ',"slotBet":' . $betline . ',"totalFreeGames":' . $slotSettings->GetGameData('Wins81EGTFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('Wins81EGTCurrentFreeGame') . ',"Balance":' . $slotSettings->GetBalance() . ',"afterBalance":' . $slotSettings->GetBalance() . ',"bonusWin":' . $slotSettings->GetGameData('Wins81EGTBonusWin') . ',"totalWin":' . $totalWin . ',"winLines":[' . $winString . '],"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
                                $slotSettings->SaveLogReport($response, $allbet, $lines, $reportWin, $postData['slotEvent']);
                                $winstring = '';
                                $slotSettings->SetGameData('Wins81EGTTotalWin', $totalWin);
                                $slotSettings->SetGameData('Wins81EGTGambleStep', 5);
                                $hist = $slotSettings->GetGameData('Wins81EGTCards');
                                $curReels = '' . rand(1, 8) . ',' . $reels['reel1'][0] . ',' . $reels['reel1'][1] . ',' . $reels['reel1'][2] . ',' . rand(1, 8);
                                $curReels .= (',' . rand(1, 8) . ',' . $reels['reel2'][0] . ',' . $reels['reel2'][1] . ',' . $reels['reel2'][2] . ',' . rand(1, 8));
                                $curReels .= (',' . rand(1, 8) . ',' . $reels['reel3'][0] . ',' . $reels['reel3'][1] . ',' . $reels['reel3'][2] . ',' . rand(1, 8));
                                $curReels .= (',' . rand(1, 8) . ',' . $reels['reel4'][0] . ',' . $reels['reel4'][1] . ',' . $reels['reel4'][2] . ',' . rand(1, 8));
                                if( $jackRandom == 1 ) 
                                {
                                    $state = 'jackpot';
                                    $isJack = 'true';
                                    $slotSettings->SetGameData('Wins81EGTJackSteps', [
                                        0, 
                                        0, 
                                        0, 
                                        0
                                ...
                                $result_tmp[] = '{"complex":{"reels":[' . $curReels . '],"combos":[' . $winString . '],"scatters":[],"expand":[],"gambles":0,"freespins":0,"jackpot":' . $isJack . ',"gameCommand":"bet"},"state":"' . $state . '","winAmount":' . ($totalWin * 100) . ',"gameIdentificationNumber":549,"gameNumber":1878401413134,"balance":' . $balanceInCents . ',"sessionKey":"7933737168a180846486f021c39b0078","msg":"success","messageId":"' . $postData['messageId'] . '","qName":"app.services.messages.response.GameEventResponse","command":"bet","eventTimestamp":' . time() . '}';
                                ...
                                break;
                            case 'collect':
                                $result_tmp[] = '{"complex":{"gameCommand":"collect"},"state":"idle","winAmount":' . ($slotSettings->GetGameData('Wins81EGTTotalWin') * 100) . ',"gameIdentificationNumber":' . $postData['gameIdentificationNumber'] . ',"gameNumber":"","balance":' . $balanceInCents . ',"sessionKey":"41be9e65e0ff03a65e8c93576bf61130","msg":"success","messageId":"' . $postData['messageId'] . '","qName":"app.services.messages.response.GameEventResponse","command":"bet","eventTimestamp":' . time() . '}';
                                $slotSettings->SetGameData('Wins81EGTTotalWin', 0);
                                break;
                            case 'jackpot':
                                $jackStep = $slotSettings->GetGameData('Wins81EGTJackSteps');
                                $jackWinID = $slotSettings->GetGameData($slotSettings->slotId . 'JackWinID');
                                if( $jackStep[0] >= 3 || $jackStep[1] >= 3 || $jackStep[2] >= 3 || $jackStep[3] >= 3 || !$slotSettings->HasGameData('Wins81EGTJackSteps') ) 
                                {
                                    exit();
                                }
                                $winAmount = 0;
                                ...
                                $slotSettings->SetGameData('Wins81EGTJackSteps', $jackStep);
                                break;
                            case 'gamble':
                                $Balance = $slotSettings->GetBalance();
                                $isGambleWin = rand(1, $slotSettings->GetGambleSettings());
                                $dealerCard = '';
                                $totalWin = $slotSettings->GetGameData('Wins81EGTTotalWin');
                                $gambleWin = 0;
                                $statBet = $totalWin;
                                $slotSettings->SetGameData('Wins81EGTGambleStep', $slotSettings->GetGameData('Wins81EGTGambleStep') - 1);
                                ...
                                else
                                {
                                    ...
                                    $totalWin = 0;
                                    $slotSettings->SetGameData('Wins81EGTGambleStep', 0);
                                    if( $postData['bet']['color'] == '1' ) 
                                    {
                                        $tmpCards = [
                                            '1', 
