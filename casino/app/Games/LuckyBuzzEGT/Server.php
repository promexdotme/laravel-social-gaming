                    ...
                    try
                    {
                        ...
                        switch( $aid ) 
                        {
                            ...
                            case 'subscribe':
                                ...
                                shuffle($hist);
                                $slotSettings->SetGameData('LuckyBuzzEGTCards', $hist);
                                $lastEvent = $slotSettings->GetHistory();
                                $slotSettings->SetGameData('LuckyBuzzEGTBonusWin', 0);
                                $slotSettings->SetGameData('LuckyBuzzEGTFreeGames', 0);
                                $slotSettings->SetGameData('LuckyBuzzEGTCurrentFreeGame', 0);
                                $slotSettings->SetGameData('LuckyBuzzEGTTotalWin', 0);
                                $slotSettings->SetGameData('LuckyBuzzEGTFreeBalance', 0);
                                if( $lastEvent != 'NULL' ) 
                                {
                                    ...
                                    $slotSettings->SetGameData('LuckyBuzzEGTCurrentSeq', $lastEvent->serverResponse->curSeq);
                                    ...
                                    $gtype = 1;
                                    if( $slotSettings->GetGameData('LuckyBuzzEGTCurrentFreeGame') < $slotSettings->GetGameData('LuckyBuzzEGTFreeGames') && $slotSettings->GetGameData('LuckyBuzzEGTFreeGames') > 0 ) 
                                    {
                                        $gtype = 2;
                                    }
                                }
                            ...
                            case 'bet':
                                ...
                                if( $postData['slotEvent'] != 'freespin' ) 
                                {
                                    ...
                                    $slotSettings->SetGameData('LuckyBuzzEGTCurrentFreeGame', 0);
                                    $slotSettings->SetGameData('LuckyBuzzEGTTotalWin', 0);
                                    $slotSettings->SetGameData('LuckyBuzzEGTFreeBalance', sprintf('%01.2f', $slotSettings->GetBalance()) * 100);
                                    $bonusMpl = 1;
                                }
                                else
                                {
                                    $slotSettings->SetGameData('LuckyBuzzEGTCurrentFreeGame', $slotSettings->GetGameData('LuckyBuzzEGTCurrentFreeGame') + 1);
                                ...
                                if( $winType == 'bonus' ) 
                                {
                                    ...
                                    if( $wlb != 'NULL' ) 
                                    {
                                        ...
                                        $slotSettings->SetGameData('LuckyBuzzEGTCurrentSeq', $curSeq);
                                        if( $curSeqWin > 0 ) 
                                        {
                                ...
                                for( $i = 0; $i <= 2000; $i++ ) 
                                {
                                    ...
                                    {
                                        $curSeq = (array)$slotSettings->GetGameData('LuckyBuzzEGTCurrentSeq');
                                        $curSeq['result'] = (array)$curSeq['result'];
                                        $curSeq['result'][$slotSettings->GetGameData('LuckyBuzzEGTCurrentFreeGame')] = (array)$curSeq['result'][$slotSettings->GetGameData('LuckyBuzzEGTCurrentFreeGame')];
                                        $curSeq['result'][$slotSettings->GetGameData('LuckyBuzzEGTCurrentFreeGame')]['reels'] = (array)$curSeq['result'][$slotSettings->GetGameData('LuckyBuzzEGTCurrentFreeGame')]['reels'];
                                        $reels = $curSeq['result'][$slotSettings->GetGameData('LuckyBuzzEGTCurrentFreeGame')]['reels'];
                                    }
                                    if( $postData['slotEvent'] == 'freespin' ) 
                                    {
                                        $cf = $slotSettings->GetGameData('LuckyBuzzEGTCurrentFreeGame');
                                        if( $cf == 1 ) 
                                        {
                                            $holdReels = '1,2';
                                            $reels['reel2'][0] = '10';
                                ...
                                if( $postData['slotEvent'] == 'freespin' ) 
                                {
                                    $slotSettings->SetGameData('LuckyBuzzEGTBonusWin', $slotSettings->GetGameData('LuckyBuzzEGTBonusWin') + $totalWin);
                                    $slotSettings->SetGameData('LuckyBuzzEGTTotalWin', $slotSettings->GetGameData('LuckyBuzzEGTTotalWin') + $totalWin);
                                    $balanceInCents = $slotSettings->GetGameData('LuckyBuzzEGTFreeBalance');
                                }
                                else
                                {
                                    $slotSettings->SetGameData('LuckyBuzzEGTTotalWin', $totalWin);
                                }
                                $fs = 0;
                                if( $scattersCount >= 3 ) 
                                {
                                    if( $slotSettings->GetGameData('LuckyBuzzEGTFreeGames') > 0 ) 
                                    {
                                        $slotSettings->SetGameData('LuckyBuzzEGTBonusWin', $totalWin);
                                        $slotSettings->SetGameData('LuckyBuzzEGTFreeGames', $slotSettings->GetGameData('LuckyBuzzEGTFreeGames') + $slotSettings->slotFreeCount);
                                    }
                                    else
                                    {
                                        $slotSettings->SetGameData('LuckyBuzzEGTFreeStartWin', $totalWin);
                                        $slotSettings->SetGameData('LuckyBuzzEGTBonusWin', $totalWin);
                                        $slotSettings->SetGameData('LuckyBuzzEGTFreeGames', $slotSettings->slotFreeCount);
                                    }
                                    $fs = $slotSettings->GetGameData('LuckyBuzzEGTFreeGames');
                                }
                                $curReels = '' . rand(0, 6) . ',' . $reels['reel1'][0] . ',' . $reels['reel1'][1] . ',' . $reels['reel1'][2] . ',' . rand(0, 6);
                                $curReels .= (',' . rand(0, 6) . ',' . $reels['reel2'][0] . ',' . $reels['reel2'][1] . ',' . $reels['reel2'][2] . ',' . rand(0, 6));
                                $curReels .= (',' . rand(0, 6) . ',' . $reels['reel3'][0] . ',' . $reels['reel3'][1] . ',' . $reels['reel3'][2] . ',' . rand(0, 6));
                                ...
                                $response = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{"curSeq":' . json_encode($curSeq) . ',"slotLines":' . $lines . '' . $slotSettings->GetGameData($slotSettings->slotId . 'FirstSpin') . ',"slotBet":' . $betline . ',"totalFreeGames":' . $slotSettings->GetGameData('LuckyBuzzEGTFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('LuckyBuzzEGTCurrentFreeGame') . ',"Balance":' . $balanceInCents . ',"afterBalance":' . $balanceInCents . ',"bonusWin":' . $slotSettings->GetGameData('LuckyBuzzEGTBonusWin') . ',"totalWin":' . $totalWin . ',"winLines":[' . $winString . '],"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
                                $slotSettings->SaveLogReport($response, $allbet, $lines, $reportWin, $postData['slotEvent']);
                                $winstring = '';
                                $slotSettings->SetGameData('LuckyBuzzEGTGambleStep', 5);
                                $hist = $slotSettings->GetGameData('LuckyBuzzEGTCards');
                                if( $jackRandom == 1 ) 
                                {
                                    $state = 'jackpot';
                                    $isJack = 'true';
                                    $slotSettings->SetGameData('LuckyBuzzEGTJackSteps', [
                                        0, 
                                        0, 
                                        0, 
                                        0
                                ...
                                if( $postData['slotEvent'] == 'freespin' ) 
                                {
                                    $totalWin = $slotSettings->GetGameData('LuckyBuzzEGTBonusWin');
                                    $state = 'freespin';
                                ...
                                break;
                            case 'collect':
                                $result_tmp[] = '{"complex":{"gameCommand":"collect"},"state":"idle","winAmount":' . ($slotSettings->GetGameData('LuckyBuzzEGTTotalWin') * 100) . ',"gameIdentificationNumber":' . $postData['gameIdentificationNumber'] . ',"gameNumber":"","balance":' . $balanceInCents . ',"sessionKey":"41be9e65e0ff03a65e8c93576bf61130","msg":"success","messageId":"' . $postData['messageId'] . '","qName":"app.services.messages.response.GameEventResponse","command":"bet","eventTimestamp":' . time() . '}';
                                $slotSettings->SetGameData('LuckyBuzzEGTTotalWin', 0);
                                break;
                            case 'jackpot':
                                $jackStep = $slotSettings->GetGameData('LuckyBuzzEGTJackSteps');
                                $jackWinID = $slotSettings->GetGameData($slotSettings->slotId . 'JackWinID');
                                if( $jackStep[0] >= 3 || $jackStep[1] >= 3 || $jackStep[2] >= 3 || $jackStep[3] >= 3 || !$slotSettings->HasGameData('LuckyBuzzEGTJackSteps') ) 
                                {
                                    exit();
                                }
                                $winAmount = 0;
                                ...
                                $slotSettings->SetGameData('LuckyBuzzEGTJackSteps', $jackStep);
                                break;
                            case 'gamble':
                                $Balance = $slotSettings->GetBalance();
                                $isGambleWin = rand(1, $slotSettings->GetGambleSettings());
                                $dealerCard = '';
                                $totalWin = $slotSettings->GetGameData('LuckyBuzzEGTTotalWin');
                                $gambleWin = 0;
                                $statBet = $totalWin;
                                $slotSettings->SetGameData('LuckyBuzzEGTGambleStep', $slotSettings->GetGameData('LuckyBuzzEGTGambleStep') - 1);
                                ...
                                else
                                {
                                    ...
                                    $totalWin = 0;
                                    $slotSettings->SetGameData('LuckyBuzzEGTGambleStep', 0);
                                    if( $postData['bet']['color'] == '1' ) 
                                    {
                                        $tmpCards = [
                                            '1', 
                                ...
                                $gtype = 1;
                                $gtype0 = 1;
                                if( $slotSettings->GetGameData('LuckyBuzzEGTBonusStart') == 1 ) 
                                {
                                    $gtype0 = 2;
                                }
                                $result_tmp[] = '{"complex":{"gambles":' . $slotSettings->GetGameData('LuckyBuzzEGTGambleStep') . ',"card":' . $dealerCard . ',"jackpot":false,"gameCommand":"gamble"},"state":"' . $gambleState . '","winAmount":' . ($totalWin * 100) . ',"gameIdentificationNumber":' . $postData['gameIdentificationNumber'] . ',"gameNumber":"","sessionKey":"88e2b82e6537db4a339e4e1b5ce462cd","msg":"success","messageId":"' . $postData['messageId'] . '","qName":"app.services.messages.response.GameEventResponse","command":"bet","eventTimestamp":' . time() . '}';
                                break;
                        }
