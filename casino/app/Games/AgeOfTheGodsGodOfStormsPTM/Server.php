                    ...
                    try
                    {
                        ...
                        if( isset($postData['spinType']) ) 
                        {
                            ...
                            if( $postData['spinType'] == 'regular' ) 
                            {
                                ...
                                $bonusMpl = 1;
                                $slotSettings->SetGameData('AgeOfTheGodsGodOfStormsPTMBonusWin', 0);
                                $slotSettings->SetGameData('AgeOfTheGodsGodOfStormsPTMFreeGames', 0);
                                $slotSettings->SetGameData('AgeOfTheGodsGodOfStormsPTMCurrentFreeGame', 0);
                                $slotSettings->SetGameData('AgeOfTheGodsGodOfStormsPTMTotalWin', 0);
                                $slotSettings->SetGameData('AgeOfTheGodsGodOfStormsPTMFreeBalance', 0);
                                $slotSettings->SetGameData('AgeOfTheGodsGodOfStormsPTMFreeStartWin', 0);
                                $slotSettings->SetGameData('AgeOfTheGodsGodOfStormsPTMFreeMpl', $slotSettings->slotFreeMpl);
                                $slotSettings->SetGameData('AgeOfTheGodsGodOfStormsPTMIncreaseMpl', 0);
                            }
                            else if( $postData['spinType'] == 're' ) 
                            {
                                $umid = '0';
                                $postData['slotEvent'] = 'freespin';
                                $slotSettings->SetGameData('AgeOfTheGodsGodOfStormsPTMCurrentFreeGame', $slotSettings->GetGameData('AgeOfTheGodsGodOfStormsPTMCurrentFreeGame') + 1);
                                $slotSettings->SetGameData('AgeOfTheGodsGodOfStormsPTMIncreaseMpl', $slotSettings->GetGameData('AgeOfTheGodsGodOfStormsPTMIncreaseMpl') + 1);
                                $mplB = [
                                    1, 
                                    1, 
                                    2, 
                                ...
                                $bonusMpl = $mplB[$slotSettings->GetGameData('AgeOfTheGodsGodOfStormsPTMIncreaseMpl')];
                            }
                            $linesId = [];
                            $linesId[0] = [
                                2, 
                            ...
                            for( $i = 0; $i <= 2000; $i++ ) 
                            {
                                ...
                                if( $postData['slotEvent'] == 'freespin' ) 
                                {
                                    ...
                                    $wildReels_ = $slotSettings->GetGameData('AgeOfTheGodsGodOfStormsPTMwildReels');
                                    for( $j = 0; $j < count($wildReels_); $j++ ) 
                                    {
                                        $wildReels_[$j]--;
                                        if( $wildReels_[$j] > 0 ) 
                                        {
                                            $reels['reel' . $wildReels_[$j]][0] = '10';
                                            $reels['reel' . $wildReels_[$j]][1] = '10';
                                            $reels['reel' . $wildReels_[$j]][2] = '10';
                                        }
                                    }
                                }
                                for( $r = 1; $r <= 5; $r++ ) 
                                    ...
                                    for( $j = 0; $j < count($slotSettings->SymbolGame); $j++ ) 
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            if( $s[0] == $csym || in_array($s[0], $wild) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":1,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('AgeOfTheGodsGodOfStormsPTMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":["none","none"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":2,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('AgeOfTheGodsGodOfStormsPTMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":3,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('AgeOfTheGodsGodOfStormsPTMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) && ($s[3] == $csym || in_array($s[3], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":4,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('AgeOfTheGodsGodOfStormsPTMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) && ($s[3] == $csym || in_array($s[3], $wild)) && ($s[4] == $csym || in_array($s[4], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":5,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('AgeOfTheGodsGodOfStormsPTMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":[' . ($linesId[$k][4] - 1) . ',"' . $s[4] . '"]}';
                                                }
                                            }
                                        }
                                    }
                                ...
                                for( $r = 1; $r <= 5; $r++ ) 
                                {
                                    if( $reelsTmp['reel' . $r][0] == '13' && $reelsTmp['reel' . $r][1] == '14' && $reelsTmp['reel' . $r][2] == '15' ) 
                                    {
                                        $isBonusStart = true;
                                        $wildReels[] = $r;
                                        $wildRow = $r;
                                ...
                                else
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        if( $isBonusStart && ($winType != 'bonus' || $postData['slotEvent'] == 'freespin') ) 
                                        {
                                        }
                            ...
                            if( $postData['slotEvent'] == 'freespin' ) 
                            {
                                $slotSettings->SetGameData('AgeOfTheGodsGodOfStormsPTMBonusWin', $slotSettings->GetGameData('AgeOfTheGodsGodOfStormsPTMBonusWin') + $totalWin);
                                $slotSettings->SetGameData('AgeOfTheGodsGodOfStormsPTMTotalWin', $totalWin);
                            }
                            else
                            {
                                $slotSettings->SetGameData('AgeOfTheGodsGodOfStormsPTMTotalWin', $totalWin);
                            }
                            $slotSettings->SetGameData('AgeOfTheGodsGodOfStormsPTMBonusStart', false);
                            if( $isBonusStart ) 
                            {
                                $slotSettings->SetGameData('AgeOfTheGodsGodOfStormsPTMBonusStart', true);
                                $slotSettings->SetGameData('AgeOfTheGodsGodOfStormsPTMBonusStep', 0);
                                $slotSettings->SetGameData('AgeOfTheGodsGodOfStormsPTMwildReels', $wildReels);
                                $slotSettings->SetGameData('AgeOfTheGodsGodOfStormsPTMIncreaseMpl', 0);
                                $slotSettings->SetGameData('AgeOfTheGodsGodOfStormsPTMFreeStartWin', $totalWin);
                                $slotSettings->SetGameData('AgeOfTheGodsGodOfStormsPTMBonusWin', 0);
                                $slotSettings->SetGameData('AgeOfTheGodsGodOfStormsPTMFreeGames', $wildRow);
                            }
                            $balanceInCents = sprintf('%01.2f', $slotSettings->GetBalance()) * 100;
                            $spinState = 'REGULAR';
                            if( $postData['spinType'] == 're' ) 
                            {
                                $spinState = 'RE';
                            }
                            $isBonus = 'false';
                            if( $slotSettings->GetGameData('AgeOfTheGodsGodOfStormsPTMBonusStart') ) 
                            {
                                $isBonus = 'true';
                            }
                            if( $postData['slotEvent'] == 'freespin' ) 
                            {
                                $slotSettings->SetGameData('AgeOfTheGodsGodOfStormsPTMwildReels', $wildReels_);
                            }
                            $jsSpin = '' . json_encode($reels) . '';
                            $jsJack = '' . json_encode($slotSettings->Jackpots) . '';
                            $winString = implode(',', $lineWins);
                            $response = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{"IncreaseMpl":' . $slotSettings->GetGameData('AgeOfTheGodsGodOfStormsPTMIncreaseMpl') . ',"linesArr":[' . implode(',', $postData['lines']) . '],"slotLines":' . $lines . ',"slotBet":' . $betLine . ',"totalFreeGames":' . $slotSettings->GetGameData('AgeOfTheGodsGodOfStormsPTMFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('AgeOfTheGodsGodOfStormsPTMCurrentFreeGame') . ',"Balance":' . $slotSettings->GetBalance() . ',"afterBalance":' . $slotSettings->GetBalance() . ',"bonusWin":' . $slotSettings->GetGameData('AgeOfTheGodsGodOfStormsPTMBonusWin') . ',"FreeMpl":' . $slotSettings->GetGameData('AgeOfTheGodsGodOfStormsPTMFreeMpl') . ',"freeStartWin":' . $slotSettings->GetGameData('AgeOfTheGodsGodOfStormsPTMFreeStartWin') . ',"totalWin":' . $totalWin . ',"winLines":[' . $winString . '],"bonusInfo":' . $scattersStr . ',"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
                            $slotSettings->SaveLogReport($response, $betLine, $lines, $reportWin, $postData['slotEvent']);
                            $result_tmp[] = '3:::{"data":{"balance":' . $balanceInCents . ',"results":[' . implode(',', $reels['rp']) . '],"spinType":"' . $spinState . '","symbols":[3,1,8,1,6,6,1,9,2,2,6,6,3,5],"windowId":"qkpJt6"},"ID":48600,"umid":36}';
                        ...
                        switch( $umid ) 
                        {
                            ...
                            case '40066':
                                ...
                                $result_tmp[] = '3:::{"data":{"funNoticeGames":0,"funNoticePayouts":0,"gameGroup":"aeolus","minBet":0,"maxBet":0,"minPosBet":0,"maxPosBet":50000,"coinSizes":[' . implode(',', $gameBets) . ']},"ID":40025,"umid":21}';
                                break;
                            case '40036':
