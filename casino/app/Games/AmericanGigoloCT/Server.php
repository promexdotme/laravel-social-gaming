            ...
            function get_($request, $game)
            {
                \DB::transaction(function() use ($request, $game)
                {
                    try
                    {
                        ...
                        {
                            case 'create_session':
                                $slotSettings->SetGameData('AmericanGigoloCTCards', [
                                    19, 
                                    44, 
                                    0, 
                                    37, 
                            ...
                            case 'init_game':
                                ...
                                $slotSettings->SetGameData('AmericanGigoloCTBonusWin', 0);
                                $slotSettings->SetGameData('AmericanGigoloCTFreeGames', 0);
                                $slotSettings->SetGameData('AmericanGigoloCTCurrentFreeGame', 0);
                                $slotSettings->SetGameData('AmericanGigoloCTCurrentFreeGame0', 0);
                                $slotSettings->SetGameData('AmericanGigoloCTTotalWin', 0);
                                $slotSettings->SetGameData('AmericanGigoloCTFreeBalance', 0);
                                ...
                                if( $lastEvent != 'NULL' ) 
                                {
                                    ...
                                    if( $slotSettings->GetGameData('AmericanGigoloCTCurrentFreeGame') < $slotSettings->GetGameData('AmericanGigoloCTFreeGames') && $slotSettings->GetGameData('AmericanGigoloCTFreeGames') > 0 ) 
                                    {
                            ...
                            case 'poll':
                                ...
                                {
                                    $balanceInCents = sprintf('%01.2f', $slotSettings->GetBalance() - $slotSettings->GetGameData('AmericanGigoloCTTotalWin')) * 100;
                                }
                            ...
                            case 'game_finished':
                                $slotSettings->SetGameData('AmericanGigoloCTBonusWin', 0);
                                $slotSettings->SetGameData('AmericanGigoloCTTotalWin', 0);
                                $responseData['game_finished'][0]['freeround_play'] = $slotSettings->GetGameData('AmericanGigoloCTCurrentFreeGame0');
                            ...
                            case 'subgame_finished':
                                if( $slotSettings->GetGameData('AmericanGigoloCTCurrentFreeGame0') < $slotSettings->GetGameData('AmericanGigoloCTFreeGames') && $slotSettings->GetGameData('AmericanGigoloCTFreeGames') > 0 ) 
                                {
                                    ...
                                    $response = '{"responseEvent":"spin","responseType":"freespin","serverResponse":{"result":' . json_encode($result) . ',"slotDenom":' . $slotSettings->GetGameData($slotSettings->slotId . 'Denom') . ',"slotLines":' . $lines . ',"slotBet":' . $betline . ',"totalFreeGames":' . $slotSettings->GetGameData('AmericanGigoloCTFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('AmericanGigoloCTCurrentFreeGame0') . ',"Balance":' . $slotSettings->GetGameData('AmericanGigoloCTFreeBalance') . ',"afterBalance":' . $slotSettings->GetGameData('AmericanGigoloCTFreeBalance') . ',"bonusWin":' . $slotSettings->GetGameData('AmericanGigoloCTBonusWin') . ',"totalWin":' . $reportWin . ',"winLines":[],"Jackpots":[],"reelsSymbols":' . json_encode($slotSettings->GetGameData($slotSettings->slotId . 'Reels')) . '}}';
                                    if( $slotSettings->GetGameData('AmericanGigoloCTFreeGames') <= $slotSettings->GetGameData('AmericanGigoloCTCurrentFreeGame0') ) 
                                    {
                                        if( $reportWin > 0 ) 
                                        {
                                    ...
                                    $balanceInCents = $slotSettings->GetGameData('AmericanGigoloCTFreeBalance');
                                    $responseData['subgame_finished'][0]['account_status']['credit'] = round($balanceInCents);
                                    $responseData['subgame_finished'][0]['freeround_play'] = $slotSettings->GetGameData('AmericanGigoloCTCurrentFreeGame0');
                                    $responseData['subgame_finished'][1]['freeround_play'] = $slotSettings->GetGameData('AmericanGigoloCTCurrentFreeGame0');
                            ...
                            case 'play':
                                ...
                                for( $spinLoop = 0; $spinLoop < $spinLoopLimit; $spinLoop++ ) 
                                {
                                    ...
                                    if( $postData['slotEvent'] != 'freespin' ) 
                                    {
                                        ...
                                        $slotSettings->SetGameData('AmericanGigoloCTCurrentFreeGame0', 0);
                                        $slotSettings->SetGameData('AmericanGigoloCTTotalWin', 0);
                                        $slotSettings->SetGameData('AmericanGigoloCTFreeBalance', sprintf('%01.2f', $slotSettings->GetBalance()) * 100);
                                    ...
                                    {
                                        $slotSettings->SetGameData('AmericanGigoloCTCurrentFreeGame', $slotSettings->GetGameData('AmericanGigoloCTCurrentFreeGame') + 1);
                                    ...
                                    if( $postData['slotEvent'] == 'freespin' ) 
                                    {
                                        $slotSettings->SetGameData('AmericanGigoloCTBonusWin', $slotSettings->GetGameData('AmericanGigoloCTBonusWin') + $totalWin);
                                        $slotSettings->SetGameData('AmericanGigoloCTTotalWin', $slotSettings->GetGameData('AmericanGigoloCTTotalWin') + $totalWin);
                                        $balanceInCents = $slotSettings->GetGameData('AmericanGigoloCTFreeBalance');
                                    }
                                    else
                                    {
                                        $slotSettings->SetGameData('AmericanGigoloCTTotalWin', $totalWin);
                                    }
                                    $fs = 0;
                                    if( $scattersCount >= 3 ) 
                                    {
                                        if( $slotSettings->GetGameData('AmericanGigoloCTFreeGames') > 0 ) 
                                        {
                                            $slotSettings->SetGameData('AmericanGigoloCTFreeGames', $slotSettings->GetGameData('AmericanGigoloCTFreeGames') + $slotSettings->slotFreeCount);
                                        }
                                        else
                                        {
                                            $slotSettings->SetGameData('AmericanGigoloCTFreeStartWin', $totalWin);
                                            $slotSettings->SetGameData('AmericanGigoloCTBonusWin', $totalWin);
                                            $slotSettings->SetGameData('AmericanGigoloCTFreeGames', $slotSettings->slotFreeCount);
                                        }
                                        $fs = $slotSettings->GetGameData('AmericanGigoloCTFreeGames');
                                    ...
                                    $winstring = '';
                                    $slotSettings->SetGameData('AmericanGigoloCTGambleStep', 5);
                                    $hist = $slotSettings->GetGameData('AmericanGigoloCTCards');
                                    if( $postData['slotEvent'] == 'freespin' ) 
                                    {
                                        $state = 'freespin';
                                        ...
                                        if( $slotSettings->GetGameData($slotSettings->slotId . 'FreeGames') <= $slotSettings->GetGameData($slotSettings->slotId . 'CurrentFreeGame') && $slotSettings->GetGameData('AmericanGigoloCTBonusWin') > 0 ) 
                                        {
                                            $responseData['play'][0]['result'][$spinLoop]['is_free'] = true;
                                    ...
                                    $responseData['play'][0]['result'][$spinLoop]['total_win'] = $slotSettings->GetGameData('AmericanGigoloCTTotalWin') / $denom;
                                ...
                                $response = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{"result":' . json_encode($responseData['play'][0]['result']) . ',"slotDenom":' . $denom . ',"slotLines":' . $lines . ',"slotBet":' . $betline . ',"totalFreeGames":' . $slotSettings->GetGameData('AmericanGigoloCTFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('AmericanGigoloCTCurrentFreeGame0') . ',"Balance":' . $slotSettings->GetGameData($slotSettings->slotId . 'FreeBalance') . ',"afterBalance":' . $slotSettings->GetBalance() . ',"bonusWin":' . $slotSettings->GetGameData('AmericanGigoloCTBonusWin') . ',"totalWin":' . $totalWin . ',"winLines":[],"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
                            ...
                            case 'gamble':
                                ...
                                $dealerCard = '';
                                $totalWin = $slotSettings->GetGameData('AmericanGigoloCTTotalWin');
                                $gambleWin = 0;
                                $statBet = $totalWin;
                                ...
                                $hist = $slotSettings->GetGameData('AmericanGigoloCTCards');
                                $slotSettings->SetGameData('AmericanGigoloCTGambleStep', $slotSettings->GetGameData('AmericanGigoloCTGambleStep') - 1);
                                if( $slotSettings->MaxWin < ($totalWin * $slotSettings->CurrentDenom) ) 
                                {
                                    $isGambleWin = 0;
                                }
                                ...
                                else
                                {
                                    ...
                                    $totalWin = 0;
                                    $slotSettings->SetGameData('AmericanGigoloCTGambleStep', 0);
                                    if( $postData['continue_params']['double_key'] != 'red' && $postData['continue_params']['double_key'] != 'black' ) 
                                    {
                                        if( $postData['continue_params']['double_key'] == 'diamond' ) 
                                        {
                                ...
                                $slotSettings->SetGameData('AmericanGigoloCTCards', $hist);
