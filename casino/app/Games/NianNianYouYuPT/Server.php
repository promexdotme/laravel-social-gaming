            ...
            function get_($request, $game)
            {
                \DB::transaction(function() use ($request, $game)
                {
                    try
                    {
                        ...
                        if( isset($postData['ID']) && $postData['ID'] == 41020 && $slotSettings->GetGameData('NianNianYouYuPTBonusStart') ) 
                        {
                            $result_tmp = [];
                            if( $postData['type'] == 'spin' ) 
                            {
                                ...
                                if( $slotSettings->GetGameData('NianNianYouYuPT_JP' . $curJID . 'Cnt') == 2 ) 
                                {
                                    $curJID = $gJackID + 1;
                                    if( $curJID == 1 ) 
                                    {
                                ...
                                $slotSettings->SetGameData('NianNianYouYuPT_JP' . $curJID . 'Cnt', $slotSettings->GetGameData('NianNianYouYuPT_JP' . $curJID . 'Cnt') + 1);
                                $jWin = 0;
                                if( $slotSettings->GetGameData('NianNianYouYuPT_JP' . $curJID . 'Cnt') >= 3 ) 
                                {
                                    ...
                                    $slotSettings->SetGameData('NianNianYouYuPTBonusStart', false);
                                ...
                                $rp = json_decode($slotSettings->GetGameData('NianNianYouYuPTJackReport'));
                                $rp->serverResponse->jackpotSelected[0] = $slotSettings->GetGameData('NianNianYouYuPT_JP1Cnt');
                                $rp->serverResponse->jackpotSelected[1] = $slotSettings->GetGameData('NianNianYouYuPT_JP2Cnt');
                                $rp->serverResponse->jackpotSelected[2] = $slotSettings->GetGameData('NianNianYouYuPT_JP3Cnt');
                                $rp->serverResponse->jackpotSelected[3] = $slotSettings->GetGameData('NianNianYouYuPT_JP4Cnt');
                                $rp->serverResponse->jackpotReel = $reelPos[0];
                                $rp->serverResponse->BonusStart = $slotSettings->GetGameData('NianNianYouYuPTBonusStart');
                                $rp_s = json_encode($rp);
                                $slotSettings->SetGameData('NianNianYouYuPTJackReport', $rp_s);
                                if( $slotSettings->GetGameData('NianNianYouYuPT_JP' . $curJID . 'Cnt') >= 3 ) 
                                {
                        ...
                        {
                            $result_tmp = [];
                            if( $slotSettings->GetGameData('NianNianYouYuPTBonusStep') == 0 ) 
                            {
                                $WinArr = [
                                    25, 
                                    22, 
                                ...
                                shuffle($WinArr);
                                $slotSettings->SetGameData('NianNianYouYuPTBonusOpt', $WinArr);
                                $curWin = $WinArr[$postData['index']];
                                if( $curWin > 0 ) 
                                {
                                    $slotSettings->SetGameData('NianNianYouYuPTFreeGames', $slotSettings->GetGameData('NianNianYouYuPTFreeGames') + $curWin);
                                }
                                else
                                {
                                    $slotSettings->SetGameData('NianNianYouYuPTFreeMpl', $slotSettings->GetGameData('NianNianYouYuPTFreeMpl') + ($curWin * -1));
                                }
                                $result_tmp[] = '3:::{"data":{"pick":' . $postData['index'] . ',"values":[' . $curWin . '],"windowId":"h72Yp3"},"ID":49022,"umid":448}';
                                $slotSettings->SetGameData('NianNianYouYuPTBonusStep', 1);
                            }
                            else if( $slotSettings->GetGameData('NianNianYouYuPTBonusStep') == 1 ) 
                            {
                                $WinArr = $slotSettings->GetGameData('NianNianYouYuPTBonusOpt');
                                $curWin = $WinArr[$postData['index']];
                                if( $curWin > 10 ) 
                                {
                                    $slotSettings->SetGameData('NianNianYouYuPTFreeGames', $slotSettings->GetGameData('NianNianYouYuPTFreeGames') + $curWin);
                                ...
                                $slotSettings->SetGameData('NianNianYouYuPTBonusStep', 2);
                            }
                            $umid = 0;
                        }
                        if( isset($postData['spinType']) ) 
                        {
                            ...
                            if( $postData['spinType'] == 'regular' ) 
                            {
                                ...
                                $bonusMpl = 1;
                                $slotSettings->SetGameData('NianNianYouYuPT_JP1Cnt', 0);
                                $slotSettings->SetGameData('NianNianYouYuPT_JP2Cnt', 0);
                                $slotSettings->SetGameData('NianNianYouYuPT_JP3Cnt', 0);
                                $slotSettings->SetGameData('NianNianYouYuPT_JP4Cnt', 0);
                                $slotSettings->SetGameData('NianNianYouYuPTBonusWin', 0);
                                $slotSettings->SetGameData('NianNianYouYuPTFreeGames', 0);
                                $slotSettings->SetGameData('NianNianYouYuPTCurrentFreeGame', 0);
                                $slotSettings->SetGameData('NianNianYouYuPTTotalWin', 0);
                                $slotSettings->SetGameData('NianNianYouYuPTFreeBalance', 0);
                                $slotSettings->SetGameData('NianNianYouYuPTFreeStartWin', 0);
                                $slotSettings->SetGameData('NianNianYouYuPTFreeMpl', $slotSettings->slotFreeMpl);
                            }
                            else if( $postData['spinType'] == 'free' ) 
                            {
                                $umid = '0';
                                $postData['slotEvent'] = 'freespin';
                                $slotSettings->SetGameData('NianNianYouYuPTCurrentFreeGame', $slotSettings->GetGameData('NianNianYouYuPTCurrentFreeGame') + 1);
                                $bonusMpl = $slotSettings->GetGameData('NianNianYouYuPTFreeMpl');
                            }
                            $linesId = [];
                            $linesId[0] = [
                                2, 
                                    ...
                                    for( $j = 0; $j < count($slotSettings->SymbolGame); $j++ ) 
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            if( $s[4] == $csym || in_array($s[4], $wild) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":1,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('NianNianYouYuPTBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":["none","none"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            ...
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":2,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('NianNianYouYuPTBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            ...
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":3,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('NianNianYouYuPTBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            ...
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) && ($s[3] == $csym || in_array($s[3], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":4,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('NianNianYouYuPTBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            ...
                                            if( ($s[4] == $csym || in_array($s[4], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) && ($s[3] == $csym || in_array($s[3], $wild)) && ($s[4] == $csym || in_array($s[4], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":5,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('NianNianYouYuPTBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":[' . ($linesId[$k][4] - 1) . ',"' . $s[4] . '"]}';
                                                }
                                            }
                                        }
                                    }
                            ...
                            if( $postData['slotEvent'] == 'freespin' ) 
                            {
                                $slotSettings->SetGameData('NianNianYouYuPTBonusWin', $slotSettings->GetGameData('NianNianYouYuPTBonusWin') + $totalWin);
                                $slotSettings->SetGameData('NianNianYouYuPTTotalWin', $totalWin);
                            }
                            else
                            {
                                $slotSettings->SetGameData('NianNianYouYuPTTotalWin', $totalWin);
                            ...
                            if( $winType == 'bonus' ) 
                            {
                                ...
                                $slotSettings->SetGameData('NianNianYouYuPTBonusStart', true);
                            ...
                            $response = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{"BonusStart":' . json_encode($slotSettings->GetGameData('NianNianYouYuPTBonusStart')) . ',"JackWinID":' . $slotSettings->GetGameData($slotSettings->slotId . 'JackWinID') . ',"jackpotReel":0,"jackpotSelected":[' . implode(',', $jackpotSelected) . '],"linesArr":[' . implode(',', $postData['lines']) . '],"slotLines":' . $lines . ',"slotBet":' . $betLine . ',"totalFreeGames":' . $slotSettings->GetGameData('NianNianYouYuPTFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('NianNianYouYuPTCurrentFreeGame') . ',"Balance":' . $slotSettings->GetBalance() . ',"afterBalance":' . $slotSettings->GetBalance() . ',"bonusWin":' . $slotSettings->GetGameData('NianNianYouYuPTBonusWin') . ',"FreeMpl":' . $slotSettings->GetGameData('NianNianYouYuPTFreeMpl') . ',"freeStartWin":' . $slotSettings->GetGameData('NianNianYouYuPTFreeStartWin') . ',"totalWin":' . $totalWin . ',"winLines":[' . $winString . '],"bonusInfo":' . $scattersStr . ',"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
                            $slotSettings->SetGameData('NianNianYouYuPTJackReport', $response);
                        ...
                        switch( $umid ) 
                        {
                            ...
                            case '40020':
                                ...
                                if( $lastEvent != 'NULL' ) 
                                {
                                    $slotSettings->SetGameData('NianNianYouYuPT_JP1Cnt', $lastEvent->serverResponse->jackpotSelected[0]);
                                    $slotSettings->SetGameData('NianNianYouYuPT_JP2Cnt', $lastEvent->serverResponse->jackpotSelected[1]);
                                    $slotSettings->SetGameData('NianNianYouYuPT_JP3Cnt', $lastEvent->serverResponse->jackpotSelected[2]);
                                    $slotSettings->SetGameData('NianNianYouYuPT_JP4Cnt', $lastEvent->serverResponse->jackpotSelected[3]);
                                    $slotSettings->SetGameData('NianNianYouYuPT_JPReel', $lastEvent->serverResponse->jackpotReel);
                                    ...
                                    if( $lastEvent->responseType == 'jackpot' && $lastEvent->serverResponse->jackpotSelected[0] < 3 && $lastEvent->serverResponse->jackpotSelected[1] < 3 && $lastEvent->serverResponse->jackpotSelected[2] < 3 && $lastEvent->serverResponse->jackpotSelected[3] < 3 ) 
                                    {
                                        ...
                                        $slotSettings->SetGameData('NianNianYouYuPTJackReport', json_encode($lastEvent));
                                    }
                                }
                            ...
                            case '40030':
                                ...
                                if( $slotSettings->GetGameData($slotSettings->slotId . 'brokenGames') != '' ) 
                                {
                                    ...
                                    if( $lastEvent != 'NULL' ) 
                                    {
                                        ...
                                        $slotSettings->SetGameData('NianNianYouYuPT_JP4Cnt', $lastEvent->serverResponse->jackpotSelected[3]);
                                        $slotSettings->SetGameData('NianNianYouYuPT_JPReel', $lastEvent->serverResponse->jackpotReel);
                                        $slotSettings->SetGameData('NianNianYouYuPTBonusStart', $lastEvent->serverResponse->BonusStart);
                                        $slotSettings->SetGameData($slotSettings->slotId . 'BonusWin', $lastEvent->serverResponse->bonusWin);
                                        $slotSettings->SetGameData($slotSettings->slotId . 'FreeStartWin', $lastEvent->serverResponse->freeStartWin);
                                        $slotSettings->SetGameData($slotSettings->slotId . 'FreeGames', $lastEvent->serverResponse->totalFreeGames);
                                        $slotSettings->SetGameData($slotSettings->slotId . 'CurrentFreeGame', $lastEvent->serverResponse->currentFreeGames);
