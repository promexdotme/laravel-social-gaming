                    ...
                    try
                    {
                        ...
                        switch( $aid ) 
                        {
                            ...
                            case 'settings':
                                ...
                                $result_tmp[] = '{"complex":{"balance":' . $balanceInCents . ',"balanceRaw":' . round($balanceInCents * $slotSettings->CurrentDenom) . ',"paytableCoef":{"0":{"coef":[5,20,100],"multiplier":1},"1":{"coef":[5,20,100],"multiplier":1},"2":{"coef":[5,20,100],"multiplier":1},"3":{"coef":[5,20,100],"multiplier":1},"4":{"coef":[5,50,150],"multiplier":1},"5":{"coef":[5,50,150],"multiplier":1},"6":{"coef":[20,75,250],"multiplier":1},"7":{"coef":[20,75,250],"multiplier":1},"8":{"coef":[25,100,400],"multiplier":1},"9":{"coef":[25,100,400],"multiplier":1},"10":{"coef":[50,200,1000],"multiplier":1},"11":{"coef":[2],"multiplier":1}},"bets":[' . implode(',', $gameBets) . '],"jackpotMinBet":1,"jackpot":true,"jackpotMinBet":1,"jackpot":true,"mainFakeReels":[[2,4,1,3,2,7,0,6,1,4,9,0,5,6,1,10,10,10,5,8,0,5,1,0,3,8,5,2,3,1],[2,4,1,3,2,7,0,6,1,4,9,0,5,6,1,2,10,10,10,1,9,2,9,6,4,11,0,2,0,2],[2,4,1,3,2,7,0,6,1,4,9,0,10,10,10,10,10,4,5,8,1,11,0,5,0,3,4,0,2,6],[2,4,1,3,2,7,0,6,1,4,9,0,5,6,10,10,10,4,5,7,3,6,0,8,0,5,0,2,11,1],[2,4,1,3,2,7,0,6,1,4,9,0,5,6,10,10,10,10,10,5,0,8,1,0,3,4,5,0,6,2]],"jackpotMaxBet":100000,"denominations":[' . implode(',', $denoms) . ']},"gameIdentificationNumber":' . $postData['gameIdentificationNumber'] . ',"gameNumber":-1,"sessionKey":"41be9e65e0ff03a65e8c93576bf61130","msg":"success","messageId":"' . $postData['messageId'] . '","qName":"app.services.messages.response.GameResponse","command":"settings","eventTimestamp":' . time() . '}';
                                break;
                            case 'subscribe':
                                $hist = [
                                    78, 
                                ...
                                shuffle($hist);
                                $slotSettings->SetGameData('OilCompanyIIEGTCards', $hist);
                                $lastEvent = $slotSettings->GetHistory();
                                $slotSettings->SetGameData('OilCompanyIIEGTBonusWin', 0);
                                $slotSettings->SetGameData('OilCompanyIIEGTFreeGames', 0);
                                $slotSettings->SetGameData('OilCompanyIIEGTCurrentFreeGame', 0);
                                $slotSettings->SetGameData('OilCompanyIIEGTTotalWin', 0);
                                $slotSettings->SetGameData('OilCompanyIIEGTFreeBalance', 0);
                                ...
                                if( $lastEvent != 'NULL' ) 
                                {
                                    ...
                                    $gtype = 1;
                                    if( $slotSettings->GetGameData('OilCompanyIIEGTCurrentFreeGame') < $slotSettings->GetGameData('OilCompanyIIEGTFreeGames') && $slotSettings->GetGameData('OilCompanyIIEGTFreeGames') > 0 ) 
                                    {
                                        $gtype = 2;
                                    }
                                }
                            ...
                            case 'bet':
                                ...
                                if( $postData['slotEvent'] != 'freespin' ) 
                                {
                                    ...
                                    $slotSettings->SetGameData('OilCompanyIIEGTCurrentFreeGame', 0);
                                    $slotSettings->SetGameData('OilCompanyIIEGTTotalWin', 0);
                                    $slotSettings->SetGameData('OilCompanyIIEGTFreeBalance', sprintf('%01.2f', $slotSettings->GetBalance()) * 100);
                                    $slotSettings->SetGameData('OilCompanyIIEGTHolds', []);
                                    $slotSettings->SetGameData($slotSettings->slotId . 'FirstSpin', '');
                                    $bonusMpl = 1;
                                }
                                else
                                {
                                    $slotSettings->SetGameData('OilCompanyIIEGTCurrentFreeGame', $slotSettings->GetGameData('OilCompanyIIEGTCurrentFreeGame') + 1);
                                ...
                                if( $postData['slotEvent'] == 'freespin' ) 
                                {
                                    $slotSettings->SetGameData('OilCompanyIIEGTBonusWin', $slotSettings->GetGameData('OilCompanyIIEGTBonusWin') + $totalWin);
                                    $slotSettings->SetGameData('OilCompanyIIEGTTotalWin', $slotSettings->GetGameData('OilCompanyIIEGTTotalWin') + $totalWin);
                                    $balanceInCents = $slotSettings->GetGameData('OilCompanyIIEGTFreeBalance');
                                    $slotSettings->SetGameData($slotSettings->slotId . 'Holds', $holdsReel);
                                }
                                else
                                {
                                    $slotSettings->SetGameData('OilCompanyIIEGTTotalWin', $totalWin);
                                }
                                $fs = 0;
                                $curReels = '' . rand(0, 6) . ',' . $reels['reel1'][0] . ',' . $reels['reel1'][1] . ',' . $reels['reel1'][2] . ',' . $reels['reel1'][3] . ',' . rand(0, 6);
                                $curReels .= (',' . rand(0, 6) . ',' . $reels['reel2'][0] . ',' . $reels['reel2'][1] . ',' . $reels['reel2'][2] . ',' . $reels['reel2'][3] . ',' . rand(0, 6));
                                ...
                                if( $scattersCount >= 3 ) 
                                {
                                    if( $slotSettings->GetGameData('OilCompanyIIEGTFreeGames') > 0 ) 
                                    {
                                        $slotSettings->SetGameData('OilCompanyIIEGTBonusWin', $totalWin);
                                        $slotSettings->SetGameData('OilCompanyIIEGTFreeGames', $slotSettings->GetGameData('OilCompanyIIEGTFreeGames') + $slotSettings->slotFreeCount[$scattersCount]);
                                    }
                                    else
                                    {
                                        $slotSettings->SetGameData('OilCompanyIIEGTFreeStartWin', $totalWin);
                                        $slotSettings->SetGameData('OilCompanyIIEGTBonusWin', $totalWin);
                                        $slotSettings->SetGameData('OilCompanyIIEGTFreeGames', $slotSettings->slotFreeCount[$scattersCount]);
                                    }
                                    $slotSettings->SetGameData($slotSettings->slotId . 'FirstSpin', ',"firstSpin":{"expand":[],"reels":[' . $curReels . '],"lines":[],"expand":[],"scatters":[' . $scattersStr . ']}');
                                    $fs = $slotSettings->GetGameData('OilCompanyIIEGTFreeGames');
                                }
                                $winString = implode(',', $lineWins);
                                $jsSpin = '' . json_encode($reels) . '';
                                $jsJack = '' . json_encode($slotSettings->Jackpots) . '';
                                $response = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{"slotLines":' . $lines . '' . $slotSettings->GetGameData($slotSettings->slotId . 'FirstSpin') . ',"slotBet":' . $betline . ',"holdReels": ' . json_encode($slotSettings->GetGameData($slotSettings->slotId . 'Holds')) . ',"totalFreeGames":' . $slotSettings->GetGameData('OilCompanyIIEGTFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('OilCompanyIIEGTCurrentFreeGame') . ',"Balance":' . $balanceInCents . ',"afterBalance":' . $balanceInCents . ',"bonusWin":' . $slotSettings->GetGameData('OilCompanyIIEGTBonusWin') . ',"totalWin":' . $totalWin . ',"winLines":[' . $winString . '],"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
                                $slotSettings->SaveLogReport($response, $allbet, $lines, $reportWin, $postData['slotEvent']);
                                $winstring = '';
                                $slotSettings->SetGameData('OilCompanyIIEGTGambleStep', 5);
                                $hist = $slotSettings->GetGameData('OilCompanyIIEGTCards');
                                if( $jackRandom == 1 ) 
                                {
                                    $state = 'jackpot';
                                    $isJack = 'true';
                                    $slotSettings->SetGameData('OilCompanyIIEGTJackSteps', [
                                        0, 
                                        0, 
                                        0, 
                                        0
                                ...
                                if( $postData['slotEvent'] == 'freespin' ) 
                                {
                                    $totalWin = $slotSettings->GetGameData('OilCompanyIIEGTBonusWin');
                                    $state = 'freespin';
                                ...
                                $result_tmp[] = '{"complex":{"gambles":5,"reels":[' . $curReels . '],"lines":[' . $winString . '],"scatters":[' . $scattersStr . '],"freespinScatters":[' . $scatter . '],"holdReels": [' . implode(',', $slotSettings->GetGameData($slotSettings->slotId . 'Holds')) . '],"expand":[' . implode(',', $holdsNew) . '],"specialExpand":[],"gambles":5,"freespins":' . $fs . ',"jackpot":' . $isJack . ',"gameCommand":"bet"},"state":"' . $state . '","winAmount":' . ($totalWin * 100) . ',"gameIdentificationNumber":' . $postData['gameIdentificationNumber'] . ',"gameNumber":"","balance":' . $balanceInCents . ',"sessionKey":"41be9e65e0ff03a65e8c93576bf61130","msg":"success","messageId":"' . $postData['messageId'] . '","qName":"app.services.messages.response.GameEventResponse","command":"bet","eventTimestamp":' . time() . '}';
                                ...
                                break;
                            case 'collect':
                                $result_tmp[] = '{"complex":{"gameCommand":"collect"},"state":"idle","winAmount":' . ($slotSettings->GetGameData('OilCompanyIIEGTTotalWin') * 100) . ',"gameIdentificationNumber":' . $postData['gameIdentificationNumber'] . ',"gameNumber":"","balance":' . $balanceInCents . ',"sessionKey":"41be9e65e0ff03a65e8c93576bf61130","msg":"success","messageId":"' . $postData['messageId'] . '","qName":"app.services.messages.response.GameEventResponse","command":"bet","eventTimestamp":' . time() . '}';
                                $slotSettings->SetGameData('OilCompanyIIEGTTotalWin', 0);
                                break;
                            case 'jackpot':
                                $jackStep = $slotSettings->GetGameData('OilCompanyIIEGTJackSteps');
                                $jackWinID = $slotSettings->GetGameData($slotSettings->slotId . 'JackWinID');
                                if( $jackStep[0] >= 3 || $jackStep[1] >= 3 || $jackStep[2] >= 3 || $jackStep[3] >= 3 || !$slotSettings->HasGameData('OilCompanyIIEGTJackSteps') ) 
                                {
                                    exit();
                                }
                                $winAmount = 0;
                                ...
                                $slotSettings->SetGameData('OilCompanyIIEGTJackSteps', $jackStep);
                                break;
                            case 'gamble':
                                $Balance = $slotSettings->GetBalance();
                                $isGambleWin = rand(1, $slotSettings->GetGambleSettings());
                                $dealerCard = '';
                                $totalWin = $slotSettings->GetGameData('OilCompanyIIEGTTotalWin');
                                $gambleWin = 0;
                                $statBet = $totalWin;
                                $slotSettings->SetGameData('OilCompanyIIEGTGambleStep', $slotSettings->GetGameData('OilCompanyIIEGTGambleStep') - 1);
                                ...
                                else
                                {
                                    ...
                                    $totalWin = 0;
                                    $slotSettings->SetGameData('OilCompanyIIEGTGambleStep', 0);
                                    if( $postData['bet']['color'] == '1' ) 
                                    {
                                        $tmpCards = [
                                            '1', 
                                ...
                                $gtype = 1;
                                $gtype0 = 1;
                                if( $slotSettings->GetGameData('OilCompanyIIEGTBonusStart') == 1 ) 
                                {
                                    $gtype0 = 2;
                                }
                                $result_tmp[] = '{"complex":{"gambles":' . $slotSettings->GetGameData('OilCompanyIIEGTGambleStep') . ',"card":' . $dealerCard . ',"jackpot":false,"gameCommand":"gamble"},"state":"' . $gambleState . '","winAmount":' . ($totalWin * 100) . ',"gameIdentificationNumber":' . $postData['gameIdentificationNumber'] . ',"gameNumber":"","sessionKey":"88e2b82e6537db4a339e4e1b5ce462cd","msg":"success","messageId":"' . $postData['messageId'] . '","qName":"app.services.messages.response.GameEventResponse","command":"bet","eventTimestamp":' . time() . '}';
                                break;
                        }
