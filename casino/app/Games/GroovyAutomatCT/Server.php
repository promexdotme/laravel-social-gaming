            ...
            function get_($request, $game)
            {
                \DB::transaction(function() use ($request, $game)
                {
                    try
                    {
                        ...
                        {
                            case 'create_session':
                                $slotSettings->SetGameData('GroovyAutomatCTCards', [
                                    19, 
                                    44, 
                                    0, 
                                    37, 
                            ...
                            case 'init_game':
                                ...
                                $slotSettings->SetGameData('GroovyAutomatCTBonusWin', 0);
                                $slotSettings->SetGameData('GroovyAutomatCTFreeGames', 0);
                                $slotSettings->SetGameData('GroovyAutomatCTCurrentFreeGame', 0);
                                $slotSettings->SetGameData('GroovyAutomatCTCurrentFreeGame0', 0);
                                $slotSettings->SetGameData('GroovyAutomatCTTotalWin', 0);
                                $slotSettings->SetGameData('GroovyAutomatCTFreeBalance', 0);
                                ...
                                if( $lastEvent != 'NULL' ) 
                                {
                                    ...
                                    if( $slotSettings->GetGameData('GroovyAutomatCTCurrentFreeGame') < $slotSettings->GetGameData('GroovyAutomatCTFreeGames') && $slotSettings->GetGameData('GroovyAutomatCTFreeGames') > 0 ) 
                                    {
                            ...
                            case 'poll':
                                ...
                                {
                                    $balanceInCents = sprintf('%01.2f', $slotSettings->GetBalance() - $slotSettings->GetGameData('GroovyAutomatCTTotalWin')) * 100;
                                }
                            ...
                            case 'game_finished':
                                $slotSettings->SetGameData('GroovyAutomatCTBonusWin', 0);
                                $slotSettings->SetGameData('GroovyAutomatCTTotalWin', 0);
                                $responseData['game_finished'][0]['freeround_play'] = $slotSettings->GetGameData('GroovyAutomatCTCurrentFreeGame0');
                            ...
                            case 'subgame_finished':
                                if( $slotSettings->GetGameData('GroovyAutomatCTCurrentFreeGame0') < $slotSettings->GetGameData('GroovyAutomatCTFreeGames') && $slotSettings->GetGameData('GroovyAutomatCTFreeGames') > 0 ) 
                                {
                                    ...
                                    $response = '{"responseEvent":"spin","responseType":"freespin","serverResponse":{"result":' . json_encode($result) . ',"slotDenom":' . $slotSettings->GetGameData($slotSettings->slotId . 'Denom') . ',"slotLines":' . $lines . ',"slotBet":' . $betline . ',"totalFreeGames":' . $slotSettings->GetGameData('GroovyAutomatCTFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('GroovyAutomatCTCurrentFreeGame0') . ',"Balance":' . $slotSettings->GetGameData('GroovyAutomatCTFreeBalance') . ',"afterBalance":' . $slotSettings->GetGameData('GroovyAutomatCTFreeBalance') . ',"bonusWin":' . $slotSettings->GetGameData('GroovyAutomatCTBonusWin') . ',"totalWin":' . $reportWin . ',"winLines":[],"Jackpots":[],"reelsSymbols":' . json_encode($slotSettings->GetGameData($slotSettings->slotId . 'Reels')) . '}}';
                                    if( $slotSettings->GetGameData('GroovyAutomatCTFreeGames') <= $slotSettings->GetGameData('GroovyAutomatCTCurrentFreeGame0') ) 
                                    {
                                        if( $reportWin > 0 ) 
                                        {
                                    ...
                                    $balanceInCents = $slotSettings->GetGameData('GroovyAutomatCTFreeBalance');
                                    $responseData['subgame_finished'][0]['account_status']['credit'] = round($balanceInCents);
                                    $responseData['subgame_finished'][0]['freeround_play'] = $slotSettings->GetGameData('GroovyAutomatCTCurrentFreeGame0');
                                    $responseData['subgame_finished'][1]['freeround_play'] = $slotSettings->GetGameData('GroovyAutomatCTCurrentFreeGame0');
                            ...
                            case 'play':
                                ...
                                for( $spinLoop = 0; $spinLoop < $spinLoopLimit; $spinLoop++ ) 
                                {
                                    ...
                                    if( $postData['slotEvent'] != 'freespin' ) 
                                    {
                                        ...
                                        $slotSettings->SetGameData('GroovyAutomatCTCurrentFreeGame0', 0);
                                        $slotSettings->SetGameData('GroovyAutomatCTTotalWin', 0);
                                        $slotSettings->SetGameData('GroovyAutomatCTFreeBalance', sprintf('%01.2f', $slotSettings->GetBalance()) * 100);
                                    ...
                                    {
                                        $slotSettings->SetGameData('GroovyAutomatCTCurrentFreeGame', $slotSettings->GetGameData('GroovyAutomatCTCurrentFreeGame') + 1);
                                    ...
                                    if( $postData['slotEvent'] == 'freespin' ) 
                                    {
                                        $slotSettings->SetGameData('GroovyAutomatCTBonusWin', $slotSettings->GetGameData('GroovyAutomatCTBonusWin') + $totalWin);
                                        $slotSettings->SetGameData('GroovyAutomatCTTotalWin', $slotSettings->GetGameData('GroovyAutomatCTTotalWin') + $totalWin);
                                        $balanceInCents = $slotSettings->GetGameData('GroovyAutomatCTFreeBalance');
                                    }
                                    else
                                    {
                                        $slotSettings->SetGameData('GroovyAutomatCTTotalWin', $totalWin);
                                    }
                                    $fs = 0;
                                    if( $scattersCount >= 3 ) 
                                    {
                                    ...
                                    $winstring = '';
                                    $slotSettings->SetGameData('GroovyAutomatCTGambleStep', 5);
                                    $hist = $slotSettings->GetGameData('GroovyAutomatCTCards');
                                    if( $postData['slotEvent'] == 'freespin' ) 
                                    {
                                        $state = 'freespin';
                                        ...
                                        if( $slotSettings->GetGameData($slotSettings->slotId . 'FreeGames') <= $slotSettings->GetGameData($slotSettings->slotId . 'CurrentFreeGame') && $slotSettings->GetGameData('GroovyAutomatCTBonusWin') > 0 ) 
                                        {
                                            $responseData['play'][0]['result'][$spinLoop]['is_free'] = true;
                                    ...
                                    $responseData['play'][0]['result'][$spinLoop]['total_win'] = $slotSettings->GetGameData('GroovyAutomatCTTotalWin') / $denom;
                                ...
                                $response = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{"result":' . json_encode($responseData['play'][0]['result']) . ',"slotDenom":' . $denom . ',"slotLines":' . $lines . ',"slotBet":' . $betline . ',"totalFreeGames":' . $slotSettings->GetGameData('GroovyAutomatCTFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('GroovyAutomatCTCurrentFreeGame0') . ',"Balance":' . $slotSettings->GetGameData($slotSettings->slotId . 'FreeBalance') . ',"afterBalance":' . $slotSettings->GetBalance() . ',"bonusWin":' . $slotSettings->GetGameData('GroovyAutomatCTBonusWin') . ',"totalWin":' . $totalWin . ',"winLines":[],"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
                            ...
                            case 'gamble':
                                ...
                                $dealerCard = '';
                                $totalWin = $slotSettings->GetGameData('GroovyAutomatCTTotalWin');
                                $gambleWin = 0;
                                $statBet = $totalWin;
                                ...
                                $hist = $slotSettings->GetGameData('GroovyAutomatCTCards');
                                $slotSettings->SetGameData('GroovyAutomatCTGambleStep', $slotSettings->GetGameData('GroovyAutomatCTGambleStep') - 1);
                                if( $slotSettings->MaxWin < ($totalWin * $slotSettings->CurrentDenom) ) 
                                {
                                    $isGambleWin = 0;
                                }
                                ...
                                else
                                {
                                    ...
                                    $totalWin = 0;
                                    $slotSettings->SetGameData('GroovyAutomatCTGambleStep', 0);
                                    if( $postData['continue_params']['double_key'] != 'red' && $postData['continue_params']['double_key'] != 'black' ) 
                                    {
                                        if( $postData['continue_params']['double_key'] == 'diamond' ) 
                                        {
                                ...
                                $slotSettings->SetGameData('GroovyAutomatCTCards', $hist);
