        ...
        public function get($request, $game)
        {
            \DB::transaction(function() use ($request, $game)
            {
                try
                {
                    ...
                    {
                        $slotSettings->SetGameData('MarkoPoloFreeGames', 0);
                        ...
                        if( $lastEvent != 'NULL' ) 
                        {
                            ...
                            $slotSettings->SetGameData('MarkoPoloFreeMpl', $lastEvent->serverResponse->multiplier);
                        }
                    ...
                    else if( $postData['slotEvent'] == 'gamble5GetUserCards' ) 
                    {
                        ...
                        $dealerCard = $slotSettings->GetGameData('MarkoPoloDealerCard');
                        $totalWin = $slotSettings->GetGameData('MarkoPoloTotalWin');
                        $gambleWin = 0;
                        ...
                        $slotSettings->SetGameData('MarkoPoloTotalWin', $totalWin);
                    ...
                    else if( $postData['slotEvent'] == 'gamble5GetDealerCard' ) 
                    {
                        ...
                        $slotSettings->SetGameData('MarkoPoloDealerCard', $tmpDc);
                    ...
                    else if( $postData['slotEvent'] == 'bet' || $postData['slotEvent'] == 'freespin' ) 
                    {
                        ...
                        if( $postData['slotEvent'] != 'freespin' ) 
                        {
                            ...
                            $bonusMpl = 1;
                            $slotSettings->SetGameData('MarkoPoloBonusWin', 0);
                            $slotSettings->SetGameData('MarkoPoloFreeGames', 0);
                            $slotSettings->SetGameData('MarkoPoloCurrentFreeGame', 0);
                            $slotSettings->SetGameData('MarkoPoloTotalWin', 0);
                            $slotSettings->SetGameData('MarkoPoloFreeBalance', 0);
                        }
                        else
                        {
                            $slotSettings->SetGameData('MarkoPoloCurrentFreeGame', $slotSettings->GetGameData('MarkoPoloCurrentFreeGame') + 1);
                        ...
                        for( $i = 0; $i <= 2000; $i++ ) 
                        {
                            ...
                            {
                                $bonusMpl = $slotSettings->GetGameData('MarkoPoloFreeMpl');
                            }
                                ...
                                for( $j = 0; $j < count($slotSettings->SymbolGame); $j++ ) 
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) ) 
                                        {
                                            ...
                                            {
                                                $cWins[$k] = $tmpWin;
                                                $tmpStringWin = '{"Count":2,"Line":' . $k . ',"Win":' . ($cWins[$k] + $totalWin) . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('MarkoPoloBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                            }
                                        }
                                        if( ($slotSettings->slotWinLineMode == 'LeftRight' || $slotSettings->slotWinLineMode == 'LeftRightMiddle') && ($s[4] == $csym || in_array($s[4], $wild)) && ($s[3] == $csym || in_array($s[3], $wild)) ) 
                                        {
                                            ...
                                            {
                                                $cWins[$k] = $tmpWin;
                                                $tmpStringWin = '{"Count":2,"Line":' . $k . ',"Win":' . ($cWins[$k] + $totalWin) . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('MarkoPoloBonusWin')) . ',"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":[' . ($linesId[$k][4] - 1) . ',"' . $s[4] . '"],"winReel1":["none","none"],"winReel2":["none","none"],"winReel3":["none","none"]}';
                                            }
                                        }
                                        if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) ) 
                                        {
                                            ...
                                            {
                                                $cWins[$k] = $tmpWin;
                                                $tmpStringWin = '{"Count":3,"Line":' . $k . ',"Win":' . ($cWins[$k] + $totalWin) . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('MarkoPoloBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                            }
                                        }
                                        if( ($slotSettings->slotWinLineMode == 'LeftRight' || $slotSettings->slotWinLineMode == 'LeftRightMiddle') && ($s[4] == $csym || in_array($s[4], $wild)) && ($s[3] == $csym || in_array($s[3], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) ) 
                                        {
                                            ...
                                            {
                                                $cWins[$k] = $tmpWin;
                                                $tmpStringWin = '{"Count":3,"Line":' . $k . ',"Win":' . ($cWins[$k] + $totalWin) . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('MarkoPoloBonusWin')) . ',"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":[' . ($linesId[$k][4] - 1) . ',"' . $s[4] . '"],"winReel1":["none","none"],"winReel2":["none","none"]}';
                                            }
                                        }
                                        if( $slotSettings->slotWinLineMode == 'LeftRightMiddle' && ($s[3] == $csym || in_array($s[3], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) ) 
                                        {
                                            ...
                                            {
                                                $cWins[$k] = $tmpWin;
                                                $tmpStringWin = '{"Count":3,"Line":' . $k . ',"Win":' . ($cWins[$k] + $totalWin) . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('MarkoPoloBonusWin')) . ',"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel1":["none","none"],"winReel5":["none","none"]}';
                                            }
                                        }
                                        if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) && ($s[3] == $csym || in_array($s[3], $wild)) ) 
                                        {
                                            ...
                                            {
                                                $cWins[$k] = $tmpWin;
                                                $tmpStringWin = '{"Count":4,"Line":' . $k . ',"Win":' . ($cWins[$k] + $totalWin) . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('MarkoPoloBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":["none","none"]}';
                                            }
                                        }
                                        if( ($slotSettings->slotWinLineMode == 'LeftRight' || $slotSettings->slotWinLineMode == 'LeftRightMiddle') && ($s[4] == $csym || in_array($s[4], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) && ($s[3] == $csym || in_array($s[3], $wild)) ) 
                                        {
                                            ...
                                            {
                                                $cWins[$k] = $tmpWin;
                                                $tmpStringWin = '{"Count":4,"Line":' . $k . ',"Win":' . ($cWins[$k] + $totalWin) . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('MarkoPoloBonusWin')) . ',"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":[' . ($linesId[$k][4] - 1) . ',"' . $s[4] . '"],"winReel1":["none","none"]}';
                                            }
                                        }
                                        if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) && ($s[3] == $csym || in_array($s[3], $wild)) && ($s[4] == $csym || in_array($s[4], $wild)) ) 
                                        {
                                            ...
                                            {
                                                $cWins[$k] = $tmpWin;
                                                $tmpStringWin = '{"Count":5,"Line":' . $k . ',"Win":' . ($cWins[$k] + $totalWin) . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('MarkoPoloBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":[' . ($linesId[$k][4] - 1) . ',"' . $s[4] . '"]}';
                                            }
                                        }
                                    }
                                }
                            ...
                            if( $slotSettings->doubleFreeWin && $postData['slotEvent'] == 'freespin' ) 
                            {
                                ...
                                {
                                    $doubleWin = $slotSettings->GetGameData('MarkoPoloTotalWin');
                            ...
                            {
                                $doubleWin = $totalWin * ($slotSettings->GetGameData('MarkoPoloFreeMpl') - 1);
                                $advancedEffects = '"freeMultiplier":["' . $slotSettings->doubleFreeWinSym . '",-1,"X' . $slotSettings->GetGameData('MarkoPoloFreeMpl') . '",' . ($totalWin + $doubleWin + $slotSettings->GetGameData('MarkoPoloTotalWin')) . ',' . ($totalWin * $slotSettings->GetGameData('MarkoPoloFreeMpl')) . '],';
                            }
                            if( $i > 1000 ) 
                            {
                                $winType = 'none';
                        ...
                        if( $postData['slotEvent'] == 'freespin' && $slotSettings->GetGameData('MarkoPoloFreeGames') <= $slotSettings->GetGameData('MarkoPoloCurrentFreeGame') && $winType != 'bonus' && $slotSettings->GetGameData('MarkoPoloTotalWin') + $totalWin > 0 ) 
                        {
                            $slotSettings->SetBalance($slotSettings->GetGameData('MarkoPoloTotalWin') + $totalWin + $doubleWin);
                        }
                        ...
                        if( $postData['slotEvent'] == 'freespin' ) 
                        {
                            $slotSettings->SetGameData('MarkoPoloBonusWin', $slotSettings->GetGameData('MarkoPoloBonusWin') + $totalWin);
                            $slotSettings->SetGameData('MarkoPoloTotalWin', $slotSettings->GetGameData('MarkoPoloTotalWin') + $totalWin);
                            $totalWin = $slotSettings->GetGameData('MarkoPoloBonusWin');
                            $Balance = $slotSettings->GetGameData('MarkoPoloFreeBalance');
                            $slotSettings->SetGameData('MarkoPoloBonusWin', $slotSettings->GetGameData('MarkoPoloBonusWin') + $doubleWin);
                            $slotSettings->SetGameData('MarkoPoloTotalWin', $slotSettings->GetGameData('MarkoPoloTotalWin') + $doubleWin);
                        }
                        else
                        {
                            $slotSettings->SetGameData('MarkoPoloTotalWin', $totalWin);
                        ...
                        {
                            if( $slotSettings->GetGameData('MarkoPoloFreeGames') > 0 ) 
                            {
                                $slotSettings->SetGameData('MarkoPoloBonusWin', $totalWin);
                                $slotSettings->SetGameData('MarkoPoloFreeGames', $slotSettings->GetGameData('MarkoPoloFreeGames') + $slotSettings->slotFreeCount);
                            }
                            else
                            {
                                $slotSettings->SetGameData('MarkoPoloFreeMpl', $slotSettings->slotFreeMpl);
                                $slotSettings->SetGameData('MarkoPoloFreeBalance', $Balance);
                                $slotSettings->SetGameData('MarkoPoloBonusWin', $totalWin);
                                $slotSettings->SetGameData('MarkoPoloFreeGames', $slotSettings->slotFreeCount);
                            }
                            if( $slotSettings->increaseFreeSpinsMpl == 1 ) 
                            {
                                $slotSettings->SetGameData('MarkoPoloFreeMpl', $slotSettings->GetGameData('MarkoPoloFreeMpl') + 1);
                            }
                        }
                        $jsSpin = '' . json_encode($reels) . '';
                        $jsJack = '' . json_encode($slotSettings->Jackpots) . '';
                        $winString = implode(',', $lineWins);
                        $response = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{"slotLines":' . $postData['slotLines'] . ',"slotBet":' . $postData['slotBet'] . ',"multiplier":"' . $slotSettings->GetGameData('MarkoPoloFreeMpl') . '",' . $advancedEffects . '"totalFreeGames":' . $slotSettings->GetGameData('MarkoPoloFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('MarkoPoloCurrentFreeGame') . ',"Balance":' . $Balance . ',"afterBalance":' . $slotSettings->GetBalance() . ',"totalWin":' . $totalWin . ',"winLines":[' . $winString . '],"bonusInfo":' . $scattersStr . ',"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
