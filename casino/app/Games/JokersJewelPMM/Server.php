            ...
            \DB::transaction(function() use ($request, $game)
            {
                try
                {
                    ...
                    if( $postData['slotEvent'] == 'doInit' ) 
                    {
                        ...
                        $fsInfo = '';
                        $slotSettings->SetGameData('JokersJewelPMMBonusWin', 0);
                        $slotSettings->SetGameData('JokersJewelPMMFreeGames', 0);
                        $slotSettings->SetGameData('JokersJewelPMMCurrentFreeGame', 0);
                        $slotSettings->SetGameData('JokersJewelPMMTotalWin', 0);
                        $slotSettings->SetGameData($slotSettings->slotId . 'FreeBalance', $slotSettings->GetBalance());
                        $slotSettings->SetGameData('JokersJewelPMMBonusState', 0);
                        $slotSettings->SetGameData('JokersJewelPMMBonusMpl', 0);
                        if( $lastEvent != 'NULL' ) 
                        {
                    ...
                    else if( $postData['slotEvent'] == 'gamble5GetUserCards' ) 
                    {
                        ...
                        $dealerCard = $slotSettings->GetGameData('JokersJewelPMMDealerCard');
                        $totalWin = $slotSettings->GetGameData('JokersJewelPMMTotalWin');
                        $gambleWin = 0;
                        ...
                        $slotSettings->SetGameData('JokersJewelPMMTotalWin', $totalWin);
                    ...
                    else if( $postData['slotEvent'] == 'gamble5GetDealerCard' ) 
                    {
                        ...
                        $slotSettings->SetGameData('JokersJewelPMMDealerCard', $tmpDc);
                    ...
                    {
                        if( $slotSettings->GetGameData('JokersJewelPMMCurrentFreeGame') < $slotSettings->GetGameData('JokersJewelPMMFreeGames') && $slotSettings->GetGameData('JokersJewelPMMFreeGames') > 0 ) 
                        {
                        ...
                        {
                            $slotSettings->SetGameData('JokersJewelPMMCurrentFreeGame', $slotSettings->GetGameData('JokersJewelPMMCurrentFreeGame') + 1);
                            $bonusMpl = $slotSettings->GetGameData('JokersJewelPMMBonusMpl');
                        }
                        $Balance = $slotSettings->GetBalance();
                        if( $postData['slotEvent'] != 'freespin' ) 
                        {
                        ...
                        if( $postData['slotEvent'] == 'freespin' ) 
                        {
                            $slotSettings->SetGameData('JokersJewelPMMBonusWin', $slotSettings->GetGameData('JokersJewelPMMBonusWin') + $totalWin);
                            $slotSettings->SetGameData('JokersJewelPMMTotalWin', $slotSettings->GetGameData('JokersJewelPMMTotalWin') + $totalWin);
                            $spinType = 's';
                            $Balance = $slotSettings->GetGameData('JokersJewelPMMFreeBalance');
                            if( $slotSettings->GetGameData('JokersJewelPMMFreeGames') <= $slotSettings->GetGameData('JokersJewelPMMCurrentFreeGame') && $slotSettings->GetGameData('JokersJewelPMMFreeGames') > 0 ) 
                            {
                                $spinType = 'c';
                                $winString .= ('&fs_total=' . $slotSettings->GetGameData('JokersJewelPMMFreeGames') . '&fsmul_total=' . $slotSettings->GetGameData('JokersJewelPMMBonusMpl') . '&fswin_total=' . $slotSettings->GetGameData('JokersJewelPMMBonusWin') . '&fsres_total=' . $slotSettings->GetGameData('JokersJewelPMMBonusWin') . '');
                            }
                            else
                            {
                                $winString .= ('&fsmul=' . $slotSettings->GetGameData('JokersJewelPMMBonusMpl') . '&fsmax=' . $slotSettings->GetGameData('JokersJewelPMMFreeGames') . '&fswin=' . $slotSettings->GetGameData('JokersJewelPMMTotalWin') . '&fs=' . $slotSettings->GetGameData('JokersJewelPMMCurrentFreeGame') . '&fsres=' . $slotSettings->GetGameData('JokersJewelPMMBonusWin'));
                            }
                        ...
                        else
                        {
                            ...
                            $slotSettings->SetGameData('JokersJewelPMMTotalWin', $totalWin);
                            $slotSettings->SetGameData('JokersJewelPMMBonusWin', $totalWin);
                        }
                        ...
                        $response = 'tw=' . $slotSettings->GetGameData('JokersJewelPMMBonusWin') . '&bstate=' . $slotSettings->GetGameData('JokersJewelPMMBonusState') . '&balance=' . $Balance . '&index=' . $postData['index'] . '&balance_cash=' . $Balance . '&balance_bonus=0.00' . $winString . '&na=' . $spinType . '&stime=' . floor(microtime(true) * 1000) . '&sa=' . $reels['reel1'][3] . ',' . $reels['reel2'][3] . ',' . $reels['reel3'][3] . ',' . $reels['reel4'][3] . ',' . $reels['reel5'][3] . '&sb=' . $reels['reel1'][-1] . ',' . $reels['reel2'][-1] . ',' . $reels['reel3'][-1] . ',' . $reels['reel4'][-1] . ',' . $reels['reel5'][-1] . '&sh=3&c=0.01&sver=5&counter=' . ((int)$postData['counter'] + 1) . '&l=25&s=' . $s . '&w=' . $totalWinRaw . '';
                        if( $slotSettings->GetGameData('JokersJewelPMMFreeGames') <= $slotSettings->GetGameData('JokersJewelPMMCurrentFreeGame') && $slotSettings->GetGameData('JokersJewelPMMFreeGames') > 0 ) 
                        {
                            $slotSettings->SetGameData('JokersJewelPMMTotalWin', 0);
                            $slotSettings->SetGameData('JokersJewelPMMBonusWin', 0);
                        }
                        $response_log = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{"BonusMpl":' . $slotSettings->GetGameData('JokersJewelPMMBonusMpl') . ',"lines":' . $postData['slotLines'] . ',"bet":' . $postData['slotBet'] . ',"totalFreeGames":' . $slotSettings->GetGameData('JokersJewelPMMFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('JokersJewelPMMCurrentFreeGame') . ',"Balance":' . $Balance . ',"afterBalance":' . $slotSettings->GetBalance() . ',"totalWin":' . $totalWin . ',"bonusWin":' . $slotSettings->GetGameData('JokersJewelPMMBonusWin') . ',"winLines":[],"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
