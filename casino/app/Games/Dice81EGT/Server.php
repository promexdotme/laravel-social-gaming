                    ...
                    try
                    {
                        ...
                        switch( $aid ) 
                        {
                            ...
                            case 'settings':
                                ...
                                $result_tmp[] = '{"complex":{"balance":' . $balanceInCents . ',"balanceRaw":' . round($balanceInCents * $slotSettings->CurrentDenom) . ',"paytableCoef":{"0":{"coef":[10,20],"multiplier":1},"1":{"coef":[10,40],"multiplier":1},"2":{"coef":[10,40],"multiplier":1},"3":{"coef":[10,40],"multiplier":1},"4":{"coef":[10,40],"multiplier":1},"5":{"coef":[40,400],"multiplier":1},"6":{"coef":[60,600],"multiplier":1},"7":{"coef":[160,1600],"multiplier":1},"8":{"coef":[],"multiplier":1}},"bets":[' . implode(',', $gameBets) . '],"jackpotMinBet":1,"lines":[5],"jackpot":true,"mainFakeReels":[[6,1,1,1,4,0,0,0,4,5,8,2,2,2,3,3,3,5,2,2,2,5,8,2,2,2,7,1,1,1],[7,0,0,0,8,2,2,2,3,3,3,7,5,1,1,1,0,0,0,2,2,2,4,8,6,5,2,2,2,5],[0,0,0,2,2,2,1,1,1,6,4,0,0,0,6,7,3,3,3,5,1,1,1,5,7,2,2,2,5,8],[0,0,0,2,2,2,1,1,1,6,4,0,0,0,6,7,3,3,3,5,1,1,1,5,7,2,2,2,5,8]],"jackpotMaxBet":100000,"denominations":[' . implode(',', $denoms) . ']},"gameIdentificationNumber":' . $postData['gameIdentificationNumber'] . ',"gameNumber":-1,"sessionKey":"41be9e65e0ff03a65e8c93576bf61130","msg":"success","messageId":"' . $postData['messageId'] . '","qName":"app.services.messages.response.GameResponse","command":"settings","eventTimestamp":' . time() . '}';
                                break;
                            case 'subscribe':
                                $hist = [
                                    78, 
                                ...
                                shuffle($hist);
                                $slotSettings->SetGameData('Dice81EGTCards', $hist);
                                $lastEvent = $slotSettings->GetHistory();
                                $slotSettings->SetGameData('Dice81EGTBonusWin', 0);
                                $slotSettings->SetGameData('Dice81EGTFreeGames', 0);
                                $slotSettings->SetGameData('Dice81EGTCurrentFreeGame', 0);
                                $slotSettings->SetGameData('Dice81EGTTotalWin', 0);
                                $slotSettings->SetGameData('Dice81EGTFreeBalance', 0);
                                if( $lastEvent != 'NULL' ) 
                                {
                                    ...
                                    $gtype = 1;
                                    if( $slotSettings->GetGameData('Dice81EGTCurrentFreeGame') < $slotSettings->GetGameData('Dice81EGTFreeGames') && $slotSettings->GetGameData('Dice81EGTFreeGames') > 0 ) 
                                    {
                                        $gtype = 2;
                                    }
                                }
                                ...
                                {
                                    $gtype = 1;
                                    $curReels = '' . rand(1, 8) . ',' . rand(0, 8) . ',' . rand(1, 8) . ',' . rand(1, 8) . ',' . rand(1, 8) . ',' . rand(1, 8) . ',' . rand(1, 8) . ',' . rand(1, 8) . ',' . rand(1, 8) . ',' . rand(1, 8) . ',' . rand(1, 8) . ',' . rand(1, 8) . ',' . rand(1, 8) . ',' . rand(1, 8) . ',' . rand(1, 8) . ',' . rand(1, 8) . ',' . rand(1, 8) . ',' . rand(1, 8) . ',' . rand(1, 8) . ',' . rand(1, 8) . ',' . rand(1, 8) . ',' . rand(1, 8) . ',' . rand(1, 8) . ',' . rand(1, 8) . ',' . rand(1, 8) . '';
                                    $lines = 10;
                                }
                            ...
                            case 'bet':
                                ...
                                for( $i = 0; $i <= 2000; $i++ ) 
                                {
                                    ...
                                    for( $j = 0; $j < count($slotSettings->SymbolGame); $j++ ) 
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            if( $wsym[0] > 0 && $wsym[1] > 0 && $wsym[2] > 0 ) 
                                            {
                                                ...
                                                {
                                                    $cWin = $tWin;
                                                    $tmpStringWin = '{"card":' . $csym . ',"len":3,"multipliersWinInfo":[{"count":' . $sMpl . ',"winPerCount":' . ($slotSettings->Paytable['SYM_' . $csym][3] * $betline * 100) . ',"multiplier":' . $wildsymmpl . '}],"count":' . $sMpl . ',"winPerCount":' . ($tWin0 * 100) . ',"multiplier":1,"winAmount":' . ($cWin * 100) . ',"cells":[' . implode(',', $cells) . ']}';
                                                }
                                            }
                                            if( $wsym[0] > 0 && $wsym[1] > 0 && $wsym[2] > 0 && $wsym[3] > 0 ) 
                                            {
                                                ...
                                                {
                                                    $cWin = $tWin;
                                                    $tmpStringWin = '{"card":' . $csym . ',"len":4,"multipliersWinInfo":[{"count":' . $sMpl . ',"winPerCount":' . ($slotSettings->Paytable['SYM_' . $csym][4] * $betline * 100) . ',"multiplier":' . $wildsymmpl . '}],"count":' . $sMpl . ',"winPerCount":' . ($tWin0 * 100) . ',"multiplier":1,"winAmount":' . ($cWin * 100) . ',"cells":[' . implode(',', $cells) . ']}';
                                                }
                                            }
                                            $totalWin += $cWin;
                                            $cWins[$j] = $cWin;
                                    ...
                                    if( $scattersWin > 0 ) 
                                    {
                                        ...
                                        $scattersStr = '{"scatterName":9,"cells":[' . implode(',', $scPos) . '],"winAmount":' . ($scattersWin * 100) . ',"freespins":0}';
                                    }
                                ...
                                $response = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{"slotLines":' . $lines . ',"slotBet":' . $betline . ',"totalFreeGames":' . $slotSettings->GetGameData('Dice81EGTFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('Dice81EGTCurrentFreeGame') . ',"Balance":' . $slotSettings->GetBalance() . ',"afterBalance":' . $slotSettings->GetBalance() . ',"bonusWin":' . $slotSettings->GetGameData('Dice81EGTBonusWin') . ',"totalWin":' . $totalWin . ',"winLines":[' . $winString . '],"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
                                $slotSettings->SaveLogReport($response, $allbet, $lines, $reportWin, $postData['slotEvent']);
                                $winstring = '';
                                $slotSettings->SetGameData('Dice81EGTTotalWin', $totalWin);
                                $slotSettings->SetGameData('Dice81EGTGambleStep', 5);
                                $hist = $slotSettings->GetGameData('Dice81EGTCards');
                                $curReels = '' . rand(1, 8) . ',' . $reels['reel1'][0] . ',' . $reels['reel1'][1] . ',' . $reels['reel1'][2] . ',' . rand(1, 8);
                                $curReels .= (',' . rand(1, 8) . ',' . $reels['reel2'][0] . ',' . $reels['reel2'][1] . ',' . $reels['reel2'][2] . ',' . rand(1, 8));
                                $curReels .= (',' . rand(1, 8) . ',' . $reels['reel3'][0] . ',' . $reels['reel3'][1] . ',' . $reels['reel3'][2] . ',' . rand(1, 8));
                                $curReels .= (',' . rand(1, 8) . ',' . $reels['reel4'][0] . ',' . $reels['reel4'][1] . ',' . $reels['reel4'][2] . ',' . rand(1, 8));
                                if( $jackRandom == 1 ) 
                                {
                                    $state = 'jackpot';
                                    $isJack = 'true';
                                    $slotSettings->SetGameData('Dice81EGTJackSteps', [
                                        0, 
                                        0, 
                                        0, 
                                        0
                                ...
                                $result_tmp[] = '{"complex":{"gambles":5,"reels":[' . $curReels . '],"combos":[' . $winString . '],"scatters":[' . $scattersStr . '],"freespinScatters":[],"expand":[],"specialExpand":[],"gambles":5,"freespins":0,"jackpot":' . $isJack . ',"gameCommand":"bet"},"state":"' . $state . '","winAmount":' . ($totalWin * 100) . ',"gameIdentificationNumber":' . $postData['gameIdentificationNumber'] . ',"gameNumber":"","balance":' . $balanceInCents . ',"sessionKey":"41be9e65e0ff03a65e8c93576bf61130","msg":"success","messageId":"' . $postData['messageId'] . '","qName":"app.services.messages.response.GameEventResponse","command":"bet","eventTimestamp":' . time() . '}';
                                ...
                                break;
                            case 'collect':
                                $result_tmp[] = '{"complex":{"gameCommand":"collect"},"state":"idle","winAmount":' . ($slotSettings->GetGameData('Dice81EGTTotalWin') * 100) . ',"gameIdentificationNumber":' . $postData['gameIdentificationNumber'] . ',"gameNumber":"","balance":' . $balanceInCents . ',"sessionKey":"41be9e65e0ff03a65e8c93576bf61130","msg":"success","messageId":"' . $postData['messageId'] . '","qName":"app.services.messages.response.GameEventResponse","command":"bet","eventTimestamp":' . time() . '}';
                                $slotSettings->SetGameData('Dice81EGTTotalWin', 0);
                                break;
                            case 'jackpot':
                                $jackStep = $slotSettings->GetGameData('Dice81EGTJackSteps');
                                $jackWinID = $slotSettings->GetGameData($slotSettings->slotId . 'JackWinID');
                                if( $jackStep[0] >= 3 || $jackStep[1] >= 3 || $jackStep[2] >= 3 || $jackStep[3] >= 3 || !$slotSettings->HasGameData('Dice81EGTJackSteps') ) 
                                {
                                    exit();
                                }
                                $winAmount = 0;
                                ...
                                $slotSettings->SetGameData('Dice81EGTJackSteps', $jackStep);
                                break;
                            case 'gamble':
                                $Balance = $slotSettings->GetBalance();
                                $isGambleWin = rand(1, $slotSettings->GetGambleSettings());
                                $dealerCard = '';
                                $totalWin = $slotSettings->GetGameData('Dice81EGTTotalWin');
                                $gambleWin = 0;
                                $statBet = $totalWin;
                                $slotSettings->SetGameData('Dice81EGTGambleStep', $slotSettings->GetGameData('Dice81EGTGambleStep') - 1);
                                ...
                                else
                                {
                                    ...
                                    $totalWin = 0;
                                    $slotSettings->SetGameData('Dice81EGTGambleStep', 0);
                                    if( $postData['bet']['color'] == '1' ) 
                                    {
                                        $tmpCards = [
                                            '1', 
