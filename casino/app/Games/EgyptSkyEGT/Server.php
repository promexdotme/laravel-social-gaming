                    ...
                    try
                    {
                        ...
                        switch( $aid ) 
                        {
                            ...
                            case 'settings':
                                ...
                                $result_tmp[] = '{"complex":{"balance":' . $balanceInCents . ',"balanceRaw":' . round($balanceInCents * $slotSettings->CurrentDenom) . ',"paytableCoef":{"0":{"coef":[5,20,100],"multiplier":1},"1":{"coef":[5,20,100],"multiplier":1},"2":{"coef":[5,20,100],"multiplier":1},"3":{"coef":[10,20,125],"multiplier":1},"4":{"coef":[15,50,200],"multiplier":1},"5":{"coef":[20,50,400],"multiplier":1},"6":{"coef":[20,100,500],"multiplier":1},"7":{"coef":[50,500,2000],"multiplier":1},"9":{"coef":[5,50,200],"multiplier":1}},"bets":[' . implode(',', $gameBets) . '],"jackpotMinBet":1,"jackpot":true,"jackpotMinBet":1,"jackpot":true,"mainFakeReels":[[5,2,4,0,0,9,1,1,7,2,3,0,4,1,2,4,0,5,3,2,0,6,9,4,0,2,2,4,0,3],[4,2,3,4,9,4,0,6,3,1,1,1,1,3,5,8,1,3,5,2,1,6,8,2,1,6,4,2,5,3],[1,6,9,5,1,1,5,7,3,2,8,7,3,2,5,0,0,4,6,8,0,4,6,1,6,0,0,0,5,2],[4,5,2,7,1,1,3,3,8,6,5,0,0,3,4,1,6,2,7,3,0,0,9,5,4,1,6,6,3,5],[5,2,6,4,1,3,1,7,1,7,2,0,4,2,4,0,6,3,3,2,1,6,2,4,0,0,9,2,4,1]],"jackpotMaxBet":100000,"denominations":[' . implode(',', $denoms) . ']},"gameIdentificationNumber":' . $postData['gameIdentificationNumber'] . ',"gameNumber":-1,"sessionKey":"41be9e65e0ff03a65e8c93576bf61130","msg":"success","messageId":"' . $postData['messageId'] . '","qName":"app.services.messages.response.GameResponse","command":"settings","eventTimestamp":' . time() . '}';
                                break;
                            case 'subscribe':
                                $hist = [
                                    78, 
                                ...
                                shuffle($hist);
                                $slotSettings->SetGameData('EgyptSkyEGTCards', $hist);
                                $lastEvent = $slotSettings->GetHistory();
                                $slotSettings->SetGameData('EgyptSkyEGTBonusWin', 0);
                                $slotSettings->SetGameData('EgyptSkyEGTFreeGames', 0);
                                $slotSettings->SetGameData('EgyptSkyEGTCurrentFreeGame', 0);
                                $slotSettings->SetGameData('EgyptSkyEGTTotalWin', 0);
                                $slotSettings->SetGameData('EgyptSkyEGTFreeBalance', 0);
                                ...
                                if( $lastEvent != 'NULL' ) 
                                {
                                    ...
                                    $slotSettings->SetGameData($slotSettings->slotId . 'Holds', $lastEvent->serverResponse->holdReels);
                                    $slotSettings->SetGameData('EgyptSkyEGTCurrentSeq', $lastEvent->serverResponse->curSeq);
                                    ...
                                    $gtype = 1;
                                    if( $slotSettings->GetGameData('EgyptSkyEGTCurrentFreeGame') < $slotSettings->GetGameData('EgyptSkyEGTFreeGames') && $slotSettings->GetGameData('EgyptSkyEGTFreeGames') > 0 ) 
                                    {
                                        $gtype = 2;
                                    }
                                }
                            ...
                            case 'bet':
                                ...
                                if( $postData['slotEvent'] != 'freespin' ) 
                                {
                                    ...
                                    $slotSettings->SetGameData('EgyptSkyEGTCurrentFreeGame', 0);
                                    $slotSettings->SetGameData('EgyptSkyEGTTotalWin', 0);
                                    $slotSettings->SetGameData('EgyptSkyEGTFreeBalance', sprintf('%01.2f', $slotSettings->GetBalance()) * 100);
                                    $slotSettings->SetGameData('EgyptSkyEGTHolds', []);
                                    $slotSettings->SetGameData($slotSettings->slotId . 'FirstSpin', '');
                                    $bonusMpl = 1;
                                }
                                else
                                {
                                    $slotSettings->SetGameData('EgyptSkyEGTCurrentFreeGame', $slotSettings->GetGameData('EgyptSkyEGTCurrentFreeGame') + 1);
                                ...
                                for( $i = 0; $i <= 2000; $i++ ) 
                                {
                                    ...
                                    {
                                        $curSeq = (array)$slotSettings->GetGameData('EgyptSkyEGTCurrentSeq');
                                        $curSeq['result'] = (array)$curSeq['result'];
                                        $curSeq['result'][$slotSettings->GetGameData('EgyptSkyEGTCurrentFreeGame')] = (array)$curSeq['result'][$slotSettings->GetGameData('EgyptSkyEGTCurrentFreeGame')];
                                        $curSeq['result'][$slotSettings->GetGameData('EgyptSkyEGTCurrentFreeGame')]['reels'] = (array)$curSeq['result'][$slotSettings->GetGameData('EgyptSkyEGTCurrentFreeGame')]['reels'];
                                        $reels = $curSeq['result'][$slotSettings->GetGameData('EgyptSkyEGTCurrentFreeGame')]['reels'];
                                    }
                                    if( $postData['slotEvent'] == 'freespin' ) 
                                    {
                                        for( $h = 0; $h < count($holds); $h++ ) 
                                        {
                                            $reels['reel' . ($holds[$h] + 1)][0] = '8';
                                            $reels['reel' . ($holds[$h] + 1)][1] = '8';
                                            $reels['reel' . ($holds[$h] + 1)][2] = '8';
                                            $reels['reel' . ($holds[$h] + 1)][3] = '8';
                                        }
                                    }
                                    $tmpReels = $reels;
                                    for( $r = 1; $r <= 5; $r++ ) 
                                    ...
                                    for( $r = 1; $r <= 5; $r++ ) 
                                    {
                                        for( $p = 0; $p <= 3; $p++ ) 
                                        {
                                            ...
                                            if( $postData['slotEvent'] == 'freespin' ) 
                                            {
                                                if( $reels['reel' . $r][$p] == '8' && !in_array($r - 1, $holdsReel) ) 
                                                {
                                                    $holdsNew[] = '' . ($r - 1) . ',0';
                                                    $holdsReel[] = $r - 1;
                                                }
                                            }
                                            else if( $reels['reel' . $r][$p] == '8' ) 
                                            {
                                                for( $pp = 0; $pp <= 3; $pp++ ) 
                                                {
                                                    if( $reels['reel' . $r][$pp] != '8' ) 
                                                    {
                                                        $holdsNew[] = '' . ($r - 1) . ',0';
                                                    }
                                                }
                                    ...
                                    if( $scattersWin > 0 ) 
                                    {
                                        ...
                                        if( $scattersCount >= 3 ) 
                                        {
                                            $sgwin = $slotSettings->slotFreeCount[$scattersCount];
                                        }
                                ...
                                if( $postData['slotEvent'] == 'freespin' ) 
                                {
                                    $slotSettings->SetGameData('EgyptSkyEGTBonusWin', $slotSettings->GetGameData('EgyptSkyEGTBonusWin') + $totalWin);
                                    $slotSettings->SetGameData('EgyptSkyEGTTotalWin', $slotSettings->GetGameData('EgyptSkyEGTTotalWin') + $totalWin);
                                    $balanceInCents = $slotSettings->GetGameData('EgyptSkyEGTFreeBalance');
                                    $slotSettings->SetGameData($slotSettings->slotId . 'Holds', $holdsReel);
                                }
                                else
                                {
                                    $slotSettings->SetGameData('EgyptSkyEGTTotalWin', $totalWin);
                                }
                                $fs = 0;
                                $curReels = '' . rand(0, 6) . ',' . $reels['reel1'][0] . ',' . $reels['reel1'][1] . ',' . $reels['reel1'][2] . ',' . $reels['reel1'][3] . ',' . rand(0, 6);
                                $curReels .= (',' . rand(0, 6) . ',' . $reels['reel2'][0] . ',' . $reels['reel2'][1] . ',' . $reels['reel2'][2] . ',' . $reels['reel2'][3] . ',' . rand(0, 6));
                                ...
                                if( $scattersCount >= 3 ) 
                                {
                                    if( $slotSettings->GetGameData('EgyptSkyEGTFreeGames') > 0 ) 
                                    {
                                        $slotSettings->SetGameData('EgyptSkyEGTBonusWin', $totalWin);
                                        $slotSettings->SetGameData('EgyptSkyEGTFreeGames', $slotSettings->GetGameData('EgyptSkyEGTFreeGames') + $slotSettings->slotFreeCount[$scattersCount]);
                                    }
                                    else
                                    {
                                        $slotSettings->SetGameData('EgyptSkyEGTFreeStartWin', $totalWin);
                                        $slotSettings->SetGameData('EgyptSkyEGTBonusWin', $totalWin);
                                        $slotSettings->SetGameData('EgyptSkyEGTFreeGames', $slotSettings->slotFreeCount[$scattersCount]);
                                    }
                                    $slotSettings->SetGameData($slotSettings->slotId . 'FirstSpin', ',"firstSpin":{"expand":[],"reels":[' . $curReels . '],"lines":[],"expand":[],"scatters":[' . $scattersStr . ']}');
                                    $fs = $slotSettings->GetGameData('EgyptSkyEGTFreeGames');
                                }
                                $winString = implode(',', $lineWins);
                                $jsSpin = '' . json_encode($reels) . '';
                                $jsJack = '' . json_encode($slotSettings->Jackpots) . '';
                                $response = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{"curSeq":' . json_encode($curSeq) . ',"slotLines":' . $lines . '' . $slotSettings->GetGameData($slotSettings->slotId . 'FirstSpin') . ',"slotBet":' . $betline . ',"holdReels": ' . json_encode($slotSettings->GetGameData($slotSettings->slotId . 'Holds')) . ',"totalFreeGames":' . $slotSettings->GetGameData('EgyptSkyEGTFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('EgyptSkyEGTCurrentFreeGame') . ',"Balance":' . $balanceInCents . ',"afterBalance":' . $balanceInCents . ',"bonusWin":' . $slotSettings->GetGameData('EgyptSkyEGTBonusWin') . ',"totalWin":' . $totalWin . ',"winLines":[' . $winString . '],"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
                                $slotSettings->SaveLogReport($response, $allbet, $lines, $reportWin, $postData['slotEvent']);
                                $winstring = '';
                                $slotSettings->SetGameData('EgyptSkyEGTGambleStep', 5);
                                $hist = $slotSettings->GetGameData('EgyptSkyEGTCards');
                                if( $jackRandom == 1 ) 
                                {
                                    $state = 'jackpot';
                                    $isJack = 'true';
                                    $slotSettings->SetGameData('EgyptSkyEGTJackSteps', [
                                        0, 
                                        0, 
                                        0, 
                                        0
                                ...
                                if( $postData['slotEvent'] == 'freespin' ) 
                                {
                                    $totalWin = $slotSettings->GetGameData('EgyptSkyEGTBonusWin');
                                    $state = 'freespin';
                                ...
                                $result_tmp[] = '{"complex":{"gambles":5,"reels":[' . $curReels . '],"lines":[' . $winString . '],"scatters":[' . $scattersStr . '],"freespinScatters":[' . $scatter . '],"holdReels": [' . implode(',', $slotSettings->GetGameData($slotSettings->slotId . 'Holds')) . '],"expand":[' . implode(',', $holdsNew) . '],"holdPositions": [],"specialExpand":[],"gambles":5,"freespins":' . $fs . ',"jackpot":' . $isJack . ',"gameCommand":"bet"},"state":"' . $state . '","winAmount":' . ($totalWin * 100) . ',"gameIdentificationNumber":' . $postData['gameIdentificationNumber'] . ',"gameNumber":"","balance":' . $balanceInCents . ',"sessionKey":"41be9e65e0ff03a65e8c93576bf61130","msg":"success","messageId":"' . $postData['messageId'] . '","qName":"app.services.messages.response.GameEventResponse","command":"bet","eventTimestamp":' . time() . '}';
                                ...
                                break;
                            case 'collect':
                                $result_tmp[] = '{"complex":{"gameCommand":"collect"},"state":"idle","winAmount":' . ($slotSettings->GetGameData('EgyptSkyEGTTotalWin') * 100) . ',"gameIdentificationNumber":' . $postData['gameIdentificationNumber'] . ',"gameNumber":"","balance":' . $balanceInCents . ',"sessionKey":"41be9e65e0ff03a65e8c93576bf61130","msg":"success","messageId":"' . $postData['messageId'] . '","qName":"app.services.messages.response.GameEventResponse","command":"bet","eventTimestamp":' . time() . '}';
                                $slotSettings->SetGameData('EgyptSkyEGTTotalWin', 0);
                                break;
                            case 'jackpot':
                                $jackStep = $slotSettings->GetGameData('EgyptSkyEGTJackSteps');
                                $jackWinID = $slotSettings->GetGameData($slotSettings->slotId . 'JackWinID');
                                if( $jackStep[0] >= 3 || $jackStep[1] >= 3 || $jackStep[2] >= 3 || $jackStep[3] >= 3 || !$slotSettings->HasGameData('EgyptSkyEGTJackSteps') ) 
                                {
                                    exit();
                                }
                                $winAmount = 0;
                                ...
                                $slotSettings->SetGameData('EgyptSkyEGTJackSteps', $jackStep);
                                break;
                            case 'gamble':
                                $Balance = $slotSettings->GetBalance();
                                $isGambleWin = rand(1, $slotSettings->GetGambleSettings());
                                $dealerCard = '';
                                $totalWin = $slotSettings->GetGameData('EgyptSkyEGTTotalWin');
                                $gambleWin = 0;
                                $statBet = $totalWin;
                                $slotSettings->SetGameData('EgyptSkyEGTGambleStep', $slotSettings->GetGameData('EgyptSkyEGTGambleStep') - 1);
                                ...
                                else
                                {
                                    ...
                                    $totalWin = 0;
                                    $slotSettings->SetGameData('EgyptSkyEGTGambleStep', 0);
                                    if( $postData['bet']['color'] == '1' ) 
                                    {
                                        $tmpCards = [
                                            '1', 
                                ...
                                $gtype = 1;
                                $gtype0 = 1;
                                if( $slotSettings->GetGameData('EgyptSkyEGTBonusStart') == 1 ) 
                                {
                                    $gtype0 = 2;
                                }
                                $result_tmp[] = '{"complex":{"gambles":' . $slotSettings->GetGameData('EgyptSkyEGTGambleStep') . ',"card":' . $dealerCard . ',"jackpot":false,"gameCommand":"gamble"},"state":"' . $gambleState . '","winAmount":' . ($totalWin * 100) . ',"gameIdentificationNumber":' . $postData['gameIdentificationNumber'] . ',"gameNumber":"","sessionKey":"88e2b82e6537db4a339e4e1b5ce462cd","msg":"success","messageId":"' . $postData['messageId'] . '","qName":"app.services.messages.response.GameEventResponse","command":"bet","eventTimestamp":' . time() . '}';
                                break;
                        }
