            ...
            function get_($request, $game)
            {
                \DB::transaction(function() use ($request, $game)
                {
                    try
                    {
                        ...
                        {
                            $result_tmp = [];
                            if( $slotSettings->GetGameData('GeishaStoryPTBonusStep') == 1 ) 
                            {
                                $WinArr = [
                                    1, 
                                    2, 
                                ...
                                shuffle($WinArr);
                                $slotSettings->SetGameData('GeishaStoryPTBonusOpt', $WinArr);
                                $curWin = $WinArr[$postData['bonusIndex']];
                                $slotSettings->SetGameData('GeishaStoryPTFreeMpl', $curWin);
                                ...
                                $slotSettings->SetGameData('GeishaStoryPTBonusStep', 2);
                            }
                            else if( $slotSettings->GetGameData('GeishaStoryPTBonusStep') == 0 ) 
                            {
                                $WinArr = [
                                    4, 
                                    6, 
                                ...
                                shuffle($WinArr);
                                $curWin = $WinArr[$postData['bonusIndex']];
                                $slotSettings->SetGameData('GeishaStoryPTFreeGames', $curWin);
                                $result_tmp[] = '3:::{"data":{"chosenBonusValue":' . $curWin . ',"bonusValues":[' . $WinArr[0] . ',' . $WinArr[1] . ',' . $WinArr[2] . ',' . $WinArr[3] . ',' . $WinArr[4] . ',' . $WinArr[5] . '],"windowId":"iaaL8l"},"ID":40471,"umid":913}';
                                $slotSettings->SetGameData('GeishaStoryPTBonusStep', 1);
                            }
                            $umid = 0;
                        }
                        if( isset($postData['spinType']) ) 
                        {
                            ...
                            if( $postData['spinType'] == 'regular' ) 
                            {
                                ...
                                $bonusMpl = 1;
                                $slotSettings->SetGameData('GeishaStoryPTBonusWin', 0);
                                $slotSettings->SetGameData('GeishaStoryPTFreeGames', 0);
                                $slotSettings->SetGameData('GeishaStoryPTCurrentFreeGame', 0);
                                $slotSettings->SetGameData('GeishaStoryPTTotalWin', 0);
                                $slotSettings->SetGameData('GeishaStoryPTFreeBalance', 0);
                                $slotSettings->SetGameData('GeishaStoryPTFreeStartWin', 0);
                                $slotSettings->SetGameData('GeishaStoryPTFreeMpl', $slotSettings->slotFreeMpl);
                            }
                            else if( $postData['spinType'] == 'free' ) 
                            {
                                $umid = '0';
                                $postData['slotEvent'] = 'freespin';
                                $slotSettings->SetGameData('GeishaStoryPTCurrentFreeGame', $slotSettings->GetGameData('GeishaStoryPTCurrentFreeGame') + 1);
                                $bonusMpl = $slotSettings->GetGameData('GeishaStoryPTFreeMpl');
                            }
                            $linesId = [];
                            $linesId[0] = [
                                2, 
                                    ...
                                    for( $j = 0; $j < count($slotSettings->SymbolGame); $j++ ) 
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            if( $s[0] == $csym || in_array($s[0], $wild) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":1,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('GeishaStoryPTBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":["none","none"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":2,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('GeishaStoryPTBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":3,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('GeishaStoryPTBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) && ($s[3] == $csym || in_array($s[3], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":4,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('GeishaStoryPTBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) && ($s[3] == $csym || in_array($s[3], $wild)) && ($s[4] == $csym || in_array($s[4], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":5,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('GeishaStoryPTBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":[' . ($linesId[$k][4] - 1) . ',"' . $s[4] . '"]}';
                                                }
                                            }
                                        }
                                    }
                            ...
                            if( $postData['slotEvent'] == 'freespin' ) 
                            {
                                $slotSettings->SetGameData('GeishaStoryPTBonusWin', $slotSettings->GetGameData('GeishaStoryPTBonusWin') + $totalWin);
                                $slotSettings->SetGameData('GeishaStoryPTTotalWin', $totalWin);
                            }
                            else
                            {
                                $slotSettings->SetGameData('GeishaStoryPTTotalWin', $totalWin);
                            ...
                            if( $scattersCount >= 2 ) 
                            {
                                if( $slotSettings->GetGameData('GeishaStoryPTFreeGames') > 0 ) 
                                {
                                    $slotSettings->SetGameData('GeishaStoryPTBonusWin', $totalWin);
                                    $slotSettings->SetGameData('GeishaStoryPTFreeGames', $slotSettings->GetGameData('GeishaStoryPTFreeGames') + $slotSettings->slotFreeCount);
                                }
                                else
                                {
                                    $slotSettings->SetGameData('GeishaStoryPTBonusStep', 0);
                                    $slotSettings->SetGameData('GeishaStoryPTFreeStartWin', $totalWin);
                                    $slotSettings->SetGameData('GeishaStoryPTBonusWin', $totalWin);
                                    $slotSettings->SetGameData('GeishaStoryPTFreeGames', $slotSettings->slotFreeCount);
                                }
                            }
                            $balanceInCents = sprintf('%01.2f', $slotSettings->GetBalance()) * 100;
                            ...
                            $response = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{"linesArr":[' . implode(',', $postData['lines']) . '],"slotLines":' . $lines . ',"slotBet":' . $betLine . ',"totalFreeGames":' . $slotSettings->GetGameData('GeishaStoryPTFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('GeishaStoryPTCurrentFreeGame') . ',"Balance":' . $slotSettings->GetBalance() . ',"afterBalance":' . $slotSettings->GetBalance() . ',"bonusWin":' . $slotSettings->GetGameData('GeishaStoryPTBonusWin') . ',"FreeMpl":' . $slotSettings->GetGameData('GeishaStoryPTFreeMpl') . ',"freeStartWin":' . $slotSettings->GetGameData('GeishaStoryPTFreeStartWin') . ',"totalWin":' . $totalWin . ',"winLines":[' . $winString . '],"bonusInfo":' . $scattersStr . ',"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
