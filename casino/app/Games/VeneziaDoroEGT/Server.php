                    ...
                    try
                    {
                        ...
                        switch( $aid ) 
                        {
                            ...
                            case 'settings':
                                ...
                                $result_tmp[] = '{"complex":{"balance":' . $balanceInCents . ',"balanceRaw":' . round($balanceInCents * $slotSettings->CurrentDenom) . ',"paytableCoef":{"0":{"coef":[5,10,100],"multiplier":1},"1":{"coef":[5,15,100],"multiplier":1},"2":{"coef":[10,15,100],"multiplier":1},"3":{"coef":[10,15,100],"multiplier":1},"4":{"coef":[10,20,200],"multiplier":1},"5":{"coef":[10,30,200],"multiplier":1},"6":{"coef":[15,35,300],"multiplier":1},"7":{"coef":[20,50,300],"multiplier":1},"8":{"coef":[30,100,800],"multiplier":1},"9":{"coef":[35,100,800],"multiplier":1},"10":{"coef":[50,100,1000],"multiplier":1},"12":{"coef":[5,10,50],"multiplier":1}},"bets":[' . implode(',', $gameBets) . '],"jackpotMinBet":1,"jackpot":true,"mainFakeReels":[[5,3,1,6,3,8,2,9,3,4,6,2,10,9,4,5,12,2,0,7],[11,0,1,10,5,3,7,0,6,5,2,12,8,0,9,5,3,12,4,7],[12,5,9,1,7,2,12,0,8,4,1,9,3,0,10,6,1,11,3,1],[4,0,2,11,7,2,9,4,8,1,10,0,6,5,12,3,8,1,9,5],[7,5,3,9,2,0,6,1,4,7,2,10,12,3,5,8,2,5,0,8]],"lines":[1, 3, 7, 15, 25],"jackpotMaxBet":100000,"denominations":[' . implode(',', $denoms) . ']},"gameIdentificationNumber":' . $postData['gameIdentificationNumber'] . ',"gameNumber":-1,"sessionKey":"41be9e65e0ff03a65e8c93576bf61130","msg":"success","messageId":"' . $postData['messageId'] . '","qName":"app.services.messages.response.GameResponse","command":"settings","eventTimestamp":' . time() . '}';
                                break;
                            case 'subscribe':
                                $hist = [
                                    78, 
                                ...
                                shuffle($hist);
                                $slotSettings->SetGameData('VeneziaDoroEGTCards', $hist);
                                $lastEvent = $slotSettings->GetHistory();
                                $slotSettings->SetGameData('VeneziaDoroEGTBonusWin', 0);
                                $slotSettings->SetGameData('VeneziaDoroEGTFreeGames', 0);
                                $slotSettings->SetGameData('VeneziaDoroEGTCurrentFreeGame', 0);
                                $slotSettings->SetGameData('VeneziaDoroEGTTotalWin', 0);
                                $slotSettings->SetGameData('VeneziaDoroEGTFreeBalance', 0);
                                if( $lastEvent != 'NULL' ) 
                                {
                                    ...
                                    $gtype = 1;
                                    if( $slotSettings->GetGameData('VeneziaDoroEGTCurrentFreeGame') < $slotSettings->GetGameData('VeneziaDoroEGTFreeGames') && $slotSettings->GetGameData('VeneziaDoroEGTFreeGames') > 0 ) 
                                    {
                                        $gtype = 2;
                                    }
                                }
                            ...
                            case 'choice':
                                ...
                                else if( $postData['bet']['choice'] == 3 ) 
                                {
                                    ...
                                    $slotSettings->slotFreeCount = 8;
                                }
                                else if( $postData['bet']['choice'] == 4 ) 
                                {
                                    $holds = [
                                        10, 
                                        15, 
                                ...
                                $slotSettings->SetGameData('VeneziaDoroEGTFreeGames', $slotSettings->slotFreeCount);
                                $slotSettings->SetGameData('VeneziaDoroEGTFreeMultipliers', $holds);
                                $result_tmp[] = '{"complex":{"freespins":' . $slotSettings->slotFreeCount . ',"gameCommand":"choice"},"state":"freespin","winAmount":' . ($slotSettings->GetGameData('VeneziaDoroEGTBonusWin') * 100) . ',"gameIdentificationNumber":' . $postData['gameIdentificationNumber'] . ',"gameNumber":1788218306705,"sessionKey":"57f186cf86ffb10508604b54143b2850","msg":"success","messageId":"' . $postData['messageId'] . '","qName":"app.services.messages.response.GameEventResponse","command":"bet","eventTimestamp":1566832774286}';
                                break;
                            case 'bet':
                                $linesId = [];
                                $linesId[0] = [
                                ...
                                if( $postData['slotEvent'] != 'freespin' ) 
                                {
                                    ...
                                    $slotSettings->SetGameData('VeneziaDoroEGTCurrentFreeGame', 0);
                                    $slotSettings->SetGameData('VeneziaDoroEGTTotalWin', 0);
                                    $slotSettings->SetGameData('VeneziaDoroEGTFreeBalance', sprintf('%01.2f', $slotSettings->GetBalance()) * 100);
                                    $slotSettings->SetGameData('VeneziaDoroEGTMultiplier', 1);
                                    $bonusMpl = 1;
                                }
                                else
                                {
                                    $slotSettings->SetGameData('VeneziaDoroEGTCurrentFreeGame', $slotSettings->GetGameData('VeneziaDoroEGTCurrentFreeGame') + 1);
                                    $bonusMpl = $slotSettings->GetGameData('VeneziaDoroEGTMultiplier');
                                }
                                    ...
                                    for( $j = 0; $j < count($slotSettings->SymbolGame); $j++ ) 
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            for( $r = 1; $r <= 5; $r++ ) 
                                            {
                                                ...
                                                for( $s = 0; $s <= 2; $s++ ) 
                                                {
                                                    if( !in_array($s, $waysRow['lines' . $lines][$r - 1]) ) 
                                                    {
                                                    }
                                                    else
                                                    {
                                                        ...
                                                        if( $reels['reel' . $r][$s] == $wild ) 
                                                        {
                                                            ...
                                                            if( $postData['slotEvent'] == 'freespin' ) 
                                                            {
                                                                $mpl = $slotSettings->GetGameData('VeneziaDoroEGTFreeMultipliers');
                                                                shuffle($mpl);
                                                                if( $wildsymcnt >= 1 ) 
                                                                {
                                                                    $wildsymmpl = $mpl[0];
                                            ...
                                            if( $wsym[0] > 0 && $wsym[1] > 0 && $wsym[2] > 0 ) 
                                            {
                                                ...
                                                $tWin = $slotSettings->Paytable['SYM_' . $csym][3] * $betline * $sMpl * $wildsymmpl;
                                                $tWin0 = $slotSettings->Paytable['SYM_' . $csym][3] * $betline;
                                                if( $cWin < $tWin ) 
                                                {
                                                    $cWin = $tWin;
                                                    $tmpStringWin = '{"card":' . $csym . ',"len":3,"count":' . $sMpl . ',"winPerCount":' . ($tWin0 * 100) . ',"multiplier":' . $wildsymmpl . ',"winAmount":' . ($cWin * 100) . ',"cells":[' . implode(',', $cells) . ']}';
                                                }
                                            }
                                            if( $wsym[0] > 0 && $wsym[1] > 0 && $wsym[2] > 0 && $wsym[3] > 0 ) 
                                            {
                                                ...
                                                $tWin = $slotSettings->Paytable['SYM_' . $csym][4] * $betline * $sMpl * $wildsymmpl;
                                                $tWin0 = $slotSettings->Paytable['SYM_' . $csym][4] * $betline;
                                                if( $cWin < $tWin ) 
                                                {
                                                    $cWin = $tWin;
                                                    $tmpStringWin = '{"card":' . $csym . ',"len":4,"count":' . $sMpl . ',"winPerCount":' . ($tWin0 * 100) . ',"multiplier":' . $wildsymmpl . ',"winAmount":' . ($cWin * 100) . ',"cells":[' . implode(',', $cells) . ']}';
                                                }
                                            }
                                            if( $wsym[0] > 0 && $wsym[1] > 0 && $wsym[2] > 0 && $wsym[3] > 0 && $wsym[4] > 0 ) 
                                            {
                                                ...
                                                $tWin = $slotSettings->Paytable['SYM_' . $csym][5] * $betline * $sMpl * $wildsymmpl;
                                                $tWin0 = $slotSettings->Paytable['SYM_' . $csym][5] * $betline;
                                                if( $cWin < $tWin ) 
                                                {
                                                    $cWin = $tWin;
                                                    $tmpStringWin = '{"card":' . $csym . ',"len":5,"count":' . $sMpl . ',"winPerCount":' . ($tWin0 * 100) . ',"multiplier":' . $wildsymmpl . ',"winAmount":' . ($cWin * 100) . ',"cells":[' . implode(',', $cells) . ']}';
                                                }
                                            }
                                            $totalWin += $cWin;
                                            $cWins[$j] = $cWin;
                                ...
                                if( $postData['slotEvent'] == 'freespin' ) 
                                {
                                    $slotSettings->SetGameData('VeneziaDoroEGTBonusWin', $slotSettings->GetGameData('VeneziaDoroEGTBonusWin') + $totalWin);
                                    $slotSettings->SetGameData('VeneziaDoroEGTTotalWin', $slotSettings->GetGameData('VeneziaDoroEGTTotalWin') + $totalWin);
                                    $balanceInCents = $slotSettings->GetGameData('VeneziaDoroEGTFreeBalance');
                                }
                                else
                                {
                                    $slotSettings->SetGameData('VeneziaDoroEGTTotalWin', $totalWin);
                                }
                                $fs = 0;
                                if( $scattersCount >= 3 ) 
                                {
                                    if( $slotSettings->GetGameData('VeneziaDoroEGTFreeGames') > 0 ) 
                                    {
                                        $slotSettings->SetGameData('VeneziaDoroEGTFreeGames', $slotSettings->GetGameData('VeneziaDoroEGTFreeGames') + $slotSettings->slotFreeCount);
                                    }
                                    else
                                    {
                                        $slotSettings->SetGameData('VeneziaDoroEGTFreeStartWin', $totalWin);
                                        $slotSettings->SetGameData('VeneziaDoroEGTBonusWin', $totalWin);
                                        $slotSettings->SetGameData('VeneziaDoroEGTFreeGames', $slotSettings->slotFreeCount);
                                    }
                                    $fs = $slotSettings->GetGameData('VeneziaDoroEGTFreeGames');
                                }
                                $curReels = '' . rand(0, 6) . ',' . $reels['reel1'][0] . ',' . $reels['reel1'][1] . ',' . $reels['reel1'][2] . ',' . rand(0, 6);
                                $curReels .= (',' . rand(0, 6) . ',' . $reels['reel2'][0] . ',' . $reels['reel2'][1] . ',' . $reels['reel2'][2] . ',' . rand(0, 6));
                                $curReels .= (',' . rand(0, 6) . ',' . $reels['reel3'][0] . ',' . $reels['reel3'][1] . ',' . $reels['reel3'][2] . ',' . rand(0, 6));
                                ...
                                $response = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{"slotLines":' . $lines . '' . $lines . '' . $slotSettings->GetGameData($slotSettings->slotId . 'FirstSpin') . ',"slotBet":' . $betline . ',"totalFreeGames":' . $slotSettings->GetGameData('VeneziaDoroEGTFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('VeneziaDoroEGTCurrentFreeGame') . ',"Balance":' . $balanceInCents . ',"afterBalance":' . $balanceInCents . ',"bonusWin":' . $slotSettings->GetGameData('VeneziaDoroEGTBonusWin') . ',"totalWin":' . $totalWin . ',"winLines":[' . $winString . '],"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
                                $slotSettings->SaveLogReport($response, $allbet, $lines, $reportWin, $postData['slotEvent']);
                                $winstring = '';
                                $slotSettings->SetGameData('VeneziaDoroEGTGambleStep', 5);
                                $hist = $slotSettings->GetGameData('VeneziaDoroEGTCards');
                                if( $jackRandom == 1 ) 
                                {
                                    $state = 'jackpot';
                                    $isJack = 'true';
                                    $slotSettings->SetGameData('VeneziaDoroEGTJackSteps', [
                                        0, 
                                        0, 
                                        0, 
                                        0
                                ...
                                if( $postData['slotEvent'] == 'freespin' ) 
                                {
                                    $totalWin = $slotSettings->GetGameData('VeneziaDoroEGTBonusWin');
                                    $state = 'freespin';
                                ...
                                $result_tmp[] = '{"complex":{"gambles":5,"reels":[' . $curReels . '],"combos":[' . $winString . '],"scatters":[' . $scattersStr . '],"freespinScatters":[' . $scatter . '],"expand":[],"additional": [],"choices": 0,"specialExpand":[],"gambles":5,"freespins":' . $fs . ',"jackpot":' . $isJack . ',"gameCommand":"bet"},"state":"' . $state . '","winAmount":' . ($totalWin * 100) . ',"gameIdentificationNumber":' . $postData['gameIdentificationNumber'] . ',"gameNumber":"","balance":' . $balanceInCents . ',"sessionKey":"41be9e65e0ff03a65e8c93576bf61130","msg":"success","messageId":"' . $postData['messageId'] . '","qName":"app.services.messages.response.GameEventResponse","command":"bet","eventTimestamp":' . time() . '}';
                                ...
                                break;
                            case 'collect':
                                $result_tmp[] = '{"complex":{"gameCommand":"collect"},"state":"idle","winAmount":' . ($slotSettings->GetGameData('VeneziaDoroEGTTotalWin') * 100) . ',"gameIdentificationNumber":' . $postData['gameIdentificationNumber'] . ',"gameNumber":"","balance":' . $balanceInCents . ',"sessionKey":"41be9e65e0ff03a65e8c93576bf61130","msg":"success","messageId":"' . $postData['messageId'] . '","qName":"app.services.messages.response.GameEventResponse","command":"bet","eventTimestamp":' . time() . '}';
                                $slotSettings->SetGameData('VeneziaDoroEGTTotalWin', 0);
                                break;
                            case 'jackpot':
                                $jackStep = $slotSettings->GetGameData('VeneziaDoroEGTJackSteps');
                                $jackWinID = $slotSettings->GetGameData($slotSettings->slotId . 'JackWinID');
                                if( $jackStep[0] >= 3 || $jackStep[1] >= 3 || $jackStep[2] >= 3 || $jackStep[3] >= 3 || !$slotSettings->HasGameData('VeneziaDoroEGTJackSteps') ) 
                                {
                                    exit();
                                }
                                $winAmount = 0;
                                ...
                                $slotSettings->SetGameData('VeneziaDoroEGTJackSteps', $jackStep);
                                break;
                            case 'gamble':
                                $Balance = $slotSettings->GetBalance();
                                $isGambleWin = rand(1, $slotSettings->GetGambleSettings());
                                $dealerCard = '';
                                $totalWin = $slotSettings->GetGameData('VeneziaDoroEGTTotalWin');
                                $gambleWin = 0;
                                $statBet = $totalWin;
                                $slotSettings->SetGameData('VeneziaDoroEGTGambleStep', $slotSettings->GetGameData('VeneziaDoroEGTGambleStep') - 1);
                                ...
                                else
                                {
                                    ...
                                    $totalWin = 0;
                                    $slotSettings->SetGameData('VeneziaDoroEGTGambleStep', 0);
                                    if( $postData['bet']['color'] == '1' ) 
                                    {
                                        $tmpCards = [
                                            '1', 
                                ...
                                $gtype = 1;
                                $gtype0 = 1;
                                if( $slotSettings->GetGameData('VeneziaDoroEGTBonusStart') == 1 ) 
                                {
                                    $gtype0 = 2;
                                }
                                $result_tmp[] = '{"complex":{"gambles":' . $slotSettings->GetGameData('VeneziaDoroEGTGambleStep') . ',"card":' . $dealerCard . ',"jackpot":false,"gameCommand":"gamble"},"state":"' . $gambleState . '","winAmount":' . ($totalWin * 100) . ',"gameIdentificationNumber":' . $postData['gameIdentificationNumber'] . ',"gameNumber":"","sessionKey":"88e2b82e6537db4a339e4e1b5ce462cd","msg":"success","messageId":"' . $postData['messageId'] . '","qName":"app.services.messages.response.GameEventResponse","command":"bet","eventTimestamp":' . time() . '}';
                                break;
                        }
