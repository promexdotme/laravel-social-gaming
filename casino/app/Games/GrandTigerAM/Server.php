                    ...
                    switch( $gameData['slotEvent'] ) 
                    {
                        ...
                        case 'A/u25':
                            ...
                            if( $lastEvent != 'NULL' ) 
                            {
                                ...
                                $slotSettings->SetGameData('GrandTigerAMLines', $curLines);
                                $freeMpl = '11';
                                $slotSettings->SetGameData('GrandTigerAMBonusWin', $lastEvent->serverResponse->bonusWin);
                                $slotSettings->SetGameData('GrandTigerAMFreeGames', $lastEvent->serverResponse->totalFreeGames);
                                $slotSettings->SetGameData('GrandTigerAMCurrentFreeGame', $lastEvent->serverResponse->currentFreeGames);
                                $slotSettings->SetGameData('GrandTigerAMTotalWin', 0);
                                $slotSettings->SetGameData('GrandTigerAMFreeBalance', 0);
                                $slotSettings->SetGameData('GrandTigerAMFreeStartWin', 0);
                                $tFree = dechex($slotSettings->GetGameData('GrandTigerAMFreeGames'));
                                $cFree = dechex($slotSettings->GetGameData('GrandTigerAMFreeGames') - $slotSettings->GetGameData('GrandTigerAMCurrentFreeGame'));
                                $freeInfo = strlen($tFree) . $tFree . strlen($cFree) . $cFree;
                                $stateWin = $slotSettings->HexFormat($slotSettings->GetGameData('GrandTigerAMBonusWin') * $floatBet);
                                if( $slotSettings->GetGameData('GrandTigerAMCurrentFreeGame') < $slotSettings->GetGameData('GrandTigerAMFreeGames') && $slotSettings->GetGameData('GrandTigerAMFreeGames') > 0 ) 
                                {
                                    $slotState = '6';
                            ...
                            {
                                $slotSettings->SetGameData('GrandTigerAMLines', $fixedLinesFormated);
                                $slotState = '4';
                            ...
                            break;
                        case 'A/u250':
                            $fixedLinesFormated = $slotSettings->GetGameData('GrandTigerAMLines');
                            $balanceFormated = $slotSettings->HexFormat(round($slotSettings->GetBalance() * $floatBet));
                            $lastEvent = $slotSettings->GetHistory();
                            if( $lastEvent != 'NULL' ) 
                            {
                        ...
                        case 'A/u251':
                            if( $postData['spinType'] == 'regular' && $slotSettings->GetGameData($slotSettings->slotId . 'FreeGames') <= $slotSettings->GetGameData($slotSettings->slotId . 'CurrentFreeGame') ) 
                            {
                                ...
                                $bonusMpl = 1;
                                $slotSettings->SetGameData('GrandTigerAMBonusWin', 0);
                                $slotSettings->SetGameData('GrandTigerAMFreeGames', 0);
                                $slotSettings->SetGameData('GrandTigerAMCurrentFreeGame', 0);
                                $slotSettings->SetGameData('GrandTigerAMTotalWin', 0);
                                $slotSettings->SetGameData('GrandTigerAMFreeBalance', 0);
                                $slotSettings->SetGameData('GrandTigerAMFreeStartWin', 0);
                            }
                            if( $slotSettings->GetGameData($slotSettings->slotId . 'CurrentFreeGame') < $slotSettings->GetGameData($slotSettings->slotId . 'FreeGames') ) 
                            {
                                ...
                                $slotSettings->SetGameData('GrandTigerAMCurrentFreeGame', $slotSettings->GetGameData('GrandTigerAMCurrentFreeGame') + 1);
                            ...
                            if( $postData['slotEvent'] == 'freespin' && $slotSettings->GetGameData('GrandTigerAMFreeGames') <= $slotSettings->GetGameData('GrandTigerAMCurrentFreeGame') && $winType != 'bonus' && $slotSettings->GetGameData('GrandTigerAMBonusWin') + $totalWin > 0 ) 
                            {
                                $slotSettings->SetBalance($slotSettings->GetGameData('GrandTigerAMBonusWin') + $totalWin);
                            }
                            ...
                            if( $postData['slotEvent'] == 'freespin' ) 
                            {
                                $slotSettings->SetGameData('GrandTigerAMBonusWin', $slotSettings->GetGameData('GrandTigerAMBonusWin') + $totalWin);
                                $slotSettings->SetGameData('GrandTigerAMTotalWin', $totalWin);
                            }
                            else
                            {
                                $slotSettings->SetGameData('GrandTigerAMTotalWin', $totalWin);
                            ...
                            if( $scattersCount >= 3 ) 
                            {
                                ...
                                if( $slotSettings->GetGameData('GrandTigerAMFreeGames') > 0 ) 
                                {
                                    $slotSettings->SetGameData('GrandTigerAMFreeGames', $slotSettings->GetGameData('GrandTigerAMFreeGames') + $slotSettings->slotFreeCount[$scattersCount]);
                                }
                                else
                                {
                                    $slotSettings->SetGameData('GrandTigerAMFreeStartWin', $totalWin);
                                    $slotSettings->SetGameData('GrandTigerAMBonusWin', $totalWin);
                                    $slotSettings->SetGameData('GrandTigerAMFreeGames', $slotSettings->slotFreeCount[$scattersCount]);
                                }
                            }
                            $reels = $reelsTmp;
                            ...
                            $response_log = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{"symDouble":' . $symDouble . ',"slotLines":' . $lines . ',"slotBet":' . $betCnt . ',"totalFreeGames":' . $slotSettings->GetGameData('GrandTigerAMFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('GrandTigerAMCurrentFreeGame') . ',"Balance":' . $slotSettings->GetBalance() . ',"afterBalance":' . $slotSettings->GetBalance() . ',"bonusWin":' . $slotSettings->GetGameData('GrandTigerAMBonusWin') . ',"freeStartWin":' . $slotSettings->GetGameData('GrandTigerAMFreeStartWin') . ',"totalWin":' . $totalWin . ',"winLines":[' . $winString . '],"bonusInfo":' . $scattersStr . ',"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
                            ...
                            if( $postData['slotEvent'] == 'freespin' ) 
                            {
                                ...
                                $cFree = dechex($slotSettings->GetGameData('GrandTigerAMFreeGames') - $slotSettings->GetGameData('GrandTigerAMCurrentFreeGame'));
                                $gameState = '06';
                                if( $slotSettings->GetGameData('GrandTigerAMFreeGames') <= $slotSettings->GetGameData('GrandTigerAMCurrentFreeGame') ) 
                                {
                                    $gameState = '0c';
                                }
                                if( $scattersCount >= 3 ) 
                                ...
                                $totalWin = $slotSettings->GetGameData('GrandTigerAMBonusWin');
                                $bonusMpl = $slotSettings->slotFreeMpl;
                            }
                            else
                            {
                            ...
                            $balanceFormated = $slotSettings->HexFormat(round($slotSettings->GetBalance() * $floatBet));
                            $response = '1' . $gameState . '010' . $balanceFormated . $slotSettings->HexFormat(round($totalWin * 100)) . $reelSate . $bet_h . $ln_h . $freeInfo . $freeWinState . $slotSettings->HexFormat($bonusMpl) . '1010' . $reelSate . '0' . $symCountAll . $winLinesFormated . implode('', $slotSettings->GetGameData($slotSettings->slotId . 'Cards')) . '01' . implode('', $wildsFormated) . '#' . $scattersCount;
                            $response .= ('_' . json_encode($reels));
                            $slotSettings->SetGameData('GrandTigerAMDoubleAnswer', $reelSate . $bet_h . $ln_h . $freeInfo . $freeWinState . $slotSettings->HexFormat($bonusMpl) . '1010' . $reelSate . '0' . $symCountAll . $winLinesFormated);
                            $slotSettings->SetGameData('GrandTigerAMDoubleBalance', $balanceFormated);
                            $slotSettings->SetGameData('GrandTigerAMDoubleWin', $totalWin);
                            if( $postData['slotEvent'] == 'freespin' ) 
                            {
                            ...
                            $slotSettings->SetGameData('GrandTigerAMCollectP0', $response_collect0);
                            $gameState = '04';
                            $balanceFormated = $slotSettings->HexFormat(round($slotSettings->GetBalance() * $floatBet));
                            ...
                            $slotSettings->SetGameData('GrandTigerAMCollect', $response_collect);
                            break;
                        case 'A/u254':
                            $slotSettings->SetGameData($slotSettings->slotId . 'TotalWin', 0);
                            $response = $slotSettings->GetGameData('GrandTigerAMCollect');
                            break;
                        case 'A/u257':
                            $doubleWin = rand(1, 2);
                            $winall = $slotSettings->GetGameData('GrandTigerAMDoubleWin');
                            $dbet = $winall;
                            $daction = $tmpPar[1];
                            ...
                            $response = '107010' . $slotSettings->GetGameData('GrandTigerAMDoubleBalance') . strlen($winall_h) . $winall_h . $slotSettings->GetGameData('GrandTigerAMDoubleAnswer') . implode('', $slotSettings->GetGameData($slotSettings->slotId . 'Cards'));
                            $slotSettings->SetGameData('GrandTigerAMDoubleWin', $winall);
                            $slotSettings->SetGameData('GrandTigerAMTotalWin', $winall);
                            $balanceFormated = $slotSettings->HexFormat(round($slotSettings->GetBalance() * $floatBet));
                            $response_collect = '104010' . $balanceFormated . strlen($winall_h) . $winall_h . $slotSettings->GetGameData('GrandTigerAMCollectP0');
                            $slotSettings->SetGameData('GrandTigerAMCollect', $response_collect);
                        ...
                        case 'A/u258':
                            ...
                            $slotSettings->SetGameData('GrandTigerAMDoubleBalance', $rtnBalance);
                            $winall = sprintf('%01.2f', $winall) * $floatBet;
                            $winall_h1 = str_replace('.', '', $winall . '');
                            $winall_h = dechex($winall_h1);
                            $doubleCards = '26280b2714161d0c';
                            $response = '108010' . $slotSettings->GetGameData('GrandTigerAMDoubleBalance') . strlen($winall_h) . $winall_h . $slotSettings->GetGameData('GrandTigerAMDoubleAnswer') . implode('', $slotSettings->GetGameData($slotSettings->slotId . 'Cards'));
                            break;
                    }
