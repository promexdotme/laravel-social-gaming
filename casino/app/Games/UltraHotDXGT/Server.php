                ...
                \DB::transaction(function() use ($request, $game)
                {
                    try
                    {
                        ...
                        else if( $postData['slotEvent'] == 'gamble5GetUserCards' ) 
                        {
                            ...
                            $dealerCard = $slotSettings->GetGameData('UltraHotDXGTDealerCard');
                            $totalWin = $slotSettings->GetGameData('UltraHotDXGTTotalWin');
                            $gambleWin = 0;
                            ...
                            $slotSettings->SetGameData('UltraHotDXGTTotalWin', $totalWin);
                        ...
                        else if( $postData['slotEvent'] == 'gamble5GetDealerCard' ) 
                        {
                            ...
                            $slotSettings->SetGameData('UltraHotDXGTDealerCard', $tmpDc);
                        ...
                        else if( $postData['slotEvent'] == 'bet' || $postData['slotEvent'] == 'freespin' ) 
                        {
                            ...
                            if( $postData['slotEvent'] != 'freespin' ) 
                            {
                                ...
                                $bonusMpl = 1;
                                $slotSettings->SetGameData('UltraHotDXGTBonusWin', 0);
                                $slotSettings->SetGameData('UltraHotDXGTFreeGames', 0);
                                $slotSettings->SetGameData('UltraHotDXGTCurrentFreeGame', 0);
                                $slotSettings->SetGameData('UltraHotDXGTTotalWin', 0);
                                $slotSettings->SetGameData('UltraHotDXGTFreeBalance', 0);
                            }
                            else
                            {
                                $slotSettings->SetGameData('UltraHotDXGTCurrentFreeGame', $slotSettings->GetGameData('UltraHotDXGTCurrentFreeGame') + 1);
                                    ...
                                    for( $j = 0; $j < count($slotSettings->SymbolGame); $j++ ) 
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            if( $s[0] == $csym || in_array($s[0], $wild) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":1,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('UltraHotDXGTBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":["none","none"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":2,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('UltraHotDXGTBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            $s[0] = $reels['reel1'][$linesId[$k][0] - 1];
                                            $s[1] = $reels['reel2'][$linesId[$k][1] - 1];
                                            ...
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":3,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('UltraHotDXGTBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                        }
                                    }
                            ...
                            if( $postData['slotEvent'] == 'freespin' && $slotSettings->GetGameData('UltraHotDXGTFreeGames') <= $slotSettings->GetGameData('UltraHotDXGTCurrentFreeGame') && $winType != 'bonus' && $slotSettings->GetGameData('UltraHotDXGTTotalWin') + $totalWin > 0 ) 
                            {
                                $slotSettings->SetBalance($slotSettings->GetGameData('UltraHotDXGTTotalWin') + $totalWin);
                            }
                            ...
                            if( $postData['slotEvent'] == 'freespin' ) 
                            {
                                $slotSettings->SetGameData('UltraHotDXGTBonusWin', $slotSettings->GetGameData('UltraHotDXGTBonusWin') + $totalWin);
                                $slotSettings->SetGameData('UltraHotDXGTTotalWin', $slotSettings->GetGameData('UltraHotDXGTTotalWin') + $totalWin);
                                $totalWin = $slotSettings->GetGameData('UltraHotDXGTBonusWin');
                                $Balance = $slotSettings->GetGameData('UltraHotDXGTFreeBalance');
                            }
                            else
                            {
                                $slotSettings->SetGameData('UltraHotDXGTTotalWin', $totalWin);
                            ...
                            if( $scattersCount >= 3 ) 
                            {
                                if( $slotSettings->GetGameData('UltraHotDXGTFreeGames') > 0 ) 
                                {
                                    $slotSettings->SetGameData('UltraHotDXGTFreeBalance', $Balance);
                                    $slotSettings->SetGameData('UltraHotDXGTBonusWin', $totalWin);
                                    $slotSettings->SetGameData('UltraHotDXGTFreeGames', $slotSettings->GetGameData('UltraHotDXGTFreeGames') + $slotSettings->slotFreeCount);
                                }
                                else
                                {
                                    $slotSettings->SetGameData('UltraHotDXGTFreeBalance', $Balance);
                                    $slotSettings->SetGameData('UltraHotDXGTBonusWin', $totalWin);
                                    $slotSettings->SetGameData('UltraHotDXGTFreeGames', $slotSettings->slotFreeCount);
                                }
                            }
                            $X2Mode = 'false';
                            ...
                            $response = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{"slotLines":' . $postData['slotLines'] . ',"slotBet":' . $postData['slotBet'] . ',"X2":' . $X2Mode . ',"totalFreeGames":' . $slotSettings->GetGameData('UltraHotDXGTFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('UltraHotDXGTCurrentFreeGame') . ',"Balance":' . $Balance . ',"afterBalance":' . $slotSettings->GetBalance() . ',"totalWin":' . $totalWin . ',"winLines":[' . $winString . '],"bonusInfo":' . $scattersStr . ',"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
