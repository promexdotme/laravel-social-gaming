                    ...
                    switch( $gameData['slotEvent'] ) 
                    {
                        ...
                        case 'A/u25':
                            ...
                            if( $lastEvent != 'NULL' ) 
                            {
                                ...
                                $slotSettings->SetGameData('BellsOnFireRomboAMLines', $curLines);
                                $freeMpl = '11';
                                $slotSettings->SetGameData('BellsOnFireRomboAMBonusWin', $lastEvent->serverResponse->bonusWin);
                                $slotSettings->SetGameData('BellsOnFireRomboAMFreeGames', $lastEvent->serverResponse->totalFreeGames);
                                $slotSettings->SetGameData('BellsOnFireRomboAMCurrentFreeGame', $lastEvent->serverResponse->currentFreeGames);
                                $slotSettings->SetGameData('BellsOnFireRomboAMTotalWin', 0);
                                $slotSettings->SetGameData('BellsOnFireRomboAMFreeBalance', 0);
                                $slotSettings->SetGameData('BellsOnFireRomboAMFreeStartWin', 0);
                                $tFree = dechex($slotSettings->GetGameData('BellsOnFireRomboAMFreeGames'));
                                $cFree = dechex($slotSettings->GetGameData('BellsOnFireRomboAMFreeGames') - $slotSettings->GetGameData('BellsOnFireRomboAMCurrentFreeGame'));
                                $freeInfo = strlen($tFree) . $tFree . strlen($cFree) . $cFree;
                                $stateWin = $slotSettings->HexFormat($slotSettings->GetGameData('BellsOnFireRomboAMBonusWin') * $floatBet);
                                if( $slotSettings->GetGameData('BellsOnFireRomboAMCurrentFreeGame') < $slotSettings->GetGameData('BellsOnFireRomboAMFreeGames') && $slotSettings->GetGameData('BellsOnFireRomboAMFreeGames') > 0 ) 
                                {
                                    $slotState = '6';
                            ...
                            {
                                $slotSettings->SetGameData('BellsOnFireRomboAMLines', $fixedLinesFormated);
                                $slotState = '4';
                            ...
                            break;
                        case 'A/u250':
                            $fixedLinesFormated = $slotSettings->GetGameData('BellsOnFireRomboAMLines');
                            $balanceFormated = $slotSettings->HexFormat(round($slotSettings->GetBalance() * $floatBet));
                            $lastEvent = $slotSettings->GetHistory();
                            if( $lastEvent != 'NULL' ) 
                            {
                        ...
                        case 'A/u251':
                            if( $postData['spinType'] == 'regular' && $slotSettings->GetGameData($slotSettings->slotId . 'FreeGames') <= $slotSettings->GetGameData($slotSettings->slotId . 'CurrentFreeGame') ) 
                            {
                                ...
                                $bonusMpl = 1;
                                $slotSettings->SetGameData('BellsOnFireRomboAMBonusWin', 0);
                                $slotSettings->SetGameData('BellsOnFireRomboAMFreeGames', 0);
                                $slotSettings->SetGameData('BellsOnFireRomboAMCurrentFreeGame', 0);
                                $slotSettings->SetGameData('BellsOnFireRomboAMTotalWin', 0);
                                $slotSettings->SetGameData('BellsOnFireRomboAMFreeBalance', 0);
                                $slotSettings->SetGameData('BellsOnFireRomboAMFreeStartWin', 0);
                            }
                            if( $slotSettings->GetGameData($slotSettings->slotId . 'CurrentFreeGame') < $slotSettings->GetGameData($slotSettings->slotId . 'FreeGames') ) 
                            {
                                ...
                                $slotSettings->SetGameData('BellsOnFireRomboAMCurrentFreeGame', $slotSettings->GetGameData('BellsOnFireRomboAMCurrentFreeGame') + 1);
                            ...
                            if( $postData['slotEvent'] == 'freespin' && $slotSettings->GetGameData('BellsOnFireRomboAMFreeGames') <= $slotSettings->GetGameData('BellsOnFireRomboAMCurrentFreeGame') && $winType != 'bonus' && $slotSettings->GetGameData('BellsOnFireRomboAMBonusWin') + $totalWin > 0 ) 
                            {
                                $slotSettings->SetBalance($slotSettings->GetGameData('BellsOnFireRomboAMBonusWin') + $totalWin);
                            }
                            ...
                            if( $postData['slotEvent'] == 'freespin' ) 
                            {
                                $slotSettings->SetGameData('BellsOnFireRomboAMBonusWin', $slotSettings->GetGameData('BellsOnFireRomboAMBonusWin') + $totalWin);
                                $slotSettings->SetGameData('BellsOnFireRomboAMTotalWin', $totalWin);
                            }
                            else
                            {
                                $slotSettings->SetGameData('BellsOnFireRomboAMTotalWin', $totalWin);
                            ...
                            if( $scattersCount >= 3 ) 
                            {
                                ...
                                if( $slotSettings->GetGameData('BellsOnFireRomboAMFreeGames') > 0 ) 
                                {
                                    $slotSettings->SetGameData('BellsOnFireRomboAMFreeGames', $slotSettings->GetGameData('BellsOnFireRomboAMFreeGames') + $slotSettings->slotFreeCount);
                                }
                                else
                                {
                                    $slotSettings->SetGameData('BellsOnFireRomboAMFreeStartWin', $totalWin);
                                    $slotSettings->SetGameData('BellsOnFireRomboAMBonusWin', $totalWin);
                                    $slotSettings->SetGameData('BellsOnFireRomboAMFreeGames', $slotSettings->slotFreeCount);
                                }
                            }
                            $jsSpin = '' . json_encode($reels) . '';
                            $jsJack = '' . json_encode($slotSettings->Jackpots) . '';
                            $winString = implode(',', $lineWins);
                            $response_log = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{"symDouble":' . $symDouble . ',"slotLines":' . $lines . ',"slotBet":' . $betCnt . ',"totalFreeGames":' . $slotSettings->GetGameData('BellsOnFireRomboAMFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('BellsOnFireRomboAMCurrentFreeGame') . ',"Balance":' . $slotSettings->GetBalance() . ',"afterBalance":' . $slotSettings->GetBalance() . ',"bonusWin":' . $slotSettings->GetGameData('BellsOnFireRomboAMBonusWin') . ',"freeStartWin":' . $slotSettings->GetGameData('BellsOnFireRomboAMFreeStartWin') . ',"totalWin":' . $totalWin . ',"winLines":[' . $winString . '],"bonusInfo":' . $scattersStr . ',"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
                            ...
                            if( $postData['slotEvent'] == 'freespin' ) 
                            {
                                ...
                                $cFree = dechex($slotSettings->GetGameData('BellsOnFireRomboAMFreeGames') - $slotSettings->GetGameData('BellsOnFireRomboAMCurrentFreeGame'));
                                $gameState = '06';
                                if( $slotSettings->GetGameData('BellsOnFireRomboAMFreeGames') <= $slotSettings->GetGameData('BellsOnFireRomboAMCurrentFreeGame') ) 
                                {
                                    $gameState = '0c';
                                }
                                if( $scattersCount >= 3 ) 
                                ...
                                $totalWin = $slotSettings->GetGameData('BellsOnFireRomboAMBonusWin');
                                $bonusMpl = $slotSettings->slotFreeMpl;
                            }
                            else
                            {
                            ...
                            $slotSettings->SetGameData('BellsOnFireRomboAMDoubleAnswer', $reelSate . $bet_h . $ln_h . $freeInfo . $freeWinState . $slotSettings->HexFormat($bonusMpl) . '1010' . $reelSate . '0' . $symCountAll . $winLinesFormated);
                            $slotSettings->SetGameData('BellsOnFireRomboAMDoubleBalance', $balanceFormated);
                            $slotSettings->SetGameData('BellsOnFireRomboAMDoubleWin', $totalWin);
                            if( $postData['slotEvent'] == 'freespin' ) 
                            {
                            ...
                            $slotSettings->SetGameData('BellsOnFireRomboAMCollectP0', $response_collect0);
                            $gameState = '04';
                            $balanceFormated = $slotSettings->HexFormat(round($slotSettings->GetBalance() * $floatBet));
                            ...
                            $slotSettings->SetGameData('BellsOnFireRomboAMCollect', $response_collect);
                            break;
                        case 'A/u254':
                            $slotSettings->SetGameData($slotSettings->slotId . 'TotalWin', 0);
                            $response = $slotSettings->GetGameData('BellsOnFireRomboAMCollect');
                            break;
                        case 'A/u257':
                            $doubleWin = rand(1, 2);
                            $winall = $slotSettings->GetGameData('BellsOnFireRomboAMDoubleWin');
                            $dbet = $winall;
                            $daction = $tmpPar[1];
                            ...
                            $response = '107010' . $slotSettings->GetGameData('BellsOnFireRomboAMDoubleBalance') . strlen($winall_h) . $winall_h . $slotSettings->GetGameData('BellsOnFireRomboAMDoubleAnswer') . implode('', $slotSettings->GetGameData($slotSettings->slotId . 'Cards'));
                            $slotSettings->SetGameData('BellsOnFireRomboAMDoubleWin', $winall);
                            $slotSettings->SetGameData('BellsOnFireRomboAMTotalWin', $winall);
                            $balanceFormated = $slotSettings->HexFormat(round($slotSettings->GetBalance() * $floatBet));
                            $response_collect = '104010' . $balanceFormated . strlen($winall_h) . $winall_h . $slotSettings->GetGameData('BellsOnFireRomboAMCollectP0');
                            $slotSettings->SetGameData('BellsOnFireRomboAMCollect', $response_collect);
                        ...
                        case 'A/u258':
                            ...
                            $slotSettings->SetGameData('BellsOnFireRomboAMDoubleBalance', $rtnBalance);
                            $winall = sprintf('%01.2f', $winall) * $floatBet;
                            $winall_h1 = str_replace('.', '', $winall . '');
                            $winall_h = dechex($winall_h1);
                            $doubleCards = '26280b2714161d0c';
                            $response = '108010' . $slotSettings->GetGameData('BellsOnFireRomboAMDoubleBalance') . strlen($winall_h) . $winall_h . $slotSettings->GetGameData('BellsOnFireRomboAMDoubleAnswer') . implode('', $slotSettings->GetGameData($slotSettings->slotId . 'Cards'));
                            break;
                    }
