                    ...
                    try
                    {
                        ...
                        switch( $aid ) 
                        {
                            case 'startGame':
                                ...
                                $result_tmp[0] = '{"sgr":{"gn":"Polynesian","lsd":{"sid":2359073781,"tid":"2472f599ebf24af8b91fd96bc6186772","sel":5,"cps":5,"dn":0.01,"nd":0.01,"ncps":0,"atb":0,"v":true,"fs":' . $fs . ',"twg":' . (25 * $bet) . ',"swm":0,"sw":0,"swu":0,"tw":0,"fsw":0,"fsr":' . $fsr . ',"tfw":' . $tfw . ',"st":[' . $curReels . '],"swi":[0],"snm":[0],"ssm":[0],"sm":[0,0,0,0,0,0],"acb":' . $acb . ',"rf":0,"as":[],"sp":0,"cr":"USD","rd":' . $rd . ',"pbb":0,"obb":' . $balanceInCents . ',"mb":false,"pwa":0},"drs":[[' . implode(',', $slotSettings->reelStrip1) . '],[' . implode(',', $slotSettings->reelStrip2) . '],[' . implode(',', $slotSettings->reelStrip3) . '],[' . implode(',', $slotSettings->reelStrip4) . '],[' . implode(',', $slotSettings->reelStrip5) . ']],"pt":[[0,0,0,0,0],[0,0,500,1000,1500],[0,0,200,500,1500],[0,0,100,250,1000],[0,0,50,150,400],[0,0,40,100,250],[0,0,25,80,200],[0,0,15,50,150],[0,0,10,25,100],[0,0,10,25,100],[0,0,10,25,100],[0,0,10,25,100],[0,0,5,0,0]],"cps":[1,2,3,5,10,15,20,25,30,50,75,100,150,250,500],"e":false,"ec":0,"cc":""},"un":"accessKey|USD|920108688","bl":' . $balanceInCents . ',"gn":"Polynesian","lgn":"Polynesian","gv":0,"fs":false,"si":"418a3f1cbf8a4e2bb0694b9111648f91","dn":[0.01,0.05,0.1,0.25,0.5,1.0,2.0],"cs":"$","cd":2,"cp":false,"gs":",","ds":".","ase":[5],"gm":0,"mi":-1,"cud":0.01,"cup":[' . implode(',', $gameBets) . '],"mm":0,"e":false,"ec":0,"cc":"EN"}';
                                break;
                            case 'ping':
                                    ...
                                    for( $j = 0; $j < count($slotSettings->SymbolGame); $j++ ) 
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            for( $rl = 1; $rl <= 5; $rl++ ) 
                                            {
                                                ...
                                                for( $rs = 0; $rs <= 2; $rs++ ) 
                                                {
                                                    if( $rl == 3 && in_array($reels['reel' . $rl][$rs], $wild) ) 
                                                    {
                                                        $isWild2 = true;
                                                    }
                                            ...
                                            if( $postData['slotEvent'] == 'freespin' && $isWild2 ) 
                                            {
                                                $bonusMpl = rand(2, 5);
                                            }
                                            if( $cWin > 0 ) 
