                    ...
                    try
                    {
                        ...
                        if( isset($postData['spinType']) ) 
                        {
                            ...
                            if( $postData['spinType'] == 'regular' ) 
                            {
                                ...
                                $bonusMpl = 1;
                                $slotSettings->SetGameData('Crazy7PTBonusWin', 0);
                                $slotSettings->SetGameData('Crazy7PTFreeGames', 0);
                                $slotSettings->SetGameData('Crazy7PTCurrentFreeGame', 0);
                                $slotSettings->SetGameData('Crazy7PTTotalWin', 0);
                                $slotSettings->SetGameData('Crazy7PTFreeBalance', 0);
                                $slotSettings->SetGameData('Crazy7PTFreeStartWin', 0);
                            }
                            else if( $postData['spinType'] == 'free' ) 
                            {
                                $umid = '0';
                                $postData['slotEvent'] = 'freespin';
                                $slotSettings->SetGameData('Crazy7PTCurrentFreeGame', $slotSettings->GetGameData('Crazy7PTCurrentFreeGame') + 1);
                                    ...
                                    for( $j = 0; $j < count($slotSettings->SymbolGame); $j++ ) 
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":3,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('Crazy7PTBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == '0' || $s[0] == '2' || $s[0] == '4') && ($s[1] == '0' || $s[1] == '2' || $s[1] == '4') && ($s[2] == '0' || $s[2] == '2' || $s[2] == '4') ) 
                                            {
                                                $mpl = 1;
                                                $mpl = 1;
                            ...
                            if( $postData['slotEvent'] == 'freespin' ) 
                            {
                                $slotSettings->SetGameData('Crazy7PTBonusWin', $slotSettings->GetGameData('Crazy7PTBonusWin') + $totalWin);
                                $slotSettings->SetGameData('Crazy7PTTotalWin', $totalWin);
                            }
                            else
                            {
                                $slotSettings->SetGameData('Crazy7PTTotalWin', $totalWin);
                            ...
                            $response = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{"linesArr":[' . implode(',', $postData['lines']) . '],"slotLines":' . $lines . ',"slotBet":' . $betLine . ',"totalFreeGames":' . $slotSettings->GetGameData('Crazy7PTFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('Crazy7PTCurrentFreeGame') . ',"Balance":' . $slotSettings->GetBalance() . ',"afterBalance":' . $slotSettings->GetBalance() . ',"bonusWin":' . $slotSettings->GetGameData('Crazy7PTBonusWin') . ',"freeStartWin":' . $slotSettings->GetGameData('Crazy7PTFreeStartWin') . ',"totalWin":' . $totalWin . ',"winLines":[' . $winString . '],"bonusInfo":' . $scattersStr . ',"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
