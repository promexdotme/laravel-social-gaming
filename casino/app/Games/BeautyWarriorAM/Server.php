                    ...
                    switch( $gameData['slotEvent'] ) 
                    {
                        ...
                        case 'A/u25':
                            ...
                            if( $lastEvent != 'NULL' ) 
                            {
                                ...
                                $slotSettings->SetGameData('BeautyWarriorAMLines', $curLines);
                                $freeMpl = '11';
                                $slotSettings->SetGameData('BeautyWarriorAMBonusWin', $lastEvent->serverResponse->bonusWin);
                                $slotSettings->SetGameData('BeautyWarriorAMFreeGames', $lastEvent->serverResponse->totalFreeGames);
                                $slotSettings->SetGameData('BeautyWarriorAMCurrentFreeGame', $lastEvent->serverResponse->currentFreeGames);
                                $slotSettings->SetGameData('BeautyWarriorAMTotalWin', 0);
                                $slotSettings->SetGameData('BeautyWarriorAMFreeBalance', 0);
                                $slotSettings->SetGameData('BeautyWarriorAMFreeStartWin', 0);
                                $tFree = dechex($slotSettings->GetGameData('BeautyWarriorAMFreeGames'));
                                $cFree = dechex($slotSettings->GetGameData('BeautyWarriorAMFreeGames') - $slotSettings->GetGameData('BeautyWarriorAMCurrentFreeGame'));
                                $freeInfo = strlen($tFree) . $tFree . strlen($cFree) . $cFree;
                                $stateWin = $slotSettings->HexFormat($slotSettings->GetGameData('BeautyWarriorAMBonusWin') * $floatBet);
                                if( $slotSettings->GetGameData('BeautyWarriorAMCurrentFreeGame') < $slotSettings->GetGameData('BeautyWarriorAMFreeGames') && $slotSettings->GetGameData('BeautyWarriorAMFreeGames') > 0 ) 
                                {
                                    $slotState = '6';
                            ...
                            {
                                $slotSettings->SetGameData('BeautyWarriorAMLines', $fixedLinesFormated);
                                $slotState = '4';
                            ...
                            break;
                        case 'A/u250':
                            $fixedLinesFormated = $slotSettings->GetGameData('BeautyWarriorAMLines');
                            $balanceFormated = $slotSettings->HexFormat(round($slotSettings->GetBalance() * $floatBet));
                            $lastEvent = $slotSettings->GetHistory();
                            if( $lastEvent != 'NULL' ) 
                            {
                        ...
                        case 'A/u251':
                            if( $postData['spinType'] == 'regular' && $slotSettings->GetGameData($slotSettings->slotId . 'FreeGames') <= $slotSettings->GetGameData($slotSettings->slotId . 'CurrentFreeGame') ) 
                            {
                                ...
                                $bonusMpl = 1;
                                $slotSettings->SetGameData('BeautyWarriorAMBonusWin', 0);
                                $slotSettings->SetGameData('BeautyWarriorAMFreeGames', 0);
                                $slotSettings->SetGameData('BeautyWarriorAMCurrentFreeGame', 0);
                                $slotSettings->SetGameData('BeautyWarriorAMTotalWin', 0);
                                $slotSettings->SetGameData('BeautyWarriorAMFreeBalance', 0);
                                $slotSettings->SetGameData('BeautyWarriorAMFreeStartWin', 0);
                            }
                            if( $slotSettings->GetGameData($slotSettings->slotId . 'CurrentFreeGame') < $slotSettings->GetGameData($slotSettings->slotId . 'FreeGames') ) 
                            {
                                ...
                                $slotSettings->SetGameData('BeautyWarriorAMCurrentFreeGame', $slotSettings->GetGameData('BeautyWarriorAMCurrentFreeGame') + 1);
                            ...
                            for( $i = 0; $i <= 2000; $i++ ) 
                            {
                                ...
                                if( $reels['reel3'][0] >= 10 && $reels['reel3'][1] >= 10 && $reels['reel3'][2] >= 10 && $reels['reel3'][3] >= 10 && $reels['reel3'][4] >= 10 ) 
                                {
                                    $rndwr = [
                                        2, 
                                        4
                                    ...
                                    $rndwr = [4];
                                    shuffle($rndwr);
                                    $reels['reel' . $rndwr[0]][0] = '10';
                                    $reels['reel' . $rndwr[0]][1] = '10';
                                    $reels['reel' . $rndwr[0]][2] = '10';
                                    $reels['reel' . $rndwr[0]][3] = '10';
                                    if( $rndwr[0] == 4 ) 
                                    {
                                        $wildsFormated = [
                                            '01', 
                                ...
                                else if( $reels['reel2'][0] >= 10 && $reels['reel2'][1] >= 10 && $reels['reel2'][2] >= 10 && $reels['reel2'][3] >= 10 ) 
                                {
                                    $rndwr = [
                                        3, 
                                        4
                                ...
                                else if( $reels['reel4'][0] >= 10 && $reels['reel4'][1] >= 10 && $reels['reel4'][2] >= 10 && $reels['reel4'][3] >= 10 ) 
                                {
                                    $rndwr = [
                                        2, 
                                        3
                            ...
                            if( $postData['slotEvent'] == 'freespin' && $slotSettings->GetGameData('BeautyWarriorAMFreeGames') <= $slotSettings->GetGameData('BeautyWarriorAMCurrentFreeGame') && $winType != 'bonus' && $slotSettings->GetGameData('BeautyWarriorAMBonusWin') + $totalWin > 0 ) 
                            {
                                $slotSettings->SetBalance($slotSettings->GetGameData('BeautyWarriorAMBonusWin') + $totalWin);
                            }
                            ...
                            if( $postData['slotEvent'] == 'freespin' ) 
                            {
                                $slotSettings->SetGameData('BeautyWarriorAMBonusWin', $slotSettings->GetGameData('BeautyWarriorAMBonusWin') + $totalWin);
                                $slotSettings->SetGameData('BeautyWarriorAMTotalWin', $totalWin);
                            }
                            else
                            {
                                $slotSettings->SetGameData('BeautyWarriorAMTotalWin', $totalWin);
                            ...
                            if( $scattersCount >= 3 ) 
                            {
                                ...
                                if( $slotSettings->GetGameData('BeautyWarriorAMFreeGames') > 0 ) 
                                {
                                    $slotSettings->SetGameData('BeautyWarriorAMFreeGames', $slotSettings->GetGameData('BeautyWarriorAMFreeGames') + $slotSettings->slotFreeCount);
                                }
                                else
                                {
                                    $slotSettings->SetGameData('BeautyWarriorAMFreeStartWin', $totalWin);
                                    $slotSettings->SetGameData('BeautyWarriorAMBonusWin', $totalWin);
                                    $slotSettings->SetGameData('BeautyWarriorAMFreeGames', $slotSettings->slotFreeCount);
                                }
                            }
                            $reels = $reelsTmp;
                            ...
                            $response_log = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{"symDouble":' . $symDouble . ',"slotLines":' . $lines . ',"slotBet":' . $betCnt . ',"totalFreeGames":' . $slotSettings->GetGameData('BeautyWarriorAMFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('BeautyWarriorAMCurrentFreeGame') . ',"Balance":' . $slotSettings->GetBalance() . ',"afterBalance":' . $slotSettings->GetBalance() . ',"bonusWin":' . $slotSettings->GetGameData('BeautyWarriorAMBonusWin') . ',"freeStartWin":' . $slotSettings->GetGameData('BeautyWarriorAMFreeStartWin') . ',"totalWin":' . $totalWin . ',"winLines":[' . $winString . '],"bonusInfo":' . $scattersStr . ',"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
                            ...
                            if( $postData['slotEvent'] == 'freespin' ) 
                            {
                                ...
                                $cFree = dechex($slotSettings->GetGameData('BeautyWarriorAMFreeGames') - $slotSettings->GetGameData('BeautyWarriorAMCurrentFreeGame'));
                                $gameState = '06';
                                if( $slotSettings->GetGameData('BeautyWarriorAMFreeGames') <= $slotSettings->GetGameData('BeautyWarriorAMCurrentFreeGame') ) 
                                {
                                    $gameState = '0c';
                                }
                                if( $scattersCount >= 3 ) 
                                ...
                                $totalWin = $slotSettings->GetGameData('BeautyWarriorAMBonusWin');
                                $bonusMpl = $slotSettings->slotFreeMpl;
                            }
                            else
                            {
                            ...
                            $wildState = '0101010101';
                            $balanceFormated = $slotSettings->HexFormat(round($slotSettings->GetBalance() * $floatBet));
                            $response = '1' . $gameState . '010' . $balanceFormated . $slotSettings->HexFormat(round($totalWin * 100)) . $reelSate . $bet_h . $ln_h . $freeInfo . $freeWinState . $slotSettings->HexFormat($bonusMpl) . '1010' . $reelSate . '0' . $symCountAll . $winLinesFormated . implode('', $slotSettings->GetGameData($slotSettings->slotId . 'Cards')) . '01' . implode('', $wildsFormated) . '#101010';
                            $response .= ('_' . json_encode($reels));
                            $slotSettings->SetGameData('BeautyWarriorAMDoubleAnswer', $reelSate . $bet_h . $ln_h . $freeInfo . $freeWinState . $slotSettings->HexFormat($bonusMpl) . '1010' . $reelSate . '0' . $symCountAll . $winLinesFormated);
                            $slotSettings->SetGameData('BeautyWarriorAMDoubleBalance', $balanceFormated);
                            $slotSettings->SetGameData('BeautyWarriorAMDoubleWin', $totalWin);
                            if( $postData['slotEvent'] == 'freespin' ) 
                            {
                            ...
                            $slotSettings->SetGameData('BeautyWarriorAMCollectP0', $response_collect0);
                            $gameState = '04';
                            $balanceFormated = $slotSettings->HexFormat(round($slotSettings->GetBalance() * $floatBet));
                            ...
                            $slotSettings->SetGameData('BeautyWarriorAMCollect', $response_collect);
                            break;
                        case 'A/u254':
                            $slotSettings->SetGameData($slotSettings->slotId . 'TotalWin', 0);
                            $slotSettings->SetGameData('BeautyWarriorAMTotalWin', 0);
                            $response = $slotSettings->GetGameData('BeautyWarriorAMCollect');
                            break;
                        case 'A/u257':
                            $doubleWin = rand(1, 2);
                            $winall = $slotSettings->GetGameData('BeautyWarriorAMDoubleWin');
                            $dbet = $winall;
                            $daction = $tmpPar[1];
                            ...
                            $response = '107010' . $slotSettings->GetGameData('BeautyWarriorAMDoubleBalance') . strlen($winall_h) . $winall_h . $slotSettings->GetGameData('BeautyWarriorAMDoubleAnswer') . implode('', $slotSettings->GetGameData($slotSettings->slotId . 'Cards'));
                            $slotSettings->SetGameData('BeautyWarriorAMDoubleWin', $winall);
                            $slotSettings->SetGameData('BeautyWarriorAMTotalWin', $winall);
                            $balanceFormated = $slotSettings->HexFormat(round($slotSettings->GetBalance() * $floatBet));
                            $response_collect = '104010' . $balanceFormated . strlen($winall_h) . $winall_h . $slotSettings->GetGameData('BeautyWarriorAMCollectP0');
                            $slotSettings->SetGameData('BeautyWarriorAMCollect', $response_collect);
                        ...
                        case 'A/u258':
                            ...
                            $slotSettings->SetGameData('BeautyWarriorAMDoubleBalance', $rtnBalance);
                            $winall = sprintf('%01.2f', $winall) * $floatBet;
                            $winall_h1 = str_replace('.', '', $winall . '');
                            $winall_h = dechex($winall_h1);
                            $doubleCards = '26280b2714161d0c';
                            $response = '108010' . $slotSettings->GetGameData('BeautyWarriorAMDoubleBalance') . strlen($winall_h) . $winall_h . $slotSettings->GetGameData('BeautyWarriorAMDoubleAnswer') . implode('', $slotSettings->GetGameData($slotSettings->slotId . 'Cards'));
                            break;
                    }
