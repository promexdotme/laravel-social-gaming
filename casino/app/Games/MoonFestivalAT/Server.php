                    ...
                    try
                    {
                        ...
                        if( $postData['slotEvent'] == 'gameInit' ) 
                        {
                            ...
                            if( $lastEvent != 'NULL' ) 
                            {
                                ...
                                $hWilds = $slotSettings->GetGameData('MoonFestivalATholdWildsStr');
                                if( !is_array($hWilds) ) 
                                {
                                    $hWilds = [];
                                }
                        ...
                        {
                            $response = '{"status":"success","microtime":0.0026731491088867,"dateTime":"2020-02-13 13:23:32","error":"","content":{"cmd":"sessionInfo","serverMathematics":"\/game\/MoonFestivalAT\/server","serverResources":"","sessionId":"54594109_4133a64673d3883d42cd003ee905ba3e","exitUlt":"\/","exitUrl":"\/","id":"341","name":"GameName","currency":"ALL","language":"en","type":"aristocrat","systemName":"moon_festival","version":"2","mobile":"1"}}';
                        }
                        ...
                        else if( $postData['slotEvent'] == 'gamePick' ) 
                        {
                            ...
                            if( $_POST['pick'] == 0 ) 
                            {
                                $slotSettings->SetGameData('MoonFestivalATMpl', 10);
                                $slotSettings->SetGameData('MoonFestivalATCurrentFreeGame', 0);
                                $slotSettings->SetGameData('MoonFestivalATFreeGames', 5);
                            }
                            else if( $_POST['pick'] == 1 ) 
                            {
                                $slotSettings->SetGameData('MoonFestivalATMpl', 5);
                                $slotSettings->SetGameData('MoonFestivalATCurrentFreeGame', 0);
                                $slotSettings->SetGameData('MoonFestivalATFreeGames', 10);
                            }
                            else if( $_POST['pick'] == 2 ) 
                            {
                                $slotSettings->SetGameData('MoonFestivalATMpl', 3);
                                $slotSettings->SetGameData('MoonFestivalATCurrentFreeGame', 0);
                                $slotSettings->SetGameData('MoonFestivalATFreeGames', 15);
                            }
                            else if( $_POST['pick'] == 3 ) 
                            {
                                $slotSettings->SetGameData('MoonFestivalATMpl', 2);
                                $slotSettings->SetGameData('MoonFestivalATCurrentFreeGame', 0);
                                $slotSettings->SetGameData('MoonFestivalATFreeGames', 20);
                            }
                            $response = '{"status":"success","microtime":0.0093810558319092,"dateTime":"2020-02-15 14:26:21","error":"","content":{"session":"54990161_9709e13bca7763b46396cda1868d2e7e","cmd":"gamePick","balance":' . $balanceInCents . ',"win":0,"symbols":{"1":{"1":"symbol_6","2":"symbol_9","3":"symbol_13"},"2":{"1":"symbol_10","2":"symbol_5","3":"symbol_8"},"3":{"1":"symbol_10","2":"symbol_13","3":"symbol_11"},"4":{"1":"symbol_13","2":"symbol_10","3":"symbol_6"},"5":{"1":"symbol_3","2":"symbol_8","3":"symbol_1"}},"winLines":[],"freeSpin":{"id":"54990161_20200215132548","current":0,"add":' . $slotSettings->GetGameData('MoonFestivalATFreeGames') . ',"total":' . $slotSettings->GetGameData('MoonFestivalATFreeGames') . ',"totalWin":' . ($slotSettings->GetGameData('MoonFestivalATBonusWin') * 100) . ',"multiplayer":' . $slotSettings->GetGameData('MoonFestivalATMpl') . ',"pick":' . $_POST['pick'] . '},"actionId":"54990161_10_60","hash":"1ace145628d930d28bdf38789a28a9d7"}}';
                        }
                        else if( $postData['slotEvent'] == 'slotGamble' ) 
                        {
                            ...
                            $dealerCard = '';
                            $totalWin = $slotSettings->GetGameData('MoonFestivalATTotalWin');
                            $gambleWin = 0;
                            $statBet = $totalWin;
                            ...
                            $slotSettings->SetGameData('MoonFestivalATTotalWin', $totalWin);
                        ...
                        else if( $postData['slotEvent'] == 'bet' || $postData['slotEvent'] == 'freespin' ) 
                        {
                            ...
                            if( $postData['slotEvent'] != 'freespin' ) 
                            {
                                ...
                                $bonusMpl = 1;
                                $slotSettings->SetGameData('MoonFestivalATBonusWin', 0);
                                $slotSettings->SetGameData('MoonFestivalATFreeGames', 0);
                                $slotSettings->SetGameData('MoonFestivalATCurrentFreeGame', 0);
                                $slotSettings->SetGameData('MoonFestivalATTotalWin', 0);
                                $slotSettings->SetGameData('MoonFestivalATFreeBalance', 0);
                                $slotSettings->SetGameData('MoonFestivalATMpl', 1);
                            }
                            else
                            {
                                $slotSettings->SetGameData('MoonFestivalATCurrentFreeGame', $slotSettings->GetGameData('MoonFestivalATCurrentFreeGame') + 1);
                                $bonusMpl = $slotSettings->GetGameData('MoonFestivalATMpl');
                            }
                            $Balance = $slotSettings->GetBalance();
                            ...
                            for( $i = 0; $i <= 2000; $i++ ) 
                            {
                                ...
                                if( $postData['slotEvent'] == 'freespin' ) 
                                {
                                    $hWilds = $slotSettings->GetGameData('MoonFestivalATholdWildsArr');
                                    if( !is_array($hWilds) ) 
                                    {
                                        $hWilds = [];
                                    }
                            ...
                            if( $postData['slotEvent'] == 'freespin' ) 
                            {
                                $slotSettings->SetGameData('MoonFestivalATholdWildsArr', $holdWildsArr);
                                $slotSettings->SetGameData('MoonFestivalATholdWildsStr', $holdWildsStr);
                                $slotSettings->SetGameData('MoonFestivalATBonusWin', $slotSettings->GetGameData('MoonFestivalATBonusWin') + $totalWin);
                                $slotSettings->SetGameData('MoonFestivalATTotalWin', $slotSettings->GetGameData('MoonFestivalATTotalWin') + $totalWin);
                                $freeStateStr = '"id":"54594109_20200214110301","current":' . $slotSettings->GetGameData('MoonFestivalATCurrentFreeGame') . ',"multiplayer":' . $slotSettings->GetGameData('MoonFestivalATMpl') . ',"add":0,"total":' . $slotSettings->GetGameData('MoonFestivalATFreeGames') . ',"totalWin":' . ($slotSettings->GetGameData('MoonFestivalATBonusWin') * 100) . ',"wilds":[' . implode(',', $holdWildsStr) . ']';
                            }
                            else
                            {
                                $slotSettings->SetGameData('MoonFestivalATTotalWin', $totalWin);
                            ...
                            if( $scattersCount >= 3 ) 
                            {
                                if( $slotSettings->GetGameData('MoonFestivalATFreeGames') > 0 ) 
                                {
                                    $slotSettings->SetGameData('MoonFestivalATFreeGames', $slotSettings->GetGameData('MoonFestivalATFreeGames') + $slotSettings->slotFreeCount);
                                    $freeStateStr = '"id":"54594109_20200214110301","current":' . $slotSettings->GetGameData('MoonFestivalATCurrentFreeGame') . ',"multiplayer":' . $slotSettings->GetGameData('MoonFestivalATMpl') . ',"add":' . $slotSettings->slotFreeCount . ',"total":' . $slotSettings->GetGameData('MoonFestivalATFreeGames') . ',"totalWin":' . ($slotSettings->GetGameData('MoonFestivalATBonusWin') * 100) . ',"wilds":[' . implode(',', $holdWildsStr) . ']';
                                }
                                else
                                {
                                    $slotSettings->SetGameData('MoonFestivalATFreeBalance', $Balance);
                                    $slotSettings->SetGameData('MoonFestivalATBonusWin', $totalWin);
                                    $slotSettings->SetGameData('MoonFestivalATFreeGames', $slotSettings->slotFreeCount);
                                    $freeStateStr = '"id":"54594109_20200214110301","current":' . $slotSettings->GetGameData('MoonFestivalATCurrentFreeGame') . ',"multiplayer":' . $slotSettings->GetGameData('MoonFestivalATMpl') . ',"add":' . $slotSettings->slotFreeCount . ',"total":' . $slotSettings->GetGameData('MoonFestivalATFreeGames') . ',"totalWin":' . ($slotSettings->GetGameData('MoonFestivalATBonusWin') * 100) . ',"wilds":[' . implode(',', $holdWildsStr) . ']';
                                }
                            }
                            ...
                            $response_log = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{"curSeq":' . json_encode($curSeq) . ',"slotLines":' . $postData['slotLines'] . ',"slotBet":' . $postData['slotBet'] . ',"totalFreeGames":' . $slotSettings->GetGameData('MoonFestivalATFreeGames') . ',"Mpl":' . $slotSettings->GetGameData('MoonFestivalATMpl') . ',"currentFreeGames":' . $slotSettings->GetGameData('MoonFestivalATCurrentFreeGame') . ',"Balance":' . $Balance . ',"afterBalance":' . $slotSettings->GetBalance() . ',"totalWin":' . $totalWin . ',"winLines":[' . $winString . '],"bonusInfo":{},"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
                            $reelStrArr = [];
                            for( $i = 1; $i <= 5; $i++ ) 
                            {
