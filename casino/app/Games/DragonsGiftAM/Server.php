                    ...
                    switch( $gameData['slotEvent'] ) 
                    {
                        ...
                        case 'A/u25':
                            ...
                            if( $lastEvent != 'NULL' ) 
                            {
                                ...
                                $slotSettings->SetGameData('DragonsGiftAMLines', $curLines);
                                $freeMpl = '11';
                                $slotSettings->SetGameData('DragonsGiftAMBonusWin', $lastEvent->serverResponse->bonusWin);
                                $slotSettings->SetGameData('DragonsGiftAMFreeGames', $lastEvent->serverResponse->totalFreeGames);
                                $slotSettings->SetGameData('DragonsGiftAMCurrentFreeGame', $lastEvent->serverResponse->currentFreeGames);
                                $slotSettings->SetGameData('DragonsGiftAMTotalWin', 0);
                                $slotSettings->SetGameData('DragonsGiftAMFreeBalance', 0);
                                $slotSettings->SetGameData('DragonsGiftAMFreeStartWin', 0);
                                $tFree = dechex($slotSettings->GetGameData('DragonsGiftAMFreeGames'));
                                $cFree = dechex($slotSettings->GetGameData('DragonsGiftAMFreeGames') - $slotSettings->GetGameData('DragonsGiftAMCurrentFreeGame'));
                                $freeInfo = strlen($tFree) . $tFree . strlen($cFree) . $cFree;
                                $stateWin = $slotSettings->HexFormat($slotSettings->GetGameData('DragonsGiftAMBonusWin') * $floatBet);
                                if( $slotSettings->GetGameData('DragonsGiftAMCurrentFreeGame') < $slotSettings->GetGameData('DragonsGiftAMFreeGames') && $slotSettings->GetGameData('DragonsGiftAMFreeGames') > 0 ) 
                                {
                                    $slotState = '6';
                            ...
                            {
                                $slotSettings->SetGameData('DragonsGiftAMLines', $fixedLinesFormated);
                                $slotState = '4';
                            ...
                            break;
                        case 'A/u250':
                            $fixedLinesFormated = $slotSettings->GetGameData('DragonsGiftAMLines');
                            $balanceFormated = $slotSettings->HexFormat(round($slotSettings->GetBalance() * $floatBet));
                            $lastEvent = $slotSettings->GetHistory();
                            if( $lastEvent != 'NULL' ) 
                            {
                        ...
                        case 'A/u251':
                            if( $postData['spinType'] == 'regular' && $slotSettings->GetGameData($slotSettings->slotId . 'FreeGames') <= $slotSettings->GetGameData($slotSettings->slotId . 'CurrentFreeGame') ) 
                            {
                                ...
                                $bonusMpl = 1;
                                $slotSettings->SetGameData('DragonsGiftAMBonusWin', 0);
                                $slotSettings->SetGameData('DragonsGiftAMFreeGames', 0);
                                $slotSettings->SetGameData('DragonsGiftAMCurrentFreeGame', 0);
                                $slotSettings->SetGameData('DragonsGiftAMTotalWin', 0);
                                $slotSettings->SetGameData('DragonsGiftAMFreeBalance', 0);
                                $slotSettings->SetGameData('DragonsGiftAMFreeStartWin', 0);
                            }
                            if( $slotSettings->GetGameData($slotSettings->slotId . 'CurrentFreeGame') < $slotSettings->GetGameData($slotSettings->slotId . 'FreeGames') ) 
                            {
                                ...
                                $slotSettings->SetGameData('DragonsGiftAMCurrentFreeGame', $slotSettings->GetGameData('DragonsGiftAMCurrentFreeGame') + 1);
                            ...
                            if( $postData['slotEvent'] == 'freespin' && $slotSettings->GetGameData('DragonsGiftAMFreeGames') <= $slotSettings->GetGameData('DragonsGiftAMCurrentFreeGame') && $winType != 'bonus' && $slotSettings->GetGameData('DragonsGiftAMBonusWin') + $totalWin > 0 ) 
                            {
                                $slotSettings->SetBalance($slotSettings->GetGameData('DragonsGiftAMBonusWin') + $totalWin);
                            }
                            ...
                            if( $postData['slotEvent'] == 'freespin' ) 
                            {
                                $slotSettings->SetGameData('DragonsGiftAMBonusWin', $slotSettings->GetGameData('DragonsGiftAMBonusWin') + $totalWin);
                                $slotSettings->SetGameData('DragonsGiftAMTotalWin', $totalWin);
                            }
                            else
                            {
                                $slotSettings->SetGameData('DragonsGiftAMTotalWin', $totalWin);
                            ...
                            if( $scattersCount >= 3 ) 
                            {
                                ...
                                if( $slotSettings->GetGameData('DragonsGiftAMFreeGames') > 0 ) 
                                {
                                    $slotSettings->SetGameData('DragonsGiftAMFreeGames', $slotSettings->GetGameData('DragonsGiftAMFreeGames') + $slotSettings->slotFreeCount);
                                }
                                else
                                {
                                    $slotSettings->SetGameData('DragonsGiftAMFreeStartWin', $totalWin);
                                    $slotSettings->SetGameData('DragonsGiftAMBonusWin', $totalWin);
                                    $slotSettings->SetGameData('DragonsGiftAMFreeGames', $slotSettings->slotFreeCount);
                                }
                            }
                            $jsSpin = '' . json_encode($reels) . '';
                            $jsJack = '' . json_encode($slotSettings->Jackpots) . '';
                            $winString = implode(',', $lineWins);
                            $response_log = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{"symDouble":' . $symDouble . ',"slotLines":' . $lines . ',"slotBet":' . $betCnt . ',"totalFreeGames":' . $slotSettings->GetGameData('DragonsGiftAMFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('DragonsGiftAMCurrentFreeGame') . ',"Balance":' . $slotSettings->GetBalance() . ',"afterBalance":' . $slotSettings->GetBalance() . ',"bonusWin":' . $slotSettings->GetGameData('DragonsGiftAMBonusWin') . ',"freeStartWin":' . $slotSettings->GetGameData('DragonsGiftAMFreeStartWin') . ',"totalWin":' . $totalWin . ',"winLines":[' . $winString . '],"bonusInfo":' . $scattersStr . ',"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
                            ...
                            if( $postData['slotEvent'] == 'freespin' ) 
                            {
                                ...
                                $cFree = dechex($slotSettings->GetGameData('DragonsGiftAMFreeGames') - $slotSettings->GetGameData('DragonsGiftAMCurrentFreeGame'));
                                $gameState = '06';
                                if( $slotSettings->GetGameData('DragonsGiftAMFreeGames') <= $slotSettings->GetGameData('DragonsGiftAMCurrentFreeGame') ) 
                                {
                                    $gameState = '0c';
                                }
                                if( $scattersCount >= 3 ) 
                                ...
                                $totalWin = $slotSettings->GetGameData('DragonsGiftAMBonusWin');
                                $bonusMpl = $slotSettings->slotFreeMpl;
                            }
                            else
                            {
                            ...
                            $slotSettings->SetGameData('DragonsGiftAMDoubleAnswer', $reelSate . $bet_h . $ln_h . $freeInfo . $freeWinState . $slotSettings->HexFormat($bonusMpl) . '1010' . $reelSate . '0' . $symCountAll . $winLinesFormated);
                            $slotSettings->SetGameData('DragonsGiftAMDoubleBalance', $balanceFormated);
                            $slotSettings->SetGameData('DragonsGiftAMDoubleWin', $totalWin);
                            if( $postData['slotEvent'] == 'freespin' ) 
                            {
                            ...
                            $slotSettings->SetGameData('DragonsGiftAMCollectP0', $response_collect0);
                            $gameState = '04';
                            $balanceFormated = $slotSettings->HexFormat(round($slotSettings->GetBalance() * $floatBet));
                            ...
                            $slotSettings->SetGameData('DragonsGiftAMCollect', $response_collect);
                            break;
                        case 'A/u254':
                            $slotSettings->SetGameData($slotSettings->slotId . 'TotalWin', 0);
                            $response = $slotSettings->GetGameData('DragonsGiftAMCollect');
                            break;
                        case 'A/u257':
                            $doubleWin = rand(1, 2);
                            $winall = $slotSettings->GetGameData('DragonsGiftAMDoubleWin');
                            $dbet = $winall;
                            $daction = $tmpPar[1];
                            ...
                            $response = '107010' . $slotSettings->GetGameData('DragonsGiftAMDoubleBalance') . strlen($winall_h) . $winall_h . $slotSettings->GetGameData('DragonsGiftAMDoubleAnswer') . implode('', $slotSettings->GetGameData($slotSettings->slotId . 'Cards'));
                            $slotSettings->SetGameData('DragonsGiftAMDoubleWin', $winall);
                            $slotSettings->SetGameData('DragonsGiftAMTotalWin', $winall);
                            $balanceFormated = $slotSettings->HexFormat(round($slotSettings->GetBalance() * $floatBet));
                            $response_collect = '104010' . $balanceFormated . strlen($winall_h) . $winall_h . $slotSettings->GetGameData('DragonsGiftAMCollectP0');
                            $slotSettings->SetGameData('DragonsGiftAMCollect', $response_collect);
                        ...
                        case 'A/u258':
                            ...
                            $slotSettings->SetGameData('DragonsGiftAMDoubleBalance', $rtnBalance);
                            $winall = sprintf('%01.2f', $winall) * $floatBet;
                            $winall_h1 = str_replace('.', '', $winall . '');
                            $winall_h = dechex($winall_h1);
                            $doubleCards = '26280b2714161d0c';
                            $response = '108010' . $slotSettings->GetGameData('DragonsGiftAMDoubleBalance') . strlen($winall_h) . $winall_h . $slotSettings->GetGameData('DragonsGiftAMDoubleAnswer') . implode('', $slotSettings->GetGameData($slotSettings->slotId . 'Cards'));
                            break;
                    }
