                ...
                \DB::transaction(function() use ($request, $game)
                {
                    try
                    {
                        ...
                        if( $postData['slotEvent'] == 'gameInit' ) 
                        {
                            ...
                            $response = '{"status":"success","microtime":0.23813390731812,"dateTime":"2020-02-18 10:17:41","error":"","content":{"cmd":"gameInit","balance":' . $balanceInCents . ',"session":"55492646_b3d33c4034356bc47136d98eae43f081","betInfo":{"denomination":0.01,"bet":' . $gameBets[0] . ',"lines":25},"betSettings":{"denomination":[0.01],"bets":[' . implode(',', $gameBets) . '],"lines":[1,5,10,15,20,25]},"symbols":' . $reelStr . ',"reels":{"base":{"1":["' . implode('","', $slotSettings->reelStrip1) . '"],"2":["' . implode('","', $slotSettings->reelStrip2) . '"],"3":["' . implode('","', $slotSettings->reelStrip3) . '"],"4":["' . implode('","', $slotSettings->reelStrip4) . '"],"5":["' . implode('","', $slotSettings->reelStrip5) . '"]},"feature":{"1":["' . implode('","', $slotSettings->reelStripBonus1) . '"],"2":["' . implode('","', $slotSettings->reelStripBonus2) . '"],"3":["' . implode('","', $slotSettings->reelStripBonus3) . '"],"4":["' . implode('","', $slotSettings->reelStripBonus4) . '"],"5":["' . implode('","', $slotSettings->reelStripBonus5) . '"]}},"exitUrl":"\/","pingInterval":60000,"restore":' . $restore . ',"freeSpin":{' . $freeStateStr . '},"hash":"af0bc9acbee8a5a9b559dfe95e6527c4"}}';
                        }
                        ...
                        {
                            $response = '{"status":"success","microtime":0.0026731491088867,"dateTime":"2020-02-13 13:23:32","error":"","content":{"cmd":"sessionInfo","serverMathematics":"\/game\/LuckyCountAT\/server","serverResources":"","sessionId":"54594109_4133a64673d3883d42cd003ee905ba3e","exitUlt":"\/","exitUrl":"\/","id":"341","name":"GameName","currency":"ALL","language":"en","type":"aristocrat","systemName":"lucky_count","version":"2","mobile":"1"}}';
                        }
                        ...
                        else if( $postData['slotEvent'] == 'gamePick' ) 
                        {
                            ...
                            if( $_POST['pick'] == 0 ) 
                            {
                                $slotSettings->SetGameData('LuckyCountATMpl', 10);
                                $slotSettings->SetGameData('LuckyCountATCurrentFreeGame', 0);
                                $slotSettings->SetGameData('LuckyCountATFreeGames', 5);
                            }
                            else if( $_POST['pick'] == 1 ) 
                            {
                                $slotSettings->SetGameData('LuckyCountATMpl', 5);
                                $slotSettings->SetGameData('LuckyCountATCurrentFreeGame', 0);
                                $slotSettings->SetGameData('LuckyCountATFreeGames', 10);
                            }
                            else if( $_POST['pick'] == 2 ) 
                            {
                                $slotSettings->SetGameData('LuckyCountATMpl', 3);
                                $slotSettings->SetGameData('LuckyCountATCurrentFreeGame', 0);
                                $slotSettings->SetGameData('LuckyCountATFreeGames', 15);
                            }
                            else if( $_POST['pick'] == 3 ) 
                            {
                                $slotSettings->SetGameData('LuckyCountATMpl', 2);
                                $slotSettings->SetGameData('LuckyCountATCurrentFreeGame', 0);
                                $slotSettings->SetGameData('LuckyCountATFreeGames', 20);
                            }
                            $response = '{"status":"success","microtime":0.0093810558319092,"dateTime":"2020-02-15 14:26:21","error":"","content":{"session":"54990161_9709e13bca7763b46396cda1868d2e7e","cmd":"gamePick","balance":' . $balanceInCents . ',"win":0,"symbols":{"1":{"1":"symbol_6","2":"symbol_9","3":"symbol_13"},"2":{"1":"symbol_10","2":"symbol_5","3":"symbol_8"},"3":{"1":"symbol_10","2":"symbol_13","3":"symbol_11"},"4":{"1":"symbol_13","2":"symbol_10","3":"symbol_6"},"5":{"1":"symbol_3","2":"symbol_8","3":"symbol_1"}},"winLines":[],"freeSpin":{"id":"54990161_20200215132548","current":0,"add":' . $slotSettings->GetGameData('LuckyCountATFreeGames') . ',"total":' . $slotSettings->GetGameData('LuckyCountATFreeGames') . ',"totalWin":' . ($slotSettings->GetGameData('LuckyCountATBonusWin') * 100) . ',"multiplayer":' . $slotSettings->GetGameData('LuckyCountATMpl') . ',"pick":' . $_POST['pick'] . '},"actionId":"54990161_10_60","hash":"1ace145628d930d28bdf38789a28a9d7"}}';
                        }
                        else if( $postData['slotEvent'] == 'slotGamble' ) 
                        {
                            ...
                            $dealerCard = '';
                            $totalWin = $slotSettings->GetGameData('LuckyCountATTotalWin');
                            $gambleWin = 0;
                            $statBet = $totalWin;
                            ...
                            $slotSettings->SetGameData('LuckyCountATTotalWin', $totalWin);
                        ...
                        else if( $postData['slotEvent'] == 'bet' || $postData['slotEvent'] == 'freespin' ) 
                        {
                            ...
                            if( $postData['slotEvent'] != 'freespin' ) 
                            {
                                ...
                                $bonusMpl = 1;
                                $slotSettings->SetGameData('LuckyCountATBonusWin', 0);
                                $slotSettings->SetGameData('LuckyCountATFreeGames', 0);
                                $slotSettings->SetGameData('LuckyCountATCurrentFreeGame', 0);
                                $slotSettings->SetGameData('LuckyCountATTotalWin', 0);
                                $slotSettings->SetGameData('LuckyCountATFreeBalance', 0);
                                $slotSettings->SetGameData('LuckyCountATMpl', 3);
                            }
                            else
                            {
                                $slotSettings->SetGameData('LuckyCountATCurrentFreeGame', $slotSettings->GetGameData('LuckyCountATCurrentFreeGame') + 1);
                                $bonusMpl = $slotSettings->GetGameData('LuckyCountATMpl');
                            }
                            $Balance = $slotSettings->GetBalance();
                            ...
                            if( $postData['slotEvent'] == 'freespin' ) 
                            {
                                $slotSettings->SetGameData('LuckyCountATBonusWin', $slotSettings->GetGameData('LuckyCountATBonusWin') + $totalWin);
                                $slotSettings->SetGameData('LuckyCountATTotalWin', $slotSettings->GetGameData('LuckyCountATTotalWin') + $totalWin);
                                $freeStateStr = '"id":"54594109_20200214110301","current":' . $slotSettings->GetGameData('LuckyCountATCurrentFreeGame') . ',"multiplayer":' . $slotSettings->GetGameData('LuckyCountATMpl') . ',"add":0,"total":' . $slotSettings->GetGameData('LuckyCountATFreeGames') . ',"totalWin":' . ($slotSettings->GetGameData('LuckyCountATBonusWin') * 100) . '';
                            }
                            else
                            {
                                $slotSettings->SetGameData('LuckyCountATTotalWin', $totalWin);
                            ...
                            if( $scattersCount >= 3 ) 
                            {
                                if( $slotSettings->GetGameData('LuckyCountATFreeGames') > 0 ) 
                                {
                                    $slotSettings->SetGameData('LuckyCountATFreeGames', $slotSettings->GetGameData('LuckyCountATFreeGames') + $slotSettings->slotFreeCount[$scattersCount]);
                                    $freeStateStr = '"id":"54594109_20200214110301","current":' . $slotSettings->GetGameData('LuckyCountATCurrentFreeGame') . ',"multiplayer":' . $slotSettings->GetGameData('LuckyCountATMpl') . ',"add":' . $slotSettings->slotFreeCount[$scattersCount] . ',"total":' . $slotSettings->GetGameData('LuckyCountATFreeGames') . ',"totalWin":' . ($slotSettings->GetGameData('LuckyCountATBonusWin') * 100) . '';
                                }
                                else
                                {
                                    $slotSettings->SetGameData('LuckyCountATFreeBalance', $Balance);
                                    $slotSettings->SetGameData('LuckyCountATBonusWin', $totalWin);
                                    $slotSettings->SetGameData('LuckyCountATFreeGames', $slotSettings->slotFreeCount[$scattersCount]);
                                    $freeStateStr = '"id":"54594109_20200214110301","current":' . $slotSettings->GetGameData('LuckyCountATCurrentFreeGame') . ',"multiplayer":' . $slotSettings->GetGameData('LuckyCountATMpl') . ',"add":' . $slotSettings->slotFreeCount[$scattersCount] . ',"total":' . $slotSettings->GetGameData('LuckyCountATFreeGames') . ',"totalWin":' . ($slotSettings->GetGameData('LuckyCountATBonusWin') * 100) . '';
                                }
                            }
                            ...
                            $response_log = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{"slotLines":' . $postData['slotLines'] . ',"slotBet":' . $postData['slotBet'] . ',"totalFreeGames":' . $slotSettings->GetGameData('LuckyCountATFreeGames') . ',"Mpl":' . $slotSettings->GetGameData('LuckyCountATMpl') . ',"currentFreeGames":' . $slotSettings->GetGameData('LuckyCountATCurrentFreeGame') . ',"Balance":' . $Balance . ',"afterBalance":' . $slotSettings->GetBalance() . ',"totalWin":' . $totalWin . ',"winLines":[' . $winString . '],"bonusInfo":{},"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
                            $reelStrArr = [];
                            for( $i = 1; $i <= 5; $i++ ) 
                            {
