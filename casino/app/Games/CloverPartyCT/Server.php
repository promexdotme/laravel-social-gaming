            ...
            function get_($request, $game)
            {
                \DB::transaction(function() use ($request, $game)
                {
                    try
                    {
                        ...
                        {
                            case 'create_session':
                                $slotSettings->SetGameData('CloverPartyCTCards', [
                                    19, 
                                    44, 
                                    0, 
                                    37, 
                            ...
                            case 'init_game':
                                ...
                                $slotSettings->SetGameData('CloverPartyCTBonusWin', 0);
                                $slotSettings->SetGameData('CloverPartyCTFreeGames', 0);
                                $slotSettings->SetGameData('CloverPartyCTCurrentFreeGame', 0);
                                $slotSettings->SetGameData('CloverPartyCTCurrentFreeGame0', 0);
                                $slotSettings->SetGameData('CloverPartyCTTotalWin', 0);
                                $slotSettings->SetGameData('CloverPartyCTFreeBalance', 0);
                                ...
                                if( $lastEvent != 'NULL' ) 
                                {
                                    ...
                                    if( $slotSettings->GetGameData('CloverPartyCTCurrentFreeGame') < $slotSettings->GetGameData('CloverPartyCTFreeGames') && $slotSettings->GetGameData('CloverPartyCTFreeGames') > 0 ) 
                                    {
                            ...
                            case 'poll':
                                ...
                                {
                                    $balanceInCents = sprintf('%01.2f', $slotSettings->GetBalance() - $slotSettings->GetGameData('CloverPartyCTTotalWin')) * 100;
                                }
                            ...
                            case 'game_finished':
                                $slotSettings->SetGameData('CloverPartyCTBonusWin', 0);
                                $slotSettings->SetGameData('CloverPartyCTTotalWin', 0);
                                $responseData['game_finished'][0]['freeround_play'] = $slotSettings->GetGameData('CloverPartyCTCurrentFreeGame0');
                            ...
                            case 'subgame_finished':
                                if( $slotSettings->GetGameData('CloverPartyCTCurrentFreeGame0') < $slotSettings->GetGameData('CloverPartyCTFreeGames') && $slotSettings->GetGameData('CloverPartyCTFreeGames') > 0 ) 
                                {
                                    ...
                                    $response = '{"responseEvent":"spin","responseType":"freespin","serverResponse":{"result":' . json_encode($result) . ',"slotDenom":' . $slotSettings->GetGameData($slotSettings->slotId . 'Denom') . ',"slotLines":' . $lines . ',"slotBet":' . $betline . ',"totalFreeGames":' . $slotSettings->GetGameData('CloverPartyCTFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('CloverPartyCTCurrentFreeGame0') . ',"Balance":' . $slotSettings->GetGameData('CloverPartyCTFreeBalance') . ',"afterBalance":' . $slotSettings->GetGameData('CloverPartyCTFreeBalance') . ',"bonusWin":' . $slotSettings->GetGameData('CloverPartyCTBonusWin') . ',"totalWin":' . $reportWin . ',"winLines":[],"Jackpots":[],"reelsSymbols":' . json_encode($slotSettings->GetGameData($slotSettings->slotId . 'Reels')) . '}}';
                                    if( $slotSettings->GetGameData('CloverPartyCTFreeGames') <= $slotSettings->GetGameData('CloverPartyCTCurrentFreeGame0') ) 
                                    {
                                        if( $reportWin > 0 ) 
                                        {
                                    ...
                                    $balanceInCents = $slotSettings->GetGameData('CloverPartyCTFreeBalance');
                                    $responseData['subgame_finished'][0]['account_status']['credit'] = round($balanceInCents);
                                    $responseData['subgame_finished'][0]['freeround_play'] = $slotSettings->GetGameData('CloverPartyCTCurrentFreeGame0');
                                    $responseData['subgame_finished'][1]['freeround_play'] = $slotSettings->GetGameData('CloverPartyCTCurrentFreeGame0');
                            ...
                            case 'play':
                                ...
                                for( $spinLoop = 0; $spinLoop < $spinLoopLimit; $spinLoop++ ) 
                                {
                                    ...
                                    if( $postData['slotEvent'] != 'freespin' ) 
                                    {
                                        ...
                                        $slotSettings->SetGameData('CloverPartyCTCurrentFreeGame0', 0);
                                        $slotSettings->SetGameData('CloverPartyCTTotalWin', 0);
                                        $slotSettings->SetGameData('CloverPartyCTFreeBalance', sprintf('%01.2f', $slotSettings->GetBalance()) * 100);
                                    ...
                                    {
                                        $slotSettings->SetGameData('CloverPartyCTCurrentFreeGame', $slotSettings->GetGameData('CloverPartyCTCurrentFreeGame') + 1);
                                    ...
                                    if( $postData['slotEvent'] == 'freespin' ) 
                                    {
                                        $slotSettings->SetGameData('CloverPartyCTBonusWin', $slotSettings->GetGameData('CloverPartyCTBonusWin') + $totalWin);
                                        $slotSettings->SetGameData('CloverPartyCTTotalWin', $slotSettings->GetGameData('CloverPartyCTTotalWin') + $totalWin);
                                        $balanceInCents = $slotSettings->GetGameData('CloverPartyCTFreeBalance');
                                    }
                                    else
                                    {
                                        $slotSettings->SetGameData('CloverPartyCTTotalWin', $totalWin);
                                    }
                                    $fs = 0;
                                    if( $scattersCount >= 3 ) 
                                    {
                                    ...
                                    $winstring = '';
                                    $slotSettings->SetGameData('CloverPartyCTGambleStep', 5);
                                    $hist = $slotSettings->GetGameData('CloverPartyCTCards');
                                    if( $postData['slotEvent'] == 'freespin' ) 
                                    {
                                        $state = 'freespin';
                                        ...
                                        if( $slotSettings->GetGameData($slotSettings->slotId . 'FreeGames') <= $slotSettings->GetGameData($slotSettings->slotId . 'CurrentFreeGame') && $slotSettings->GetGameData('CloverPartyCTBonusWin') > 0 ) 
                                        {
                                            $responseData['play'][0]['result'][$spinLoop]['is_free'] = true;
                                    ...
                                    $responseData['play'][0]['result'][$spinLoop]['total_win'] = $slotSettings->GetGameData('CloverPartyCTTotalWin') / $denom;
                                ...
                                $response = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{"result":' . json_encode($responseData['play'][0]['result']) . ',"slotDenom":' . $denom . ',"slotLines":' . $lines . ',"slotBet":' . $betline . ',"totalFreeGames":' . $slotSettings->GetGameData('CloverPartyCTFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('CloverPartyCTCurrentFreeGame0') . ',"Balance":' . $slotSettings->GetGameData($slotSettings->slotId . 'FreeBalance') . ',"afterBalance":' . $slotSettings->GetBalance() . ',"bonusWin":' . $slotSettings->GetGameData('CloverPartyCTBonusWin') . ',"totalWin":' . $totalWin . ',"winLines":[],"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
                            ...
                            case 'gamble':
                                ...
                                $dealerCard = '';
                                $totalWin = $slotSettings->GetGameData('CloverPartyCTTotalWin');
                                $gambleWin = 0;
                                $statBet = $totalWin;
                                ...
                                $hist = $slotSettings->GetGameData('CloverPartyCTCards');
                                $slotSettings->SetGameData('CloverPartyCTGambleStep', $slotSettings->GetGameData('CloverPartyCTGambleStep') - 1);
                                if( $slotSettings->MaxWin < ($totalWin * $slotSettings->CurrentDenom) ) 
                                {
                                    $isGambleWin = 0;
                                }
                                ...
                                else
                                {
                                    ...
                                    $totalWin = 0;
                                    $slotSettings->SetGameData('CloverPartyCTGambleStep', 0);
                                    if( $postData['continue_params']['double_key'] != 'red' && $postData['continue_params']['double_key'] != 'black' ) 
                                    {
                                        if( $postData['continue_params']['double_key'] == 'diamond' ) 
                                        {
                                ...
                                $slotSettings->SetGameData('CloverPartyCTCards', $hist);
