                ...
                \DB::transaction(function() use ($request, $game)
                {
                    try
                    {
                        ...
                        else if( $postData['slotEvent'] == 'gamble5GetUserCards' ) 
                        {
                            ...
                            $dealerCard = $slotSettings->GetGameData('ExtremeRichesGTDealerCard');
                            $totalWin = $slotSettings->GetGameData('ExtremeRichesGTTotalWin');
                            $gambleWin = 0;
                            ...
                            $slotSettings->SetGameData('ExtremeRichesGTTotalWin', $totalWin);
                        ...
                        else if( $postData['slotEvent'] == 'gamble5GetDealerCard' ) 
                        {
                            ...
                            $slotSettings->SetGameData('ExtremeRichesGTDealerCard', $tmpDc);
                        ...
                        else if( $postData['slotEvent'] == 'bet' || $postData['slotEvent'] == 'freespin' ) 
                        {
                            ...
                            if( $postData['slotEvent'] != 'freespin' ) 
                            {
                                ...
                                $jackState = $slotSettings->UpdateJackpots($postData['slotBet'] * $postData['slotLines'], $slotSettings->GetGameData('ExtremeRichesGTFreeMpl') - 1, false);
                                $slotSettings->SetBalance(-1 * ($postData['slotBet'] * $postData['slotLines']), $postData['slotEvent']);
                                $bonusMpl = 1;
                                $slotSettings->SetGameData('ExtremeRichesGTBonusWin', 0);
                                $slotSettings->SetGameData('ExtremeRichesGTFreeGames', 0);
                                $slotSettings->SetGameData('ExtremeRichesGTCurrentFreeGame', 0);
                                $slotSettings->SetGameData('ExtremeRichesGTTotalWin', 0);
                                $slotSettings->SetGameData('ExtremeRichesGTFreeBalance', 0);
                                $slotSettings->SetGameData('ExtremeRichesGTFreeMpl', 1);
                            }
                            else
                            {
                                $jackState = $slotSettings->UpdateJackpots($postData['slotBet'] * $postData['slotLines'], 0, true);
                                $slotSettings->SetGameData('ExtremeRichesGTCurrentFreeGame', $slotSettings->GetGameData('ExtremeRichesGTCurrentFreeGame') + 1);
                                $bonusMpl = $slotSettings->GetGameData('ExtremeRichesGTFreeMpl');
                            }
                            $Balance = $slotSettings->GetBalance();
                            for( $i = 0; $i <= 2000; $i++ ) 
                            {
                                    ...
                                    for( $j = 0; $j < count($slotSettings->SymbolGame); $j++ ) 
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            if( $s[0] == $csym || in_array($s[0], $wild) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":1,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('ExtremeRichesGTBonusWin')) . ',"winReel1":[' . ($linesId[$k + 1][0] - 1) . ',"' . $s[0] . '"],"winReel2":["none","none"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":2,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('ExtremeRichesGTBonusWin')) . ',"winReel1":[' . ($linesId[$k + 1][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k + 1][1] - 1) . ',"' . $s[1] . '"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            $s[0] = $reels['reel1'][$linesId[$k + 1][0] - 1];
                                            $s[1] = $reels['reel2'][$linesId[$k + 1][1] - 1];
                                            ...
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":3,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('ExtremeRichesGTBonusWin')) . ',"winReel1":[' . ($linesId[$k + 1][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k + 1][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k + 1][2] - 1) . ',"' . $s[2] . '"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            $s[0] = $reels['reel1'][$linesId[$k + 1][0] - 1];
                                            $s[1] = $reels['reel2'][$linesId[$k + 1][1] - 1];
                                            ...
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) && ($s[3] == $csym || in_array($s[3], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":4,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('ExtremeRichesGTBonusWin')) . ',"winReel1":[' . ($linesId[$k + 1][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k + 1][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k + 1][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k + 1][3] - 1) . ',"' . $s[3] . '"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            $s[0] = $reels['reel1'][$linesId[$k + 1][0] - 1];
                                            $s[1] = $reels['reel2'][$linesId[$k + 1][1] - 1];
                                            ...
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) && ($s[3] == $csym || in_array($s[3], $wild)) && ($s[4] == $csym || in_array($s[4], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":5,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('ExtremeRichesGTBonusWin')) . ',"winReel1":[' . ($linesId[$k + 1][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k + 1][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k + 1][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k + 1][3] - 1) . ',"' . $s[3] . '"],"winReel5":[' . ($linesId[$k + 1][4] - 1) . ',"' . $s[4] . '"]}';
                                                }
                                            }
                                        }
                                    }
                            ...
                            if( $postData['slotEvent'] == 'freespin' && $slotSettings->GetGameData('ExtremeRichesGTFreeGames') <= $slotSettings->GetGameData('ExtremeRichesGTCurrentFreeGame') && $winType != 'bonus' && $slotSettings->GetGameData('ExtremeRichesGTTotalWin') + $totalWin > 0 ) 
                            {
                                $slotSettings->SetBalance($slotSettings->GetGameData('ExtremeRichesGTTotalWin') + $totalWin);
                            }
                            ...
                            if( $postData['slotEvent'] == 'freespin' ) 
                            {
                                $slotSettings->SetGameData('ExtremeRichesGTBonusWin', $slotSettings->GetGameData('ExtremeRichesGTBonusWin') + $totalWin);
                                $slotSettings->SetGameData('ExtremeRichesGTTotalWin', $slotSettings->GetGameData('ExtremeRichesGTTotalWin') + $totalWin);
                                $totalWin = $slotSettings->GetGameData('ExtremeRichesGTBonusWin');
                                $Balance = $slotSettings->GetGameData('ExtremeRichesGTFreeBalance');
                            }
                            else
                            {
                                $slotSettings->SetGameData('ExtremeRichesGTTotalWin', $totalWin);
                            ...
                            if( $scattersCount >= 3 ) 
                            {
                                if( $slotSettings->GetGameData('ExtremeRichesGTFreeGames') > 0 ) 
                                {
                                    $slotSettings->SetGameData('ExtremeRichesGTFreeBalance', $Balance);
                                    $slotSettings->SetGameData('ExtremeRichesGTBonusWin', $totalWin);
                                    $slotSettings->SetGameData('ExtremeRichesGTFreeGames', $slotSettings->GetGameData('ExtremeRichesGTFreeGames') + $slotSettings->slotFreeCount);
                                    $slotSettings->SetGameData('ExtremeRichesGTFreeMpl', $slotSettings->GetGameData('ExtremeRichesGTFreeMpl') + 1);
                                }
                                else
                                {
                                    $slotSettings->SetGameData('ExtremeRichesGTFreeBalance', $Balance);
                                    $slotSettings->SetGameData('ExtremeRichesGTBonusWin', $totalWin);
                                    $slotSettings->SetGameData('ExtremeRichesGTFreeGames', $slotSettings->slotFreeCount);
                                    $slotSettings->SetGameData('ExtremeRichesGTFreeMpl', 2);
                                }
                            }
                            $jsSpin = '' . json_encode($reels) . '';
                            $jsJack = '' . json_encode($slotSettings->Jackpots) . '';
                            $winString = implode(',', $lineWins);
                            $response = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{"slotLines":' . $postData['slotLines'] . ',"slotBet":' . $postData['slotBet'] . ',"slotFreeMpl":' . $slotSettings->GetGameData('ExtremeRichesGTFreeMpl') . ',"slotJackpot":[' . implode(',', $slotSettings->slotJackpot) . '],"totalFreeGames":' . $slotSettings->GetGameData('ExtremeRichesGTFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('ExtremeRichesGTCurrentFreeGame') . ',"Balance":' . $Balance . ',"afterBalance":' . $slotSettings->GetBalance() . ',"totalWin":' . $totalWin . ',"winLines":[' . $winString . '],"bonusInfo":' . $scattersStr . ',"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
