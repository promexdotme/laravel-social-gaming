                    ...
                    try
                    {
                        ...
                        if( isset($postData['spinType']) ) 
                        {
                            ...
                            if( $postData['spinType'] == 'regular' ) 
                            {
                                ...
                                $bonusMpl = 1;
                                $slotSettings->SetGameData('SantaSurprisePTMBonusWin', 0);
                                $slotSettings->SetGameData('SantaSurprisePTMFreeGames', 0);
                                $slotSettings->SetGameData('SantaSurprisePTMCurrentFreeGame', 0);
                                $slotSettings->SetGameData('SantaSurprisePTMTotalWin', 0);
                                $slotSettings->SetGameData('SantaSurprisePTMFreeBalance', 0);
                                $slotSettings->SetGameData('SantaSurprisePTMFreeStartWin', 0);
                                $chosenTree = 0;
                                $startStick = 0;
                                $treeStep = [
                                    -1, 
                                ...
                                $slotSettings->SetGameData('SantaSurprisePTMChosenTree', $chosenTree);
                                $slotSettings->SetGameData('SantaSurprisePTMstartStick', $startStick);
                                $slotSettings->SetGameData('SantaSurprisePTMtreeStep', $treeStep);
                                $slotSettings->SetGameData('SantaSurprisePTMlastWins', $lastWins);
                            }
                            else if( $postData['spinType'] == 'free' ) 
                            {
                                $umid = '0';
                                $postData['slotEvent'] = 'freespin';
                                $slotSettings->SetGameData('SantaSurprisePTMCurrentFreeGame', $slotSettings->GetGameData('SantaSurprisePTMCurrentFreeGame') + 1);
                            ...
                            $slotSettings->SetGameData('SantaSurprisePTMAllBet', $postData['bet']);
                            $slotSettings->SetGameData('SantaSurprisePTMBetLine', $betLine);
                            ...
                            for( $i = 0; $i <= 2000; $i++ ) 
                            {
                                    ...
                                    for( $j = 0; $j < count($slotSettings->SymbolGame); $j++ ) 
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            if( $s[0] == $csym || in_array($s[0], $wild) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":1,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('SantaSurprisePTMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":["none","none"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":2,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('SantaSurprisePTMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":3,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('SantaSurprisePTMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) && ($s[3] == $csym || in_array($s[3], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":4,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('SantaSurprisePTMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) && ($s[3] == $csym || in_array($s[3], $wild)) && ($s[4] == $csym || in_array($s[4], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":5,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('SantaSurprisePTMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":[' . ($linesId[$k][4] - 1) . ',"' . $s[4] . '"]}';
                                                }
                                            }
                                            if( $csym == '9' ) 
                                            {
                                ...
                                else
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        if( ($scattersCount >= 3 || $prizeBonusStart) && $winType != 'bonus' ) 
                                        {
                                        }
                            ...
                            if( $postData['slotEvent'] == 'freespin' ) 
                            {
                                $slotSettings->SetGameData('SantaSurprisePTMBonusWin', $slotSettings->GetGameData('SantaSurprisePTMBonusWin') + $totalWin);
                                $slotSettings->SetGameData('SantaSurprisePTMTotalWin', $totalWin);
                            }
                            else
                            {
                                $slotSettings->SetGameData('SantaSurprisePTMTotalWin', $totalWin);
                            ...
                            if( $scattersCount >= 3 ) 
                            {
                                if( $slotSettings->GetGameData('SantaSurprisePTMFreeGames') > 0 ) 
                                {
                                    $slotSettings->SetGameData('SantaSurprisePTMFreeGames', $slotSettings->GetGameData('SantaSurprisePTMFreeGames') + $slotSettings->slotFreeCount);
                                }
                                else
                                {
                                    $slotSettings->SetGameData('SantaSurprisePTMFreeStartWin', $totalWin);
                                    $slotSettings->SetGameData('SantaSurprisePTMBonusWin', 0);
                                    $slotSettings->SetGameData('SantaSurprisePTMFreeGames', $slotSettings->slotFreeCount);
                                }
                            }
                            ...
                            if( $prizeBonusStart ) 
                            {
                                ...
                                $slotSettings->SetGameData('SantaSurprisePTMWinValues', $prizeResult['curValues']);
                                $slotSettings->SetGameData('SantaSurprisePTMPickedCount', 0);
                                $slotSettings->SetGameData('SantaSurprisePTMPickedCountArr', []);
                                $slotSettings->SetGameData('SantaSurprisePTMprizeBonusNum', $prizeBonusNum);
                            }
                            $response = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{' . $bStr . '"allbet":' . $slotSettings->GetGameData('SantaSurprisePTMAllBet') . ',"betLine":' . $slotSettings->GetGameData('SantaSurprisePTMBetLine') . ',"linesArr":[' . implode(',', $postData['lines']) . '],"slotLines":' . $lines . ',"slotBet":' . $betLine . ',"totalFreeGames":' . $slotSettings->GetGameData('SantaSurprisePTMFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('SantaSurprisePTMCurrentFreeGame') . ',"Balance":' . $slotSettings->GetBalance() . ',"afterBalance":' . $slotSettings->GetBalance() . ',"bonusWin":' . $slotSettings->GetGameData('SantaSurprisePTMBonusWin') . ',"freeStartWin":' . $slotSettings->GetGameData('SantaSurprisePTMFreeStartWin') . ',"totalWin":' . $totalWin . ',"winLines":[' . $winString . '],"bonusInfo":' . $scattersStr . ',"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
                            $slotSettings->SetGameData('SantaSurprisePTMLastResponse', $response);
                            $slotSettings->SaveLogReport($response, $betLine, $lines, $reportWin, $postData['slotEvent']);
                        }
                        switch( $umid ) 
                        {
                            case '40145':
                                if( $postData['pickIndex'] >= 0 && $slotSettings->GetGameData('SantaSurprisePTMPickedCount') < $slotSettings->GetGameData('SantaSurprisePTMprizeBonusNum') ) 
                                {
                                    $lr = json_decode($slotSettings->GetGameData('SantaSurprisePTMLastResponse'));
                                    $values = $slotSettings->GetGameData('SantaSurprisePTMWinValues');
                                    $pick = $slotSettings->GetGameData('SantaSurprisePTMPickedCount');
                                    $pickArr = $slotSettings->GetGameData('SantaSurprisePTMPickedCountArr');
                                    $reportWin = $values[$pick] * $slotSettings->GetGameData('SantaSurprisePTMBetLine');
                                    $slotSettings->SetBalance($reportWin);
                                    $pick++;
                                    $pickArr[] = $postData['pickIndex'];
                                    $slotSettings->SetGameData('SantaSurprisePTMPickedCount', $pick);
                                    $slotSettings->SetGameData('SantaSurprisePTMPickedCountArr', $pickArr);
                                    $lr->serverResponse->PickedCount = $pick;
                                    $lr->serverResponse->PickedCountArr = $pickArr;
                                    $slotSettings->SaveLogReport(json_encode($lr), 0, 0, $reportWin, 'prize_bonus');
                                    $slotSettings->SetGameData('SantaSurprisePTMLastResponse', json_encode($lr));
                                }
                                $result_tmp[] = '3:::{"data":{"pickedIndex":' . $postData['pickIndex'] . ',"windowId":"ohzB06"},"ID":49298,"umid":204}';
                                break;
                            case '31031':
                            ...
                            case '40066':
                                ...
                                $result_tmp[] = '3:::{"data":{"funNoticeGames":0,"funNoticePayouts":0,"gameGroup":"ssp","minBet":0,"maxBet":0,"minPosBet":0,"maxPosBet":50000,"coinSizes":[' . implode(',', $gameBets) . ']},"ID":40025,"umid":21}';
                                break;
                            case '40036':
                                ...
                                if( $lastEvent != 'NULL' ) 
                                {
                                    ...
                                    $slotSettings->SetGameData('SantaSurprisePTMLastResponse', json_encode($lastEvent));
                                    $slotSettings->SetGameData('SantaSurprisePTMWinValues', $lastEvent->serverResponse->winValues);
                                    $slotSettings->SetGameData('SantaSurprisePTMPickedCount', $lastEvent->serverResponse->PickedCount);
                                    $slotSettings->SetGameData('SantaSurprisePTMPickedCountArr', $lastEvent->serverResponse->PickedCountArr);
                                    $slotSettings->SetGameData('SantaSurprisePTMPrizeNum', $lastEvent->serverResponse->prizeBonusNum);
                                    $slotSettings->SetGameData('SantaSurprisePTMEprizeBonusNum', $lastEvent->serverResponse->prizeBonusNum);
                                    if( $slotSettings->GetGameData($slotSettings->slotId . 'CurrentFreeGame') < $slotSettings->GetGameData($slotSettings->slotId . 'FreeGames') && $slotSettings->GetGameData($slotSettings->slotId . 'FreeGames') > 0 ) 
                                    {
                                        $slotSettings->SetGameData($slotSettings->slotId . 'brokenGames', 'ssp');
                                    }
                                    if( $lastEvent->responseType == 'prize_bonus' && $slotSettings->GetGameData('SantaSurprisePTMPickedCount') < $slotSettings->GetGameData('SantaSurprisePTMEprizeBonusNum') ) 
                                    {
                                        $slotSettings->SetGameData($slotSettings->slotId . 'brokenGames', 'ssp');
                                    }
                                    $slotSettings->SetGameData('SantaSurprisePTMresponseType', $lastEvent->responseType);
                                }
                            ...
                            case '40030':
                                ...
                                {
                                    if( $slotSettings->GetGameData('SantaSurprisePTMresponseType') == 'prize_bonus' ) 
                                    {
                                        $values = $slotSettings->GetGameData('SantaSurprisePTMWinValues');
                                        $pick = $slotSettings->GetGameData('SantaSurprisePTMPickedCount');
                                        $pickArr = $slotSettings->GetGameData('SantaSurprisePTMPickedCountArr');
                                        $result_tmp[] = '3:::{"data":{"bonusIdentificator":"ssp_bonusgame' . $slotSettings->GetGameData('SantaSurprisePTMPrizeNum') . '","freespins":{"numFreeSpins":0,"coinsize":' . ($slotSettings->GetGameData($slotSettings->slotId . 'Bet') * 100) . ',"rows":[' . implode(',', $slotSettings->GetGameData($slotSettings->slotId . 'LinesArr')) . '],"gamewin":' . ($slotSettings->GetGameData($slotSettings->slotId . 'FreeStartWin') * 100) . ',"freespinwin":0,"freespinTriggerReels":[46,98,125,2,44],"coins":1,"multiplier":1,"mode":0,"startBonus":1},"winValues":[' . implode(',', $values) . '],"pickIndexes":[' . implode(',', $pickArr) . '],"reelinfo":[46,98,125,2,44],"windowId":"miFjES"},"ID":40141,"umid":29}';
                                    }
                                    else
                                    {
                                        $result_tmp[] = '3:::{"data":{"bonusIdentificator":"ssp_freegames","freespins":{"numFreeSpins":' . ($slotSettings->GetGameData($slotSettings->slotId . 'FreeGames') - $slotSettings->GetGameData($slotSettings->slotId . 'CurrentFreeGame')) . ',"coinsize":' . ($slotSettings->GetGameData($slotSettings->slotId . 'Bet') * 100) . ',"rows":[' . implode(',', $slotSettings->GetGameData($slotSettings->slotId . 'LinesArr')) . '],"gamewin":' . ($slotSettings->GetGameData($slotSettings->slotId . 'FreeStartWin') * 100) . ',"freespinwin":' . ($slotSettings->GetGameData($slotSettings->slotId . 'BonusWin') * 100) . ',"freespinTriggerReels":[65,102,126,126,42],"coins":1,"multiplier":3,"mode":1,"startBonus":1},"reelinfo":[99,58,67,110,96],"windowId":"NdXGjL"},"ID":40141,"umid":31}';
                                    }
                                }
                                break;
                            case '48300':
