                    ...
                    try
                    {
                        ...
                        if( isset($postData['spinType']) ) 
                        {
                            ...
                            if( $postData['spinType'] == 'regular' ) 
                            {
                                ...
                                $bonusMpl = 1;
                                $slotSettings->SetGameData('PrinceOfOlympusJPPTMBonusWin', 0);
                                $slotSettings->SetGameData('PrinceOfOlympusJPPTMFreeGames', 0);
                                $slotSettings->SetGameData('PrinceOfOlympusJPPTMCurrentFreeGame', 0);
                                $slotSettings->SetGameData('PrinceOfOlympusJPPTMTotalWin', 0);
                                $slotSettings->SetGameData('PrinceOfOlympusJPPTMFreeBalance', 0);
                                $slotSettings->SetGameData('PrinceOfOlympusJPPTMFreeStartWin', 0);
                                $slotSettings->SetGameData('PrinceOfOlympusJPPTMFreeMpl', $slotSettings->slotFreeMpl);
                                $slotSettings->SetGameData('PrinceOfOlympusJPPTMIncreaseMpl', 0);
                                $slotSettings->SetGameData('PrinceOfOlympusJPPTMBonusStep', 0);
                            }
                            else if( $postData['spinType'] == 'free' || $postData['spinType'] == 're' ) 
                            {
                                $umid = '0';
                                $postData['slotEvent'] = 'freespin';
                                $slotSettings->SetGameData('PrinceOfOlympusJPPTMCurrentFreeGame', $slotSettings->GetGameData('PrinceOfOlympusJPPTMCurrentFreeGame') + 1);
                                $slotSettings->SetGameData('PrinceOfOlympusJPPTMIncreaseMpl', $slotSettings->GetGameData('PrinceOfOlympusJPPTMIncreaseMpl') + 1);
                                if( $slotSettings->GetGameData('PrinceOfOlympusJPPTMBonusStep') != 1 ) 
                                {
                                    $bonusMpl = 3;
                                }
                                else
                            ...
                            for( $i = 0; $i <= 2000; $i++ ) 
                            {
                                ...
                                if( $slotSettings->GetGameData('PrinceOfOlympusJPPTMBonusStep') == 1 && $postData['slotEvent'] == 'freespin' ) 
                                {
                                    $reels['reel3'][0] = 0;
                                    $reels['reel3'][1] = 0;
                                    $reels['reel3'][2] = 0;
                                    ...
                                    for( $j = 0; $j < count($slotSettings->SymbolGame); $j++ ) 
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            if( $s[0] == $csym || in_array($s[0], $wild) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":1,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('PrinceOfOlympusJPPTMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":["none","none"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":2,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('PrinceOfOlympusJPPTMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":3,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('PrinceOfOlympusJPPTMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) && ($s[3] == $csym || in_array($s[3], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":4,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('PrinceOfOlympusJPPTMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) && ($s[3] == $csym || in_array($s[3], $wild)) && ($s[4] == $csym || in_array($s[4], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":5,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('PrinceOfOlympusJPPTMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":[' . ($linesId[$k][4] - 1) . ',"' . $s[4] . '"]}';
                                                }
                                            }
                                        }
                                    }
                                ...
                                else
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        if( $postData['slotEvent'] == 'freespin' && $totalWin <= $spinWinLimit && $slotSettings->GetGameData('PrinceOfOlympusJPPTMBonusStep') == 1 ) 
                                        {
                                            break;
                                        }
                                        if( ($scattersCount >= 3 || $scattersCount2 >= 2 || $scattersCount3 >= 3 || $scattersCount4 >= 1 && $slotSettings->GetGameData('PrinceOfOlympusJPPTMBonusStep') != 1) && $winType != 'bonus' && $postData['slotEvent'] != 'freespin' ) 
                                        {
                                        }
                                        else
                                        {
                                            if( $scattersCount2 >= 2 ) 
                                            {
                                                ...
                                                $slotSettings->SetGameData('PrinceOfOlympusJPPTMHydraBonusArr', $hBonusWinArr);
                                                $slotSettings->SetGameData('PrinceOfOlympusJPPTMHydraBonusMpl', $hBonusMpl);
                                                $totalWin += $hBonusWin;
                                            }
                            ...
                            if( $postData['slotEvent'] == 'freespin' ) 
                            {
                                $slotSettings->SetGameData('PrinceOfOlympusJPPTMBonusWin', $slotSettings->GetGameData('PrinceOfOlympusJPPTMBonusWin') + $totalWin);
                                $slotSettings->SetGameData('PrinceOfOlympusJPPTMTotalWin', $totalWin);
                            }
                            else
                            {
                                $slotSettings->SetGameData('PrinceOfOlympusJPPTMTotalWin', $totalWin);
                            }
                            $slotSettings->SetGameData('PrinceOfOlympusJPPTMBonusStart', false);
                            if( $scattersCount >= 3 ) 
                            {
                                $slotSettings->SetGameData('PrinceOfOlympusJPPTMBonusStart', true);
                                $slotSettings->SetGameData('PrinceOfOlympusJPPTMBonusStep', 0);
                                if( $slotSettings->GetGameData('PrinceOfOlympusJPPTMFreeGames') > 0 ) 
                                {
                                    $slotSettings->SetGameData('PrinceOfOlympusJPPTMFreeGames', $slotSettings->GetGameData('PrinceOfOlympusJPPTMFreeGames') + $slotSettings->slotFreeCount);
                                }
                                else
                                {
                                    $slotSettings->SetGameData('PrinceOfOlympusJPPTMIncreaseMpl', 0);
                                    $slotSettings->SetGameData('PrinceOfOlympusJPPTMFreeStartWin', $totalWin);
                                    $slotSettings->SetGameData('PrinceOfOlympusJPPTMBonusWin', 0);
                                    $slotSettings->SetGameData('PrinceOfOlympusJPPTMFreeGames', $slotSettings->slotFreeCount);
                                }
                            }
                            if( $scattersCount4 >= 1 ) 
                            {
                                $slotSettings->SetGameData('PrinceOfOlympusJPPTMBonusStart', true);
                                $slotSettings->SetGameData('PrinceOfOlympusJPPTMBonusStep', 1);
                            }
                            $balanceInCents = sprintf('%01.2f', $slotSettings->GetBalance()) * 100;
                            $spinState = 'REGULAR';
                            ...
                            $isBonus = 'false';
                            if( $slotSettings->GetGameData('PrinceOfOlympusJPPTMBonusStart') ) 
                            {
                                $isBonus = 'true';
                            }
                            ...
                            $response = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{"IncreaseMpl":' . $slotSettings->GetGameData('PrinceOfOlympusJPPTMIncreaseMpl') . ',"linesArr":[' . implode(',', $postData['lines']) . '],"slotLines":' . $lines . ',"slotBet":' . $betLine . ',"totalFreeGames":' . $slotSettings->GetGameData('PrinceOfOlympusJPPTMFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('PrinceOfOlympusJPPTMCurrentFreeGame') . ',"Balance":' . $slotSettings->GetBalance() . ',"afterBalance":' . $slotSettings->GetBalance() . ',"bonusWin":' . $slotSettings->GetGameData('PrinceOfOlympusJPPTMBonusWin') . ',"FreeMpl":' . $slotSettings->GetGameData('PrinceOfOlympusJPPTMFreeMpl') . ',"freeStartWin":' . $slotSettings->GetGameData('PrinceOfOlympusJPPTMFreeStartWin') . ',"totalWin":' . $totalWin . ',"winLines":[' . $winString . '],"bonusInfo":' . $scattersStr . ',"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
                        ...
                        switch( $umid ) 
                        {
                            case '47850':
                                if( $postData['stage'] == 0 ) 
                                {
                                    $BonusWinArr = $slotSettings->GetGameData('PrinceOfOlympusJPPTMHydraBonusArr');
                                    ...
                                    $slotSettings->SetGameData('PrinceOfOlympusJPPTMHydraBonusArr', $BonusWinArr);
                                }
                                else
                                {
                                    $mpls = [
                                    ...
                                    $mpls[$postData['pickIndex']] = $slotSettings->GetGameData('PrinceOfOlympusJPPTMHydraBonusMpl');
