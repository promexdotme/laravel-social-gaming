                    ...
                    switch( $gameData['slotEvent'] ) 
                    {
                        ...
                        case 'A/u25':
                            ...
                            if( $lastEvent != 'NULL' ) 
                            {
                                ...
                                $slotSettings->SetGameData('FlyingDutchmanAMLines', $curLines);
                                $freeMpl = '11';
                                $slotSettings->SetGameData('FlyingDutchmanAMBonusWin', $lastEvent->serverResponse->bonusWin);
                                $slotSettings->SetGameData('FlyingDutchmanAMFreeGames', $lastEvent->serverResponse->totalFreeGames);
                                $slotSettings->SetGameData('FlyingDutchmanAMCurrentFreeGame', $lastEvent->serverResponse->currentFreeGames);
                                $slotSettings->SetGameData('FlyingDutchmanAMTotalWin', 0);
                                $slotSettings->SetGameData('FlyingDutchmanAMFreeBalance', 0);
                                $slotSettings->SetGameData('FlyingDutchmanAMFreeStartWin', 0);
                                $tFree = dechex($slotSettings->GetGameData('FlyingDutchmanAMFreeGames'));
                                $cFree = dechex($slotSettings->GetGameData('FlyingDutchmanAMFreeGames') - $slotSettings->GetGameData('FlyingDutchmanAMCurrentFreeGame'));
                                $freeInfo = strlen($tFree) . $tFree . strlen($cFree) . $cFree;
                                $stateWin = $slotSettings->HexFormat($slotSettings->GetGameData('FlyingDutchmanAMBonusWin') * $floatBet);
                                if( $slotSettings->GetGameData('FlyingDutchmanAMCurrentFreeGame') < $slotSettings->GetGameData('FlyingDutchmanAMFreeGames') && $slotSettings->GetGameData('FlyingDutchmanAMFreeGames') > 0 ) 
                                {
                                    $slotState = '6';
                            ...
                            {
                                $slotSettings->SetGameData('FlyingDutchmanAMLines', $fixedLinesFormated);
                                $slotState = '4';
                            ...
                            break;
                        case 'A/u250':
                            $fixedLinesFormated = $slotSettings->GetGameData('FlyingDutchmanAMLines');
                            $balanceFormated = $slotSettings->HexFormat(round($slotSettings->GetBalance() * $floatBet));
                            $lastEvent = $slotSettings->GetHistory();
                            if( $lastEvent != 'NULL' ) 
                            {
                        ...
                        case 'A/u251':
                            if( $postData['spinType'] == 'regular' && $slotSettings->GetGameData($slotSettings->slotId . 'FreeGames') <= $slotSettings->GetGameData($slotSettings->slotId . 'CurrentFreeGame') ) 
                            {
                                ...
                                $bonusMpl = 1;
                                $slotSettings->SetGameData('FlyingDutchmanAMBonusWin', 0);
                                $slotSettings->SetGameData('FlyingDutchmanAMFreeGames', 0);
                                $slotSettings->SetGameData('FlyingDutchmanAMCurrentFreeGame', 0);
                                $slotSettings->SetGameData('FlyingDutchmanAMTotalWin', 0);
                                $slotSettings->SetGameData('FlyingDutchmanAMFreeBalance', 0);
                                $slotSettings->SetGameData('FlyingDutchmanAMFreeStartWin', 0);
                            }
                            if( $slotSettings->GetGameData($slotSettings->slotId . 'CurrentFreeGame') < $slotSettings->GetGameData($slotSettings->slotId . 'FreeGames') ) 
                            {
                                ...
                                $slotSettings->SetGameData('FlyingDutchmanAMCurrentFreeGame', $slotSettings->GetGameData('FlyingDutchmanAMCurrentFreeGame') + 1);
                            ...
                            for( $i = 0; $i <= 2000; $i++ ) 
                            {
                                ...
                                if( in_array($reels['reel6'][0], $sym1) ) 
                                {
                                    $reels['reel2'][0] = '1';
                                    $reels['reel3'][0] = '1';
                                    $reels['reel4'][0] = '1';
                                }
                                if( in_array($reels['reel6'][1], $sym1) ) 
                                {
                                    $reels['reel2'][1] = '1';
                                    $reels['reel3'][1] = '1';
                                    $reels['reel4'][1] = '1';
                                }
                                if( in_array($reels['reel6'][2], $sym1) ) 
                                {
                                    $reels['reel2'][2] = '1';
                                    $reels['reel3'][2] = '1';
                                    $reels['reel4'][2] = '1';
                                }
                                if( in_array($reels['reel6'][3], $sym1) ) 
                                {
                                    $reels['reel2'][3] = '1';
                                    $reels['reel3'][3] = '1';
                                    $reels['reel4'][3] = '1';
                                ...
                                if( in_array($reels['reel6'][0], $sym0) ) 
                                {
                                    $reels['reel2'][0] = '0';
                                    $reels['reel3'][0] = '0';
                                    $reels['reel4'][0] = '0';
                                }
                                if( in_array($reels['reel6'][1], $sym0) ) 
                                {
                                    $reels['reel2'][1] = '0';
                                    $reels['reel3'][1] = '0';
                                    $reels['reel4'][1] = '0';
                                }
                                if( in_array($reels['reel6'][2], $sym0) ) 
                                {
                                    $reels['reel2'][2] = '0';
                                    $reels['reel3'][2] = '0';
                                    $reels['reel4'][2] = '0';
                                }
                                if( in_array($reels['reel6'][3], $sym0) ) 
                                {
                                    $reels['reel2'][3] = '0';
                                    $reels['reel3'][3] = '0';
                                    $reels['reel4'][3] = '0';
                                ...
                                if( in_array($reels['reel6'][0], $sym2) ) 
                                {
                                    $reels['reel2'][0] = '2';
                                    $reels['reel3'][0] = '2';
                                    $reels['reel4'][0] = '2';
                                }
                                if( in_array($reels['reel6'][1], $sym2) ) 
                                {
                                    $reels['reel2'][1] = '2';
                                    $reels['reel3'][1] = '2';
                                    $reels['reel4'][1] = '2';
                                }
                                if( in_array($reels['reel6'][2], $sym2) ) 
                                {
                                    $reels['reel2'][2] = '2';
                                    $reels['reel3'][2] = '2';
                                    $reels['reel4'][2] = '2';
                                }
                                if( in_array($reels['reel6'][3], $sym2) ) 
                                {
                                    $reels['reel2'][3] = '2';
                                    $reels['reel3'][3] = '2';
                                    $reels['reel4'][3] = '2';
                                    ...
                                    for( $j = 0; $j < count($slotSettings->SymbolGame); $j++ ) 
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            if( $s[0] == $csym || in_array($s[0], $wild) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":1,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('FlyingDutchmanAMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":["none","none"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":2,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('FlyingDutchmanAMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":3,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('FlyingDutchmanAMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) && ($s[3] == $csym || in_array($s[3], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":4,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('FlyingDutchmanAMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) && ($s[3] == $csym || in_array($s[3], $wild)) && ($s[4] == $csym || in_array($s[4], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":5,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('FlyingDutchmanAMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":[' . ($linesId[$k][4] - 1) . ',"' . $s[4] . '"]}';
                                                }
                                            }
                                        }
                                    }
                            ...
                            if( $postData['slotEvent'] == 'freespin' && $slotSettings->GetGameData('FlyingDutchmanAMFreeGames') <= $slotSettings->GetGameData('FlyingDutchmanAMCurrentFreeGame') && $winType != 'bonus' && $slotSettings->GetGameData('FlyingDutchmanAMBonusWin') + $totalWin > 0 ) 
                            {
                                $slotSettings->SetBalance($slotSettings->GetGameData('FlyingDutchmanAMBonusWin') + $totalWin);
                            }
                            ...
                            if( $postData['slotEvent'] == 'freespin' ) 
                            {
                                $slotSettings->SetGameData('FlyingDutchmanAMBonusWin', $slotSettings->GetGameData('FlyingDutchmanAMBonusWin') + $totalWin);
                                $slotSettings->SetGameData('FlyingDutchmanAMTotalWin', $totalWin);
                            }
                            else
                            {
                                $slotSettings->SetGameData('FlyingDutchmanAMTotalWin', $totalWin);
                            ...
                            if( $scattersCount >= 3 ) 
                            {
                                ...
                                if( $slotSettings->GetGameData('FlyingDutchmanAMFreeGames') > 0 ) 
                                {
                                    $slotSettings->SetGameData('FlyingDutchmanAMFreeGames', $slotSettings->GetGameData('FlyingDutchmanAMFreeGames') + $slotSettings->slotFreeCount);
                                }
                                else
                                {
                                    $slotSettings->SetGameData('FlyingDutchmanAMFreeStartWin', $totalWin);
                                    $slotSettings->SetGameData('FlyingDutchmanAMBonusWin', $totalWin);
                                    $slotSettings->SetGameData('FlyingDutchmanAMFreeGames', $slotSettings->slotFreeCount);
                                }
                            }
                            $jsSpin = '' . json_encode($reels) . '';
                            $jsJack = '' . json_encode($slotSettings->Jackpots) . '';
                            $winString = implode(',', $lineWins);
                            $response_log = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{"slotLines":' . $lines . ',"slotBet":' . $betCnt . ',"totalFreeGames":' . $slotSettings->GetGameData('FlyingDutchmanAMFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('FlyingDutchmanAMCurrentFreeGame') . ',"Balance":' . $slotSettings->GetBalance() . ',"afterBalance":' . $slotSettings->GetBalance() . ',"bonusWin":' . $slotSettings->GetGameData('FlyingDutchmanAMBonusWin') . ',"freeStartWin":' . $slotSettings->GetGameData('FlyingDutchmanAMFreeStartWin') . ',"totalWin":' . $totalWin . ',"winLines":[' . $winString . '],"bonusInfo":' . $scattersStr . ',"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
                            ...
                            if( $postData['slotEvent'] == 'freespin' ) 
                            {
                                ...
                                $cFree = dechex($slotSettings->GetGameData('FlyingDutchmanAMFreeGames') - $slotSettings->GetGameData('FlyingDutchmanAMCurrentFreeGame'));
                                $gameState = '06';
                                if( $slotSettings->GetGameData('FlyingDutchmanAMFreeGames') <= $slotSettings->GetGameData('FlyingDutchmanAMCurrentFreeGame') ) 
                                {
                                    $gameState = '0c';
                                }
                                if( $scattersCount >= 3 ) 
                                ...
                                $totalWin = $slotSettings->GetGameData('FlyingDutchmanAMBonusWin');
                                $bonusMpl = $slotSettings->slotFreeMpl;
                            }
                            else
                            {
                            ...
                            $slotSettings->SetGameData('FlyingDutchmanAMDoubleAnswer', $reelSate . $bet_h . $ln_h . '1010101010101010101010' . $fixedLinesFormated0 . $winLinesFormated);
                            $slotSettings->SetGameData('FlyingDutchmanAMDoubleBalance', $balanceFormated);
                            $slotSettings->SetGameData('FlyingDutchmanAMDoubleWin', $totalWin);
                            if( $postData['slotEvent'] == 'freespin' ) 
                            {
                            ...
                            $slotSettings->SetGameData('FlyingDutchmanAMCollectP0', $response_collect0);
                            $gameState = '04';
                            $balanceFormated = $slotSettings->HexFormat(round($slotSettings->GetBalance() * $floatBet));
                            ...
                            $slotSettings->SetGameData('FlyingDutchmanAMCollect', $response_collect);
                            break;
                        case 'A/u254':
                            $slotSettings->SetGameData($slotSettings->slotId . 'TotalWin', 0);
                            $response = $slotSettings->GetGameData('FlyingDutchmanAMCollect');
                            break;
                        case 'A/u257':
                            $doubleWin = rand(1, 2);
                            $winall = $slotSettings->GetGameData('FlyingDutchmanAMDoubleWin');
                            $dbet = $winall;
                            $daction = $tmpPar[1];
                            ...
                            $response = '107010' . $slotSettings->GetGameData('FlyingDutchmanAMDoubleBalance') . strlen($winall_h) . $winall_h . $slotSettings->GetGameData('FlyingDutchmanAMDoubleAnswer') . implode('', $slotSettings->GetGameData($slotSettings->slotId . 'Cards'));
                            $slotSettings->SetGameData('FlyingDutchmanAMDoubleWin', $winall);
                            $slotSettings->SetGameData('FlyingDutchmanAMTotalWin', $winall);
                            $balanceFormated = $slotSettings->HexFormat(round($slotSettings->GetBalance() * $floatBet));
                            $response_collect = '104010' . $balanceFormated . strlen($winall_h) . $winall_h . $slotSettings->GetGameData('FlyingDutchmanAMCollectP0');
                            $slotSettings->SetGameData('FlyingDutchmanAMCollect', $response_collect);
                        ...
                        case 'A/u258':
                            ...
                            $slotSettings->SetGameData('FlyingDutchmanAMDoubleBalance', $rtnBalance);
                            $winall = sprintf('%01.2f', $winall) * $floatBet;
                            $winall_h1 = str_replace('.', '', $winall . '');
                            $winall_h = dechex($winall_h1);
                            $doubleCards = '26280b2714161d0c';
                            $response = '108010' . $slotSettings->GetGameData('FlyingDutchmanAMDoubleBalance') . strlen($winall_h) . $winall_h . $slotSettings->GetGameData('FlyingDutchmanAMDoubleAnswer') . implode('', $slotSettings->GetGameData($slotSettings->slotId . 'Cards'));
                            break;
                    }
