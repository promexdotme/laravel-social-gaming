                    ...
                    try
                    {
                        ...
                        switch( $aid ) 
                        {
                            ...
                            case 'settings':
                                ...
                                $result_tmp[] = '{"complex":{"balance":' . $balanceInCents . ',"balanceRaw":' . round($balanceInCents * $slotSettings->CurrentDenom) . ',"paytableCoef":{"0":{"coef":[5,15],"multiplier":1},"1":{"coef":[5,15],"multiplier":1},"2":{"coef":[5,15],"multiplier":1},"3":{"coef":[5,15],"multiplier":1},"4":{"coef":[5,15],"multiplier":1},"5":{"coef":[5,20,50],"multiplier":1},"6":{"coef":[5,25,100],"multiplier":1},"7":{"coef":[5,25,100],"multiplier":1},"8":{"coef":[1,10,30,150],"multiplier":1},"9":{"coef":[1,10,40,200],"multiplier":1},"10":{"coef":[2,15,75,500],"multiplier":1},"11":{"coef":[5,20,100],"multiplier":1}},"bets":[' . implode(',', $gameBets) . '],"jackpotMinBet":1,"jackpot":true,"mainFakeReels":[[1,3,0,0,5,4,3,3,9,4,1,11,2,5,10,3,8,0,7,1,6,2,5,5,4,2,5,4,2,5],[4,3,2,8,1,3,2,9,7,10,8,3,7,11,2,3,9,9,4,0,0,5,6,8,0,3,6,4,0,0],[1,5,0,11,1,5,0,2,6,1,8,2,6,1,7,3,1,8,7,3,9,2,6,4,10,10,1,5,0,6],[6,4,2,5,1,3,11,4,8,3,6,4,7,9,5,10,1,5,2,7,5,0,11,2,0,3,7,2,1,4],[7,2,6,0,0,9,4,3,0,6,6,8,2,7,1,6,10,10,0,3,11,0,2,6,1,7,2,5,6,0]],"jackpotMinBet":1,"jackpot":true,"mainFakeReels":[[5,2,4,10,0,9,8,1,7,2,3,0,11,1,2,4,0,5,3,10,0,6,9,4,0,2,2,4,0,3],[4,2,3,11,9,4,0,6,3,1,11,10,1,7,5,8,1,3,5,2,1,6,8,2,1,6,4,2,5,3],[1,6,9,5,1,10,5,7,3,8,8,7,3,2,5,0,11,4,6,5,0,4,6,1,6,11,0,0,5,2],[4,5,2,7,11,1,3,3,8,6,5,10,0,3,4,1,6,2,7,3,0,0,9,8,4,1,6,6,3,5],[5,2,6,4,1,3,1,10,7,7,2,2,4,0,11,0,6,8,3,2,1,6,2,4,0,0,9,2,4,1]],"jackpotMaxBet":100000,"denominations":[' . implode(',', $denoms) . ']},"gameIdentificationNumber":' . $postData['gameIdentificationNumber'] . ',"gameNumber":-1,"sessionKey":"41be9e65e0ff03a65e8c93576bf61130","msg":"success","messageId":"' . $postData['messageId'] . '","qName":"app.services.messages.response.GameResponse","command":"settings","eventTimestamp":' . time() . '}';
                                break;
                            case 'subscribe':
                                $hist = [
                                    78, 
                                ...
                                shuffle($hist);
                                $slotSettings->SetGameData('VolcanoWealthEGTCards', $hist);
                                $lastEvent = $slotSettings->GetHistory();
                                $slotSettings->SetGameData('VolcanoWealthEGTBonusWin', 0);
                                $slotSettings->SetGameData('VolcanoWealthEGTFreeGames', 0);
                                $slotSettings->SetGameData('VolcanoWealthEGTCurrentFreeGame', 0);
                                $slotSettings->SetGameData('VolcanoWealthEGTTotalWin', 0);
                                $slotSettings->SetGameData('VolcanoWealthEGTFreeBalance', 0);
                                if( $lastEvent != 'NULL' ) 
                                {
                                    ...
                                    $gtype = 1;
                                    if( $slotSettings->GetGameData('VolcanoWealthEGTCurrentFreeGame') < $slotSettings->GetGameData('VolcanoWealthEGTFreeGames') && $slotSettings->GetGameData('VolcanoWealthEGTFreeGames') > 0 ) 
                                    {
                                        $gtype = 2;
                                    }
                                }
                            ...
                            case 'bet':
                                ...
                                if( $postData['slotEvent'] != 'freespin' ) 
                                {
                                    ...
                                    $slotSettings->SetGameData('VolcanoWealthEGTCurrentFreeGame', 0);
                                    $slotSettings->SetGameData('VolcanoWealthEGTTotalWin', 0);
                                    $slotSettings->SetGameData('VolcanoWealthEGTFreeBalance', sprintf('%01.2f', $slotSettings->GetBalance()) * 100);
                                    $bonusMpl = 1;
                                }
                                else
                                {
                                    $slotSettings->SetGameData('VolcanoWealthEGTCurrentFreeGame', $slotSettings->GetGameData('VolcanoWealthEGTCurrentFreeGame') + 1);
                                ...
                                for( $i = 0; $i <= 2000; $i++ ) 
                                {
                                    ...
                                    for( $r = 1; $r <= 5; $r++ ) 
                                    {
                                        for( $sm = 0; $sm <= 3; $sm++ ) 
                                        {
                                            if( $reels['reel' . $r][$sm] == '10' ) 
                                            {
                                                for( $sm0 = $sm + 1; $sm0 <= 3; $sm0++ ) 
                                                {
                                                    $reels['reel' . $r][$sm0] = '10';
                                                    $expandWild[] = ($r - 1) . ',' . $sm0;
                                                }
                                ...
                                if( $postData['slotEvent'] == 'freespin' ) 
                                {
                                    $slotSettings->SetGameData('VolcanoWealthEGTBonusWin', $slotSettings->GetGameData('VolcanoWealthEGTBonusWin') + $totalWin);
                                    $slotSettings->SetGameData('VolcanoWealthEGTTotalWin', $slotSettings->GetGameData('VolcanoWealthEGTTotalWin') + $totalWin);
                                    $balanceInCents = $slotSettings->GetGameData('VolcanoWealthEGTFreeBalance');
                                }
                                else
                                {
                                    $slotSettings->SetGameData('VolcanoWealthEGTTotalWin', $totalWin);
                                }
                                $fs = 0;
                                if( $scattersCount >= 3 ) 
                                {
                                    if( $slotSettings->GetGameData('VolcanoWealthEGTFreeGames') > 0 ) 
                                    {
                                        $slotSettings->SetGameData('VolcanoWealthEGTBonusWin', $totalWin);
                                        $slotSettings->SetGameData('VolcanoWealthEGTFreeGames', $slotSettings->GetGameData('VolcanoWealthEGTFreeGames') + $slotSettings->slotFreeCount[$scattersCount]);
                                    }
                                    else
                                    {
                                        $slotSettings->SetGameData('VolcanoWealthEGTFreeStartWin', $totalWin);
                                        $slotSettings->SetGameData('VolcanoWealthEGTBonusWin', $totalWin);
                                        $slotSettings->SetGameData('VolcanoWealthEGTFreeGames', $slotSettings->slotFreeCount[$scattersCount]);
                                    }
                                    $fs = $slotSettings->GetGameData('VolcanoWealthEGTFreeGames');
                                }
                                $curReels = '' . rand(0, 6) . ',' . $reels['reel1'][0] . ',' . $reels['reel1'][1] . ',' . $reels['reel1'][2] . ',' . $reels['reel1'][3] . ',' . rand(0, 6);
                                $curReels .= (',' . rand(0, 6) . ',' . $reels['reel2'][0] . ',' . $reels['reel2'][1] . ',' . $reels['reel2'][2] . ',' . $reels['reel2'][3] . ',' . rand(0, 6));
                                $curReels .= (',' . rand(0, 6) . ',' . $reels['reel3'][0] . ',' . $reels['reel3'][1] . ',' . $reels['reel3'][2] . ',' . $reels['reel3'][3] . ',' . rand(0, 6));
                                ...
                                $response = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{"slotLines":' . $lines . '' . $slotSettings->GetGameData($slotSettings->slotId . 'FirstSpin') . ',"slotBet":' . $betline . ',"totalFreeGames":' . $slotSettings->GetGameData('VolcanoWealthEGTFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('VolcanoWealthEGTCurrentFreeGame') . ',"Balance":' . $balanceInCents . ',"afterBalance":' . $balanceInCents . ',"bonusWin":' . $slotSettings->GetGameData('VolcanoWealthEGTBonusWin') . ',"totalWin":' . $totalWin . ',"winLines":[' . $winString . '],"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
                                $slotSettings->SaveLogReport($response, $allbet, $lines, $reportWin, $postData['slotEvent']);
                                $winstring = '';
                                $reels = $reelsTmp;
                                $slotSettings->SetGameData('VolcanoWealthEGTGambleStep', 5);
                                $hist = $slotSettings->GetGameData('VolcanoWealthEGTCards');
                                if( $jackRandom == 1 ) 
                                {
                                    $state = 'jackpot';
                                    $isJack = 'true';
                                    $slotSettings->SetGameData('VolcanoWealthEGTJackSteps', [
                                        0, 
                                        0, 
                                        0, 
                                        0
                                ...
                                if( $postData['slotEvent'] == 'freespin' ) 
                                {
                                    $totalWin = $slotSettings->GetGameData('VolcanoWealthEGTBonusWin');
                                    $state = 'freespin';
                                ...
                                break;
                            case 'collect':
                                $result_tmp[] = '{"complex":{"gameCommand":"collect"},"state":"idle","winAmount":' . ($slotSettings->GetGameData('VolcanoWealthEGTTotalWin') * 100) . ',"gameIdentificationNumber":' . $postData['gameIdentificationNumber'] . ',"gameNumber":"","balance":' . $balanceInCents . ',"sessionKey":"41be9e65e0ff03a65e8c93576bf61130","msg":"success","messageId":"' . $postData['messageId'] . '","qName":"app.services.messages.response.GameEventResponse","command":"bet","eventTimestamp":' . time() . '}';
                                $slotSettings->SetGameData('VolcanoWealthEGTTotalWin', 0);
                                break;
                            case 'jackpot':
                                $jackStep = $slotSettings->GetGameData('VolcanoWealthEGTJackSteps');
                                $jackWinID = $slotSettings->GetGameData($slotSettings->slotId . 'JackWinID');
                                if( $jackStep[0] >= 3 || $jackStep[1] >= 3 || $jackStep[2] >= 3 || $jackStep[3] >= 3 || !$slotSettings->HasGameData('VolcanoWealthEGTJackSteps') ) 
                                {
                                    exit();
                                }
                                $winAmount = 0;
                                ...
                                $slotSettings->SetGameData('VolcanoWealthEGTJackSteps', $jackStep);
                                break;
                            case 'gamble':
                                $Balance = $slotSettings->GetBalance();
                                $isGambleWin = rand(1, $slotSettings->GetGambleSettings());
                                $dealerCard = '';
                                $totalWin = $slotSettings->GetGameData('VolcanoWealthEGTTotalWin');
                                $gambleWin = 0;
                                $statBet = $totalWin;
                                $slotSettings->SetGameData('VolcanoWealthEGTGambleStep', $slotSettings->GetGameData('VolcanoWealthEGTGambleStep') - 1);
                                ...
                                else
                                {
                                    ...
                                    $totalWin = 0;
                                    $slotSettings->SetGameData('VolcanoWealthEGTGambleStep', 0);
                                    if( $postData['bet']['color'] == '1' ) 
                                    {
                                        $tmpCards = [
                                            '1', 
