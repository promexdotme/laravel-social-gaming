                    ...
                    try
                    {
                        ...
                        switch( $aid ) 
                        {
                            ...
                            case 'playerControl.tableHandler.searchTableAndJoin':
                                $slotSettings->SetGameData('KingOctopusKABullets', []);
                                $slotSettings->SetGameData('KingOctopusKAFishes', []);
                                $slotSettings->SetGameData('KingOctopusKAWaveTime', time());
                                $slotSettings->SetGameData('KingOctopusKACurScene', 0);
                                $slotSettings->SetGameData('KingOctopusKAIsGroupFish', 0);
                                $slotSettings->SetGameData('KingOctopusKAGamePause', time());
                                if( $postData['query']['level'] == 0 ) 
                                {
                                    $slotSettings->SetGameData('KingOctopusKABet', 0.01);
                                    $slotSettings->SetGameData('KingOctopusKABetCnt', 0);
                                    $slotSettings->SetGameData('KingOctopusKABetArr', [
                                        0.01, 
                                        0.02, 
                                        0.03, 
                                        0.05, 
                                ...
                                {
                                    $slotSettings->SetGameData('KingOctopusKABet', 0.1);
                                    $slotSettings->SetGameData('KingOctopusKABetCnt', 0);
                                    $slotSettings->SetGameData('KingOctopusKABetArr', [
                                        0.1, 
                                        0.2, 
                                ...
                                {
                                    $slotSettings->SetGameData('KingOctopusKABet', 1);
                                    $slotSettings->SetGameData('KingOctopusKABetCnt', 0);
                                    $slotSettings->SetGameData('KingOctopusKABetArr', [
                                        1, 
                                        2, 
                                ...
                                $fishesArr = [];
                                $fishes = $slotSettings->GetGameData('KingOctopusKAFishes');
                                if( !is_array($fishes) ) 
                                {
                                    $fishes = [];
                                }
                                ...
                                $slotSettings->SetGameData('KingOctopusKAFishes', $fishes);
                            ...
                            case 'connector.accountHandler.onPingBalance':
                                $bullets = '';
                                $Bet = $slotSettings->GetGameData('KingOctopusKABet');
                                $BetCnt = $slotSettings->GetGameData('KingOctopusKABetCnt');
                                $BetArr = $slotSettings->GetGameData('KingOctopusKABetArr');
                                $BetLevel = $slotSettings->GetGameData('KingOctopusKABetLevel');
                            ...
                            case 'connector.accountHandler.onPingBalance_2':
                                ...
                                $BetArr = $slotSettings->GetGameData('KingOctopusKABetArr');
                                $BetLevel = $slotSettings->GetGameData('KingOctopusKABetLevel');
                                if( time() < $slotSettings->GetGameData('KingOctopusKAGamePause') ) 
                                {
                                    $result_tmp[0] = '{"answerType":"game.fire","responseView":[4,0,0,0,6,' . strlen('game.fire') . '],"msg":{"player":{"nickName":"' . $slotSettings->username . '","gender":1,"avatarUrl":"","gameServerId":"player-server-3","connectorId":"connector-server-3","teamId":"","gameId":"10007","tableId":"2ba04cc50c285a21b223e1043993456918e041415cac8ce29e72d3dc948474be-connector-server-3","gameState":"playing","id":"9dab0ea6-0cb0-4b8c-951a-e10077945f2b","areaId":"7909d963c43c6df71d7f7ee17bfc4b5133809d80342e2f645d01e16119eec1ad-connector-server-3","gold":100,"delta":' . ($Bet * 100) . ',"gain":0,"cost":' . ($Bet * 100) . ',"ratio":1,"rmpRatioCredit":' . $balanceInCents . ',"denom":0.01},"areaPlayer":{"id":"13879583b6558342be4b011cf849ee29989667afd2eb4c993a7f06371e78a2d4","areaId":"7909d963c43c6df71d7f7ee17bfc4b5133809d80342e2f645d01e16119eec1ad-connector-server-3","playerId":"d607e29f-99cc-48bc-a37d-5590b80fa0f6","cannonLevel":' . $BetCnt . ',"cannonCost":' . ($Bet * 100) . ',"cannonMaxLen":18,"skin":1,"lockTargetId":0,"chairId":2}' . $bullets . '}}';
                                    break;
                                }
                                ...
                                if( time() - $slotSettings->GetGameData('KingOctopusKAWaveTime') >= 300 ) 
                                {
                                    $slotSettings->SetGameData('KingOctopusKAFishes', []);
                                    $curScene = $slotSettings->GetGameData('KingOctopusKACurScene');
                                    $curScene++;
                                    if( $curScene > 3 ) 
                                    {
                                        $curScene = 0;
                                    ...
                                    $slotSettings->SetGameData('KingOctopusKAWaveTime', time());
                                    $slotSettings->SetGameData('KingOctopusKACurScene', $curScene);
                                    $slotSettings->SetGameData('KingOctopusKAIsGroupFish', 1);
                                }
                                else
                                {
                                    $result_tmp[0] = '{"answerType":"game.fire","responseView":[4,0,0,0,6,' . strlen('game.fire') . '],"msg":{"player":{"nickName":"' . $slotSettings->username . '","gender":1,"avatarUrl":"","gameServerId":"player-server-3","connectorId":"connector-server-3","teamId":"","gameId":"10007","tableId":"2ba04cc50c285a21b223e1043993456918e041415cac8ce29e72d3dc948474be-connector-server-3","gameState":"playing","id":"9dab0ea6-0cb0-4b8c-951a-e10077945f2b","areaId":"7909d963c43c6df71d7f7ee17bfc4b5133809d80342e2f645d01e16119eec1ad-connector-server-3","gold":100,"delta":' . ($Bet * 100) . ',"gain":0,"cost":' . ($Bet * 100) . ',"ratio":1,"rmpRatioCredit":' . $balanceInCents . ',"denom":0.01},"areaPlayer":{"id":"13879583b6558342be4b011cf849ee29989667afd2eb4c993a7f06371e78a2d4","areaId":"7909d963c43c6df71d7f7ee17bfc4b5133809d80342e2f645d01e16119eec1ad-connector-server-3","playerId":"d607e29f-99cc-48bc-a37d-5590b80fa0f6","cannonLevel":' . $BetCnt . ',"cannonCost":' . ($Bet * 100) . ',"cannonMaxLen":18,"skin":1,"lockTargetId":0,"chairId":2}' . $bullets . '}}';
                                    ...
                                    if( $slotSettings->GetGameData('KingOctopusKAIsGroupFish') == 0 ) 
                                    {
                                        $answerType = 'game.onSpawnFishes';
                                        $gr = '';
                                        $rfish = rand(10, 30);
                                    ...
                                    $slotSettings->SetGameData('KingOctopusKAFishes', $fishesArrNew);
                                }
                                break;
                            case 'playerControl.areaHandler.onCollider':
                                ...
                                $fishes = $slotSettings->GetGameData('KingOctopusKAFishes');
                                $bulletsArr = $slotSettings->GetGameData('KingOctopusKABullets');
                                $allbet = $slotSettings->GetGameData('KingOctopusKABet');
                                $die = 'false';
                                $results = '';
                                $totalWin = 0;
                                $pause = '';
                                ...
                                {
                                    $result_tmp[0] = '{"answerType":"game.colliderResult","Win":' . ($totalWin * 100) . ',"Balance":' . sprintf('%01.2f', $slotSettings->GetBalance()) . ',"curBet":' . $slotSettings->GetGameData('KingOctopusKABet') . ',"responseView":[4,0,0,0,6,' . strlen('game.colliderResult') . '],"msg":{"player":{"id":"d607e29f-99cc-48bc-a37d-5590b80fa0f6","gold":' . ($totalWin * 100) . ',"delta":0,"gain":0,"cost":' . ($Bet * 100) . ',"rmpRatioCredit":' . $balanceInCents . ',"ratio":1},"result":[]}}';
                                    echo $result_tmp[0];
                                }
                                if( isset($fishes[$fid]) ) 
                                {
                                    ...
                                    else if( $totalWin <= $bank && rand(1, 5) == 1 && $totalWin > 0 && $fishes[$fid]['state'] != 'bomb' ) 
                                    {
                                        ...
                                        if( $fishes[$fid]['fishView'] == 'Fish_01' ) 
                                        {
                                            ...
                                            $slotSettings->SetGameData('KingOctopusKAGamePause', time() + 10);
                                ...
                                {
                                    $result_tmp[0] = '{"answerType":"game.colliderResult","Win":' . ($totalWin * 100) . ',"Balance":0.0,"curBet":' . $slotSettings->GetGameData('KingOctopusKABet') . ',"responseView":[4,0,0,0,6,' . strlen('game.colliderResult') . '],"msg":{"player":{"id":"d607e29f-99cc-48bc-a37d-5590b80fa0f6","gold":' . ($totalWin * 100) . ',"delta":0,"gain":0,"cost":' . ($Bet * 100) . ',"rmpRatioCredit":0.1,"ratio":1},"result":[' . $results . ']}}';
                                }
                                else
                                {
                                    $result_tmp[0] = '{"answerType":"game.colliderResult","Win":' . ($totalWin * 100) . ',"Balance":' . sprintf('%01.2f', $slotSettings->GetBalance()) . ',"curBet":' . $slotSettings->GetGameData('KingOctopusKABet') . ',"responseView":[4,0,0,0,6,' . strlen('game.colliderResult') . '],"msg":{"player":{"id":"d607e29f-99cc-48bc-a37d-5590b80fa0f6","gold":' . ($totalWin * 100) . ',"delta":1,"gain":1,"cost":' . ($Bet * 100) . ',"rmpRatioCredit":' . $balanceInCents . ',"ratio":1},"result":[' . $results . ']}}';
                                }
                            ...
                            case 'fishHunter.areaHandler.onUpdateCannon':
                                ...
                                $BetArr = $slotSettings->GetGameData('KingOctopusKABetArr');
                                $BetLevel = $slotSettings->GetGameData('KingOctopusKABetLevel');
                                $cnLevel = $slotSettings->GetGameData('KingOctopusKABetLevel') * 6;
                                ...
                                $Bet = $BetArr[$BetCnt];
                                $slotSettings->SetGameData('KingOctopusKABet', $Bet);
                                $slotSettings->SetGameData('KingOctopusKABetCnt', $BetCnt);
                                $slotSettings->SetGameData('KingOctopusKABetArr', $BetArr);
                                $slotSettings->SetGameData('KingOctopusKABetLevel', $BetLevel);
                                $result_tmp[0] = '{"answerType":"game.updateCannon","Balance":' . sprintf('%01.2f', $slotSettings->GetBalance()) . ',"curBet":' . $slotSettings->GetGameData('KingOctopusKABet') . ',"responseView":[4,0,0,0,6,' . strlen('game.updateCannon') . '],"msg":{"areaPlayer":{"id":"2b7e1e20bfc42e388fe81831c2a2d80a6657370638b7170b5031110e10e73379","areaId":"e339f81cfa6b0d3ed09053d2d6f186416e90b358c2b26a84a81fa9e90d94004a-connector-server-3","playerId":"d607e29f-99cc-48bc-a37d-5590b80fa0f6","cannonLevel":' . $BetCnt . ',"cannonCost":' . ($Bet * 100) . ',"cannonMaxLen":18,"skin":1,"lockTargetId":0,"chairId":0}}}';
                                break;
                            ...
                            case 'fishHunter.areaHandler.onFire':
                                $bulletsArr = $slotSettings->GetGameData('KingOctopusKABullets');
                                $bulletBet = $slotSettings->GetGameData('KingOctopusKABet');
                                $allbet = $bulletBet;
                                $Bet = $slotSettings->GetGameData('KingOctopusKABet');
                                $BetCnt = $slotSettings->GetGameData('KingOctopusKABetCnt');
                                $BetArr = $slotSettings->GetGameData('KingOctopusKABetArr');
                                ...
                                else
                                {
                                    ...
                                    $slotSettings->SetGameData('KingOctopusKABullets', $bulletsArr);
