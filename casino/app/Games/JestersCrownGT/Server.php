                ...
                \DB::transaction(function() use ($request, $game)
                {
                    try
                    {
                        ...
                        else if( $postData['slotEvent'] == 'gamble5GetUserCards' ) 
                        {
                            ...
                            $dealerCard = $slotSettings->GetGameData('JestersCrownGTDealerCard');
                            $totalWin = $slotSettings->GetGameData('JestersCrownGTTotalWin');
                            $gambleWin = 0;
                            ...
                            $slotSettings->SetGameData('JestersCrownGTTotalWin', $totalWin);
                        ...
                        else if( $postData['slotEvent'] == 'gamble5GetDealerCard' ) 
                        {
                            ...
                            $slotSettings->SetGameData('JestersCrownGTDealerCard', $tmpDc);
                        ...
                        else if( $postData['slotEvent'] == 'bet' || $postData['slotEvent'] == 'freespin' ) 
                        {
                            ...
                            if( $postData['slotEvent'] != 'freespin' ) 
                            {
                                ...
                                $bonusMpl = 1;
                                $slotSettings->SetGameData('JestersCrownGTBonusWin', 0);
                                $slotSettings->SetGameData('JestersCrownGTFreeGames', 0);
                                $slotSettings->SetGameData('JestersCrownGTCurrentFreeGame', 0);
                                $slotSettings->SetGameData('JestersCrownGTTotalWin', 0);
                                $slotSettings->SetGameData('JestersCrownGTFreeBalance', 0);
                                $slotSettings->SetGameData('JestersCrownGTBonusWin', 0);
                            }
                            else
                            {
                                $slotSettings->SetGameData('JestersCrownGTCurrentFreeGame', $slotSettings->GetGameData('JestersCrownGTCurrentFreeGame') + 1);
                            ...
                            if( $postData['slotEvent'] == 'freespin' && $slotSettings->GetGameData('JestersCrownGTFreeGames') <= $slotSettings->GetGameData('JestersCrownGTCurrentFreeGame') && $winType != 'bonus' && $slotSettings->GetGameData('JestersCrownGTTotalWin') + $totalWin > 0 ) 
                            {
                                $slotSettings->SetBalance($slotSettings->GetGameData('JestersCrownGTTotalWin') + $totalWin);
                            }
                            ...
                            if( $postData['slotEvent'] == 'freespin' ) 
                            {
                                $slotSettings->SetGameData('JestersCrownGTBonusWin', $slotSettings->GetGameData('JestersCrownGTBonusWin') + $totalWin);
                                $slotSettings->SetGameData('JestersCrownGTTotalWin', $totalWin);
                            }
                            else
                            {
                            ...
                            if( $scattersCount >= 3 ) 
                            {
                                if( $slotSettings->GetGameData('JestersCrownGTFreeGames') > 0 ) 
                                {
                                    $slotSettings->SetGameData('JestersCrownGTFreeBalance', $Balance);
                                    $slotSettings->SetGameData('JestersCrownGTBonusWin', $totalWin);
                                    $slotSettings->SetGameData('JestersCrownGTFreeGames', $slotSettings->GetGameData('JestersCrownGTFreeGames') + $slotSettings->slotFreeCount);
                                }
                                else
                                {
                                    $slotSettings->SetGameData('JestersCrownGTFreeBalance', $Balance);
                                    $slotSettings->SetGameData('JestersCrownGTBonusWin', $totalWin);
                                    $slotSettings->SetGameData('JestersCrownGTFreeGames', $slotSettings->slotFreeCount);
                                }
                            }
                            $jsSpin = '' . json_encode($reels) . '';
                            $jsJack = '' . json_encode($slotSettings->Jackpots) . '';
                            $winString = implode(',', $lineWins);
                            $response = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{"slotLines":' . $postData['slotLines'] . ',"slotBet":' . $postData['slotBet'] . ',"slotJackpot0":' . $slotSettings->slotJackpot[0] . ',"slotJackpot":' . $slotSettings->slotJackpot[1] . ',"totalFreeGames":' . $slotSettings->GetGameData('JestersCrownGTFreeGames') . ',"BonusWin":' . $slotSettings->GetGameData('JestersCrownGTBonusWin') . ',"currentFreeGames":' . $slotSettings->GetGameData('JestersCrownGTCurrentFreeGame') . ',"Balance":' . $Balance . ',"afterBalance":' . $slotSettings->GetBalance() . ',"totalWin":' . $totalWin . ',"winLines":[' . $winString . '],"bonusInfo":' . $scattersStr . ',"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
