                    ...
                    try
                    {
                        ...
                        switch( $aid ) 
                        {
                            ...
                            case 'settings':
                                ...
                                $result_tmp[] = '{"complex":{"balance":' . $balanceInCents . ',"balanceRaw":' . round($balanceInCents * $slotSettings->CurrentDenom) . ',"paytableCoef":{"0":{"coef":[5,20,100],"multiplier":1},"1":{"coef":[5,20,100],"multiplier":1},"2":{"coef":[5,40,200],"multiplier":1},"3":{"coef":[5,40,200],"multiplier":1},"4":{"coef":[10,50,400],"multiplier":1},"5":{"coef":[10,50,400],"multiplier":1},"6":{"coef":[20,100,500],"multiplier":1},"7":{"coef":[20,100,500],"multiplier":1},"8":{"coef":[30,200,1000],"multiplier":1},"9":{"coef":[50,500,5000],"multiplier":1},"10":{"coef":[2],"multiplier":1},"11":{"coef":[],"multiplier":1}},"bets":[' . implode(',', $gameBets) . '],"jackpotMinBet":1,"jackpot":true,"freespinFakeReels":[[1,2,5,6,3,9,5,7,2,0,9,2,6,1,7,4,8,1,0,3],[3,1,10,8,4,3,9,2,4,8,7,4,2,3,0,6,4,9,3,5],[5,2,9,4,8,5,2,3,4,6,0,8,5,7,3,8,1,10,0,2],[7,0,2,1,5,9,0,8,3,2,10,1,6,5,4,2,10,1,0,3],[3,8,0,6,1,4,7,3,8,4,5,3,2,0,1,3,9,0,4,7]],"jackpotMinBet":1,"jackpot":true,"mainFakeReels":[[1,2,5,6,3,9,5,7,2,0,9,2,6,1,7,4,8,1,0,3],[3,1,10,8,4,3,9,2,4,8,7,4,2,3,0,6,4,9,3,5],[5,2,9,4,8,5,2,3,4,6,0,8,5,7,3,8,1,10,0,2],[7,0,2,1,5,9,0,8,3,2,10,1,6,5,4,2,10,1,0,3],[3,8,0,6,1,4,7,3,8,4,5,3,2,0,1,3,9,0,4,7]],"jackpotMaxBet":100000,"denominations":[' . implode(',', $denoms) . ']},"gameIdentificationNumber":' . $postData['gameIdentificationNumber'] . ',"gameNumber":-1,"sessionKey":"41be9e65e0ff03a65e8c93576bf61130","msg":"success","messageId":"' . $postData['messageId'] . '","qName":"app.services.messages.response.GameResponse","command":"settings","eventTimestamp":' . time() . '}';
                                break;
                            case 'subscribe':
                                $hist = [
                                    78, 
                                ...
                                shuffle($hist);
                                $slotSettings->SetGameData('AlmightyRamsesIIEGTCards', $hist);
                                $lastEvent = $slotSettings->GetHistory();
                                $slotSettings->SetGameData('AlmightyRamsesIIEGTBonusWin', 0);
                                $slotSettings->SetGameData('AlmightyRamsesIIEGTFreeGames', 0);
                                $slotSettings->SetGameData('AlmightyRamsesIIEGTCurrentFreeGame', 0);
                                $slotSettings->SetGameData('AlmightyRamsesIIEGTTotalWin', 0);
                                $slotSettings->SetGameData('AlmightyRamsesIIEGTFreeBalance', 0);
                                if( $lastEvent != 'NULL' ) 
                                {
                                    ...
                                    $gtype = 1;
                                    if( $slotSettings->GetGameData('AlmightyRamsesIIEGTCurrentFreeGame') < $slotSettings->GetGameData('AlmightyRamsesIIEGTFreeGames') && $slotSettings->GetGameData('AlmightyRamsesIIEGTFreeGames') > 0 ) 
                                    {
                                        $gtype = 2;
                                    }
                                }
                            ...
                            case 'bet':
                                ...
                                if( $postData['slotEvent'] != 'freespin' ) 
                                {
                                    ...
                                    $slotSettings->SetGameData('AlmightyRamsesIIEGTCurrentFreeGame', 0);
                                    $slotSettings->SetGameData('AlmightyRamsesIIEGTTotalWin', 0);
                                    $slotSettings->SetGameData('AlmightyRamsesIIEGTFreeBalance', sprintf('%01.2f', $slotSettings->GetBalance()) * 100);
                                    $bonusMpl = 1;
                                }
                                else
                                {
                                    $slotSettings->SetGameData('AlmightyRamsesIIEGTCurrentFreeGame', $slotSettings->GetGameData('AlmightyRamsesIIEGTCurrentFreeGame') + 1);
                                ...
                                for( $i = 0; $i <= 2000; $i++ ) 
                                {
                                    ...
                                    $tmpReels = $reels;
                                    $expandMSym = [];
                                    if( $postData['slotEvent'] == 'freespin' && $reels['reel1'][0] == $reels['reel1'][1] && $reels['reel1'][1] == $reels['reel1'][2] ) 
                                    {
                                        $mSym = $reels['reel1'][0];
                                        for( $ms = 0; $ms < 3; $ms++ ) 
                                        {
                                            $expStr = '';
                                            if( $reels['reel3'][$ms] == $mSym ) 
                                            {
                                                $expStr = '1,' . $ms . ',2,' . $ms . '';
                                                $reels['reel2'][$ms] = $mSym;
                                                $reels['reel3'][$ms] = $mSym;
                                            }
                                            if( $reels['reel4'][$ms] == $mSym ) 
                                            {
                                                $expStr = '1,' . $ms . ',2,' . $ms . ',3,' . $ms . '';
                                                $reels['reel2'][$ms] = $mSym;
                                                $reels['reel3'][$ms] = $mSym;
                                                $reels['reel4'][$ms] = $mSym;
                                            }
                                            if( $reels['reel5'][$ms] == $mSym ) 
                                            {
                                                $expStr = '1,' . $ms . ',2,' . $ms . ',3,' . $ms . ',4,' . $ms . '';
                                                $reels['reel2'][$ms] = $mSym;
                                                $reels['reel3'][$ms] = $mSym;
                                                $reels['reel4'][$ms] = $mSym;
                                            }
                                ...
                                if( $postData['slotEvent'] == 'freespin' ) 
                                {
                                    $slotSettings->SetGameData('AlmightyRamsesIIEGTBonusWin', $slotSettings->GetGameData('AlmightyRamsesIIEGTBonusWin') + $totalWin);
                                    $slotSettings->SetGameData('AlmightyRamsesIIEGTTotalWin', $slotSettings->GetGameData('AlmightyRamsesIIEGTTotalWin') + $totalWin);
                                    $balanceInCents = $slotSettings->GetGameData('AlmightyRamsesIIEGTFreeBalance');
                                }
                                else
                                {
                                    $slotSettings->SetGameData('AlmightyRamsesIIEGTTotalWin', $totalWin);
                                }
                                $fs = 0;
                                if( $scattersCount >= 3 ) 
                                {
                                    if( $slotSettings->GetGameData('AlmightyRamsesIIEGTFreeGames') > 0 ) 
                                    {
                                        $slotSettings->SetGameData('AlmightyRamsesIIEGTFreeGames', $slotSettings->GetGameData('AlmightyRamsesIIEGTFreeGames') + $slotSettings->slotFreeCount);
                                    }
                                    else
                                    {
                                        $slotSettings->SetGameData('AlmightyRamsesIIEGTFreeStartWin', $totalWin);
                                        $slotSettings->SetGameData('AlmightyRamsesIIEGTBonusWin', $totalWin);
                                        $slotSettings->SetGameData('AlmightyRamsesIIEGTFreeGames', $slotSettings->slotFreeCount);
                                    }
                                    $fs = $slotSettings->GetGameData('AlmightyRamsesIIEGTFreeGames');
                                }
                                $curReels = '' . rand(0, 6) . ',' . $reels['reel1'][0] . ',' . $reels['reel1'][1] . ',' . $reels['reel1'][2] . ',' . rand(0, 6);
                                $curReels .= (',' . rand(0, 6) . ',' . $reels['reel2'][0] . ',' . $reels['reel2'][1] . ',' . $reels['reel2'][2] . ',' . rand(0, 6));
                                $curReels .= (',' . rand(0, 6) . ',' . $reels['reel3'][0] . ',' . $reels['reel3'][1] . ',' . $reels['reel3'][2] . ',' . rand(0, 6));
                                ...
                                $response = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{"slotLines":' . $lines . '' . $slotSettings->GetGameData($slotSettings->slotId . 'FirstSpin') . ',"slotBet":' . $betline . ',"totalFreeGames":' . $slotSettings->GetGameData('AlmightyRamsesIIEGTFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('AlmightyRamsesIIEGTCurrentFreeGame') . ',"Balance":' . $balanceInCents . ',"afterBalance":' . $balanceInCents . ',"bonusWin":' . $slotSettings->GetGameData('AlmightyRamsesIIEGTBonusWin') . ',"totalWin":' . $totalWin . ',"winLines":[' . $winString . '],"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
                                $slotSettings->SaveLogReport($response, $allbet, $lines, $reportWin, $postData['slotEvent']);
                                $winstring = '';
                                $slotSettings->SetGameData('AlmightyRamsesIIEGTGambleStep', 5);
                                $hist = $slotSettings->GetGameData('AlmightyRamsesIIEGTCards');
                                if( $jackRandom == 1 ) 
                                {
                                    $state = 'jackpot';
                                    $isJack = 'true';
                                    $slotSettings->SetGameData('AlmightyRamsesIIEGTJackSteps', [
                                        0, 
                                        0, 
                                        0, 
                                        0
                                ...
                                if( $postData['slotEvent'] == 'freespin' ) 
                                {
                                    $totalWin = $slotSettings->GetGameData('AlmightyRamsesIIEGTBonusWin');
                                    $state = 'freespin';
                                ...
                                $result_tmp[] = '{"complex":{"gambles":5,"reels":[' . $curReels . '],"lines":[' . $winString . '],"scatters":[' . $scattersStr . '],"freespinScatters":[' . $scatter . '],"expand":[' . implode(',', $expandMSym) . '],"specialExpand":[],"gambles":5,"freespins":' . $fs . ',"jackpot":' . $isJack . ',"gameCommand":"bet"},"state":"' . $state . '","winAmount":' . ($totalWin * 100) . ',"gameIdentificationNumber":' . $postData['gameIdentificationNumber'] . ',"gameNumber":"","balance":' . $balanceInCents . ',"sessionKey":"41be9e65e0ff03a65e8c93576bf61130","msg":"success","messageId":"' . $postData['messageId'] . '","qName":"app.services.messages.response.GameEventResponse","command":"bet","eventTimestamp":' . time() . '}';
                                ...
                                break;
                            case 'collect':
                                $result_tmp[] = '{"complex":{"gameCommand":"collect"},"state":"idle","winAmount":' . ($slotSettings->GetGameData('AlmightyRamsesIIEGTTotalWin') * 100) . ',"gameIdentificationNumber":' . $postData['gameIdentificationNumber'] . ',"gameNumber":"","balance":' . $balanceInCents . ',"sessionKey":"41be9e65e0ff03a65e8c93576bf61130","msg":"success","messageId":"' . $postData['messageId'] . '","qName":"app.services.messages.response.GameEventResponse","command":"bet","eventTimestamp":' . time() . '}';
                                $slotSettings->SetGameData('AlmightyRamsesIIEGTTotalWin', 0);
                                break;
                            case 'jackpot':
                                $jackStep = $slotSettings->GetGameData('AlmightyRamsesIIEGTJackSteps');
                                $jackWinID = $slotSettings->GetGameData($slotSettings->slotId . 'JackWinID');
                                if( $jackStep[0] >= 3 || $jackStep[1] >= 3 || $jackStep[2] >= 3 || $jackStep[3] >= 3 || !$slotSettings->HasGameData('AlmightyRamsesIIEGTJackSteps') ) 
                                {
                                    exit();
                                }
                                $winAmount = 0;
                                ...
                                $slotSettings->SetGameData('AlmightyRamsesIIEGTJackSteps', $jackStep);
                                break;
                            case 'gamble':
                                $Balance = $slotSettings->GetBalance();
                                $isGambleWin = rand(1, $slotSettings->GetGambleSettings());
                                $dealerCard = '';
                                $totalWin = $slotSettings->GetGameData('AlmightyRamsesIIEGTTotalWin');
                                $gambleWin = 0;
                                $statBet = $totalWin;
                                $slotSettings->SetGameData('AlmightyRamsesIIEGTGambleStep', $slotSettings->GetGameData('AlmightyRamsesIIEGTGambleStep') - 1);
                                ...
                                else
                                {
                                    ...
                                    $totalWin = 0;
                                    $slotSettings->SetGameData('AlmightyRamsesIIEGTGambleStep', 0);
                                    if( $postData['bet']['color'] == '1' ) 
                                    {
                                        $tmpCards = [
                                            '1', 
