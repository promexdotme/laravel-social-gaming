                    ...
                    try
                    {
                        ...
                        if( isset($postData['spinType']) ) 
                        {
                            ...
                            if( $postData['spinType'] == 'regular' ) 
                            {
                                ...
                                $bonusMpl = 1;
                                $slotSettings->SetGameData('SherlockMysteryPTMBonusWin', 0);
                                $slotSettings->SetGameData('SherlockMysteryPTMFreeGames', 0);
                                $slotSettings->SetGameData('SherlockMysteryPTMCurrentFreeGame', 0);
                                $slotSettings->SetGameData('SherlockMysteryPTMTotalWin', 0);
                                $slotSettings->SetGameData('SherlockMysteryPTMFreeBalance', 0);
                                $slotSettings->SetGameData('SherlockMysteryPTMFreeStartWin', 0);
                            }
                            else if( $postData['spinType'] == 'free' ) 
                            {
                                $umid = '0';
                                $postData['slotEvent'] = 'freespin';
                                $slotSettings->SetGameData('SherlockMysteryPTMCurrentFreeGame', $slotSettings->GetGameData('SherlockMysteryPTMCurrentFreeGame') + 1);
                                $bonusMpl = 1;
                            }
                            $linesId[0] = [
                                2, 
                            ...
                            if( $postData['slotEvent'] == 'freespin' ) 
                            {
                                ...
                                shuffle($mpls);
                                $slotSettings->slotWildMpl = $mpls[0];
                                if( $winType == 'bonus' ) 
                                {
                                    $winType = 'win';
                                }
                            ...
                            for( $i = 0; $i <= 2000; $i++ ) 
                            {
                                ...
                                for( $k = 0; $k < $lines; $k++ ) 
                                {
                                    ...
                                    for( $j = 0; $j < count($slotSettings->SymbolGame); $j++ ) 
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            {
                                                $mpl = 1;
                                                if( $postData['slotEvent'] == 'freespin' && $csym == '0' ) 
                                                {
                                                    $wild = ['0'];
                                                }
                                                else
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":1,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('SherlockMysteryPTMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":["none","none"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) ) 
                                            {
                                                ...
                                                if( in_array($s[0], $wild2) || in_array($s[1], $wild2) ) 
                                                {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":2,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('SherlockMysteryPTMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) ) 
                                            {
                                                ...
                                                if( in_array($s[0], $wild2) || in_array($s[1], $wild2) || in_array($s[2], $wild2) ) 
                                                {
                                                    $mpl = $slotSettings->slotWildMpl;
                                                }
                                                if( in_array($s[0], $wild2) && in_array($s[1], $wild2) && in_array($s[2], $wild2) ) 
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":3,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('SherlockMysteryPTMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) && ($s[3] == $csym || in_array($s[3], $wild)) ) 
                                            {
                                                ...
                                                if( in_array($s[0], $wild2) || in_array($s[1], $wild2) || in_array($s[2], $wild2) || in_array($s[3], $wild2) ) 
                                                {
                                                    $mpl = $slotSettings->slotWildMpl;
                                                }
                                                if( in_array($s[0], $wild2) && in_array($s[1], $wild2) && in_array($s[2], $wild2) && in_array($s[3], $wild2) ) 
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":4,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('SherlockMysteryPTMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) && ($s[3] == $csym || in_array($s[3], $wild)) && ($s[4] == $csym || in_array($s[4], $wild)) ) 
                                            {
                                                ...
                                                if( in_array($s[0], $wild2) || in_array($s[1], $wild2) || in_array($s[2], $wild2) || in_array($s[3], $wild2) || in_array($s[4], $wild2) ) 
                                                {
                                                    $mpl = $slotSettings->slotWildMpl;
                                                }
                                                if( in_array($s[0], $wild2) && in_array($s[1], $wild2) && in_array($s[2], $wild2) && in_array($s[3], $wild2) && in_array($s[4], $wild2) ) 
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":5,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('SherlockMysteryPTMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":[' . ($linesId[$k][4] - 1) . ',"' . $s[4] . '"]}';
                                                }
                                            }
                                        }
                                    }
                                ...
                                for( $r = 1; $r <= 4; $r++ ) 
                                {
                                    for( $p = 0; $p <= 3; $p++ ) 
                                    {
                                        if( $reels['reel' . $r][$p] == 1 && $reels['reel' . ($r + 1)][$p] == 2 ) 
                                        {
                                            $sherWin = $betLine * $lines * 3;
                                        }
                                    }
                                }
                                ...
                                else
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        if( $scattersCount2 >= 3 ) 
                                        {
                                            ...
                                            for( $cb = 0; $cb < 5; $cb++ ) 
                                            {
                                                $cw = $wins[$cb] * $betLine * $lines;
                                                $crimeBonusWin += $cw;
                                                $crimeBonusWinArr[] = $wins[$cb];
                                            }
                                            $slotSettings->SetGameData('SherlockMysteryPTMBonusWinArr', $crimeBonusWinArr);
                                            $totalWin += $crimeBonusWin;
                                        }
                            ...
                            if( $postData['slotEvent'] == 'freespin' ) 
                            {
                                $slotSettings->SetGameData('SherlockMysteryPTMBonusWin', $slotSettings->GetGameData('SherlockMysteryPTMBonusWin') + $totalWin);
                                $slotSettings->SetGameData('SherlockMysteryPTMTotalWin', $totalWin);
                                $result_tmp[] = '3:::{"data":{"multiplier":' . $slotSettings->slotWildMpl . ',"windowId":"fdyxbZ"},"ID":40595,"umid":67}';
                            }
                            else
                            {
                                $slotSettings->SetGameData('SherlockMysteryPTMTotalWin', $totalWin);
                            ...
                            if( $scattersCount >= 3 ) 
                            {
                                if( $slotSettings->GetGameData('SherlockMysteryPTMFreeGames') > 0 ) 
                                {
                                    $slotSettings->SetGameData('SherlockMysteryPTMFreeGames', $slotSettings->GetGameData('SherlockMysteryPTMFreeGames') + $slotSettings->slotFreeCount);
                                }
                                else
                                {
                                    $slotSettings->SetGameData('SherlockMysteryPTMFreeStartWin', $totalWin);
                                    $slotSettings->SetGameData('SherlockMysteryPTMBonusWin', 0);
                                    $slotSettings->SetGameData('SherlockMysteryPTMFreeGames', $slotSettings->slotFreeCount);
                                }
                            }
                            if( $scattersCount2 >= 3 ) 
                            {
                                $result_tmp[] = '3:::{"data":{"picksCount":5,"windowId":"2FV71o"},"ID":40595,"umid":275}';
                            }
                            $balanceInCents = sprintf('%01.2f', $slotSettings->GetBalance()) * 100;
                            ...
                            $response = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{"linesArr":[' . implode(',', $postData['lines']) . '],"slotLines":' . $lines . ',"slotBet":' . $betLine . ',"totalFreeGames":' . $slotSettings->GetGameData('SherlockMysteryPTMFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('SherlockMysteryPTMCurrentFreeGame') . ',"Balance":' . $slotSettings->GetBalance() . ',"afterBalance":' . $slotSettings->GetBalance() . ',"bonusWin":' . $slotSettings->GetGameData('SherlockMysteryPTMBonusWin') . ',"freeStartWin":' . $slotSettings->GetGameData('SherlockMysteryPTMFreeStartWin') . ',"totalWin":' . $totalWin . ',"winLines":[' . $winString . '],"bonusInfo":' . $scattersStr . ',"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
                            $slotSettings->SaveLogReport($response, $betLine, $lines, $reportWin, $postData['slotEvent']);
                        }
                        switch( $umid ) 
                        {
                            case '40591':
                                $BonusWinArr = $slotSettings->GetGameData('SherlockMysteryPTMBonusWinArr');
                                $result_tmp[] = '3:::{"data":{"prize":' . array_shift($BonusWinArr) . ',"windowId":"2FV71o"},"ID":40595,"umid":287}';
                                $slotSettings->SetGameData('SherlockMysteryPTMBonusWinArr', $BonusWinArr);
                                break;
                            case '31031':
                            ...
                            case '40066':
                                ...
                                $result_tmp[] = '3:::{"data":{"funNoticeGames":0,"funNoticePayouts":0,"gameGroup":"shmst","minBet":0,"maxBet":0,"minPosBet":0,"maxPosBet":50000,"coinSizes":[' . implode(',', $gameBets) . ']},"ID":40025,"umid":21}';
                                break;
                            case '40036':
                                ...
                                if( $lastEvent != 'NULL' ) 
                                {
                                    ...
                                    {
                                        $slotSettings->SetGameData($slotSettings->slotId . 'brokenGames', 'shmst');
                                    }
                                }
