                                ...
                                for( $i = 0; $i <= 2000; $i++ ) 
                                {
                                    ...
                                    for( $j = 0; $j < count($slotSettings->SymbolGame); $j++ ) 
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            {
                                                $cWin = ($tmpWin = $slotSettings->Paytable['SYM_' . $csym][3] * $betline * $bonusMpl) * $reelWayMpl[1] * $reelWayMpl[2] * $reelWayMpl[3] * $isWildMpl;
                                                $cWinsCount[$k] = $slotSettings->GetSymPositions($reels_t);
                                                $wwMpl = $reelWayMpl[1] * $reelWayMpl[2] * $reelWayMpl[3] * $isWildMpl;
                                            }
                                            if( $reelWayMpl[1] > 0 && $reelWayMpl[2] > 0 && $reelWayMpl[3] > 0 && $reelWayMpl[4] > 0 ) 
                                            {
                                                $cWin = ($tmpWin = $slotSettings->Paytable['SYM_' . $csym][4] * $betline * $bonusMpl) * $reelWayMpl[1] * $reelWayMpl[2] * $reelWayMpl[3] * $reelWayMpl[4] * $isWildMpl;
                                                $cWinsCount[$k] = $slotSettings->GetSymPositions($reels_t);
                                                $wwMpl = $reelWayMpl[1] * $reelWayMpl[2] * $reelWayMpl[3] * $reelWayMpl[4] * $isWildMpl;
                                            }
                                            if( $reelWayMpl[1] > 0 && $reelWayMpl[2] > 0 && $reelWayMpl[3] > 0 && $reelWayMpl[4] > 0 && $reelWayMpl[5] > 0 ) 
                                            {
                                                $cWin = ($tmpWin = $slotSettings->Paytable['SYM_' . $csym][5] * $betline * $bonusMpl) * $reelWayMpl[1] * $reelWayMpl[2] * $reelWayMpl[3] * $reelWayMpl[4] * $reelWayMpl[5] * $isWildMpl;
                                                $cWinsCount[$k] = $slotSettings->GetSymPositions($reels_t);
                                                $wwMpl = $reelWayMpl[1] * $reelWayMpl[2] * $reelWayMpl[3] * $reelWayMpl[4] * $reelWayMpl[5] * $isWildMpl;
                                            }
                                            if( $cWin > 0 ) 
                                            {
                                                if( $wwMpl == 0 ) 
