                ...
                \DB::transaction(function() use ($request, $game)
                {
                    try
                    {
                        ...
                        else if( $postData['slotEvent'] == 'gamble5GetUserCards' ) 
                        {
                            ...
                            $dealerCard = $slotSettings->GetGameData('RedHotBurningGTMDealerCard');
                            $totalWin = $slotSettings->GetGameData('RedHotBurningGTMTotalWin');
                            $gambleWin = 0;
                            ...
                            $slotSettings->SetGameData('RedHotBurningGTMTotalWin', $totalWin);
                        ...
                        else if( $postData['slotEvent'] == 'gamble5GetDealerCard' ) 
                        {
                            ...
                            $slotSettings->SetGameData('RedHotBurningGTMDealerCard', $tmpDc);
                        ...
                        else if( $postData['slotEvent'] == 'bet' || $postData['slotEvent'] == 'freespin' ) 
                        {
                            ...
                            if( $postData['slotEvent'] != 'freespin' ) 
                            {
                                ...
                                $bonusMpl = 1;
                                $slotSettings->SetGameData('RedHotBurningGTMBonusWin', 0);
                                $slotSettings->SetGameData('RedHotBurningGTMFreeGames', 0);
                                $slotSettings->SetGameData('RedHotBurningGTMCurrentFreeGame', 0);
                                $slotSettings->SetGameData('RedHotBurningGTMTotalWin', 0);
                                $slotSettings->SetGameData('RedHotBurningGTMFreeBalance', 0);
                            }
                            else
                            {
                                $slotSettings->SetGameData('RedHotBurningGTMCurrentFreeGame', $slotSettings->GetGameData('RedHotBurningGTMCurrentFreeGame') + 1);
                            ...
                            for( $i = 0; $i <= 2000; $i++ ) 
                            {
                                ...
                                $reelsTmp = $reels;
                                if( $reels['reel2'][0] == 'P_1' || $reels['reel2'][1] == 'P_1' || $reels['reel2'][2] == 'P_1' ) 
                                {
                                    if( $reels['reel2'][0] != 'P_1' ) 
                                    {
                                        $reels['reel2'][0] = 'P_1_WILD';
                                    }
                                    if( $reels['reel2'][1] != 'P_1' ) 
                                    {
                                        $reels['reel2'][1] = 'P_1_WILD';
                                    }
                                    if( $reels['reel2'][2] != 'P_1' ) 
                                    {
                                        $reels['reel2'][2] = 'P_1_WILD';
                                    }
                                }
                                if( $reels['reel3'][0] == 'P_1' || $reels['reel3'][1] == 'P_1' || $reels['reel3'][2] == 'P_1' ) 
                                {
                                    if( $reels['reel3'][0] != 'P_1' ) 
                                    {
                                        $reels['reel3'][0] = 'P_1_WILD';
                                    }
                                    if( $reels['reel3'][1] != 'P_1' ) 
                                    {
                                        $reels['reel3'][1] = 'P_1_WILD';
                                    }
                                    if( $reels['reel3'][2] != 'P_1' ) 
                                    {
                                        $reels['reel3'][2] = 'P_1_WILD';
                                    }
                                }
                                if( $reels['reel4'][0] == 'P_1' || $reels['reel4'][1] == 'P_1' || $reels['reel4'][2] == 'P_1' ) 
                                {
                                    if( $reels['reel4'][0] != 'P_1' ) 
                                    {
                                        $reels['reel4'][0] = 'P_1_WILD';
                                    }
                                    if( $reels['reel4'][1] != 'P_1' ) 
                                    {
                                        $reels['reel4'][1] = 'P_1_WILD';
                                    }
                                    if( $reels['reel4'][2] != 'P_1' ) 
                                    {
                                        $reels['reel4'][2] = 'P_1_WILD';
                                    }
                                }
                                for( $k = 0; $k < $postData['slotLines']; $k++ ) 
                                {
                                    ...
                                    for( $j = 0; $j < count($slotSettings->SymbolGame); $j++ ) 
                                    {
                                        ...
                                        if( $csym == $scatter || $csym == $scatter2 || in_array($csym, $wild) ) 
                                        {
                                        }
                                        else
                                        {
                                            ...
                                            if( $s[0] == $csym || in_array($s[0], $wild) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":1,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('RedHotBurningGTMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":["none","none"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":2,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('RedHotBurningGTMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            $s[0] = $reels['reel1'][$linesId[$k][0] - 1];
                                            $s[1] = $reels['reel2'][$linesId[$k][1] - 1];
                                            ...
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":3,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('RedHotBurningGTMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            $s[0] = $reels['reel1'][$linesId[$k][0] - 1];
                                            $s[1] = $reels['reel2'][$linesId[$k][1] - 1];
                                            ...
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) && ($s[3] == $csym || in_array($s[3], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":4,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('RedHotBurningGTMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            $s[0] = $reels['reel1'][$linesId[$k][0] - 1];
                                            $s[1] = $reels['reel2'][$linesId[$k][1] - 1];
                                            ...
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) && ($s[3] == $csym || in_array($s[3], $wild)) && ($s[4] == $csym || in_array($s[4], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":5,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('RedHotBurningGTMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":[' . ($linesId[$k][4] - 1) . ',"' . $s[4] . '"]}';
                                                }
                                            }
                                        }
                                    }
                                ...
                                {
                                    $scattersStr2 .= '"scattersType":"bonus",';
                                }
                                else if( $scattersWin2 > 0 ) 
                                {
                            ...
                            if( $postData['slotEvent'] == 'freespin' && $slotSettings->GetGameData('RedHotBurningGTMFreeGames') <= $slotSettings->GetGameData('RedHotBurningGTMCurrentFreeGame') && $winType != 'bonus' && $slotSettings->GetGameData('RedHotBurningGTMTotalWin') + $totalWin > 0 ) 
                            {
                                $slotSettings->SetBalance($slotSettings->GetGameData('RedHotBurningGTMTotalWin') + $totalWin);
                            }
                            ...
                            if( $postData['slotEvent'] == 'freespin' ) 
                            {
                                $slotSettings->SetGameData('RedHotBurningGTMBonusWin', $slotSettings->GetGameData('RedHotBurningGTMBonusWin') + $totalWin);
                                $slotSettings->SetGameData('RedHotBurningGTMTotalWin', $slotSettings->GetGameData('RedHotBurningGTMTotalWin') + $totalWin);
                                $totalWin = $slotSettings->GetGameData('RedHotBurningGTMBonusWin');
                                $Balance = $slotSettings->GetGameData('RedHotBurningGTMFreeBalance');
                            }
                            else
                            {
                                $slotSettings->SetGameData('RedHotBurningGTMTotalWin', $totalWin);
                            ...
                            if( $scattersCount >= 3 ) 
                            {
                                if( $slotSettings->GetGameData('RedHotBurningGTMFreeGames') > 0 ) 
                                {
                                    $slotSettings->SetGameData('RedHotBurningGTMFreeBalance', $Balance);
                                    $slotSettings->SetGameData('RedHotBurningGTMBonusWin', $totalWin);
                                    $slotSettings->SetGameData('RedHotBurningGTMFreeGames', $slotSettings->GetGameData('RedHotBurningGTMFreeGames') + $slotSettings->slotFreeCount);
                                }
                                else
                                {
                                    $slotSettings->SetGameData('RedHotBurningGTMFreeBalance', $Balance);
                                    $slotSettings->SetGameData('RedHotBurningGTMBonusWin', $totalWin);
                                    $slotSettings->SetGameData('RedHotBurningGTMFreeGames', $slotSettings->slotFreeCount);
                                }
                            }
                            $jsSpin = '' . json_encode($reels) . '';
                            $jsJack = '' . json_encode($slotSettings->Jackpots) . '';
                            $winString = implode(',', $lineWins);
                            $response = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{"slotLines":' . $postData['slotLines'] . ',"slotBet":' . $postData['slotBet'] . ',"totalFreeGames":' . $slotSettings->GetGameData('RedHotBurningGTMFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('RedHotBurningGTMCurrentFreeGame') . ',"Balance":' . $Balance . ',"afterBalance":' . $slotSettings->GetBalance() . ',"totalWin":' . $totalWin . ',"winLines":[' . $winString . '],"bonusInfo2":' . $scattersStr2 . ',"bonusInfo":' . $scattersStr . ',"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
