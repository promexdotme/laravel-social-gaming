            ...
            function get_($request, $game)
            {
                \DB::transaction(function() use ($request, $game)
                {
                    try
                    {
                        ...
                        {
                            case 'create_session':
                                $slotSettings->SetGameData('FullOfLuckCTCards', [
                                    19, 
                                    44, 
                                    0, 
                                    37, 
                            ...
                            case 'init_game':
                                ...
                                $slotSettings->SetGameData('FullOfLuckCTBonusWin', 0);
                                $slotSettings->SetGameData('FullOfLuckCTFreeGames', 0);
                                $slotSettings->SetGameData('FullOfLuckCTCurrentFreeGame', 0);
                                $slotSettings->SetGameData('FullOfLuckCTCurrentFreeGame0', 0);
                                $slotSettings->SetGameData('FullOfLuckCTTotalWin', 0);
                                $slotSettings->SetGameData('FullOfLuckCTFreeBalance', 0);
                                ...
                                if( $lastEvent != 'NULL' ) 
                                {
                                    ...
                                    if( $slotSettings->GetGameData('FullOfLuckCTCurrentFreeGame') < $slotSettings->GetGameData('FullOfLuckCTFreeGames') && $slotSettings->GetGameData('FullOfLuckCTFreeGames') > 0 ) 
                                    {
                            ...
                            case 'poll':
                                ...
                                {
                                    $balanceInCents = sprintf('%01.2f', $slotSettings->GetBalance() - $slotSettings->GetGameData('FullOfLuckCTTotalWin')) * 100;
                                }
                            ...
                            case 'game_finished':
                                $slotSettings->SetGameData('FullOfLuckCTBonusWin', 0);
                                $slotSettings->SetGameData('FullOfLuckCTTotalWin', 0);
                                $responseData['game_finished'][0]['freeround_play'] = $slotSettings->GetGameData('FullOfLuckCTCurrentFreeGame0');
                            ...
                            case 'subgame_finished':
                                if( $slotSettings->GetGameData('FullOfLuckCTCurrentFreeGame0') < $slotSettings->GetGameData('FullOfLuckCTFreeGames') && $slotSettings->GetGameData('FullOfLuckCTFreeGames') > 0 ) 
                                {
                                    ...
                                    $response = '{"responseEvent":"spin","responseType":"freespin","serverResponse":{"result":' . json_encode($result) . ',"slotDenom":' . $slotSettings->GetGameData($slotSettings->slotId . 'Denom') . ',"slotLines":' . $lines . ',"slotBet":' . $betline . ',"totalFreeGames":' . $slotSettings->GetGameData('FullOfLuckCTFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('FullOfLuckCTCurrentFreeGame0') . ',"Balance":' . $slotSettings->GetGameData('FullOfLuckCTFreeBalance') . ',"afterBalance":' . $slotSettings->GetGameData('FullOfLuckCTFreeBalance') . ',"bonusWin":' . $slotSettings->GetGameData('FullOfLuckCTBonusWin') . ',"totalWin":' . $reportWin . ',"winLines":[],"Jackpots":[],"reelsSymbols":' . json_encode($slotSettings->GetGameData($slotSettings->slotId . 'Reels')) . '}}';
                                    if( $slotSettings->GetGameData('FullOfLuckCTFreeGames') <= $slotSettings->GetGameData('FullOfLuckCTCurrentFreeGame0') ) 
                                    {
                                        if( $reportWin > 0 ) 
                                        {
                                    ...
                                    $balanceInCents = $slotSettings->GetGameData('FullOfLuckCTFreeBalance');
                                    $responseData['subgame_finished'][0]['account_status']['credit'] = round($balanceInCents);
                                    $responseData['subgame_finished'][0]['freeround_play'] = $slotSettings->GetGameData('FullOfLuckCTCurrentFreeGame0');
                                    $responseData['subgame_finished'][1]['freeround_play'] = $slotSettings->GetGameData('FullOfLuckCTCurrentFreeGame0');
                            ...
                            case 'play':
                                ...
                                for( $spinLoop = 0; $spinLoop < $spinLoopLimit; $spinLoop++ ) 
                                {
                                    ...
                                    if( $postData['slotEvent'] != 'freespin' ) 
                                    {
                                        ...
                                        $slotSettings->SetGameData('FullOfLuckCTCurrentFreeGame0', 0);
                                        $slotSettings->SetGameData('FullOfLuckCTTotalWin', 0);
                                        $slotSettings->SetGameData('FullOfLuckCTFreeBalance', sprintf('%01.2f', $slotSettings->GetBalance()) * 100);
                                    ...
                                    {
                                        $slotSettings->SetGameData('FullOfLuckCTCurrentFreeGame', $slotSettings->GetGameData('FullOfLuckCTCurrentFreeGame') + 1);
                                    ...
                                    if( $postData['slotEvent'] == 'freespin' ) 
                                    {
                                        $slotSettings->SetGameData('FullOfLuckCTBonusWin', $slotSettings->GetGameData('FullOfLuckCTBonusWin') + $totalWin);
                                        $slotSettings->SetGameData('FullOfLuckCTTotalWin', $slotSettings->GetGameData('FullOfLuckCTTotalWin') + $totalWin);
                                        $balanceInCents = $slotSettings->GetGameData('FullOfLuckCTFreeBalance');
                                    }
                                    else
                                    {
                                        $slotSettings->SetGameData('FullOfLuckCTTotalWin', $totalWin);
                                    }
                                    $fs = 0;
                                    if( $scattersCount >= 2 ) 
                                    {
                                    ...
                                    $winstring = '';
                                    $slotSettings->SetGameData('FullOfLuckCTGambleStep', 5);
                                    $hist = $slotSettings->GetGameData('FullOfLuckCTCards');
                                    if( $postData['slotEvent'] == 'freespin' ) 
                                    {
                                        $state = 'freespin';
                                        ...
                                        if( $slotSettings->GetGameData($slotSettings->slotId . 'FreeGames') <= $slotSettings->GetGameData($slotSettings->slotId . 'CurrentFreeGame') && $slotSettings->GetGameData('FullOfLuckCTBonusWin') > 0 ) 
                                        {
                                            $responseData['play'][0]['result'][$spinLoop]['is_free'] = true;
                                    ...
                                    $responseData['play'][0]['result'][$spinLoop]['total_win'] = $slotSettings->GetGameData('FullOfLuckCTTotalWin') / $denom;
                                ...
                                $response = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{"result":' . json_encode($responseData['play'][0]['result']) . ',"slotDenom":' . $denom . ',"slotLines":' . $lines . ',"slotBet":' . $betline . ',"totalFreeGames":' . $slotSettings->GetGameData('FullOfLuckCTFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('FullOfLuckCTCurrentFreeGame0') . ',"Balance":' . $slotSettings->GetGameData($slotSettings->slotId . 'FreeBalance') . ',"afterBalance":' . $slotSettings->GetBalance() . ',"bonusWin":' . $slotSettings->GetGameData('FullOfLuckCTBonusWin') . ',"totalWin":' . $totalWin . ',"winLines":[],"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
                            ...
                            case 'gamble':
                                ...
                                $dealerCard = '';
                                $totalWin = $slotSettings->GetGameData('FullOfLuckCTTotalWin');
                                $gambleWin = 0;
                                $statBet = $totalWin;
                                ...
                                $hist = $slotSettings->GetGameData('FullOfLuckCTCards');
                                $slotSettings->SetGameData('FullOfLuckCTGambleStep', $slotSettings->GetGameData('FullOfLuckCTGambleStep') - 1);
                                if( $slotSettings->MaxWin < ($totalWin * $slotSettings->CurrentDenom) ) 
                                {
                                    $isGambleWin = 0;
                                }
                                ...
                                else
                                {
                                    ...
                                    $totalWin = 0;
                                    $slotSettings->SetGameData('FullOfLuckCTGambleStep', 0);
                                    if( $postData['continue_params']['double_key'] != 'red' && $postData['continue_params']['double_key'] != 'black' ) 
                                    {
                                        if( $postData['continue_params']['double_key'] == 'diamond' ) 
                                        {
                                ...
                                $slotSettings->SetGameData('FullOfLuckCTCards', $hist);
