                    ...
                    switch( $gameData['slotEvent'] ) 
                    {
                        ...
                        case 'A/u25':
                            ...
                            if( $lastEvent != 'NULL' ) 
                            {
                                ...
                                $slotSettings->SetGameData('EyeOfRaAMLines', $curLines);
                                $freeMpl = '11';
                                $slotSettings->SetGameData('EyeOfRaAMBonusWin', $lastEvent->serverResponse->bonusWin);
                                $slotSettings->SetGameData('EyeOfRaAMFreeGames', $lastEvent->serverResponse->totalFreeGames);
                                $slotSettings->SetGameData('EyeOfRaAMCurrentFreeGame', $lastEvent->serverResponse->currentFreeGames);
                                $slotSettings->SetGameData('EyeOfRaAMTotalWin', 0);
                                $slotSettings->SetGameData('EyeOfRaAMFreeBalance', 0);
                                $slotSettings->SetGameData('EyeOfRaAMFreeStartWin', 0);
                                $tFree = dechex($slotSettings->GetGameData('EyeOfRaAMFreeGames'));
                                $cFree = dechex($slotSettings->GetGameData('EyeOfRaAMFreeGames') - $slotSettings->GetGameData('EyeOfRaAMCurrentFreeGame'));
                                $freeInfo = strlen($tFree) . $tFree . strlen($cFree) . $cFree;
                                $stateWin = $slotSettings->HexFormat($slotSettings->GetGameData('EyeOfRaAMBonusWin') * $floatBet);
                                if( $slotSettings->GetGameData('EyeOfRaAMCurrentFreeGame') < $slotSettings->GetGameData('EyeOfRaAMFreeGames') && $slotSettings->GetGameData('EyeOfRaAMFreeGames') > 0 ) 
                                {
                                    $slotState = '6';
                            ...
                            {
                                $slotSettings->SetGameData('EyeOfRaAMLines', $fixedLinesFormated);
                                $slotState = '4';
                            ...
                            break;
                        case 'A/u250':
                            $fixedLinesFormated = $slotSettings->GetGameData('EyeOfRaAMLines');
                            $balanceFormated = $slotSettings->HexFormat(round($slotSettings->GetBalance() * $floatBet));
                            $lastEvent = $slotSettings->GetHistory();
                            if( $lastEvent != 'NULL' ) 
                            {
                        ...
                        case 'A/u251':
                            if( $postData['spinType'] == 'regular' && $slotSettings->GetGameData($slotSettings->slotId . 'FreeGames') <= $slotSettings->GetGameData($slotSettings->slotId . 'CurrentFreeGame') ) 
                            {
                                ...
                                $bonusMpl = 1;
                                $slotSettings->SetGameData('EyeOfRaAMBonusWin', 0);
                                $slotSettings->SetGameData('EyeOfRaAMFreeGames', 0);
                                $slotSettings->SetGameData('EyeOfRaAMCurrentFreeGame', 0);
                                $slotSettings->SetGameData('EyeOfRaAMTotalWin', 0);
                                $slotSettings->SetGameData('EyeOfRaAMFreeBalance', 0);
                                $slotSettings->SetGameData('EyeOfRaAMFreeStartWin', 0);
                            }
                            if( $slotSettings->GetGameData($slotSettings->slotId . 'CurrentFreeGame') < $slotSettings->GetGameData($slotSettings->slotId . 'FreeGames') ) 
                            {
                                ...
                                $slotSettings->SetGameData('EyeOfRaAMCurrentFreeGame', $slotSettings->GetGameData('EyeOfRaAMCurrentFreeGame') + 1);
                            ...
                            if( $postData['slotEvent'] == 'freespin' && $slotSettings->GetGameData('EyeOfRaAMFreeGames') <= $slotSettings->GetGameData('EyeOfRaAMCurrentFreeGame') && $winType != 'bonus' && $slotSettings->GetGameData('EyeOfRaAMBonusWin') + $totalWin > 0 ) 
                            {
                                $slotSettings->SetBalance($slotSettings->GetGameData('EyeOfRaAMBonusWin') + $totalWin);
                            }
                            ...
                            if( $postData['slotEvent'] == 'freespin' ) 
                            {
                                $slotSettings->SetGameData('EyeOfRaAMBonusWin', $slotSettings->GetGameData('EyeOfRaAMBonusWin') + $totalWin);
                                $slotSettings->SetGameData('EyeOfRaAMTotalWin', $totalWin);
                            }
                            else
                            {
                                $slotSettings->SetGameData('EyeOfRaAMTotalWin', $totalWin);
                            ...
                            if( $scattersCount >= 3 ) 
                            {
                                ...
                                if( $slotSettings->GetGameData('EyeOfRaAMFreeGames') > 0 ) 
                                {
                                    $slotSettings->SetGameData('EyeOfRaAMFreeGames', $slotSettings->GetGameData('EyeOfRaAMFreeGames') + $slotSettings->slotFreeCount);
                                }
                                else
                                {
                                    $slotSettings->SetGameData('EyeOfRaAMFreeStartWin', $totalWin);
                                    $slotSettings->SetGameData('EyeOfRaAMBonusWin', $totalWin);
                                    $slotSettings->SetGameData('EyeOfRaAMFreeGames', $slotSettings->slotFreeCount);
                                }
                            }
                            $jsSpin = '' . json_encode($reels) . '';
                            $jsJack = '' . json_encode($slotSettings->Jackpots) . '';
                            $winString = implode(',', $lineWins);
                            $response_log = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{"symDouble":' . $symDouble . ',"slotLines":' . $lines . ',"slotBet":' . $betCnt . ',"totalFreeGames":' . $slotSettings->GetGameData('EyeOfRaAMFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('EyeOfRaAMCurrentFreeGame') . ',"Balance":' . $slotSettings->GetBalance() . ',"afterBalance":' . $slotSettings->GetBalance() . ',"bonusWin":' . $slotSettings->GetGameData('EyeOfRaAMBonusWin') . ',"freeStartWin":' . $slotSettings->GetGameData('EyeOfRaAMFreeStartWin') . ',"totalWin":' . $totalWin . ',"winLines":[' . $winString . '],"bonusInfo":' . $scattersStr . ',"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
                            ...
                            if( $postData['slotEvent'] == 'freespin' ) 
                            {
                                ...
                                $cFree = dechex($slotSettings->GetGameData('EyeOfRaAMFreeGames') - $slotSettings->GetGameData('EyeOfRaAMCurrentFreeGame'));
                                $gameState = '06';
                                if( $slotSettings->GetGameData('EyeOfRaAMFreeGames') <= $slotSettings->GetGameData('EyeOfRaAMCurrentFreeGame') ) 
                                {
                                    $gameState = '0c';
                                }
                                if( $scattersCount >= 3 ) 
                                ...
                                $totalWin = $slotSettings->GetGameData('EyeOfRaAMBonusWin');
                                $bonusMpl = $slotSettings->slotFreeMpl;
                            }
                            else
                            {
                            ...
                            $response = '1' . $gameState . '010' . $balanceFormated . $slotSettings->HexFormat(round($totalWin * 100)) . $reelSate . $bet_h . $ln_h . $freeInfo . $freeWinState . $slotSettings->HexFormat($bonusMpl) . '1010' . $reelSate . '0' . $symCountAll . $winLinesFormated . implode('', $slotSettings->GetGameData($slotSettings->slotId . 'Cards')) . '#' . implode('-', $cWins);
                            $response .= ('_' . json_encode($reels));
                            $slotSettings->SetGameData('EyeOfRaAMDoubleAnswer', $reelSate . $bet_h . $ln_h . $freeInfo . $freeWinState . $slotSettings->HexFormat($bonusMpl) . '1010' . $reelSate . '0' . $symCountAll . $winLinesFormated);
                            $slotSettings->SetGameData('EyeOfRaAMDoubleBalance', $balanceFormated);
                            $slotSettings->SetGameData('EyeOfRaAMDoubleWin', $totalWin);
                            if( $postData['slotEvent'] == 'freespin' ) 
                            {
                            ...
                            $slotSettings->SetGameData('EyeOfRaAMCollectP0', $response_collect0);
                            $gameState = '04';
                            $balanceFormated = $slotSettings->HexFormat(round($slotSettings->GetBalance() * $floatBet));
                            ...
                            $slotSettings->SetGameData('EyeOfRaAMCollect', $response_collect);
                            break;
                        case 'A/u254':
                            $slotSettings->SetGameData($slotSettings->slotId . 'TotalWin', 0);
                            $response = $slotSettings->GetGameData('EyeOfRaAMCollect');
                            break;
                        case 'A/u257':
                            $doubleWin = rand(1, 2);
                            $winall = $slotSettings->GetGameData('EyeOfRaAMDoubleWin');
                            $dbet = $winall;
                            $daction = $tmpPar[1];
                            ...
                            $response = '107010' . $slotSettings->GetGameData('EyeOfRaAMDoubleBalance') . strlen($winall_h) . $winall_h . $slotSettings->GetGameData('EyeOfRaAMDoubleAnswer') . implode('', $slotSettings->GetGameData($slotSettings->slotId . 'Cards'));
                            $slotSettings->SetGameData('EyeOfRaAMDoubleWin', $winall);
                            $slotSettings->SetGameData('EyeOfRaAMTotalWin', $winall);
                            $balanceFormated = $slotSettings->HexFormat(round($slotSettings->GetBalance() * $floatBet));
                            $response_collect = '104010' . $balanceFormated . strlen($winall_h) . $winall_h . $slotSettings->GetGameData('EyeOfRaAMCollectP0');
                            $slotSettings->SetGameData('EyeOfRaAMCollect', $response_collect);
                        ...
                        case 'A/u258':
                            ...
                            $slotSettings->SetGameData('EyeOfRaAMDoubleBalance', $rtnBalance);
                            $winall = sprintf('%01.2f', $winall) * $floatBet;
                            $winall_h1 = str_replace('.', '', $winall . '');
                            $winall_h = dechex($winall_h1);
                            $doubleCards = '26280b2714161d0c';
                            $response = '108010' . $slotSettings->GetGameData('EyeOfRaAMDoubleBalance') . strlen($winall_h) . $winall_h . $slotSettings->GetGameData('EyeOfRaAMDoubleAnswer') . implode('', $slotSettings->GetGameData($slotSettings->slotId . 'Cards'));
                            break;
                    }
