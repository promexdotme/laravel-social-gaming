                    ...
                    try
                    {
                        ...
                        if( isset($postData['umid']) ) 
                        {
                            ...
                            if( isset($postData['ID']) && $postData['ID'] == 40041 ) 
                            {
                                ...
                                for( $j = 0; $j < 4; $j++ ) 
                                {
                                    $jpa[] = '{"coinSize":' . ($slotSettings->Bet[$j] * 100) . ',"jackpot":' . ($slotSettings->slotJackpot[0] * 100) . '}';
                                }
                                $result_tmp[] = '3:::{"data":{"jackpotUpdates":{"ccccny":[' . implode(',', $jpa) . ']}},"ID":40042,"umid":10}';
                            }
                        ...
                        if( isset($postData['spinType']) ) 
                        {
                            ...
                            if( $postData['spinType'] == 'regular' ) 
                            {
                                ...
                                $bonusMpl = 1;
                                $slotSettings->SetGameData('CoinCoinCoinPTMBonusWin', 0);
                                $slotSettings->SetGameData('CoinCoinCoinPTMFreeGames', 0);
                                $slotSettings->SetGameData('CoinCoinCoinPTMCurrentFreeGame', 0);
                                $slotSettings->SetGameData('CoinCoinCoinPTMTotalWin', 0);
                                $slotSettings->SetGameData('CoinCoinCoinPTMFreeBalance', 0);
                                $slotSettings->SetGameData('CoinCoinCoinPTMFreeStartWin', 0);
                            }
                            else if( $postData['spinType'] == 'free' ) 
                            {
                                $umid = '0';
                                $postData['slotEvent'] = 'freespin';
                                $slotSettings->SetGameData('CoinCoinCoinPTMCurrentFreeGame', $slotSettings->GetGameData('CoinCoinCoinPTMCurrentFreeGame') + 1);
                                    ...
                                    for( $j = 0; $j < count($slotSettings->SymbolGame); $j++ ) 
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            if( $s[0] == $csym || in_array($s[0], $wild) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":1,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('CoinCoinCoinPTMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":["none","none"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":2,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('CoinCoinCoinPTMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":3,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('CoinCoinCoinPTMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) && ($s[3] == $csym || in_array($s[3], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":4,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('CoinCoinCoinPTMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) && ($s[3] == $csym || in_array($s[3], $wild)) && ($s[4] == $csym || in_array($s[4], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":5,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('CoinCoinCoinPTMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":[' . ($linesId[$k][4] - 1) . ',"' . $s[4] . '"]}';
                                                }
                                            }
                            ...
                            if( $postData['slotEvent'] == 'freespin' ) 
                            {
                                $slotSettings->SetGameData('CoinCoinCoinPTMBonusWin', $slotSettings->GetGameData('CoinCoinCoinPTMBonusWin') + $totalWin);
                                $slotSettings->SetGameData('CoinCoinCoinPTMTotalWin', $totalWin);
                            }
                            else
                            {
                                $slotSettings->SetGameData('CoinCoinCoinPTMTotalWin', $totalWin);
                            ...
                            $balanceInCents = sprintf('%01.2f', $slotSettings->GetBalance()) * 100;
                            $result_tmp[] = '3:::{"data":{"reelset":8,"credit":' . $balanceInCents . ',"results":[' . implode(',', $reels['rp']) . '],"windowId":"LDND1G"},"ID":48840,"umid":36}';
                            $jpa = [];
                            for( $j = 0; $j < 4; $j++ ) 
                            {
                                $jpa[] = '{"coinSize":' . ($slotSettings->Bet[$j] * 100) . ',"jackpot":' . ($slotSettings->slotJackpot[0] * 100) . '}';
                            ...
                            $response = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{"linesArr":[' . implode(',', $postData['lines']) . '],"slotLines":' . $lines . ',"slotBet":' . $betLine . ',"totalFreeGames":' . $slotSettings->GetGameData('CoinCoinCoinPTMFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('CoinCoinCoinPTMCurrentFreeGame') . ',"Balance":' . $slotSettings->GetBalance() . ',"afterBalance":' . $slotSettings->GetBalance() . ',"bonusWin":' . $slotSettings->GetGameData('CoinCoinCoinPTMBonusWin') . ',"freeStartWin":' . $slotSettings->GetGameData('CoinCoinCoinPTMFreeStartWin') . ',"totalWin":' . $totalWin . ',"winLines":[' . $winString . '],"bonusInfo":' . $scattersStr . ',"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
                            if( $jackID >= 0 && $jackPay ) 
                            {
                                $result_tmp[] = '3:::{"data":{"win":' . $jackWin . ',"windowId":"LDND1G"},"ID":48841,"umid":36}';
                        ...
                        switch( $umid ) 
                        {
                            ...
                            case '10010':
                                ...
                                break;
                            case '40066':
                                $gameBets0 = $slotSettings->Bet;
                                for( $i = 0; $i < 4; $i++ ) 
                                {
                                    $gameBets[$i] = $gameBets0[$i] * 100;
                                }
                                $result_tmp[] = '3:::{"data":{"funNoticeGames":0,"funNoticePayouts":0,"gameGroup":"ccccny","minBet":0,"maxBet":0,"minPosBet":0,"maxPosBet":50000,"coinSizes":[' . implode(',', $gameBets) . ']},"ID":40025,"umid":21}';
                                break;
                            case '40036':
                                ...
                                if( $lastEvent != 'NULL' ) 
                                {
                                    ...
                                    {
                                        $slotSettings->SetGameData($slotSettings->slotId . 'brokenGames', 'ccccny');
                                    }
                                }
