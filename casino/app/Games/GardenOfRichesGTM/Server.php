                ...
                \DB::transaction(function() use ($request, $game)
                {
                    try
                    {
                        ...
                        else if( $postData['slotEvent'] == 'gamble5GetUserCards' ) 
                        {
                            ...
                            $dealerCard = $slotSettings->GetGameData('GardenOfRichesGTMDealerCard');
                            $totalWin = $slotSettings->GetGameData('GardenOfRichesGTMTotalWin');
                            $gambleWin = 0;
                            ...
                            $slotSettings->SetGameData('GardenOfRichesGTMTotalWin', $totalWin);
                        ...
                        else if( $postData['slotEvent'] == 'gamble5GetDealerCard' ) 
                        {
                            ...
                            $slotSettings->SetGameData('GardenOfRichesGTMDealerCard', $tmpDc);
                        ...
                        else if( $postData['slotEvent'] == 'bet' || $postData['slotEvent'] == 'freespin' ) 
                        {
                            ...
                            if( $postData['slotEvent'] != 'freespin' ) 
                            {
                                ...
                                $bonusMpl = 1;
                                $slotSettings->SetGameData('GardenOfRichesGTMBonusWin', 0);
                                $slotSettings->SetGameData('GardenOfRichesGTMFreeGames', 0);
                                $slotSettings->SetGameData('GardenOfRichesGTMCurrentFreeGame', 0);
                                $slotSettings->SetGameData('GardenOfRichesGTMTotalWin', 0);
                                $slotSettings->SetGameData('GardenOfRichesGTMFreeBalance', 0);
                                $slotSettings->SetGameData('GardenOfRichesGTMFreeStacked', [
                                    'false', 
                                    'false', 
                                    'false', 
                                    'false', 
                            ...
                            else
                            {
                                ...
                                $slotSettings->SetGameData('GardenOfRichesGTMCurrentFreeGame', $slotSettings->GetGameData('GardenOfRichesGTMCurrentFreeGame') + 1);
                                $bonusMpl = $slotSettings->slotFreeMpl;
                                if( $slotSettings->GetGameData('GardenOfRichesGTMCurrentFreeGame') == $slotSettings->GetGameData('GardenOfRichesGTMFreeGames') ) 
                                {
                            ...
                            for( $i = 0; $i <= 2000; $i++ ) 
                            {
                                ...
                                if( $postData['slotEvent'] == 'freespin' ) 
                                {
                                    ...
                                    for( $ii = 1; $ii <= 5; $ii++ ) 
                                    {
                                        if( $slotSettings->GetGameData('GardenOfRichesGTMFreeStacked.' . $stackCount) == 'true' ) 
                                        {
                                    ...
                                    for( $j = 0; $j < count($slotSettings->SymbolGame); $j++ ) 
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            if( $s[0] == $csym || in_array($s[0], $wild) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":1,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('GardenOfRichesGTMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":["none","none"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":2,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('GardenOfRichesGTMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            $s[0] = $reels['reel1'][$linesId[$k][0] - 1];
                                            $s[1] = $reels['reel2'][$linesId[$k][1] - 1];
                                            ...
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":3,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('GardenOfRichesGTMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            $s[0] = $reels['reel1'][$linesId[$k][0] - 1];
                                            $s[1] = $reels['reel2'][$linesId[$k][1] - 1];
                                            ...
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) && ($s[3] == $csym || in_array($s[3], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":4,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('GardenOfRichesGTMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            $s[0] = $reels['reel1'][$linesId[$k][0] - 1];
                                            $s[1] = $reels['reel2'][$linesId[$k][1] - 1];
                                            ...
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) && ($s[3] == $csym || in_array($s[3], $wild)) && ($s[4] == $csym || in_array($s[4], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":5,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('GardenOfRichesGTMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":[' . ($linesId[$k][4] - 1) . ',"' . $s[4] . '"]}';
                                                }
                                                if( $isSlotJack ) 
                                                {
                                                    $tmpStringWin = '';
                            ...
                            if( $postData['slotEvent'] == 'freespin' && $slotSettings->GetGameData('GardenOfRichesGTMFreeGames') <= $slotSettings->GetGameData('GardenOfRichesGTMCurrentFreeGame') && $winType != 'bonus' && $slotSettings->GetGameData('GardenOfRichesGTMTotalWin') + $totalWin > 0 ) 
                            {
                                $slotSettings->SetBalance($slotSettings->GetGameData('GardenOfRichesGTMTotalWin') + $totalWin);
                            }
                            ...
                            if( $postData['slotEvent'] == 'freespin' ) 
                            {
                                $slotSettings->SetGameData('GardenOfRichesGTMBonusWin', $slotSettings->GetGameData('GardenOfRichesGTMBonusWin') + $totalWin);
                                $slotSettings->SetGameData('GardenOfRichesGTMTotalWin', $slotSettings->GetGameData('GardenOfRichesGTMTotalWin') + $totalWin);
                                $totalWin = $slotSettings->GetGameData('GardenOfRichesGTMBonusWin');
                                $Balance = $slotSettings->GetGameData('GardenOfRichesGTMFreeBalance');
                                $stackCount = 1;
                                for( $i = 1; $i <= 5; $i++ ) 
                                {
                                    if( $reels['reel' . $i][0] == 'SCAT' ) 
                                    {
                                        $slotSettings->SetGameData('GardenOfRichesGTMFreeStacked.' . $stackCount, 'true');
                                    }
                                    $stackCount++;
                            ...
                            if( $scattersCount >= 3 ) 
                            {
                                if( $slotSettings->GetGameData('GardenOfRichesGTMFreeGames') > 0 ) 
                                {
                                    $slotSettings->SetGameData('GardenOfRichesGTMFreeBalance', $Balance);
                                    $slotSettings->SetGameData('GardenOfRichesGTMBonusWin', $totalWin);
                                    $slotSettings->SetGameData('GardenOfRichesGTMFreeGames', $slotSettings->GetGameData('GardenOfRichesGTMFreeGames') + $slotSettings->slotFreeCount);
                                }
                                else
                                {
                                    $slotSettings->SetGameData('GardenOfRichesGTMFreeBalance', $Balance);
                                    $slotSettings->SetGameData('GardenOfRichesGTMBonusWin', $totalWin);
                                    $slotSettings->SetGameData('GardenOfRichesGTMFreeGames', $slotSettings->slotFreeCount);
                                    $stackCount = 1;
                                    for( $i = 1; $i <= 5; $i++ ) 
                                    {
                                        if( $reels['reel' . $i][0] == 'SCAT' ) 
                            ...
                            $response = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{"curSeq":' . json_encode($curSeq) . ',"slotLines":' . $postData['slotLines'] . ',"slotBet":' . $postData['slotBet'] . ',"slotJackpot":' . $slotSettings->slotJackpot[0] . ',"stackedWilds":[' . implode(',', $slotSettings->GetGameData('GardenOfRichesGTMFreeStacked')) . '],"totalFreeGames":' . $slotSettings->GetGameData('GardenOfRichesGTMFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('GardenOfRichesGTMCurrentFreeGame') . ',"Balance":' . $Balance . ',"afterBalance":' . $slotSettings->GetBalance() . ',"totalWin":' . $totalWin . ',"winLines":[' . $winString . '],"bonusInfo":' . $scattersStr . ',"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
                            $response_log = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{"curSeq":' . json_encode($curSeq) . ',"slotLines":' . $postData['slotLines'] . ',"slotBet":' . $postData['slotBet'] . ',"slotJackpot":' . $slotSettings->slotJackpot[0] . ',"stackedWilds":[' . implode(',', $slotSettings->GetGameData('GardenOfRichesGTMFreeStacked')) . '],"totalFreeGames":' . $slotSettings->GetGameData('GardenOfRichesGTMFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('GardenOfRichesGTMCurrentFreeGame') . ',"Balance":' . $Balance . ',"afterBalance":' . $slotSettings->GetBalance() . ',"totalWin":' . $totalWin . ',"winLines":[' . $winString . '],"bonusInfo":' . $scattersStr . ',"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
