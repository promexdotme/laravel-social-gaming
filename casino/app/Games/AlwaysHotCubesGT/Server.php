                ...
                \DB::transaction(function() use ($request, $game)
                {
                    try
                    {
                        ...
                        else if( $postData['slotEvent'] == 'gamble5GetUserCards' ) 
                        {
                            ...
                            $dealerCard = $slotSettings->GetGameData('AlwaysHotCubesGTDealerCard');
                            $totalWin = $slotSettings->GetGameData('AlwaysHotCubesGTTotalWin');
                            $gambleWin = 0;
                            ...
                            $slotSettings->SetGameData('AlwaysHotCubesGTTotalWin', $totalWin);
                        ...
                        else if( $postData['slotEvent'] == 'gamble5GetDealerCard' ) 
                        {
                            ...
                            $slotSettings->SetGameData('AlwaysHotCubesGTDealerCard', $tmpDc);
                        ...
                        else if( $postData['slotEvent'] == 'bet' || $postData['slotEvent'] == 'freespin' ) 
                        {
                            ...
                            if( $postData['slotEvent'] != 'freespin' ) 
                            {
                                ...
                                $bonusMpl = 1;
                                $slotSettings->SetGameData('AlwaysHotCubesGTBonusWin', 0);
                                $slotSettings->SetGameData('AlwaysHotCubesGTFreeGames', 0);
                                $slotSettings->SetGameData('AlwaysHotCubesGTCurrentFreeGame', 0);
                                $slotSettings->SetGameData('AlwaysHotCubesGTTotalWin', 0);
                                $slotSettings->SetGameData('AlwaysHotCubesGTFreeBalance', 0);
                            }
                            else
                            {
                                $slotSettings->SetGameData('AlwaysHotCubesGTCurrentFreeGame', $slotSettings->GetGameData('AlwaysHotCubesGTCurrentFreeGame') + 1);
                                    ...
                                    for( $j = 0; $j < count($slotSettings->SymbolGame); $j++ ) 
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            if( $s[0] == $csym || in_array($s[0], $wild) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":1,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('AlwaysHotCubesGTBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":["none","none"],"winReel3":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":2,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('AlwaysHotCubesGTBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":["none","none"]}';
                                                }
                                            }
                                            $s[0] = $reels['reel1'][$linesId[$k][0] - 1];
                                            $s[1] = $reels['reel2'][$linesId[$k][1] - 1];
                                            ...
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":3,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('AlwaysHotCubesGTBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"]}';
                                                }
                                            }
                                        }
                                    }
                            ...
                            if( $postData['slotEvent'] == 'freespin' && $slotSettings->GetGameData('AlwaysHotCubesGTFreeGames') <= $slotSettings->GetGameData('AlwaysHotCubesGTCurrentFreeGame') && $winType != 'bonus' && $slotSettings->GetGameData('AlwaysHotCubesGTTotalWin') + $totalWin > 0 ) 
                            {
                                $slotSettings->SetBalance($slotSettings->GetGameData('AlwaysHotCubesGTTotalWin') + $totalWin);
                            }
                            ...
                            if( $postData['slotEvent'] == 'freespin' ) 
                            {
                                $slotSettings->SetGameData('AlwaysHotCubesGTBonusWin', $slotSettings->GetGameData('AlwaysHotCubesGTBonusWin') + $totalWin);
                                $slotSettings->SetGameData('AlwaysHotCubesGTTotalWin', $slotSettings->GetGameData('AlwaysHotCubesGTTotalWin') + $totalWin);
                                $totalWin = $slotSettings->GetGameData('AlwaysHotCubesGTBonusWin');
                                $Balance = $slotSettings->GetGameData('AlwaysHotCubesGTFreeBalance');
                            }
                            else
                            {
                                $slotSettings->SetGameData('AlwaysHotCubesGTTotalWin', $totalWin);
                            ...
                            if( $scattersCount >= 3 ) 
                            {
                                if( $slotSettings->GetGameData('AlwaysHotCubesGTFreeGames') > 0 ) 
                                {
                                    $slotSettings->SetGameData('AlwaysHotCubesGTFreeBalance', $Balance);
                                    $slotSettings->SetGameData('AlwaysHotCubesGTBonusWin', $totalWin);
                                    $slotSettings->SetGameData('AlwaysHotCubesGTFreeGames', $slotSettings->GetGameData('AlwaysHotCubesGTFreeGames') + $slotSettings->slotFreeCount);
                                }
                                else
                                {
                                    $slotSettings->SetGameData('AlwaysHotCubesGTFreeBalance', $Balance);
                                    $slotSettings->SetGameData('AlwaysHotCubesGTBonusWin', $totalWin);
                                    $slotSettings->SetGameData('AlwaysHotCubesGTFreeGames', $slotSettings->slotFreeCount);
                                }
                            }
                            $jsSpin = '' . json_encode($reels) . '';
                            $jsJack = '' . json_encode($slotSettings->Jackpots) . '';
                            $winString = implode(',', $lineWins);
                            $response = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{"slotLines":' . $postData['slotLines'] . ',"slotBet":' . $postData['slotBet'] . ',"totalFreeGames":' . $slotSettings->GetGameData('AlwaysHotCubesGTFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('AlwaysHotCubesGTCurrentFreeGame') . ',"Balance":' . $Balance . ',"afterBalance":' . $slotSettings->GetBalance() . ',"totalWin":' . $totalWin . ',"winLines":[' . $winString . '],"bonusInfo":' . $scattersStr . ',"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
