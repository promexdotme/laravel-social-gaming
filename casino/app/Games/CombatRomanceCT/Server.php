            ...
            function get_($request, $game)
            {
                \DB::transaction(function() use ($request, $game)
                {
                    try
                    {
                        ...
                        {
                            case 'create_session':
                                $slotSettings->SetGameData('CombatRomanceCTCards', [
                                    19, 
                                    44, 
                                    0, 
                                    37, 
                            ...
                            case 'init_game':
                                ...
                                $slotSettings->SetGameData('CombatRomanceCTBonusWin', 0);
                                $slotSettings->SetGameData('CombatRomanceCTFreeGames', 0);
                                $slotSettings->SetGameData('CombatRomanceCTCurrentFreeGame', 0);
                                $slotSettings->SetGameData('CombatRomanceCTCurrentFreeGame0', 0);
                                $slotSettings->SetGameData('CombatRomanceCTTotalWin', 0);
                                $slotSettings->SetGameData('CombatRomanceCTFreeBalance', 0);
                                ...
                                if( $lastEvent != 'NULL' ) 
                                {
                                    ...
                                    if( $slotSettings->GetGameData('CombatRomanceCTCurrentFreeGame') < $slotSettings->GetGameData('CombatRomanceCTFreeGames') && $slotSettings->GetGameData('CombatRomanceCTFreeGames') > 0 ) 
                                    {
                            ...
                            case 'poll':
                                ...
                                {
                                    $balanceInCents = sprintf('%01.2f', $slotSettings->GetBalance() - $slotSettings->GetGameData('CombatRomanceCTTotalWin')) * 100;
                                }
                            ...
                            case 'game_finished':
                                $slotSettings->SetGameData('CombatRomanceCTBonusWin', 0);
                                $slotSettings->SetGameData('CombatRomanceCTTotalWin', 0);
                                $responseData['game_finished'][0]['freeround_play'] = $slotSettings->GetGameData('CombatRomanceCTCurrentFreeGame0');
                            ...
                            case 'subgame_finished':
                                if( $slotSettings->GetGameData('CombatRomanceCTCurrentFreeGame0') < $slotSettings->GetGameData('CombatRomanceCTFreeGames') && $slotSettings->GetGameData('CombatRomanceCTFreeGames') > 0 ) 
                                {
                                    ...
                                    $response = '{"responseEvent":"spin","responseType":"freespin","serverResponse":{"result":' . json_encode($result) . ',"slotDenom":' . $slotSettings->GetGameData($slotSettings->slotId . 'Denom') . ',"slotLines":' . $lines . ',"slotBet":' . $betline . ',"totalFreeGames":' . $slotSettings->GetGameData('CombatRomanceCTFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('CombatRomanceCTCurrentFreeGame0') . ',"Balance":' . $slotSettings->GetGameData('CombatRomanceCTFreeBalance') . ',"afterBalance":' . $slotSettings->GetGameData('CombatRomanceCTFreeBalance') . ',"bonusWin":' . $slotSettings->GetGameData('CombatRomanceCTBonusWin') . ',"totalWin":' . $reportWin . ',"winLines":[],"Jackpots":[],"reelsSymbols":' . json_encode($slotSettings->GetGameData($slotSettings->slotId . 'Reels')) . '}}';
                                    if( $slotSettings->GetGameData('CombatRomanceCTFreeGames') <= $slotSettings->GetGameData('CombatRomanceCTCurrentFreeGame0') ) 
                                    {
                                        if( $reportWin > 0 ) 
                                        {
                                    ...
                                    $balanceInCents = $slotSettings->GetGameData('CombatRomanceCTFreeBalance');
                                    $responseData['subgame_finished'][0]['account_status']['credit'] = round($balanceInCents);
                                    $responseData['subgame_finished'][0]['freeround_play'] = $slotSettings->GetGameData('CombatRomanceCTCurrentFreeGame0');
                                    $responseData['subgame_finished'][1]['freeround_play'] = $slotSettings->GetGameData('CombatRomanceCTCurrentFreeGame0');
                            ...
                            case 'play':
                                ...
                                for( $spinLoop = 0; $spinLoop < $spinLoopLimit; $spinLoop++ ) 
                                {
                                    ...
                                    if( $postData['slotEvent'] != 'freespin' ) 
                                    {
                                        ...
                                        $slotSettings->SetGameData('CombatRomanceCTCurrentFreeGame0', 0);
                                        $slotSettings->SetGameData('CombatRomanceCTTotalWin', 0);
                                        $slotSettings->SetGameData('CombatRomanceCTFreeBalance', sprintf('%01.2f', $slotSettings->GetBalance()) * 100);
                                    ...
                                    {
                                        $slotSettings->SetGameData('CombatRomanceCTCurrentFreeGame', $slotSettings->GetGameData('CombatRomanceCTCurrentFreeGame') + 1);
                                    ...
                                    if( $postData['slotEvent'] == 'freespin' ) 
                                    {
                                        $slotSettings->SetGameData('CombatRomanceCTBonusWin', $slotSettings->GetGameData('CombatRomanceCTBonusWin') + $totalWin);
                                        $slotSettings->SetGameData('CombatRomanceCTTotalWin', $slotSettings->GetGameData('CombatRomanceCTTotalWin') + $totalWin);
                                        $balanceInCents = $slotSettings->GetGameData('CombatRomanceCTFreeBalance');
                                    }
                                    else
                                    {
                                        $slotSettings->SetGameData('CombatRomanceCTTotalWin', $totalWin);
                                    }
                                    $fs = 0;
                                    if( $scattersCount >= 3 ) 
                                    {
                                        if( $slotSettings->GetGameData('CombatRomanceCTFreeGames') > 0 ) 
                                        {
                                            $slotSettings->SetGameData('CombatRomanceCTFreeGames', $slotSettings->GetGameData('CombatRomanceCTFreeGames') + $slotSettings->slotFreeCount);
                                        }
                                        else
                                        {
                                            $slotSettings->SetGameData('CombatRomanceCTFreeStartWin', $totalWin);
                                            $slotSettings->SetGameData('CombatRomanceCTBonusWin', $totalWin);
                                            $slotSettings->SetGameData('CombatRomanceCTFreeGames', $slotSettings->slotFreeCount);
                                        }
                                        $fs = $slotSettings->GetGameData('CombatRomanceCTFreeGames');
                                        $responseData['play'][0]['result'][0] = (array)$responseData['free_result'];
                                        $responseData['play'][0]['result'][0]['scatters_win'] = $scattersStr[0];
                                    ...
                                    {
                                        $responseData['play'][0]['result'][$spinLoop]['scatters_win'] = $scattersStr[$spinLoop];
                                    }
                                    ...
                                    $winstring = '';
                                    $slotSettings->SetGameData('CombatRomanceCTGambleStep', 5);
                                    $hist = $slotSettings->GetGameData('CombatRomanceCTCards');
                                    if( $postData['slotEvent'] == 'freespin' ) 
                                    {
                                        $state = 'freespin';
                                        ...
                                        if( $slotSettings->GetGameData($slotSettings->slotId . 'FreeGames') <= $slotSettings->GetGameData($slotSettings->slotId . 'CurrentFreeGame') && $slotSettings->GetGameData('CombatRomanceCTBonusWin') > 0 ) 
                                        {
                                            $responseData['play'][0]['result'][$spinLoop]['is_free'] = true;
                                    ...
                                    $responseData['play'][0]['result'][$spinLoop]['total_win'] = $slotSettings->GetGameData('CombatRomanceCTTotalWin') / $denom;
                                ...
                                $response = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{"result":' . json_encode($responseData['play'][0]['result']) . ',"slotDenom":' . $denom . ',"slotLines":' . $lines . ',"slotBet":' . $betline . ',"totalFreeGames":' . $slotSettings->GetGameData('CombatRomanceCTFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('CombatRomanceCTCurrentFreeGame0') . ',"Balance":' . $slotSettings->GetGameData($slotSettings->slotId . 'FreeBalance') . ',"afterBalance":' . $slotSettings->GetBalance() . ',"bonusWin":' . $slotSettings->GetGameData('CombatRomanceCTBonusWin') . ',"totalWin":' . $totalWin . ',"winLines":[],"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
                            ...
                            case 'gamble':
                                ...
                                $dealerCard = '';
                                $totalWin = $slotSettings->GetGameData('CombatRomanceCTTotalWin');
                                $gambleWin = 0;
                                $statBet = $totalWin;
                                ...
                                $hist = $slotSettings->GetGameData('CombatRomanceCTCards');
                                $slotSettings->SetGameData('CombatRomanceCTGambleStep', $slotSettings->GetGameData('CombatRomanceCTGambleStep') - 1);
                                if( $slotSettings->MaxWin < ($totalWin * $slotSettings->CurrentDenom) ) 
                                {
                                    $isGambleWin = 0;
                                }
                                ...
                                else
                                {
                                    ...
                                    $totalWin = 0;
                                    $slotSettings->SetGameData('CombatRomanceCTGambleStep', 0);
                                    if( $postData['continue_params']['double_key'] != 'red' && $postData['continue_params']['double_key'] != 'black' ) 
                                    {
                                        if( $postData['continue_params']['double_key'] == 'diamond' ) 
                                        {
                                ...
                                $slotSettings->SetGameData('CombatRomanceCTCards', $hist);
