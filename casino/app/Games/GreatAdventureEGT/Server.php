                    ...
                    try
                    {
                        ...
                        switch( $aid ) 
                        {
                            ...
                            case 'settings':
                                ...
                                $result_tmp[] = '{"complex":{"balance":' . $balanceInCents . ',"balanceRaw":' . round($balanceInCents * $slotSettings->CurrentDenom) . ',"paytableCoef":{"0":{"coef":[10,40,100],"multiplier":1},"1":{"coef":[20,50,100],"multiplier":1},"2":{"coef":[30,70,125],"multiplier":1},"3":{"coef":[40,80,150],"multiplier":1},"4":{"coef":[50,100,300],"multiplier":1},"5":{"coef":[50,100,300],"multiplier":1},"6":{"coef":[2,80,150,500],"multiplier":1},"7":{"coef":[4,100,200,1000],"multiplier":1},"8":{"coef":[2,10,50],"multiplier":1}},"bets":[' . implode(',', $gameBets) . '],"jackpotMinBet":1,"jackpot":true,"jackpotMinBet":1,"jackpot":true,"mainFakeReels":[[2,4,8,3,2,7,0,6,1,4,6,0,5,6,1,2,3,4,5,8],[7,8,0,1,3,2,4,6,0,5,7,0,2,1,5,0,3,2,5,1],[0,3,1,7,1,0,6,2,0,8,3,0,6,1,4,0,2,7,4,5],[3,6,0,1,7,0,4,8,0,2,6,8,5,7,3,6,1,4,8,2],[2,1,3,0,1,7,0,5,6,2,1,4,7,3,0,6,5,1,8,4]],"jackpotMaxBet":100000,"denominations":[' . implode(',', $denoms) . ']},"gameIdentificationNumber":' . $postData['gameIdentificationNumber'] . ',"gameNumber":-1,"sessionKey":"41be9e65e0ff03a65e8c93576bf61130","msg":"success","messageId":"' . $postData['messageId'] . '","qName":"app.services.messages.response.GameResponse","command":"settings","eventTimestamp":' . time() . '}';
                                break;
                            case 'subscribe':
                                $hist = [
                                    78, 
                                ...
                                shuffle($hist);
                                $slotSettings->SetGameData('GreatAdventureEGTCards', $hist);
                                $lastEvent = $slotSettings->GetHistory();
                                $slotSettings->SetGameData('GreatAdventureEGTBonusWin', 0);
                                $slotSettings->SetGameData('GreatAdventureEGTFreeGames', 0);
                                $slotSettings->SetGameData('GreatAdventureEGTCurrentFreeGame', 0);
                                $slotSettings->SetGameData('GreatAdventureEGTTotalWin', 0);
                                $slotSettings->SetGameData('GreatAdventureEGTFreeBalance', 0);
                                $slotSettings->SetGameData('GreatAdventureEGTFreespinCard', '-1');
                                $slotSettings->SetGameData('GreatAdventureEGTWildIndexes', []);
                                if( $lastEvent != 'NULL' ) 
                                {
                                    ...
                                    $slotSettings->SetGameData('GreatAdventureEGTFreespinCard', $lastEvent->serverResponse->freespinCard);
                                    $slotSettings->SetGameData('GreatAdventureEGTWildIndexes', $lastEvent->serverResponse->wildIndexes);
                                    ...
                                    $gtype = 1;
                                    if( $slotSettings->GetGameData('GreatAdventureEGTCurrentFreeGame') < $slotSettings->GetGameData('GreatAdventureEGTFreeGames') && $slotSettings->GetGameData('GreatAdventureEGTFreeGames') > 0 ) 
                                    {
                                        $gtype = 2;
                                    }
                                }
                            ...
                            case 'ping':
                                ...
                                break;
                            case 'choice':
                                $slotSettings->slotFreeCount = rand(3, 10);
                                $holds = rand(0, 7);
                                $slotSettings->SetGameData('GreatAdventureEGTFreeGames', $slotSettings->slotFreeCount);
                                $slotSettings->SetGameData('GreatAdventureEGTFreespinCard', $holds);
                                $slotSettings->SetGameData('GreatAdventureEGTWildIndexes', [$holds]);
                                $choice = (int)$postData['bet']['choice'];
                                $figures = [];
                                $figures[0] = '{"freespins":' . rand(3, 10) . ',"numberOfWilds":1,"wildIndexes":[' . rand(0, 7) . ']}';
                                $figures[1] = '{"freespins":' . rand(3, 10) . ',"numberOfWilds":1,"wildIndexes":[' . rand(0, 7) . ']}';
                                $figures[2] = '{"freespins":' . rand(3, 10) . ',"numberOfWilds":1,"wildIndexes":[' . rand(0, 7) . ']}';
                                $figures[3] = '{"freespins":' . rand(3, 10) . ',"numberOfWilds":1,"wildIndexes":[' . rand(0, 7) . ']}';
                                $figures[4] = '{"freespins":' . rand(3, 10) . ',"numberOfWilds":1,"wildIndexes":[' . rand(0, 7) . ']}';
                                $figures[$choice] = '{"freespins":' . $slotSettings->slotFreeCount . ',"numberOfWilds":1,"wildIndexes":[' . $holds . ']}';
                                $result_tmp[] = '{"complex":{"selectedChoice":' . $postData['bet']['choice'] . ',"figures":[' . implode(',', $figures) . '],"freespins":' . $slotSettings->slotFreeCount . ',"gameCommand":"choice"},"state":"freespin","winAmount":' . ($slotSettings->GetGameData('GreatAdventureEGTBonusWin') * 100) . ',"gameIdentificationNumber":837,"gameNumber":1788419735632,"sessionKey":"65c80f0ddb696dd15c57d302947c4f35","msg":"success","messageId":"' . $postData['messageId'] . '","qName":"app.services.messages.response.GameEventResponse","command":"bet","eventTimestamp":1566881918263}';
                                break;
                            case 'bet':
                                $linesId = [];
                                $linesId[0] = [
                                ...
                                if( $postData['slotEvent'] != 'freespin' ) 
                                {
                                    ...
                                    $slotSettings->SetGameData('GreatAdventureEGTCurrentFreeGame', 0);
                                    $slotSettings->SetGameData('GreatAdventureEGTTotalWin', 0);
                                    $slotSettings->SetGameData('GreatAdventureEGTFreeBalance', sprintf('%01.2f', $slotSettings->GetBalance()) * 100);
                                    $slotSettings->SetGameData('GreatAdventureEGTFreespinCard', '-1');
                                    $slotSettings->SetGameData('GreatAdventureEGTWildIndexes', []);
                                    $bonusMpl = 1;
                                ...
                                {
                                    $slotSettings->SetGameData('GreatAdventureEGTCurrentFreeGame', $slotSettings->GetGameData('GreatAdventureEGTCurrentFreeGame') + 1);
                                ...
                                for( $i = 0; $i <= 2000; $i++ ) 
                                {
                                    ...
                                    $wild = [''];
                                    $scatter = '8';
                                    $reels = $slotSettings->GetReelStrips($winType, $postData['slotEvent'], $slotSettings->GetGameData('GreatAdventureEGTFreespinCard'));
                                    $tmpReels = $reels;
                                    if( $postData['slotEvent'] == 'freespin' ) 
                                    {
                                        $fw = $slotSettings->GetGameData('GreatAdventureEGTWildIndexes');
                                        $wild = [$fw[0] . ''];
                                    }
                                    for( $k = 0; $k < $lines; $k++ ) 
                                    {
                                ...
                                if( $postData['slotEvent'] == 'freespin' ) 
                                {
                                    $slotSettings->SetGameData('GreatAdventureEGTBonusWin', $slotSettings->GetGameData('GreatAdventureEGTBonusWin') + $totalWin);
                                    $slotSettings->SetGameData('GreatAdventureEGTTotalWin', $slotSettings->GetGameData('GreatAdventureEGTTotalWin') + $totalWin);
                                    $balanceInCents = $slotSettings->GetGameData('GreatAdventureEGTFreeBalance');
                                }
                                else
                                {
                                    $slotSettings->SetGameData('GreatAdventureEGTTotalWin', $totalWin);
                                }
                                $fs = 0;
                                if( $scattersCount >= 3 ) 
                                {
                                    if( $slotSettings->GetGameData('GreatAdventureEGTFreeGames') > 0 ) 
                                    {
                                        $slotSettings->SetGameData('GreatAdventureEGTFreeGames', $slotSettings->GetGameData('GreatAdventureEGTFreeGames') + $slotSettings->slotFreeCount);
                                    }
                                    else
                                    {
                                        $slotSettings->SetGameData('GreatAdventureEGTFreeStartWin', $totalWin);
                                        $slotSettings->SetGameData('GreatAdventureEGTBonusWin', $totalWin);
                                        $slotSettings->SetGameData('GreatAdventureEGTFreeGames', $slotSettings->slotFreeCount);
                                    }
                                    $slotSettings->SetGameData($slotSettings->slotId . 'FirstSpin', ',"firstSpin":{"expand":[],"reels":[' . $curReels . '],"lines":[],"scatters":[' . $scattersStr . ']}');
                                    $fs = $slotSettings->GetGameData('GreatAdventureEGTFreeGames');
                                }
                                $winString = implode(',', $lineWins);
                                $jsSpin = '' . json_encode($reels) . '';
                                $jsJack = '' . json_encode($slotSettings->Jackpots) . '';
                                $response = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{"slotLines":' . $lines . '' . $slotSettings->GetGameData($slotSettings->slotId . 'FirstSpin') . ',"wildIndexes":[' . implode(',', $slotSettings->GetGameData('GreatAdventureEGTWildIndexes')) . '],"freespinCard":' . $slotSettings->GetGameData('GreatAdventureEGTFreespinCard') . ',"slotBet":' . $betline . ',"totalFreeGames":' . $slotSettings->GetGameData('GreatAdventureEGTFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('GreatAdventureEGTCurrentFreeGame') . ',"Balance":' . $balanceInCents . ',"afterBalance":' . $balanceInCents . ',"bonusWin":' . $slotSettings->GetGameData('GreatAdventureEGTBonusWin') . ',"totalWin":' . $totalWin . ',"winLines":[' . $winString . '],"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
                                $slotSettings->SaveLogReport($response, $allbet, $lines, $reportWin, $postData['slotEvent']);
                                $winstring = '';
                                $slotSettings->SetGameData('GreatAdventureEGTGambleStep', 5);
                                $hist = $slotSettings->GetGameData('GreatAdventureEGTCards');
                                if( $jackRandom == 1 ) 
                                {
                                    $state = 'jackpot';
                                    $isJack = 'true';
                                    $slotSettings->SetGameData('GreatAdventureEGTJackSteps', [
                                        0, 
                                        0, 
                                        0, 
                                        0
                                ...
                                if( $postData['slotEvent'] == 'freespin' ) 
                                {
                                    $totalWin = $slotSettings->GetGameData('GreatAdventureEGTBonusWin');
                                    $state = 'freespin';
                                ...
                                break;
                            case 'collect':
                                $result_tmp[] = '{"complex":{"gameCommand":"collect"},"state":"idle","winAmount":' . ($slotSettings->GetGameData('GreatAdventureEGTTotalWin') * 100) . ',"gameIdentificationNumber":' . $postData['gameIdentificationNumber'] . ',"gameNumber":"","balance":' . $balanceInCents . ',"sessionKey":"41be9e65e0ff03a65e8c93576bf61130","msg":"success","messageId":"' . $postData['messageId'] . '","qName":"app.services.messages.response.GameEventResponse","command":"bet","eventTimestamp":' . time() . '}';
                                $slotSettings->SetGameData('GreatAdventureEGTTotalWin', 0);
                                break;
                            case 'jackpot':
                                $jackStep = $slotSettings->GetGameData('GreatAdventureEGTJackSteps');
                                $jackWinID = $slotSettings->GetGameData($slotSettings->slotId . 'JackWinID');
                                if( $jackStep[0] >= 3 || $jackStep[1] >= 3 || $jackStep[2] >= 3 || $jackStep[3] >= 3 || !$slotSettings->HasGameData('GreatAdventureEGTJackSteps') ) 
                                {
                                    exit();
                                }
                                $winAmount = 0;
                                ...
                                $slotSettings->SetGameData('GreatAdventureEGTJackSteps', $jackStep);
                                break;
                            case 'gamble':
                                $Balance = $slotSettings->GetBalance();
                                $isGambleWin = rand(1, $slotSettings->GetGambleSettings());
                                $dealerCard = '';
                                $totalWin = $slotSettings->GetGameData('GreatAdventureEGTTotalWin');
                                $gambleWin = 0;
                                $statBet = $totalWin;
                                $slotSettings->SetGameData('GreatAdventureEGTGambleStep', $slotSettings->GetGameData('GreatAdventureEGTGambleStep') - 1);
                                ...
                                else
                                {
                                    ...
                                    $totalWin = 0;
                                    $slotSettings->SetGameData('GreatAdventureEGTGambleStep', 0);
                                    if( $postData['bet']['color'] == '1' ) 
                                    {
                                        $tmpCards = [
                                            '1', 
                                ...
                                $gtype = 1;
                                $gtype0 = 1;
                                if( $slotSettings->GetGameData('GreatAdventureEGTBonusStart') == 1 ) 
                                {
                                    $gtype0 = 2;
                                }
                                $result_tmp[] = '{"complex":{"gambles":' . $slotSettings->GetGameData('GreatAdventureEGTGambleStep') . ',"card":' . $dealerCard . ',"jackpot":false,"gameCommand":"gamble"},"state":"' . $gambleState . '","winAmount":' . ($totalWin * 100) . ',"gameIdentificationNumber":' . $postData['gameIdentificationNumber'] . ',"gameNumber":"","sessionKey":"88e2b82e6537db4a339e4e1b5ce462cd","msg":"success","messageId":"' . $postData['messageId'] . '","qName":"app.services.messages.response.GameEventResponse","command":"bet","eventTimestamp":' . time() . '}';
                                break;
                        }
