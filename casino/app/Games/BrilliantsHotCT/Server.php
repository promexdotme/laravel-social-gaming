            ...
            function get_($request, $game)
            {
                \DB::transaction(function() use ($request, $game)
                {
                    try
                    {
                        ...
                        {
                            case 'create_session':
                                $slotSettings->SetGameData('BrilliantsHotCTCards', [
                                    19, 
                                    44, 
                                    0, 
                                    37, 
                            ...
                            case 'continue':
                                ...
                                $slotSettings->SetGameData('BrilliantsHotCTTotalWin', 0);
                            ...
                            case 'init_game':
                                ...
                                $slotSettings->SetGameData('BrilliantsHotCTBonusWin', 0);
                                $slotSettings->SetGameData('BrilliantsHotCTFreeGames', 0);
                                $slotSettings->SetGameData('BrilliantsHotCTCurrentFreeGame', 0);
                                $slotSettings->SetGameData('BrilliantsHotCTCurrentFreeGame0', 0);
                                $slotSettings->SetGameData('BrilliantsHotCTTotalWin', 0);
                                $slotSettings->SetGameData('BrilliantsHotCTFreeBalance', 0);
                                ...
                                if( $lastEvent != 'NULL' ) 
                                {
                                    ...
                                    if( $slotSettings->GetGameData('BrilliantsHotCTCurrentFreeGame') < $slotSettings->GetGameData('BrilliantsHotCTFreeGames') && $slotSettings->GetGameData('BrilliantsHotCTFreeGames') > 0 ) 
                                    {
                            ...
                            case 'poll':
                                ...
                                {
                                    $balanceInCents = sprintf('%01.2f', $slotSettings->GetBalance() - $slotSettings->GetGameData('BrilliantsHotCTTotalWin')) * 100;
                                }
                            ...
                            case 'game_finished':
                                $slotSettings->SetGameData('BrilliantsHotCTBonusWin', 0);
                                $slotSettings->SetGameData('BrilliantsHotCTTotalWin', 0);
                                $responseData['game_finished'][0]['freeround_play'] = $slotSettings->GetGameData('BrilliantsHotCTCurrentFreeGame0');
                            ...
                            case 'subgame_finished':
                                if( $slotSettings->GetGameData('BrilliantsHotCTCurrentFreeGame0') < $slotSettings->GetGameData('BrilliantsHotCTFreeGames') && $slotSettings->GetGameData('BrilliantsHotCTFreeGames') > 0 ) 
                                {
                                    ...
                                    $response = '{"responseEvent":"spin","responseType":"freespin","serverResponse":{"result":' . json_encode($result) . ',"slotDenom":' . $slotSettings->GetGameData($slotSettings->slotId . 'Denom') . ',"slotLines":' . $lines . ',"slotBet":' . $betline . ',"totalFreeGames":' . $slotSettings->GetGameData('BrilliantsHotCTFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('BrilliantsHotCTCurrentFreeGame0') . ',"Balance":' . $slotSettings->GetGameData('BrilliantsHotCTFreeBalance') . ',"afterBalance":' . $slotSettings->GetGameData('BrilliantsHotCTFreeBalance') . ',"bonusWin":' . $slotSettings->GetGameData('BrilliantsHotCTBonusWin') . ',"totalWin":' . $reportWin . ',"winLines":[],"Jackpots":[],"reelsSymbols":' . json_encode($slotSettings->GetGameData($slotSettings->slotId . 'Reels')) . '}}';
                                    if( $slotSettings->GetGameData('BrilliantsHotCTFreeGames') <= $slotSettings->GetGameData('BrilliantsHotCTCurrentFreeGame0') ) 
                                    {
                                        if( $reportWin > 0 ) 
                                        {
                                    ...
                                    $balanceInCents = $slotSettings->GetGameData('BrilliantsHotCTFreeBalance');
                                    $responseData['subgame_finished'][0]['account_status']['credit'] = round($balanceInCents);
                                    $responseData['subgame_finished'][0]['freeround_play'] = $slotSettings->GetGameData('BrilliantsHotCTCurrentFreeGame0');
                                    $responseData['subgame_finished'][1]['freeround_play'] = $slotSettings->GetGameData('BrilliantsHotCTCurrentFreeGame0');
                            ...
                            case 'play':
                                ...
                                for( $spinLoop = 0; $spinLoop < $spinLoopLimit; $spinLoop++ ) 
                                {
                                    ...
                                    if( $postData['slotEvent'] != 'freespin' ) 
                                    {
                                        ...
                                        $slotSettings->SetGameData('BrilliantsHotCTCurrentFreeGame0', 0);
                                        $slotSettings->SetGameData('BrilliantsHotCTTotalWin', 0);
                                        $slotSettings->SetGameData('BrilliantsHotCTFreeBalance', sprintf('%01.2f', $slotSettings->GetBalance()) * 100);
                                    ...
                                    {
                                        $slotSettings->SetGameData('BrilliantsHotCTCurrentFreeGame', $slotSettings->GetGameData('BrilliantsHotCTCurrentFreeGame') + 1);
                                    ...
                                    if( $postData['slotEvent'] == 'freespin' ) 
                                    {
                                        $slotSettings->SetGameData('BrilliantsHotCTBonusWin', $slotSettings->GetGameData('BrilliantsHotCTBonusWin') + $totalWin);
                                        $slotSettings->SetGameData('BrilliantsHotCTTotalWin', $slotSettings->GetGameData('BrilliantsHotCTTotalWin') + $totalWin);
                                        $balanceInCents = $slotSettings->GetGameData('BrilliantsHotCTFreeBalance');
                                    }
                                    else
                                    {
                                        $slotSettings->SetGameData('BrilliantsHotCTTotalWin', $totalWin);
                                    }
                                    $fs = 0;
                                    if( $scattersCount >= 3 ) 
                                    {
                                    ...
                                    $winstring = '';
                                    $slotSettings->SetGameData('BrilliantsHotCTGambleStep', 5);
                                    $hist = $slotSettings->GetGameData('BrilliantsHotCTCards');
                                    if( $postData['slotEvent'] == 'freespin' ) 
                                    {
                                        $state = 'freespin';
                                        ...
                                        if( $slotSettings->GetGameData($slotSettings->slotId . 'FreeGames') <= $slotSettings->GetGameData($slotSettings->slotId . 'CurrentFreeGame') && $slotSettings->GetGameData('BrilliantsHotCTBonusWin') > 0 ) 
                                        {
                                            $responseData['play'][0]['result'][$spinLoop]['is_free'] = true;
                                    ...
                                    $responseData['play'][0]['result'][$spinLoop]['total_win'] = $slotSettings->GetGameData('BrilliantsHotCTTotalWin') / $denom;
                                ...
                                $response = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{"result":' . json_encode($responseData['play'][0]['result']) . ',"slotDenom":' . $denom . ',"slotLines":' . $lines . ',"slotBet":' . $betline . ',"totalFreeGames":' . $slotSettings->GetGameData('BrilliantsHotCTFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('BrilliantsHotCTCurrentFreeGame0') . ',"Balance":' . $slotSettings->GetGameData($slotSettings->slotId . 'FreeBalance') . ',"afterBalance":' . $slotSettings->GetBalance() . ',"bonusWin":' . $slotSettings->GetGameData('BrilliantsHotCTBonusWin') . ',"totalWin":' . $totalWin . ',"winLines":[],"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
                            ...
                            case 'gamble':
                                ...
                                $dealerCard = '';
                                $totalWin = $slotSettings->GetGameData('BrilliantsHotCTTotalWin');
                                $gambleWin = 0;
                                $statBet = $totalWin;
                                ...
                                $hist = $slotSettings->GetGameData('BrilliantsHotCTCards');
                                $slotSettings->SetGameData('BrilliantsHotCTGambleStep', $slotSettings->GetGameData('BrilliantsHotCTGambleStep') - 1);
                                if( $slotSettings->MaxWin < ($totalWin * $slotSettings->CurrentDenom) ) 
                                {
                                    $isGambleWin = 0;
                                }
                                ...
                                else
                                {
                                    ...
                                    $totalWin = 0;
                                    $slotSettings->SetGameData('BrilliantsHotCTGambleStep', 0);
                                    if( $postData['continue_params']['double_key'] != 'red' && $postData['continue_params']['double_key'] != 'black' ) 
                                    {
                                        if( $postData['continue_params']['double_key'] == 'diamond' ) 
                                        {
                                ...
                                $slotSettings->SetGameData('BrilliantsHotCTCards', $hist);
