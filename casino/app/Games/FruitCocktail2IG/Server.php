            ...
            function get_($request, $game)
            {
                \DB::transaction(function() use ($request, $game)
                {
                    try
                    {
                        ...
                        else if( $postData['action'] == 'risk' && $slotSettings->GetGameData('FruitCocktail2IGWin') <= 0 ) 
                        {
                        ...
                        switch( $postData['action'] ) 
                        {
                            ...
                            case 'start':
                                ...
                                {
                                    $totalWin = 0;
                                    $reels = $slotSettings->GetReelStrips($isBonus, $isBonus2);
                                    $lineWins = [
                                        0, 
                                        0, 
                                        0, 
                                    ...
                                    else
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            if( $bonusSym2 >= 3 ) 
                                            {
                                                ...
                                                $wfr = $slotSettings->GetFreeSpins($bet, $lines, $countFreeSpins);
                                                $freeWin = $wfr[0];
                                                $infoBonus = '"FreeGames":[' . implode(',', $wfr[1]) . '], "FreeGamesCnt":' . $countFreeSpins . ',';
                                            }
                                            if( $bonusSym >= 3 && !$isBonus ) 
                                            {
                                            }
                                            else if( $bonusSym2 >= 3 && !$isBonus2 ) 
                                            {
                                            }
                                            else if( $bank < ($totalWin + $freeWin) ) 
                                            {
                                            }
                                            else
                                            {
                                ...
                                $balanceIncrease = $totalWin + $freeWin;
                                ...
                                $slotSettings->SetGameData('FruitCocktail2IGReels', $reelStr);
                                $slotSettings->SetGameData('FruitCocktail2IGWin', $totalWin + $freeWin);
                                ...
                                $slotSettings->SetGameData('FruitCocktail2IGDealerCard', $card);
                                $rState = 'bet';
                                if( $isBonus ) 
                                {
                                    $rState = 'BG';
                                ...
                                $slotSettings->SaveLogReport($response, $bet, $lines, $totalWin + $freeWin, $rState);
                                break;
                            case 'finish':
                                $balance = $slotSettings->GetBalance();
