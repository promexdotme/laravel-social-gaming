            ...
            function get_($request, $game)
            {
                \DB::transaction(function() use ($request, $game)
                {
                    try
                    {
                        ...
                        {
                            $result_tmp = [];
                            if( $slotSettings->GetGameData('NightOutPTMBonusStep') == 0 ) 
                            {
                                $WinArr = [
                                    25, 
                                    22, 
                                ...
                                shuffle($WinArr);
                                $slotSettings->SetGameData('NightOutPTMBonusOpt', $WinArr);
                                $curWin = $WinArr[0];
                                $slotSettings->SetGameData('NightOutPTMFreeGames', $curWin);
                                $result_tmp[] = '3:::{"data":{"winList":[' . $curWin . ',' . $WinArr[1] . ',' . $WinArr[2] . ',' . $WinArr[3] . ',' . $WinArr[4] . ',' . $WinArr[5] . '],"windowId":"OHOJFb"},"ID":40201,"umid":1493}';
                                $slotSettings->SetGameData('NightOutPTMBonusStep', 1);
                            }
                            else if( $slotSettings->GetGameData('NightOutPTMBonusStep') == 1 ) 
                            {
                                $WinArr = $slotSettings->GetGameData('NightOutPTMBonusOpt');
                                $WinArr = [
                                    1, 
                                    2, 
                                    6, 
                                ...
                                shuffle($WinArr);
                                $curWin = $WinArr[0];
                                $slotSettings->SetGameData('NightOutPTMFreeMpl', $curWin);
                                $result_tmp[] = '3:::{"data":{"winList":[' . $curWin . ',' . $WinArr[1] . ',' . $WinArr[2] . ',' . $WinArr[3] . ',' . $WinArr[4] . ',' . $WinArr[5] . '],"windowId":"OHOJFb"},"ID":40201,"umid":1493}';
                                $slotSettings->SetGameData('NightOutPTMBonusStep', 2);
                            }
                            $umid = 0;
                        }
                        if( isset($postData['spinType']) ) 
                        {
                            ...
                            if( $postData['spinType'] == 'regular' ) 
                            {
                                ...
                                $bonusMpl = 1;
                                $slotSettings->SetGameData('NightOutPTMBonusWin', 0);
                                $slotSettings->SetGameData('NightOutPTMFreeGames', 0);
                                $slotSettings->SetGameData('NightOutPTMCurrentFreeGame', 0);
                                $slotSettings->SetGameData('NightOutPTMTotalWin', 0);
                                $slotSettings->SetGameData('NightOutPTMFreeBalance', 0);
                                $slotSettings->SetGameData('NightOutPTMFreeStartWin', 0);
                                $slotSettings->SetGameData('NightOutPTMFreeMpl', $slotSettings->slotFreeMpl);
                            }
                            else if( $postData['spinType'] == 'free' ) 
                            {
                                $umid = '0';
                                $postData['slotEvent'] = 'freespin';
                                $slotSettings->SetGameData('NightOutPTMCurrentFreeGame', $slotSettings->GetGameData('NightOutPTMCurrentFreeGame') + 1);
                                $bonusMpl = $slotSettings->GetGameData('NightOutPTMFreeMpl');
                            }
                            $linesId = [];
                            $linesId[0] = [
                                2, 
                                    ...
                                    for( $j = 0; $j < count($slotSettings->SymbolGame); $j++ ) 
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            if( $s[0] == $csym || in_array($s[0], $wild) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":1,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('NightOutPTMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":["none","none"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":2,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('NightOutPTMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":3,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('NightOutPTMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) && ($s[3] == $csym || in_array($s[3], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":4,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('NightOutPTMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) && ($s[3] == $csym || in_array($s[3], $wild)) && ($s[4] == $csym || in_array($s[4], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":5,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('NightOutPTMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":[' . ($linesId[$k][4] - 1) . ',"' . $s[4] . '"]}';
                                                }
                                            }
                                        }
                                    }
                            ...
                            if( $postData['slotEvent'] == 'freespin' ) 
                            {
                                $slotSettings->SetGameData('NightOutPTMBonusWin', $slotSettings->GetGameData('NightOutPTMBonusWin') + $totalWin);
                                $slotSettings->SetGameData('NightOutPTMTotalWin', $totalWin);
                            }
                            else
                            {
                                $slotSettings->SetGameData('NightOutPTMTotalWin', $totalWin);
                            ...
                            if( $scattersCount >= 2 ) 
                            {
                                $slotSettings->SetGameData('NightOutPTMBonusStep', 0);
                                $slotSettings->SetGameData('NightOutPTMFreeStartWin', $totalWin);
                                $slotSettings->SetGameData('NightOutPTMBonusWin', 0);
                                $slotSettings->SetGameData('NightOutPTMFreeGames', $slotSettings->slotFreeCount);
                            }
                            $balanceInCents = sprintf('%01.2f', $slotSettings->GetBalance()) * 100;
                            ...
                            $response = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{"linesArr":[' . implode(',', $postData['lines']) . '],"slotLines":' . $lines . ',"slotBet":' . $betLine . ',"totalFreeGames":' . $slotSettings->GetGameData('NightOutPTMFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('NightOutPTMCurrentFreeGame') . ',"Balance":' . $slotSettings->GetBalance() . ',"afterBalance":' . $slotSettings->GetBalance() . ',"bonusWin":' . $slotSettings->GetGameData('NightOutPTMBonusWin') . ',"FreeMpl":' . $slotSettings->GetGameData('NightOutPTMFreeMpl') . ',"freeStartWin":' . $slotSettings->GetGameData('NightOutPTMFreeStartWin') . ',"totalWin":' . $totalWin . ',"winLines":[' . $winString . '],"bonusInfo":' . $scattersStr . ',"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
