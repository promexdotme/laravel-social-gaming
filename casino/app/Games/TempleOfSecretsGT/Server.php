                ...
                \DB::transaction(function() use ($request, $game)
                {
                    try
                    {
                        ...
                        else if( $postData['slotEvent'] == 'gamble5GetUserCards' ) 
                        {
                            ...
                            $dealerCard = $slotSettings->GetGameData('TempleOfSecretsGTDealerCard');
                        ...
                        else if( $postData['slotEvent'] == 'gamble5GetDealerCard' ) 
                        {
                            ...
                            $slotSettings->SetGameData('TempleOfSecretsGTDealerCard', $tmpDc);
                        ...
                        else if( $postData['slotEvent'] == 'bet' || $postData['slotEvent'] == 'freespin' ) 
                        {
                            ...
                            if( $postData['slotEvent'] != 'freespin' ) 
                            {
                                ...
                                $jackState = $slotSettings->UpdateJackpots($postData['slotBet'] * $postData['slotLines'], $slotSettings->GetGameData('TempleOfSecretsGTFreeMpl') - 1, false);
                            ...
                            $response = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{"slotLines":' . $postData['slotLines'] . ',"slotBet":' . $postData['slotBet'] . ',"bonusWin":' . $slotSettings->GetGameData('TempleOfSecretsGTBonusWin') . ',"slotFreeMpl":' . $slotSettings->GetGameData('TempleOfSecretsGTFreeMpl') . ',"slotJackpot":[' . implode(',', $slotSettings->slotJackpot) . '],"totalFreeGames":' . $slotSettings->GetGameData('TempleOfSecretsGTFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('TempleOfSecretsGTCurrentFreeGame') . ',"Balance":' . $Balance . ',"afterBalance":' . $slotSettings->GetBalance() . ',"totalWin":' . $totalWin . ',"winLines":[' . $winString . '],"bonusInfo":' . $scattersStr . ',"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
