            ...
            \DB::transaction(function() use ($request, $game)
            {
                try
                {
                    ...
                    if( $postData['slotEvent'] == 'doInit' ) 
                    {
                        ...
                        $fsInfo = '';
                        $slotSettings->SetGameData('EgyptianFortunesBonusWin', 0);
                        $slotSettings->SetGameData('EgyptianFortunesFreeGames', 0);
                        $slotSettings->SetGameData('EgyptianFortunesCurrentFreeGame', 0);
                        $slotSettings->SetGameData('EgyptianFortunesTotalWin', 0);
                        $slotSettings->SetGameData($slotSettings->slotId . 'FreeBalance', $slotSettings->GetBalance());
                        $slotSettings->SetGameData('EgyptianFortunesBonusState', 0);
                        $slotSettings->SetGameData('EgyptianFortunesBonusMpl', 0);
                        if( $lastEvent != 'NULL' ) 
                        {
                    ...
                    else if( $postData['slotEvent'] == 'gamble5GetUserCards' ) 
                    {
                        ...
                        $dealerCard = $slotSettings->GetGameData('EgyptianFortunesDealerCard');
                        $totalWin = $slotSettings->GetGameData('EgyptianFortunesTotalWin');
                        $gambleWin = 0;
                        ...
                        $slotSettings->SetGameData('EgyptianFortunesTotalWin', $totalWin);
                    ...
                    else if( $postData['slotEvent'] == 'gamble5GetDealerCard' ) 
                    {
                        ...
                        $slotSettings->SetGameData('EgyptianFortunesDealerCard', $tmpDc);
                    ...
                    {
                        if( $slotSettings->GetGameData('EgyptianFortunesCurrentFreeGame') <= $slotSettings->GetGameData('EgyptianFortunesFreeGames') && $slotSettings->GetGameData('EgyptianFortunesFreeGames') > 0 ) 
                        {
                        ...
                        {
                            $slotSettings->SetGameData('EgyptianFortunesCurrentFreeGame', $slotSettings->GetGameData('EgyptianFortunesCurrentFreeGame') + 1);
                            $bonusMpl = $slotSettings->GetGameData('EgyptianFortunesBonusMpl');
                        }
                        $Balance = $slotSettings->GetBalance();
                        if( $postData['slotEvent'] != 'freespin' ) 
                        {
                        ...
                        if( $scattersCount >= 3 ) 
                        {
                            if( $slotSettings->GetGameData('EgyptianFortunesFreeGames') == 0 ) 
                            {
                                $slotSettings->SetGameData('EgyptianFortunesBonusMpl', 1);
                                $slotSettings->SetGameData('EgyptianFortunesFreeGames', $slotSettings->slotFreeCount);
                                $slotSettings->SetGameData('EgyptianFortunesCurrentFreeGame', 1);
                                $spinType = 's&fsmul=' . $slotSettings->GetGameData('EgyptianFortunesBonusMpl') . '&fsmax=' . $slotSettings->GetGameData('EgyptianFortunesFreeGames') . '&fswin=' . $totalWin . '&fs=1&fsres=' . $totalWin;
                            }
                            else
                            {
                                $slotSettings->SetGameData('EgyptianFortunesFreeGames', $slotSettings->GetGameData('EgyptianFortunesFreeGames') + $slotSettings->slotFreeCount);
                            }
                        }
                        if( $postData['slotEvent'] == 'freespin' ) 
                        {
                            $slotSettings->SetGameData('EgyptianFortunesBonusWin', $slotSettings->GetGameData('EgyptianFortunesBonusWin') + $totalWin);
                            $slotSettings->SetGameData('EgyptianFortunesTotalWin', $slotSettings->GetGameData('EgyptianFortunesTotalWin') + $totalWin);
                            $spinType = 's';
                            $Balance = $slotSettings->GetGameData('EgyptianFortunesFreeBalance');
                            if( $slotSettings->GetGameData('EgyptianFortunesFreeGames') + 1 <= $slotSettings->GetGameData('EgyptianFortunesCurrentFreeGame') && $slotSettings->GetGameData('EgyptianFortunesFreeGames') > 0 ) 
                            {
                                $spinType = 'c';
                                $winString .= ('&fs_total=' . $slotSettings->GetGameData('EgyptianFortunesFreeGames') . '&fsmul_total=' . $slotSettings->GetGameData('EgyptianFortunesBonusMpl') . '&fswin_total=' . $slotSettings->GetGameData('EgyptianFortunesBonusWin') . '&fsres_total=' . $slotSettings->GetGameData('EgyptianFortunesBonusWin') . '');
                            }
                            else
                            {
                                $winString .= ('&fsmul=' . $slotSettings->GetGameData('EgyptianFortunesBonusMpl') . '&fsmax=' . $slotSettings->GetGameData('EgyptianFortunesFreeGames') . '&fswin=' . $slotSettings->GetGameData('EgyptianFortunesTotalWin') . '&fs=' . $slotSettings->GetGameData('EgyptianFortunesCurrentFreeGame') . '&fsres=' . $slotSettings->GetGameData('EgyptianFortunesBonusWin'));
                            }
                        ...
                        else
                        {
                            ...
                            $slotSettings->SetGameData('EgyptianFortunesTotalWin', $totalWin);
                            $slotSettings->SetGameData('EgyptianFortunesBonusWin', $totalWin);
                        }
                        ...
                        $response = 'tw=' . $slotSettings->GetGameData('EgyptianFortunesBonusWin') . '&balance=' . $Balance . '&index=' . $postData['index'] . '&balance_cash=' . $Balance . '&balance_bonus=0.00' . $winString . '&na=' . $spinType . '&stime=' . floor(microtime(true) * 1000) . '&sa=' . $reels['reel1'][3] . ',' . $reels['reel2'][3] . ',' . $reels['reel3'][3] . ',' . $reels['reel4'][3] . ',' . $reels['reel5'][3] . '&sb=' . $reels['reel1'][-1] . ',' . $reels['reel2'][-1] . ',' . $reels['reel3'][-1] . ',' . $reels['reel4'][-1] . ',' . $reels['reel5'][-1] . '&sh=3&c=0.01&sver=5&n_reel_set=0&counter=' . ((int)$postData['counter'] + 1) . '&l=20&s=' . $s . '&w=' . $totalWinRaw . '';
                        if( $slotSettings->GetGameData('EgyptianFortunesFreeGames') + 1 <= $slotSettings->GetGameData('EgyptianFortunesCurrentFreeGame') && $slotSettings->GetGameData('EgyptianFortunesFreeGames') > 0 ) 
                        {
                            $slotSettings->SetGameData('EgyptianFortunesTotalWin', 0);
                            $slotSettings->SetGameData('EgyptianFortunesBonusWin', 0);
                        }
                        $response_log = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{"BonusMpl":' . $slotSettings->GetGameData('EgyptianFortunesBonusMpl') . ',"lines":' . $postData['slotLines'] . ',"bet":' . $postData['slotBet'] . ',"totalFreeGames":' . $slotSettings->GetGameData('EgyptianFortunesFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('EgyptianFortunesCurrentFreeGame') . ',"Balance":' . $Balance . ',"afterBalance":' . $slotSettings->GetBalance() . ',"totalWin":' . $totalWin . ',"bonusWin":' . $slotSettings->GetGameData('EgyptianFortunesBonusWin') . ',"winLines":[],"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
                        ...
                        if( $scattersCount >= 3 ) 
                        {
                            ...
                            {
                                $slotSettings->SetGameData('EgyptianFortunesFreeBalance', $Balance);
                                $slotSettings->SetGameData('EgyptianFortunesTotalWin', 0);
                                $slotSettings->SetGameData('EgyptianFortunesBonusState', 0);
                                $slotSettings->SetGameData('EgyptianFortunesBonusWin', $totalWin);
                            }
