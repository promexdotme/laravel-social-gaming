            ...
            function get_($request, $game)
            {
                \DB::transaction(function() use ($request, $game)
                {
                    try
                    {
                        ...
                        {
                            case 'create_session':
                                $slotSettings->SetGameData('FusionFruitBeatCTCards', [
                                    19, 
                                    44, 
                                    0, 
                                    37, 
                            ...
                            case 'init_game':
                                ...
                                $slotSettings->SetGameData('FusionFruitBeatCTBonusWin', 0);
                                $slotSettings->SetGameData('FusionFruitBeatCTFreeGames', 0);
                                $slotSettings->SetGameData('FusionFruitBeatCTCurrentFreeGame', 0);
                                $slotSettings->SetGameData('FusionFruitBeatCTCurrentFreeGame0', 0);
                                $slotSettings->SetGameData('FusionFruitBeatCTTotalWin', 0);
                                $slotSettings->SetGameData('FusionFruitBeatCTFreeBalance', 0);
                                ...
                                if( $lastEvent != 'NULL' ) 
                                {
                                    ...
                                    if( $slotSettings->GetGameData('FusionFruitBeatCTCurrentFreeGame') < $slotSettings->GetGameData('FusionFruitBeatCTFreeGames') && $slotSettings->GetGameData('FusionFruitBeatCTFreeGames') > 0 ) 
                                    {
                            ...
                            case 'poll':
                                ...
                                {
                                    $balanceInCents = sprintf('%01.2f', $slotSettings->GetBalance() - $slotSettings->GetGameData('FusionFruitBeatCTTotalWin')) * 100;
                                }
                            ...
                            case 'game_finished':
                                $slotSettings->SetGameData('FusionFruitBeatCTBonusWin', 0);
                                $slotSettings->SetGameData('FusionFruitBeatCTTotalWin', 0);
                                $responseData['game_finished'][0]['freeround_play'] = $slotSettings->GetGameData('FusionFruitBeatCTCurrentFreeGame0');
                            ...
                            case 'subgame_finished':
                                if( $slotSettings->GetGameData('FusionFruitBeatCTCurrentFreeGame0') < $slotSettings->GetGameData('FusionFruitBeatCTFreeGames') && $slotSettings->GetGameData('FusionFruitBeatCTFreeGames') > 0 ) 
                                {
                                    ...
                                    $response = '{"responseEvent":"spin","responseType":"freespin","serverResponse":{"result":' . json_encode($result) . ',"slotDenom":' . $slotSettings->GetGameData($slotSettings->slotId . 'Denom') . ',"slotLines":' . $lines . ',"slotBet":' . $betline . ',"totalFreeGames":' . $slotSettings->GetGameData('FusionFruitBeatCTFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('FusionFruitBeatCTCurrentFreeGame0') . ',"Balance":' . $slotSettings->GetGameData('FusionFruitBeatCTFreeBalance') . ',"afterBalance":' . $slotSettings->GetGameData('FusionFruitBeatCTFreeBalance') . ',"bonusWin":' . $slotSettings->GetGameData('FusionFruitBeatCTBonusWin') . ',"totalWin":' . $reportWin . ',"winLines":[],"Jackpots":[],"reelsSymbols":' . json_encode($slotSettings->GetGameData($slotSettings->slotId . 'Reels')) . '}}';
                                    if( $slotSettings->GetGameData('FusionFruitBeatCTFreeGames') <= $slotSettings->GetGameData('FusionFruitBeatCTCurrentFreeGame0') ) 
                                    {
                                        if( $reportWin > 0 ) 
                                        {
                                    ...
                                    $balanceInCents = $slotSettings->GetGameData('FusionFruitBeatCTFreeBalance');
                                    $responseData['subgame_finished'][0]['account_status']['credit'] = round($balanceInCents);
                                    $responseData['subgame_finished'][0]['freeround_play'] = $slotSettings->GetGameData('FusionFruitBeatCTCurrentFreeGame0');
                                    $responseData['subgame_finished'][1]['freeround_play'] = $slotSettings->GetGameData('FusionFruitBeatCTCurrentFreeGame0');
                            ...
                            case 'play':
                                ...
                                for( $spinLoop = 0; $spinLoop < $spinLoopLimit; $spinLoop++ ) 
                                {
                                    ...
                                    if( $postData['slotEvent'] != 'freespin' ) 
                                    {
                                        ...
                                        $slotSettings->SetGameData('FusionFruitBeatCTCurrentFreeGame0', 0);
                                        $slotSettings->SetGameData('FusionFruitBeatCTTotalWin', 0);
                                        $slotSettings->SetGameData('FusionFruitBeatCTFreeBalance', sprintf('%01.2f', $slotSettings->GetBalance()) * 100);
                                    ...
                                    {
                                        $slotSettings->SetGameData('FusionFruitBeatCTCurrentFreeGame', $slotSettings->GetGameData('FusionFruitBeatCTCurrentFreeGame') + 1);
                                    ...
                                    if( $postData['slotEvent'] == 'freespin' ) 
                                    {
                                        $slotSettings->SetGameData('FusionFruitBeatCTBonusWin', $slotSettings->GetGameData('FusionFruitBeatCTBonusWin') + $totalWin);
                                        $slotSettings->SetGameData('FusionFruitBeatCTTotalWin', $slotSettings->GetGameData('FusionFruitBeatCTTotalWin') + $totalWin);
                                        $balanceInCents = $slotSettings->GetGameData('FusionFruitBeatCTFreeBalance');
                                    }
                                    else
                                    {
                                        $slotSettings->SetGameData('FusionFruitBeatCTTotalWin', $totalWin);
                                    }
                                    $fs = 0;
                                    if( $scattersCount >= 3 ) 
                                    {
                                    ...
                                    $winstring = '';
                                    $slotSettings->SetGameData('FusionFruitBeatCTGambleStep', 5);
                                    $hist = $slotSettings->GetGameData('FusionFruitBeatCTCards');
                                    if( $postData['slotEvent'] == 'freespin' ) 
                                    {
                                        $state = 'freespin';
                                        ...
                                        if( $slotSettings->GetGameData($slotSettings->slotId . 'FreeGames') <= $slotSettings->GetGameData($slotSettings->slotId . 'CurrentFreeGame') && $slotSettings->GetGameData('FusionFruitBeatCTBonusWin') > 0 ) 
                                        {
                                            $responseData['play'][0]['result'][$spinLoop]['is_free'] = true;
                                    ...
                                    $responseData['play'][0]['result'][$spinLoop]['total_win'] = $slotSettings->GetGameData('FusionFruitBeatCTTotalWin') / $denom;
                                ...
                                $response = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{"result":' . json_encode($responseData['play'][0]['result']) . ',"slotDenom":' . $denom . ',"slotLines":' . $lines . ',"slotBet":' . $betline . ',"totalFreeGames":' . $slotSettings->GetGameData('FusionFruitBeatCTFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('FusionFruitBeatCTCurrentFreeGame0') . ',"Balance":' . $slotSettings->GetGameData($slotSettings->slotId . 'FreeBalance') . ',"afterBalance":' . $slotSettings->GetBalance() . ',"bonusWin":' . $slotSettings->GetGameData('FusionFruitBeatCTBonusWin') . ',"totalWin":' . $totalWin . ',"winLines":[],"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
                            ...
                            case 'gamble':
                                ...
                                $dealerCard = '';
                                $totalWin = $slotSettings->GetGameData('FusionFruitBeatCTTotalWin');
                                $gambleWin = 0;
                                $statBet = $totalWin;
                                ...
                                $hist = $slotSettings->GetGameData('FusionFruitBeatCTCards');
                                $slotSettings->SetGameData('FusionFruitBeatCTGambleStep', $slotSettings->GetGameData('FusionFruitBeatCTGambleStep') - 1);
                                if( $slotSettings->MaxWin < ($totalWin * $slotSettings->CurrentDenom) ) 
                                {
                                    $isGambleWin = 0;
                                }
                                ...
                                else
                                {
                                    ...
                                    $totalWin = 0;
                                    $slotSettings->SetGameData('FusionFruitBeatCTGambleStep', 0);
                                    if( $postData['continue_params']['double_key'] != 'red' && $postData['continue_params']['double_key'] != 'black' ) 
                                    {
                                        if( $postData['continue_params']['double_key'] == 'diamond' ) 
                                        {
                                ...
                                $slotSettings->SetGameData('FusionFruitBeatCTCards', $hist);
