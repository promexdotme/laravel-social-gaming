                    ...
                    try
                    {
                        ...
                        switch( $aid ) 
                        {
                            ...
                            case 'subscribe':
                                ...
                                shuffle($hist);
                                $slotSettings->SetGameData('VersaillesGoldEGTCards', $hist);
                                $lastEvent = $slotSettings->GetHistory();
                                $slotSettings->SetGameData('VersaillesGoldEGTBonusWin', 0);
                                $slotSettings->SetGameData('VersaillesGoldEGTFreeGames', 0);
                                $slotSettings->SetGameData('VersaillesGoldEGTCurrentFreeGame', 0);
                                $slotSettings->SetGameData('VersaillesGoldEGTTotalWin', 0);
                                $slotSettings->SetGameData('VersaillesGoldEGTFreeBalance', 0);
                                $slotSettings->SetGameData('VersaillesGoldEGTExpandSymbol', -1);
                                if( $lastEvent != 'NULL' ) 
                                {
                                    ...
                                    $gtype = 1;
                                    if( $slotSettings->GetGameData('VersaillesGoldEGTCurrentFreeGame') < $slotSettings->GetGameData('VersaillesGoldEGTFreeGames') && $slotSettings->GetGameData('VersaillesGoldEGTFreeGames') > 0 ) 
                                    {
                                        $gtype = 2;
                                    }
                                }
                            ...
                            case 'bet':
                                ...
                                if( $postData['slotEvent'] != 'freespin' ) 
                                {
                                    ...
                                    $slotSettings->SetGameData('VersaillesGoldEGTTotalWin', 0);
                                    $slotSettings->SetGameData('VersaillesGoldEGTExpandSymbol', -1);
                                    $slotSettings->SetGameData('VersaillesGoldEGTFreeBalance', sprintf('%01.2f', $slotSettings->GetBalance()) * 100);
                                    $slotSettings->SetGameData($slotSettings->slotId . 'FirstSpin', '');
                                    $bonusMpl = 1;
                                }
                                else
                                {
                                    $slotSettings->SetGameData('VersaillesGoldEGTCurrentFreeGame', $slotSettings->GetGameData('VersaillesGoldEGTCurrentFreeGame') + 1);
                                ...
                                for( $i = 0; $i <= 2000; $i++ ) 
                                {
                                    ...
                                    if( $postData['slotEvent'] == 'freespin' ) 
                                    {
                                        for( $r = 1; $r <= 5; $r++ ) 
                                        {
                                            for( $p = 0; $p <= 2; $p++ ) 
                                            {
                                                if( $reelsEx['reel' . $r][$p] == $slotSettings->GetGameData('VersaillesGoldEGTExpandSymbol') ) 
                                                {
                                                    $reelsEx['reel' . $r][0] = $slotSettings->GetGameData('VersaillesGoldEGTExpandSymbol');
                                                    $reelsEx['reel' . $r][1] = $slotSettings->GetGameData('VersaillesGoldEGTExpandSymbol');
                                                    $reelsEx['reel' . $r][2] = $slotSettings->GetGameData('VersaillesGoldEGTExpandSymbol');
                                                    break;
                                                }
                                            }
                                        }
                                    ...
                                    for( $k = 0; $k < $lines; $k++ ) 
                                    {
                                        ...
                                        for( $j = 0; $j < count($slotSettings->SymbolGame); $j++ ) 
                                        {
                                            ...
                                            else
                                            {
                                                ...
                                                if( $postData['slotEvent'] == 'freespin' && $csym == $slotSettings->GetGameData('VersaillesGoldEGTExpandSymbol') ) 
                                                {
                                                    $cLineExp = [];
                                                    $exCount = 0;
                                                    for( $ex = 0; $ex < 5; $ex++ ) 
                                ...
                                if( $postData['slotEvent'] == 'freespin' ) 
                                {
                                    $slotSettings->SetGameData('VersaillesGoldEGTBonusWin', $slotSettings->GetGameData('VersaillesGoldEGTBonusWin') + $totalWin);
                                    $slotSettings->SetGameData('VersaillesGoldEGTTotalWin', $slotSettings->GetGameData('VersaillesGoldEGTTotalWin') + $totalWin);
                                    $balanceInCents = $slotSettings->GetGameData('VersaillesGoldEGTFreeBalance');
                                }
                                else
                                {
                                    $slotSettings->SetGameData('VersaillesGoldEGTTotalWin', $totalWin);
                                }
                                $fs = 0;
                                $firstSpinLog = '';
                                $curReels = '' . rand(0, 6) . ',' . $reels['reel1'][0] . ',' . $reels['reel1'][1] . ',' . $reels['reel1'][2] . ',' . rand(0, 6);
                                ...
                                if( $scattersCount >= 3 ) 
                                {
                                    if( $slotSettings->GetGameData('VersaillesGoldEGTFreeGames') > 0 ) 
                                    {
                                        $slotSettings->SetGameData('VersaillesGoldEGTFreeGames', $slotSettings->GetGameData('VersaillesGoldEGTFreeGames') + $slotSettings->slotFreeCount);
                                    }
                                    else
                                    {
                                        $slotSettings->SetGameData('VersaillesGoldEGTExpandSymbol', rand(0, 8));
                                        $slotSettings->SetGameData('VersaillesGoldEGTFreeStartWin', $totalWin);
                                        $slotSettings->SetGameData('VersaillesGoldEGTBonusWin', $totalWin);
                                        $slotSettings->SetGameData('VersaillesGoldEGTFreeGames', $slotSettings->slotFreeCount);
                                        $slotSettings->SetGameData($slotSettings->slotId . 'FirstSpin', ',"firstSpin":{"expand":[],"reels":[' . $curReels . '],"lines":[],"expand":[],"scatters":[' . $scattersStr . ']}');
                                    }
                                    $fs = $slotSettings->GetGameData('VersaillesGoldEGTFreeGames');
                                }
                                $winString = implode(',', $lineWins);
                                $winStringExpand = implode(',', $lineWins2);
                                $jsSpin = '' . json_encode($reels) . '';
                                $jsJack = '' . json_encode($slotSettings->Jackpots) . '';
                                $response = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{"slotLines":' . $lines . '' . $slotSettings->GetGameData($slotSettings->slotId . 'FirstSpin') . ',"slotBet":' . $betline . ',"totalFreeGames":' . $slotSettings->GetGameData('VersaillesGoldEGTFreeGames') . ',"freeSpinsExpandLines": [' . $winStringExpand . '],"freeSpinsExpandSymbol":' . $slotSettings->GetGameData('VersaillesGoldEGTExpandSymbol') . ',"freeSpinsExpandWinAmount": ' . $expandWin . ',"currentFreeGames":' . $slotSettings->GetGameData('VersaillesGoldEGTCurrentFreeGame') . ',"Balance":' . $balanceInCents . ',"afterBalance":' . $balanceInCents . ',"bonusWin":' . $slotSettings->GetGameData('VersaillesGoldEGTBonusWin') . ',"totalWin":' . $totalWin . ',"winLines":[' . $winString . '],"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
                                $slotSettings->SaveLogReport($response, $allbet, $lines, $reportWin, $postData['slotEvent']);
                                $winstring = '';
                                $slotSettings->SetGameData('VersaillesGoldEGTGambleStep', 5);
                                $hist = $slotSettings->GetGameData('VersaillesGoldEGTCards');
                                if( $jackRandom == 1 ) 
                                {
                                    $state = 'jackpot';
                                    $isJack = 'true';
                                    $slotSettings->SetGameData('VersaillesGoldEGTJackSteps', [
                                        0, 
                                        0, 
                                        0, 
                                        0
                                ...
                                if( $postData['slotEvent'] == 'freespin' ) 
                                {
                                    $totalWin = $slotSettings->GetGameData('VersaillesGoldEGTBonusWin');
                                    $state = 'freespin';
                                ...
                                $result_tmp[] = '{"complex":{"gambles":5,"reels":[' . $curReels . '],"lines":[' . $winString . '],"scatters":[' . $scattersStr . '],"freespinScatters":[' . $scatter . '],"expand":[],"freespinScatters":[' . $scatter . '],"freespinScatters":[9],"freespins":' . $fs . ',"jackpot":' . $isJack . ',"freeSpinsExpandSymbol":' . $slotSettings->GetGameData('VersaillesGoldEGTExpandSymbol') . ',"freeSpinsExpandLines":[' . $winStringExpand . '],"freeSpinsExpandWinAmount":' . $expandWin . ',"gameCommand":"bet"},"state":"' . $state . '","winAmount":' . ($totalWin * 100) . ',"gameIdentificationNumber":' . $postData['gameIdentificationNumber'] . ',"gameNumber":1786348900601,"balance":' . $balanceInCents . ',"sessionKey":"894b17d797618b2d99d0c94df1d88e72","msg":"success","messageId":"' . $postData['messageId'] . '","qName":"app.services.messages.response.GameEventResponse","command":"bet","eventTimestamp":' . time() . '}';
                                ...
                                break;
                            case 'collect':
                                $result_tmp[] = '{"complex":{"gameCommand":"collect"},"state":"idle","winAmount":' . ($slotSettings->GetGameData('VersaillesGoldEGTTotalWin') * 100) . ',"gameIdentificationNumber":' . $postData['gameIdentificationNumber'] . ',"gameNumber":"","balance":' . $balanceInCents . ',"sessionKey":"41be9e65e0ff03a65e8c93576bf61130","msg":"success","messageId":"' . $postData['messageId'] . '","qName":"app.services.messages.response.GameEventResponse","command":"bet","eventTimestamp":' . time() . '}';
                                $slotSettings->SetGameData('VersaillesGoldEGTTotalWin', 0);
                                break;
                            case 'jackpot':
                                $jackStep = $slotSettings->GetGameData('VersaillesGoldEGTJackSteps');
                                $jackWinID = $slotSettings->GetGameData($slotSettings->slotId . 'JackWinID');
                                if( $jackStep[0] >= 3 || $jackStep[1] >= 3 || $jackStep[2] >= 3 || $jackStep[3] >= 3 || !$slotSettings->HasGameData('VersaillesGoldEGTJackSteps') ) 
                                {
                                    exit();
                                }
                                $winAmount = 0;
                                ...
                                $slotSettings->SetGameData('VersaillesGoldEGTJackSteps', $jackStep);
                                break;
                            case 'gamble':
                                $Balance = $slotSettings->GetBalance();
                                $isGambleWin = rand(1, $slotSettings->GetGambleSettings());
                                $dealerCard = '';
                                $totalWin = $slotSettings->GetGameData('VersaillesGoldEGTTotalWin');
                                $gambleWin = 0;
                                $statBet = $totalWin;
                                $slotSettings->SetGameData('VersaillesGoldEGTGambleStep', $slotSettings->GetGameData('VersaillesGoldEGTGambleStep') - 1);
                                ...
                                else
                                {
                                    ...
                                    $totalWin = 0;
                                    $slotSettings->SetGameData('VersaillesGoldEGTGambleStep', 0);
                                    if( $postData['bet']['color'] == '1' ) 
                                    {
                                        $tmpCards = [
                                            '1', 
