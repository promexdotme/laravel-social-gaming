            ...
            function get_($request, $game)
            {
                \DB::transaction(function() use ($request, $game)
                {
                    try
                    {
                        ...
                        {
                            case 'freespinchoice':
                                if( $slotSettings->GetGameData('CrazyBugsIIEGTBonusStart') != 2 && $slotSettings->GetGameData('CrazyBugsIIEGTBonusStart') != 1 ) 
                                {
                                    exit();
                                }
                                $fs = $slotSettings->GetGameData('CrazyBugsIIEGTFreeGames');
                                $fw = $slotSettings->GetGameData('CrazyBugsIIEGTFreeWild');
                                $choice = (int)$postData['bet']['choice'];
                                $opt = [];
                                $cfr = rand(5, 12);
                                $cfr0 = rand(5, 7);
                                $opt[0] = '{"pos":0,"multiplier":0,"freespins":' . $cfr . ',"wildcard":' . $cfr0 . ',"mult":0,"fs":' . $cfr . ',"play":true}';
                                $cfr = rand(5, 12);
                                $cfr0 = rand(5, 7);
                                $opt[1] = '{"pos":1,"multiplier":0,"freespins":' . $cfr . ',"wildcard":' . $cfr0 . ',"mult":0,"fs":' . $cfr . ',"play":true}';
                                $cfr = rand(5, 12);
                                $cfr0 = rand(5, 7);
                                $opt[2] = '{"pos":2,"multiplier":0,"freespins":' . $cfr . ',"wildcard":' . $cfr0 . ',"mult":0,"fs":' . $cfr . ',"play":true}';
                                $cfr = rand(5, 12);
                                $cfr0 = rand(5, 7);
                                $opt[3] = '{"pos":3,"multiplier":0,"freespins":' . $cfr . ',"wildcard":' . $cfr0 . ',"mult":0,"fs":' . $cfr . ',"play":true}';
                                $cfr = rand(5, 12);
                                $cfr0 = rand(5, 7);
                                $opt[4] = '{"pos":4,"multiplier":0,"freespins":' . $cfr . ',"wildcard":' . $cfr0 . ',"mult":0,"fs":' . $cfr . ',"play":true}';
                                $cfr = rand(5, 12);
                                $cfr0 = rand(5, 7);
                                $opt[5] = '{"pos":5,"multiplier":0,"freespins":' . $cfr . ',"wildcard":' . $cfr0 . ',"mult":0,"fs":' . $cfr . ',"play":true}';
                                $cfr = rand(5, 12);
                                $cfr0 = rand(5, 7);
                                $opt[6] = '{"pos":6,"multiplier":0,"freespins":' . $cfr . ',"wildcard":' . $cfr0 . ',"mult":0,"fs":' . $cfr . ',"play":true}';
                                $cfr = rand(5, 12);
                                $cfr0 = rand(5, 7);
                                $opt[7] = '{"pos":7,"multiplier":0,"freespins":' . $cfr . ',"wildcard":' . $cfr0 . ',"mult":0,"fs":' . $cfr . ',"play":true}';
                                unset($opt[$choice]);
                                $result_tmp[] = '{"complex":{"choice":{"pos":' . $choice . ',"multiplier":0,"freespins":' . $fs . ',"mult":0,"fs":' . $fs . ',"play":true,"closed":[' . implode(',', $opt) . ']},"freespins":' . $fs . ',"choices":1,"gameCommand":"freespinchoice"},"state":"multiplierchoice","winAmount":' . ($slotSettings->GetGameData($slotSettings->slotId . 'BonusWin') * 100) . ',"gameIdentificationNumber":' . $postData['gameIdentificationNumber'] . ',"gameNumber":1787203010852,"sessionKey":"5af6a26c031aa4ec491159428c5a7742","msg":"success","messageId":"' . $postData['messageId'] . '","qName":"app.services.messages.response.GameEventResponse","command":"bet","eventTimestamp":1566584969191}';
                                break;
                            case 'multiplierchoice':
                                ...
                                $mpl = $slotSettings->GetGameData('CrazyBugsIIEGTMultiplier');
                                $choice = (int)$postData['bet']['choice'];
                                $opt = [];
                                $cfr = rand(1, 4);
                                ...
                                $slotSettings->SetGameData('CrazyBugsIIEGTBonusStart', 0);
                                unset($opt[$choice]);
                                $result_tmp[] = '{"complex":{"choice":{"pos":' . $choice . ',"multiplier":' . $mpl . ',"freespins":0,"wildcard":-1,"mult":' . $mpl . ',"fs":0,"play":true,"closed":[' . implode(',', $opt) . ']},"multiplier":' . $mpl . ',"choices":1,"gameCommand":"multiplierchoice"},"state":"freespin","winAmount":' . ($slotSettings->GetGameData($slotSettings->slotId . 'BonusWin') * 100) . ',"gameIdentificationNumber":' . $postData['gameIdentificationNumber'] . ',"gameNumber":1787203010852,"sessionKey":"5af6a26c031aa4ec491159428c5a7742","msg":"success","messageId":"' . $postData['messageId'] . '","qName":"app.services.messages.response.GameEventResponse","command":"bet","eventTimestamp":1566584919562} ';
                                break;
                            case 'bonuschoice':
                                $mplArr = [
                                    2, 
                                ...
                                $bet = $slotSettings->GetGameData('CrazyBugsIIEGTBonusBet');
                                $bank = $slotSettings->GetBank('bonus');
                                for( $i = 0; $i <= 1000; $i++ ) 
                                {
                                    shuffle($mplArr);
                                    $curWin = $mplArr[0] * $bet;
                                    if( $i >= 1000 || $slotSettings->GetGameData('CrazyBugsIIEGTBonusStart') != 1 ) 
                                    {
                                        exit();
                                    }
                                    if( $curWin <= $bank ) 
                                ...
                                if( $slotSettings->GetGameData('CrazyBugsIIEGTBonusCnt') >= 4 ) 
                                {
                                    $cfr = rand(1, 10);
                                    $opt[3] = '{"coef":' . $cfr . ',"bonus":false,"totalWin":' . ($cfr * $bet * 100) . '}';
                                }
                                if( $slotSettings->GetGameData('CrazyBugsIIEGTBonusCnt') >= 5 ) 
                                {
                                    $cfr = rand(1, 10);
                                ...
                                $slotSettings->SetGameData('CrazyBugsIIEGTBonusStart', 2);
                                $curWin = $curWin + $slotSettings->GetGameData('CrazyBugsIIEGTTotalWin');
                                $slotSettings->SetGameData('CrazyBugsIIEGTTotalWin', $curWin);
                                $result_tmp[] = '{"complex":{"bonuschoiceObject":{"selectedIndex":' . $choice . ',"totalBet":' . ($bet * 100) . ',"options":[' . implode(',', $opt) . ']},"freespins":0,"multiplier":1,"choices":0,"gambles":5,"gameCommand":"bonuschoice"},"state":"freespinchoice","winAmount":' . ($curWin * 100) . ',"gameIdentificationNumber":' . $postData['gameIdentificationNumber'] . ',"gameNumber":1787135676614,"sessionKey":"6644c1af1441d207d3482a78f200b182","msg":"success","messageId":"' . $postData['messageId'] . '","qName":"app.services.messages.response.GameEventResponse","command":"bet","eventTimestamp":1566568567774}';
                                break;
                            case 'login':
                            ...
                            case 'subscribe':
                                ...
                                shuffle($hist);
                                $slotSettings->SetGameData('CrazyBugsIIEGTCards', $hist);
                                $lastEvent = $slotSettings->GetHistory();
                                $slotSettings->SetGameData('CrazyBugsIIEGTBonusWin', 0);
                                $slotSettings->SetGameData('CrazyBugsIIEGTFreeGames', 0);
                                $slotSettings->SetGameData('CrazyBugsIIEGTCurrentFreeGame', 0);
                                $slotSettings->SetGameData('CrazyBugsIIEGTTotalWin', 0);
                                $slotSettings->SetGameData('CrazyBugsIIEGTFreeBalance', 0);
                                $slotSettings->SetGameData('CrazyBugsIIEGTMultiplier', 1);
                                $slotSettings->SetGameData('CrazyBugsIIEGTFreeWild', -1);
                                if( $lastEvent != 'NULL' ) 
                                {
                                    ...
                                    $gtype = 1;
                                    if( $slotSettings->GetGameData('CrazyBugsIIEGTCurrentFreeGame') < $slotSettings->GetGameData('CrazyBugsIIEGTFreeGames') && $slotSettings->GetGameData('CrazyBugsIIEGTFreeGames') > 0 ) 
                                    {
                                        $gtype = 2;
                                    }
                                }
                            ...
                            case 'bet':
                                ...
                                if( $postData['slotEvent'] != 'freespin' ) 
                                {
                                    ...
                                    $slotSettings->SetGameData('CrazyBugsIIEGTBonusStart', 0);
                                    $slotSettings->SetGameData('CrazyBugsIIEGTBonusBet', $allbet);
                                    $slotSettings->SetGameData('CrazyBugsIIEGTBonusWin', 0);
                                    $slotSettings->SetGameData('CrazyBugsIIEGTFreeGames', 0);
                                    $slotSettings->SetGameData('CrazyBugsIIEGTCurrentFreeGame', 0);
                                    $slotSettings->SetGameData('CrazyBugsIIEGTTotalWin', 0);
                                    $slotSettings->SetGameData('CrazyBugsIIEGTFreeBalance', sprintf('%01.2f', $slotSettings->GetBalance()) * 100);
                                    $slotSettings->SetGameData('CrazyBugsIIEGTMultiplier', 1);
                                    $slotSettings->SetGameData('CrazyBugsIIEGTFreeWild', -1);
                                    $bonusMpl = 1;
                                }
                                ...
                                {
                                    $slotSettings->SetGameData('CrazyBugsIIEGTCurrentFreeGame', $slotSettings->GetGameData('CrazyBugsIIEGTCurrentFreeGame') + 1);
                                    $bonusMpl = $slotSettings->GetGameData('CrazyBugsIIEGTMultiplier');
                                }
                                ...
                                if( $postData['slotEvent'] == 'freespin' ) 
                                {
                                    $slotSettings->SetGameData('CrazyBugsIIEGTBonusWin', $slotSettings->GetGameData('CrazyBugsIIEGTBonusWin') + $totalWin);
                                    $slotSettings->SetGameData('CrazyBugsIIEGTTotalWin', $slotSettings->GetGameData('CrazyBugsIIEGTTotalWin') + $totalWin);
                                    $balanceInCents = $slotSettings->GetGameData('CrazyBugsIIEGTFreeBalance');
                                }
                                else
                                {
                                    $slotSettings->SetGameData('CrazyBugsIIEGTTotalWin', $totalWin);
                                }
                                $fs = 0;
                                if( $scattersCount >= 3 || $scattersCount2 >= 3 ) 
                                {
                                    if( $postData['slotEvent'] == 'freespin' ) 
                                    {
                                        $slotSettings->SetGameData('CrazyBugsIIEGTFreeGames', $slotSettings->GetGameData('CrazyBugsIIEGTFreeGames'));
                                    }
                                    else
                                    {
                                        $slotSettings->SetGameData('CrazyBugsIIEGTFreeStartWin', $totalWin);
                                        $slotSettings->SetGameData('CrazyBugsIIEGTBonusWin', $totalWin);
                                        $slotSettings->SetGameData('CrazyBugsIIEGTFreeGames', rand(8, 15));
                                        $slotSettings->SetGameData('CrazyBugsIIEGTMultiplier', rand(1, 4));
                                        $slotSettings->SetGameData('CrazyBugsIIEGTFreeWild', rand(5, 7));
                                    }
                                    $fs = $slotSettings->GetGameData('CrazyBugsIIEGTFreeGames');
                                }
                                $curReels = '' . rand(0, 6) . ',' . $reels['reel1'][0] . ',' . $reels['reel1'][1] . ',' . $reels['reel1'][2] . ',' . rand(0, 6);
                                ...
                                $response = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{"slotLines":' . $lines . '' . $slotSettings->GetGameData($slotSettings->slotId . 'FirstSpin') . ',"Multiplier":' . $slotSettings->GetGameData('CrazyBugsIIEGTMultiplier') . ',"FreeWild":' . $slotSettings->GetGameData('CrazyBugsIIEGTFreeWild') . ',"slotBet":' . $betline . ',"totalFreeGames":' . $slotSettings->GetGameData('CrazyBugsIIEGTFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('CrazyBugsIIEGTCurrentFreeGame') . ',"Balance":' . $balanceInCents . ',"afterBalance":' . $balanceInCents . ',"bonusWin":' . $slotSettings->GetGameData('CrazyBugsIIEGTBonusWin') . ',"totalWin":' . $totalWin . ',"winLines":[' . $winString . '],"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
                                $slotSettings->SaveLogReport($response, $allbet, $lines, $reportWin, $postData['slotEvent']);
                                $winstring = '';
                                $slotSettings->SetGameData('CrazyBugsIIEGTGambleStep', 5);
                                $hist = $slotSettings->GetGameData('CrazyBugsIIEGTCards');
                                if( $jackRandom == 1 ) 
                                {
                                    $state = 'jackpot';
                                    $isJack = 'true';
                                    $slotSettings->SetGameData('CrazyBugsIIEGTJackSteps', [
                                        0, 
                                        0, 
                                        0, 
                                        0
                                ...
                                if( $postData['slotEvent'] == 'freespin' ) 
                                {
                                    $totalWin = $slotSettings->GetGameData('CrazyBugsIIEGTBonusWin');
                                    $state = 'freespin';
                                    if( $slotSettings->GetGameData($slotSettings->slotId . 'FreeGames') <= $slotSettings->GetGameData($slotSettings->slotId . 'CurrentFreeGame') && $slotSettings->GetGameData('CrazyBugsIIEGTBonusWin') > 0 ) 
                                    {
                                        $state = 'gamble';
                                    }
                                }
                                ...
                                if( $scattersCount2 >= 3 ) 
                                {
                                    $state = 'bonuschoice';
                                    $slotSettings->SetGameData('CrazyBugsIIEGTTotalWin', $totalWin);
                                    $slotSettings->SetGameData('CrazyBugsIIEGTBonusStart', 1);
                                    $slotSettings->SetGameData('CrazyBugsIIEGTBonusCnt', $scattersCount2);
                                ...
                                $result_tmp[] = '{"complex":{"gambles":5,"reels":[' . $curReels . '],"lines":[' . $winString . '],"scatters":[' . $scattersStr . '],"freespinScatters":[' . $scatter . '],"choices": 0,"expand":[]' . $bstate . ',"multiplier":' . $slotSettings->GetGameData('CrazyBugsIIEGTMultiplier') . ',"wildcard":' . $slotSettings->GetGameData('CrazyBugsIIEGTFreeWild') . ',"specialExpand":[],"gambles":5,"freespins":' . $fs . ',"jackpot":' . $isJack . ',"gameCommand":"bet"},"state":"' . $state . '","winAmount":' . ($totalWin * 100) . ',"gameIdentificationNumber":' . $postData['gameIdentificationNumber'] . ',"gameNumber":"","balance":' . $balanceInCents . ',"sessionKey":"41be9e65e0ff03a65e8c93576bf61130","msg":"success","messageId":"' . $postData['messageId'] . '","qName":"app.services.messages.response.GameEventResponse","command":"bet","eventTimestamp":' . time() . '}';
                                ...
                                break;
                            case 'collect':
                                $result_tmp[] = '{"complex":{"gameCommand":"collect"},"state":"idle","winAmount":' . ($slotSettings->GetGameData('CrazyBugsIIEGTTotalWin') * 100) . ',"gameIdentificationNumber":' . $postData['gameIdentificationNumber'] . ',"gameNumber":"","balance":' . $balanceInCents . ',"sessionKey":"41be9e65e0ff03a65e8c93576bf61130","msg":"success","messageId":"' . $postData['messageId'] . '","qName":"app.services.messages.response.GameEventResponse","command":"bet","eventTimestamp":' . time() . '}';
                                $slotSettings->SetGameData('CrazyBugsIIEGTTotalWin', 0);
                                break;
                            case 'jackpot':
                                $jackStep = $slotSettings->GetGameData('CrazyBugsIIEGTJackSteps');
                                $jackWinID = $slotSettings->GetGameData($slotSettings->slotId . 'JackWinID');
                                if( $jackStep[0] >= 3 || $jackStep[1] >= 3 || $jackStep[2] >= 3 || $jackStep[3] >= 3 || !$slotSettings->HasGameData('CrazyBugsIIEGTJackSteps') ) 
                                {
                                    exit();
                                }
                                $winAmount = 0;
                                ...
                                $slotSettings->SetGameData('CrazyBugsIIEGTJackSteps', $jackStep);
                                break;
                            case 'gamble':
                                $Balance = $slotSettings->GetBalance();
                                $isGambleWin = rand(1, $slotSettings->GetGambleSettings());
                                $dealerCard = '';
                                $totalWin = $slotSettings->GetGameData('CrazyBugsIIEGTTotalWin');
                                $gambleWin = 0;
                                $statBet = $totalWin;
                                $slotSettings->SetGameData('CrazyBugsIIEGTGambleStep', $slotSettings->GetGameData('CrazyBugsIIEGTGambleStep') - 1);
                                ...
                                else
                                {
                                    ...
                                    $totalWin = 0;
                                    $slotSettings->SetGameData('CrazyBugsIIEGTGambleStep', 0);
                                    if( $postData['bet']['color'] == '1' ) 
                                    {
                                        $tmpCards = [
                                            '1', 
                                ...
                                $gtype = 1;
                                $gtype0 = 1;
                                if( $slotSettings->GetGameData('CrazyBugsIIEGTBonusStart') == 1 ) 
                                {
                                    $gtype0 = 2;
                                }
                                $result_tmp[] = '{"complex":{"gambles":' . $slotSettings->GetGameData('CrazyBugsIIEGTGambleStep') . ',"card":' . $dealerCard . ',"jackpot":false,"gameCommand":"gamble"},"state":"' . $gambleState . '","winAmount":' . ($totalWin * 100) . ',"gameIdentificationNumber":' . $postData['gameIdentificationNumber'] . ',"gameNumber":"","sessionKey":"88e2b82e6537db4a339e4e1b5ce462cd","msg":"success","messageId":"' . $postData['messageId'] . '","qName":"app.services.messages.response.GameEventResponse","command":"bet","eventTimestamp":' . time() . '}';
                                break;
                        }
