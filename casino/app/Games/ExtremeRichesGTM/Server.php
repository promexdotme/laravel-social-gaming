                ...
                \DB::transaction(function() use ($request, $game)
                {
                    try
                    {
                        ...
                        else if( $postData['slotEvent'] == 'gamble5GetUserCards' ) 
                        {
                            ...
                            $dealerCard = $slotSettings->GetGameData('ExtremeRichesGTMDealerCard');
                            $totalWin = $slotSettings->GetGameData('ExtremeRichesGTMTotalWin');
                            $gambleWin = 0;
                            ...
                            $slotSettings->SetGameData('ExtremeRichesGTMTotalWin', $totalWin);
                        ...
                        else if( $postData['slotEvent'] == 'gamble5GetDealerCard' ) 
                        {
                            ...
                            $slotSettings->SetGameData('ExtremeRichesGTMDealerCard', $tmpDc);
                        ...
                        else if( $postData['slotEvent'] == 'bet' || $postData['slotEvent'] == 'freespin' ) 
                        {
                            ...
                            if( $postData['slotEvent'] != 'freespin' ) 
                            {
                                ...
                                $bonusMpl = 1;
                                $slotSettings->SetGameData('ExtremeRichesGTMBonusWin', 0);
                                $slotSettings->SetGameData('ExtremeRichesGTMFreeGames', 0);
                                $slotSettings->SetGameData('ExtremeRichesGTMCurrentFreeGame', 0);
                                $slotSettings->SetGameData('ExtremeRichesGTMTotalWin', 0);
                                $slotSettings->SetGameData('ExtremeRichesGTMFreeBalance', 0);
                                $slotSettings->SetGameData('ExtremeRichesGTMFreeMpl', 1);
                            }
                            else
                            {
                                $jackState = $slotSettings->UpdateJackpots($postData['slotBet'] * $postData['slotLines'], 0, true);
                                $slotSettings->SetGameData('ExtremeRichesGTMCurrentFreeGame', $slotSettings->GetGameData('ExtremeRichesGTMCurrentFreeGame') + 1);
                                $bonusMpl = $slotSettings->GetGameData('ExtremeRichesGTMFreeMpl');
                            }
                            $Balance = $slotSettings->GetBalance();
                            for( $i = 0; $i <= 2000; $i++ ) 
                            {
                                    ...
                                    for( $j = 0; $j < count($slotSettings->SymbolGame); $j++ ) 
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            if( $s[0] == $csym || in_array($s[0], $wild) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":1,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('ExtremeRichesGTMBonusWin')) . ',"winReel1":[' . ($linesId[$k + 1][0] - 1) . ',"' . $s[0] . '"],"winReel2":["none","none"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":2,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('ExtremeRichesGTMBonusWin')) . ',"winReel1":[' . ($linesId[$k + 1][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k + 1][1] - 1) . ',"' . $s[1] . '"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            $s[0] = $reels['reel1'][$linesId[$k + 1][0] - 1];
                                            $s[1] = $reels['reel2'][$linesId[$k + 1][1] - 1];
                                            ...
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":3,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('ExtremeRichesGTMBonusWin')) . ',"winReel1":[' . ($linesId[$k + 1][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k + 1][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k + 1][2] - 1) . ',"' . $s[2] . '"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            $s[0] = $reels['reel1'][$linesId[$k + 1][0] - 1];
                                            $s[1] = $reels['reel2'][$linesId[$k + 1][1] - 1];
                                            ...
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) && ($s[3] == $csym || in_array($s[3], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":4,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('ExtremeRichesGTMBonusWin')) . ',"winReel1":[' . ($linesId[$k + 1][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k + 1][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k + 1][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k + 1][3] - 1) . ',"' . $s[3] . '"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            $s[0] = $reels['reel1'][$linesId[$k + 1][0] - 1];
                                            $s[1] = $reels['reel2'][$linesId[$k + 1][1] - 1];
                                            ...
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) && ($s[3] == $csym || in_array($s[3], $wild)) && ($s[4] == $csym || in_array($s[4], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":5,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('ExtremeRichesGTMBonusWin')) . ',"winReel1":[' . ($linesId[$k + 1][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k + 1][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k + 1][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k + 1][3] - 1) . ',"' . $s[3] . '"],"winReel5":[' . ($linesId[$k + 1][4] - 1) . ',"' . $s[4] . '"]}';
                                                }
                                            }
                                        }
                                    }
                            ...
                            if( $postData['slotEvent'] == 'freespin' && $slotSettings->GetGameData('ExtremeRichesGTMFreeGames') <= $slotSettings->GetGameData('ExtremeRichesGTMCurrentFreeGame') && $winType != 'bonus' && $slotSettings->GetGameData('ExtremeRichesGTMTotalWin') + $totalWin > 0 ) 
                            {
                                $slotSettings->SetBalance($slotSettings->GetGameData('ExtremeRichesGTMTotalWin') + $totalWin);
                            }
                            ...
                            if( $postData['slotEvent'] == 'freespin' ) 
                            {
                                $slotSettings->SetGameData('ExtremeRichesGTMBonusWin', $slotSettings->GetGameData('ExtremeRichesGTMBonusWin') + $totalWin);
                                $slotSettings->SetGameData('ExtremeRichesGTMTotalWin', $slotSettings->GetGameData('ExtremeRichesGTMTotalWin') + $totalWin);
                                $totalWin = $slotSettings->GetGameData('ExtremeRichesGTMBonusWin');
                                $Balance = $slotSettings->GetGameData('ExtremeRichesGTMFreeBalance');
                            }
                            else
                            {
                                $slotSettings->SetGameData('ExtremeRichesGTMTotalWin', $totalWin);
                            ...
                            if( $scattersCount >= 3 ) 
                            {
                                if( $slotSettings->GetGameData('ExtremeRichesGTMFreeGames') > 0 ) 
                                {
                                    $slotSettings->SetGameData('ExtremeRichesGTMFreeBalance', $Balance);
                                    $slotSettings->SetGameData('ExtremeRichesGTMBonusWin', $totalWin);
                                    $slotSettings->SetGameData('ExtremeRichesGTMFreeGames', $slotSettings->GetGameData('ExtremeRichesGTMFreeGames') + $slotSettings->slotFreeCount);
                                    $slotSettings->SetGameData('ExtremeRichesGTMFreeMpl', $slotSettings->GetGameData('ExtremeRichesGTMFreeMpl') + 1);
                                }
                                else
                                {
                                    $slotSettings->SetGameData('ExtremeRichesGTMFreeBalance', $Balance);
                                    $slotSettings->SetGameData('ExtremeRichesGTMBonusWin', $totalWin);
                                    $slotSettings->SetGameData('ExtremeRichesGTMFreeGames', $slotSettings->slotFreeCount);
                                    $slotSettings->SetGameData('ExtremeRichesGTMFreeMpl', 2);
                                }
                            }
                            $jsSpin = '' . json_encode($reels) . '';
                            $jsJack = '' . json_encode($slotSettings->Jackpots) . '';
                            $winString = implode(',', $lineWins);
                            $response = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{"slotLines":' . $postData['slotLines'] . ',"slotBet":' . $postData['slotBet'] . ',"slotFreeMpl":' . $slotSettings->GetGameData('ExtremeRichesGTMFreeMpl') . ',"slotJackpot":[' . implode(',', $slotSettings->slotJackpot) . '],"totalFreeGames":' . $slotSettings->GetGameData('ExtremeRichesGTMFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('ExtremeRichesGTMCurrentFreeGame') . ',"Balance":' . $Balance . ',"afterBalance":' . $slotSettings->GetBalance() . ',"totalWin":' . $totalWin . ',"winLines":[' . $winString . '],"bonusInfo":' . $scattersStr . ',"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
