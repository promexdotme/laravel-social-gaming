            ...
            \DB::transaction(function() use ($request, $game)
            {
                try
                {
                    ...
                    else if( $postData['slotEvent'] == 'gamble5GetUserCards' ) 
                    {
                        ...
                        $dealerCard = $slotSettings->GetGameData('BookOfRaDealerCard');
                        $totalWin = $slotSettings->GetGameData('BookOfRaTotalWin');
                        $gambleWin = 0;
                        ...
                        $slotSettings->SetGameData('BookOfRaTotalWin', $totalWin);
                    ...
                    else if( $postData['slotEvent'] == 'gamble5GetDealerCard' ) 
                    {
                        ...
                        $slotSettings->SetGameData('BookOfRaDealerCard', $tmpDc);
                    ...
                    else if( $postData['slotEvent'] == 'bet' || $postData['slotEvent'] == 'freespin' ) 
                    {
                        ...
                        if( $postData['slotEvent'] != 'freespin' ) 
                        {
                            ...
                            $bonusMpl = 1;
                            $slotSettings->SetGameData('BookOfRaExpSymbol', 'NONE');
                            $slotSettings->SetGameData('BookOfRaBonusWin', 0);
                            $slotSettings->SetGameData('BookOfRaFreeGames', 0);
                            $slotSettings->SetGameData('BookOfRaCurrentFreeGame', 0);
                            $slotSettings->SetGameData('BookOfRaTotalWin', 0);
                            $slotSettings->SetGameData('BookOfRaFreeBalance', 0);
                        }
                        else
                        {
                            $slotSettings->SetGameData('BookOfRaCurrentFreeGame', $slotSettings->GetGameData('BookOfRaCurrentFreeGame') + 1);
                        ...
                        for( $i = 0; $i <= 2000; $i++ ) 
                        {
                                ...
                                for( $j = 0; $j < count($slotSettings->SymbolGame); $j++ ) 
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        if( ($s[0] == $csym || $s[0] == $wild) && ($s[1] == $csym || $s[1] == $wild) ) 
                                        {
                                            ...
                                            {
                                                $cWins[$k] = $tmpWin;
                                                $tmpStringWin = '{"Count":2,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('BookOfRaBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                            }
                                        }
                                        if( ($s[0] == $csym || $s[0] == $wild) && ($s[1] == $csym || $s[1] == $wild) && ($s[2] == $csym || $s[2] == $wild) ) 
                                        {
                                            ...
                                            {
                                                $cWins[$k] = $tmpWin;
                                                $tmpStringWin = '{"Count":3,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('BookOfRaBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                            }
                                        }
                                        if( ($s[0] == $csym || $s[0] == $wild) && ($s[1] == $csym || $s[1] == $wild) && ($s[2] == $csym || $s[2] == $wild) && ($s[3] == $csym || $s[3] == $wild) ) 
                                        {
                                            ...
                                            {
                                                $cWins[$k] = $tmpWin;
                                                $tmpStringWin = '{"Count":4,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('BookOfRaBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":["none","none"]}';
                                            }
                                        }
                                        if( ($s[0] == $csym || $s[0] == $wild) && ($s[1] == $csym || $s[1] == $wild) && ($s[2] == $csym || $s[2] == $wild) && ($s[3] == $csym || $s[3] == $wild) && ($s[4] == $csym || $s[4] == $wild) ) 
                                        {
                                            ...
                                            {
                                                $cWins[$k] = $tmpWin;
                                                $tmpStringWin = '{"Count":5,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('BookOfRaBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":[' . ($linesId[$k][4] - 1) . ',"' . $s[4] . '"]}';
                                            }
                                        }
                                    }
                                }
                            ...
                            if( $postData['slotEvent'] == 'freespin' ) 
                            {
                                for( $e = 1; $e <= 5; $e++ ) 
                                {
                                    if( $reels['reel' . $e][0] == $slotSettings->GetGameData('BookOfRaExpSymbol') || $reels['reel' . $e][1] == $slotSettings->GetGameData('BookOfRaExpSymbol') || $reels['reel' . $e][2] == $slotSettings->GetGameData('BookOfRaExpSymbol') ) 
                                    {
                                        $expReels[$e] = true;
                                        $expPayCnt++;
                                    }
                                ...
                                {
                                    $expPay += ($slotSettings->Paytable[$slotSettings->GetGameData('BookOfRaExpSymbol')][$expPayCnt] * $postData['slotBet']);
                                    $tmpStringWin = '{"Count":' . $expPayCnt . ',"Line":' . $ll . ',"Win":' . $expPay . ',"stepWin":' . ($expPay + $totalWin + $slotSettings->GetGameData('BookOfRaBonusWin'));
                                    for( $e = 1; $e <= 5; $e++ ) 
                                    {
                                        if( $expReels[$e] ) 
                                        {
                                            $tmpStringWin .= (',"winReel' . $e . '":[' . ($linesId[$ll][$e - 1] - 1) . ',"' . $slotSettings->GetGameData('BookOfRaExpSymbol') . '"]');
                                        }
                                        else
                                        {
                        ...
                        if( $postData['slotEvent'] == 'freespin' && $slotSettings->GetGameData('BookOfRaFreeGames') <= $slotSettings->GetGameData('BookOfRaCurrentFreeGame') && $winType != 'bonus' && $slotSettings->GetGameData('BookOfRaTotalWin') + $totalWin > 0 ) 
                        {
                            $slotSettings->SetBalance($slotSettings->GetGameData('BookOfRaTotalWin') + $totalWin);
                        }
                        ...
                        if( $postData['slotEvent'] == 'freespin' ) 
                        {
                            $slotSettings->SetGameData('BookOfRaBonusWin', $slotSettings->GetGameData('BookOfRaBonusWin') + $totalWin);
                            $slotSettings->SetGameData('BookOfRaTotalWin', $slotSettings->GetGameData('BookOfRaTotalWin') + $totalWin);
                            $totalWin = $slotSettings->GetGameData('BookOfRaBonusWin');
                            $Balance = $slotSettings->GetGameData('BookOfRaFreeBalance');
                        }
                        else
                        {
                            $slotSettings->SetGameData('BookOfRaTotalWin', $totalWin);
                        ...
                        if( $scattersCount >= 3 ) 
                        {
                            ...
                            if( $slotSettings->GetGameData('BookOfRaFreeGames') > 0 ) 
                            {
                                $slotSettings->SetGameData('BookOfRaFreeBalance', $Balance);
                                $slotSettings->SetGameData('BookOfRaBonusWin', $totalWin);
                                $slotSettings->SetGameData('BookOfRaFreeGames', $slotSettings->GetGameData('BookOfRaFreeGames') + $slotSettings->slotFreeCount);
                            }
                            else
                            {
                                $slotSettings->SetGameData('BookOfRaExpSymbol', $slotSettings->SymbolGameExp[0]);
                                $slotSettings->SetGameData('BookOfRaFreeBalance', $Balance);
                                $slotSettings->SetGameData('BookOfRaBonusWin', $totalWin);
                                $slotSettings->SetGameData('BookOfRaFreeGames', $slotSettings->slotFreeCount);
                            }
                        }
                        ...
                        if( $slotSettings->GetGameData('BookOfRaExpSymbol') != 'NONE' ) 
                        {
                            $expSymbol = '"expSymbol":"' . $slotSettings->GetGameData('BookOfRaExpSymbol') . '",';
                        }
                        else
                        {
                            $expSymbol = '';
                        }
                        $response = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{"slotLines":' . $postData['slotLines'] . ',"slotBet":' . $postData['slotBet'] . ',' . $expLinesStr . ',"expPay":' . $expPay . ',' . $expReelsStr . ',' . $expSymbol . '"totalFreeGames":' . $slotSettings->GetGameData('BookOfRaFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('BookOfRaCurrentFreeGame') . ',"Balance":' . $Balance . ',"afterBalance":' . $slotSettings->GetBalance() . ',"totalWin":' . $totalWin . ',"winLines":[' . $winString . '],"bonusInfo":' . $scattersStr . ',"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
