                    ...
                    try
                    {
                        ...
                        switch( $aid ) 
                        {
                            ...
                            case 'settings':
                                ...
                                $result_tmp[] = '{"complex":{"balance":' . $balanceInCents . ',"balanceRaw":' . round($balanceInCents * $slotSettings->CurrentDenom) . ',"paytableCoef":{"0":{"coef":[10,20,100],"multiplier":1},"1":{"coef":[10,20,100],"multiplier":1},"2":{"coef":[10,30,150],"multiplier":1},"3":{"coef":[10,30,150],"multiplier":1},"4":{"coef":[20,50,200],"multiplier":1},"5":{"coef":[20,50,200],"multiplier":1},"6":{"coef":[50,200,500],"multiplier":1},"7":{"coef":[100,500,1000],"multiplier":1}},"bets":[' . implode(',', $gameBets) . '],"jackpotMinBet":1,"jackpot":true,"mainFakeReels":[[7,7,7,4,4,4,1,1,1,5,5,5,3,3,3,2,2,2,6,6,6,0,0,0,2,2,2,4,4,4],[7,7,7,3,3,3,8,5,5,5,0,0,0,2,2,2,6,6,6,8,0,0,0,1,1,1,8,4,4,4],[7,7,7,1,1,1,6,6,6,3,3,3,8,2,2,2,7,7,7,5,5,5,8,4,4,4,0,0,0,8],[7,7,7,0,0,0,1,1,1,8,5,5,5,1,1,1,8,6,6,6,3,3,3,8,2,2,2,4,4,4],[7,7,7,2,2,2,5,5,5,6,6,6,5,5,5,0,0,0,1,1,1,4,4,4,3,3,3,6,6,6]],"jackpotMaxBet":100000,"denominations":[' . implode(',', $denoms) . ']},"gameIdentificationNumber":' . $postData['gameIdentificationNumber'] . ',"gameNumber":-1,"sessionKey":"41be9e65e0ff03a65e8c93576bf61130","msg":"success","messageId":"' . $postData['messageId'] . '","qName":"app.services.messages.response.GameResponse","command":"settings","eventTimestamp":' . time() . '}';
                                break;
                            case 'subscribe':
                                $hist = [
                                    78, 
                                ...
                                shuffle($hist);
                                $slotSettings->SetGameData('ExtraStarsEGTCards', $hist);
                                $lastEvent = $slotSettings->GetHistory();
                                $slotSettings->SetGameData('ExtraStarsEGTBonusWin', 0);
                                $slotSettings->SetGameData('ExtraStarsEGTFreeGames', 0);
                                $slotSettings->SetGameData('ExtraStarsEGTCurrentFreeGame', 0);
                                $slotSettings->SetGameData('ExtraStarsEGTTotalWin', 0);
                                $slotSettings->SetGameData('ExtraStarsEGTFreeBalance', 0);
                                if( $lastEvent != 'NULL' ) 
                                {
                                    ...
                                    $gtype = 1;
                                    if( $slotSettings->GetGameData('ExtraStarsEGTCurrentFreeGame') < $slotSettings->GetGameData('ExtraStarsEGTFreeGames') && $slotSettings->GetGameData('ExtraStarsEGTFreeGames') > 0 ) 
                                    {
                                        $gtype = 2;
                                    }
                                }
                            ...
                            case 'bet':
                                ...
                                if( $postData['slotEvent'] != 'freespin' ) 
                                {
                                    ...
                                    $slotSettings->SetGameData('ExtraStarsEGTFreeGames', 0);
                                    $slotSettings->SetGameData('ExtraStarsEGTCurrentFreeGame', 0);
                                    $slotSettings->SetGameData('ExtraStarsEGTRespinRow', '');
                                    $slotSettings->SetGameData('ExtraStarsEGTTotalWin', 0);
                                    $slotSettings->SetGameData('ExtraStarsEGTFreeBalance', sprintf('%01.2f', $slotSettings->GetBalance()) * 100);
                                    $bonusMpl = 1;
                                }
                                else
                                {
                                    $slotSettings->SetGameData('ExtraStarsEGTCurrentFreeGame', $slotSettings->GetGameData('ExtraStarsEGTCurrentFreeGame') + 1);
                                ...
                                for( $i = 0; $i <= 2000; $i++ ) 
                                {
                                    ...
                                    $holdReels = $slotSettings->GetGameData('ExtraStarsEGTRespinRow');
                                    if( $postData['slotEvent'] == 'freespin' ) 
                                    {
                                        $r_ = (int)$holdReels + 1;
                                        $reels['reel' . $r_][0] = '8';
                                    ...
                                    for( $k = 0; $k < $lines; $k++ ) 
                                    {
                                        ...
                                        for( $j = 0; $j < count($slotSettings->SymbolGame); $j++ ) 
                                        {
                                            ...
                                            else
                                            {
                                                ...
                                                {
                                                    $mpl = 1;
                                                    if( in_array($s[4], $wild) && in_array($s[3], $wild) && in_array($s[3], $wild) ) 
                                                    {
                                                        $mpl = 1;
                                                    }
                                                    ...
                                                    {
                                                        $cWins[$k] = $tmpWin;
                                                        $tmpStringWin = '{"line":' . $k . ',"winAmount":' . ($cWins[$k] * 100) . ',"cells":[4,' . ($linesId[$k][4] - 1) . ',3,' . ($linesId[$k][3] - 1) . ',2,' . ($linesId[$k][2] - 1) . '],"freespins":0,"card":' . $csym . '}';
                                                    }
                                                }
                                                ...
                                                if( ($s[4] == $csym || in_array($s[4], $wild)) && ($s[3] == $csym || in_array($s[3], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) ) 
                                                {
                                                    ...
                                                    {
                                                        $cWins[$k] = $tmpWin;
                                                        $tmpStringWin = '{"line":' . $k . ',"winAmount":' . ($cWins[$k] * 100) . ',"cells":[4,' . ($linesId[$k][4] - 1) . ',3,' . ($linesId[$k][3] - 1) . ',2,' . ($linesId[$k][2] - 1) . ',3,' . ($linesId[$k][1] - 1) . '],"freespins":0,"card":' . $csym . '}';
                                                    }
                                                }
                                    ...
                                    for( $r = 1; $r <= 5; $r++ ) 
                                    {
                                        for( $p = 0; $p <= 2; $p++ ) 
                                        {
                                            if( $reels['reel' . $r][$p] == $scatter && $postData['slotEvent'] != 'freespin' ) 
                                            {
                                                $scattersCount++;
                                                $expand = '' . ($r - 1) . ',0,' . ($r - 1) . ',1,' . ($r - 1) . ',2';
                                                $holdReels = $r - 1;
                                                break;
                                            }
                                        }
                                ...
                                if( $postData['slotEvent'] == 'freespin' ) 
                                {
                                    $slotSettings->SetGameData('ExtraStarsEGTBonusWin', $slotSettings->GetGameData('ExtraStarsEGTBonusWin') + $totalWin);
                                    $slotSettings->SetGameData('ExtraStarsEGTTotalWin', $slotSettings->GetGameData('ExtraStarsEGTTotalWin') + $totalWin);
                                    $balanceInCents = $slotSettings->GetGameData('ExtraStarsEGTFreeBalance');
                                }
                                else
                                {
                                    $slotSettings->SetGameData('ExtraStarsEGTTotalWin', $totalWin);
                                }
                                $fs = 0;
                                if( $scattersCount >= 1 ) 
                                {
                                    if( $slotSettings->GetGameData('ExtraStarsEGTFreeGames') > 0 ) 
                                    {
                                        $slotSettings->SetGameData('ExtraStarsEGTFreeGames', $slotSettings->GetGameData('ExtraStarsEGTFreeGames') + $slotSettings->slotFreeCount);
                                    }
                                    else
                                    {
                                        $slotSettings->SetGameData('ExtraStarsEGTFreeStartWin', $totalWin);
                                        $slotSettings->SetGameData('ExtraStarsEGTBonusWin', $totalWin);
                                        $slotSettings->SetGameData('ExtraStarsEGTFreeGames', $slotSettings->slotFreeCount);
                                    }
                                    $fs = $slotSettings->GetGameData('ExtraStarsEGTFreeGames');
                                }
                                $winString = implode(',', $lineWins);
                                $jsSpin = '' . json_encode($reels) . '';
                                $jsJack = '' . json_encode($slotSettings->Jackpots) . '';
                                $response = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{"slotLines":' . $lines . ',"slotBet":' . $betline . ',"totalFreeGames":' . $slotSettings->GetGameData('ExtraStarsEGTFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('ExtraStarsEGTCurrentFreeGame') . ',"Balance":' . $balanceInCents . ',"afterBalance":' . $balanceInCents . ',"bonusWin":' . $slotSettings->GetGameData('ExtraStarsEGTBonusWin') . ',"totalWin":' . $totalWin . ',"winLines":[' . $winString . '],"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
                                $slotSettings->SaveLogReport($response, $allbet, $lines, $reportWin, $postData['slotEvent']);
                                $winstring = '';
                                $slotSettings->SetGameData('ExtraStarsEGTGambleStep', 5);
                                $hist = $slotSettings->GetGameData('ExtraStarsEGTCards');
                                $curReels = '' . rand(0, 6) . ',' . $reels['reel1'][0] . ',' . $reels['reel1'][1] . ',' . $reels['reel1'][2] . ',' . rand(0, 6);
                                $curReels .= (',' . rand(0, 6) . ',' . $reels['reel2'][0] . ',' . $reels['reel2'][1] . ',' . $reels['reel2'][2] . ',' . rand(0, 6));
                                $curReels .= (',' . rand(0, 6) . ',' . $reels['reel3'][0] . ',' . $reels['reel3'][1] . ',' . $reels['reel3'][2] . ',' . rand(0, 6));
                                $curReels .= (',' . rand(0, 6) . ',' . $reels['reel4'][0] . ',' . $reels['reel4'][1] . ',' . $reels['reel4'][2] . ',' . rand(0, 6));
                                ...
                                if( $jackRandom == 1 ) 
                                {
                                    $state = 'jackpot';
                                    $isJack = 'true';
                                    $slotSettings->SetGameData('ExtraStarsEGTJackSteps', [
                                        0, 
                                        0, 
                                        0, 
                                        0
                                ...
                                if( $postData['slotEvent'] == 'freespin' ) 
                                {
                                    $totalWin = $slotSettings->GetGameData('ExtraStarsEGTBonusWin');
                                    $state = 'freespin';
                                    $slotSettings->SetGameData($slotSettings->slotId . 'RespinRow', '');
                                ...
                                if( $scattersCount >= 1 ) 
                                {
                                    $slotSettings->SetGameData($slotSettings->slotId . 'RespinRow', $holdReels);
                                    $state = 'freespin';
                                }
                                if( !isset($sgwin) ) 
                                {
                                ...
                                $result_tmp[] = '{"complex":{"gambles":5,"reels":[' . $curReels . '],"lines":[' . $winString . '],"scatters":[' . $scattersStr . '],"freespinScatters":[' . $scatter . '],"expand":[' . $expand . '],"holdReels":[' . $slotSettings->GetGameData('ExtraStarsEGTRespinRow') . '],"specialExpand":[],"gambles":5,"freespins":' . $fs . ',"jackpot":' . $isJack . ',"gameCommand":"bet"},"state":"' . $state . '","winAmount":' . ($totalWin * 100) . ',"gameIdentificationNumber":' . $postData['gameIdentificationNumber'] . ',"gameNumber":"","balance":' . $balanceInCents . ',"sessionKey":"41be9e65e0ff03a65e8c93576bf61130","msg":"success","messageId":"' . $postData['messageId'] . '","qName":"app.services.messages.response.GameEventResponse","command":"bet","eventTimestamp":' . time() . '}';
                                ...
                                break;
                            case 'collect':
                                $result_tmp[] = '{"complex":{"gameCommand":"collect"},"state":"idle","winAmount":' . ($slotSettings->GetGameData('ExtraStarsEGTTotalWin') * 100) . ',"gameIdentificationNumber":' . $postData['gameIdentificationNumber'] . ',"gameNumber":"","balance":' . $balanceInCents . ',"sessionKey":"41be9e65e0ff03a65e8c93576bf61130","msg":"success","messageId":"' . $postData['messageId'] . '","qName":"app.services.messages.response.GameEventResponse","command":"bet","eventTimestamp":' . time() . '}';
                                $slotSettings->SetGameData('ExtraStarsEGTTotalWin', 0);
                                break;
                            case 'jackpot':
                                $jackStep = $slotSettings->GetGameData('ExtraStarsEGTJackSteps');
                                $jackWinID = $slotSettings->GetGameData($slotSettings->slotId . 'JackWinID');
                                if( $jackStep[0] >= 3 || $jackStep[1] >= 3 || $jackStep[2] >= 3 || $jackStep[3] >= 3 || !$slotSettings->HasGameData('ExtraStarsEGTJackSteps') ) 
                                {
                                    exit();
                                }
                                $winAmount = 0;
                                ...
                                $slotSettings->SetGameData('ExtraStarsEGTJackSteps', $jackStep);
                                break;
                            case 'gamble':
                                $Balance = $slotSettings->GetBalance();
                                $isGambleWin = rand(1, $slotSettings->GetGambleSettings());
                                $dealerCard = '';
                                $totalWin = $slotSettings->GetGameData('ExtraStarsEGTTotalWin');
                                $gambleWin = 0;
                                $statBet = $totalWin;
                                $slotSettings->SetGameData('ExtraStarsEGTGambleStep', $slotSettings->GetGameData('ExtraStarsEGTGambleStep') - 1);
                                ...
                                else
                                {
                                    ...
                                    $totalWin = 0;
                                    $slotSettings->SetGameData('ExtraStarsEGTGambleStep', 0);
                                    if( $postData['bet']['color'] == '1' ) 
                                    {
                                        $tmpCards = [
                                            '1', 
                                ...
                                $gtype = 1;
                                $gtype0 = 1;
                                if( $slotSettings->GetGameData('ExtraStarsEGTBonusStart') == 1 ) 
                                {
                                    $gtype0 = 2;
                                }
                                $result_tmp[] = '{"complex":{"gambles":' . $slotSettings->GetGameData('ExtraStarsEGTGambleStep') . ',"card":' . $dealerCard . ',"jackpot":false,"gameCommand":"gamble"},"state":"' . $gambleState . '","winAmount":' . ($totalWin * 100) . ',"gameIdentificationNumber":' . $postData['gameIdentificationNumber'] . ',"gameNumber":"","sessionKey":"88e2b82e6537db4a339e4e1b5ce462cd","msg":"success","messageId":"' . $postData['messageId'] . '","qName":"app.services.messages.response.GameEventResponse","command":"bet","eventTimestamp":' . time() . '}';
                                break;
                        }
