                    ...
                    try
                    {
                        ...
                        if( $postData['slotEvent'] == 'getSettings' ) 
                        {
                            ...
                            if( $lastEvent != 'NULL' ) 
                            {
                                ...
                                $RingsOfFortuneGTStacked = $lastEvent->serverResponse->stackedWilds;
                                for( $i = 0; $i < 5; $i++ ) 
                                {
                                    $slotSettings->SetGameData('RingsOfFortuneGTStacked.' . $i, $RingsOfFortuneGTStacked[$i]);
                                }
                                for( $r = 1; $r <= 5; $r++ ) 
                                {
                                    if( $slotSettings->GetGameData('RingsOfFortuneGTStacked.' . ($r - 1)) > 0 ) 
                                    {
                                        $slotSettings->SetGameData('RingsOfFortuneGTStacked.' . ($r - 1), -1);
                                    }
                                    if( $slotSettings->GetGameData('RingsOfFortuneGTStacked.' . ($r - 1)) == 0 ) 
                                    {
                                        $slotSettings->SetGameData('RingsOfFortuneGTStacked.' . ($r - 1), 1);
                        ...
                        else if( $postData['slotEvent'] == 'gamble5GetUserCards' ) 
                        {
                            ...
                            $dealerCard = $slotSettings->GetGameData('RingsOfFortuneGTDealerCard');
                            $totalWin = $slotSettings->GetGameData('RingsOfFortuneGTTotalWin');
                            $gambleWin = 0;
                            ...
                            $slotSettings->SetGameData('RingsOfFortuneGTTotalWin', $totalWin);
                        ...
                        else if( $postData['slotEvent'] == 'gamble5GetDealerCard' ) 
                        {
                            ...
                            $slotSettings->SetGameData('RingsOfFortuneGTDealerCard', $tmpDc);
                        ...
                        else if( $postData['slotEvent'] == 'bet' || $postData['slotEvent'] == 'freespin' ) 
                        {
                            ...
                            if( $postData['slotEvent'] != 'freespin' ) 
                            {
                                ...
                                $bonusMpl = 1;
                                $slotSettings->SetGameData('RingsOfFortuneGTBonusWin', 0);
                                $slotSettings->SetGameData('RingsOfFortuneGTFreeGames', 0);
                                $slotSettings->SetGameData('RingsOfFortuneGTCurrentFreeGame', 0);
                                $slotSettings->SetGameData('RingsOfFortuneGTTotalWin', 0);
                                $slotSettings->SetGameData('RingsOfFortuneGTFreeBalance', 0);
                                $slotSettings->SetGameData('RingsOfFortuneGTIsJack', 0);
                                for( $i = 0; $i < 5; $i++ ) 
                                {
                                    $slotSettings->SetGameData('RingsOfFortuneGTStacked.' . $i, -1);
                                }
                            }
                            else
                            {
                                $slotSettings->SetGameData('RingsOfFortuneGTCurrentFreeGame', $slotSettings->GetGameData('RingsOfFortuneGTCurrentFreeGame') + 1);
                                $bonusMpl = $slotSettings->slotFreeMpl;
                                if( $slotSettings->GetGameData('RingsOfFortuneGTStacked.0') > 0 && $slotSettings->GetGameData('RingsOfFortuneGTStacked.1') > 0 && $slotSettings->GetGameData('RingsOfFortuneGTStacked.2') > 0 && $slotSettings->GetGameData('RingsOfFortuneGTStacked.3') > 0 && $slotSettings->GetGameData('RingsOfFortuneGTStacked.4') > 0 ) 
                                {
                            ...
                            for( $i = 0; $i <= 2000; $i++ ) 
                            {
                                ...
                                if( isset($jackState) && $jackState['isJackPay'] ) 
                                {
                                    ...
                                    $slotSettings->SetGameData('RingsOfFortuneGTIsJack', 1);
                                    $winType = 'win';
                                    ...
                                    for( $j = 0; $j < count($slotSettings->SymbolGame); $j++ ) 
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            if( $s[0] == $csym || in_array($s[0], $wild) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":1,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('RingsOfFortuneGTBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":["none","none"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":2,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('RingsOfFortuneGTBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            $s[0] = $reels['reel1'][$linesId[$k][0] - 1];
                                            $s[1] = $reels['reel2'][$linesId[$k][1] - 1];
                                            ...
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":3,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('RingsOfFortuneGTBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            $s[0] = $reels['reel1'][$linesId[$k][0] - 1];
                                            $s[1] = $reels['reel2'][$linesId[$k][1] - 1];
                                            ...
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) && ($s[3] == $csym || in_array($s[3], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":4,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('RingsOfFortuneGTBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            $s[0] = $reels['reel1'][$linesId[$k][0] - 1];
                                            $s[1] = $reels['reel2'][$linesId[$k][1] - 1];
                                            ...
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) && ($s[3] == $csym || in_array($s[3], $wild)) && ($s[4] == $csym || in_array($s[4], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":5,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('RingsOfFortuneGTBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":[' . ($linesId[$k][4] - 1) . ',"' . $s[4] . '"]}';
                                                }
                                                if( $isSlotJack ) 
                                                {
                                                    $tmpStringWin = '';
                            ...
                            if( $postData['slotEvent'] == 'freespin' && $slotSettings->GetGameData('RingsOfFortuneGTFreeGames') <= $slotSettings->GetGameData('RingsOfFortuneGTCurrentFreeGame') && $winType != 'bonus' && $slotSettings->GetGameData('RingsOfFortuneGTTotalWin') + $totalWin > 0 ) 
                            {
                                $slotSettings->SetBalance($slotSettings->GetGameData('RingsOfFortuneGTTotalWin') + $totalWin);
                            }
                            ...
                            if( $postData['slotEvent'] == 'freespin' ) 
                            {
                                $slotSettings->SetGameData('RingsOfFortuneGTBonusWin', $slotSettings->GetGameData('RingsOfFortuneGTBonusWin') + $totalWin);
                                $slotSettings->SetGameData('RingsOfFortuneGTTotalWin', $slotSettings->GetGameData('RingsOfFortuneGTTotalWin') + $totalWin);
                                $totalWin = $slotSettings->GetGameData('RingsOfFortuneGTBonusWin');
                                $Balance = $slotSettings->GetGameData('RingsOfFortuneGTFreeBalance');
                                for( $r = 1; $r <= 5; $r++ ) 
                                {
                                    for( $p = 0; $p <= 3; $p++ ) 
                                    {
                                        if( $reels['reel' . $r][$p] == 'P_1' ) 
                                        {
                                            $slotSettings->SetGameData('RingsOfFortuneGTStacked.' . ($r - 1), 0);
                                        }
                                    }
                                }
                            }
                            ...
                            if( $scattersCount >= 3 ) 
                            {
                                if( $slotSettings->GetGameData('RingsOfFortuneGTFreeGames') > 0 ) 
                                {
                                    $slotSettings->SetGameData('RingsOfFortuneGTFreeBalance', $Balance);
                                    $slotSettings->SetGameData('RingsOfFortuneGTBonusWin', $totalWin);
                                    $slotSettings->SetGameData('RingsOfFortuneGTFreeGames', $slotSettings->GetGameData('RingsOfFortuneGTFreeGames') + $slotSettings->slotFreeCount);
                                }
                                else
                                {
                                    $slotSettings->SetGameData('RingsOfFortuneGTFreeBalance', $Balance);
                                    $slotSettings->SetGameData('RingsOfFortuneGTBonusWin', $totalWin);
                                    $slotSettings->SetGameData('RingsOfFortuneGTFreeGames', $slotSettings->slotFreeCount);
                                }
                            }
                            $RingsOfFortuneGTStacked = [];
                            for( $i = 0; $i < 5; $i++ ) 
                            {
                                if( $slotSettings->HasGameData('RingsOfFortuneGTStacked.' . $i) ) 
                                {
                                    $RingsOfFortuneGTStacked[] = $slotSettings->GetGameData('RingsOfFortuneGTStacked.' . $i);
                                }
                            }
                            $jsSpin = '' . json_encode($reels) . '';
                            $jsJack = '' . json_encode($slotSettings->Jackpots) . '';
                            $winString = implode(',', $lineWins);
                            $stackedWilds = '"stackedWilds":[' . implode(',', $RingsOfFortuneGTStacked) . ']';
                            $response = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{' . $stackedWilds . ',"slotJackpot":' . $slotSettings->slotJackpot[0] . ',"slotLines":' . $postData['slotLines'] . ',"slotBet":' . $postData['slotBet'] . ',"totalFreeGames":' . $slotSettings->GetGameData('RingsOfFortuneGTFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('RingsOfFortuneGTCurrentFreeGame') . ',"Balance":' . $Balance . ',"afterBalance":' . $slotSettings->GetBalance() . ',"totalWin":' . $totalWin . ',"winLines":[' . $winString . '],"bonusInfo":' . $scattersStr . ',"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
