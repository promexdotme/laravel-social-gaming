                ...
                try
                    ...
                    switch( $gameData['slotEvent'] ) 
                    {
                        ...
                        case 'A/u25':
                            ...
                            $slotSettings->SetGameData('BookOfLordsAMFreeSym', '0');
                            if( $lastEvent != 'NULL' ) 
                            {
                                ...
                                $slotSettings->SetGameData('BookOfLordsAMLines', $curLines);
                                $freeMpl = '11';
                                $slotSettings->SetGameData('BookOfLordsAMFreeSym', $lastEvent->serverResponse->FreeSym);
                                $slotSettings->SetGameData('BookOfLordsAMBonusWin', $lastEvent->serverResponse->bonusWin);
                                $slotSettings->SetGameData('BookOfLordsAMFreeGames', $lastEvent->serverResponse->totalFreeGames);
                                $slotSettings->SetGameData('BookOfLordsAMCurrentFreeGame', $lastEvent->serverResponse->currentFreeGames);
                                $slotSettings->SetGameData('BookOfLordsAMTotalWin', 0);
                                $slotSettings->SetGameData('BookOfLordsAMFreeBalance', 0);
                                $slotSettings->SetGameData('BookOfLordsAMFreeStartWin', 0);
                                $tFree = dechex($slotSettings->GetGameData('BookOfLordsAMFreeGames'));
                                $cFree = dechex($slotSettings->GetGameData('BookOfLordsAMFreeGames') - $slotSettings->GetGameData('BookOfLordsAMCurrentFreeGame'));
                                $freeInfo = strlen($tFree) . $tFree . strlen($cFree) . $cFree;
                                $stateWin = $slotSettings->HexFormat($slotSettings->GetGameData('BookOfLordsAMBonusWin') * $floatBet);
                                if( $slotSettings->GetGameData('BookOfLordsAMCurrentFreeGame') < $slotSettings->GetGameData('BookOfLordsAMFreeGames') && $slotSettings->GetGameData('BookOfLordsAMFreeGames') > 0 ) 
                                {
                                    $slotState = '6';
                            ...
                            {
                                $slotSettings->SetGameData('BookOfLordsAMLines', $fixedLinesFormated);
                                $slotSettings->SetGameData('BookOfLordsAMLines', $fixedLinesFormated);
                                $slotState = '4';
                        ...
                        case 'A/u251':
                            if( $postData['spinType'] == 'regular' && $slotSettings->GetGameData($slotSettings->slotId . 'FreeGames') <= $slotSettings->GetGameData($slotSettings->slotId . 'CurrentFreeGame') ) 
                            {
                                ...
                                $bonusMpl = 1;
                                $slotSettings->SetGameData('BookOfLordsAMBonusWin', 0);
                                $slotSettings->SetGameData('BookOfLordsAMFreeGames', 0);
                                $slotSettings->SetGameData('BookOfLordsAMCurrentFreeGame', 0);
                                $slotSettings->SetGameData('BookOfLordsAMTotalWin', 0);
                                $slotSettings->SetGameData('BookOfLordsAMFreeBalance', 0);
                                $slotSettings->SetGameData('BookOfLordsAMFreeStartWin', 0);
                                $slotSettings->SetGameData('BookOfLordsAMFreeSym', '0');
                            ...
                            if( $slotSettings->GetGameData($slotSettings->slotId . 'CurrentFreeGame') < $slotSettings->GetGameData($slotSettings->slotId . 'FreeGames') ) 
                            {
                                ...
                                $slotSettings->SetGameData('BookOfLordsAMCurrentFreeGame', $slotSettings->GetGameData('BookOfLordsAMCurrentFreeGame') + 1);
                            ...
                            for( $i = 0; $i <= 2000; $i++ ) 
                            {
                                    ...
                                    for( $j = 0; $j < count($slotSettings->SymbolGame); $j++ ) 
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            if( $s[0] == $csym || in_array($s[0], $wild) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":1,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('BookOfLordsAMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":["none","none"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":2,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('BookOfLordsAMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":3,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('BookOfLordsAMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) && ($s[3] == $csym || in_array($s[3], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":4,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('BookOfLordsAMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) && ($s[3] == $csym || in_array($s[3], $wild)) && ($s[4] == $csym || in_array($s[4], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":5,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('BookOfLordsAMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":[' . ($linesId[$k][4] - 1) . ',"' . $s[4] . '"]}';
                                                }
                                            }
                                        }
                                    }
                                ...
                                for( $r = 1; $r <= 5; $r++ ) 
                                {
                                    for( $p = 0; $p <= 3; $p++ ) 
                                    {
                                        ...
                                        if( $reels['reel' . $r][$p] == $slotSettings->GetGameData('BookOfLordsAMFreeSym') ) 
                                        {
                                            $expCount++;
                                        }
                                    }
                                ...
                                if( $postData['slotEvent'] == 'freespin' ) 
                                {
                                    $expWin = $slotSettings->Paytable['SYM_' . $slotSettings->GetGameData('BookOfLordsAMFreeSym')][$expCount] * $betLine * $lines * $bonusMpl;
                                }
                            ...
                            if( $postData['slotEvent'] == 'freespin' && $slotSettings->GetGameData('BookOfLordsAMFreeGames') <= $slotSettings->GetGameData('BookOfLordsAMCurrentFreeGame') && $winType != 'bonus' && $slotSettings->GetGameData('BookOfLordsAMBonusWin') + $totalWin > 0 ) 
                            {
                                $slotSettings->SetBalance($slotSettings->GetGameData('BookOfLordsAMBonusWin') + $totalWin);
                            }
                            ...
                            if( $postData['slotEvent'] == 'freespin' ) 
                            {
                                $slotSettings->SetGameData('BookOfLordsAMBonusWin', $slotSettings->GetGameData('BookOfLordsAMBonusWin') + $totalWin);
                                $slotSettings->SetGameData('BookOfLordsAMTotalWin', $totalWin);
                            }
                            else
                            {
                                $slotSettings->SetGameData('BookOfLordsAMTotalWin', $totalWin);
                            ...
                            if( $scattersCount >= 3 ) 
                            {
                                ...
                                if( $slotSettings->GetGameData('BookOfLordsAMFreeGames') > 0 ) 
                                {
                                    $slotSettings->SetGameData('BookOfLordsAMFreeGames', $slotSettings->GetGameData('BookOfLordsAMFreeGames') + $slotSettings->slotFreeCount);
                                }
                                else
                                {
                                    $slotSettings->SetGameData('BookOfLordsAMFreeSym', rand(1, 8));
                                    $slotSettings->SetGameData('BookOfLordsAMFreeStartWin', $totalWin);
                                    $slotSettings->SetGameData('BookOfLordsAMBonusWin', $totalWin);
                                    $slotSettings->SetGameData('BookOfLordsAMFreeGames', $slotSettings->slotFreeCount);
                                }
                            }
                            $jsSpin = '' . json_encode($reels) . '';
                            $jsJack = '' . json_encode($slotSettings->Jackpots) . '';
                            $winString = implode(',', $lineWins);
                            $response_log = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{"FreeSym":' . $slotSettings->GetGameData('BookOfLordsAMFreeSym') . ',"slotLines":' . $lines . ',"slotBet":' . $betCnt . ',"totalFreeGames":' . $slotSettings->GetGameData('BookOfLordsAMFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('BookOfLordsAMCurrentFreeGame') . ',"Balance":' . $slotSettings->GetBalance() . ',"afterBalance":' . $slotSettings->GetBalance() . ',"bonusWin":' . $slotSettings->GetGameData('BookOfLordsAMBonusWin') . ',"freeStartWin":' . $slotSettings->GetGameData('BookOfLordsAMFreeStartWin') . ',"totalWin":' . $totalWin . ',"winLines":[' . $winString . '],"bonusInfo":' . $scattersStr . ',"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
                            ...
                            if( $postData['slotEvent'] == 'freespin' ) 
                            {
                                ...
                                $cFree = dechex($slotSettings->GetGameData('BookOfLordsAMFreeGames') - $slotSettings->GetGameData('BookOfLordsAMCurrentFreeGame'));
                                $gameState = '06';
                                if( $slotSettings->GetGameData('BookOfLordsAMFreeGames') <= $slotSettings->GetGameData('BookOfLordsAMCurrentFreeGame') ) 
                                {
                                    $gameState = '0c';
                                }
                                if( $scattersCount >= 3 ) 
                                ...
                                $totalWin = $slotSettings->GetGameData('BookOfLordsAMBonusWin');
                                $bonusMpl = $slotSettings->slotFreeMpl;
                            }
                            else
                            {
                            ...
                            $response = '1' . $gameState . '010' . $balanceFormated . $slotSettings->HexFormat(round($totalWin * 100)) . $reelSate . $bet_h . $ln_h . $freeInfo . $freeWinState . $slotSettings->HexFormat($bonusMpl) . '1010' . $reelSate . $fixedLinesFormated0 . $winLinesFormated . implode('', $slotSettings->GetGameData($slotSettings->slotId . 'Cards')) . '1' . $slotSettings->GetGameData('BookOfLordsAMFreeSym') . '1' . $expCount . $slotSettings->HexFormat($expWin * 100) . '#' . $scattersCount;
                            $response .= ('_' . json_encode($reels));
                            $slotSettings->SetGameData('BookOfLordsAMDoubleAnswer', $reelSate . $bet_h . $ln_h . '1010101010101010101010' . $fixedLinesFormated0 . $winLinesFormated);
                            $slotSettings->SetGameData('BookOfLordsAMDoubleBalance', $balanceFormated);
                            $slotSettings->SetGameData('BookOfLordsAMDoubleWin', $totalWin);
                            if( $postData['slotEvent'] == 'freespin' ) 
                            {
                            ...
                            $slotSettings->SetGameData('BookOfLordsAMCollectP0', $response_collect0);
                            $gameState = '04';
                            $balanceFormated = $slotSettings->HexFormat(round($slotSettings->GetBalance() * $floatBet));
                            ...
                            $slotSettings->SetGameData('BookOfLordsAMCollect', $response_collect);
                            break;
                        case 'A/u254':
                            $slotSettings->SetGameData($slotSettings->slotId . 'TotalWin', 0);
                            $slotSettings->SetGameData('BookOfLordsAMTotalWin', 0);
                            $response = $slotSettings->GetGameData('BookOfLordsAMCollect');
                            break;
                        case 'A/u257':
                            $doubleWin = rand(1, 2);
                            $winall = $slotSettings->GetGameData('BookOfLordsAMDoubleWin');
                            $dbet = $winall;
                            $daction = $tmpPar[1];
                            ...
                            $response = '107010' . $slotSettings->GetGameData('BookOfLordsAMDoubleBalance') . strlen($winall_h) . $winall_h . $slotSettings->GetGameData('BookOfLordsAMDoubleAnswer') . implode('', $slotSettings->GetGameData($slotSettings->slotId . 'Cards'));
                            $slotSettings->SetGameData('BookOfLordsAMDoubleWin', $winall);
                            $slotSettings->SetGameData('BookOfLordsAMTotalWin', $winall);
                            $balanceFormated = $slotSettings->HexFormat(round($slotSettings->GetBalance() * $floatBet));
                            $response_collect = '104010' . $balanceFormated . strlen($winall_h) . $winall_h . $slotSettings->GetGameData('BookOfLordsAMCollectP0');
                            $slotSettings->SetGameData('BookOfLordsAMCollect', $response_collect);
                        ...
                        case 'A/u258':
                            ...
                            $slotSettings->SetGameData('BookOfLordsAMDoubleBalance', $rtnBalance);
                            $winall = sprintf('%01.2f', $winall) * $floatBet;
                            $winall_h1 = str_replace('.', '', $winall . '');
                            $winall_h = dechex($winall_h1);
                            $doubleCards = '26280b2714161d0c';
                            $response = '108010' . $slotSettings->GetGameData('BookOfLordsAMDoubleBalance') . strlen($winall_h) . $winall_h . $slotSettings->GetGameData('BookOfLordsAMDoubleAnswer') . implode('', $slotSettings->GetGameData($slotSettings->slotId . 'Cards'));
                            break;
                    }
