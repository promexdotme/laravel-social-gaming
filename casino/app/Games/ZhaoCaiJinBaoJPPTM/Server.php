            ...
            function get_($request, $game)
            {
                \DB::transaction(function() use ($request, $game)
                {
                    try
                    {
                        ...
                        if( isset($postData['ID']) && $postData['ID'] == 41020 && $slotSettings->GetGameData('ZhaoCaiJinBaoJPPTMBonusStart') ) 
                        {
                            $result_tmp = [];
                            if( $postData['type'] == 'spin' ) 
                            {
                                ...
                                if( $slotSettings->GetGameData('ZhaoCaiJinBaoJPPTM_JP' . $curJID . 'Cnt') == 2 ) 
                                {
                                    $curJID = $gJackID + 1;
                                    if( $curJID == 1 ) 
                                    {
                                ...
                                $slotSettings->SetGameData('ZhaoCaiJinBaoJPPTM_JP' . $curJID . 'Cnt', $slotSettings->GetGameData('ZhaoCaiJinBaoJPPTM_JP' . $curJID . 'Cnt') + 1);
                                $jWin = 0;
                                if( $slotSettings->GetGameData('ZhaoCaiJinBaoJPPTM_JP' . $curJID . 'Cnt') >= 3 ) 
                                {
                                    ...
                                    $slotSettings->SetGameData('ZhaoCaiJinBaoJPPTMBonusStart', false);
                                ...
                                $rp = json_decode($slotSettings->GetGameData('ZhaoCaiJinBaoJPPTMJackReport'));
                                $rp->serverResponse->jackpotSelected[0] = $slotSettings->GetGameData('ZhaoCaiJinBaoJPPTM_JP1Cnt');
                                $rp->serverResponse->jackpotSelected[1] = $slotSettings->GetGameData('ZhaoCaiJinBaoJPPTM_JP2Cnt');
                                $rp->serverResponse->jackpotSelected[2] = $slotSettings->GetGameData('ZhaoCaiJinBaoJPPTM_JP3Cnt');
                                $rp->serverResponse->jackpotSelected[3] = $slotSettings->GetGameData('ZhaoCaiJinBaoJPPTM_JP4Cnt');
                                $rp->serverResponse->jackpotReel = $reelPos[0];
                                $rp->serverResponse->BonusStart = $slotSettings->GetGameData('ZhaoCaiJinBaoJPPTMBonusStart');
                                $rp_s = json_encode($rp);
                                $slotSettings->SetGameData('ZhaoCaiJinBaoJPPTMJackReport', $rp_s);
                                if( $slotSettings->GetGameData('ZhaoCaiJinBaoJPPTM_JP' . $curJID . 'Cnt') >= 3 ) 
                                {
                        ...
                        {
                            $result_tmp = [];
                            if( $slotSettings->GetGameData('ZhaoCaiJinBaoJPPTMBonusStep') == 0 ) 
                            {
                                $WinArr = [
                                    25, 
                                    22, 
                                ...
                                shuffle($WinArr);
                                $slotSettings->SetGameData('ZhaoCaiJinBaoJPPTMBonusOpt', $WinArr);
                                $curWin = $WinArr[$postData['index']];
                                if( $curWin > 0 ) 
                                {
                                    $slotSettings->SetGameData('ZhaoCaiJinBaoJPPTMFreeGames', $slotSettings->GetGameData('ZhaoCaiJinBaoJPPTMFreeGames') + $curWin);
                                }
                                else
                                {
                                    $slotSettings->SetGameData('ZhaoCaiJinBaoJPPTMFreeMpl', $slotSettings->GetGameData('ZhaoCaiJinBaoJPPTMFreeMpl') + ($curWin * -1));
                                }
                                $result_tmp[] = '3:::{"data":{"pick":' . $postData['index'] . ',"values":[' . $curWin . '],"windowId":"h72Yp3"},"ID":49022,"umid":448}';
                                $slotSettings->SetGameData('ZhaoCaiJinBaoJPPTMBonusStep', 1);
                            }
                            else if( $slotSettings->GetGameData('ZhaoCaiJinBaoJPPTMBonusStep') == 1 ) 
                            {
                                $WinArr = $slotSettings->GetGameData('ZhaoCaiJinBaoJPPTMBonusOpt');
                                $curWin = $WinArr[$postData['index']];
                                if( $curWin > 10 ) 
                                {
                                    $slotSettings->SetGameData('ZhaoCaiJinBaoJPPTMFreeGames', $slotSettings->GetGameData('ZhaoCaiJinBaoJPPTMFreeGames') + $curWin);
                                ...
                                $slotSettings->SetGameData('ZhaoCaiJinBaoJPPTMBonusStep', 2);
                            }
                            $umid = 0;
                        }
                        if( isset($postData['spinType']) ) 
                        {
                            ...
                            if( $postData['spinType'] == 'regular' ) 
                            {
                                ...
                                $bonusMpl = 1;
                                $slotSettings->SetGameData('ZhaoCaiJinBaoJPPTM_JP1Cnt', 0);
                                $slotSettings->SetGameData('ZhaoCaiJinBaoJPPTM_JP2Cnt', 0);
                                $slotSettings->SetGameData('ZhaoCaiJinBaoJPPTM_JP3Cnt', 0);
                                $slotSettings->SetGameData('ZhaoCaiJinBaoJPPTM_JP4Cnt', 0);
                                $slotSettings->SetGameData('ZhaoCaiJinBaoJPPTMBonusWin', 0);
                                $slotSettings->SetGameData('ZhaoCaiJinBaoJPPTMFreeGames', 0);
                                $slotSettings->SetGameData('ZhaoCaiJinBaoJPPTMCurrentFreeGame', 0);
                                $slotSettings->SetGameData('ZhaoCaiJinBaoJPPTMTotalWin', 0);
                                $slotSettings->SetGameData('ZhaoCaiJinBaoJPPTMFreeBalance', 0);
                                $slotSettings->SetGameData('ZhaoCaiJinBaoJPPTMFreeStartWin', 0);
                                $slotSettings->SetGameData('ZhaoCaiJinBaoJPPTMFreeMpl', $slotSettings->slotFreeMpl);
                            }
                            else if( $postData['spinType'] == 'free' ) 
                            {
                                $umid = '0';
                                $postData['slotEvent'] = 'freespin';
                                $slotSettings->SetGameData('ZhaoCaiJinBaoJPPTMCurrentFreeGame', $slotSettings->GetGameData('ZhaoCaiJinBaoJPPTMCurrentFreeGame') + 1);
                                $bonusMpl = $slotSettings->GetGameData('ZhaoCaiJinBaoJPPTMFreeMpl');
                            }
                            $linesId = [];
                            $linesId[0] = [
                                2, 
                                    ...
                                    for( $j = 0; $j < count($slotSettings->SymbolGame); $j++ ) 
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            if( $s[4] == $csym || in_array($s[4], $wild) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":1,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('ZhaoCaiJinBaoJPPTMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":["none","none"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            ...
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":2,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('ZhaoCaiJinBaoJPPTMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            ...
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":3,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('ZhaoCaiJinBaoJPPTMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            ...
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) && ($s[3] == $csym || in_array($s[3], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":4,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('ZhaoCaiJinBaoJPPTMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            ...
                                            if( ($s[4] == $csym || in_array($s[4], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) && ($s[3] == $csym || in_array($s[3], $wild)) && ($s[4] == $csym || in_array($s[4], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":5,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('ZhaoCaiJinBaoJPPTMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":[' . ($linesId[$k][4] - 1) . ',"' . $s[4] . '"]}';
                                                }
                                            }
                                        }
                                    }
                            ...
                            if( $postData['slotEvent'] == 'freespin' ) 
                            {
                                $slotSettings->SetGameData('ZhaoCaiJinBaoJPPTMBonusWin', $slotSettings->GetGameData('ZhaoCaiJinBaoJPPTMBonusWin') + $totalWin);
                                $slotSettings->SetGameData('ZhaoCaiJinBaoJPPTMTotalWin', $totalWin);
                            }
                            else
                            {
                                $slotSettings->SetGameData('ZhaoCaiJinBaoJPPTMTotalWin', $totalWin);
                            ...
                            if( $winType == 'bonus' ) 
                            {
                                ...
                                $slotSettings->SetGameData('ZhaoCaiJinBaoJPPTMBonusStart', true);
                            ...
                            $response = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{"BonusStart":' . json_encode($slotSettings->GetGameData('ZhaoCaiJinBaoJPPTMBonusStart')) . ',"JackWinID":' . $slotSettings->GetGameData($slotSettings->slotId . 'JackWinID') . ',"jackpotReel":0,"jackpotSelected":[' . implode(',', $jackpotSelected) . '],"linesArr":[' . implode(',', $postData['lines']) . '],"slotLines":' . $lines . ',"slotBet":' . $betLine . ',"totalFreeGames":' . $slotSettings->GetGameData('ZhaoCaiJinBaoJPPTMFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('ZhaoCaiJinBaoJPPTMCurrentFreeGame') . ',"Balance":' . $slotSettings->GetBalance() . ',"afterBalance":' . $slotSettings->GetBalance() . ',"bonusWin":' . $slotSettings->GetGameData('ZhaoCaiJinBaoJPPTMBonusWin') . ',"FreeMpl":' . $slotSettings->GetGameData('ZhaoCaiJinBaoJPPTMFreeMpl') . ',"freeStartWin":' . $slotSettings->GetGameData('ZhaoCaiJinBaoJPPTMFreeStartWin') . ',"totalWin":' . $totalWin . ',"winLines":[' . $winString . '],"bonusInfo":' . $scattersStr . ',"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
                            $slotSettings->SetGameData('ZhaoCaiJinBaoJPPTMJackReport', $response);
                        ...
                        switch( $umid ) 
                        {
                            ...
                            case '40066':
                                ...
                                $result_tmp[] = '3:::{"data":{"funNoticeGames":0,"funNoticePayouts":0,"gameGroup":"zcjbjp","minBet":0,"maxBet":0,"minPosBet":0,"maxPosBet":50000,"coinSizes":[' . implode(',', $gameBets) . ']},"ID":40025,"umid":21}';
                                ...
                                if( $lastEvent != 'NULL' ) 
                                {
                                    $slotSettings->SetGameData('ZhaoCaiJinBaoJPPTM_JP1Cnt', $lastEvent->serverResponse->jackpotSelected[0]);
                                    $slotSettings->SetGameData('ZhaoCaiJinBaoJPPTM_JP2Cnt', $lastEvent->serverResponse->jackpotSelected[1]);
                                    $slotSettings->SetGameData('ZhaoCaiJinBaoJPPTM_JP3Cnt', $lastEvent->serverResponse->jackpotSelected[2]);
                                    $slotSettings->SetGameData('ZhaoCaiJinBaoJPPTM_JP4Cnt', $lastEvent->serverResponse->jackpotSelected[3]);
                                    $slotSettings->SetGameData('ZhaoCaiJinBaoJPPTM_JPReel', $lastEvent->serverResponse->jackpotReel);
                                    ...
                                    if( $lastEvent->responseType == 'jackpot' && $lastEvent->serverResponse->jackpotSelected[0] < 3 && $lastEvent->serverResponse->jackpotSelected[1] < 3 && $lastEvent->serverResponse->jackpotSelected[2] < 3 && $lastEvent->serverResponse->jackpotSelected[3] < 3 ) 
                                    {
                                        ...
                                        $slotSettings->SetGameData('ZhaoCaiJinBaoJPPTMJackReport', json_encode($lastEvent));
                                    }
                                }
                                break;
                            case '40036':
                            ...
                            case '40030':
                                ...
                                if( $slotSettings->GetGameData($slotSettings->slotId . 'brokenGames') != '' ) 
                                {
                                    ...
                                    if( $lastEvent != 'NULL' ) 
                                    {
                                        ...
                                        $slotSettings->SetGameData('ZhaoCaiJinBaoJPPTM_JP4Cnt', $lastEvent->serverResponse->jackpotSelected[3]);
                                        $slotSettings->SetGameData('ZhaoCaiJinBaoJPPTM_JPReel', $lastEvent->serverResponse->jackpotReel);
                                        $slotSettings->SetGameData('ZhaoCaiJinBaoJPPTMBonusStart', $lastEvent->serverResponse->BonusStart);
                                        $slotSettings->SetGameData($slotSettings->slotId . 'BonusWin', $lastEvent->serverResponse->bonusWin);
                                        $slotSettings->SetGameData($slotSettings->slotId . 'FreeStartWin', $lastEvent->serverResponse->freeStartWin);
                                        $slotSettings->SetGameData($slotSettings->slotId . 'FreeGames', $lastEvent->serverResponse->totalFreeGames);
                                        $slotSettings->SetGameData($slotSettings->slotId . 'CurrentFreeGame', $lastEvent->serverResponse->currentFreeGames);
