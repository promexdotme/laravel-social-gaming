                ...
                \DB::transaction(function() use ($request, $game)
                {
                    try
                    {
                        ...
                        else if( $postData['slotEvent'] == 'gamble5GetUserCards' ) 
                        {
                            ...
                            $dealerCard = $slotSettings->GetGameData('BurningHot7GTMDealerCard');
                            $totalWin = $slotSettings->GetGameData('BurningHot7GTMTotalWin');
                            $gambleWin = 0;
                            ...
                            $slotSettings->SetGameData('BurningHot7GTMTotalWin', $totalWin);
                        ...
                        else if( $postData['slotEvent'] == 'gamble5GetDealerCard' ) 
                        {
                            ...
                            $slotSettings->SetGameData('BurningHot7GTMDealerCard', $tmpDc);
                        ...
                        else if( $postData['slotEvent'] == 'bet' || $postData['slotEvent'] == 'freespin' ) 
                        {
                            ...
                            if( $postData['slotEvent'] != 'freespin' ) 
                            {
                                ...
                                $bonusMpl = 1;
                                $slotSettings->SetGameData('BurningHot7GTMBonusWin', 0);
                                $slotSettings->SetGameData('BurningHot7GTMFreeGames', 0);
                                $slotSettings->SetGameData('BurningHot7GTMCurrentFreeGame', 0);
                                $slotSettings->SetGameData('BurningHot7GTMTotalWin', 0);
                                $slotSettings->SetGameData('BurningHot7GTMFreeBalance', 0);
                            }
                            else
                            {
                                $slotSettings->SetGameData('BurningHot7GTMCurrentFreeGame', $slotSettings->GetGameData('BurningHot7GTMCurrentFreeGame') + 1);
                                    ...
                                    for( $j = 0; $j < count($slotSettings->SymbolGame); $j++ ) 
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            if( $s[0] == $csym || in_array($s[0], $wild) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":1,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('BurningHot7GTMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":["none","none"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":2,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('BurningHot7GTMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            $s[0] = $reels['reel1'][$linesId[$k][0] - 1];
                                            $s[1] = $reels['reel2'][$linesId[$k][1] - 1];
                                            ...
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":3,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('BurningHot7GTMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                        }
                                    }
                            ...
                            if( $postData['slotEvent'] == 'freespin' && $slotSettings->GetGameData('BurningHot7GTMFreeGames') <= $slotSettings->GetGameData('BurningHot7GTMCurrentFreeGame') && $winType != 'bonus' && $slotSettings->GetGameData('BurningHot7GTMTotalWin') + $totalWin > 0 ) 
                            {
                                $slotSettings->SetBalance($slotSettings->GetGameData('BurningHot7GTMTotalWin') + $totalWin);
                            }
                            ...
                            if( $postData['slotEvent'] == 'freespin' ) 
                            {
                                $slotSettings->SetGameData('BurningHot7GTMBonusWin', $slotSettings->GetGameData('BurningHot7GTMBonusWin') + $totalWin);
                                $slotSettings->SetGameData('BurningHot7GTMTotalWin', $slotSettings->GetGameData('BurningHot7GTMTotalWin') + $totalWin);
                                $totalWin = $slotSettings->GetGameData('BurningHot7GTMBonusWin');
                                $Balance = $slotSettings->GetGameData('BurningHot7GTMFreeBalance');
                            }
                            else
                            {
                                $slotSettings->SetGameData('BurningHot7GTMTotalWin', $totalWin);
                            ...
                            if( $scattersCount >= 3 ) 
                            {
                                if( $slotSettings->GetGameData('BurningHot7GTMFreeGames') > 0 ) 
                                {
                                    $slotSettings->SetGameData('BurningHot7GTMFreeBalance', $Balance);
                                    $slotSettings->SetGameData('BurningHot7GTMBonusWin', $totalWin);
                                    $freeGamesCount = rand(14, 20);
                                    $slotSettings->SetGameData('BurningHot7GTMFreeGames', $slotSettings->GetGameData('BurningHot7GTMFreeGames') + $freeGamesCount);
                                }
                                else
                                {
                                    $freeGamesCount = rand(14, 20);
                                    $slotSettings->SetGameData('BurningHot7GTMFreeBalance', $Balance);
                                    $slotSettings->SetGameData('BurningHot7GTMBonusWin', $totalWin);
                                    $slotSettings->SetGameData('BurningHot7GTMFreeGames', $freeGamesCount);
                                }
                            }
                            $X2Mode = 'false';
                            if( $reels['reel1'][0] == $reels['reel1'][1] && $reels['reel1'][0] == $reels['reel1'][2] && $reels['reel1'][0] == $reels['reel2'][0] && $reels['reel2'][0] == $reels['reel2'][1] && $reels['reel2'][0] == $reels['reel2'][2] && $reels['reel1'][0] == $reels['reel3'][0] && $reels['reel3'][0] == $reels['reel3'][1] && $reels['reel2'][0] == $reels['reel3'][2] ) 
                            {
                                $X2Mode = 'true';
                            }
                            ...
                            $response = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{"slotLines":' . $postData['slotLines'] . ',"slotBet":' . $postData['slotBet'] . ',"selectedFreeCount":' . $freeGamesCount . ',"X2":' . $X2Mode . ',"totalFreeGames":' . $slotSettings->GetGameData('BurningHot7GTMFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('BurningHot7GTMCurrentFreeGame') . ',"Balance":' . $Balance . ',"afterBalance":' . $slotSettings->GetBalance() . ',"totalWin":' . $totalWin . ',"winLines":[' . $winString . '],"bonusInfo":' . $scattersStr . ',"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
