            ...
            function get_($request, $game)
            {
                \DB::transaction(function() use ($request, $game)
                {
                    try
                    {
                        ...
                        {
                            $response = '{"status":"success","microtime":0.0026731491088867,"dateTime":"2020-02-13 13:23:32","error":"","content":{"cmd":"sessionInfo","serverMathematics":"\/game\/Lucky88AT\/server","serverResources":"","sessionId":"54594109_4133a64673d3883d42cd003ee905ba3e","exitUlt":"\/","exitUrl":"\/","id":"341","name":"GameName","currency":"ALL","language":"en","type":"aristocrat","systemName":"lucky88","version":"2","mobile":"1"}}';
                        }
                        ...
                        else if( $postData['slotEvent'] == 'gamePick' ) 
                        {
                            ...
                            if( $_POST['pick'] == 0 ) 
                            {
                                $slotSettings->SetGameData('Lucky88ATMpl', 10);
                                $slotSettings->SetGameData('Lucky88ATCurrentFreeGame', 0);
                                $slotSettings->SetGameData('Lucky88ATFreeGames', 5);
                            }
                            else if( $_POST['pick'] == 1 ) 
                            {
                                $slotSettings->SetGameData('Lucky88ATMpl', 5);
                                $slotSettings->SetGameData('Lucky88ATCurrentFreeGame', 0);
                                $slotSettings->SetGameData('Lucky88ATFreeGames', 10);
                            }
                            else if( $_POST['pick'] == 2 ) 
                            {
                                $slotSettings->SetGameData('Lucky88ATMpl', 3);
                                $slotSettings->SetGameData('Lucky88ATCurrentFreeGame', 0);
                                $slotSettings->SetGameData('Lucky88ATFreeGames', 15);
                            }
                            else if( $_POST['pick'] == 3 ) 
                            {
                                $slotSettings->SetGameData('Lucky88ATMpl', 2);
                                $slotSettings->SetGameData('Lucky88ATCurrentFreeGame', 0);
                                $slotSettings->SetGameData('Lucky88ATFreeGames', 20);
                            }
                            $response = '{"status":"success","microtime":0.0093810558319092,"dateTime":"2020-02-15 14:26:21","error":"","content":{"session":"54990161_9709e13bca7763b46396cda1868d2e7e","cmd":"gamePick","balance":' . $balanceInCents . ',"win":0,"symbols":{"1":{"1":"symbol_6","2":"symbol_9","3":"symbol_13"},"2":{"1":"symbol_10","2":"symbol_5","3":"symbol_8"},"3":{"1":"symbol_10","2":"symbol_13","3":"symbol_11"},"4":{"1":"symbol_13","2":"symbol_10","3":"symbol_6"},"5":{"1":"symbol_3","2":"symbol_8","3":"symbol_1"}},"winLines":[],"freeSpin":{"id":"54990161_20200215132548","current":0,"add":' . $slotSettings->GetGameData('Lucky88ATFreeGames') . ',"total":' . $slotSettings->GetGameData('Lucky88ATFreeGames') . ',"totalWin":' . ($slotSettings->GetGameData('Lucky88ATBonusWin') * 100) . ',"multiplayer":' . $slotSettings->GetGameData('Lucky88ATMpl') . ',"pick":' . $_POST['pick'] . '},"actionId":"54990161_10_60","hash":"1ace145628d930d28bdf38789a28a9d7"}}';
                        }
                        else if( $postData['slotEvent'] == 'slotGamble' ) 
                        {
                            ...
                            $dealerCard = '';
                            $totalWin = $slotSettings->GetGameData('Lucky88ATTotalWin');
                            $gambleWin = 0;
                            $statBet = $totalWin;
                            ...
                            $slotSettings->SetGameData('Lucky88ATTotalWin', $totalWin);
                        ...
                        else if( $postData['slotEvent'] == 'bet' || $postData['slotEvent'] == 'freespin' ) 
                        {
                            ...
                            if( $postData['slotEvent'] != 'freespin' ) 
                            {
                                ...
                                $bonusMpl = 1;
                                $slotSettings->SetGameData('Lucky88ATBonusWin', 0);
                                $slotSettings->SetGameData('Lucky88ATFreeGames', 0);
                                $slotSettings->SetGameData('Lucky88ATCurrentFreeGame', 0);
                                $slotSettings->SetGameData('Lucky88ATTotalWin', 0);
                                $slotSettings->SetGameData('Lucky88ATFreeBalance', 0);
                                $slotSettings->SetGameData('Lucky88ATMpl', 3);
                            }
                            else
                            {
                                $slotSettings->SetGameData('Lucky88ATCurrentFreeGame', $slotSettings->GetGameData('Lucky88ATCurrentFreeGame') + 1);
                                $bonusMpl = $slotSettings->GetGameData('Lucky88ATMpl');
                            }
                            $Balance = $slotSettings->GetBalance();
                            ...
                            if( $postData['slotEvent'] == 'freespin' ) 
                            {
                                $slotSettings->SetGameData('Lucky88ATBonusWin', $slotSettings->GetGameData('Lucky88ATBonusWin') + $totalWin);
                                $slotSettings->SetGameData('Lucky88ATTotalWin', $slotSettings->GetGameData('Lucky88ATTotalWin') + $totalWin);
                                $freeStateStr = '"id":"54594109_20200214110301","current":' . $slotSettings->GetGameData('Lucky88ATCurrentFreeGame') . ',"multiplayer":' . $slotSettings->GetGameData('Lucky88ATMpl') . ',"add":0,"total":' . $slotSettings->GetGameData('Lucky88ATFreeGames') . ',"totalWin":' . ($slotSettings->GetGameData('Lucky88ATBonusWin') * 100) . '';
                            }
                            else
                            {
                                $slotSettings->SetGameData('Lucky88ATTotalWin', $totalWin);
                            ...
                            if( $scattersCount >= 3 ) 
                            {
                                if( $slotSettings->GetGameData('Lucky88ATFreeGames') > 0 ) 
                                {
                                    $slotSettings->SetGameData('Lucky88ATFreeGames', $slotSettings->GetGameData('Lucky88ATFreeGames') + $slotSettings->slotFreeCount);
                                    $freeStateStr = '"id":"54594109_20200214110301","current":' . $slotSettings->GetGameData('Lucky88ATCurrentFreeGame') . ',"multiplayer":' . $slotSettings->GetGameData('Lucky88ATMpl') . ',"add":' . $slotSettings->slotFreeCount . ',"total":' . $slotSettings->GetGameData('Lucky88ATFreeGames') . ',"totalWin":' . ($slotSettings->GetGameData('Lucky88ATBonusWin') * 100) . '';
                                }
                                else
                                {
                                    $slotSettings->SetGameData('Lucky88ATFreeBalance', $Balance);
                                    $slotSettings->SetGameData('Lucky88ATBonusWin', $totalWin);
                                    $slotSettings->SetGameData('Lucky88ATFreeGames', $slotSettings->slotFreeCount);
                                    $freeStateStr = '"id":"54594109_20200214110301","current":' . $slotSettings->GetGameData('Lucky88ATCurrentFreeGame') . ',"multiplayer":' . $slotSettings->GetGameData('Lucky88ATMpl') . ',"add":-1,"total":-1,"totalWin":' . ($slotSettings->GetGameData('Lucky88ATBonusWin') * 100) . '';
                                }
                            }
                            $jsSpin = '' . json_encode($reels) . '';
                            $jsJack = '' . json_encode($slotSettings->Jackpots) . '';
                            $winString = implode(',', $lineWins);
                            $response_log = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{"slotLines":' . $postData['slotLines'] . ',"slotBet":' . $postData['slotBet'] . ',"totalFreeGames":' . $slotSettings->GetGameData('Lucky88ATFreeGames') . ',"Mpl":' . $slotSettings->GetGameData('Lucky88ATMpl') . ',"currentFreeGames":' . $slotSettings->GetGameData('Lucky88ATCurrentFreeGame') . ',"Balance":' . $Balance . ',"afterBalance":' . $slotSettings->GetBalance() . ',"totalWin":' . $totalWin . ',"winLines":[' . $winString . '],"bonusInfo":{},"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
                            $reelStrArr = [];
                            for( $i = 1; $i <= 5; $i++ ) 
                            {
