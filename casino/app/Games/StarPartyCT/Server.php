            ...
            function get_($request, $game)
            {
                \DB::transaction(function() use ($request, $game)
                {
                    try
                    {
                        ...
                        {
                            case 'create_session':
                                $slotSettings->SetGameData('StarPartyCTCards', [
                                    19, 
                                    44, 
                                    0, 
                                    37, 
                            ...
                            case 'init_game':
                                ...
                                $slotSettings->SetGameData('StarPartyCTBonusWin', 0);
                                $slotSettings->SetGameData('StarPartyCTFreeGames', 0);
                                $slotSettings->SetGameData('StarPartyCTCurrentFreeGame', 0);
                                $slotSettings->SetGameData('StarPartyCTCurrentFreeGame0', 0);
                                $slotSettings->SetGameData('StarPartyCTTotalWin', 0);
                                $slotSettings->SetGameData('StarPartyCTFreeBalance', 0);
                                ...
                                if( $lastEvent != 'NULL' ) 
                                {
                                    ...
                                    if( $slotSettings->GetGameData('StarPartyCTCurrentFreeGame') < $slotSettings->GetGameData('StarPartyCTFreeGames') && $slotSettings->GetGameData('StarPartyCTFreeGames') > 0 ) 
                                    {
                            ...
                            case 'poll':
                                ...
                                {
                                    $balanceInCents = sprintf('%01.2f', $slotSettings->GetBalance() - $slotSettings->GetGameData('StarPartyCTTotalWin')) * 100;
                                }
                            ...
                            case 'game_finished':
                                $slotSettings->SetGameData('StarPartyCTBonusWin', 0);
                                $slotSettings->SetGameData('StarPartyCTTotalWin', 0);
                                $responseData['game_finished'][0]['freeround_play'] = $slotSettings->GetGameData('StarPartyCTCurrentFreeGame0');
                            ...
                            case 'subgame_finished':
                                if( $slotSettings->GetGameData('StarPartyCTCurrentFreeGame0') < $slotSettings->GetGameData('StarPartyCTFreeGames') && $slotSettings->GetGameData('StarPartyCTFreeGames') > 0 ) 
                                {
                                    ...
                                    $response = '{"responseEvent":"spin","responseType":"freespin","serverResponse":{"result":' . json_encode($result) . ',"slotDenom":' . $slotSettings->GetGameData($slotSettings->slotId . 'Denom') . ',"slotLines":' . $lines . ',"slotBet":' . $betline . ',"totalFreeGames":' . $slotSettings->GetGameData('StarPartyCTFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('StarPartyCTCurrentFreeGame0') . ',"Balance":' . $slotSettings->GetGameData('StarPartyCTFreeBalance') . ',"afterBalance":' . $slotSettings->GetGameData('StarPartyCTFreeBalance') . ',"bonusWin":' . $slotSettings->GetGameData('StarPartyCTBonusWin') . ',"totalWin":' . $reportWin . ',"winLines":[],"Jackpots":[],"reelsSymbols":' . json_encode($slotSettings->GetGameData($slotSettings->slotId . 'Reels')) . '}}';
                                    if( $slotSettings->GetGameData('StarPartyCTFreeGames') <= $slotSettings->GetGameData('StarPartyCTCurrentFreeGame0') ) 
                                    {
                                        if( $reportWin > 0 ) 
                                        {
                                    ...
                                    $balanceInCents = $slotSettings->GetGameData('StarPartyCTFreeBalance');
                                    $responseData['subgame_finished'][0]['account_status']['credit'] = round($balanceInCents);
                                    $responseData['subgame_finished'][0]['freeround_play'] = $slotSettings->GetGameData('StarPartyCTCurrentFreeGame0');
                                    $responseData['subgame_finished'][1]['freeround_play'] = $slotSettings->GetGameData('StarPartyCTCurrentFreeGame0');
                            ...
                            case 'play':
                                ...
                                for( $spinLoop = 0; $spinLoop < $spinLoopLimit; $spinLoop++ ) 
                                {
                                    ...
                                    if( $postData['slotEvent'] != 'freespin' ) 
                                    {
                                        ...
                                        $slotSettings->SetGameData('StarPartyCTCurrentFreeGame0', 0);
                                        $slotSettings->SetGameData('StarPartyCTTotalWin', 0);
                                        $slotSettings->SetGameData('StarPartyCTFreeBalance', sprintf('%01.2f', $slotSettings->GetBalance()) * 100);
                                    ...
                                    {
                                        $slotSettings->SetGameData('StarPartyCTCurrentFreeGame', $slotSettings->GetGameData('StarPartyCTCurrentFreeGame') + 1);
                                    ...
                                    if( $postData['slotEvent'] == 'freespin' ) 
                                    {
                                        $slotSettings->SetGameData('StarPartyCTBonusWin', $slotSettings->GetGameData('StarPartyCTBonusWin') + $totalWin);
                                        $slotSettings->SetGameData('StarPartyCTTotalWin', $slotSettings->GetGameData('StarPartyCTTotalWin') + $totalWin);
                                        $balanceInCents = $slotSettings->GetGameData('StarPartyCTFreeBalance');
                                    }
                                    else
                                    {
                                        $slotSettings->SetGameData('StarPartyCTTotalWin', $totalWin);
                                    }
                                    $fs = 0;
                                    if( $scattersCount >= 3 ) 
                                    {
                                    ...
                                    $winstring = '';
                                    $slotSettings->SetGameData('StarPartyCTGambleStep', 5);
                                    $hist = $slotSettings->GetGameData('StarPartyCTCards');
                                    if( $postData['slotEvent'] == 'freespin' ) 
                                    {
                                        $state = 'freespin';
                                        ...
                                        if( $slotSettings->GetGameData($slotSettings->slotId . 'FreeGames') <= $slotSettings->GetGameData($slotSettings->slotId . 'CurrentFreeGame') && $slotSettings->GetGameData('StarPartyCTBonusWin') > 0 ) 
                                        {
                                            $responseData['play'][0]['result'][$spinLoop]['is_free'] = true;
                                    ...
                                    $responseData['play'][0]['result'][$spinLoop]['total_win'] = $slotSettings->GetGameData('StarPartyCTTotalWin') / $denom;
                                ...
                                $response = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{"result":' . json_encode($responseData['play'][0]['result']) . ',"slotDenom":' . $denom . ',"slotLines":' . $lines . ',"slotBet":' . $betline . ',"totalFreeGames":' . $slotSettings->GetGameData('StarPartyCTFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('StarPartyCTCurrentFreeGame0') . ',"Balance":' . $slotSettings->GetGameData($slotSettings->slotId . 'FreeBalance') . ',"afterBalance":' . $slotSettings->GetBalance() . ',"bonusWin":' . $slotSettings->GetGameData('StarPartyCTBonusWin') . ',"totalWin":' . $totalWin . ',"winLines":[],"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
                            ...
                            case 'gamble':
                                ...
                                $dealerCard = '';
                                $totalWin = $slotSettings->GetGameData('StarPartyCTTotalWin');
                                $gambleWin = 0;
                                $statBet = $totalWin;
                                ...
                                $hist = $slotSettings->GetGameData('StarPartyCTCards');
                                $slotSettings->SetGameData('StarPartyCTGambleStep', $slotSettings->GetGameData('StarPartyCTGambleStep') - 1);
                                if( $slotSettings->MaxWin < ($totalWin * $slotSettings->CurrentDenom) ) 
                                {
                                    $isGambleWin = 0;
                                }
                                ...
                                else
                                {
                                    ...
                                    $totalWin = 0;
                                    $slotSettings->SetGameData('StarPartyCTGambleStep', 0);
                                    if( $postData['continue_params']['double_key'] != 'red' && $postData['continue_params']['double_key'] != 'black' ) 
                                    {
                                        if( $postData['continue_params']['double_key'] == 'diamond' ) 
                                        {
                                ...
                                $slotSettings->SetGameData('StarPartyCTCards', $hist);
