                    ...
                    try
                    {
                        ...
                        switch( $aid ) 
                        {
                            ...
                            case 'playerControl.tableHandler.searchTableAndJoin':
                                ...
                                $fishesArr = [];
                                $fishes = $slotSettings->GetGameData('FishHunterKAFishes');
                                if( !is_array($fishes) ) 
                                {
                                    $fishes = [];
                                }
                                ...
                                $slotSettings->SetGameData('FishHunterKAFishes', $fishes);
                            ...
                            case 'connector.accountHandler.onPingBalance':
                                $bullets = '';
                                $Bet = $slotSettings->GetGameData('FishHunterKABet');
                                $BetCnt = $slotSettings->GetGameData('FishHunterKABetCnt');
                                $BetArr = $slotSettings->GetGameData('FishHunterKABetArr');
                                $BetLevel = $slotSettings->GetGameData('FishHunterKABetLevel');
                            ...
                            case 'connector.accountHandler.onPingBalance_2':
                                ...
                                {
                                    $slotSettings->SetGameData('FishHunterKAFishes', []);
                                    $curScene = $slotSettings->GetGameData('FishHunterKACurScene');
                                    $curScene++;
                                    if( $curScene > 3 ) 
                                    {
                                        $curScene = 0;
                                    ...
                                    $slotSettings->SetGameData('FishHunterKAWaveTime', time());
                                    $slotSettings->SetGameData('FishHunterKACurScene', $curScene);
                                ...
                                else
                                {
                                    ...
                                    $slotSettings->SetGameData('FishHunterKAFishes', $fishesArrNew);
                                }
                                break;
                            case 'playerControl.areaHandler.onCollider':
                                ...
                                $fishes = $slotSettings->GetGameData('FishHunterKAFishes');
                                $bulletsArr = $slotSettings->GetGameData('FishHunterKABullets');
                                ...
                                {
                                    $result_tmp[0] = '{"answerType":"game.colliderResult","Win":' . ($totalWin * 100) . ',"Balance":' . sprintf('%01.2f', $slotSettings->GetBalance()) . ',"curBet":' . $slotSettings->GetGameData('FishHunterKABet') . ',"responseView":[4,0,0,0,6,' . strlen('game.colliderResult') . '],"msg":{"player":{"id":"d607e29f-99cc-48bc-a37d-5590b80fa0f6","gold":' . ($totalWin * 100) . ',"delta":0,"gain":0,"cost":' . ($Bet * 100) . ',"rmpRatioCredit":' . $balanceInCents . ',"ratio":1},"result":[]}}';
                                    echo $result_tmp[0];
                                }
                                if( isset($fishes[$fid]) ) 
                                {
                                ...
                                {
                                    $result_tmp[0] = '{"answerType":"game.colliderResult","Win":' . ($totalWin * 100) . ',"Balance":0.0,"curBet":' . $slotSettings->GetGameData('FishHunterKABet') . ',"responseView":[4,0,0,0,6,' . strlen('game.colliderResult') . '],"msg":{"player":{"id":"d607e29f-99cc-48bc-a37d-5590b80fa0f6","gold":' . ($totalWin * 100) . ',"delta":0,"gain":0,"cost":' . ($Bet * 100) . ',"rmpRatioCredit":0.1,"ratio":1},"result":[' . $results . ']}}';
                                }
                                else
                                {
                                    $result_tmp[0] = '{"answerType":"game.colliderResult","Win":' . ($totalWin * 100) . ',"Balance":' . sprintf('%01.2f', $slotSettings->GetBalance()) . ',"curBet":' . $slotSettings->GetGameData('FishHunterKABet') . ',"responseView":[4,0,0,0,6,' . strlen('game.colliderResult') . '],"msg":{"player":{"id":"d607e29f-99cc-48bc-a37d-5590b80fa0f6","gold":' . ($totalWin * 100) . ',"delta":1,"gain":1,"cost":' . ($Bet * 100) . ',"rmpRatioCredit":' . $balanceInCents . ',"ratio":1},"result":[' . $results . ']}}';
                                }
                            ...
                            case 'fishHunter.areaHandler.onUpdateCannon':
                                ...
                                $BetArr = $slotSettings->GetGameData('FishHunterKABetArr');
                                $BetLevel = $slotSettings->GetGameData('FishHunterKABetLevel');
                                $cnLevel = $slotSettings->GetGameData('FishHunterKABetLevel') * 6;
                                ...
                                $slotSettings->SetGameData('FishHunterKABetCnt', $BetCnt);
                                $slotSettings->SetGameData('FishHunterKABetArr', $BetArr);
                                $slotSettings->SetGameData('FishHunterKABetLevel', $BetLevel);
                            ...
                            case 'fishHunter.areaHandler.onFire':
                                $bulletsArr = $slotSettings->GetGameData('FishHunterKABullets');
                                $bulletBet = $slotSettings->GetGameData('FishHunterKABet');
                                $allbet = $bulletBet;
                                $Bet = $slotSettings->GetGameData('FishHunterKABet');
                                $BetCnt = $slotSettings->GetGameData('FishHunterKABetCnt');
                                $BetArr = $slotSettings->GetGameData('FishHunterKABetArr');
                                ...
                                else
                                {
                                    ...
                                    $slotSettings->SetGameData('FishHunterKABullets', $bulletsArr);
