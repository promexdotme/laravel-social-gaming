            ...
            function get_($request, $game)
            {
                \DB::transaction(function() use ($request, $game)
                {
                    try
                    {
                        ...
                        if( isset($postData['ID']) && $postData['ID'] == 41020 && $slotSettings->GetGameData('FeiCuiGongZhuJPPTBonusStart') ) 
                        {
                            $result_tmp = [];
                            if( $postData['type'] == 'spin' ) 
                            {
                                ...
                                if( $slotSettings->GetGameData('FeiCuiGongZhuJPPT_JP' . $curJID . 'Cnt') == 2 ) 
                                {
                                    $curJID = $gJackID + 1;
                                    if( $curJID == 1 ) 
                                    {
                                ...
                                $slotSettings->SetGameData('FeiCuiGongZhuJPPT_JP' . $curJID . 'Cnt', $slotSettings->GetGameData('FeiCuiGongZhuJPPT_JP' . $curJID . 'Cnt') + 1);
                                $jWin = 0;
                                if( $slotSettings->GetGameData('FeiCuiGongZhuJPPT_JP' . $curJID . 'Cnt') >= 3 ) 
                                {
                                    ...
                                    $slotSettings->SetGameData('FeiCuiGongZhuJPPTBonusStart', false);
                                ...
                                $rp = json_decode($slotSettings->GetGameData('FeiCuiGongZhuJPPTJackReport'));
                                $rp->serverResponse->jackpotSelected[0] = $slotSettings->GetGameData('FeiCuiGongZhuJPPT_JP1Cnt');
                                $rp->serverResponse->jackpotSelected[1] = $slotSettings->GetGameData('FeiCuiGongZhuJPPT_JP2Cnt');
                                $rp->serverResponse->jackpotSelected[2] = $slotSettings->GetGameData('FeiCuiGongZhuJPPT_JP3Cnt');
                                $rp->serverResponse->jackpotSelected[3] = $slotSettings->GetGameData('FeiCuiGongZhuJPPT_JP4Cnt');
                                $rp->serverResponse->jackpotReel = $reelPos[0];
                                $rp->serverResponse->BonusStart = $slotSettings->GetGameData('FeiCuiGongZhuJPPTBonusStart');
                                $rp_s = json_encode($rp);
                                $slotSettings->SetGameData('FeiCuiGongZhuJPPTJackReport', $rp_s);
                                if( $slotSettings->GetGameData('FeiCuiGongZhuJPPT_JP' . $curJID . 'Cnt') >= 3 ) 
                                {
                        ...
                        {
                            $result_tmp = [];
                            if( $slotSettings->GetGameData('FeiCuiGongZhuJPPTBonusStep') == 0 ) 
                            {
                                $WinArr = [
                                    25, 
                                    22, 
                                ...
                                shuffle($WinArr);
                                $slotSettings->SetGameData('FeiCuiGongZhuJPPTBonusOpt', $WinArr);
                                $curWin = $WinArr[$postData['index']];
                                if( $curWin > 0 ) 
                                {
                                    $slotSettings->SetGameData('FeiCuiGongZhuJPPTFreeGames', $slotSettings->GetGameData('FeiCuiGongZhuJPPTFreeGames') + $curWin);
                                }
                                else
                                {
                                    $slotSettings->SetGameData('FeiCuiGongZhuJPPTFreeMpl', $slotSettings->GetGameData('FeiCuiGongZhuJPPTFreeMpl') + ($curWin * -1));
                                }
                                $result_tmp[] = '3:::{"data":{"pick":' . $postData['index'] . ',"values":[' . $curWin . '],"windowId":"h72Yp3"},"ID":49022,"umid":448}';
                                $slotSettings->SetGameData('FeiCuiGongZhuJPPTBonusStep', 1);
                            }
                            else if( $slotSettings->GetGameData('FeiCuiGongZhuJPPTBonusStep') == 1 ) 
                            {
                                $WinArr = $slotSettings->GetGameData('FeiCuiGongZhuJPPTBonusOpt');
                                $curWin = $WinArr[$postData['index']];
                                if( $curWin > 10 ) 
                                {
                                    $slotSettings->SetGameData('FeiCuiGongZhuJPPTFreeGames', $slotSettings->GetGameData('FeiCuiGongZhuJPPTFreeGames') + $curWin);
                                ...
                                $slotSettings->SetGameData('FeiCuiGongZhuJPPTBonusStep', 2);
                            }
                            $umid = 0;
                        }
                        if( isset($postData['spinType']) ) 
                        {
                            ...
                            if( $postData['spinType'] == 'regular' ) 
                            {
                                ...
                                $bonusMpl = 1;
                                $slotSettings->SetGameData('FeiCuiGongZhuJPPT_JP1Cnt', 0);
                                $slotSettings->SetGameData('FeiCuiGongZhuJPPT_JP2Cnt', 0);
                                $slotSettings->SetGameData('FeiCuiGongZhuJPPT_JP3Cnt', 0);
                                $slotSettings->SetGameData('FeiCuiGongZhuJPPT_JP4Cnt', 0);
                                $slotSettings->SetGameData('FeiCuiGongZhuJPPTBonusWin', 0);
                                $slotSettings->SetGameData('FeiCuiGongZhuJPPTFreeGames', 0);
                                $slotSettings->SetGameData('FeiCuiGongZhuJPPTCurrentFreeGame', 0);
                                $slotSettings->SetGameData('FeiCuiGongZhuJPPTTotalWin', 0);
                                $slotSettings->SetGameData('FeiCuiGongZhuJPPTFreeBalance', 0);
                                $slotSettings->SetGameData('FeiCuiGongZhuJPPTFreeStartWin', 0);
                                $slotSettings->SetGameData('FeiCuiGongZhuJPPTFreeMpl', $slotSettings->slotFreeMpl);
                            }
                            else if( $postData['spinType'] == 'free' ) 
                            {
                                $umid = '0';
                                $postData['slotEvent'] = 'freespin';
                                $slotSettings->SetGameData('FeiCuiGongZhuJPPTCurrentFreeGame', $slotSettings->GetGameData('FeiCuiGongZhuJPPTCurrentFreeGame') + 1);
                                $bonusMpl = $slotSettings->GetGameData('FeiCuiGongZhuJPPTFreeMpl');
                            }
                            $linesId = [];
                            $linesId[0] = [
                                2, 
                            ...
                            if( $postData['slotEvent'] != 'freespin' ) 
                            {
                                ...
                                $slotSettings->SetGameData('FeiCuiGongZhuJPPTAllBet', $postData['bet']);
                                $slotSettings->SetGameData('FeiCuiGongZhuJPPTBetLine', $betLine);
                            }
                            else
                            {
                                    ...
                                    for( $j = 0; $j < count($slotSettings->SymbolGame); $j++ ) 
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            if( $s[0] == $csym || in_array($s[0], $wild) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":1,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('FeiCuiGongZhuJPPTBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":["none","none"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":2,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('FeiCuiGongZhuJPPTBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":3,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('FeiCuiGongZhuJPPTBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) && ($s[3] == $csym || in_array($s[3], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":4,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('FeiCuiGongZhuJPPTBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) && ($s[3] == $csym || in_array($s[3], $wild)) && ($s[4] == $csym || in_array($s[4], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":5,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('FeiCuiGongZhuJPPTBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":[' . ($linesId[$k][4] - 1) . ',"' . $s[4] . '"]}';
                                                }
                                            }
                                        }
                                    }
                            ...
                            if( $scattersCount >= 3 ) 
                            {
                                $slotSettings->SetGameData('FeiCuiGongZhuJPPTBonusStep', 0);
                                if( $slotSettings->GetGameData('FeiCuiGongZhuJPPTFreeGames') > 0 ) 
                                {
                                    $slotSettings->SetGameData('FeiCuiGongZhuJPPTFreeGames', $slotSettings->GetGameData('FeiCuiGongZhuJPPTFreeGames') + 10);
                                }
                                else
                                {
                                    $slotSettings->SetGameData('FeiCuiGongZhuJPPTIncreaseMpl', 0);
                                    $slotSettings->SetGameData('FeiCuiGongZhuJPPTFreeStartWin', $totalWin);
                                    $slotSettings->SetGameData('FeiCuiGongZhuJPPTBonusWin', 0);
                                    $slotSettings->SetGameData('FeiCuiGongZhuJPPTFreeGames', $slotSettings->slotFreeCount);
                                }
                            }
                            $reportWin = $totalWin;
                            if( $postData['slotEvent'] == 'freespin' ) 
                            {
                                $slotSettings->SetGameData('FeiCuiGongZhuJPPTBonusWin', $slotSettings->GetGameData('FeiCuiGongZhuJPPTBonusWin') + $totalWin);
                                $slotSettings->SetGameData('FeiCuiGongZhuJPPTTotalWin', $totalWin);
                            }
                            else
                            {
                                $slotSettings->SetGameData('FeiCuiGongZhuJPPTTotalWin', $totalWin);
                            ...
                            if( $winType == 'bonus' ) 
                            {
                                ...
                                $slotSettings->SetGameData('FeiCuiGongZhuJPPTBonusStart', true);
                            ...
                            if( $prizeBonusStart ) 
                            {
                                ...
                                $slotSettings->SetGameData('FeiCuiGongZhuJPPTWinValues', $prizeResult['curValues']);
                                $slotSettings->SetGameData('FeiCuiGongZhuJPPTPickedCount', 0);
                                $slotSettings->SetGameData('FeiCuiGongZhuJPPTPickedCountArr', []);
                                $slotSettings->SetGameData('FeiCuiGongZhuJPPTprizeBonusNum', $prizeBonusNum);
                            }
                            $response = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{' . $bStr . '"BonusStart":' . json_encode($slotSettings->GetGameData('FeiCuiGongZhuJPPTBonusStart')) . ',"JackWinID":' . $slotSettings->GetGameData($slotSettings->slotId . 'JackWinID') . ',"jackpotReel":0,"jackpotSelected":[' . implode(',', $jackpotSelected) . '],"linesArr":[' . implode(',', $postData['lines']) . '],"slotLines":' . $lines . ',"slotBet":' . $betLine . ',"totalFreeGames":' . $slotSettings->GetGameData('FeiCuiGongZhuJPPTFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('FeiCuiGongZhuJPPTCurrentFreeGame') . ',"Balance":' . $slotSettings->GetBalance() . ',"afterBalance":' . $slotSettings->GetBalance() . ',"bonusWin":' . $slotSettings->GetGameData('FeiCuiGongZhuJPPTBonusWin') . ',"FreeMpl":' . $slotSettings->GetGameData('FeiCuiGongZhuJPPTFreeMpl') . ',"freeStartWin":' . $slotSettings->GetGameData('FeiCuiGongZhuJPPTFreeStartWin') . ',"totalWin":' . $totalWin . ',"winLines":[' . $winString . '],"bonusInfo":' . $scattersStr . ',"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
                            $slotSettings->SetGameData('FeiCuiGongZhuJPPTLastResponse', $response);
                            $slotSettings->SetGameData('FeiCuiGongZhuJPPTJackReport', $response);
                        ...
                        {
                            case '40145':
                                if( $postData['pickIndex'] >= 0 && $slotSettings->GetGameData('FeiCuiGongZhuJPPTPickedCount') < $slotSettings->GetGameData('FeiCuiGongZhuJPPTprizeBonusNum') ) 
                                {
                                    $lr = json_decode($slotSettings->GetGameData('FeiCuiGongZhuJPPTLastResponse'));
                                    $values = $slotSettings->GetGameData('FeiCuiGongZhuJPPTWinValues');
                                    $pick = $slotSettings->GetGameData('FeiCuiGongZhuJPPTPickedCount');
                                    $pickArr = $slotSettings->GetGameData('FeiCuiGongZhuJPPTPickedCountArr');
                                    $reportWin = $values[$pick] * $slotSettings->GetGameData('FeiCuiGongZhuJPPTBetLine');
                                    $slotSettings->SetBalance($reportWin);
                                    $pick++;
                                    $pickArr[] = $postData['pickIndex'];
                                    $slotSettings->SetGameData('FeiCuiGongZhuJPPTPickedCount', $pick);
                                    $slotSettings->SetGameData('FeiCuiGongZhuJPPTPickedCountArr', $pickArr);
                                    ...
                                    $slotSettings->SetGameData('FeiCuiGongZhuJPPTLastResponse', json_encode($lr));
                                }
                            ...
                            case '40066':
                                ...
                                if( $lastEvent != 'NULL' ) 
                                {
                                    $slotSettings->SetGameData('FeiCuiGongZhuJPPT_JP1Cnt', $lastEvent->serverResponse->jackpotSelected[0]);
                                    $slotSettings->SetGameData('FeiCuiGongZhuJPPT_JP2Cnt', $lastEvent->serverResponse->jackpotSelected[1]);
                                    $slotSettings->SetGameData('FeiCuiGongZhuJPPT_JP3Cnt', $lastEvent->serverResponse->jackpotSelected[2]);
                                    $slotSettings->SetGameData('FeiCuiGongZhuJPPT_JP4Cnt', $lastEvent->serverResponse->jackpotSelected[3]);
                                    $slotSettings->SetGameData('FeiCuiGongZhuJPPT_JPReel', $lastEvent->serverResponse->jackpotReel);
                                    ...
                                    if( $lastEvent->responseType == 'jackpot' && $lastEvent->serverResponse->jackpotSelected[0] < 3 && $lastEvent->serverResponse->jackpotSelected[1] < 3 && $lastEvent->serverResponse->jackpotSelected[2] < 3 && $lastEvent->serverResponse->jackpotSelected[3] < 3 ) 
                                    {
                                        ...
                                        $slotSettings->SetGameData('FeiCuiGongZhuJPPTJackReport', json_encode($lastEvent));
                                    }
                                }
                            ...
                            case '40030':
                                ...
                                if( $slotSettings->GetGameData($slotSettings->slotId . 'brokenGames') != '' ) 
                                {
                                    ...
                                    if( $lastEvent != 'NULL' ) 
                                    {
                                        ...
                                        $slotSettings->SetGameData('FeiCuiGongZhuJPPT_JP4Cnt', $lastEvent->serverResponse->jackpotSelected[3]);
                                        $slotSettings->SetGameData('FeiCuiGongZhuJPPT_JPReel', $lastEvent->serverResponse->jackpotReel);
                                        $slotSettings->SetGameData('FeiCuiGongZhuJPPTBonusStart', $lastEvent->serverResponse->BonusStart);
                                        $slotSettings->SetGameData($slotSettings->slotId . 'BonusWin', $lastEvent->serverResponse->bonusWin);
                                        $slotSettings->SetGameData($slotSettings->slotId . 'FreeStartWin', $lastEvent->serverResponse->freeStartWin);
                                        $slotSettings->SetGameData($slotSettings->slotId . 'FreeGames', $lastEvent->serverResponse->totalFreeGames);
                                        $slotSettings->SetGameData($slotSettings->slotId . 'CurrentFreeGame', $lastEvent->serverResponse->currentFreeGames);
