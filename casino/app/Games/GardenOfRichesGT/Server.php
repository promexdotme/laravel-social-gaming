                ...
                \DB::transaction(function() use ($request, $game)
                {
                    try
                    {
                        ...
                        if( $postData['slotEvent'] == 'getSettings' ) 
                        {
                            ...
                            if( $lastEvent != 'NULL' ) 
                            {
                                ...
                                for( $r = 1; $r <= 5; $r++ ) 
                                {
                                    for( $p = 0; $p <= 2; $p++ ) 
                                    {
                                        $slotSettings->SetGameData($slotSettings->slotId . 'FreeStacked.' . $scWilds, $scWildsArr[$scWilds]);
                                        $scWilds++;
                                    }
                                }
                            }
                        ...
                        else if( $postData['slotEvent'] == 'gamble5GetUserCards' ) 
                        {
                            ...
                            $dealerCard = $slotSettings->GetGameData('GardenOfRichesGTDealerCard');
                            $totalWin = $slotSettings->GetGameData('GardenOfRichesGTTotalWin');
                            $gambleWin = 0;
                            ...
                            $slotSettings->SetGameData('GardenOfRichesGTTotalWin', $totalWin);
                        ...
                        else if( $postData['slotEvent'] == 'gamble5GetDealerCard' ) 
                        {
                            ...
                            $slotSettings->SetGameData('GardenOfRichesGTDealerCard', $tmpDc);
                        ...
                        else if( $postData['slotEvent'] == 'bet' || $postData['slotEvent'] == 'freespin' ) 
                        {
                            ...
                            if( $postData['slotEvent'] != 'freespin' ) 
                            {
                                ...
                                $bonusMpl = 1;
                                $slotSettings->SetGameData('GardenOfRichesGTBonusWin', 0);
                                $slotSettings->SetGameData('GardenOfRichesGTFreeGames', 0);
                                $slotSettings->SetGameData('GardenOfRichesGTCurrentFreeGame', 0);
                                $slotSettings->SetGameData('GardenOfRichesGTTotalWin', 0);
                                $slotSettings->SetGameData('GardenOfRichesGTFreeBalance', 0);
                                $slotSettings->SetGameData('GardenOfRichesGTFreeStacked', [
                                    'false', 
                                    'false', 
                                    'false', 
                                    'false', 
                                ...
                                for( $r = 1; $r <= 5; $r++ ) 
                                {
                                    for( $p = 0; $p <= 2; $p++ ) 
                                    {
                                        $slotSettings->SetGameData($slotSettings->slotId . 'FreeStacked.' . $scWilds, 'false');
                                        $scWilds++;
                                    }
                                }
                            ...
                            else
                            {
                                ...
                                $slotSettings->SetGameData('GardenOfRichesGTCurrentFreeGame', $slotSettings->GetGameData('GardenOfRichesGTCurrentFreeGame') + 1);
                                $bonusMpl = $slotSettings->slotFreeMpl;
                                if( $slotSettings->GetGameData('GardenOfRichesGTCurrentFreeGame') == $slotSettings->GetGameData('GardenOfRichesGTFreeGames') ) 
                                {
                            ...
                            for( $i = 0; $i <= 2000; $i++ ) 
                            {
                                ...
                                if( $postData['slotEvent'] == 'freespin' ) 
                                {
                                    ...
                                    for( $ii = 1; $ii <= 5; $ii++ ) 
                                    {
                                        if( $slotSettings->GetGameData('GardenOfRichesGTFreeStacked.' . $stackCount) == 'true' ) 
                                        {
                                    ...
                                    for( $j = 0; $j < count($slotSettings->SymbolGame); $j++ ) 
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            if( $s[0] == $csym || in_array($s[0], $wild) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":1,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('GardenOfRichesGTBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":["none","none"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":2,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('GardenOfRichesGTBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            $s[0] = $reels['reel1'][$linesId[$k][0] - 1];
                                            $s[1] = $reels['reel2'][$linesId[$k][1] - 1];
                                            ...
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":3,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('GardenOfRichesGTBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            $s[0] = $reels['reel1'][$linesId[$k][0] - 1];
                                            $s[1] = $reels['reel2'][$linesId[$k][1] - 1];
                                            ...
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) && ($s[3] == $csym || in_array($s[3], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":4,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('GardenOfRichesGTBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            $s[0] = $reels['reel1'][$linesId[$k][0] - 1];
                                            $s[1] = $reels['reel2'][$linesId[$k][1] - 1];
                                            ...
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) && ($s[3] == $csym || in_array($s[3], $wild)) && ($s[4] == $csym || in_array($s[4], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":5,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('GardenOfRichesGTBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":[' . ($linesId[$k][4] - 1) . ',"' . $s[4] . '"]}';
                                                }
                                                if( $isSlotJack ) 
                                                {
                                                    $tmpStringWin = '';
                            ...
                            if( $postData['slotEvent'] == 'freespin' && $slotSettings->GetGameData('GardenOfRichesGTFreeGames') <= $slotSettings->GetGameData('GardenOfRichesGTCurrentFreeGame') && $winType != 'bonus' && $slotSettings->GetGameData('GardenOfRichesGTTotalWin') + $totalWin > 0 ) 
                            {
                                $slotSettings->SetBalance($slotSettings->GetGameData('GardenOfRichesGTTotalWin') + $totalWin);
                            }
                            ...
                            if( $postData['slotEvent'] == 'freespin' ) 
                            {
                                $slotSettings->SetGameData('GardenOfRichesGTBonusWin', $slotSettings->GetGameData('GardenOfRichesGTBonusWin') + $totalWin);
                                $slotSettings->SetGameData('GardenOfRichesGTTotalWin', $slotSettings->GetGameData('GardenOfRichesGTTotalWin') + $totalWin);
                                $totalWin = $slotSettings->GetGameData('GardenOfRichesGTBonusWin');
                                $Balance = $slotSettings->GetGameData('GardenOfRichesGTFreeBalance');
                                $stackCount = 1;
                                for( $i = 1; $i <= 5; $i++ ) 
                                {
                                    if( $reels['reel' . $i][0] == 'SCAT' ) 
                                    {
                                        $slotSettings->SetGameData('GardenOfRichesGTFreeStacked.' . $stackCount, 'true');
                                    }
                                    $stackCount++;
                            ...
                            if( $scattersCount >= 3 ) 
                            {
                                if( $slotSettings->GetGameData('GardenOfRichesGTFreeGames') > 0 ) 
                                {
                                    $slotSettings->SetGameData('GardenOfRichesGTFreeBalance', $Balance);
                                    $slotSettings->SetGameData('GardenOfRichesGTBonusWin', $totalWin);
                                    $slotSettings->SetGameData('GardenOfRichesGTFreeGames', $slotSettings->GetGameData('GardenOfRichesGTFreeGames') + $slotSettings->slotFreeCount);
                                }
                                else
                                {
                                    $slotSettings->SetGameData('GardenOfRichesGTFreeBalance', $Balance);
                                    $slotSettings->SetGameData('GardenOfRichesGTBonusWin', $totalWin);
                                    $slotSettings->SetGameData('GardenOfRichesGTFreeGames', $slotSettings->slotFreeCount);
                                    $stackCount = 1;
                                    for( $i = 1; $i <= 5; $i++ ) 
                                    {
                                        if( $reels['reel' . $i][0] == 'SCAT' ) 
                            ...
                            $response = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{"curSeq":' . json_encode($curSeq) . ',"slotLines":' . $postData['slotLines'] . ',"slotBet":' . $postData['slotBet'] . ',"slotJackpot":' . $slotSettings->slotJackpot[0] . ',"stackedWilds":[' . implode(',', $slotSettings->GetGameData('GardenOfRichesGTFreeStacked')) . '],"totalFreeGames":' . $slotSettings->GetGameData('GardenOfRichesGTFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('GardenOfRichesGTCurrentFreeGame') . ',"Balance":' . $Balance . ',"afterBalance":' . $slotSettings->GetBalance() . ',"totalWin":' . $totalWin . ',"winLines":[' . $winString . '],"bonusInfo":' . $scattersStr . ',"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
                            $response_log = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{"curSeq":' . json_encode($curSeq) . ',"slotLines":' . $postData['slotLines'] . ',"slotBet":' . $postData['slotBet'] . ',"slotJackpot":' . $slotSettings->slotJackpot[0] . ',"stackedWilds":[' . implode(',', $slotSettings->GetGameData('GardenOfRichesGTFreeStacked')) . '],"totalFreeGames":' . $slotSettings->GetGameData('GardenOfRichesGTFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('GardenOfRichesGTCurrentFreeGame') . ',"Balance":' . $Balance . ',"afterBalance":' . $slotSettings->GetBalance() . ',"totalWin":' . $totalWin . ',"winLines":[' . $winString . '],"bonusInfo":' . $scattersStr . ',"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
