                    ...
                    try
                    {
                        ...
                        if( $postData['slotEvent'] == 'gameInit' ) 
                        {
                            ...
                            if( $lastEvent != 'NULL' ) 
                            {
                                ...
                                $hWilds = $slotSettings->GetGameData('PelicanPeteATholdWildsStr');
                                if( !is_array($hWilds) ) 
                                {
                                    $hWilds = [];
                                }
                        ...
                        else if( $postData['slotEvent'] == 'bet' || $postData['slotEvent'] == 'freespin' ) 
                        {
                            ...
                            for( $i = 0; $i <= 2000; $i++ ) 
                            {
                                ...
                                if( $postData['slotEvent'] == 'freespin' ) 
                                {
                                    $hWilds = $slotSettings->GetGameData('PelicanPeteATholdWildsArr');
                                    if( !is_array($hWilds) ) 
                                    {
                                        $hWilds = [];
                                    }
                            ...
                            if( $postData['slotEvent'] == 'freespin' ) 
                            {
                                $slotSettings->SetGameData('PelicanPeteATholdWildsArr', $holdWildsArr);
                                $slotSettings->SetGameData('PelicanPeteATholdWildsStr', $holdWildsStr);
                                ...
                                $freeStateStr = '"id":"54594109_20200214110301","current":' . $slotSettings->GetGameData('PelicanPeteATCurrentFreeGame') . ',"multiplayer":' . $slotSettings->GetGameData('PelicanPeteATMpl') . ',"add":0,"total":' . $slotSettings->GetGameData('PelicanPeteATFreeGames') . ',"totalWin":' . ($slotSettings->GetGameData('PelicanPeteATBonusWin') * 100) . ',"wilds":[' . implode(',', $holdWildsStr) . ']';
                            }
                            else
                            {
                                $slotSettings->SetGameData('PelicanPeteATTotalWin', $totalWin);
                            ...
                            if( $scattersCount >= 3 ) 
                            {
                                if( $slotSettings->GetGameData('PelicanPeteATFreeGames') > 0 ) 
                                {
                                    ...
                                    $freeStateStr = '"id":"54594109_20200214110301","current":' . $slotSettings->GetGameData('PelicanPeteATCurrentFreeGame') . ',"multiplayer":' . $slotSettings->GetGameData('PelicanPeteATMpl') . ',"add":' . $slotSettings->slotFreeCount . ',"total":' . $slotSettings->GetGameData('PelicanPeteATFreeGames') . ',"totalWin":' . ($slotSettings->GetGameData('PelicanPeteATBonusWin') * 100) . ',"wilds":[' . implode(',', $holdWildsStr) . ']';
                                }
                                else
                                {
                            ...
                            $response_log = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{"curSeq":' . json_encode($curSeq) . ',"slotLines":' . $postData['slotLines'] . ',"slotBet":' . $postData['slotBet'] . ',"totalFreeGames":' . $slotSettings->GetGameData('PelicanPeteATFreeGames') . ',"Mpl":' . $slotSettings->GetGameData('PelicanPeteATMpl') . ',"currentFreeGames":' . $slotSettings->GetGameData('PelicanPeteATCurrentFreeGame') . ',"Balance":' . $Balance . ',"afterBalance":' . $slotSettings->GetBalance() . ',"totalWin":' . $totalWin . ',"winLines":[' . $winString . '],"bonusInfo":{},"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
                            $reelStrArr = [];
                            for( $i = 1; $i <= 5; $i++ ) 
                            {
