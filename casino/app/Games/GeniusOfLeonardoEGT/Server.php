            ...
            function get_($request, $game)
            {
                \DB::transaction(function() use ($request, $game)
                {
                    try
                    {
                        ...
                        {
                            case 'choice':
                                $bet = $slotSettings->GetGameData('GeniusOfLeonardoEGTBonusBet');
                                $bank = $slotSettings->GetBank('bonus');
                                $ChoiceArr = $slotSettings->GetGameData('GeniusOfLeonardoEGTChoiceArr');
                                $fs = $slotSettings->GetGameData('GeniusOfLeonardoEGTFreeGames');
                                $fw = $slotSettings->GetGameData('GeniusOfLeonardoEGTMultiplier');
                                $fc = $slotSettings->GetGameData('GeniusOfLeonardoEGTBonusCredits');
                                ...
                                for( $i = 0; $i <= 1000; $i++ ) 
                                {
                                    $cfr_cur = rand(1, 10);
                                    $curWin = $cfr_cur * $bet;
                                    if( $i >= 1000 || $slotSettings->GetGameData('GeniusOfLeonardoEGTBonusStart') != 1 ) 
                                    {
                                        exit();
                                    }
                                    if( $curWin <= $bank ) 
                                ...
                                $cfr0_cur = rand(1, 3);
                                $pl_cur = 'false';
                                if( rand(3, 9) <= count($ChoiceArr) && $slotSettings->GetGameData('GeniusOfLeonardoEGTFreeGames') > 0 ) 
                                {
                                    $isEnd = true;
                                    $pl_cur = 'true';
                                }
                                ...
                                if( $isEnd ) 
                                {
                                    ...
                                    for( $i = 0; $i < 18; $i++ ) 
                                    {
                                        ...
                                        {
                                            $opt[$i] = '{"pos":' . $i . ',"credits":0,"currentCredits":' . $cfr . ',"stopKey":' . $pl[rand(0, 1)] . '}';
                                        }
                                    }
                                    $closed = implode(',', $opt);
                                }
                                ...
                                {
                                    $reportWin = $fc * $bet;
                                    $response = '{"responseEvent":"spin","responseType":"freespin","serverResponse":{"slotLines":30' . $slotSettings->GetGameData($slotSettings->slotId . 'FirstSpin') . ',"slotBet":' . ($bet / 30) . ',"totalFreeGames":' . $slotSettings->GetGameData('GeniusOfLeonardoEGTFreeGames') . ',"Multiplier":' . $slotSettings->GetGameData('GeniusOfLeonardoEGTMultiplier') . ',"currentFreeGames":' . $slotSettings->GetGameData('GeniusOfLeonardoEGTCurrentFreeGame') . ',"Balance":' . $balanceInCents . ',"afterBalance":' . $balanceInCents . ',"bonusWin":' . $slotSettings->GetGameData('GeniusOfLeonardoEGTBonusWin') . ',"totalWin":' . $reportWin . ',"winLines":[]}}';
                                    $slotSettings->SaveLogReport($response, $bet, 30, $reportWin, 'freespin');
                                }
                                $slotSettings->SetGameData('GeniusOfLeonardoEGTChoiceArr', $ChoiceArr);
                                $slotSettings->SetGameData('GeniusOfLeonardoEGTFreeGames', $fss);
                                $slotSettings->SetGameData('GeniusOfLeonardoEGTBonusCredits', $fc);
                                $slotSettings->SetGameData($slotSettings->slotId . 'BonusWin', $slotSettings->GetGameData($slotSettings->slotId . 'BonusWin') + $curWin);
                                $result_tmp[] = '{"complex":{"pos":' . $choice . ',"credits":' . $fc . ',"currentCredits":' . $cfr_cur . ',"freespins":' . $slotSettings->GetGameData('GeniusOfLeonardoEGTFreeGames') . ',"totalBet":' . ($bet * 100) . ',"play":' . $pl_cur . ',"closed":[' . $closed . '],"gameCommand":"choice"},"state":"' . $state . '","winAmount":' . ($slotSettings->GetGameData($slotSettings->slotId . 'BonusWin') * 100) . ',"gameIdentificationNumber":' . $postData['gameIdentificationNumber'] . ',"gameNumber":1787203010852,"sessionKey":"5af6a26c031aa4ec491159428c5a7742","msg":"success","messageId":"' . $postData['messageId'] . '","qName":"app.services.messages.response.GameEventResponse","command":"bet","eventTimestamp":1566584969191}';
                                break;
                            case 'login':
                            ...
                            case 'settings':
                                ...
                                $result_tmp[] = '{"complex":{"balance":' . $balanceInCents . ',"balanceRaw":' . round($balanceInCents * $slotSettings->CurrentDenom) . ',"paytableCoef":{"0":{"coef":[5,20,100],"multiplier":2},"1":{"coef":[5,20,100],"multiplier":2},"2":{"coef":[5,20,100],"multiplier":2},"3":{"coef":[10,40,200],"multiplier":2},"4":{"coef":[10,40,200],"multiplier":2},"5":{"coef":[20,100,400],"multiplier":2},"6":{"coef":[20,100,400],"multiplier":2},"7":{"coef":[30,150,600],"multiplier":2},"8":{"coef":[30,150,600],"multiplier":2},"9":{"coef":[50,250,800],"multiplier":2},"10":{"coef":[100,500,1000],"multiplier":1},"11":{"coef":[0],"multiplier":1}},"bets":[' . implode(',', $gameBets) . '],"jackpotMinBet":1,"jackpot":true,"mainFakeReels":[[8,1,4,0,5,2,6,1,9,7,3,8,1,4,2,10,5,6,0,2],[2,8,0,6,1,5,9,11,4,3,5,10,2,3,5,7,0,8,3,6],[4,0,2,1,9,3,7,4,8,1,10,3,2,0,1,3,6,11,6,2],[3,6,1,5,3,9,1,7,0,5,2,11,7,1,4,11,2,3,4,10],[6,1,7,3,5,0,2,4,8,1,5,10,2,4,9,7,5,0,3,4]],"jackpotMaxBet":100000,"denominations":[' . implode(',', $denoms) . ']},"gameIdentificationNumber":' . $postData['gameIdentificationNumber'] . ',"gameNumber":-1,"sessionKey":"41be9e65e0ff03a65e8c93576bf61130","msg":"success","messageId":"' . $postData['messageId'] . '","qName":"app.services.messages.response.GameResponse","command":"settings","eventTimestamp":' . time() . '}';
                                break;
                            case 'subscribe':
                                $hist = [
                                    78, 
                                ...
                                shuffle($hist);
                                $slotSettings->SetGameData('GeniusOfLeonardoEGTCards', $hist);
                                $lastEvent = $slotSettings->GetHistory();
                                $slotSettings->SetGameData('GeniusOfLeonardoEGTBonusWin', 0);
                                $slotSettings->SetGameData('GeniusOfLeonardoEGTFreeGames', 0);
                                $slotSettings->SetGameData('GeniusOfLeonardoEGTCurrentFreeGame', 0);
                                $slotSettings->SetGameData('GeniusOfLeonardoEGTTotalWin', 0);
                                $slotSettings->SetGameData('GeniusOfLeonardoEGTFreeBalance', 0);
                                $slotSettings->SetGameData('GeniusOfLeonardoEGTMultiplier', 1);
                                if( $lastEvent != 'NULL' ) 
                                {
                                    ...
                                    if( isset($lastEvent->serverResponse->reelsSymbols) ) 
                                    {
                                    ...
                                    $gtype = 1;
                                    if( $slotSettings->GetGameData('GeniusOfLeonardoEGTCurrentFreeGame') < $slotSettings->GetGameData('GeniusOfLeonardoEGTFreeGames') && $slotSettings->GetGameData('GeniusOfLeonardoEGTFreeGames') > 0 ) 
                                    {
                                        $gtype = 2;
                                    }
                                }
                            ...
                            case 'bet':
                                ...
                                if( $postData['slotEvent'] != 'freespin' ) 
                                {
                                    ...
                                    $slotSettings->SetGameData('GeniusOfLeonardoEGTFreeGames', 0);
                                    $slotSettings->SetGameData('GeniusOfLeonardoEGTCurrentFreeGame', 0);
                                    $slotSettings->SetGameData('GeniusOfLeonardoEGTBonusBet', $allbet);
                                    $slotSettings->SetGameData('GeniusOfLeonardoEGTTotalWin', 0);
                                    $slotSettings->SetGameData('GeniusOfLeonardoEGTMultiplier', 1);
                                    $slotSettings->SetGameData('GeniusOfLeonardoEGTFreeBalance', sprintf('%01.2f', $slotSettings->GetBalance()) * 100);
                                    $bonusMpl = 1;
                                }
                                else
                                {
                                    $slotSettings->SetGameData('GeniusOfLeonardoEGTCurrentFreeGame', $slotSettings->GetGameData('GeniusOfLeonardoEGTCurrentFreeGame') + 1);
                                ...
                                for( $i = 0; $i <= 2000; $i++ ) 
                                {
                                    ...
                                    {
                                        $isWildRow = false;
                                        if( $reels['reel' . $r][0] == '10' ) 
                                        {
                                            $wPos[] = '' . ($r - 1) . ',1';
                                            $wPos[] = '' . ($r - 1) . ',2';
                                            $isWildRow = true;
                                        }
                                        if( $reels['reel' . $r][1] == '10' ) 
                                        {
                                            $wPos[] = '' . ($r - 1) . ',0';
                                            $wPos[] = '' . ($r - 1) . ',2';
                                            $isWildRow = true;
                                        }
                                        if( $reels['reel' . $r][2] == '10' ) 
                                        {
                                            $wPos[] = '' . ($r - 1) . ',1';
                                            $wPos[] = '' . ($r - 1) . ',0';
                                            $isWildRow = true;
                                ...
                                if( $postData['slotEvent'] == 'freespin' ) 
                                {
                                    $slotSettings->SetGameData('GeniusOfLeonardoEGTBonusWin', $slotSettings->GetGameData('GeniusOfLeonardoEGTBonusWin') + $totalWin);
                                    $slotSettings->SetGameData('GeniusOfLeonardoEGTTotalWin', $slotSettings->GetGameData('GeniusOfLeonardoEGTTotalWin') + $totalWin);
                                    $balanceInCents = $slotSettings->GetGameData('GeniusOfLeonardoEGTFreeBalance');
                                }
                                else
                                {
                                    $slotSettings->SetGameData('GeniusOfLeonardoEGTTotalWin', $totalWin);
                                }
                                $fs = 0;
                                if( $scattersCount >= 3 ) 
                                {
                                    $slotSettings->SetGameData('GeniusOfLeonardoEGTChoiceArr', []);
                                    if( $slotSettings->GetGameData('GeniusOfLeonardoEGTFreeGames') > 0 ) 
                                    {
                                        $slotSettings->SetGameData('GeniusOfLeonardoEGTFreeGames', $slotSettings->GetGameData('GeniusOfLeonardoEGTFreeGames') + 1);
                                    }
                                    else
                                    {
                                        $slotSettings->SetGameData('GeniusOfLeonardoEGTFreeStartWin', $totalWin);
                                        $slotSettings->SetGameData('GeniusOfLeonardoEGTBonusWin', $totalWin);
                                        $slotSettings->SetGameData('GeniusOfLeonardoEGTFreeGames', $slotSettings->slotFreeCount);
                                    }
                                    $fs = $slotSettings->GetGameData('GeniusOfLeonardoEGTFreeGames');
                                }
                                $curReels = '' . rand(0, 6) . ',' . $reels['reel1'][0] . ',' . $reels['reel1'][1] . ',' . $reels['reel1'][2] . ',' . rand(0, 6);
                                ...
                                $response = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{"slotLines":' . $lines . '' . $slotSettings->GetGameData($slotSettings->slotId . 'FirstSpin') . ',"slotBet":' . $betline . ',"totalFreeGames":' . $slotSettings->GetGameData('GeniusOfLeonardoEGTFreeGames') . ',"Multiplier":' . $slotSettings->GetGameData('GeniusOfLeonardoEGTMultiplier') . ',"currentFreeGames":' . $slotSettings->GetGameData('GeniusOfLeonardoEGTCurrentFreeGame') . ',"Balance":' . $balanceInCents . ',"afterBalance":' . $balanceInCents . ',"bonusWin":' . $slotSettings->GetGameData('GeniusOfLeonardoEGTBonusWin') . ',"totalWin":' . $totalWin . ',"winLines":[' . $winString . '],"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
                                $slotSettings->SaveLogReport($response, $allbet, $lines, $reportWin, $postData['slotEvent']);
                                $winstring = '';
                                $slotSettings->SetGameData('GeniusOfLeonardoEGTGambleStep', 5);
                                $hist = $slotSettings->GetGameData('GeniusOfLeonardoEGTCards');
                                if( $jackRandom == 1 ) 
                                {
                                    $state = 'jackpot';
                                    $isJack = 'true';
                                    $slotSettings->SetGameData('GeniusOfLeonardoEGTJackSteps', [
                                        0, 
                                        0, 
                                        0, 
                                        0
                                ...
                                if( $postData['slotEvent'] == 'freespin' ) 
                                {
                                    $totalWin = $slotSettings->GetGameData('GeniusOfLeonardoEGTBonusWin');
                                    $state = 'freespin';
                                ...
                                {
                                    $state = 'choice';
                                    $slotSettings->SetGameData('GeniusOfLeonardoEGTBonusStart', 1);
                                    $slotSettings->SetGameData('GeniusOfLeonardoEGTBonusCredits', 0);
                                ...
                                {
                                    $state = 'freespin';
                                    $sgwin = $slotSettings->GetGameData('GeniusOfLeonardoEGTFreeGames');
                                    $fs = $sgwin;
                                }
                                $result_tmp[] = '{"complex":{"gambles":5,"reels":[' . $curReels . '],"lines":[' . $winString . ']' . $bstate . ',"scatters":[' . $scattersStr . '],"freespinScatters":[' . $scatter . '],"expand":[' . implode(',', $wPos) . '],"specialExpand":[],"gambles":5,"freespins":' . $fs . ',"jackpot":' . $isJack . ',"gameCommand":"bet"},"state":"' . $state . '","winAmount":' . ($totalWin * 100) . ',"gameIdentificationNumber":' . $postData['gameIdentificationNumber'] . ',"gameNumber":"","balance":' . $balanceInCents . ',"sessionKey":"41be9e65e0ff03a65e8c93576bf61130","msg":"success","messageId":"' . $postData['messageId'] . '","qName":"app.services.messages.response.GameEventResponse","command":"bet","eventTimestamp":' . time() . '}';
                                ...
                                break;
                            case 'collect':
                                $result_tmp[] = '{"complex":{"gameCommand":"collect"},"state":"idle","winAmount":' . ($slotSettings->GetGameData('GeniusOfLeonardoEGTTotalWin') * 100) . ',"gameIdentificationNumber":' . $postData['gameIdentificationNumber'] . ',"gameNumber":"","balance":' . $balanceInCents . ',"sessionKey":"41be9e65e0ff03a65e8c93576bf61130","msg":"success","messageId":"' . $postData['messageId'] . '","qName":"app.services.messages.response.GameEventResponse","command":"bet","eventTimestamp":' . time() . '}';
                                $slotSettings->SetGameData('GeniusOfLeonardoEGTTotalWin', 0);
                                break;
                            case 'jackpot':
                                $jackStep = $slotSettings->GetGameData('GeniusOfLeonardoEGTJackSteps');
                                $jackWinID = $slotSettings->GetGameData($slotSettings->slotId . 'JackWinID');
                                if( $jackStep[0] >= 3 || $jackStep[1] >= 3 || $jackStep[2] >= 3 || $jackStep[3] >= 3 || !$slotSettings->HasGameData('GeniusOfLeonardoEGTJackSteps') ) 
                                {
                                    exit();
                                }
                                $winAmount = 0;
                                ...
                                $slotSettings->SetGameData('GeniusOfLeonardoEGTJackSteps', $jackStep);
                                break;
                            case 'gamble':
                                $Balance = $slotSettings->GetBalance();
                                $isGambleWin = rand(1, $slotSettings->GetGambleSettings());
                                $dealerCard = '';
                                $totalWin = $slotSettings->GetGameData('GeniusOfLeonardoEGTTotalWin');
                                $gambleWin = 0;
                                $statBet = $totalWin;
                                $slotSettings->SetGameData('GeniusOfLeonardoEGTGambleStep', $slotSettings->GetGameData('GeniusOfLeonardoEGTGambleStep') - 1);
                                ...
                                else
                                {
                                    ...
                                    $totalWin = 0;
                                    $slotSettings->SetGameData('GeniusOfLeonardoEGTGambleStep', 0);
                                    if( $postData['bet']['color'] == '1' ) 
                                    {
                                        $tmpCards = [
                                            '1', 
                                ...
                                $gtype = 1;
                                $gtype0 = 1;
                                if( $slotSettings->GetGameData('GeniusOfLeonardoEGTBonusStart') == 1 ) 
                                {
                                    $gtype0 = 2;
                                }
                                $result_tmp[] = '{"complex":{"gambles":' . $slotSettings->GetGameData('GeniusOfLeonardoEGTGambleStep') . ',"card":' . $dealerCard . ',"jackpot":false,"gameCommand":"gamble"},"state":"' . $gambleState . '","winAmount":' . ($totalWin * 100) . ',"gameIdentificationNumber":' . $postData['gameIdentificationNumber'] . ',"gameNumber":"","sessionKey":"88e2b82e6537db4a339e4e1b5ce462cd","msg":"success","messageId":"' . $postData['messageId'] . '","qName":"app.services.messages.response.GameEventResponse","command":"bet","eventTimestamp":' . time() . '}';
                                break;
                        }
