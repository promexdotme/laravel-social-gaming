                    ...
                    try
                    {
                        ...
                        switch( $aid ) 
                        {
                            ...
                            case 'spin':
                                ...
                                {
                                    $slotSettings->slotFreeMpl = rand(3, 5);
                                    $mainLoopLimit = $slotSettings->GetGameData($slotSettings->slotId . 'FreeGames');
                                    $response = "d=2 6\r\n3 0 0 0 " . $mainLoopLimit . ' ' . $slotSettings->slotFreeMpl . "\r\n";
                                }
                                else
                                {
                                    $response = '';
                                ...
                                for( $mainLoop = 0; $mainLoop < $mainLoopLimit; $mainLoop++ ) 
                                {
                                    ...
                                    if( $scattersCount >= 2 ) 
                                    {
                                        ...
                                        $slotSettings->SetGameData($slotSettings->slotId . 'FreeGames', $slotSettings->slotFreeCount[rand(0, 5)]);
                                    ...
                                    $response_log = '{"responseEvent":"spin","$i":' . $i . ',"$winType":"' . $winType . '","responseType":"' . $postData['slotEvent'] . '","serverResponse":{"freeState":"' . $freeState . '","slotLines":' . $lines . ',"slotBet":' . $betline . ',"totalFreeGames":' . $slotSettings->GetGameData($slotSettings->slotId . 'FreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData($slotSettings->slotId . 'CurrentFreeGame') . ',"Balance":' . $balanceInCents . ',"afterBalance":' . $balanceInCents . ',"bonusWin":' . $slotSettings->GetGameData($slotSettings->slotId . 'BonusWin') . ',"totalWin":' . $totalWin . ',"winLines":[],"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
                                    ...
                                    if( $postData['slotEvent'] == 'freespin' ) 
                                    {
                                        ...
                                        $response .= ('1 10 1 ' . ($betline * 100) . ' ' . implode(' ', $resultReels) . ' ' . $fStart . ' ' . count($lineWins) . ' ' . $winString . ' 0');
                                        $response .= ("\r\n3 0 " . round($slotSettings->GetGameData($slotSettings->slotId . 'BonusWin') / $betline) . ' ' . ($slotSettings->GetGameData($slotSettings->slotId . 'BonusWin') * 100) . ' ' . $fsLeft . ' ' . $slotSettings->slotFreeMpl . "\r\n");
                                    }
                                    else if( $totalWin > 0 ) 
                                    {
                                        $response .= ('d=1 10 1 ' . ($betline * 100) . ' ' . implode(' ', $resultReels) . ' ' . $fStart . ' ' . count($lineWins) . ' ' . $winString . ' 0');
                                        if( $scattersCount >= 2 ) 
                                        {
                                    ...
                                    {
                                        $response .= ('d=1 10 1 ' . ($betline * 100) . ' ' . implode(' ', $resultReels) . ' ' . $fStart . " 0 0\r\n");
                                        if( $scattersCount >= 2 ) 
                                        {
