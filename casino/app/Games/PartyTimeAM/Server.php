                    ...
                    switch( $gameData['slotEvent'] ) 
                    {
                        ...
                        case 'A/u25':
                            ...
                            if( $lastEvent != 'NULL' ) 
                            {
                                ...
                                $slotSettings->SetGameData('PartyTimeAMLines', $curLines);
                                $freeMpl = '11';
                                $slotSettings->SetGameData('PartyTimeAMBonusWin', $lastEvent->serverResponse->bonusWin);
                                $slotSettings->SetGameData('PartyTimeAMFreeGames', $lastEvent->serverResponse->totalFreeGames);
                                $slotSettings->SetGameData('PartyTimeAMCurrentFreeGame', $lastEvent->serverResponse->currentFreeGames);
                                $slotSettings->SetGameData('PartyTimeAMTotalWin', 0);
                                $slotSettings->SetGameData('PartyTimeAMFreeBalance', 0);
                                $slotSettings->SetGameData('PartyTimeAMFreeStartWin', 0);
                                $tFree = dechex($slotSettings->GetGameData('PartyTimeAMFreeGames'));
                                $cFree = dechex($slotSettings->GetGameData('PartyTimeAMFreeGames') - $slotSettings->GetGameData('PartyTimeAMCurrentFreeGame'));
                                $freeInfo = strlen($tFree) . $tFree . strlen($cFree) . $cFree;
                                $stateWin = $slotSettings->HexFormat($slotSettings->GetGameData('PartyTimeAMBonusWin') * $floatBet);
                                if( $slotSettings->GetGameData('PartyTimeAMCurrentFreeGame') < $slotSettings->GetGameData('PartyTimeAMFreeGames') && $slotSettings->GetGameData('PartyTimeAMFreeGames') > 0 ) 
                                {
                                    $slotState = '6';
                            ...
                            {
                                $slotSettings->SetGameData('PartyTimeAMLines', $fixedLinesFormated);
                                $slotState = '4';
                            ...
                            break;
                        case 'A/u250':
                            $fixedLinesFormated = $slotSettings->GetGameData('PartyTimeAMLines');
                            $balanceFormated = $slotSettings->HexFormat(round($slotSettings->GetBalance() * $floatBet));
                            $lastEvent = $slotSettings->GetHistory();
                            if( $lastEvent != 'NULL' ) 
                            {
                        ...
                        case 'A/u251':
                            if( $postData['spinType'] == 'regular' && $slotSettings->GetGameData($slotSettings->slotId . 'FreeGames') <= $slotSettings->GetGameData($slotSettings->slotId . 'CurrentFreeGame') ) 
                            {
                                ...
                                $bonusMpl = 1;
                                $slotSettings->SetGameData('PartyTimeAMBonusWin', 0);
                                $slotSettings->SetGameData('PartyTimeAMFreeGames', 0);
                                $slotSettings->SetGameData('PartyTimeAMCurrentFreeGame', 0);
                                $slotSettings->SetGameData('PartyTimeAMTotalWin', 0);
                                $slotSettings->SetGameData('PartyTimeAMFreeBalance', 0);
                                $slotSettings->SetGameData('PartyTimeAMFreeStartWin', 0);
                            }
                            if( $slotSettings->GetGameData($slotSettings->slotId . 'CurrentFreeGame') < $slotSettings->GetGameData($slotSettings->slotId . 'FreeGames') ) 
                            {
                                ...
                                $slotSettings->SetGameData('PartyTimeAMCurrentFreeGame', $slotSettings->GetGameData('PartyTimeAMCurrentFreeGame') + 1);
                            ...
                            if( $postData['slotEvent'] == 'freespin' && $slotSettings->GetGameData('PartyTimeAMFreeGames') <= $slotSettings->GetGameData('PartyTimeAMCurrentFreeGame') && $winType != 'bonus' && $slotSettings->GetGameData('PartyTimeAMBonusWin') + $totalWin > 0 ) 
                            {
                                $slotSettings->SetBalance($slotSettings->GetGameData('PartyTimeAMBonusWin') + $totalWin);
                            }
                            ...
                            if( $postData['slotEvent'] == 'freespin' ) 
                            {
                                $slotSettings->SetGameData('PartyTimeAMBonusWin', $slotSettings->GetGameData('PartyTimeAMBonusWin') + $totalWin);
                                $slotSettings->SetGameData('PartyTimeAMTotalWin', $totalWin);
                            }
                            else
                            {
                                $slotSettings->SetGameData('PartyTimeAMTotalWin', $totalWin);
                            ...
                            if( $scattersCount >= 3 ) 
                            {
                                ...
                                if( $slotSettings->GetGameData('PartyTimeAMFreeGames') > 0 ) 
                                {
                                    $slotSettings->SetGameData('PartyTimeAMFreeGames', $slotSettings->GetGameData('PartyTimeAMFreeGames') + $slotSettings->slotFreeCount);
                                }
                                else
                                {
                                    $slotSettings->SetGameData('PartyTimeAMFreeStartWin', $totalWin);
                                    $slotSettings->SetGameData('PartyTimeAMBonusWin', $totalWin);
                                    $slotSettings->SetGameData('PartyTimeAMFreeGames', $slotSettings->slotFreeCount);
                                }
                            }
                            $jsSpin = '' . json_encode($reels) . '';
                            $jsJack = '' . json_encode($slotSettings->Jackpots) . '';
                            $winString = implode(',', $lineWins);
                            $response_log = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{"symDouble":' . $symDouble . ',"slotLines":' . $lines . ',"slotBet":' . $betCnt . ',"totalFreeGames":' . $slotSettings->GetGameData('PartyTimeAMFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('PartyTimeAMCurrentFreeGame') . ',"Balance":' . $slotSettings->GetBalance() . ',"afterBalance":' . $slotSettings->GetBalance() . ',"bonusWin":' . $slotSettings->GetGameData('PartyTimeAMBonusWin') . ',"freeStartWin":' . $slotSettings->GetGameData('PartyTimeAMFreeStartWin') . ',"totalWin":' . $totalWin . ',"winLines":[' . $winString . '],"bonusInfo":' . $scattersStr . ',"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
                            ...
                            if( $postData['slotEvent'] == 'freespin' ) 
                            {
                                ...
                                $cFree = dechex($slotSettings->GetGameData('PartyTimeAMFreeGames') - $slotSettings->GetGameData('PartyTimeAMCurrentFreeGame'));
                                $gameState = '06';
                                if( $slotSettings->GetGameData('PartyTimeAMFreeGames') <= $slotSettings->GetGameData('PartyTimeAMCurrentFreeGame') ) 
                                {
                                    $gameState = '0c';
                                }
                                if( $scattersCount >= 3 ) 
                                ...
                                $totalWin = $slotSettings->GetGameData('PartyTimeAMBonusWin');
                                $bonusMpl = $slotSettings->slotFreeMpl;
                            }
                            else
                            {
                            ...
                            $slotSettings->SetGameData('PartyTimeAMDoubleAnswer', $reelSate . $bet_h . $ln_h . $freeInfo . $freeWinState . $slotSettings->HexFormat($bonusMpl) . '1010' . $reelSate . '0' . $symCountAll . $winLinesFormated);
                            $slotSettings->SetGameData('PartyTimeAMDoubleBalance', $balanceFormated);
                            $slotSettings->SetGameData('PartyTimeAMDoubleWin', $totalWin);
                            if( $postData['slotEvent'] == 'freespin' ) 
                            {
                            ...
                            $slotSettings->SetGameData('PartyTimeAMCollectP0', $response_collect0);
                            $gameState = '04';
                            $balanceFormated = $slotSettings->HexFormat(round($slotSettings->GetBalance() * $floatBet));
                            ...
                            $slotSettings->SetGameData('PartyTimeAMCollect', $response_collect);
                            break;
                        case 'A/u254':
                            $slotSettings->SetGameData($slotSettings->slotId . 'TotalWin', 0);
                            $response = $slotSettings->GetGameData('PartyTimeAMCollect');
                            break;
                        case 'A/u257':
                            $doubleWin = rand(1, 2);
                            $winall = $slotSettings->GetGameData('PartyTimeAMDoubleWin');
                            $dbet = $winall;
                            $daction = $tmpPar[1];
                            ...
                            $response = '107010' . $slotSettings->GetGameData('PartyTimeAMDoubleBalance') . strlen($winall_h) . $winall_h . $slotSettings->GetGameData('PartyTimeAMDoubleAnswer') . implode('', $slotSettings->GetGameData($slotSettings->slotId . 'Cards'));
                            $slotSettings->SetGameData('PartyTimeAMDoubleWin', $winall);
                            $slotSettings->SetGameData('PartyTimeAMTotalWin', $winall);
                            $balanceFormated = $slotSettings->HexFormat(round($slotSettings->GetBalance() * $floatBet));
                            $response_collect = '104010' . $balanceFormated . strlen($winall_h) . $winall_h . $slotSettings->GetGameData('PartyTimeAMCollectP0');
                            $slotSettings->SetGameData('PartyTimeAMCollect', $response_collect);
                        ...
                        case 'A/u258':
                            ...
                            $slotSettings->SetGameData('PartyTimeAMDoubleBalance', $rtnBalance);
                            $winall = sprintf('%01.2f', $winall) * $floatBet;
                            $winall_h1 = str_replace('.', '', $winall . '');
                            $winall_h = dechex($winall_h1);
                            $doubleCards = '26280b2714161d0c';
                            $response = '108010' . $slotSettings->GetGameData('PartyTimeAMDoubleBalance') . strlen($winall_h) . $winall_h . $slotSettings->GetGameData('PartyTimeAMDoubleAnswer') . implode('', $slotSettings->GetGameData($slotSettings->slotId . 'Cards'));
                            break;
                    }
