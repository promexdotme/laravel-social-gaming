            ...
            function get_($request, $game)
            {
                \DB::transaction(function() use ($request, $game)
                {
                    try
                    {
                        ...
                        {
                            $result_tmp = [];
                            if( $slotSettings->GetGameData('GreatBluePTBonusStep') == 0 ) 
                            {
                                $WinArr = [
                                    2500, 
                                    2200, 
                                ...
                                shuffle($WinArr);
                                $slotSettings->SetGameData('GreatBluePTBonusOpt', $WinArr);
                                $curWin = $WinArr[$postData['index']];
                                if( $curWin > 10 ) 
                                {
                                    $slotSettings->SetGameData('GreatBluePTFreeGames', $slotSettings->GetGameData('GreatBluePTFreeGames') + ($curWin / 100));
                                }
                                else
                                {
                                    $slotSettings->SetGameData('GreatBluePTFreeMpl', $slotSettings->GetGameData('GreatBluePTFreeMpl') + $curWin);
                                }
                                $result_tmp[] = '3:::{"data":{"prizes":[' . $curWin . '],"windowId":"2Hjr3k"},"ID":40241,"umid":474}';
                                $slotSettings->SetGameData('GreatBluePTBonusStep', 1);
                            }
                            else if( $slotSettings->GetGameData('GreatBluePTBonusStep') == 1 ) 
                            {
                                $WinArr = $slotSettings->GetGameData('GreatBluePTBonusOpt');
                                $curWin = $WinArr[$postData['index']];
                                if( $curWin > 10 ) 
                                {
                                    $slotSettings->SetGameData('GreatBluePTFreeGames', $slotSettings->GetGameData('GreatBluePTFreeGames') + ($curWin / 100));
                                ...
                                $slotSettings->SetGameData('GreatBluePTBonusStep', 2);
                            }
                            $umid = 0;
                        }
                        if( isset($postData['spinType']) ) 
                        {
                            ...
                            if( $postData['spinType'] == 'regular' ) 
                            {
                                ...
                                $bonusMpl = 1;
                                $slotSettings->SetGameData('GreatBluePTBonusWin', 0);
                                $slotSettings->SetGameData('GreatBluePTFreeGames', 0);
                                $slotSettings->SetGameData('GreatBluePTCurrentFreeGame', 0);
                                $slotSettings->SetGameData('GreatBluePTTotalWin', 0);
                                $slotSettings->SetGameData('GreatBluePTFreeBalance', 0);
                                $slotSettings->SetGameData('GreatBluePTFreeStartWin', 0);
                                $slotSettings->SetGameData('GreatBluePTFreeMpl', $slotSettings->slotFreeMpl);
                            }
                            else if( $postData['spinType'] == 'free' ) 
                            {
                                $umid = '0';
                                $postData['slotEvent'] = 'freespin';
                                $slotSettings->SetGameData('GreatBluePTCurrentFreeGame', $slotSettings->GetGameData('GreatBluePTCurrentFreeGame') + 1);
                                $bonusMpl = $slotSettings->GetGameData('GreatBluePTFreeMpl');
                            }
                            $linesId = [];
                            $linesId[0] = [
                                2, 
                                    ...
                                    for( $j = 0; $j < count($slotSettings->SymbolGame); $j++ ) 
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            if( $s[0] == $csym || in_array($s[0], $wild) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":1,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('GreatBluePTBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":["none","none"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":2,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('GreatBluePTBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":3,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('GreatBluePTBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) && ($s[3] == $csym || in_array($s[3], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":4,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('GreatBluePTBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) && ($s[3] == $csym || in_array($s[3], $wild)) && ($s[4] == $csym || in_array($s[4], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":5,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('GreatBluePTBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":[' . ($linesId[$k][4] - 1) . ',"' . $s[4] . '"]}';
                                                }
                                            }
                                        }
                                    }
                            ...
                            if( $postData['slotEvent'] == 'freespin' ) 
                            {
                                $slotSettings->SetGameData('GreatBluePTBonusWin', $slotSettings->GetGameData('GreatBluePTBonusWin') + $totalWin);
                                $slotSettings->SetGameData('GreatBluePTTotalWin', $totalWin);
                            }
                            else
                            {
                                $slotSettings->SetGameData('GreatBluePTTotalWin', $totalWin);
                            ...
                            if( $scattersCount >= 3 ) 
                            {
                                if( $slotSettings->GetGameData('GreatBluePTFreeGames') > 0 ) 
                                {
                                    $slotSettings->SetGameData('GreatBluePTBonusWin', $totalWin);
                                    $slotSettings->SetGameData('GreatBluePTFreeGames', $slotSettings->GetGameData('GreatBluePTFreeGames') + $slotSettings->slotFreeCount);
                                }
                                else
                                {
                                    $slotSettings->SetGameData('GreatBluePTBonusStep', 0);
                                    $slotSettings->SetGameData('GreatBluePTFreeStartWin', $totalWin);
                                    $slotSettings->SetGameData('GreatBluePTBonusWin', $totalWin);
                                    $slotSettings->SetGameData('GreatBluePTFreeGames', $slotSettings->slotFreeCount);
                                }
                            }
                            $balanceInCents = sprintf('%01.2f', $slotSettings->GetBalance()) * 100;
                            ...
                            $response = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{"linesArr":[' . implode(',', $postData['lines']) . '],"slotLines":' . $lines . ',"slotBet":' . $betLine . ',"totalFreeGames":' . $slotSettings->GetGameData('GreatBluePTFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('GreatBluePTCurrentFreeGame') . ',"Balance":' . $slotSettings->GetBalance() . ',"afterBalance":' . $slotSettings->GetBalance() . ',"bonusWin":' . $slotSettings->GetGameData('GreatBluePTBonusWin') . ',"FreeMpl":' . $slotSettings->GetGameData('GreatBluePTFreeMpl') . ',"freeStartWin":' . $slotSettings->GetGameData('GreatBluePTFreeStartWin') . ',"totalWin":' . $totalWin . ',"winLines":[' . $winString . '],"bonusInfo":' . $scattersStr . ',"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
