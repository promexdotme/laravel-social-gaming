            ...
            function get_($request, $game)
            {
                \DB::transaction(function() use ($request, $game)
                {
                    try
                    {
                        ...
                        {
                            case 'create_session':
                                $slotSettings->SetGameData('BigJokerCTCards', [
                                    19, 
                                    44, 
                                    0, 
                                    37, 
                            ...
                            case 'init_game':
                                ...
                                $slotSettings->SetGameData('BigJokerCTBonusWin', 0);
                                $slotSettings->SetGameData('BigJokerCTFreeGames', 0);
                                $slotSettings->SetGameData('BigJokerCTCurrentFreeGame', 0);
                                $slotSettings->SetGameData('BigJokerCTCurrentFreeGame0', 0);
                                $slotSettings->SetGameData('BigJokerCTTotalWin', 0);
                                $slotSettings->SetGameData('BigJokerCTFreeBalance', 0);
                                ...
                                if( $lastEvent != 'NULL' ) 
                                {
                                    ...
                                    if( $slotSettings->GetGameData('BigJokerCTCurrentFreeGame') < $slotSettings->GetGameData('BigJokerCTFreeGames') && $slotSettings->GetGameData('BigJokerCTFreeGames') > 0 ) 
                                    {
                            ...
                            case 'poll':
                                ...
                                {
                                    $balanceInCents = sprintf('%01.2f', $slotSettings->GetBalance() - $slotSettings->GetGameData('BigJokerCTTotalWin')) * 100;
                                }
                            ...
                            case 'game_finished':
                                $slotSettings->SetGameData('BigJokerCTBonusWin', 0);
                                $slotSettings->SetGameData('BigJokerCTTotalWin', 0);
                                $responseData['game_finished'][0]['freeround_play'] = $slotSettings->GetGameData('BigJokerCTCurrentFreeGame0');
                            ...
                            case 'subgame_finished':
                                if( $slotSettings->GetGameData('BigJokerCTCurrentFreeGame0') < $slotSettings->GetGameData('BigJokerCTFreeGames') && $slotSettings->GetGameData('BigJokerCTFreeGames') > 0 ) 
                                {
                                    ...
                                    $response = '{"responseEvent":"spin","responseType":"freespin","serverResponse":{"result":' . json_encode($result) . ',"slotDenom":' . $slotSettings->GetGameData($slotSettings->slotId . 'Denom') . ',"slotLines":' . $lines . ',"slotBet":' . $betline . ',"totalFreeGames":' . $slotSettings->GetGameData('BigJokerCTFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('BigJokerCTCurrentFreeGame0') . ',"Balance":' . $slotSettings->GetGameData('BigJokerCTFreeBalance') . ',"afterBalance":' . $slotSettings->GetGameData('BigJokerCTFreeBalance') . ',"bonusWin":' . $slotSettings->GetGameData('BigJokerCTBonusWin') . ',"totalWin":' . $reportWin . ',"winLines":[],"Jackpots":[],"reelsSymbols":' . json_encode($slotSettings->GetGameData($slotSettings->slotId . 'Reels')) . '}}';
                                    if( $slotSettings->GetGameData('BigJokerCTFreeGames') <= $slotSettings->GetGameData('BigJokerCTCurrentFreeGame0') ) 
                                    {
                                        if( $reportWin > 0 ) 
                                        {
                                    ...
                                    $balanceInCents = $slotSettings->GetGameData('BigJokerCTFreeBalance');
                                    $responseData['subgame_finished'][0]['account_status']['credit'] = round($balanceInCents);
                                    $responseData['subgame_finished'][0]['freeround_play'] = $slotSettings->GetGameData('BigJokerCTCurrentFreeGame0');
                                    $responseData['subgame_finished'][1]['freeround_play'] = $slotSettings->GetGameData('BigJokerCTCurrentFreeGame0');
                            ...
                            case 'play':
                                ...
                                for( $spinLoop = 0; $spinLoop < $spinLoopLimit; $spinLoop++ ) 
                                {
                                    ...
                                    if( $postData['slotEvent'] != 'freespin' ) 
                                    {
                                        ...
                                        $slotSettings->SetGameData('BigJokerCTCurrentFreeGame0', 0);
                                        $slotSettings->SetGameData('BigJokerCTTotalWin', 0);
                                        $slotSettings->SetGameData('BigJokerCTFreeBalance', sprintf('%01.2f', $slotSettings->GetBalance()) * 100);
                                    ...
                                    {
                                        $slotSettings->SetGameData('BigJokerCTCurrentFreeGame', $slotSettings->GetGameData('BigJokerCTCurrentFreeGame') + 1);
                                    ...
                                    if( $postData['slotEvent'] == 'freespin' ) 
                                    {
                                        $slotSettings->SetGameData('BigJokerCTBonusWin', $slotSettings->GetGameData('BigJokerCTBonusWin') + $totalWin);
                                        $slotSettings->SetGameData('BigJokerCTTotalWin', $slotSettings->GetGameData('BigJokerCTTotalWin') + $totalWin);
                                        $balanceInCents = $slotSettings->GetGameData('BigJokerCTFreeBalance');
                                    }
                                    else
                                    {
                                        $slotSettings->SetGameData('BigJokerCTTotalWin', $totalWin);
                                    }
                                    $fs = 0;
                                    if( $scattersCount >= 3 ) 
                                    {
                                    ...
                                    $winstring = '';
                                    $slotSettings->SetGameData('BigJokerCTGambleStep', 5);
                                    $hist = $slotSettings->GetGameData('BigJokerCTCards');
                                    if( $postData['slotEvent'] == 'freespin' ) 
                                    {
                                        $state = 'freespin';
                                        ...
                                        if( $slotSettings->GetGameData($slotSettings->slotId . 'FreeGames') <= $slotSettings->GetGameData($slotSettings->slotId . 'CurrentFreeGame') && $slotSettings->GetGameData('BigJokerCTBonusWin') > 0 ) 
                                        {
                                            $responseData['play'][0]['result'][$spinLoop]['is_free'] = true;
                                    ...
                                    $responseData['play'][0]['result'][$spinLoop]['total_win'] = $slotSettings->GetGameData('BigJokerCTTotalWin') / $denom;
                                ...
                                $response = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{"result":' . json_encode($responseData['play'][0]['result']) . ',"slotDenom":' . $denom . ',"slotLines":' . $lines . ',"slotBet":' . $betline . ',"totalFreeGames":' . $slotSettings->GetGameData('BigJokerCTFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('BigJokerCTCurrentFreeGame0') . ',"Balance":' . $slotSettings->GetGameData($slotSettings->slotId . 'FreeBalance') . ',"afterBalance":' . $slotSettings->GetBalance() . ',"bonusWin":' . $slotSettings->GetGameData('BigJokerCTBonusWin') . ',"totalWin":' . $totalWin . ',"winLines":[],"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
                            ...
                            case 'gamble':
                                ...
                                $dealerCard = '';
                                $totalWin = $slotSettings->GetGameData('BigJokerCTTotalWin');
                                $gambleWin = 0;
                                $statBet = $totalWin;
                                ...
                                $hist = $slotSettings->GetGameData('BigJokerCTCards');
                                $slotSettings->SetGameData('BigJokerCTGambleStep', $slotSettings->GetGameData('BigJokerCTGambleStep') - 1);
                                if( $slotSettings->MaxWin < ($totalWin * $slotSettings->CurrentDenom) ) 
                                {
                                    $isGambleWin = 0;
                                }
                                ...
                                else
                                {
                                    ...
                                    $totalWin = 0;
                                    $slotSettings->SetGameData('BigJokerCTGambleStep', 0);
                                    if( $postData['continue_params']['double_key'] != 'red' && $postData['continue_params']['double_key'] != 'black' ) 
                                    {
                                        if( $postData['continue_params']['double_key'] == 'diamond' ) 
                                        {
                                ...
                                $slotSettings->SetGameData('BigJokerCTCards', $hist);
