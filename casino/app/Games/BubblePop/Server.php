...
namespace VanguardLTE\Games\BubblePop
{
    ...
    use VanguardLTE\Games\BubblePop\PragmaticLib\Collect;
    use VanguardLTE\Games\BubblePop\PragmaticLib\GameSettings;
    use VanguardLTE\Games\BubblePop\PragmaticLib\Loader;
    use VanguardLTE\Games\BubblePop\PragmaticLib\Log;
    use VanguardLTE\Games\BubblePop\PragmaticLib\Spin;
    use VanguardLTE\Games\BubblePop\PragmaticLib\DoMysteryScatter;
