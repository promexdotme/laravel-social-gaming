                ...
                \DB::transaction(function() use ($request, $game)
                {
                    try
                    {
                        ...
                        else if( $postData['slotEvent'] == 'gamble5GetUserCards' ) 
                        {
                            ...
                            $dealerCard = $slotSettings->GetGameData('AmazingFruitsGTMDealerCard');
                            $totalWin = $slotSettings->GetGameData('AmazingFruitsGTMTotalWin');
                            $gambleWin = 0;
                            ...
                            $slotSettings->SetGameData('AmazingFruitsGTMTotalWin', $totalWin);
                        ...
                        else if( $postData['slotEvent'] == 'gamble5GetDealerCard' ) 
                        {
                            ...
                            $slotSettings->SetGameData('AmazingFruitsGTMDealerCard', $tmpDc);
                        ...
                        else if( $postData['slotEvent'] == 'bet' || $postData['slotEvent'] == 'freespin' ) 
                        {
                            ...
                            if( $postData['slotEvent'] != 'freespin' ) 
                            {
                                ...
                                $bonusMpl = 1;
                                $slotSettings->SetGameData('AmazingFruitsGTMBonusWin', 0);
                                $slotSettings->SetGameData('AmazingFruitsGTMFreeGames', 0);
                                $slotSettings->SetGameData('AmazingFruitsGTMCurrentFreeGame', 0);
                                $slotSettings->SetGameData('AmazingFruitsGTMTotalWin', 0);
                                $slotSettings->SetGameData('AmazingFruitsGTMFreeBalance', 0);
                                for( $i = 0; $i < 22; $i++ ) 
                                {
                                    $slotSettings->SetGameData('AmazingFruitsGTMFreeStacked.' . $i, 'false');
                                }
                            }
                            else
                            {
                                $slotSettings->SetGameData('AmazingFruitsGTMCurrentFreeGame', $slotSettings->GetGameData('AmazingFruitsGTMCurrentFreeGame') + 1);
                                $bonusMpl = $slotSettings->slotFreeMpl;
                                if( $slotSettings->GetGameData('AmazingFruitsGTMFreeGames') == $slotSettings->GetGameData('AmazingFruitsGTMCurrentFreeGame') ) 
                                {
                            ...
                            for( $i = 0; $i <= 2000; $i++ ) 
                            {
                                ...
                                if( $postData['slotEvent'] == 'freespin' ) 
                                {
                                    ...
                                    for( $ii = 1; $ii <= 5; $ii++ ) 
                                    {
                                        if( $slotSettings->GetGameData('AmazingFruitsGTMFreeStacked.' . $stackCount) == 'true' ) 
                                        {
                                    ...
                                    for( $j = 0; $j < count($slotSettings->SymbolGame); $j++ ) 
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            if( $s[0] == $csym || in_array($s[0], $wild) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":1,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('AmazingFruitsGTMBonusWin')) . ',"winReel1":[' . ($linesId[$k + 1][0] - 1) . ',"' . $s[0] . '"],"winReel2":["none","none"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":2,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('AmazingFruitsGTMBonusWin')) . ',"winReel1":[' . ($linesId[$k + 1][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k + 1][1] - 1) . ',"' . $s[1] . '"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            $s[0] = $reels['reel1'][$linesId[$k + 1][0] - 1];
                                            $s[1] = $reels['reel2'][$linesId[$k + 1][1] - 1];
                                            ...
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":3,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('AmazingFruitsGTMBonusWin')) . ',"winReel1":[' . ($linesId[$k + 1][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k + 1][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k + 1][2] - 1) . ',"' . $s[2] . '"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            $s[0] = $reels['reel1'][$linesId[$k + 1][0] - 1];
                                            $s[1] = $reels['reel2'][$linesId[$k + 1][1] - 1];
                                            ...
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) && ($s[3] == $csym || in_array($s[3], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":4,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('AmazingFruitsGTMBonusWin')) . ',"winReel1":[' . ($linesId[$k + 1][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k + 1][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k + 1][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k + 1][3] - 1) . ',"' . $s[3] . '"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            $s[0] = $reels['reel1'][$linesId[$k + 1][0] - 1];
                                            $s[1] = $reels['reel2'][$linesId[$k + 1][1] - 1];
                                            ...
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) && ($s[3] == $csym || in_array($s[3], $wild)) && ($s[4] == $csym || in_array($s[4], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":5,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('AmazingFruitsGTMBonusWin')) . ',"winReel1":[' . ($linesId[$k + 1][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k + 1][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k + 1][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k + 1][3] - 1) . ',"' . $s[3] . '"],"winReel5":[' . ($linesId[$k + 1][4] - 1) . ',"' . $s[4] . '"]}';
                                                }
                                                if( $isSlotJack ) 
                                                {
                                                    $tmpStringWin = '';
                                ...
                                if( $slotSettings->GetGameData('AmazingFruitsGTMFreeGames') <= $slotSettings->GetGameData('AmazingFruitsGTMCurrentFreeGame') && $postData['slotEvent'] == 'freespin' ) 
                                {
                                    $winType = 'win';
                            ...
                            if( $postData['slotEvent'] == 'freespin' && $slotSettings->GetGameData('AmazingFruitsGTMFreeGames') <= $slotSettings->GetGameData('AmazingFruitsGTMCurrentFreeGame') && $winType != 'bonus' && $slotSettings->GetGameData('AmazingFruitsGTMTotalWin') + $totalWin > 0 ) 
                            {
                                $slotSettings->SetBalance($slotSettings->GetGameData('AmazingFruitsGTMTotalWin') + $totalWin);
                            }
                            ...
                            if( $postData['slotEvent'] == 'freespin' ) 
                            {
                                $slotSettings->SetGameData('AmazingFruitsGTMBonusWin', $slotSettings->GetGameData('AmazingFruitsGTMBonusWin') + $totalWin);
                                $slotSettings->SetGameData('AmazingFruitsGTMTotalWin', $slotSettings->GetGameData('AmazingFruitsGTMTotalWin') + $totalWin);
                                $totalWin = $slotSettings->GetGameData('AmazingFruitsGTMBonusWin');
                                $Balance = $slotSettings->GetGameData('AmazingFruitsGTMFreeBalance');
                                $stackCount = 1;
                                for( $i = 1; $i <= 5; $i++ ) 
                                {
                                    if( $reels['reel' . $i][0] == 'SCAT' ) 
                                    {
                                        $slotSettings->SetGameData('AmazingFruitsGTMFreeStacked.' . $stackCount, 'true');
                                    }
                                    $stackCount++;
                            ...
                            {
                                if( $slotSettings->GetGameData('AmazingFruitsGTMFreeGames') > 0 ) 
                                {
                                    $slotSettings->SetGameData('AmazingFruitsGTMFreeBalance', $Balance);
                                    $slotSettings->SetGameData('AmazingFruitsGTMBonusWin', $totalWin);
                                    $slotSettings->SetGameData('AmazingFruitsGTMFreeGames', $slotSettings->GetGameData('AmazingFruitsGTMFreeGames') + $slotSettings->slotFreeCount);
                                }
                                else
                                {
                                    $slotSettings->SetGameData('AmazingFruitsGTMFreeBalance', $Balance);
                                    $slotSettings->SetGameData('AmazingFruitsGTMBonusWin', $totalWin);
                                    $slotSettings->SetGameData('AmazingFruitsGTMFreeGames', $slotSettings->slotFreeCount);
                                    $stackCount = 1;
                                    for( $i = 1; $i <= 5; $i++ ) 
                                    {
                                        if( $reels['reel' . $i][0] == 'SCAT' ) 
                            ...
                            $AmazingFruitsGTMFreeStacked = [];
                            for( $i = 0; $i < 22; $i++ ) 
                            {
                                if( $slotSettings->HasGameData('AmazingFruitsGTMFreeStacked.' . $i) ) 
                                {
                                    $AmazingFruitsGTMFreeStacked[] = $slotSettings->GetGameData('AmazingFruitsGTMFreeStacked.' . $i);
                                }
                            }
                            $response = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{"slotLines":' . $postData['slotLines'] . ',"slotBet":' . $postData['slotBet'] . ',"stackedWilds":[' . implode(',', $AmazingFruitsGTMFreeStacked) . '],"slotJackpot":' . json_encode($slotSettings->slotJackpot) . ',"totalFreeGames":' . $slotSettings->GetGameData('AmazingFruitsGTMFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('AmazingFruitsGTMCurrentFreeGame') . ',"Balance":' . $Balance . ',"afterBalance":' . $slotSettings->GetBalance() . ',"totalWin":' . $totalWin . ',"winLines":[' . $winString . '],"bonusInfo":' . $scattersStr . ',"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
