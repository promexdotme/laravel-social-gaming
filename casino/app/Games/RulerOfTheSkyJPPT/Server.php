                    ...
                    try
                    {
                        ...
                        if( isset($postData['spinType']) ) 
                        {
                            ...
                            if( $postData['spinType'] == 'regular' ) 
                            {
                                ...
                                $bonusMpl = 1;
                                $slotSettings->SetGameData('RulerOfTheSkyJPPTBonusWin', 0);
                                $slotSettings->SetGameData('RulerOfTheSkyJPPTFreeGames', 0);
                                $slotSettings->SetGameData('RulerOfTheSkyJPPTCurrentFreeGame', 0);
                                $slotSettings->SetGameData('RulerOfTheSkyJPPTTotalWin', 0);
                                $slotSettings->SetGameData('RulerOfTheSkyJPPTFreeBalance', 0);
                                $slotSettings->SetGameData('RulerOfTheSkyJPPTFreeStartWin', 0);
                                $slotSettings->SetGameData('RulerOfTheSkyJPPTFreeMpl', $slotSettings->slotFreeMpl);
                                $slotSettings->SetGameData('RulerOfTheSkyJPPTIncreaseMpl', 0);
                            }
                            else if( $postData['spinType'] == 'free' ) 
                            {
                                $umid = '0';
                                $postData['slotEvent'] = 'freespin';
                                $slotSettings->SetGameData('RulerOfTheSkyJPPTCurrentFreeGame', $slotSettings->GetGameData('RulerOfTheSkyJPPTCurrentFreeGame') + 1);
                                $bonusMpl = 1;
                            }
                            $linesId = [];
                            $linesId[0] = [
                                    ...
                                    for( $j = 0; $j < count($slotSettings->SymbolGame); $j++ ) 
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            if( $s[0] == $csym || in_array($s[0], $wild) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":1,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('RulerOfTheSkyJPPTBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":["none","none"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":2,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('RulerOfTheSkyJPPTBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":3,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('RulerOfTheSkyJPPTBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) && ($s[3] == $csym || in_array($s[3], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":4,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('RulerOfTheSkyJPPTBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) && ($s[3] == $csym || in_array($s[3], $wild)) && ($s[4] == $csym || in_array($s[4], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":5,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('RulerOfTheSkyJPPTBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":[' . ($linesId[$k][4] - 1) . ',"' . $s[4] . '"]}';
                                                }
                                            }
                                        }
                                    }
                            ...
                            if( $postData['slotEvent'] == 'freespin' ) 
                            {
                                $slotSettings->SetGameData('RulerOfTheSkyJPPTBonusWin', $slotSettings->GetGameData('RulerOfTheSkyJPPTBonusWin') + $totalWin);
                                $slotSettings->SetGameData('RulerOfTheSkyJPPTTotalWin', $totalWin);
                            }
                            else
                            {
                                $slotSettings->SetGameData('RulerOfTheSkyJPPTTotalWin', $totalWin);
                            }
                            $slotSettings->SetGameData('RulerOfTheSkyJPPTBonusStart', false);
                            if( $scattersCount >= 3 ) 
                            {
                                $slotSettings->SetGameData('RulerOfTheSkyJPPTBonusStart', true);
                                $slotSettings->SetGameData('RulerOfTheSkyJPPTBonusStep', 0);
                                if( $slotSettings->GetGameData('RulerOfTheSkyJPPTFreeGames') > 0 ) 
                                {
                                    $slotSettings->SetGameData('RulerOfTheSkyJPPTFreeGames', $slotSettings->GetGameData('RulerOfTheSkyJPPTFreeGames') + 15);
                                }
                                else
                                {
                                    $slotSettings->SetGameData('RulerOfTheSkyJPPTIncreaseMpl', 0);
                                    $slotSettings->SetGameData('RulerOfTheSkyJPPTFreeStartWin', $totalWin);
                                    $slotSettings->SetGameData('RulerOfTheSkyJPPTBonusWin', 0);
                                    $slotSettings->SetGameData('RulerOfTheSkyJPPTFreeGames', $slotSettings->slotFreeCount);
                                }
                            }
                            $balanceInCents = sprintf('%01.2f', $slotSettings->GetBalance()) * 100;
                            $spinState = 'REGULAR';
                            ...
                            $isBonus = 'false';
                            if( $slotSettings->GetGameData('RulerOfTheSkyJPPTBonusStart') ) 
                            {
                                $isBonus = 'true';
                            }
                            ...
                            $response = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{"IncreaseMpl":' . $slotSettings->GetGameData('RulerOfTheSkyJPPTIncreaseMpl') . ',"linesArr":[' . implode(',', $postData['lines']) . '],"slotLines":' . $lines . ',"slotBet":' . $betLine . ',"totalFreeGames":' . $slotSettings->GetGameData('RulerOfTheSkyJPPTFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('RulerOfTheSkyJPPTCurrentFreeGame') . ',"Balance":' . $slotSettings->GetBalance() . ',"afterBalance":' . $slotSettings->GetBalance() . ',"bonusWin":' . $slotSettings->GetGameData('RulerOfTheSkyJPPTBonusWin') . ',"FreeMpl":' . $slotSettings->GetGameData('RulerOfTheSkyJPPTFreeMpl') . ',"freeStartWin":' . $slotSettings->GetGameData('RulerOfTheSkyJPPTFreeStartWin') . ',"totalWin":' . $totalWin . ',"winLines":[' . $winString . '],"bonusInfo":' . $scattersStr . ',"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
