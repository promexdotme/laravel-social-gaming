            ...
            function get_($request, $game)
            {
                \DB::transaction(function() use ($request, $game)
                {
                    try
                    {
                        ...
                        {
                            $slotSettings->SetGameData('QueenofWandsBonusWin', 0);
                            $slotSettings->SetGameData('QueenofWandsFreeGames', 0);
                            $slotSettings->SetGameData('QueenofWandsCurrentFreeGame', 0);
                            $slotSettings->SetGameData('QueenofWandsTotalWin', 0);
                            $slotSettings->SetGameData('QueenofWandsStartBonusWin', 0);
                            $slotSettings->SetGameData('QueenofWandsFreeBalance', 0);
                        ...
                        else if( $postData['slotEvent'] == 'gamble5GetUserCards' ) 
                        {
                            ...
                            $dealerCard = $slotSettings->GetGameData('QueenofWandsDealerCard');
                            $totalWin = $slotSettings->GetGameData('QueenofWandsTotalWin');
                            $gambleWin = 0;
                            ...
                            $slotSettings->SetGameData('QueenofWandsTotalWin', $totalWin);
                        ...
                        else if( $postData['slotEvent'] == 'gamble5GetDealerCard' ) 
                        {
                            ...
                            $slotSettings->SetGameData('QueenofWandsDealerCard', $tmpDc);
                        ...
                        else if( $postData['slotEvent'] == 'spin' || $postData['slotEvent'] == 'freespin' ) 
                        {
                            ...
                            if( $slotSettings->GetGameData('QueenofWandsCurrentFreeGame') <= $slotSettings->GetGameData('QueenofWandsFreeGames') && $slotSettings->GetGameData('QueenofWandsFreeGames') > 0 ) 
                            {
                                $postData['slotEvent'] = 'freespin';
                            }
                            ...
                            {
                                $slotSettings->SetGameData('QueenofWandsCurrentFreeGame', $slotSettings->GetGameData('QueenofWandsCurrentFreeGame') + 1);
                            ...
                            if( $postData['slotEvent'] == 'freespin' ) 
                            {
                                $slotSettings->SetGameData('QueenofWandsBonusWin', $slotSettings->GetGameData('QueenofWandsBonusWin') + $totalWin);
                                $Balance = $slotSettings->GetGameData('QueenofWandsFreeBalance');
                                $spinState = '"currentScene":"freeSpins","multiplier":1,"freeSpinsCount":' . ($slotSettings->GetGameData('QueenofWandsFreeGames') - $slotSettings->GetGameData('QueenofWandsCurrentFreeGame')) . ',"freeSpinsWin":' . $slotSettings->GetGameData('QueenofWandsBonusWin') . ',"initialFreeSpinWin":' . $slotSettings->GetGameData('QueenofWandsStartBonusWin') . ',"initialFreeSpinsCount":' . $slotSettings->slotFreeCount . ',"totalFreeSpinsCount":' . $slotSettings->GetGameData('QueenofWandsFreeGames');
                                $spinEvent = '';
                                $roundEnded = 'false';
                                $curScene = 'freeSpins';
                                $reelSet = 'freeSpins';
                            ...
                            if( $scattersCount >= 3 ) 
                            {
                                ...
                                $slotSettings->SetGameData('QueenofWandsStartBonusInfo', ',"reels":{"view":[' . $rpTmp . '],"positions":[' . implode(',', $reels['rp']) . ']}');
                                if( $slotSettings->GetGameData('QueenofWandsFreeGames') > 0 ) 
                                {
                                    $slotSettings->SetGameData('QueenofWandsFreeBalance', $Balance);
                                    $slotSettings->SetGameData('QueenofWandsFreeGames', $slotSettings->GetGameData('QueenofWandsFreeGames') + $slotSettings->slotFreeCount);
                                }
                                else
                                {
                                    $slotSettings->SetGameData('QueenofWandsFreeBalance', $Balance);
                                    $slotSettings->SetGameData('QueenofWandsStartBonusWin', $totalWin);
                                    $slotSettings->SetGameData('QueenofWandsBonusWin', 0);
                                    $slotSettings->SetGameData('QueenofWandsFreeGames', $slotSettings->slotFreeCount);
                                }
                            ...
                            if( $slotSettings->GetGameData('QueenofWandsFreeGames') <= $slotSettings->GetGameData('QueenofWandsCurrentFreeGame') && $slotSettings->GetGameData('QueenofWandsCurrentFreeGame') > 0 ) 
                            {
                                $spinState = '"currentScene":"main","multiplier":1,"freeSpinsWin":' . $slotSettings->GetGameData('QueenofWandsBonusWin') . ',"freeSpinsCount":0,"initialFreeSpinWin":' . $slotSettings->GetGameData('QueenofWandsStartBonusWin') . ',"initialFreeSpinsCount":' . $slotSettings->slotFreeCount . ',"totalFreeSpinsCount":' . $slotSettings->GetGameData('QueenofWandsFreeGames');
