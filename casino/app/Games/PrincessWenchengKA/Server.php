                        ...
                        switch( $aid ) 
                        {
                            ...
                            case 'spin':
                                ...
                                for( $i = 0; $i <= 2000; $i++ ) 
                                {
                                    ...
                                    if( $reels['reel2'][0] == '0' || $reels['reel2'][1] == '0' || $reels['reel2'][2] == '0' || $reels['reel2'][3] == '0' ) 
                                    {
                                        $reels['reel2'][0] = '0';
                                        $reels['reel2'][1] = '0';
                                        $reels['reel2'][2] = '0';
                                    ...
                                    if( $reels['reel3'][0] == '0' || $reels['reel3'][1] == '0' || $reels['reel3'][2] == '0' || $reels['reel3'][3] == '0' ) 
                                    {
                                        $reels['reel3'][0] = '0';
                                        $reels['reel3'][1] = '0';
                                        $reels['reel3'][2] = '0';
                                    ...
                                    if( $reels['reel4'][0] == '0' || $reels['reel4'][1] == '0' || $reels['reel4'][2] == '0' || $reels['reel4'][3] == '0' ) 
                                    {
                                        $reels['reel4'][0] = '0';
                                        $reels['reel4'][1] = '0';
                                        $reels['reel4'][2] = '0';
                                ...
                                if( $totalWin > 0 ) 
                                {
                                    for( $p = 3; $p >= 0; $p-- ) 
                                    {
                                        ...
                                        if( $reels['reel1'][$p] == '0' && $reels['reel2'][$p] == '0' ) 
                                        {
                                            $wps = 3;
                                        }
                                        if( $reels['reel1'][$p] == '0' && $reels['reel3'][$p] == '0' ) 
                                        {
                                            $wps = 5;
                                        }
                                        ...
                                        if( $reels['reel1'][$p] == '0' && $reels['reel4'][$p] == '0' ) 
                                        {
                                            $wps = 9;
                                        }
                                        ...
                                        if( $reels['reel1'][$p] == '0' && $reels['reel5'][$p] == '0' ) 
                                        {
                                            $wps = 17;
                                        }
                                        if( $reels['reel2'][$p] == '0' && $reels['reel5'][$p] == '0' ) 
                                        {
                                            $wps = 18;
                                        }
                                        if( $reels['reel3'][$p] == '0' && $reels['reel5'][$p] == '0' ) 
                                        {
                                            $wps = 20;
                                        }
                                        if( $reels['reel4'][$p] == '0' && $reels['reel5'][$p] == '0' ) 
                                        {
                                            $wps = 24;
                                        }
                                        if( $reels['reel1'][$p] == '0' && $reels['reel2'][$p] == '0' && $reels['reel3'][$p] == '0' ) 
                                        {
                                            $wps = 7;
                                        }
                                        if( $reels['reel1'][$p] == '0' && $reels['reel2'][$p] == '0' && $reels['reel4'][$p] == '0' ) 
                                        {
                                            $wps = 11;
                                        }
                                        if( $reels['reel1'][$p] == '0' && $reels['reel3'][$p] == '0' && $reels['reel4'][$p] == '0' ) 
                                        {
                                            $wps = 13;
                                        }
                                        ...
                                        if( $reels['reel1'][$p] == '0' && $reels['reel2'][$p] == '0' && $reels['reel5'][$p] == '0' ) 
                                        {
                                            $wps = 19;
                                        }
                                        if( $reels['reel1'][$p] == '0' && $reels['reel3'][$p] == '0' && $reels['reel5'][$p] == '0' ) 
                                        {
                                            $wps = 21;
                                        }
                                        if( $reels['reel2'][$p] == '0' && $reels['reel3'][$p] == '0' && $reels['reel5'][$p] == '0' ) 
                                        {
                                            $wps = 22;
                                        }
                                        if( $reels['reel1'][$p] == '0' && $reels['reel4'][$p] == '0' && $reels['reel5'][$p] == '0' ) 
                                        {
                                            $wps = 25;
                                        }
                                        if( $reels['reel2'][$p] == '0' && $reels['reel4'][$p] == '0' && $reels['reel5'][$p] == '0' ) 
                                        {
                                            $wps = 26;
                                        }
                                        if( $reels['reel3'][$p] == '0' && $reels['reel4'][$p] == '0' && $reels['reel5'][$p] == '0' ) 
                                        {
                                            $wps = 28;
                                        }
                                        if( $reels['reel1'][$p] == '0' && $reels['reel2'][$p] == '0' && $reels['reel4'][$p] == '0' && $reels['reel5'][$p] == '0' ) 
                                        {
                                            $wps = 27;
                                        }
                                        if( $reels['reel1'][$p] == '0' && $reels['reel3'][$p] == '0' && $reels['reel4'][$p] == '0' && $reels['reel5'][$p] == '0' ) 
                                        {
                                            $wps = 29;
                                        }
                                        if( $reels['reel2'][$p] == '0' && $reels['reel3'][$p] == '0' && $reels['reel4'][$p] == '0' && $reels['reel5'][$p] == '0' ) 
                                        {
                                            $wps = 30;
                                        }
                                        if( $reels['reel1'][$p] == '0' && $reels['reel2'][$p] == '0' && $reels['reel3'][$p] == '0' && $reels['reel4'][$p] == '0' && $reels['reel5'][$p] == '0' ) 
                                        {
                                            $wps = 31;
                                        }
                                    }
