            ...
            function get_($request, $game)
            {
                \DB::transaction(function() use ($request, $game)
                {
                    try
                    {
                        ...
                        if( $slotSettings->GetGameData('GreatBlueJPPTMBonusStart') ) 
                        {
                            $slotSettings->SetGameData('GreatBlueJPPTMBonusStart', false);
                            $result_tmp = [];
                        ...
                        {
                            $result_tmp = [];
                            if( $slotSettings->GetGameData('GreatBlueJPPTMBonusStep') == 0 ) 
                            {
                                $WinArr = [
                                    25, 
                                    22, 
                                ...
                                shuffle($WinArr);
                                $slotSettings->SetGameData('GreatBlueJPPTMBonusOpt', $WinArr);
                                $curWin = $WinArr[$postData['index']];
                                if( $curWin > 0 ) 
                                {
                                    $slotSettings->SetGameData('GreatBlueJPPTMFreeGames', $slotSettings->GetGameData('GreatBlueJPPTMFreeGames') + $curWin);
                                }
                                else
                                {
                                    $slotSettings->SetGameData('GreatBlueJPPTMFreeMpl', $slotSettings->GetGameData('GreatBlueJPPTMFreeMpl') + ($curWin * -1));
                                }
                                $result_tmp[] = '3:::{"data":{"pick":' . $postData['index'] . ',"values":[' . $curWin . '],"windowId":"h72Yp3"},"ID":49022,"umid":448}';
                                $slotSettings->SetGameData('GreatBlueJPPTMBonusStep', 1);
                            }
                            else if( $slotSettings->GetGameData('GreatBlueJPPTMBonusStep') == 1 ) 
                            {
                                $WinArr = $slotSettings->GetGameData('GreatBlueJPPTMBonusOpt');
                                $curWin = $WinArr[$postData['index']];
                                if( $curWin > 0 ) 
                                {
                                    $slotSettings->SetGameData('GreatBlueJPPTMFreeGames', $slotSettings->GetGameData('GreatBlueJPPTMFreeGames') + $curWin);
                                ...
                                $slotSettings->SetGameData('GreatBlueJPPTMBonusStep', 2);
                            }
                            $umid = 0;
                        }
                        if( isset($postData['spinType']) ) 
                        {
                            ...
                            if( $postData['spinType'] == 'regular' ) 
                            {
                                ...
                                $bonusMpl = 1;
                                $slotSettings->SetGameData('GreatBlueJPPTMBonusWin', 0);
                                $slotSettings->SetGameData('GreatBlueJPPTMFreeGames', 0);
                                $slotSettings->SetGameData('GreatBlueJPPTMCurrentFreeGame', 0);
                                $slotSettings->SetGameData('GreatBlueJPPTMTotalWin', 0);
                                $slotSettings->SetGameData('GreatBlueJPPTMFreeBalance', 0);
                                $slotSettings->SetGameData('GreatBlueJPPTMFreeStartWin', 0);
                                $slotSettings->SetGameData('GreatBlueJPPTMFreeMpl', $slotSettings->slotFreeMpl);
                            }
                            else if( $postData['spinType'] == 'free' ) 
                            {
                                $umid = '0';
                                $postData['slotEvent'] = 'freespin';
                                $slotSettings->SetGameData('GreatBlueJPPTMCurrentFreeGame', $slotSettings->GetGameData('GreatBlueJPPTMCurrentFreeGame') + 1);
                                $bonusMpl = $slotSettings->GetGameData('GreatBlueJPPTMFreeMpl');
                            }
                            $linesId = [];
                            $linesId[0] = [
                                2, 
                                    ...
                                    for( $j = 0; $j < count($slotSettings->SymbolGame); $j++ ) 
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            if( $s[0] == $csym || in_array($s[0], $wild) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":1,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('GreatBlueJPPTMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":["none","none"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":2,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('GreatBlueJPPTMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":3,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('GreatBlueJPPTMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) && ($s[3] == $csym || in_array($s[3], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":4,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('GreatBlueJPPTMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) && ($s[3] == $csym || in_array($s[3], $wild)) && ($s[4] == $csym || in_array($s[4], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":5,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('GreatBlueJPPTMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":[' . ($linesId[$k][4] - 1) . ',"' . $s[4] . '"]}';
                                                }
                                            }
                                        }
                                    }
                            ...
                            if( $postData['slotEvent'] == 'freespin' ) 
                            {
                                $slotSettings->SetGameData('GreatBlueJPPTMBonusWin', $slotSettings->GetGameData('GreatBlueJPPTMBonusWin') + $totalWin);
                                $slotSettings->SetGameData('GreatBlueJPPTMTotalWin', $totalWin);
                            }
                            else
                            {
                                $slotSettings->SetGameData('GreatBlueJPPTMTotalWin', $totalWin);
                            ...
                            if( $scattersCount >= 3 ) 
                            {
                                $slotSettings->SetGameData('GreatBlueJPPTMBonusStart', true);
                                $slotSettings->SetGameData('GreatBlueJPPTMBonusStep', 0);
                                if( $slotSettings->GetGameData('GreatBlueJPPTMFreeGames') > 0 ) 
                                {
                                    $slotSettings->SetGameData('GreatBlueJPPTMFreeGames', $slotSettings->GetGameData('GreatBlueJPPTMFreeGames') + 15);
                                }
                                else
                                {
                                    $slotSettings->SetGameData('GreatBlueJPPTMFreeStartWin', $totalWin);
                                    $slotSettings->SetGameData('GreatBlueJPPTMBonusWin', 0);
                                    $slotSettings->SetGameData('GreatBlueJPPTMFreeGames', $slotSettings->slotFreeCount);
                                }
                            }
                            $balanceInCents = sprintf('%01.2f', $slotSettings->GetBalance()) * 100;
                            $spinState = 'REGULAR';
                            ...
                            $response = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{"linesArr":[' . implode(',', $postData['lines']) . '],"slotLines":' . $lines . ',"slotBet":' . $betLine . ',"totalFreeGames":' . $slotSettings->GetGameData('GreatBlueJPPTMFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('GreatBlueJPPTMCurrentFreeGame') . ',"Balance":' . $slotSettings->GetBalance() . ',"afterBalance":' . $slotSettings->GetBalance() . ',"bonusWin":' . $slotSettings->GetGameData('GreatBlueJPPTMBonusWin') . ',"FreeMpl":' . $slotSettings->GetGameData('GreatBlueJPPTMFreeMpl') . ',"freeStartWin":' . $slotSettings->GetGameData('GreatBlueJPPTMFreeStartWin') . ',"totalWin":' . $totalWin . ',"winLines":[' . $winString . '],"bonusInfo":' . $scattersStr . ',"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
