                    ...
                    try
                    {
                        ...
                        switch( $aid ) 
                        {
                            ...
                            case 'settings':
                                ...
                                $result_tmp[] = '{"complex":{"balance":' . $balanceInCents . ',"balanceRaw":' . round($balanceInCents * $slotSettings->CurrentDenom) . ',"paytableCoef":{"0":{"coef":[10,20,100],"multiplier":1},"1":{"coef":[10,20,100],"multiplier":1},"2":{"coef":[10,30,100],"multiplier":1},"3":{"coef":[10,30,100],"multiplier":1},"4":{"coef":[20,40,100],"multiplier":1},"5":{"coef":[20,40,100],"multiplier":1},"6":{"coef":[20,50,125],"multiplier":1},"7":{"coef":[20,50,125],"multiplier":1},"8":{"coef":[25,75,150],"multiplier":1},"9":{"coef":[25,75,150],"multiplier":1},"10":{"coef":[10,30,100,250],"multiplier":1},"11":{"coef":[10,30,100,250],"multiplier":1},"12":{"coef":[],"multiplier":1},"13":{"coef":[5],"multiplier":1},"14":{"coef":[],"multiplier":1}},"bets":[' . implode(',', $gameBets) . '],"jackpotMinBet":1,"jackpot":true,"freespinFakeReels":[[2,4,11,3,2,7,0,6,1,4,9,0,5,6,1,13,10,11,5,8,0,5,1,0,3,8,5,2,13,1],[2,4,12,3,2,7,0,6,1,4,9,0,5,6,1,12,10,10,10,1,9,2,9,6,4,11,0,2,0,2],[2,4,2,3,2,7,12,6,1,4,9,0,10,10,3,10,12,4,5,8,1,11,0,5,0,3,4,0,2,6],[2,4,1,3,12,7,0,6,1,4,9,0,5,6,12,10,10,4,5,7,3,6,12,8,0,5,0,2,11,1],[2,4,1,3,2,7,0,6,1,4,9,0,5,6,10,11,10,10,5,5,0,8,1,0,11,4,5,0,6,2]],"jackpotMinBet":1,"jackpot":true,"mainFakeReels":[[2,4,11,3,2,7,0,6,1,4,9,0,5,6,1,13,10,11,5,8,0,5,1,0,3,8,5,2,13,1],[2,4,12,3,2,7,0,6,1,4,9,0,5,6,1,12,10,10,10,1,9,2,9,6,4,11,0,2,0,2],[2,4,13,3,2,7,12,6,1,4,9,0,10,10,13,10,12,4,5,8,1,11,0,5,0,3,4,0,2,6],[2,4,1,3,12,7,0,6,1,4,9,0,5,6,12,10,10,4,5,7,3,6,12,8,0,5,0,2,11,1],[2,4,1,3,2,7,0,6,11,4,9,0,5,6,10,11,10,10,13,5,0,8,1,0,13,4,5,0,6,2]],"jackpotMaxBet":100000,"denominations":[' . implode(',', $denoms) . ']},"gameIdentificationNumber":' . $postData['gameIdentificationNumber'] . ',"gameNumber":-1,"sessionKey":"41be9e65e0ff03a65e8c93576bf61130","msg":"success","messageId":"' . $postData['messageId'] . '","qName":"app.services.messages.response.GameResponse","command":"settings","eventTimestamp":' . time() . '}';
                                break;
                            case 'subscribe':
                                $hist = [
                                    78, 
                                ...
                                shuffle($hist);
                                $slotSettings->SetGameData('StoryOfAlexandrEGTCards', $hist);
                                $lastEvent = $slotSettings->GetHistory();
                                $slotSettings->SetGameData('StoryOfAlexandrEGTBonusWin', 0);
                                $slotSettings->SetGameData('StoryOfAlexandrEGTFreeGames', 0);
                                $slotSettings->SetGameData('StoryOfAlexandrEGTCurrentFreeGame', 0);
                                $slotSettings->SetGameData('StoryOfAlexandrEGTTotalWin', 0);
                                $slotSettings->SetGameData('StoryOfAlexandrEGTFreeBalance', 0);
                                ...
                                if( $lastEvent != 'NULL' ) 
                                {
                                    ...
                                    $slotSettings->SetGameData($slotSettings->slotId . 'Holds', $lastEvent->serverResponse->holdPositions);
                                    $slotSettings->SetGameData('StoryOfAlexandrEGTCurrentSeq', $lastEvent->serverResponse->curSeq);
                                    ...
                                    $gtype = 1;
                                    if( $slotSettings->GetGameData('StoryOfAlexandrEGTCurrentFreeGame') < $slotSettings->GetGameData('StoryOfAlexandrEGTFreeGames') && $slotSettings->GetGameData('StoryOfAlexandrEGTFreeGames') > 0 ) 
                                    {
                                        $gtype = 2;
                                    }
                                }
                                ...
                                {
                                    $gtype = 1;
                                    $curReels = '' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . '';
                                    $lines = 100;
                                ...
                                $result_tmp[] = '{"complex":{"firstSpin":{"reels":[4,1,11,0,4,4,0,9,4,0,1,11,0,4,6,8,3,0,6,1,1,11,0,2,8],"lines":[],"scatters":[{"scatterName":11,"cells":[0,1,2,0,4,0],"winAmount":5000}],"expand":[]},"currentState":{"gamblesUsed":0,"freespinsUsed":' . $slotSettings->GetGameData($slotSettings->slotId . 'CurrentFreeGame') . ',"previousGambles":[],"holdPositions": [' . implode(',', $slotSettings->GetGameData($slotSettings->slotId . 'Holds')) . '],"bet":' . $bet . ',"numberOfLines":' . $lines . ',"denomination":100,"state":"' . $state_ . '","winAmount":' . ($slotSettings->GetGameData($slotSettings->slotId . 'BonusWin') * 100) . ',"reels":[' . $curReels . '],"lines":[],"scatters":[],"expand":[],"specialExpand":[],"gambles":5,"freespins":' . ($slotSettings->GetGameData($slotSettings->slotId . 'FreeGames') - $slotSettings->GetGameData('StoryOfAlexandrEGTCurrentFreeGame')) . ',"freespinScatters":[],"jackpot":false},"jackpotState":{"levelI":' . ($slotSettings->slotJackpot[0] * 100) . ',"levelII":' . ($slotSettings->slotJackpot[1] * 100) . ',"levelIII":' . ($slotSettings->slotJackpot[2] * 100) . ',"levelIV":' . ($slotSettings->slotJackpot[3] * 100) . ',"winsLevelI":0,"largestWinLevelI":0,"largestWinDateLevelI":"","largestWinUserLevelI":"player","lastWinLevelI":0,"lastWinDateLevelI":"","lastWinUserLevelI":"","winsLevelII":0,"largestWinLevelII":0,"largestWinDateLevelII":"","largestWinUserLevelII":"","lastWinLevelII":0,"lastWinDateLevelII":"","lastWinUserLevelII":"","winsLevelIII":0,"largestWinLevelIII":0,"largestWinDateLevelIII":"","largestWinUserLevelIII":"player","lastWinLevelIII":0,"lastWinDateLevelIII":"","lastWinUserLevelIII":"","winsLevelIV":0,"largestWinLevelIV":0,"largestWinDateLevelIV":"","largestWinUserLevelIV":"","lastWinLevelIV":0,"lastWinDateLevelIV":"","lastWinUserLevelIV":""}},"gameIdentificationNumber":' . $postData['gameIdentificationNumber'] . ',"gameNumber":-1,"sessionKey":"41be9e65e0ff03a65e8c93576bf61130","msg":"success","messageId":"' . $postData['messageId'] . '","qName":"app.services.messages.response.GameEventResponse","command":"subscribe","eventTimestamp":' . time() . '}';
                                break;
                            case 'ping':
                                $cashBackBtn = 0;
                            ...
                            case 'bet':
                                ...
                                if( $postData['slotEvent'] != 'freespin' ) 
                                {
                                    ...
                                    $slotSettings->SetGameData('StoryOfAlexandrEGTCurrentFreeGame', 0);
                                    $slotSettings->SetGameData('StoryOfAlexandrEGTTotalWin', 0);
                                    $slotSettings->SetGameData('StoryOfAlexandrEGTFreeBalance', sprintf('%01.2f', $slotSettings->GetBalance()) * 100);
                                    $slotSettings->SetGameData('StoryOfAlexandrEGTHolds', []);
                                    $bonusMpl = 1;
                                }
                                else
                                {
                                    $slotSettings->SetGameData('StoryOfAlexandrEGTCurrentFreeGame', $slotSettings->GetGameData('StoryOfAlexandrEGTCurrentFreeGame') + 1);
                                ...
                                if( $winType == 'bonus' ) 
                                {
                                    ...
                                    if( $wlb != 'NULL' ) 
                                    {
                                        ...
                                        $slotSettings->SetGameData('StoryOfAlexandrEGTCurrentSeq', $curSeq);
                                        if( $curSeqWin > 0 ) 
                                        {
                                ...
                                for( $i = 0; $i <= 2000; $i++ ) 
                                {
                                    ...
                                    {
                                        $curSeq = (array)$slotSettings->GetGameData('StoryOfAlexandrEGTCurrentSeq');
                                        $curSeq['result'] = (array)$curSeq['result'];
                                        $curSeq['result'][$slotSettings->GetGameData('StoryOfAlexandrEGTCurrentFreeGame')] = (array)$curSeq['result'][$slotSettings->GetGameData('StoryOfAlexandrEGTCurrentFreeGame')];
                                        $curSeq['result'][$slotSettings->GetGameData('StoryOfAlexandrEGTCurrentFreeGame')]['reels'] = (array)$curSeq['result'][$slotSettings->GetGameData('StoryOfAlexandrEGTCurrentFreeGame')]['reels'];
                                        $reels = $curSeq['result'][$slotSettings->GetGameData('StoryOfAlexandrEGTCurrentFreeGame')]['reels'];
                                    }
                                    if( $postData['slotEvent'] == 'freespin' ) 
                                    {
                                        for( $r = 0; $r < count($holds); $r++ ) 
                                        {
                                            $t = explode(',', $holds[$r]);
                                            $reels['reel' . ((int)$t[0] + 1)][(int)$t[1]] = '12';
                                        }
                                    }
                                    for( $k = 0; $k < $lines; $k++ ) 
                                    {
                                ...
                                if( $postData['slotEvent'] == 'freespin' ) 
                                {
                                    $slotSettings->SetGameData('StoryOfAlexandrEGTBonusWin', $slotSettings->GetGameData('StoryOfAlexandrEGTBonusWin') + $totalWin);
                                    $slotSettings->SetGameData('StoryOfAlexandrEGTTotalWin', $slotSettings->GetGameData('StoryOfAlexandrEGTTotalWin') + $totalWin);
                                    $balanceInCents = $slotSettings->GetGameData('StoryOfAlexandrEGTFreeBalance');
                                    $slotSettings->SetGameData($slotSettings->slotId . 'Holds', $holdsNew);
                                }
                                else
                                {
                                    $slotSettings->SetGameData('StoryOfAlexandrEGTTotalWin', $totalWin);
                                }
                                $fs = 0;
                                if( $scattersCount >= 3 ) 
                                {
                                    if( $slotSettings->GetGameData('StoryOfAlexandrEGTFreeGames') > 0 ) 
                                    {
                                        $slotSettings->SetGameData('StoryOfAlexandrEGTFreeGames', $slotSettings->GetGameData('StoryOfAlexandrEGTFreeGames') + $slotSettings->slotFreeCount);
                                    }
                                    else
                                    {
                                        $slotSettings->SetGameData('StoryOfAlexandrEGTFreeStartWin', $totalWin);
                                        $slotSettings->SetGameData('StoryOfAlexandrEGTBonusWin', $totalWin);
                                        $slotSettings->SetGameData('StoryOfAlexandrEGTFreeGames', $slotSettings->slotFreeCount);
                                    }
                                    $fs = $slotSettings->GetGameData('StoryOfAlexandrEGTFreeGames');
                                }
                                $winString = implode(',', $lineWins);
                                $jsSpin = '' . json_encode($reels) . '';
                                $jsJack = '' . json_encode($slotSettings->Jackpots) . '';
                                $response = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{"curSeq":' . json_encode($curSeq) . ',"slotLines":' . $lines . ',"slotBet":' . $betline . ',"holdPositions": ' . json_encode($slotSettings->GetGameData($slotSettings->slotId . 'Holds')) . ',"totalFreeGames":' . $slotSettings->GetGameData('StoryOfAlexandrEGTFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('StoryOfAlexandrEGTCurrentFreeGame') . ',"Balance":' . $balanceInCents . ',"afterBalance":' . $balanceInCents . ',"bonusWin":' . $slotSettings->GetGameData('StoryOfAlexandrEGTBonusWin') . ',"totalWin":' . $totalWin . ',"winLines":[' . $winString . '],"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
                                $slotSettings->SaveLogReport($response, $allbet, $lines, $reportWin, $postData['slotEvent']);
                                $winstring = '';
                                $slotSettings->SetGameData('StoryOfAlexandrEGTGambleStep', 5);
                                $hist = $slotSettings->GetGameData('StoryOfAlexandrEGTCards');
                                $curReels = '' . rand(0, 6) . ',' . $reels['reel1'][0] . ',' . $reels['reel1'][1] . ',' . $reels['reel1'][2] . ',' . $reels['reel1'][3] . ',' . rand(0, 6);
                                $curReels .= (',' . rand(0, 6) . ',' . $reels['reel2'][0] . ',' . $reels['reel2'][1] . ',' . $reels['reel2'][2] . ',' . $reels['reel2'][3] . ',' . rand(0, 6));
                                $curReels .= (',' . rand(0, 6) . ',' . $reels['reel3'][0] . ',' . $reels['reel3'][1] . ',' . $reels['reel3'][2] . ',' . $reels['reel3'][3] . ',' . rand(0, 6));
                                $curReels .= (',' . rand(0, 6) . ',' . $reels['reel4'][0] . ',' . $reels['reel4'][1] . ',' . $reels['reel4'][2] . ',' . $reels['reel4'][3] . ',' . rand(0, 6));
                                ...
                                if( $jackRandom == 1 ) 
                                {
                                    $state = 'jackpot';
                                    $isJack = 'true';
                                    $slotSettings->SetGameData('StoryOfAlexandrEGTJackSteps', [
                                        0, 
                                        0, 
                                        0, 
                                        0
                                ...
                                if( $postData['slotEvent'] == 'freespin' ) 
                                {
                                    $totalWin = $slotSettings->GetGameData('StoryOfAlexandrEGTBonusWin');
                                    $state = 'freespin';
                                ...
                                $result_tmp[] = '{"complex":{"gambles":5,"reels":[' . $curReels . '],"lines":[' . $winString . '],"scatters":[' . $scattersStr . '],"freespinScatters":[' . $scatter . '],"holdPositions": [' . implode(',', $slotSettings->GetGameData($slotSettings->slotId . 'Holds')) . '],"expand":[],"specialExpand":[],"gambles":5,"freespins":' . $fs . ',"jackpot":' . $isJack . ',"gameCommand":"bet"},"state":"' . $state . '","winAmount":' . ($totalWin * 100) . ',"gameIdentificationNumber":' . $postData['gameIdentificationNumber'] . ',"gameNumber":"","balance":' . $balanceInCents . ',"sessionKey":"41be9e65e0ff03a65e8c93576bf61130","msg":"success","messageId":"' . $postData['messageId'] . '","qName":"app.services.messages.response.GameEventResponse","command":"bet","eventTimestamp":' . time() . '}';
                                ...
                                break;
                            case 'collect':
                                $result_tmp[] = '{"complex":{"gameCommand":"collect"},"state":"idle","winAmount":' . ($slotSettings->GetGameData('StoryOfAlexandrEGTTotalWin') * 100) . ',"gameIdentificationNumber":' . $postData['gameIdentificationNumber'] . ',"gameNumber":"","balance":' . $balanceInCents . ',"sessionKey":"41be9e65e0ff03a65e8c93576bf61130","msg":"success","messageId":"' . $postData['messageId'] . '","qName":"app.services.messages.response.GameEventResponse","command":"bet","eventTimestamp":' . time() . '}';
                                $slotSettings->SetGameData('StoryOfAlexandrEGTTotalWin', 0);
                                break;
                            case 'jackpot':
                                $jackStep = $slotSettings->GetGameData('StoryOfAlexandrEGTJackSteps');
                                $jackWinID = $slotSettings->GetGameData($slotSettings->slotId . 'JackWinID');
                                if( $jackStep[0] >= 3 || $jackStep[1] >= 3 || $jackStep[2] >= 3 || $jackStep[3] >= 3 || !$slotSettings->HasGameData('StoryOfAlexandrEGTJackSteps') ) 
                                {
                                    exit();
                                }
                                $winAmount = 0;
                                ...
                                $slotSettings->SetGameData('StoryOfAlexandrEGTJackSteps', $jackStep);
                                break;
                            case 'gamble':
                                $Balance = $slotSettings->GetBalance();
                                $isGambleWin = rand(1, $slotSettings->GetGambleSettings());
                                $dealerCard = '';
                                $totalWin = $slotSettings->GetGameData('StoryOfAlexandrEGTTotalWin');
                                $gambleWin = 0;
                                $statBet = $totalWin;
                                $slotSettings->SetGameData('StoryOfAlexandrEGTGambleStep', $slotSettings->GetGameData('StoryOfAlexandrEGTGambleStep') - 1);
                                ...
                                else
                                {
                                    ...
                                    $totalWin = 0;
                                    $slotSettings->SetGameData('StoryOfAlexandrEGTGambleStep', 0);
                                    if( $postData['bet']['color'] == '1' ) 
                                    {
                                        $tmpCards = [
                                            '1', 
                                ...
                                $gtype = 1;
                                $gtype0 = 1;
                                if( $slotSettings->GetGameData('StoryOfAlexandrEGTBonusStart') == 1 ) 
                                {
                                    $gtype0 = 2;
                                }
                                $result_tmp[] = '{"complex":{"gambles":' . $slotSettings->GetGameData('StoryOfAlexandrEGTGambleStep') . ',"card":' . $dealerCard . ',"jackpot":false,"gameCommand":"gamble"},"state":"' . $gambleState . '","winAmount":' . ($totalWin * 100) . ',"gameIdentificationNumber":' . $postData['gameIdentificationNumber'] . ',"gameNumber":"","sessionKey":"88e2b82e6537db4a339e4e1b5ce462cd","msg":"success","messageId":"' . $postData['messageId'] . '","qName":"app.services.messages.response.GameEventResponse","command":"bet","eventTimestamp":' . time() . '}';
                                break;
                        }
