                ...
                \DB::transaction(function() use ($request, $game)
                {
                    try
                    {
                        ...
                        if( $postData['slotEvent'] == 'gameInit' ) 
                        {
                            ...
                            $response = '{"status":"success","microtime":0.0077991485595703,"dateTime":"2020-02-13 13:16:03","error":"","content":{"cmd":"gameInit","balance":' . $balanceInCents . ',"session":"54594109_4133a64673d3883d42cd003ee905ba3e","betInfo":{"denomination":0.01,"bet":' . $gameBets[0] . ',"lines":5},"betSettings":{"denomination":[0.01],"bets":[' . implode(',', $gameBets) . '],"lines":[5]},"symbols":' . $reelStr . ',"reels":{"base":{"1":["' . implode('","', $slotSettings->reelStrip1) . '"],"2":["' . implode('","', $slotSettings->reelStrip2) . '"],"3":["' . implode('","', $slotSettings->reelStrip3) . '"],"4":["' . implode('","', $slotSettings->reelStrip4) . '"],"5":["' . implode('","', $slotSettings->reelStrip5) . '"]}},"exitUrl":"\/","pingInterval":60000,"restore":' . $restore . ',"freeSpin":{' . $freeStateStr . '},"hash":"da0a5044aebc413b6da3a8e42dea0246"}}';
                        }
                        ...
                        {
                            $response = '{"status":"success","microtime":0.0026731491088867,"dateTime":"2020-02-13 13:23:32","error":"","content":{"cmd":"sessionInfo","serverMathematics":"\/game\/BigRedAT\/server","serverResources":"","sessionId":"54594109_4133a64673d3883d42cd003ee905ba3e","exitUlt":"\/","exitUrl":"\/","id":"341","name":"GameName","currency":"ALL","language":"en","type":"aristocrat","systemName":"big_red","version":"2","mobile":"1"}}';
                        }
                        ...
                        else if( $postData['slotEvent'] == 'gamePick' ) 
                        {
                            ...
                            if( $_POST['pick'] == 0 ) 
                            {
                                $slotSettings->SetGameData('BigRedATMpl', 10);
                                $slotSettings->SetGameData('BigRedATCurrentFreeGame', 0);
                                $slotSettings->SetGameData('BigRedATFreeGames', 5);
                            }
                            else if( $_POST['pick'] == 1 ) 
                            {
                                $slotSettings->SetGameData('BigRedATMpl', 5);
                                $slotSettings->SetGameData('BigRedATCurrentFreeGame', 0);
                                $slotSettings->SetGameData('BigRedATFreeGames', 10);
                            }
                            else if( $_POST['pick'] == 2 ) 
                            {
                                $slotSettings->SetGameData('BigRedATMpl', 3);
                                $slotSettings->SetGameData('BigRedATCurrentFreeGame', 0);
                                $slotSettings->SetGameData('BigRedATFreeGames', 15);
                            }
                            else if( $_POST['pick'] == 3 ) 
                            {
                                $slotSettings->SetGameData('BigRedATMpl', 2);
                                $slotSettings->SetGameData('BigRedATCurrentFreeGame', 0);
                                $slotSettings->SetGameData('BigRedATFreeGames', 20);
                            }
                            $response = '{"status":"success","microtime":0.0093810558319092,"dateTime":"2020-02-15 14:26:21","error":"","content":{"session":"54990161_9709e13bca7763b46396cda1868d2e7e","cmd":"gamePick","balance":' . $balanceInCents . ',"win":0,"symbols":{"1":{"1":"symbol_6","2":"symbol_9","3":"symbol_13"},"2":{"1":"symbol_10","2":"symbol_5","3":"symbol_8"},"3":{"1":"symbol_10","2":"symbol_13","3":"symbol_11"},"4":{"1":"symbol_13","2":"symbol_10","3":"symbol_6"},"5":{"1":"symbol_3","2":"symbol_8","3":"symbol_1"}},"winLines":[],"freeSpin":{"id":"54990161_20200215132548","current":0,"add":' . $slotSettings->GetGameData('BigRedATFreeGames') . ',"total":' . $slotSettings->GetGameData('BigRedATFreeGames') . ',"totalWin":' . ($slotSettings->GetGameData('BigRedATBonusWin') * 100) . ',"multiplayer":' . $slotSettings->GetGameData('BigRedATMpl') . ',"pick":' . $_POST['pick'] . '},"actionId":"54990161_10_60","hash":"1ace145628d930d28bdf38789a28a9d7"}}';
                        }
                        else if( $postData['slotEvent'] == 'slotGamble' ) 
                        {
                            ...
                            $dealerCard = '';
                            $totalWin = $slotSettings->GetGameData('BigRedATTotalWin');
                            $gambleWin = 0;
                            $statBet = $totalWin;
                            ...
                            $slotSettings->SetGameData('BigRedATTotalWin', $totalWin);
                        ...
                        else if( $postData['slotEvent'] == 'bet' || $postData['slotEvent'] == 'freespin' ) 
                        {
                            ...
                            if( $postData['slotEvent'] != 'freespin' ) 
                            {
                                ...
                                $bonusMpl = 1;
                                $slotSettings->SetGameData('BigRedATBonusWin', 0);
                                $slotSettings->SetGameData('BigRedATFreeGames', 0);
                                $slotSettings->SetGameData('BigRedATCurrentFreeGame', 0);
                                $slotSettings->SetGameData('BigRedATTotalWin', 0);
                                $slotSettings->SetGameData('BigRedATFreeBalance', 0);
                                $slotSettings->SetGameData('BigRedATMpl', 1);
                            }
                            else
                            {
                                $slotSettings->SetGameData('BigRedATCurrentFreeGame', $slotSettings->GetGameData('BigRedATCurrentFreeGame') + 1);
                                $bonusMpl = $slotSettings->GetGameData('BigRedATMpl');
                            }
                            $Balance = $slotSettings->GetBalance();
                            ...
                            if( $postData['slotEvent'] == 'freespin' ) 
                            {
                                $slotSettings->SetGameData('BigRedATBonusWin', $slotSettings->GetGameData('BigRedATBonusWin') + $totalWin);
                                $slotSettings->SetGameData('BigRedATTotalWin', $slotSettings->GetGameData('BigRedATTotalWin') + $totalWin);
                                $freeStateStr = '"id":"54594109_20200214110301","current":' . $slotSettings->GetGameData('BigRedATCurrentFreeGame') . ',"multiplayer":' . $slotSettings->GetGameData('BigRedATMpl') . ',"add":0,"total":' . $slotSettings->GetGameData('BigRedATFreeGames') . ',"totalWin":' . ($slotSettings->GetGameData('BigRedATBonusWin') * 100) . '';
                            }
                            else
                            {
                                $slotSettings->SetGameData('BigRedATTotalWin', $totalWin);
                            ...
                            if( $scattersCount >= 3 ) 
                            {
                                if( $slotSettings->GetGameData('BigRedATFreeGames') > 0 ) 
                                {
                                    $slotSettings->SetGameData('BigRedATFreeGames', $slotSettings->GetGameData('BigRedATFreeGames') + $slotSettings->slotFreeCount);
                                    $freeStateStr = '"id":"54594109_20200214110301","current":' . $slotSettings->GetGameData('BigRedATCurrentFreeGame') . ',"multiplayer":' . $slotSettings->GetGameData('BigRedATMpl') . ',"add":' . $slotSettings->slotFreeCount . ',"total":' . $slotSettings->GetGameData('BigRedATFreeGames') . ',"totalWin":' . ($slotSettings->GetGameData('BigRedATBonusWin') * 100) . '';
                                }
                                else
                                {
                                    $slotSettings->SetGameData('BigRedATFreeBalance', $Balance);
                                    $slotSettings->SetGameData('BigRedATBonusWin', $totalWin);
                                    $slotSettings->SetGameData('BigRedATFreeGames', $slotSettings->slotFreeCount);
                                    $freeStateStr = '"id":"54594109_20200214110301","current":' . $slotSettings->GetGameData('BigRedATCurrentFreeGame') . ',"multiplayer":' . $slotSettings->GetGameData('BigRedATMpl') . ',"add":' . $slotSettings->slotFreeCount . ',"total":' . $slotSettings->GetGameData('BigRedATFreeGames') . ',"totalWin":' . ($slotSettings->GetGameData('BigRedATBonusWin') * 100) . '';
                                }
                            }
                            ...
                            $response_log = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{"slotLines":' . $postData['slotLines'] . ',"slotBet":' . $postData['slotBet'] . ',"totalFreeGames":' . $slotSettings->GetGameData('BigRedATFreeGames') . ',"Mpl":' . $slotSettings->GetGameData('BigRedATMpl') . ',"currentFreeGames":' . $slotSettings->GetGameData('BigRedATCurrentFreeGame') . ',"Balance":' . $Balance . ',"afterBalance":' . $slotSettings->GetBalance() . ',"totalWin":' . $totalWin . ',"winLines":[' . $winString . '],"bonusInfo":{},"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
                            $reelStrArr = [];
                            for( $i = 1; $i <= 5; $i++ ) 
                            {
