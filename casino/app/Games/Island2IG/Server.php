            ...
            function get_($request, $game)
            {
                \DB::transaction(function() use ($request, $game)
                {
                    try
                    {
                        ...
                        else if( $postData['action'] == 'risk' && $slotSettings->GetGameData('Island2IGWin') <= 0 ) 
                        {
                        ...
                        switch( $postData['action'] ) 
                        {
                            ...
                            case 'start':
                                ...
                                $slotSettings->SetGameData('Island2IGReels', $reelStr);
                                ...
                                $slotSettings->SetGameData('Island2IGDealerCard', $card);
                                $rState = 'bet';
                                if( $isBonus ) 
                                {
                                    $rState = 'BG';
