            ...
            function get_($request, $game)
            {
                \DB::transaction(function() use ($request, $game)
                {
                    try
                    {
                        ...
                        {
                            $result_tmp = [];
                            if( $slotSettings->GetGameData('IrishLuckPTMBonusStep') == 0 ) 
                            {
                                $WinArr = [
                                    2500, 
                                    2200, 
                                ...
                                shuffle($WinArr);
                                $slotSettings->SetGameData('IrishLuckPTMBonusOpt', $WinArr);
                                $curWin = $WinArr[$postData['index']];
                                if( $curWin > 10 ) 
                                {
                                    $slotSettings->SetGameData('IrishLuckPTMFreeGames', $slotSettings->GetGameData('IrishLuckPTMFreeGames') + ($curWin / 100));
                                }
                                else
                                {
                                    $slotSettings->SetGameData('IrishLuckPTMFreeMpl', $slotSettings->GetGameData('IrishLuckPTMFreeMpl') + $curWin);
                                }
                                $result_tmp[] = '3:::{"data":{"prizes":[' . $curWin . '],"windowId":"2Hjr3k"},"ID":40251,"umid":474}';
                                $slotSettings->SetGameData('IrishLuckPTMBonusStep', 1);
                            }
                            else if( $slotSettings->GetGameData('IrishLuckPTMBonusStep') == 1 ) 
                            {
                                $WinArr = $slotSettings->GetGameData('IrishLuckPTMBonusOpt');
                                $curWin = $WinArr[$postData['index']];
                                if( $curWin > 10 ) 
                                {
                                    $slotSettings->SetGameData('IrishLuckPTMFreeGames', $slotSettings->GetGameData('IrishLuckPTMFreeGames') + ($curWin / 100));
                                ...
                                $slotSettings->SetGameData('IrishLuckPTMBonusStep', 2);
                            }
                            $umid = 0;
                        }
                        if( isset($postData['spinType']) ) 
                        {
                            ...
                            if( $postData['spinType'] == 'regular' ) 
                            {
                                ...
                                $bonusMpl = 1;
                                $slotSettings->SetGameData('IrishLuckPTMBonusWin', 0);
                                $slotSettings->SetGameData('IrishLuckPTMFreeGames', 0);
                                $slotSettings->SetGameData('IrishLuckPTMCurrentFreeGame', 0);
                                $slotSettings->SetGameData('IrishLuckPTMTotalWin', 0);
                                $slotSettings->SetGameData('IrishLuckPTMFreeBalance', 0);
                                $slotSettings->SetGameData('IrishLuckPTMFreeStartWin', 0);
                                $slotSettings->SetGameData('IrishLuckPTMFreeMpl', $slotSettings->slotFreeMpl);
                            }
                            else if( $postData['spinType'] == 'free' ) 
                            {
                                $umid = '0';
                                $postData['slotEvent'] = 'freespin';
                                $slotSettings->SetGameData('IrishLuckPTMCurrentFreeGame', $slotSettings->GetGameData('IrishLuckPTMCurrentFreeGame') + 1);
                                $bonusMpl = $slotSettings->GetGameData('IrishLuckPTMFreeMpl');
                            }
                            $linesId = [];
                            $linesId[0] = [
                                2, 
                                    ...
                                    for( $j = 0; $j < count($slotSettings->SymbolGame); $j++ ) 
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            if( $s[0] == $csym || in_array($s[0], $wild) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":1,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('IrishLuckPTMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":["none","none"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":2,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('IrishLuckPTMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":3,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('IrishLuckPTMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) && ($s[3] == $csym || in_array($s[3], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":4,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('IrishLuckPTMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) && ($s[3] == $csym || in_array($s[3], $wild)) && ($s[4] == $csym || in_array($s[4], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":5,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('IrishLuckPTMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":[' . ($linesId[$k][4] - 1) . ',"' . $s[4] . '"]}';
                                                }
                                            }
                                        }
                                    }
                            ...
                            if( $postData['slotEvent'] == 'freespin' ) 
                            {
                                $slotSettings->SetGameData('IrishLuckPTMBonusWin', $slotSettings->GetGameData('IrishLuckPTMBonusWin') + $totalWin);
                                $slotSettings->SetGameData('IrishLuckPTMTotalWin', $totalWin);
                            }
                            else
                            {
                                $slotSettings->SetGameData('IrishLuckPTMTotalWin', $totalWin);
                            ...
                            if( $scattersCount >= 3 ) 
                            {
                                if( $slotSettings->GetGameData('IrishLuckPTMFreeGames') > 0 ) 
                                {
                                    $slotSettings->SetGameData('IrishLuckPTMBonusWin', $totalWin);
                                    $slotSettings->SetGameData('IrishLuckPTMFreeGames', $slotSettings->GetGameData('IrishLuckPTMFreeGames') + $slotSettings->slotFreeCount);
                                }
                                else
                                {
                                    $slotSettings->SetGameData('IrishLuckPTMBonusStep', 0);
                                    $slotSettings->SetGameData('IrishLuckPTMFreeStartWin', $totalWin);
                                    $slotSettings->SetGameData('IrishLuckPTMBonusWin', $totalWin);
                                    $slotSettings->SetGameData('IrishLuckPTMFreeGames', $slotSettings->slotFreeCount);
                                }
                            }
                            $balanceInCents = sprintf('%01.2f', $slotSettings->GetBalance()) * 100;
                            ...
                            $response = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{"linesArr":[' . implode(',', $postData['lines']) . '],"slotLines":' . $lines . ',"slotBet":' . $betLine . ',"totalFreeGames":' . $slotSettings->GetGameData('IrishLuckPTMFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('IrishLuckPTMCurrentFreeGame') . ',"Balance":' . $slotSettings->GetBalance() . ',"afterBalance":' . $slotSettings->GetBalance() . ',"bonusWin":' . $slotSettings->GetGameData('IrishLuckPTMBonusWin') . ',"FreeMpl":' . $slotSettings->GetGameData('IrishLuckPTMFreeMpl') . ',"freeStartWin":' . $slotSettings->GetGameData('IrishLuckPTMFreeStartWin') . ',"totalWin":' . $totalWin . ',"winLines":[' . $winString . '],"bonusInfo":' . $scattersStr . ',"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
