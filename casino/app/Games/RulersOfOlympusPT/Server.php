                    ...
                    try
                    {
                        ...
                        if( isset($postData['spinType']) ) 
                        {
                            ...
                            if( $postData['spinType'] == 'regular' ) 
                            {
                                ...
                                $bonusMpl = 1;
                                $slotSettings->SetGameData('RulersOfOlympusPTBonusWin', 0);
                                $slotSettings->SetGameData('RulersOfOlympusPTFreeGames', 0);
                                $slotSettings->SetGameData('RulersOfOlympusPTCurrentFreeGame', 0);
                                $slotSettings->SetGameData('RulersOfOlympusPTTotalWin', 0);
                                $slotSettings->SetGameData('RulersOfOlympusPTFreeBalance', 0);
                                $slotSettings->SetGameData('RulersOfOlympusPTFreeStartWin', 0);
                                $slotSettings->SetGameData('RulersOfOlympusPTBonusType', '');
                                $slotSettings->SetGameData('RulersOfOlympusPTOlympusFreeWilds', []);
                            }
                            else if( $postData['spinType'] == 'free' ) 
                            {
                                $umid = '0';
                                $postData['slotEvent'] = 'freespin';
                                $slotSettings->SetGameData('RulersOfOlympusPTCurrentFreeGame', $slotSettings->GetGameData('RulersOfOlympusPTCurrentFreeGame') + 1);
                                $slotSettings->SetGameData('RulersOfOlympusPTIncreaseMpl', $slotSettings->GetGameData('RulersOfOlympusPTIncreaseMpl') + 1);
                                $bonusMpl = 1;
                            }
                            $linesId = [];
                            if( $slotSettings->GetGameData('RulersOfOlympusPTBonusType') == 'olympus' ) 
                            {
                                $linesId[0] = [
                                    2, 
                                    2, 
                            ...
                            for( $i = 0; $i <= 2000; $i++ ) 
                            {
                                ...
                                $shiftingWilds = $slotSettings->GetGameData('RulersOfOlympusPTShiftingWilds');
                                $wild = [
                                    '22', 
                                    '23', 
                                    '19'
                                ...
                                $scatter = '26';
                                $reels = $slotSettings->GetReelStrips($winType, $postData['slotEvent'], $slotSettings->GetGameData('RulersOfOlympusPTBonusType'));
                                $reelsTmp = $reels;
                                $isBonusStart = false;
                                $reelSetIndex = 0;
                                if( $postData['slotEvent'] == 'freespin' && $slotSettings->GetGameData('RulersOfOlympusPTBonusType') == 'olympus' ) 
                                {
                                    $reelSetIndex = 12;
                                    $oWilds = $slotSettings->GetGameData('RulersOfOlympusPTOlympusFreeWilds');
                                    $owc = 0;
                                    for( $p = 0; $p <= 3; $p++ ) 
                                    {
                                        for( $r = 1; $r <= 5; $r++ ) 
                                    ...
                                    for( $j = 0; $j < count($slotSettings->SymbolGame); $j++ ) 
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            if( $s[0] == $csym || in_array($s[0], $wild) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":1,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('RulersOfOlympusPTBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":["none","none"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":2,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('RulersOfOlympusPTBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":3,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('RulersOfOlympusPTBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) && ($s[3] == $csym || in_array($s[3], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":4,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('RulersOfOlympusPTBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) && ($s[3] == $csym || in_array($s[3], $wild)) && ($s[4] == $csym || in_array($s[4], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":5,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('RulersOfOlympusPTBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":[' . ($linesId[$k][4] - 1) . ',"' . $s[4] . '"]}';
                                                }
                                            }
                                        }
                                    }
                            ...
                            if( $postData['slotEvent'] == 'freespin' ) 
                            {
                                $slotSettings->SetGameData('RulersOfOlympusPTBonusWin', $slotSettings->GetGameData('RulersOfOlympusPTBonusWin') + $totalWin);
                                $slotSettings->SetGameData('RulersOfOlympusPTTotalWin', $totalWin);
                            }
                            else
                            {
                                $slotSettings->SetGameData('RulersOfOlympusPTTotalWin', $totalWin);
                            }
                            $slotSettings->SetGameData('RulersOfOlympusPTBonusStart', false);
                            $olympusWilds = '';
                            if( $scattersCount >= 1 ) 
                            {
                                $slotSettings->SetGameData('RulersOfOlympusPTFreeGames', $slotSettings->slotFreeCount);
                                $slotSettings->SetGameData('RulersOfOlympusPTFreeStartWin', $totalWin);
                                $slotSettings->SetGameData('RulersOfOlympusPTBonusWin', 0);
                                $slotSettings->SetGameData('RulersOfOlympusPTBonusType', 'olympus');
                                $olympusFreeWilds = [
                                    0, 
                                    0, 
                                    0, 
                                ...
                                $slotSettings->SetGameData('RulersOfOlympusPTOlympusFreeWilds', $olympusFreeWilds);
                            }
                            $balanceInCents = sprintf('%01.2f', $slotSettings->GetBalance()) * 100;
                            $spinState = 'REGULAR';
                            ...
                            $isBonus = 'false';
                            if( $slotSettings->GetGameData('RulersOfOlympusPTBonusStart') ) 
                            {
                                $isBonus = 'true';
                            }
                            $slotSettings->SetGameData('RulersOfOlympusPTShiftingWilds', $shiftingWilds);
                            $jsSpin = '' . json_encode($reels) . '';
                            $jsJack = '' . json_encode($slotSettings->Jackpots) . '';
                            $winString = implode(',', $lineWins);
                            $response = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{"OlympusFreeWilds":' . json_encode($slotSettings->GetGameData('RulersOfOlympusPTOlympusFreeWilds')) . ',"BonusType":"' . $slotSettings->GetGameData('RulersOfOlympusPTBonusType') . '","linesArr":[' . implode(',', $postData['lines']) . '],"slotLines":' . $lines . ',"slotBet":' . $betLine . ',"totalFreeGames":' . $slotSettings->GetGameData('RulersOfOlympusPTFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('RulersOfOlympusPTCurrentFreeGame') . ',"Balance":' . $slotSettings->GetBalance() . ',"afterBalance":' . $slotSettings->GetBalance() . ',"bonusWin":' . $slotSettings->GetGameData('RulersOfOlympusPTBonusWin') . ',"freeStartWin":' . $slotSettings->GetGameData('RulersOfOlympusPTFreeStartWin') . ',"totalWin":' . $totalWin . ',"winLines":[' . $winString . '],"bonusInfo":' . $scattersStr . ',"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
                            ...
                            $result_tmp[] = '3:::{"data":{"ww":' . $totalWin . ',"wt":' . json_encode($slotSettings->GetGameData('RulersOfOlympusPTShiftingWilds')) . ',"balance":' . $balanceInCents . ',"results":[' . implode(',', $reels['rp']) . '],"spinType":"' . $spinState . '","symbols":[3,1,8,1,6,6,1,9,2,2,6,6,3,5],"windowId":"qkpJt6"},"ID":40022,"umid":36}';
                            $result_tmp[] = '3:::{"data":{"reelSet":' . $reelSetIndex . ',"display":[' . $rSym . ']' . $olympusWilds . ',"windowId":"NXY2mU"},"ID":49301,"umid":71}';
                            $slotSettings->SetGameData('RulersOfOlympusPTreelSetIndex', $reelSetIndex);
                            $slotSettings->SetGameData('RulersOfOlympusPTresults', $reels['rp']);
                            $slotSettings->SetGameData('RulersOfOlympusPTrSym', $rSym);
                        ...
                        switch( $umid ) 
                        {
                            ...
                            case '40036':
                                ...
                                if( !$slotSettings->HasGameData('RulersOfOlympusPTShiftingWilds') ) 
                                {
                                    $slotSettings->SetGameData('RulersOfOlympusPTShiftingWilds', []);
                                }
                                ...
                                break;
                            case '49149':
                                $reelSetIndex = $slotSettings->GetGameData('RulersOfOlympusPTreelSetIndex');
                                $reels = $slotSettings->GetGameData('RulersOfOlympusPTresults');
                                $rSym = $slotSettings->GetGameData('RulersOfOlympusPTrSym');
                                if( !is_array($reels) ) 
                                {
                                    $reels = [
                                        0, 
