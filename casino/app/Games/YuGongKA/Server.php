                            ...
                            case 'spin':
                                ...
                                for( $i = 0; $i <= 2000; $i++ ) 
                                {
                                    ...
                                    for( $k = 0; $k < $lines; $k++ ) 
                                    {
                                        ...
                                        {
                                            $cWinsMpl[$k] = $bonusMpl * $mpl;
                                            array_push($lineWins, $tmpStringWin);
                                            $totalWin += $cWins[$k];
                                            $cWins[$k] = $cWins[$k] / ($bonusMpl * $mpl);
                                        }
                                    }
                                    $scattersWin = 0;
                                    $scattersStr = '';
                                ...
                                $swu = 0;
                                $swm = 0;
                                if( $postData['slotEvent'] == 'freespin' && $scattersCount >= 2 ) 
                                {
                                ...
                                $result_tmp[0] = '{"sid":' . rand(0, 9999999) . ',"md":{"sid":' . rand(0, 9999999) . ',"tid":"bbdbe1ae735248bf994a7ae0f75bfcd3","sel":' . $lines . ',"cps":5,"dn":0.01,"nd":0.01,"ncps":0,"atb":0,"v":true,"fs":' . $fs_ . ',"twg":' . ($lines * $betline * 100) . ',"swm":' . $swm . ',"sw":' . ($scattersWin * 100) . ',"swu":' . $swu . ',"tw":' . ($totalWin * 100) . ',"fsw":' . $fs . ',"fsr":' . ($slotSettings->GetGameData($slotSettings->slotId . 'FreeGames') - $slotSettings->GetGameData($slotSettings->slotId . 'CurrentFreeGame')) . ',"tfw":' . ($slotSettings->GetGameData($slotSettings->slotId . 'BonusWin') * 100) . ',"st":[' . $curReels . '],"swi":[' . implode(',', $cWinsStr) . '],"snm":[' . implode(',', $cWinsMpl) . '],"ssm":[' . implode(',', $cWinsCount) . '],"sm":[' . $bonusMpl . '],"acb":' . $acb . ',"rf":0,"sp":134,"cr":"USD","sessionId":"c9be2120a19f40f885044ac375313240","rd":' . $slotSettings->GetGameData($slotSettings->slotId . 'CurrentFreeGame') . ',"pbb":' . $balanceInCents . ',"obb":' . $balanceInCents2 . ',"mb":false,"pwa":0,"pac":{}},"pcr":' . $balanceInCents . ',"cr":' . $balanceInCents2 . ',"xp":0,"lvl":{"lvl":1,"xp":0,"bc":0,"cps":5,"sc":200,"wb":0},"dl":0,"cps":[1,2,3,5,10,20,25,50,75,100,250,500,750,1000,1500],"e":false,"ec":0,"cc":"EN"}';
                                break;
