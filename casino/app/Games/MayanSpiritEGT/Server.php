                    ...
                    try
                    {
                        ...
                        switch( $aid ) 
                        {
                            ...
                            case 'settings':
                                ...
                                $result_tmp[] = '{"complex":{"balance":' . $balanceInCents . ',"balanceRaw":' . round($balanceInCents * $slotSettings->CurrentDenom) . ',"paytableCoef":{"0":{"coef":[5,25,100],"multiplier":1},"1":{"coef":[5,25,100],"multiplier":1},"2":{"coef":[5,50,125],"multiplier":1},"3":{"coef":[5,50,125],"multiplier":1},"4":{"coef":[10,100,200],"multiplier":1},"5":{"coef":[10,100,200],"multiplier":1},"6":{"coef":[25,150,350],"multiplier":1},"7":{"coef":[25,150,400],"multiplier":1},"8":{"coef":[50,200,600],"multiplier":1},"9":{"coef":[50,200,600],"multiplier":1},"10":{"coef":[100,225,1000],"multiplier":1},"11":{"coef":[2],"multiplier":1}},"bets":[' . implode(',', $gameBets) . '],"jackpotMinBet":1,"jackpot":true,"mainFakeReels":[[2,4,1,3,2,7,0,6,1,4,9,0,5,10,10,10,10,4,5,8,0,7,1,0,3,8,5,2,3,1],[2,4,1,3,2,7,0,6,1,4,9,0,5,6,1,2,10,10,10,10,9,2,9,6,4,11,0,2,0,2],[2,4,1,3,2,7,0,6,11,4,9,0,5,6,10,10,10,10,5,8,1,4,0,5,0,3,4,0,1,6],[2,4,1,3,2,7,0,6,1,4,9,0,5,6,10,10,10,10,5,7,3,6,0,8,0,5,0,2,11,1],[2,4,1,3,2,7,0,6,1,4,9,0,5,6,1,2,10,10,10,10,0,8,1,0,4,4,5,0,0,2]],"jackpotMaxBet":100000,"denominations":[' . implode(',', $denoms) . ']},"gameIdentificationNumber":' . $postData['gameIdentificationNumber'] . ',"gameNumber":-1,"sessionKey":"41be9e65e0ff03a65e8c93576bf61130","msg":"success","messageId":"' . $postData['messageId'] . '","qName":"app.services.messages.response.GameResponse","command":"settings","eventTimestamp":' . time() . '}';
                                break;
                            case 'subscribe':
                                $hist = [
                                    78, 
                                ...
                                shuffle($hist);
                                $slotSettings->SetGameData('MayanSpiritEGTCards', $hist);
                                $lastEvent = $slotSettings->GetHistory();
                                $slotSettings->SetGameData('MayanSpiritEGTBonusWin', 0);
                                $slotSettings->SetGameData('MayanSpiritEGTFreeGames', 0);
                                $slotSettings->SetGameData('MayanSpiritEGTCurrentFreeGame', 0);
                                $slotSettings->SetGameData('MayanSpiritEGTTotalWin', 0);
                                $slotSettings->SetGameData('MayanSpiritEGTFreeBalance', 0);
                                if( $lastEvent != 'NULL' ) 
                                {
                                    ...
                                    $gtype = 1;
                                    if( $slotSettings->GetGameData('MayanSpiritEGTCurrentFreeGame') < $slotSettings->GetGameData('MayanSpiritEGTFreeGames') && $slotSettings->GetGameData('MayanSpiritEGTFreeGames') > 0 ) 
                                    {
                                        $gtype = 2;
                                    }
                                }
                            ...
                            case 'bet':
                                ...
                                if( $postData['slotEvent'] != 'freespin' ) 
                                {
                                    ...
                                    $slotSettings->SetGameData('MayanSpiritEGTCurrentFreeGame', 0);
                                    $slotSettings->SetGameData('MayanSpiritEGTTotalWin', 0);
                                    $slotSettings->SetGameData('MayanSpiritEGTFreeBalance', sprintf('%01.2f', $slotSettings->GetBalance()) * 100);
                                    $bonusMpl = 1;
                                }
                                else
                                {
                                    $slotSettings->SetGameData('MayanSpiritEGTCurrentFreeGame', $slotSettings->GetGameData('MayanSpiritEGTCurrentFreeGame') + 1);
                                ...
                                if( $postData['slotEvent'] == 'freespin' ) 
                                {
                                    $slotSettings->SetGameData('MayanSpiritEGTBonusWin', $slotSettings->GetGameData('MayanSpiritEGTBonusWin') + $totalWin);
                                    $slotSettings->SetGameData('MayanSpiritEGTTotalWin', $slotSettings->GetGameData('MayanSpiritEGTTotalWin') + $totalWin);
                                    $balanceInCents = $slotSettings->GetGameData('MayanSpiritEGTFreeBalance');
                                }
                                else
                                {
                                    $slotSettings->SetGameData('MayanSpiritEGTTotalWin', $totalWin);
                                }
                                $fs = 0;
                                if( $scattersCount >= 3 ) 
                                {
                                    if( $slotSettings->GetGameData('MayanSpiritEGTFreeGames') > 0 ) 
                                    {
                                        $slotSettings->SetGameData('MayanSpiritEGTFreeGames', $slotSettings->GetGameData('MayanSpiritEGTFreeGames') + $slotSettings->slotFreeCount);
                                    }
                                    else
                                    {
                                        $slotSettings->SetGameData('MayanSpiritEGTFreeStartWin', $totalWin);
                                        $slotSettings->SetGameData('MayanSpiritEGTBonusWin', $totalWin);
                                        $slotSettings->SetGameData('MayanSpiritEGTFreeGames', $slotSettings->slotFreeCount);
                                    }
                                    $fs = $slotSettings->GetGameData('MayanSpiritEGTFreeGames');
                                }
                                $winString = implode(',', $lineWins);
                                $jsSpin = '' . json_encode($reels) . '';
                                $jsJack = '' . json_encode($slotSettings->Jackpots) . '';
                                $response = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{"slotLines":' . $lines . ',"slotBet":' . $betline . ',"totalFreeGames":' . $slotSettings->GetGameData('MayanSpiritEGTFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('MayanSpiritEGTCurrentFreeGame') . ',"Balance":' . $balanceInCents . ',"afterBalance":' . $balanceInCents . ',"bonusWin":' . $slotSettings->GetGameData('MayanSpiritEGTBonusWin') . ',"totalWin":' . $totalWin . ',"winLines":[' . $winString . '],"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
                                $slotSettings->SaveLogReport($response, $allbet, $lines, $reportWin, $postData['slotEvent']);
                                $winstring = '';
                                $slotSettings->SetGameData('MayanSpiritEGTGambleStep', 5);
                                $hist = $slotSettings->GetGameData('MayanSpiritEGTCards');
                                $curReels = '' . rand(0, 6) . ',' . $reels['reel1'][0] . ',' . $reels['reel1'][1] . ',' . $reels['reel1'][2] . ',' . $reels['reel1'][3] . ',' . rand(0, 6);
                                $curReels .= (',' . rand(0, 6) . ',' . $reels['reel2'][0] . ',' . $reels['reel2'][1] . ',' . $reels['reel2'][2] . ',' . $reels['reel2'][3] . ',' . rand(0, 6));
                                $curReels .= (',' . rand(0, 6) . ',' . $reels['reel3'][0] . ',' . $reels['reel3'][1] . ',' . $reels['reel3'][2] . ',' . $reels['reel3'][3] . ',' . rand(0, 6));
                                $curReels .= (',' . rand(0, 6) . ',' . $reels['reel4'][0] . ',' . $reels['reel4'][1] . ',' . $reels['reel4'][2] . ',' . $reels['reel4'][3] . ',' . rand(0, 6));
                                ...
                                if( $jackRandom == 1 ) 
                                {
                                    $state = 'jackpot';
                                    $isJack = 'true';
                                    $slotSettings->SetGameData('MayanSpiritEGTJackSteps', [
                                        0, 
                                        0, 
                                        0, 
                                        0
                                ...
                                if( $postData['slotEvent'] == 'freespin' ) 
                                {
                                    $totalWin = $slotSettings->GetGameData('MayanSpiritEGTBonusWin');
                                    $state = 'freespin';
                                ...
                                break;
                            case 'collect':
                                $result_tmp[] = '{"complex":{"gameCommand":"collect"},"state":"idle","winAmount":' . ($slotSettings->GetGameData('MayanSpiritEGTTotalWin') * 100) . ',"gameIdentificationNumber":' . $postData['gameIdentificationNumber'] . ',"gameNumber":"","balance":' . $balanceInCents . ',"sessionKey":"41be9e65e0ff03a65e8c93576bf61130","msg":"success","messageId":"' . $postData['messageId'] . '","qName":"app.services.messages.response.GameEventResponse","command":"bet","eventTimestamp":' . time() . '}';
                                $slotSettings->SetGameData('MayanSpiritEGTTotalWin', 0);
                                break;
                            case 'jackpot':
                                $jackStep = $slotSettings->GetGameData('MayanSpiritEGTJackSteps');
                                $jackWinID = $slotSettings->GetGameData($slotSettings->slotId . 'JackWinID');
                                if( $jackStep[0] >= 3 || $jackStep[1] >= 3 || $jackStep[2] >= 3 || $jackStep[3] >= 3 || !$slotSettings->HasGameData('MayanSpiritEGTJackSteps') ) 
                                {
                                    exit();
                                }
                                $winAmount = 0;
                                ...
                                $slotSettings->SetGameData('MayanSpiritEGTJackSteps', $jackStep);
                                break;
                            case 'gamble':
                                $Balance = $slotSettings->GetBalance();
                                $isGambleWin = rand(1, $slotSettings->GetGambleSettings());
                                $dealerCard = '';
                                $totalWin = $slotSettings->GetGameData('MayanSpiritEGTTotalWin');
                                $gambleWin = 0;
                                $statBet = $totalWin;
                                $slotSettings->SetGameData('MayanSpiritEGTGambleStep', $slotSettings->GetGameData('MayanSpiritEGTGambleStep') - 1);
                                ...
                                else
                                {
                                    ...
                                    $totalWin = 0;
                                    $slotSettings->SetGameData('MayanSpiritEGTGambleStep', 0);
                                    if( $postData['bet']['color'] == '1' ) 
                                    {
                                        $tmpCards = [
                                            '1', 
                                ...
                                $gtype = 1;
                                $gtype0 = 1;
                                if( $slotSettings->GetGameData('MayanSpiritEGTBonusStart') == 1 ) 
                                {
                                    $gtype0 = 2;
                                }
                                $result_tmp[] = '{"complex":{"gambles":' . $slotSettings->GetGameData('MayanSpiritEGTGambleStep') . ',"card":' . $dealerCard . ',"jackpot":false,"gameCommand":"gamble"},"state":"' . $gambleState . '","winAmount":' . ($totalWin * 100) . ',"gameIdentificationNumber":' . $postData['gameIdentificationNumber'] . ',"gameNumber":"","sessionKey":"88e2b82e6537db4a339e4e1b5ce462cd","msg":"success","messageId":"' . $postData['messageId'] . '","qName":"app.services.messages.response.GameEventResponse","command":"bet","eventTimestamp":' . time() . '}';
                                break;
                        }
