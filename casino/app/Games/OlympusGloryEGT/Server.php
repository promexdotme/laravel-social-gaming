                    ...
                    try
                    {
                        ...
                        switch( $aid ) 
                        {
                            ...
                            case 'subscribe':
                                ...
                                shuffle($hist);
                                $slotSettings->SetGameData('OlympusGloryEGTCards', $hist);
                                $lastEvent = $slotSettings->GetHistory();
                                $slotSettings->SetGameData('OlympusGloryEGTBonusWin', 0);
                                $slotSettings->SetGameData('OlympusGloryEGTFreeGames', 0);
                                $slotSettings->SetGameData('OlympusGloryEGTCurrentFreeGame', 0);
                                $slotSettings->SetGameData('OlympusGloryEGTTotalWin', 0);
                                $slotSettings->SetGameData('OlympusGloryEGTFreeBalance', 0);
                                $slotSettings->SetGameData('OlympusGloryEGTExpandSymbol', -1);
                                if( $lastEvent != 'NULL' ) 
                                {
                                    ...
                                    $gtype = 1;
                                    if( $slotSettings->GetGameData('OlympusGloryEGTCurrentFreeGame') < $slotSettings->GetGameData('OlympusGloryEGTFreeGames') && $slotSettings->GetGameData('OlympusGloryEGTFreeGames') > 0 ) 
                                    {
                                        $gtype = 2;
                                    }
                                }
                            ...
                            case 'bet':
                                ...
                                if( $postData['slotEvent'] != 'freespin' ) 
                                {
                                    ...
                                    $slotSettings->SetGameData('OlympusGloryEGTTotalWin', 0);
                                    $slotSettings->SetGameData('OlympusGloryEGTExpandSymbol', -1);
                                    $slotSettings->SetGameData('OlympusGloryEGTFreeBalance', sprintf('%01.2f', $slotSettings->GetBalance()) * 100);
                                    $slotSettings->SetGameData($slotSettings->slotId . 'FirstSpin', '');
                                    $bonusMpl = 1;
                                }
                                else
                                {
                                    $slotSettings->SetGameData('OlympusGloryEGTCurrentFreeGame', $slotSettings->GetGameData('OlympusGloryEGTCurrentFreeGame') + 1);
                                ...
                                for( $i = 0; $i <= 2000; $i++ ) 
                                {
                                    ...
                                    if( $postData['slotEvent'] == 'freespin' ) 
                                    {
                                        for( $r = 1; $r <= 5; $r++ ) 
                                        {
                                            for( $p = 0; $p <= 2; $p++ ) 
                                            {
                                                if( $reelsEx['reel' . $r][$p] == $slotSettings->GetGameData('OlympusGloryEGTExpandSymbol') ) 
                                                {
                                                    $reelsEx['reel' . $r][0] = $slotSettings->GetGameData('OlympusGloryEGTExpandSymbol');
                                                    $reelsEx['reel' . $r][1] = $slotSettings->GetGameData('OlympusGloryEGTExpandSymbol');
                                                    $reelsEx['reel' . $r][2] = $slotSettings->GetGameData('OlympusGloryEGTExpandSymbol');
                                                    break;
                                                }
                                            }
                                        }
                                    ...
                                    for( $k = 0; $k < $lines; $k++ ) 
                                    {
                                        ...
                                        for( $j = 0; $j < count($slotSettings->SymbolGame); $j++ ) 
                                        {
                                            ...
                                            else
                                            {
                                                ...
                                                if( $postData['slotEvent'] == 'freespin' && $csym == $slotSettings->GetGameData('OlympusGloryEGTExpandSymbol') ) 
                                                {
                                                    $cLineExp = [];
                                                    $exCount = 0;
                                                    for( $ex = 0; $ex < 5; $ex++ ) 
                                ...
                                if( $postData['slotEvent'] == 'freespin' ) 
                                {
                                    $slotSettings->SetGameData('OlympusGloryEGTBonusWin', $slotSettings->GetGameData('OlympusGloryEGTBonusWin') + $totalWin);
                                    $slotSettings->SetGameData('OlympusGloryEGTTotalWin', $slotSettings->GetGameData('OlympusGloryEGTTotalWin') + $totalWin);
                                    $balanceInCents = $slotSettings->GetGameData('OlympusGloryEGTFreeBalance');
                                }
                                else
                                {
                                    $slotSettings->SetGameData('OlympusGloryEGTTotalWin', $totalWin);
                                }
                                $fs = 0;
                                $firstSpinLog = '';
                                $curReels = '' . rand(0, 6) . ',' . $reels['reel1'][0] . ',' . $reels['reel1'][1] . ',' . $reels['reel1'][2] . ',' . rand(0, 6);
                                ...
                                if( $scattersCount >= 3 ) 
                                {
                                    if( $slotSettings->GetGameData('OlympusGloryEGTFreeGames') > 0 ) 
                                    {
                                        $slotSettings->SetGameData('OlympusGloryEGTFreeGames', $slotSettings->GetGameData('OlympusGloryEGTFreeGames') + $slotSettings->slotFreeCount);
                                    }
                                    else
                                    {
                                        $slotSettings->SetGameData('OlympusGloryEGTExpandSymbol', rand(0, 8));
                                        $slotSettings->SetGameData('OlympusGloryEGTFreeStartWin', $totalWin);
                                        $slotSettings->SetGameData('OlympusGloryEGTBonusWin', $totalWin);
                                        $slotSettings->SetGameData('OlympusGloryEGTFreeGames', $slotSettings->slotFreeCount);
                                        $slotSettings->SetGameData($slotSettings->slotId . 'FirstSpin', ',"firstSpin":{"expand":[],"reels":[' . $curReels . '],"lines":[],"expand":[],"scatters":[' . $scattersStr . ']}');
                                    }
                                    $fs = $slotSettings->GetGameData('OlympusGloryEGTFreeGames');
                                }
                                $winString = implode(',', $lineWins);
                                $winStringExpand = implode(',', $lineWins2);
                                $jsSpin = '' . json_encode($reels) . '';
                                $jsJack = '' . json_encode($slotSettings->Jackpots) . '';
                                $response = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{"slotLines":' . $lines . '' . $slotSettings->GetGameData($slotSettings->slotId . 'FirstSpin') . ',"slotBet":' . $betline . ',"totalFreeGames":' . $slotSettings->GetGameData('OlympusGloryEGTFreeGames') . ',"freeSpinsExpandLines": [' . $winStringExpand . '],"freeSpinsExpandSymbol":' . $slotSettings->GetGameData('OlympusGloryEGTExpandSymbol') . ',"freeSpinsExpandWinAmount": ' . $expandWin . ',"currentFreeGames":' . $slotSettings->GetGameData('OlympusGloryEGTCurrentFreeGame') . ',"Balance":' . $balanceInCents . ',"afterBalance":' . $balanceInCents . ',"bonusWin":' . $slotSettings->GetGameData('OlympusGloryEGTBonusWin') . ',"totalWin":' . $totalWin . ',"winLines":[' . $winString . '],"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
                                $slotSettings->SaveLogReport($response, $allbet, $lines, $reportWin, $postData['slotEvent']);
                                $winstring = '';
                                $slotSettings->SetGameData('OlympusGloryEGTGambleStep', 5);
                                $hist = $slotSettings->GetGameData('OlympusGloryEGTCards');
                                if( $jackRandom == 1 ) 
                                {
                                    $state = 'jackpot';
                                    $isJack = 'true';
                                    $slotSettings->SetGameData('OlympusGloryEGTJackSteps', [
                                        0, 
                                        0, 
                                        0, 
                                        0
                                ...
                                if( $postData['slotEvent'] == 'freespin' ) 
                                {
                                    $totalWin = $slotSettings->GetGameData('OlympusGloryEGTBonusWin');
                                    $state = 'freespin';
                                ...
                                $result_tmp[] = '{"complex":{"gambles":5,"reels":[' . $curReels . '],"lines":[' . $winString . '],"scatters":[' . $scattersStr . '],"freespinScatters":[' . $scatter . '],"expand":[],"gambles":5,"freespinScatters":[9],"freespins":' . $fs . ',"jackpot":' . $isJack . ',"freeSpinsExpandSymbol":' . $slotSettings->GetGameData('OlympusGloryEGTExpandSymbol') . ',"freeSpinsExpandLines":[' . $winStringExpand . '],"freeSpinsExpandWinAmount":' . $expandWin . ',"gameCommand":"bet"},"state":"' . $state . '","winAmount":' . ($totalWin * 100) . ',"gameIdentificationNumber":' . $postData['gameIdentificationNumber'] . ',"gameNumber":1786348900601,"balance":' . $balanceInCents . ',"sessionKey":"894b17d797618b2d99d0c94df1d88e72","msg":"success","messageId":"' . $postData['messageId'] . '","qName":"app.services.messages.response.GameEventResponse","command":"bet","eventTimestamp":' . time() . '}';
                                ...
                                break;
                            case 'collect':
                                $result_tmp[] = '{"complex":{"gameCommand":"collect"},"state":"idle","winAmount":' . ($slotSettings->GetGameData('OlympusGloryEGTTotalWin') * 100) . ',"gameIdentificationNumber":' . $postData['gameIdentificationNumber'] . ',"gameNumber":"","balance":' . $balanceInCents . ',"sessionKey":"41be9e65e0ff03a65e8c93576bf61130","msg":"success","messageId":"' . $postData['messageId'] . '","qName":"app.services.messages.response.GameEventResponse","command":"bet","eventTimestamp":' . time() . '}';
                                $slotSettings->SetGameData('OlympusGloryEGTTotalWin', 0);
                                break;
                            case 'jackpot':
                                $jackStep = $slotSettings->GetGameData('OlympusGloryEGTJackSteps');
                                $jackWinID = $slotSettings->GetGameData($slotSettings->slotId . 'JackWinID');
                                if( $jackStep[0] >= 3 || $jackStep[1] >= 3 || $jackStep[2] >= 3 || $jackStep[3] >= 3 || !$slotSettings->HasGameData('OlympusGloryEGTJackSteps') ) 
                                {
                                    exit();
                                }
                                $winAmount = 0;
                                ...
                                $slotSettings->SetGameData('OlympusGloryEGTJackSteps', $jackStep);
                                break;
                            case 'gamble':
                                $Balance = $slotSettings->GetBalance();
                                $isGambleWin = rand(1, $slotSettings->GetGambleSettings());
                                $dealerCard = '';
                                $totalWin = $slotSettings->GetGameData('OlympusGloryEGTTotalWin');
                                $gambleWin = 0;
                                $statBet = $totalWin;
                                $slotSettings->SetGameData('OlympusGloryEGTGambleStep', $slotSettings->GetGameData('OlympusGloryEGTGambleStep') - 1);
                                ...
                                else
                                {
                                    ...
                                    $totalWin = 0;
                                    $slotSettings->SetGameData('OlympusGloryEGTGambleStep', 0);
                                    if( $postData['bet']['color'] == '1' ) 
                                    {
                                        $tmpCards = [
                                            '1', 
                                ...
                                $gtype = 1;
                                $gtype0 = 1;
                                if( $slotSettings->GetGameData('OlympusGloryEGTBonusStart') == 1 ) 
                                {
                                    $gtype0 = 2;
                                }
                                $result_tmp[] = '{"complex":{"gambles":' . $slotSettings->GetGameData('OlympusGloryEGTGambleStep') . ',"card":' . $dealerCard . ',"jackpot":false,"gameCommand":"gamble"},"state":"' . $gambleState . '","winAmount":' . ($totalWin * 100) . ',"gameIdentificationNumber":' . $postData['gameIdentificationNumber'] . ',"gameNumber":"","sessionKey":"88e2b82e6537db4a339e4e1b5ce462cd","msg":"success","messageId":"' . $postData['messageId'] . '","qName":"app.services.messages.response.GameEventResponse","command":"bet","eventTimestamp":' . time() . '}';
                                break;
                        }
