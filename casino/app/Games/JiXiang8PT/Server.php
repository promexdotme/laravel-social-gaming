                ...
                \DB::transaction(function() use ($request, $game)
                {
                    try
                    {
                        ...
                        if( isset($postData['ID']) && $postData['ID'] == '46123' ) 
                        {
                            ...
                            $bonusMpl = 1;
                            $slotSettings->SetGameData('JiXiang8PTBonusWin', 0);
                            $slotSettings->SetGameData('JiXiang8PTFreeGames', 0);
                            $slotSettings->SetGameData('JiXiang8PTCurrentFreeGame', 0);
                            $slotSettings->SetGameData('JiXiang8PTTotalWin', 0);
                            $slotSettings->SetGameData('JiXiang8PTFreeBalance', 0);
                            $slotSettings->SetGameData('JiXiang8PTFreeStartWin', 0);
                            $linesId[0] = [
                                2, 
                                2, 
                                2, 
                                    ...
                                    for( $j = 0; $j < count($slotSettings->SymbolGame); $j++ ) 
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            if( $s[0] == $csym && $s[1] == $csym && $s[2] == $csym ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":3,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('JiXiang8PTBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                        }
                                    }
                            ...
                            if( $postData['slotEvent'] == 'freespin' ) 
                            {
                                $slotSettings->SetGameData('JiXiang8PTBonusWin', $slotSettings->GetGameData('JiXiang8PTBonusWin') + $totalWin);
                                $slotSettings->SetGameData('JiXiang8PTTotalWin', $totalWin);
                            }
                            else
                            {
                                $slotSettings->SetGameData('JiXiang8PTTotalWin', $totalWin);
                            ...
                            $response = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{"slotLines":' . $lines . ',"slotBet":' . $betLine . ',"totalFreeGames":' . $slotSettings->GetGameData('JiXiang8PTFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('JiXiang8PTCurrentFreeGame') . ',"Balance":' . $slotSettings->GetBalance() . ',"afterBalance":' . $slotSettings->GetBalance() . ',"bonusWin":' . $slotSettings->GetGameData('JiXiang8PTBonusWin') . ',"freeStartWin":' . $slotSettings->GetGameData('JiXiang8PTFreeStartWin') . ',"totalWin":' . $totalWin . ',"winLines":[' . $winString . '],"bonusInfo":' . $scattersStr . ',"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
