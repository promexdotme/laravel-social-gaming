...
namespace VanguardLTE\Games\Cleocatra
{
    ...
    use VanguardLTE\Games\Cleocatra\PragmaticLib\Collect;
    use VanguardLTE\Games\Cleocatra\PragmaticLib\GameSettings;
    use VanguardLTE\Games\Cleocatra\PragmaticLib\Loader;
    use VanguardLTE\Games\Cleocatra\PragmaticLib\Log;
    use VanguardLTE\Games\Cleocatra\PragmaticLib\Spin;
    use VanguardLTE\Games\Cleocatra\PragmaticLib\DoMysteryScatter;
    use VanguardLTE\Games\Cleocatra\PragmaticLib\DoBonus;
