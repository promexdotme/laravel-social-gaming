                    ...
                    try
                    {
                        ...
                        switch( $aid ) 
                        {
                            ...
                            case 'subscribe':
                                ...
                                shuffle($hist);
                                $slotSettings->SetGameData('RainbowDiceEGTCards', $hist);
                                $lastEvent = $slotSettings->GetHistory();
                                $slotSettings->SetGameData('RainbowDiceEGTBonusWin', 0);
                                $slotSettings->SetGameData('RainbowDiceEGTFreeGames', 0);
                                $slotSettings->SetGameData('RainbowDiceEGTCurrentFreeGame', 0);
                                $slotSettings->SetGameData('RainbowDiceEGTTotalWin', 0);
                                $slotSettings->SetGameData('RainbowDiceEGTFreeBalance', 0);
                                $slotSettings->SetGameData($slotSettings->slotId . 'allWilds', []);
                                $slotSettings->SetGameData($slotSettings->slotId . 'passedClovers', 0);
                                if( $lastEvent != 'NULL' ) 
                                {
                                    ...
                                    $slotSettings->SetGameData($slotSettings->slotId . 'allWilds', $lastEvent->serverResponse->allWilds);
                                    $slotSettings->SetGameData($slotSettings->slotId . 'passedClovers', $lastEvent->serverResponse->passedClovers);
                                    ...
                                    $gtype = 1;
                                    if( $slotSettings->GetGameData('RainbowDiceEGTCurrentFreeGame') < $slotSettings->GetGameData('RainbowDiceEGTFreeGames') && $slotSettings->GetGameData('RainbowDiceEGTFreeGames') > 0 ) 
                                    {
                                        $gtype = 2;
                                    }
                                }
                            ...
                            case 'bet':
                                ...
                                if( $postData['slotEvent'] != 'freespin' ) 
                                {
                                    ...
                                    $slotSettings->SetGameData('RainbowDiceEGTCurrentFreeGame', 0);
                                    $slotSettings->SetGameData('RainbowDiceEGTTotalWin', 0);
                                    $slotSettings->SetGameData('RainbowDiceEGTFreeBalance', sprintf('%01.2f', $slotSettings->GetBalance()) * 100);
                                    $slotSettings->SetGameData($slotSettings->slotId . 'allWilds', []);
                                    $slotSettings->SetGameData($slotSettings->slotId . 'passedClovers', 0);
                                    $bonusMpl = 1;
                                }
                                ...
                                {
                                    $slotSettings->SetGameData('RainbowDiceEGTCurrentFreeGame', $slotSettings->GetGameData('RainbowDiceEGTCurrentFreeGame') + 1);
                                ...
                                for( $i = 0; $i <= 2000; $i++ ) 
                                {
                                    ...
                                    if( $postData['slotEvent'] == 'freespin' ) 
                                    {
                                        $wildsFree = $slotSettings->GetGameData($slotSettings->slotId . 'allWilds');
                                        $wild = array_merge($wild, $wildsFree);
                                    }
                                    for( $k = 0; $k < $lines; $k++ ) 
                                    {
                                        $tmpStringWin = '';
                                ...
                                if( $isClover ) 
                                {
                                    $slotSettings->SetGameData($slotSettings->slotId . 'passedClovers', $slotSettings->GetGameData($slotSettings->slotId . 'passedClovers') + 1);
                                    if( $slotSettings->GetGameData($slotSettings->slotId . 'passedClovers') == 3 ) 
                                    {
                                        $allwilds = $slotSettings->GetGameData($slotSettings->slotId . 'allWilds');
                                        $allwilds[] = 8;
                                        $newWild = 8;
                                        $slotSettings->SetGameData($slotSettings->slotId . 'allWilds', $allwilds);
                                    }
                                    if( $slotSettings->GetGameData($slotSettings->slotId . 'passedClovers') == 6 ) 
                                    {
                                        $allwilds = $slotSettings->GetGameData($slotSettings->slotId . 'allWilds');
                                        $allwilds[] = 7;
                                        $newWild = 7;
                                    ...
                                    if( $slotSettings->GetGameData($slotSettings->slotId . 'passedClovers') == 9 ) 
                                    {
                                        $allwilds = $slotSettings->GetGameData($slotSettings->slotId . 'allWilds');
                                        $allwilds[] = 6;
                                        $newWild = 6;
                                    ...
                                    if( $slotSettings->GetGameData($slotSettings->slotId . 'passedClovers') == 12 ) 
                                    {
                                        $allwilds = $slotSettings->GetGameData($slotSettings->slotId . 'allWilds');
                                        $allwilds[] = 5;
                                        $newWild = 5;
                                ...
                                if( $postData['slotEvent'] == 'freespin' ) 
                                {
                                    $slotSettings->SetGameData('RainbowDiceEGTBonusWin', $slotSettings->GetGameData('RainbowDiceEGTBonusWin') + $totalWin);
                                    $slotSettings->SetGameData('RainbowDiceEGTTotalWin', $slotSettings->GetGameData('RainbowDiceEGTTotalWin') + $totalWin);
                                    $balanceInCents = $slotSettings->GetGameData('RainbowDiceEGTFreeBalance');
                                }
                                else
                                {
                                    $slotSettings->SetGameData('RainbowDiceEGTTotalWin', $totalWin);
                                }
                                $fs = 0;
                                if( $scattersCount >= 3 ) 
                                {
                                    if( $slotSettings->GetGameData('RainbowDiceEGTFreeGames') > 0 ) 
                                    {
                                        $slotSettings->SetGameData('RainbowDiceEGTFreeGames', $slotSettings->GetGameData('RainbowDiceEGTFreeGames') + $slotSettings->slotFreeCount);
                                    }
                                    else
                                    {
                                        $slotSettings->SetGameData('RainbowDiceEGTFreeStartWin', $totalWin);
                                        $slotSettings->SetGameData('RainbowDiceEGTBonusWin', $totalWin);
                                        $slotSettings->SetGameData('RainbowDiceEGTFreeGames', $slotSettings->slotFreeCount);
                                    }
                                    $fs = $slotSettings->GetGameData('RainbowDiceEGTFreeGames');
                                }
                                $curReels = '' . rand(0, 6) . ',' . $reels['reel1'][0] . ',' . $reels['reel1'][1] . ',' . $reels['reel1'][2] . ',' . rand(0, 6);
                                $curReels .= (',' . rand(0, 6) . ',' . $reels['reel2'][0] . ',' . $reels['reel2'][1] . ',' . $reels['reel2'][2] . ',' . rand(0, 6));
                                $curReels .= (',' . rand(0, 6) . ',' . $reels['reel3'][0] . ',' . $reels['reel3'][1] . ',' . $reels['reel3'][2] . ',' . rand(0, 6));
                                ...
                                $response = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{"slotLines":' . $lines . '' . $slotSettings->GetGameData($slotSettings->slotId . 'FirstSpin') . ',"allWilds":[' . implode(',', $slotSettings->GetGameData($slotSettings->slotId . 'allWilds')) . '],"passedClovers":' . $slotSettings->GetGameData($slotSettings->slotId . 'passedClovers') . ',"slotBet":' . $betline . ',"totalFreeGames":' . $slotSettings->GetGameData('RainbowDiceEGTFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('RainbowDiceEGTCurrentFreeGame') . ',"Balance":' . $balanceInCents . ',"afterBalance":' . $balanceInCents . ',"bonusWin":' . $slotSettings->GetGameData('RainbowDiceEGTBonusWin') . ',"totalWin":' . $totalWin . ',"winLines":[' . $winString . '],"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
                                $slotSettings->SaveLogReport($response, $allbet, $lines, $reportWin, $postData['slotEvent']);
                                $winstring = '';
                                $slotSettings->SetGameData('RainbowDiceEGTGambleStep', 5);
                                $hist = $slotSettings->GetGameData('RainbowDiceEGTCards');
                                if( $jackRandom == 1 ) 
                                {
                                    $state = 'jackpot';
                                    $isJack = 'true';
                                    $slotSettings->SetGameData('RainbowDiceEGTJackSteps', [
                                        0, 
                                        0, 
                                        0, 
                                        0
                                ...
                                if( $postData['slotEvent'] == 'freespin' ) 
                                {
                                    $totalWin = $slotSettings->GetGameData('RainbowDiceEGTBonusWin');
                                    $state = 'freespin';
                                ...
                                $result_tmp[] = '{"complex":{"gambles":5,"reels":[' . $curReels . '],"lines":[' . $winString . '],"scatters":[' . $scattersStr . '],"freespinScatters":[' . $scatter . '],"clover":[' . $clover . '],"newWild":' . $newWild . ',"allWilds":[' . implode(',', $slotSettings->GetGameData($slotSettings->slotId . 'allWilds')) . '],"passedClovers":' . $slotSettings->GetGameData($slotSettings->slotId . 'passedClovers') . ',"expand":[],"specialExpand":[],"gambles":5,"freespins":' . $fs . ',"jackpot":' . $isJack . ',"gameCommand":"bet"},"state":"' . $state . '","winAmount":' . ($totalWin * 100) . ',"gameIdentificationNumber":' . $postData['gameIdentificationNumber'] . ',"gameNumber":"","balance":' . $balanceInCents . ',"sessionKey":"41be9e65e0ff03a65e8c93576bf61130","msg":"success","messageId":"' . $postData['messageId'] . '","qName":"app.services.messages.response.GameEventResponse","command":"bet","eventTimestamp":' . time() . '}';
                                ...
                                break;
                            case 'collect':
                                $result_tmp[] = '{"complex":{"gameCommand":"collect"},"state":"idle","winAmount":' . ($slotSettings->GetGameData('RainbowDiceEGTTotalWin') * 100) . ',"gameIdentificationNumber":' . $postData['gameIdentificationNumber'] . ',"gameNumber":"","balance":' . $balanceInCents . ',"sessionKey":"41be9e65e0ff03a65e8c93576bf61130","msg":"success","messageId":"' . $postData['messageId'] . '","qName":"app.services.messages.response.GameEventResponse","command":"bet","eventTimestamp":' . time() . '}';
                                $slotSettings->SetGameData('RainbowDiceEGTTotalWin', 0);
                                break;
                            case 'jackpot':
                                $jackStep = $slotSettings->GetGameData('RainbowDiceEGTJackSteps');
                                $jackWinID = $slotSettings->GetGameData($slotSettings->slotId . 'JackWinID');
                                if( $jackStep[0] >= 3 || $jackStep[1] >= 3 || $jackStep[2] >= 3 || $jackStep[3] >= 3 || !$slotSettings->HasGameData('RainbowDiceEGTJackSteps') ) 
                                {
                                    exit();
                                }
                                $winAmount = 0;
                                ...
                                $slotSettings->SetGameData('RainbowDiceEGTJackSteps', $jackStep);
                                break;
                            case 'gamble':
                                $Balance = $slotSettings->GetBalance();
                                $isGambleWin = rand(1, $slotSettings->GetGambleSettings());
                                $dealerCard = '';
                                $totalWin = $slotSettings->GetGameData('RainbowDiceEGTTotalWin');
                                $gambleWin = 0;
                                $statBet = $totalWin;
                                $slotSettings->SetGameData('RainbowDiceEGTGambleStep', $slotSettings->GetGameData('RainbowDiceEGTGambleStep') - 1);
                                ...
                                else
                                {
                                    ...
                                    $totalWin = 0;
                                    $slotSettings->SetGameData('RainbowDiceEGTGambleStep', 0);
                                    if( $postData['bet']['color'] == '1' ) 
                                    {
                                        $tmpCards = [
                                            '1', 
                                ...
                                $gtype = 1;
                                $gtype0 = 1;
                                if( $slotSettings->GetGameData('RainbowDiceEGTBonusStart') == 1 ) 
                                {
                                    $gtype0 = 2;
                                }
                                $result_tmp[] = '{"complex":{"gambles":' . $slotSettings->GetGameData('RainbowDiceEGTGambleStep') . ',"card":' . $dealerCard . ',"jackpot":false,"gameCommand":"gamble"},"state":"' . $gambleState . '","winAmount":' . ($totalWin * 100) . ',"gameIdentificationNumber":' . $postData['gameIdentificationNumber'] . ',"gameNumber":"","sessionKey":"88e2b82e6537db4a339e4e1b5ce462cd","msg":"success","messageId":"' . $postData['messageId'] . '","qName":"app.services.messages.response.GameEventResponse","command":"bet","eventTimestamp":' . time() . '}';
                                break;
                        }
