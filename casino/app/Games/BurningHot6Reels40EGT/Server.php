                    ...
                    try
                    {
                        ...
                        switch( $aid ) 
                        {
                            ...
                            case 'settings':
                                ...
                                $result_tmp[] = '{"complex":{"balance":' . $balanceInCents . ',"balanceRaw":' . round($balanceInCents * $slotSettings->CurrentDenom) . ',"paytableCoef":{"0":{"coef":[10,25,100,250],"multiplier":1},"1":{"coef":[10,25,100,250],"multiplier":1},"2":{"coef":[10,25,100,250],"multiplier":1},"3":{"coef":[10,25,100,250],"multiplier":1},"4":{"coef":[20,50,250,750],"multiplier":1},"5":{"coef":[25,100,500,1500],"multiplier":1},"6":{"coef":[25,100,500,1500],"multiplier":1},"7":{"coef":[50,200,1000,6000],"multiplier":1},"8":{"coef":[],"multiplier":1},"9":{"coef":[10,200],"multiplier":1},"10":{"coef":[2,20,250,500],"multiplier":1}},"bets":[' . implode(',', $gameBets) . '],"jackpotMinBet":1,"jackpot":true,"mainFakeReels":[[6,2,2,2,0,0,0,5,4,1,5,10,1,1,3,4,7,4,0,4],[7,2,2,2,5,3,0,0,10,6,3,3,1,1,4,1,4,8,4,9],[6,1,1,8,7,1,5,3,3,9,1,4,0,4,2,2,2,10,9,9],[1,1,1,7,1,3,3,8,6,4,3,4,2,2,10,2,0,0,5,9],[7,3,3,8,2,2,1,6,10,1,1,3,3,5,2,7,0,0,4,9],[7,3,5,2,2,1,6,10,1,1,3,3,3,2,7,0,0,4,0,4]],"jackpotMaxBet":100000,"denominations":[' . implode(',', $denoms) . ']},"gameIdentificationNumber":' . $postData['gameIdentificationNumber'] . ',"gameNumber":"","sessionKey":"41be9e65e0ff03a65e8c93576bf61130","msg":"success","messageId":"' . $postData['messageId'] . '","qName":"app.services.messages.response.GameResponse","command":"settings","eventTimestamp":' . time() . '}';
                                break;
                            case 'subscribe':
                                $hist = [
                                    78, 
                                ...
                                shuffle($hist);
                                $slotSettings->SetGameData('BurningHot6Reels40EGTCards', $hist);
                                $lastEvent = $slotSettings->GetHistory();
                                $slotSettings->SetGameData('BurningHot6Reels40EGTBonusWin', 0);
                                $slotSettings->SetGameData('BurningHot6Reels40EGTFreeGames', 0);
                                $slotSettings->SetGameData('BurningHot6Reels40EGTCurrentFreeGame', 0);
                                $slotSettings->SetGameData('BurningHot6Reels40EGTTotalWin', 0);
                                $slotSettings->SetGameData('BurningHot6Reels40EGTFreeBalance', 0);
                                if( $lastEvent != 'NULL' ) 
                                {
                                    ...
                                    $curReels = '' . rand(1, 8) . ',' . $reels->reel1[0] . ',' . $reels->reel1[1] . ',' . $reels->reel1[2] . ',' . $reels->reel1[3] . ',' . rand(1, 8);
                                    $curReels .= (',' . rand(1, 8) . ',' . $reels->reel2[0] . ',' . $reels->reel2[1] . ',' . $reels->reel2[2] . ',' . $reels->reel2[3] . ',' . rand(1, 8));
                                    $curReels .= (',' . rand(1, 8) . ',' . $reels->reel3[0] . ',' . $reels->reel3[1] . ',' . $reels->reel3[2] . ',' . $reels->reel3[3] . ',' . rand(1, 8));
                                    $curReels .= (',' . rand(1, 8) . ',' . $reels->reel4[0] . ',' . $reels->reel4[1] . ',' . $reels->reel4[2] . ',' . $reels->reel4[3] . ',' . rand(1, 8));
                                    $curReels .= (',' . rand(1, 8) . ',' . $reels->reel5[0] . ',' . $reels->reel5[1] . ',' . $reels->reel5[2] . ',' . $reels->reel5[3] . ',' . rand(1, 8));
                                    $curReels .= (',' . rand(1, 8) . ',' . $reels->reel6[0] . ',' . $reels->reel6[1] . ',' . $reels->reel6[2] . ',' . $reels->reel6[3] . ',' . rand(1, 8));
                                    $lines = $lastEvent->serverResponse->slotLines;
                                    $bet = $lastEvent->serverResponse->slotBet * $lines * 100;
                                    $gtype = 1;
                                    if( $slotSettings->GetGameData('BurningHot6Reels40EGTCurrentFreeGame') < $slotSettings->GetGameData('BurningHot6Reels40EGTFreeGames') && $slotSettings->GetGameData('BurningHot6Reels40EGTFreeGames') > 0 ) 
                                    {
                                        $gtype = 2;
                                    }
                                }
                                ...
                                {
                                    $gtype = 1;
                                    $curReels = '' . rand(1, 8) . ',' . rand(0, 8) . ',' . rand(1, 8) . ',' . rand(1, 8) . ',' . rand(1, 8) . ',' . rand(1, 8) . ',' . rand(1, 8) . ',' . rand(1, 8) . ',' . rand(1, 8) . ',' . rand(1, 8) . ',' . rand(1, 8) . ',' . rand(1, 8) . ',' . rand(1, 8) . ',' . rand(1, 8) . ',' . rand(1, 8) . ',' . rand(1, 8) . ',' . rand(1, 8) . ',' . rand(1, 8) . ',' . rand(1, 8) . ',' . rand(1, 8) . ',' . rand(1, 8) . ',' . rand(1, 8) . ',' . rand(1, 8) . ',' . rand(1, 8) . ',' . rand(1, 8) . ',' . rand(1, 8) . ',' . rand(1, 8) . ',' . rand(1, 8) . ',' . rand(1, 8) . ',' . rand(1, 8) . ',' . rand(1, 8) . ',' . rand(1, 8) . ',' . rand(1, 8) . ',' . rand(1, 8) . ',' . rand(1, 8) . ',' . rand(1, 8) . '';
                                    $lines = 10;
                                }
                                $result_tmp[] = '{"complex":{"currentState":{"gamblesUsed":0,"freespinsUsed":0,"previousGambles":[],"bet":100,"numberOfLines":20,"denomination":100,"state":"idle","winAmount":0,"reels":[' . $curReels . '],"lines":[],"scatters":[],"expand":[],"specialExpand":[],"gambles":5,"freespins":0,"freespinScatters":[],"jackpot":false},"jackpotState":{"levelI":' . ($slotSettings->slotJackpot[0] * 100) . ',"levelII":' . ($slotSettings->slotJackpot[1] * 100) . ',"levelIII":' . ($slotSettings->slotJackpot[2] * 100) . ',"levelIV":' . ($slotSettings->slotJackpot[3] * 100) . ',"winsLevelI":0,"largestWinLevelI":0,"largestWinDateLevelI":"","largestWinUserLevelI":"","lastWinLevelI":0,"lastWinDateLevelI":"","lastWinUserLevelI":"player","winsLevelII":0,"largestWinLevelII":0,"largestWinDateLevelII":"","largestWinUserLevelII":"","lastWinLevelII":0,"lastWinDateLevelII":"","lastWinUserLevelII":"player","winsLevelIII":0,"largestWinLevelIII":0,"largestWinDateLevelIII":"","largestWinUserLevelIII":"","lastWinLevelIII":0,"lastWinDateLevelIII":"","lastWinUserLevelIII":"","winsLevelIV":18133,"largestWinLevelIV":0,"largestWinDateLevelIV":"","largestWinUserLevelIV":"","lastWinLevelIV":0,"lastWinDateLevelIV":"","lastWinUserLevelIV":""}},"gameIdentificationNumber":' . $postData['gameIdentificationNumber'] . ',"gameNumber":"","sessionKey":"41be9e65e0ff03a65e8c93576bf61130","msg":"success","messageId":"' . $postData['messageId'] . '","qName":"app.services.messages.response.GameEventResponse","command":"subscribe","eventTimestamp":' . time() . '}';
                                break;
                            case 'ping':
                                $cashBackBtn = 0;
                            ...
                            case 'bet':
                                ...
                                for( $i = 0; $i <= 2000; $i++ ) 
                                {
                                    ...
                                    {
                                        $sgwin = 0;
                                        $scattersStr = '{"scatterName":' . $scatter2 . ',"cells":[' . implode(',', $scPos2) . '],"winAmount":' . ($scattersWin2 * 100) . ',"freespins":0}';
                                    }
                                ...
                                $response = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{"slotLines":' . $lines . ',"slotBet":' . $betline . ',"totalFreeGames":' . $slotSettings->GetGameData('BurningHot6Reels40EGTFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('BurningHot6Reels40EGTCurrentFreeGame') . ',"Balance":' . $slotSettings->GetBalance() . ',"afterBalance":' . $slotSettings->GetBalance() . ',"bonusWin":' . $slotSettings->GetGameData('BurningHot6Reels40EGTBonusWin') . ',"totalWin":' . $totalWin . ',"winLines":[' . $winString . '],"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
                                $slotSettings->SaveLogReport($response, $allbet, $lines, $reportWin, $postData['slotEvent']);
                                $winstring = '';
                                $slotSettings->SetGameData('BurningHot6Reels40EGTTotalWin', $totalWin);
                                $slotSettings->SetGameData('BurningHot6Reels40EGTGambleStep', 5);
                                $hist = $slotSettings->GetGameData('BurningHot6Reels40EGTCards');
                                $curReels = '' . rand(1, 8) . ',' . $reels['reel1'][0] . ',' . $reels['reel1'][1] . ',' . $reels['reel1'][2] . ',' . $reels['reel1'][3] . ',' . rand(1, 8);
                                $curReels .= (',' . rand(1, 8) . ',' . $reels['reel2'][0] . ',' . $reels['reel2'][1] . ',' . $reels['reel2'][2] . ',' . $reels['reel2'][3] . ',' . rand(1, 8));
                                $curReels .= (',' . rand(1, 8) . ',' . $reels['reel3'][0] . ',' . $reels['reel3'][1] . ',' . $reels['reel3'][2] . ',' . $reels['reel3'][3] . ',' . rand(1, 8));
                                $curReels .= (',' . rand(1, 8) . ',' . $reels['reel4'][0] . ',' . $reels['reel4'][1] . ',' . $reels['reel4'][2] . ',' . $reels['reel4'][3] . ',' . rand(1, 8));
                                ...
                                if( $jackRandom == 1 ) 
                                {
                                    $state = 'jackpot';
                                    $isJack = 'true';
                                    $slotSettings->SetGameData('BurningHot6Reels40EGTJackSteps', [
                                        0, 
                                        0, 
                                        0, 
                                        0
                                ...
                                $result_tmp[] = '{"complex":{"gambles":5,"reels":[' . $curReels . '],"lines":[' . $winString . '],"scatters":[' . $scattersStr . '],"freespinScatters":[' . $scatter . '],"expand":[' . implode(',', $expandArr) . '],"specialExpand":[],"gambles":5,"freespins":0,"jackpot":' . $isJack . ',"gameCommand":"bet"},"state":"' . $state . '","winAmount":' . ($totalWin * 100) . ',"gameIdentificationNumber":' . $postData['gameIdentificationNumber'] . ',"gameNumber":"","balance":' . $balanceInCents . ',"sessionKey":"41be9e65e0ff03a65e8c93576bf61130","msg":"success","messageId":"' . $postData['messageId'] . '","qName":"app.services.messages.response.GameEventResponse","command":"bet","eventTimestamp":' . time() . '}';
                                ...
                                break;
                            case 'collect':
                                $result_tmp[] = '{"complex":{"gameCommand":"collect"},"state":"idle","winAmount":' . ($slotSettings->GetGameData('BurningHot6Reels40EGTTotalWin') * 100) . ',"gameIdentificationNumber":' . $postData['gameIdentificationNumber'] . ',"gameNumber":"","balance":' . $balanceInCents . ',"sessionKey":"41be9e65e0ff03a65e8c93576bf61130","msg":"success","messageId":"' . $postData['messageId'] . '","qName":"app.services.messages.response.GameEventResponse","command":"bet","eventTimestamp":' . time() . '}';
                                $slotSettings->SetGameData('BurningHot6Reels40EGTTotalWin', 0);
                                break;
                            case 'jackpot':
                                $jackStep = $slotSettings->GetGameData('BurningHot6Reels40EGTJackSteps');
                                $jackWinID = $slotSettings->GetGameData($slotSettings->slotId . 'JackWinID');
                                if( $jackStep[0] >= 3 || $jackStep[1] >= 3 || $jackStep[2] >= 3 || $jackStep[3] >= 3 || !$slotSettings->HasGameData('BurningHot6Reels40EGTJackSteps') ) 
                                {
                                    exit();
                                }
                                $winAmount = 0;
                                ...
                                $slotSettings->SetGameData('BurningHot6Reels40EGTJackSteps', $jackStep);
                                break;
                            case 'gamble':
                                $Balance = $slotSettings->GetBalance();
                                $isGambleWin = rand(1, $slotSettings->GetGambleSettings());
                                $dealerCard = '';
                                $totalWin = $slotSettings->GetGameData('BurningHot6Reels40EGTTotalWin');
                                $gambleWin = 0;
                                $statBet = $totalWin;
                                $slotSettings->SetGameData('BurningHot6Reels40EGTGambleStep', $slotSettings->GetGameData('BurningHot6Reels40EGTGambleStep') - 1);
                                ...
                                else
                                {
                                    ...
                                    $totalWin = 0;
                                    $slotSettings->SetGameData('BurningHot6Reels40EGTGambleStep', 0);
                                    if( $postData['bet']['color'] == '1' ) 
                                    {
                                        $tmpCards = [
                                            '1', 
                                ...
                                $gtype = 1;
                                $gtype0 = 1;
                                if( $slotSettings->GetGameData('BurningHot6Reels40EGTBonusStart') == 1 ) 
                                {
                                    $gtype0 = 2;
                                }
                                $result_tmp[] = '{"complex":{"gambles":' . $slotSettings->GetGameData('BurningHot6Reels40EGTGambleStep') . ',"card":' . $dealerCard . ',"jackpot":false,"gameCommand":"gamble"},"state":"' . $gambleState . '","winAmount":' . ($totalWin * 100) . ',"gameIdentificationNumber":' . $postData['gameIdentificationNumber'] . ',"gameNumber":"","sessionKey":"88e2b82e6537db4a339e4e1b5ce462cd","msg":"success","messageId":"' . $postData['messageId'] . '","qName":"app.services.messages.response.GameEventResponse","command":"bet","eventTimestamp":' . time() . '}';
                                break;
                        }
