                ...
                try
                {
                    ...
                    if( $postData['slotEvent'] == 'getSettings' ) 
                    {
                        ...
                        if( $lastEvent != 'NULL' ) 
                        {
                            ...
                            $slotSettings->SetGameData($slotSettings->slotId . 'CurrentFreeMpl', $lastEvent->serverResponse->CurrentFreeMpl);
                        }
                    ...
                    else if( $postData['slotEvent'] == 'gamble5GetUserCards' ) 
                    {
                        ...
                        $dealerCard = $slotSettings->GetGameData('FourQueensDealerCard');
                        $totalWin = $slotSettings->GetGameData('FourQueensTotalWin');
                        $gambleWin = 0;
                        ...
                        $slotSettings->SetGameData('FourQueensTotalWin', $totalWin);
                    ...
                    else if( $postData['slotEvent'] == 'gamble5GetDealerCard' ) 
                    {
                        ...
                        $slotSettings->SetGameData('FourQueensDealerCard', $tmpDc);
                    ...
                    else if( $postData['slotEvent'] == 'bet' || $postData['slotEvent'] == 'freespin' ) 
                    {
                        ...
                        if( $postData['slotEvent'] != 'freespin' ) 
                        {
                            ...
                            $bonusMpl = 1;
                            $slotSettings->SetGameData('FourQueensBonusWin', 0);
                            $slotSettings->SetGameData('FourQueensFreeGames', 0);
                            $slotSettings->SetGameData('FourQueensCurrentFreeGame', 0);
                            $slotSettings->SetGameData('FourQueensTotalWin', 0);
                            $slotSettings->SetGameData('FourQueensFreeBalance', 0);
                            $slotSettings->SetGameData('FourQueensCurrentFreeMode', 0);
                            $slotSettings->SetGameData('FourQueensCurrentFreeMpl', 1);
                        }
                        else
                        {
                            $slotSettings->SetGameData('FourQueensCurrentFreeGame', $slotSettings->GetGameData('FourQueensCurrentFreeGame') + 1);
                        ...
                        {
                            if( $slotSettings->GetGameData('FourQueensCurrentFreeMode') == 0 ) 
                            {
                                $slotSettings->SetGameData('FourQueensCurrentFreeMode', $postData['currentFreeMode']);
                                if( $postData['currentFreeMode'] == 1 ) 
                                {
                                    $slotSettings->SetGameData('FourQueensCurrentFreeGame', 1);
                                    $slotSettings->SetGameData('FourQueensFreeGames', 25);
                                    $slotSettings->SetGameData('FourQueensCurrentFreeMpl', 1);
                                }
                                else if( $postData['currentFreeMode'] == 2 ) 
                                {
                                    $slotSettings->SetGameData('FourQueensCurrentFreeGame', 1);
                                    $slotSettings->SetGameData('FourQueensFreeGames', 15);
                                    $slotSettings->SetGameData('FourQueensCurrentFreeMpl', 2);
                                }
                                else if( $postData['currentFreeMode'] == 3 ) 
                                {
                                    $slotSettings->SetGameData('FourQueensCurrentFreeGame', 1);
                                    $slotSettings->SetGameData('FourQueensFreeGames', 11);
                                    $slotSettings->SetGameData('FourQueensCurrentFreeMpl', 3);
                                }
                                else if( $postData['currentFreeMode'] == 4 ) 
                                {
                                    $slotSettings->SetGameData('FourQueensCurrentFreeGame', 1);
                                    $slotSettings->SetGameData('FourQueensFreeGames', 9);
                                    $slotSettings->SetGameData('FourQueensCurrentFreeMpl', 4);
                                }
                            }
                            $bonusMpl = $slotSettings->GetGameData('FourQueensCurrentFreeMpl');
                        }
                        for( $i = 0; $i <= 2000; $i++ ) 
                        {
                            $totalWin = 0;
                                ...
                                for( $j = 0; $j < count($slotSettings->SymbolGame); $j++ ) 
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        if( ($s[0] == $csym || $s[0] == $wild) && ($s[1] == $csym || $s[1] == $wild) ) 
                                        {
                                            ...
                                            {
                                                $cWins[$k] = $tmpWin;
                                                $tmpStringWin = '{"Count":2,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('FourQueensBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                            }
                                        }
                                        if( ($s[0] == $csym || $s[0] == $wild) && ($s[1] == $csym || $s[1] == $wild) && ($s[2] == $csym || $s[2] == $wild) ) 
                                        {
                                            ...
                                            {
                                                $cWins[$k] = $tmpWin;
                                                $tmpStringWin = '{"Count":3,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('FourQueensBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                            }
                                        }
                                        if( ($s[0] == $csym || $s[0] == $wild) && ($s[1] == $csym || $s[1] == $wild) && ($s[2] == $csym || $s[2] == $wild) && ($s[3] == $csym || $s[3] == $wild) ) 
                                        {
                                            ...
                                            {
                                                $cWins[$k] = $tmpWin;
                                                $tmpStringWin = '{"Count":4,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('FourQueensBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":["none","none"]}';
                                            }
                                        }
                                        if( ($s[0] == $csym || $s[0] == $wild) && ($s[1] == $csym || $s[1] == $wild) && ($s[2] == $csym || $s[2] == $wild) && ($s[3] == $csym || $s[3] == $wild) && ($s[4] == $csym || $s[4] == $wild) ) 
                                        {
                                            ...
                                            {
                                                $cWins[$k] = $tmpWin;
                                                $tmpStringWin = '{"Count":5,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('FourQueensBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":[' . ($linesId[$k][4] - 1) . ',"' . $s[4] . '"]}';
                                            }
                                        }
                                    }
                                }
                            ...
                            if( $postData['slotEvent'] == 'freespin' && $scattersCount >= 3 ) 
                            {
                            }
                            else
                            {
                        ...
                        if( $postData['slotEvent'] == 'freespin' && $slotSettings->GetGameData('FourQueensFreeGames') <= $slotSettings->GetGameData('FourQueensCurrentFreeGame') && $winType != 'bonus' && $slotSettings->GetGameData('FourQueensTotalWin') + $totalWin > 0 ) 
                        {
                            $slotSettings->SetBalance($slotSettings->GetGameData('FourQueensTotalWin') + $totalWin);
                        }
                        ...
                        if( $postData['slotEvent'] == 'freespin' ) 
                        {
                            $slotSettings->SetGameData('FourQueensBonusWin', $slotSettings->GetGameData('FourQueensBonusWin') + $totalWin);
                            $slotSettings->SetGameData('FourQueensTotalWin', $slotSettings->GetGameData('FourQueensTotalWin') + $totalWin);
                            $totalWin = $slotSettings->GetGameData('FourQueensBonusWin');
                            $Balance = $slotSettings->GetGameData('FourQueensFreeBalance');
                        }
                        else
                        {
                            $slotSettings->SetGameData('FourQueensTotalWin', $totalWin);
                        ...
                        if( $scattersCount >= 3 ) 
                        {
                            if( $slotSettings->GetGameData('FourQueensFreeGames') > 0 ) 
                            {
                                $slotSettings->SetGameData('FourQueensFreeBalance', $Balance);
                                $slotSettings->SetGameData('FourQueensBonusWin', $totalWin);
                            }
                            else
                            {
                                $slotSettings->SetGameData('FourQueensFreeBalance', $Balance);
                                $slotSettings->SetGameData('FourQueensBonusWin', $totalWin);
                                $slotSettings->SetGameData('FourQueensFreeGames', 1);
                            }
                        }
                        $jsSpin = '' . json_encode($reels) . '';
                        $jsJack = '' . json_encode($slotSettings->Jackpots) . '';
                        $winString = implode(',', $lineWins);
                        $response = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{"CurrentFreeMpl":' . $slotSettings->GetGameData('FourQueensCurrentFreeMpl') . ',"slotLines":' . $postData['slotLines'] . ',"slotBet":' . $postData['slotBet'] . ',"totalFreeGames":' . $slotSettings->GetGameData('FourQueensFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('FourQueensCurrentFreeGame') . ',"Balance":' . $Balance . ',"afterBalance":' . $slotSettings->GetBalance() . ',"totalWin":' . $totalWin . ',"winLines":[' . $winString . '],"bonusInfo":' . $scattersStr . ',"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
