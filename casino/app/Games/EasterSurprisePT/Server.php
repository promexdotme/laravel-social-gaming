                    ...
                    try
                    {
                        ...
                        if( isset($postData['spinType']) ) 
                        {
                            ...
                            if( $postData['spinType'] == 'regular' ) 
                            {
                                ...
                                $bonusMpl = 1;
                                $slotSettings->SetGameData('EasterSurprisePTBonusWin', 0);
                                $slotSettings->SetGameData('EasterSurprisePTFreeGames', 0);
                                $slotSettings->SetGameData('EasterSurprisePTCurrentFreeGame', 0);
                                $slotSettings->SetGameData('EasterSurprisePTTotalWin', 0);
                                $slotSettings->SetGameData('EasterSurprisePTFreeBalance', 0);
                                $slotSettings->SetGameData('EasterSurprisePTFreeStartWin', 0);
                                $chosenTree = 0;
                                $startStick = 0;
                                $treeStep = [
                                    -1, 
                                ...
                                $slotSettings->SetGameData('EasterSurprisePTChosenTree', $chosenTree);
                                $slotSettings->SetGameData('EasterSurprisePTstartStick', $startStick);
                                $slotSettings->SetGameData('EasterSurprisePTtreeStep', $treeStep);
                                $slotSettings->SetGameData('EasterSurprisePTlastWins', $lastWins);
                            }
                            else if( $postData['spinType'] == 'free' ) 
                            {
                                $umid = '0';
                                $postData['slotEvent'] = 'freespin';
                                $slotSettings->SetGameData('EasterSurprisePTCurrentFreeGame', $slotSettings->GetGameData('EasterSurprisePTCurrentFreeGame') + 1);
                            ...
                            $slotSettings->SetGameData('EasterSurprisePTAllBet', $postData['bet']);
                            $slotSettings->SetGameData('EasterSurprisePTBetLine', $betLine);
                            for( $i = 0; $i <= 2000; $i++ ) 
                            {
                                $totalWin = 0;
                                $lineWins = [];
                                    ...
                                    for( $j = 0; $j < count($slotSettings->SymbolGame); $j++ ) 
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            if( $s[0] == $csym || in_array($s[0], $wild) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":1,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('EasterSurprisePTBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":["none","none"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":2,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('EasterSurprisePTBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":3,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('EasterSurprisePTBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) && ($s[3] == $csym || in_array($s[3], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":4,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('EasterSurprisePTBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) && ($s[3] == $csym || in_array($s[3], $wild)) && ($s[4] == $csym || in_array($s[4], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":5,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('EasterSurprisePTBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":[' . ($linesId[$k][4] - 1) . ',"' . $s[4] . '"]}';
                                                }
                                            }
                                            if( $csym == '9' ) 
                                            {
                            ...
                            if( $postData['slotEvent'] == 'freespin' ) 
                            {
                                $slotSettings->SetGameData('EasterSurprisePTBonusWin', $slotSettings->GetGameData('EasterSurprisePTBonusWin') + $totalWin);
                                $slotSettings->SetGameData('EasterSurprisePTTotalWin', $totalWin);
                            }
                            else
                            {
                                $slotSettings->SetGameData('EasterSurprisePTTotalWin', $totalWin);
                            ...
                            if( $scattersCount >= 3 ) 
                            {
                                if( $slotSettings->GetGameData('EasterSurprisePTFreeGames') > 0 ) 
                                {
                                    $slotSettings->SetGameData('EasterSurprisePTFreeGames', $slotSettings->GetGameData('EasterSurprisePTFreeGames') + $slotSettings->slotFreeCount);
                                }
                                else
                                {
                                    $slotSettings->SetGameData('EasterSurprisePTFreeStartWin', $totalWin);
                                    $slotSettings->SetGameData('EasterSurprisePTBonusWin', 0);
                                    $slotSettings->SetGameData('EasterSurprisePTFreeGames', $slotSettings->slotFreeCount);
                                }
                            }
                            ...
                            if( $eggBonusStart ) 
                            {
                                ...
                                $slotSettings->SetGameData('EasterSurprisePTWinValues', $eggResult['curValues']);
                                $slotSettings->SetGameData('EasterSurprisePTPickedCount', 0);
                                $slotSettings->SetGameData('EasterSurprisePTPickedCountArr', []);
                                $slotSettings->SetGameData('EasterSurprisePTeggBonusNum', $eggBonusNum);
                            }
                            $response = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{' . $bStr . '"allbet":' . $slotSettings->GetGameData('EasterSurprisePTAllBet') . ',"betLine":' . $slotSettings->GetGameData('EasterSurprisePTBetLine') . ',"linesArr":[' . implode(',', $postData['lines']) . '],"slotLines":' . $lines . ',"slotBet":' . $betLine . ',"totalFreeGames":' . $slotSettings->GetGameData('EasterSurprisePTFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('EasterSurprisePTCurrentFreeGame') . ',"Balance":' . $slotSettings->GetBalance() . ',"afterBalance":' . $slotSettings->GetBalance() . ',"bonusWin":' . $slotSettings->GetGameData('EasterSurprisePTBonusWin') . ',"freeStartWin":' . $slotSettings->GetGameData('EasterSurprisePTFreeStartWin') . ',"totalWin":' . $totalWin . ',"winLines":[' . $winString . '],"bonusInfo":' . $scattersStr . ',"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
                            $slotSettings->SetGameData('EasterSurprisePTLastResponse', $response);
                            $slotSettings->SaveLogReport($response, $betLine, $lines, $reportWin, $postData['slotEvent']);
                        }
                        switch( $umid ) 
                        {
                            case '40971':
                                if( $postData['pickIndex'] >= 0 && $slotSettings->GetGameData('EasterSurprisePTPickedCount') < $slotSettings->GetGameData('EasterSurprisePTeggBonusNum') ) 
                                {
                                    $lr = json_decode($slotSettings->GetGameData('EasterSurprisePTLastResponse'));
                                    $values = $slotSettings->GetGameData('EasterSurprisePTWinValues');
                                    $pick = $slotSettings->GetGameData('EasterSurprisePTPickedCount');
                                    $pickArr = $slotSettings->GetGameData('EasterSurprisePTPickedCountArr');
                                    $reportWin = $values[$pick] * $slotSettings->GetGameData('EasterSurprisePTBetLine');
                                    $slotSettings->SetBalance($reportWin);
                                    $pick++;
                                    $pickArr[] = $postData['pickIndex'];
                                    $slotSettings->SetGameData('EasterSurprisePTPickedCount', $pick);
                                    $slotSettings->SetGameData('EasterSurprisePTPickedCountArr', $pickArr);
                                    ...
                                    $slotSettings->SetGameData('EasterSurprisePTLastResponse', json_encode($lr));
                                }
                                break;
                            case '31031':
                            ...
                            case '40036':
                                ...
                                if( $lastEvent != 'NULL' ) 
                                {
                                    ...
                                    $slotSettings->SetGameData('EasterSurprisePTLastResponse', json_encode($lastEvent));
                                    $slotSettings->SetGameData('EasterSurprisePTWinValues', $lastEvent->serverResponse->winValues);
                                    $slotSettings->SetGameData('EasterSurprisePTPickedCount', $lastEvent->serverResponse->PickedCount);
                                    $slotSettings->SetGameData('EasterSurprisePTPickedCountArr', $lastEvent->serverResponse->PickedCountArr);
                                    $slotSettings->SetGameData('EasterSurprisePTEggNum', $lastEvent->serverResponse->eggBonusNum);
                                    $slotSettings->SetGameData('EasterSurprisePTEeggBonusNum', $lastEvent->serverResponse->eggBonusNum);
                                    if( $slotSettings->GetGameData($slotSettings->slotId . 'CurrentFreeGame') < $slotSettings->GetGameData($slotSettings->slotId . 'FreeGames') && $slotSettings->GetGameData($slotSettings->slotId . 'FreeGames') > 0 ) 
                                    {
                                        $slotSettings->SetGameData($slotSettings->slotId . 'brokenGames', 'eas');
                                    }
                                    if( $lastEvent->responseType == 'egg_bonus' && $slotSettings->GetGameData('EasterSurprisePTPickedCount') < $slotSettings->GetGameData('EasterSurprisePTEeggBonusNum') ) 
                                    {
                                        $slotSettings->SetGameData($slotSettings->slotId . 'brokenGames', 'eas');
                                    }
                                    $slotSettings->SetGameData('EasterSurprisePTresponseType', $lastEvent->responseType);
                                }
