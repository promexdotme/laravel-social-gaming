            ...
            function get_($request, $game)
            {
                \DB::transaction(function() use ($request, $game)
                {
                    try
                    {
                        ...
                        {
                            case 'create_session':
                                $slotSettings->SetGameData('MegaSlot40CTCards', [
                                    19, 
                                    44, 
                                    0, 
                                    37, 
                            ...
                            case 'init_game':
                                ...
                                $slotSettings->SetGameData('MegaSlot40CTBonusWin', 0);
                                $slotSettings->SetGameData('MegaSlot40CTFreeGames', 0);
                                $slotSettings->SetGameData('MegaSlot40CTCurrentFreeGame', 0);
                                $slotSettings->SetGameData('MegaSlot40CTCurrentFreeGame0', 0);
                                $slotSettings->SetGameData('MegaSlot40CTTotalWin', 0);
                                $slotSettings->SetGameData('MegaSlot40CTFreeBalance', 0);
                                ...
                                if( $lastEvent != 'NULL' ) 
                                {
                                    ...
                                    if( $slotSettings->GetGameData('MegaSlot40CTCurrentFreeGame') < $slotSettings->GetGameData('MegaSlot40CTFreeGames') && $slotSettings->GetGameData('MegaSlot40CTFreeGames') > 0 ) 
                                    {
                            ...
                            case 'poll':
                                ...
                                {
                                    $balanceInCents = sprintf('%01.2f', $slotSettings->GetBalance() - $slotSettings->GetGameData('MegaSlot40CTTotalWin')) * 100;
                                }
                            ...
                            case 'game_finished':
                                $slotSettings->SetGameData('MegaSlot40CTBonusWin', 0);
                                $slotSettings->SetGameData('MegaSlot40CTTotalWin', 0);
                                $responseData['game_finished'][0]['freeround_play'] = $slotSettings->GetGameData('MegaSlot40CTCurrentFreeGame0');
                            ...
                            case 'subgame_finished':
                                if( $slotSettings->GetGameData('MegaSlot40CTCurrentFreeGame0') < $slotSettings->GetGameData('MegaSlot40CTFreeGames') && $slotSettings->GetGameData('MegaSlot40CTFreeGames') > 0 ) 
                                {
                                    ...
                                    $response = '{"responseEvent":"spin","responseType":"freespin","serverResponse":{"result":' . json_encode($result) . ',"slotDenom":' . $slotSettings->GetGameData($slotSettings->slotId . 'Denom') . ',"slotLines":' . $lines . ',"slotBet":' . $betline . ',"totalFreeGames":' . $slotSettings->GetGameData('MegaSlot40CTFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('MegaSlot40CTCurrentFreeGame0') . ',"Balance":' . $slotSettings->GetGameData('MegaSlot40CTFreeBalance') . ',"afterBalance":' . $slotSettings->GetGameData('MegaSlot40CTFreeBalance') . ',"bonusWin":' . $slotSettings->GetGameData('MegaSlot40CTBonusWin') . ',"totalWin":' . $reportWin . ',"winLines":[],"Jackpots":[],"reelsSymbols":' . json_encode($slotSettings->GetGameData($slotSettings->slotId . 'Reels')) . '}}';
                                    if( $slotSettings->GetGameData('MegaSlot40CTFreeGames') <= $slotSettings->GetGameData('MegaSlot40CTCurrentFreeGame0') ) 
                                    {
                                        if( $reportWin > 0 ) 
                                        {
                                    ...
                                    $balanceInCents = $slotSettings->GetGameData('MegaSlot40CTFreeBalance');
                                    $responseData['subgame_finished'][0]['account_status']['credit'] = round($balanceInCents);
                                    $responseData['subgame_finished'][0]['freeround_play'] = $slotSettings->GetGameData('MegaSlot40CTCurrentFreeGame0');
                                    $responseData['subgame_finished'][1]['freeround_play'] = $slotSettings->GetGameData('MegaSlot40CTCurrentFreeGame0');
                            ...
                            case 'play':
                                ...
                                for( $spinLoop = 0; $spinLoop < $spinLoopLimit; $spinLoop++ ) 
                                {
                                    ...
                                    if( $postData['slotEvent'] != 'freespin' ) 
                                    {
                                        ...
                                        $slotSettings->SetGameData('MegaSlot40CTCurrentFreeGame0', 0);
                                        $slotSettings->SetGameData('MegaSlot40CTTotalWin', 0);
                                        $slotSettings->SetGameData('MegaSlot40CTFreeBalance', sprintf('%01.2f', $slotSettings->GetBalance()) * 100);
                                    ...
                                    {
                                        $slotSettings->SetGameData('MegaSlot40CTCurrentFreeGame', $slotSettings->GetGameData('MegaSlot40CTCurrentFreeGame') + 1);
                                    ...
                                    if( $postData['slotEvent'] == 'freespin' ) 
                                    {
                                        $slotSettings->SetGameData('MegaSlot40CTBonusWin', $slotSettings->GetGameData('MegaSlot40CTBonusWin') + $totalWin);
                                        $slotSettings->SetGameData('MegaSlot40CTTotalWin', $slotSettings->GetGameData('MegaSlot40CTTotalWin') + $totalWin);
                                        $balanceInCents = $slotSettings->GetGameData('MegaSlot40CTFreeBalance');
                                    }
                                    else
                                    {
                                        $slotSettings->SetGameData('MegaSlot40CTTotalWin', $totalWin);
                                    }
                                    $fs = 0;
                                    if( $scattersCount >= 3 ) 
                                    {
                                    ...
                                    $winstring = '';
                                    $slotSettings->SetGameData('MegaSlot40CTGambleStep', 5);
                                    $hist = $slotSettings->GetGameData('MegaSlot40CTCards');
                                    if( $postData['slotEvent'] == 'freespin' ) 
                                    {
                                        $state = 'freespin';
                                        ...
                                        if( $slotSettings->GetGameData($slotSettings->slotId . 'FreeGames') <= $slotSettings->GetGameData($slotSettings->slotId . 'CurrentFreeGame') && $slotSettings->GetGameData('MegaSlot40CTBonusWin') > 0 ) 
                                        {
                                            $responseData['play'][0]['result'][$spinLoop]['is_free'] = true;
                                    ...
                                    $responseData['play'][0]['result'][$spinLoop]['total_win'] = $slotSettings->GetGameData('MegaSlot40CTTotalWin') / $denom;
                                ...
                                $response = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{"result":' . json_encode($responseData['play'][0]['result']) . ',"slotDenom":' . $denom . ',"slotLines":' . $lines . ',"slotBet":' . $betline . ',"totalFreeGames":' . $slotSettings->GetGameData('MegaSlot40CTFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('MegaSlot40CTCurrentFreeGame0') . ',"Balance":' . $slotSettings->GetGameData($slotSettings->slotId . 'FreeBalance') . ',"afterBalance":' . $slotSettings->GetBalance() . ',"bonusWin":' . $slotSettings->GetGameData('MegaSlot40CTBonusWin') . ',"totalWin":' . $totalWin . ',"winLines":[],"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
                            ...
                            case 'gamble':
                                ...
                                $dealerCard = '';
                                $totalWin = $slotSettings->GetGameData('MegaSlot40CTTotalWin');
                                $gambleWin = 0;
                                $statBet = $totalWin;
                                ...
                                $hist = $slotSettings->GetGameData('MegaSlot40CTCards');
                                $slotSettings->SetGameData('MegaSlot40CTGambleStep', $slotSettings->GetGameData('MegaSlot40CTGambleStep') - 1);
                                if( $slotSettings->MaxWin < ($totalWin * $slotSettings->CurrentDenom) ) 
                                {
                                    $isGambleWin = 0;
                                }
                                ...
                                else
                                {
                                    ...
                                    $totalWin = 0;
                                    $slotSettings->SetGameData('MegaSlot40CTGambleStep', 0);
                                    if( $postData['continue_params']['double_key'] != 'red' && $postData['continue_params']['double_key'] != 'black' ) 
                                    {
                                        if( $postData['continue_params']['double_key'] == 'diamond' ) 
                                        {
                                ...
                                $slotSettings->SetGameData('MegaSlot40CTCards', $hist);
