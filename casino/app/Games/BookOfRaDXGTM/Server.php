                ...
                \DB::transaction(function() use ($request, $game)
                {
                    try
                    {
                        ...
                        else if( $postData['slotEvent'] == 'gamble5GetUserCards' ) 
                        {
                            ...
                            $dealerCard = $slotSettings->GetGameData('BookOfRaDXGTMDealerCard');
                            $totalWin = $slotSettings->GetGameData('BookOfRaDXGTMTotalWin');
                            $gambleWin = 0;
                            ...
                            $slotSettings->SetGameData('BookOfRaDXGTMTotalWin', $totalWin);
                        ...
                        else if( $postData['slotEvent'] == 'gamble5GetDealerCard' ) 
                        {
                            ...
                            $slotSettings->SetGameData('BookOfRaDXGTMDealerCard', $tmpDc);
                        ...
                        else if( $postData['slotEvent'] == 'bet' || $postData['slotEvent'] == 'freespin' ) 
                        {
                            ...
                            if( $postData['slotEvent'] != 'freespin' ) 
                            {
                                ...
                                $bonusMpl = 1;
                                $slotSettings->SetGameData('BookOfRaDXGTMExpSymbol', 'NONE');
                                $slotSettings->SetGameData('BookOfRaDXGTMBonusWin', 0);
                                $slotSettings->SetGameData('BookOfRaDXGTMFreeGames', 0);
                                $slotSettings->SetGameData('BookOfRaDXGTMCurrentFreeGame', 0);
                                $slotSettings->SetGameData('BookOfRaDXGTMTotalWin', 0);
                                $slotSettings->SetGameData('BookOfRaDXGTMFreeBalance', 0);
                            }
                            else
                            {
                                $slotSettings->SetGameData('BookOfRaDXGTMCurrentFreeGame', $slotSettings->GetGameData('BookOfRaDXGTMCurrentFreeGame') + 1);
                            ...
                            for( $i = 0; $i <= 2000; $i++ ) 
                            {
                                    ...
                                    for( $j = 0; $j < count($slotSettings->SymbolGame); $j++ ) 
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            if( ($s[0] == $csym || $s[0] == $wild) && ($s[1] == $csym || $s[1] == $wild) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":2,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('BookOfRaDXGTMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || $s[0] == $wild) && ($s[1] == $csym || $s[1] == $wild) && ($s[2] == $csym || $s[2] == $wild) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":3,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('BookOfRaDXGTMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || $s[0] == $wild) && ($s[1] == $csym || $s[1] == $wild) && ($s[2] == $csym || $s[2] == $wild) && ($s[3] == $csym || $s[3] == $wild) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":4,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('BookOfRaDXGTMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || $s[0] == $wild) && ($s[1] == $csym || $s[1] == $wild) && ($s[2] == $csym || $s[2] == $wild) && ($s[3] == $csym || $s[3] == $wild) && ($s[4] == $csym || $s[4] == $wild) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":5,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('BookOfRaDXGTMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":[' . ($linesId[$k][4] - 1) . ',"' . $s[4] . '"]}';
                                                }
                                            }
                                        }
                                    }
                                ...
                                if( $postData['slotEvent'] == 'freespin' ) 
                                {
                                    for( $e = 1; $e <= 5; $e++ ) 
                                    {
                                        if( $reels['reel' . $e][0] == $slotSettings->GetGameData('BookOfRaDXGTMExpSymbol') || $reels['reel' . $e][1] == $slotSettings->GetGameData('BookOfRaDXGTMExpSymbol') || $reels['reel' . $e][2] == $slotSettings->GetGameData('BookOfRaDXGTMExpSymbol') ) 
                                        {
                                            $expReels[$e] = true;
                                            $expPayCnt++;
                                        }
                                    ...
                                    {
                                        $expPay += ($slotSettings->Paytable[$slotSettings->GetGameData('BookOfRaDXGTMExpSymbol')][$expPayCnt] * $postData['slotBet']);
                                        $tmpStringWin = '{"lineWin":' . ($slotSettings->Paytable[$slotSettings->GetGameData('BookOfRaDXGTMExpSymbol')][$expPayCnt] * $postData['slotBet']) . ',"Count":' . $expPayCnt . ',"Line":' . $ll . ',"Win":' . $expPay . ',"stepWin":' . ($expPay + $totalWin + $slotSettings->GetGameData('BookOfRaDXGTMBonusWin'));
                                        for( $e = 1; $e <= 5; $e++ ) 
                                        {
                                            if( $expReels[$e] ) 
                                            {
                                                $tmpStringWin .= (',"winReel' . $e . '":[' . ($linesId[$ll][$e - 1] - 1) . ',"' . $slotSettings->GetGameData('BookOfRaDXGTMExpSymbol') . '"]');
                                            }
                                            else
                                            {
                            ...
                            if( $postData['slotEvent'] == 'freespin' && $slotSettings->GetGameData('BookOfRaDXGTMFreeGames') <= $slotSettings->GetGameData('BookOfRaDXGTMCurrentFreeGame') && $winType != 'bonus' && $slotSettings->GetGameData('BookOfRaDXGTMTotalWin') + $totalWin > 0 ) 
                            {
                                $slotSettings->SetBalance($slotSettings->GetGameData('BookOfRaDXGTMTotalWin') + $totalWin);
                            }
                            ...
                            if( $postData['slotEvent'] == 'freespin' ) 
                            {
                                $slotSettings->SetGameData('BookOfRaDXGTMBonusWin', $slotSettings->GetGameData('BookOfRaDXGTMBonusWin') + $totalWin);
                                $slotSettings->SetGameData('BookOfRaDXGTMTotalWin', $slotSettings->GetGameData('BookOfRaDXGTMTotalWin') + $totalWin);
                                $totalWin = $slotSettings->GetGameData('BookOfRaDXGTMBonusWin');
                                $Balance = $slotSettings->GetGameData('BookOfRaDXGTMFreeBalance');
                            }
                            else
                            {
                                $slotSettings->SetGameData('BookOfRaDXGTMTotalWin', $totalWin);
                            ...
                            if( $scattersCount >= 3 ) 
                            {
                                ...
                                if( $slotSettings->GetGameData('BookOfRaDXGTMFreeGames') > 0 ) 
                                {
                                    $slotSettings->SetGameData('BookOfRaDXGTMFreeBalance', $Balance);
                                    $slotSettings->SetGameData('BookOfRaDXGTMBonusWin', $totalWin);
                                    $slotSettings->SetGameData('BookOfRaDXGTMFreeGames', $slotSettings->GetGameData('BookOfRaDXGTMFreeGames') + $slotSettings->slotFreeCount);
                                }
                                else
                                {
                                    $slotSettings->SetGameData('BookOfRaDXGTMExpSymbol', $slotSettings->SymbolGameExp[0]);
                                    $slotSettings->SetGameData('BookOfRaDXGTMFreeBalance', $Balance);
                                    $slotSettings->SetGameData('BookOfRaDXGTMBonusWin', $totalWin);
                                    $slotSettings->SetGameData('BookOfRaDXGTMFreeGames', $slotSettings->slotFreeCount);
                                }
                            }
                            ...
                            if( $slotSettings->GetGameData('BookOfRaDXGTMExpSymbol') != 'NONE' ) 
                            {
                                $expSymbol = '"expSymbol":"' . $slotSettings->GetGameData('BookOfRaDXGTMExpSymbol') . '",';
                            }
                            else
                            {
                                $expSymbol = '';
                            }
                            $response = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{"slotLines":' . $postData['slotLines'] . ',"slotBet":' . $postData['slotBet'] . ',' . $expLinesStr . ',"expPay":' . $expPay . ',' . $expReelsStr . ',' . $expSymbol . '"totalFreeGames":' . $slotSettings->GetGameData('BookOfRaDXGTMFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('BookOfRaDXGTMCurrentFreeGame') . ',"Balance":' . $Balance . ',"afterBalance":' . $slotSettings->GetBalance() . ',"totalWin":' . $totalWin . ',"winLines":[' . $winString . '],"bonusInfo":' . $scattersStr . ',"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
