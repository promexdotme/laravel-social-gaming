            ...
            function get_($request, $game)
            {
                \DB::transaction(function() use ($request, $game)
                {
                    try
                    {
                        ...
                        {
                            case 'create_session':
                                $slotSettings->SetGameData('BavarianForestCTCards', [
                                    19, 
                                    44, 
                                    0, 
                                    37, 
                            ...
                            case 'init_game':
                                ...
                                $slotSettings->SetGameData('BavarianForestCTBonusWin', 0);
                                $slotSettings->SetGameData('BavarianForestCTFreeGames', 0);
                                $slotSettings->SetGameData('BavarianForestCTCurrentFreeGame', 0);
                                $slotSettings->SetGameData('BavarianForestCTCurrentFreeGame0', 0);
                                $slotSettings->SetGameData('BavarianForestCTTotalWin', 0);
                                $slotSettings->SetGameData('BavarianForestCTFreeBalance', 0);
                                ...
                                if( $lastEvent != 'NULL' ) 
                                {
                                    ...
                                    if( $slotSettings->GetGameData('BavarianForestCTCurrentFreeGame') < $slotSettings->GetGameData('BavarianForestCTFreeGames') && $slotSettings->GetGameData('BavarianForestCTFreeGames') > 0 ) 
                                    {
                            ...
                            case 'poll':
                                ...
                                {
                                    $balanceInCents = sprintf('%01.2f', $slotSettings->GetBalance() - $slotSettings->GetGameData('BavarianForestCTTotalWin')) * 100;
                                }
                            ...
                            case 'game_finished':
                                $slotSettings->SetGameData('BavarianForestCTBonusWin', 0);
                                $slotSettings->SetGameData('BavarianForestCTTotalWin', 0);
                                $responseData['game_finished'][0]['freeround_play'] = $slotSettings->GetGameData('BavarianForestCTCurrentFreeGame0');
                            ...
                            case 'subgame_finished':
                                if( $slotSettings->GetGameData('BavarianForestCTCurrentFreeGame0') < $slotSettings->GetGameData('BavarianForestCTFreeGames') && $slotSettings->GetGameData('BavarianForestCTFreeGames') > 0 ) 
                                {
                                    ...
                                    $response = '{"responseEvent":"spin","responseType":"freespin","serverResponse":{"result":' . json_encode($result) . ',"slotDenom":' . $slotSettings->GetGameData($slotSettings->slotId . 'Denom') . ',"slotLines":' . $lines . ',"slotBet":' . $betline . ',"totalFreeGames":' . $slotSettings->GetGameData('BavarianForestCTFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('BavarianForestCTCurrentFreeGame0') . ',"Balance":' . $slotSettings->GetGameData('BavarianForestCTFreeBalance') . ',"afterBalance":' . $slotSettings->GetGameData('BavarianForestCTFreeBalance') . ',"bonusWin":' . $slotSettings->GetGameData('BavarianForestCTBonusWin') . ',"totalWin":' . $reportWin . ',"winLines":[],"Jackpots":[],"reelsSymbols":' . json_encode($slotSettings->GetGameData($slotSettings->slotId . 'Reels')) . '}}';
                                    if( $slotSettings->GetGameData('BavarianForestCTFreeGames') <= $slotSettings->GetGameData('BavarianForestCTCurrentFreeGame0') ) 
                                    {
                                        if( $reportWin > 0 ) 
                                        {
                                    ...
                                    $balanceInCents = $slotSettings->GetGameData('BavarianForestCTFreeBalance');
                                    $responseData['subgame_finished'][0]['account_status']['credit'] = round($balanceInCents);
                                    $responseData['subgame_finished'][0]['freeround_play'] = $slotSettings->GetGameData('BavarianForestCTCurrentFreeGame0');
                                    $responseData['subgame_finished'][1]['freeround_play'] = $slotSettings->GetGameData('BavarianForestCTCurrentFreeGame0');
                            ...
                            case 'play':
                                ...
                                for( $spinLoop = 0; $spinLoop < $spinLoopLimit; $spinLoop++ ) 
                                {
                                    ...
                                    if( $postData['slotEvent'] != 'freespin' ) 
                                    {
                                        ...
                                        $slotSettings->SetGameData('BavarianForestCTCurrentFreeGame0', 0);
                                        $slotSettings->SetGameData('BavarianForestCTTotalWin', 0);
                                        $slotSettings->SetGameData('BavarianForestCTFreeBalance', sprintf('%01.2f', $slotSettings->GetBalance()) * 100);
                                    ...
                                    {
                                        $slotSettings->SetGameData('BavarianForestCTCurrentFreeGame', $slotSettings->GetGameData('BavarianForestCTCurrentFreeGame') + 1);
                                    ...
                                    if( $postData['slotEvent'] == 'freespin' ) 
                                    {
                                        $slotSettings->SetGameData('BavarianForestCTBonusWin', $slotSettings->GetGameData('BavarianForestCTBonusWin') + $totalWin);
                                        $slotSettings->SetGameData('BavarianForestCTTotalWin', $slotSettings->GetGameData('BavarianForestCTTotalWin') + $totalWin);
                                        $balanceInCents = $slotSettings->GetGameData('BavarianForestCTFreeBalance');
                                    }
                                    else
                                    {
                                        $slotSettings->SetGameData('BavarianForestCTTotalWin', $totalWin);
                                    }
                                    $fs = 0;
                                    if( $scattersCount >= 3 ) 
                                    {
                                        if( $slotSettings->GetGameData('BavarianForestCTFreeGames') > 0 ) 
                                        {
                                            $slotSettings->SetGameData('BavarianForestCTFreeGames', $slotSettings->GetGameData('BavarianForestCTFreeGames') + $slotSettings->slotFreeCount);
                                        }
                                        else
                                        {
                                            $slotSettings->SetGameData('BavarianForestCTFreeStartWin', $totalWin);
                                            $slotSettings->SetGameData('BavarianForestCTBonusWin', $totalWin);
                                            $slotSettings->SetGameData('BavarianForestCTFreeGames', $slotSettings->slotFreeCount);
                                        }
                                        $fs = $slotSettings->GetGameData('BavarianForestCTFreeGames');
                                    ...
                                    $winstring = '';
                                    $slotSettings->SetGameData('BavarianForestCTGambleStep', 5);
                                    $hist = $slotSettings->GetGameData('BavarianForestCTCards');
                                    if( $postData['slotEvent'] == 'freespin' ) 
                                    {
                                        $state = 'freespin';
                                        ...
                                        if( $slotSettings->GetGameData($slotSettings->slotId . 'FreeGames') <= $slotSettings->GetGameData($slotSettings->slotId . 'CurrentFreeGame') && $slotSettings->GetGameData('BavarianForestCTBonusWin') > 0 ) 
                                        {
                                            $responseData['play'][0]['result'][$spinLoop]['is_free'] = true;
                                    ...
                                    $responseData['play'][0]['result'][$spinLoop]['total_win'] = $slotSettings->GetGameData('BavarianForestCTTotalWin') / $denom;
                                ...
                                $response = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{"result":' . json_encode($responseData['play'][0]['result']) . ',"slotDenom":' . $denom . ',"slotLines":' . $lines . ',"slotBet":' . $betline . ',"totalFreeGames":' . $slotSettings->GetGameData('BavarianForestCTFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('BavarianForestCTCurrentFreeGame0') . ',"Balance":' . $slotSettings->GetGameData($slotSettings->slotId . 'FreeBalance') . ',"afterBalance":' . $slotSettings->GetBalance() . ',"bonusWin":' . $slotSettings->GetGameData('BavarianForestCTBonusWin') . ',"totalWin":' . $totalWin . ',"winLines":[],"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
                            ...
                            case 'gamble':
                                ...
                                $dealerCard = '';
                                $totalWin = $slotSettings->GetGameData('BavarianForestCTTotalWin');
                                $gambleWin = 0;
                                $statBet = $totalWin;
                                ...
                                $hist = $slotSettings->GetGameData('BavarianForestCTCards');
                                $slotSettings->SetGameData('BavarianForestCTGambleStep', $slotSettings->GetGameData('BavarianForestCTGambleStep') - 1);
                                if( $slotSettings->MaxWin < ($totalWin * $slotSettings->CurrentDenom) ) 
                                {
                                    $isGambleWin = 0;
                                }
                                ...
                                else
                                {
                                    ...
                                    $totalWin = 0;
                                    $slotSettings->SetGameData('BavarianForestCTGambleStep', 0);
                                    if( $postData['continue_params']['double_key'] != 'red' && $postData['continue_params']['double_key'] != 'black' ) 
                                    {
                                        if( $postData['continue_params']['double_key'] == 'diamond' ) 
                                        {
                                ...
                                $slotSettings->SetGameData('BavarianForestCTCards', $hist);
