...
namespace VanguardLTE\Games\TheTigerWarrior
{
    ...
    use VanguardLTE\Games\TheTigerWarrior\PragmaticLib\Collect;
    use VanguardLTE\Games\TheTigerWarrior\PragmaticLib\GameSettings;
    use VanguardLTE\Games\TheTigerWarrior\PragmaticLib\Loader;
    use VanguardLTE\Games\TheTigerWarrior\PragmaticLib\Log;
    use VanguardLTE\Games\TheTigerWarrior\PragmaticLib\Spin;
    use VanguardLTE\Games\TheTigerWarrior\PragmaticLib\DoMysteryScatter;
    use VanguardLTE\Games\TheTigerWarrior\PragmaticLib\DoBonus;
