                    ...
                    try
                    {
                        ...
                        switch( $aid ) 
                        {
                            ...
                            case 'subscribe':
                                ...
                                shuffle($hist);
                                $slotSettings->SetGameData('ImperialDiceEGTCards', $hist);
                                $lastEvent = $slotSettings->GetHistory();
                                $slotSettings->SetGameData('ImperialDiceEGTBonusWin', 0);
                                $slotSettings->SetGameData('ImperialDiceEGTFreeGames', 0);
                                $slotSettings->SetGameData('ImperialDiceEGTCurrentFreeGame', 0);
                                $slotSettings->SetGameData('ImperialDiceEGTTotalWin', 0);
                                $slotSettings->SetGameData('ImperialDiceEGTFreeBalance', 0);
                                if( $lastEvent != 'NULL' ) 
                                {
                                    ...
                                    $slotSettings->SetGameData('ImperialDiceEGTCurrentSeq', $lastEvent->serverResponse->curSeq);
                                    ...
                                    $gtype = 1;
                                    if( $slotSettings->GetGameData('ImperialDiceEGTCurrentFreeGame') < $slotSettings->GetGameData('ImperialDiceEGTFreeGames') && $slotSettings->GetGameData('ImperialDiceEGTFreeGames') > 0 ) 
                                    {
                                        $gtype = 2;
                                    }
                                }
                            ...
                            case 'bet':
                                ...
                                if( $postData['slotEvent'] != 'freespin' ) 
                                {
                                    ...
                                    $slotSettings->SetGameData('ImperialDiceEGTCurrentFreeGame', 0);
                                    $slotSettings->SetGameData('ImperialDiceEGTTotalWin', 0);
                                    $slotSettings->SetGameData('ImperialDiceEGTFreeBalance', sprintf('%01.2f', $slotSettings->GetBalance()) * 100);
                                    $bonusMpl = 1;
                                }
                                else
                                {
                                    $slotSettings->SetGameData('ImperialDiceEGTCurrentFreeGame', $slotSettings->GetGameData('ImperialDiceEGTCurrentFreeGame') + 1);
                                ...
                                if( $winType == 'bonus' ) 
                                {
                                    ...
                                    if( $wlb != 'NULL' ) 
                                    {
                                        ...
                                        $slotSettings->SetGameData('ImperialDiceEGTCurrentSeq', $curSeq);
                                        if( $curSeqWin > 0 ) 
                                        {
                                ...
                                for( $i = 0; $i <= 2000; $i++ ) 
                                {
                                    ...
                                    {
                                        $curSeq = (array)$slotSettings->GetGameData('ImperialDiceEGTCurrentSeq');
                                        $curSeq['result'] = (array)$curSeq['result'];
                                        $curSeq['result'][$slotSettings->GetGameData('ImperialDiceEGTCurrentFreeGame')] = (array)$curSeq['result'][$slotSettings->GetGameData('ImperialDiceEGTCurrentFreeGame')];
                                        $curSeq['result'][$slotSettings->GetGameData('ImperialDiceEGTCurrentFreeGame')]['reels'] = (array)$curSeq['result'][$slotSettings->GetGameData('ImperialDiceEGTCurrentFreeGame')]['reels'];
                                        $reels = $curSeq['result'][$slotSettings->GetGameData('ImperialDiceEGTCurrentFreeGame')]['reels'];
                                    }
                                    if( $postData['slotEvent'] == 'freespin' ) 
                                    {
                                        $reels['reel1'][0] = '10';
                                ...
                                if( $postData['slotEvent'] == 'freespin' ) 
                                {
                                    $slotSettings->SetGameData('ImperialDiceEGTBonusWin', $slotSettings->GetGameData('ImperialDiceEGTBonusWin') + $totalWin);
                                    $slotSettings->SetGameData('ImperialDiceEGTTotalWin', $slotSettings->GetGameData('ImperialDiceEGTTotalWin') + $totalWin);
                                    $balanceInCents = $slotSettings->GetGameData('ImperialDiceEGTFreeBalance');
                                }
                                else
                                {
                                    $slotSettings->SetGameData('ImperialDiceEGTTotalWin', $totalWin);
                                }
                                $fs = 0;
                                if( $scattersCount >= 3 ) 
                                {
                                    if( $slotSettings->GetGameData('ImperialDiceEGTFreeGames') > 0 ) 
                                    {
                                        $slotSettings->SetGameData('ImperialDiceEGTFreeGames', $slotSettings->GetGameData('ImperialDiceEGTFreeGames') + $slotSettings->slotFreeCount);
                                    }
                                    else
                                    {
                                        $slotSettings->SetGameData('ImperialDiceEGTFreeStartWin', $totalWin);
                                        $slotSettings->SetGameData('ImperialDiceEGTBonusWin', $totalWin);
                                        $slotSettings->SetGameData('ImperialDiceEGTFreeGames', $slotSettings->slotFreeCount);
                                    }
                                    $fs = $slotSettings->GetGameData('ImperialDiceEGTFreeGames');
                                }
                                $curReels = '' . rand(0, 6) . ',' . $reels['reel1'][0] . ',' . $reels['reel1'][1] . ',' . $reels['reel1'][2] . ',' . rand(0, 6);
                                $curReels .= (',' . rand(0, 6) . ',' . $reels['reel2'][0] . ',' . $reels['reel2'][1] . ',' . $reels['reel2'][2] . ',' . rand(0, 6));
                                $curReels .= (',' . rand(0, 6) . ',' . $reels['reel3'][0] . ',' . $reels['reel3'][1] . ',' . $reels['reel3'][2] . ',' . rand(0, 6));
                                ...
                                $response = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{"curSeq":' . json_encode($curSeq) . ',"slotLines":' . $lines . '' . $slotSettings->GetGameData($slotSettings->slotId . 'FirstSpin') . ',"slotBet":' . $betline . ',"totalFreeGames":' . $slotSettings->GetGameData('ImperialDiceEGTFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('ImperialDiceEGTCurrentFreeGame') . ',"Balance":' . $balanceInCents . ',"afterBalance":' . $balanceInCents . ',"bonusWin":' . $slotSettings->GetGameData('ImperialDiceEGTBonusWin') . ',"totalWin":' . $totalWin . ',"winLines":[' . $winString . '],"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
                                $slotSettings->SaveLogReport($response, $allbet, $lines, $reportWin, $postData['slotEvent']);
                                $winstring = '';
                                $slotSettings->SetGameData('ImperialDiceEGTGambleStep', 5);
                                $hist = $slotSettings->GetGameData('ImperialDiceEGTCards');
                                if( $jackRandom == 1 ) 
                                {
                                    $state = 'jackpot';
                                    $isJack = 'true';
                                    $slotSettings->SetGameData('ImperialDiceEGTJackSteps', [
                                        0, 
                                        0, 
                                        0, 
                                        0
                                ...
                                if( $postData['slotEvent'] == 'freespin' ) 
                                {
                                    $totalWin = $slotSettings->GetGameData('ImperialDiceEGTBonusWin');
                                    $state = 'freespin';
                                    $holdReels = '0,1,2';
                                ...
                                break;
                            case 'collect':
                                $result_tmp[] = '{"complex":{"gameCommand":"collect"},"state":"idle","winAmount":' . ($slotSettings->GetGameData('ImperialDiceEGTTotalWin') * 100) . ',"gameIdentificationNumber":' . $postData['gameIdentificationNumber'] . ',"gameNumber":"","balance":' . $balanceInCents . ',"sessionKey":"41be9e65e0ff03a65e8c93576bf61130","msg":"success","messageId":"' . $postData['messageId'] . '","qName":"app.services.messages.response.GameEventResponse","command":"bet","eventTimestamp":' . time() . '}';
                                $slotSettings->SetGameData('ImperialDiceEGTTotalWin', 0);
                                break;
                            case 'jackpot':
                                $jackStep = $slotSettings->GetGameData('ImperialDiceEGTJackSteps');
                                $jackWinID = $slotSettings->GetGameData($slotSettings->slotId . 'JackWinID');
                                if( $jackStep[0] >= 3 || $jackStep[1] >= 3 || $jackStep[2] >= 3 || $jackStep[3] >= 3 || !$slotSettings->HasGameData('ImperialDiceEGTJackSteps') ) 
                                {
                                    exit();
                                }
                                $winAmount = 0;
                                ...
                                $slotSettings->SetGameData('ImperialDiceEGTJackSteps', $jackStep);
                                break;
                            case 'gamble':
                                $Balance = $slotSettings->GetBalance();
                                $isGambleWin = rand(1, $slotSettings->GetGambleSettings());
                                $dealerCard = '';
                                $totalWin = $slotSettings->GetGameData('ImperialDiceEGTTotalWin');
                                $gambleWin = 0;
                                $statBet = $totalWin;
                                $slotSettings->SetGameData('ImperialDiceEGTGambleStep', $slotSettings->GetGameData('ImperialDiceEGTGambleStep') - 1);
                                ...
                                else
                                {
                                    ...
                                    $totalWin = 0;
                                    $slotSettings->SetGameData('ImperialDiceEGTGambleStep', 0);
                                    if( $postData['bet']['color'] == '1' ) 
                                    {
                                        $tmpCards = [
                                            '1', 
