                    ...
                    try
                    {
                        ...
                        else if( $postData['slotEvent'] == 'bet' || $postData['slotEvent'] == 'freespin' ) 
                        {
                            ...
                            if( $postData['slotEvent'] == 'freespin' ) 
                            {
                                ...
                                $freeStateStr = '"id":"54594109_20200214110301","current":' . $slotSettings->GetGameData('ChoySunDoaATCurrentFreeGame') . ',"multiplayer":' . $slotSettings->GetGameData('ChoySunDoaATMpl') . ',"xWin":[' . implode(',', $wildsMplArr) . '],"add":0,"total":' . $slotSettings->GetGameData('ChoySunDoaATFreeGames') . ',"totalWin":' . ($slotSettings->GetGameData('ChoySunDoaATBonusWin') * 100) . '';
                            }
                            else
                            {
                                $slotSettings->SetGameData('ChoySunDoaATTotalWin', $totalWin);
