                    ...
                    try
                    {
                        ...
                        switch( $aid ) 
                        {
                            ...
                            case 'Act18':
                                    ...
                                    for( $i = 0; $i <= 2000; $i++ ) 
                                    {
                                        ...
                                        for( $rl = 1; $rl <= 5; $rl++ ) 
                                        {
                                            for( $rs = 0; $rs <= 2; $rs++ ) 
                                            {
                                                ...
                                                if( $reels['reel' . $rl][$rs] == '8' || $reels['reel' . $rl][$rs] == '9' ) 
                                                {
                                                    $scattersCount1++;
                                                }
                                            }
                                ...
                                $result_tmp[0] = '{"action":"' . $aid . '","gameid":75,"serverResponse":' . json_encode($postData) . ',"nickName":"' . $slotSettings->username . '","currency":"' . $slotSettings->slotCurrency . '","Credit":' . $balanceInCents . ',"Denom":' . ($slotSettings->CurrentDenom * 100) . '}';
                                break;
                        }
