            ...
            function get_($request, $game)
            {
                \DB::transaction(function() use ($request, $game)
                {
                    try
                    {
                        ...
                        {
                            $response = '{"status":"success","microtime":0.0026731491088867,"dateTime":"2020-02-13 13:23:32","error":"","content":{"cmd":"sessionInfo","serverMathematics":"\/game\/SunAndMoonAT\/server","serverResources":"","sessionId":"54594109_4133a64673d3883d42cd003ee905ba3e","exitUlt":"\/","exitUrl":"\/","id":"341","name":"GameName","currency":"ALL","language":"en","type":"aristocrat","systemName":"sun_and_moon","version":"2","mobile":"1"}}';
                        }
                        ...
                        else if( $postData['slotEvent'] == 'gamePick' ) 
                        {
                            ...
                            if( $_POST['pick'] == 0 ) 
                            {
                                $slotSettings->SetGameData('SunAndMoonATMpl', 10);
                                $slotSettings->SetGameData('SunAndMoonATCurrentFreeGame', 0);
                                $slotSettings->SetGameData('SunAndMoonATFreeGames', 5);
                            }
                            else if( $_POST['pick'] == 1 ) 
                            {
                                $slotSettings->SetGameData('SunAndMoonATMpl', 5);
                                $slotSettings->SetGameData('SunAndMoonATCurrentFreeGame', 0);
                                $slotSettings->SetGameData('SunAndMoonATFreeGames', 10);
                            }
                            else if( $_POST['pick'] == 2 ) 
                            {
                                $slotSettings->SetGameData('SunAndMoonATMpl', 3);
                                $slotSettings->SetGameData('SunAndMoonATCurrentFreeGame', 0);
                                $slotSettings->SetGameData('SunAndMoonATFreeGames', 15);
                            }
                            else if( $_POST['pick'] == 3 ) 
                            {
                                $slotSettings->SetGameData('SunAndMoonATMpl', 2);
                                $slotSettings->SetGameData('SunAndMoonATCurrentFreeGame', 0);
                                $slotSettings->SetGameData('SunAndMoonATFreeGames', 20);
                            }
                            $response = '{"status":"success","microtime":0.0093810558319092,"dateTime":"2020-02-15 14:26:21","error":"","content":{"session":"54990161_9709e13bca7763b46396cda1868d2e7e","cmd":"gamePick","balance":' . $balanceInCents . ',"win":0,"symbols":{"1":{"1":"symbol_6","2":"symbol_9","3":"symbol_13"},"2":{"1":"symbol_10","2":"symbol_5","3":"symbol_8"},"3":{"1":"symbol_10","2":"symbol_13","3":"symbol_11"},"4":{"1":"symbol_13","2":"symbol_10","3":"symbol_6"},"5":{"1":"symbol_3","2":"symbol_8","3":"symbol_1"}},"winLines":[],"freeSpin":{"id":"54990161_20200215132548","current":0,"add":' . $slotSettings->GetGameData('SunAndMoonATFreeGames') . ',"total":' . $slotSettings->GetGameData('SunAndMoonATFreeGames') . ',"totalWin":' . ($slotSettings->GetGameData('SunAndMoonATBonusWin') * 100) . ',"multiplayer":' . $slotSettings->GetGameData('SunAndMoonATMpl') . ',"pick":' . $_POST['pick'] . '},"actionId":"54990161_10_60","hash":"1ace145628d930d28bdf38789a28a9d7"}}';
                        }
                        else if( $postData['slotEvent'] == 'slotGamble' ) 
                        {
                            ...
                            $dealerCard = '';
                            $totalWin = $slotSettings->GetGameData('SunAndMoonATTotalWin');
                            $gambleWin = 0;
                            $statBet = $totalWin;
                            ...
                            $slotSettings->SetGameData('SunAndMoonATTotalWin', $totalWin);
                        ...
                        else if( $postData['slotEvent'] == 'bet' || $postData['slotEvent'] == 'freespin' ) 
                        {
                            ...
                            if( $postData['slotEvent'] != 'freespin' ) 
                            {
                                ...
                                $bonusMpl = 1;
                                $slotSettings->SetGameData('SunAndMoonATBonusWin', 0);
                                $slotSettings->SetGameData('SunAndMoonATFreeGames', 0);
                                $slotSettings->SetGameData('SunAndMoonATCurrentFreeGame', 0);
                                $slotSettings->SetGameData('SunAndMoonATTotalWin', 0);
                                $slotSettings->SetGameData('SunAndMoonATFreeBalance', 0);
                                $slotSettings->SetGameData('SunAndMoonATMpl', 3);
                            }
                            else
                            {
                                $slotSettings->SetGameData('SunAndMoonATCurrentFreeGame', $slotSettings->GetGameData('SunAndMoonATCurrentFreeGame') + 1);
                                $bonusMpl = $slotSettings->GetGameData('SunAndMoonATMpl');
                            }
                            $Balance = $slotSettings->GetBalance();
                            ...
                            for( $i = 0; $i <= 2000; $i++ ) 
                            {
                                ...
                                if( $scattersCount > 0 && $scattersCount2 > 0 ) 
                                {
                                    $scattersWin = $slotSettings->Paytable['symbol_mixed'][$scattersCount + $scattersCount2] * $postData['slotBet'] * $postData['slotLines'];
                                    $scattersCount = $scattersCount + $scattersCount2;
                                }
                                else
                                {
                                    $scattersWin = $slotSettings->Paytable['symbol_scat'][$scattersCount] * $postData['slotBet'] * $postData['slotLines'];
                                }
                            ...
                            if( $postData['slotEvent'] == 'freespin' ) 
                            {
                                $slotSettings->SetGameData('SunAndMoonATBonusWin', $slotSettings->GetGameData('SunAndMoonATBonusWin') + $totalWin);
                                $slotSettings->SetGameData('SunAndMoonATTotalWin', $slotSettings->GetGameData('SunAndMoonATTotalWin') + $totalWin);
                                $freeStateStr = '"id":"54594109_20200214110301","current":' . $slotSettings->GetGameData('SunAndMoonATCurrentFreeGame') . ',"multiplayer":' . $slotSettings->GetGameData('SunAndMoonATMpl') . ',"add":0,"total":' . $slotSettings->GetGameData('SunAndMoonATFreeGames') . ',"totalWin":' . ($slotSettings->GetGameData('SunAndMoonATBonusWin') * 100) . '';
                            }
                            else
                            {
                                $slotSettings->SetGameData('SunAndMoonATTotalWin', $totalWin);
                            ...
                            if( $scattersCount >= 3 ) 
                            {
                                if( $slotSettings->GetGameData('SunAndMoonATFreeGames') > 0 ) 
                                {
                                    $slotSettings->SetGameData('SunAndMoonATFreeGames', $slotSettings->GetGameData('SunAndMoonATFreeGames') + $slotSettings->slotFreeCount);
                                    $freeStateStr = '"id":"54594109_20200214110301","current":' . $slotSettings->GetGameData('SunAndMoonATCurrentFreeGame') . ',"multiplayer":' . $slotSettings->GetGameData('SunAndMoonATMpl') . ',"add":' . $slotSettings->slotFreeCount . ',"total":' . $slotSettings->GetGameData('SunAndMoonATFreeGames') . ',"totalWin":' . ($slotSettings->GetGameData('SunAndMoonATBonusWin') * 100) . '';
                                }
                                else
                                {
                                    $slotSettings->SetGameData('SunAndMoonATFreeBalance', $Balance);
                                    $slotSettings->SetGameData('SunAndMoonATBonusWin', $totalWin);
                                    $slotSettings->SetGameData('SunAndMoonATFreeGames', $slotSettings->slotFreeCount);
                                    $freeStateStr = '"id":"54594109_20200214110301","current":' . $slotSettings->GetGameData('SunAndMoonATCurrentFreeGame') . ',"multiplayer":' . $slotSettings->GetGameData('SunAndMoonATMpl') . ',"add":' . $slotSettings->slotFreeCount . ',"total":' . $slotSettings->GetGameData('SunAndMoonATFreeGames') . ',"totalWin":' . ($slotSettings->GetGameData('SunAndMoonATBonusWin') * 100) . '';
                                }
                            }
                            ...
                            $response_log = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{"slotLines":' . $postData['slotLines'] . ',"slotBet":' . $postData['slotBet'] . ',"totalFreeGames":' . $slotSettings->GetGameData('SunAndMoonATFreeGames') . ',"Mpl":' . $slotSettings->GetGameData('SunAndMoonATMpl') . ',"currentFreeGames":' . $slotSettings->GetGameData('SunAndMoonATCurrentFreeGame') . ',"Balance":' . $Balance . ',"afterBalance":' . $slotSettings->GetBalance() . ',"totalWin":' . $totalWin . ',"winLines":[' . $winString . '],"bonusInfo":{},"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
                            $reelStrArr = [];
                            for( $i = 1; $i <= 5; $i++ ) 
                            {
