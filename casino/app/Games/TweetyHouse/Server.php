...
namespace VanguardLTE\Games\TweetyHouse
{
    ...
    use VanguardLTE\Games\TweetyHouse\PragmaticLib\Collect;
    use VanguardLTE\Games\TweetyHouse\PragmaticLib\GameSettings;
    use VanguardLTE\Games\TweetyHouse\PragmaticLib\Loader;
    use VanguardLTE\Games\TweetyHouse\PragmaticLib\Log;
    use VanguardLTE\Games\TweetyHouse\PragmaticLib\Spin;
    use VanguardLTE\Games\TweetyHouse\PragmaticLib\DoMysteryScatter;
    use VanguardLTE\Games\TweetyHouse\PragmaticLib\DoBonus;
