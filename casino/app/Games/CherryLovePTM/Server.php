                    ...
                    try
                    {
                        ...
                        if( isset($postData['spinType']) ) 
                        {
                            ...
                            if( $postData['spinType'] == 'regular' ) 
                            {
                                ...
                                $bonusMpl = 1;
                                $slotSettings->SetGameData('CherryLovePTMBonusWin', 0);
                                $slotSettings->SetGameData('CherryLovePTMFreeGames', 0);
                                $slotSettings->SetGameData('CherryLovePTMCurrentFreeGame', 0);
                                $slotSettings->SetGameData('CherryLovePTMTotalWin', 0);
                                $slotSettings->SetGameData('CherryLovePTMFreeBalance', 0);
                                $slotSettings->SetGameData('CherryLovePTMFreeStartWin', 0);
                                $slotSettings->SetGameData('CherryLovePTMWildPos', 0);
                            }
                            else if( $postData['spinType'] == 'free' ) 
                            {
                                $umid = '0';
                                $postData['slotEvent'] = 'freespin';
                                $slotSettings->SetGameData('CherryLovePTMCurrentFreeGame', $slotSettings->GetGameData('CherryLovePTMCurrentFreeGame') + 1);
                            ...
                            for( $i = 0; $i <= 2000; $i++ ) 
                            {
                                ...
                                if( $reels['reel2'][0] == '0' || $reels['reel2'][1] == '0' || $reels['reel2'][2] == '0' || $slotSettings->GetGameData('CherryLovePTMWildPos') == 2 ) 
                                {
                                    $reels['reel2'][0] = '0';
                                    $reels['reel2'][1] = '0';
                                    $reels['reel2'][2] = '0';
                                }
                                if( $reels['reel3'][0] == '0' || $reels['reel3'][1] == '0' || $reels['reel3'][2] == '0' || $slotSettings->GetGameData('CherryLovePTMWildPos') == 3 ) 
                                {
                                    $reels['reel3'][0] = '0';
                                    $reels['reel3'][1] = '0';
                                    $reels['reel3'][2] = '0';
                                }
                                if( $reels['reel4'][0] == '0' || $reels['reel4'][1] == '0' || $reels['reel4'][2] == '0' || $slotSettings->GetGameData('CherryLovePTMWildPos') == 4 ) 
                                {
                                    $reels['reel4'][0] = '0';
                                    $reels['reel4'][1] = '0';
                                    $reels['reel4'][2] = '0';
                                    ...
                                    for( $j = 0; $j < count($slotSettings->SymbolGame); $j++ ) 
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            if( $s[0] == $csym || in_array($s[0], $wild) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":1,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('CherryLovePTMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":["none","none"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":2,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('CherryLovePTMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":3,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('CherryLovePTMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) && ($s[3] == $csym || in_array($s[3], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":4,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('CherryLovePTMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) && ($s[3] == $csym || in_array($s[3], $wild)) && ($s[4] == $csym || in_array($s[4], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":5,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('CherryLovePTMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":[' . ($linesId[$k][4] - 1) . ',"' . $s[4] . '"]}';
                                                }
                                            }
                                        }
                                    }
                            ...
                            if( $postData['slotEvent'] == 'freespin' ) 
                            {
                                $slotSettings->SetGameData('CherryLovePTMBonusWin', $slotSettings->GetGameData('CherryLovePTMBonusWin') + $totalWin);
                                $slotSettings->SetGameData('CherryLovePTMTotalWin', $totalWin);
                                $slotSettings->SetGameData('CherryLovePTMWildPos', $slotSettings->GetGameData('CherryLovePTMWildPos') + 1);
                                if( $slotSettings->GetGameData('CherryLovePTMWildPos') > 4 ) 
                                {
                                    $slotSettings->SetGameData('CherryLovePTMWildPos', 2);
                                }
                            }
                            else
                            {
                            ...
                            if( $scattersCount >= 3 ) 
                            {
                                if( $slotSettings->GetGameData('CherryLovePTMFreeGames') > 0 ) 
                                {
                                    $slotSettings->SetGameData('CherryLovePTMFreeGames', $slotSettings->GetGameData('CherryLovePTMFreeGames') + $slotSettings->slotFreeCount);
                                }
                                else
                                {
                                    $slotSettings->SetGameData('CherryLovePTMWildPos', 2);
                                    $slotSettings->SetGameData('CherryLovePTMFreeStartWin', $totalWin);
                                    $slotSettings->SetGameData('CherryLovePTMBonusWin', 0);
                                    $slotSettings->SetGameData('CherryLovePTMFreeGames', $slotSettings->slotFreeCount);
                                }
                            }
                            $balanceInCents = sprintf('%01.2f', $slotSettings->GetBalance()) * 100;
                            ...
                            $response = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{"WildPos":' . $slotSettings->GetGameData('CherryLovePTMWildPos') . ',"linesArr":[' . implode(',', $postData['lines']) . '],"slotLines":' . $lines . ',"slotBet":' . $betLine . ',"totalFreeGames":' . $slotSettings->GetGameData('CherryLovePTMFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('CherryLovePTMCurrentFreeGame') . ',"Balance":' . $slotSettings->GetBalance() . ',"afterBalance":' . $slotSettings->GetBalance() . ',"bonusWin":' . $slotSettings->GetGameData('CherryLovePTMBonusWin') . ',"freeStartWin":' . $slotSettings->GetGameData('CherryLovePTMFreeStartWin') . ',"totalWin":' . $totalWin . ',"winLines":[' . $winString . '],"bonusInfo":' . $scattersStr . ',"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
                        ...
                        switch( $umid ) 
                        {
                            ...
                            case '40066':
                                ...
                                $result_tmp[] = '3:::{"data":{"funNoticeGames":0,"funNoticePayouts":0,"gameGroup":"chl","minBet":0,"maxBet":0,"minPosBet":0,"maxPosBet":50000,"coinSizes":[' . implode(',', $gameBets) . ']},"ID":40025,"umid":21}';
                                break;
                            case '40036':
                                ...
                                if( $lastEvent != 'NULL' ) 
                                {
                                    ...
                                    $slotSettings->SetGameData('CherryLovePTMWildPos', $lastEvent->serverResponse->WildPos);
                                    ...
                                    {
                                        $slotSettings->SetGameData($slotSettings->slotId . 'brokenGames', 'chl');
                                    }
                                }
