                ...
                \DB::transaction(function() use ($request, $game)
                {
                    try
                    {
                        ...
                        else if( $postData['slotEvent'] == 'gamble5GetUserCards' ) 
                        {
                            ...
                            $dealerCard = $slotSettings->GetGameData('AlchemistsSecretGTDealerCard');
                            $totalWin = $slotSettings->GetGameData('AlchemistsSecretGTTotalWin');
                            $gambleWin = 0;
                            ...
                            $slotSettings->SetGameData('AlchemistsSecretGTTotalWin', $totalWin);
                        ...
                        else if( $postData['slotEvent'] == 'gamble5GetDealerCard' ) 
                        {
                            ...
                            $slotSettings->SetGameData('AlchemistsSecretGTDealerCard', $tmpDc);
                        ...
                        else if( $postData['slotEvent'] == 'bet' || $postData['slotEvent'] == 'freespin' ) 
                        {
                            ...
                            if( $postData['slotEvent'] != 'freespin' ) 
                            {
                                ...
                                $bonusMpl = 1;
                                $slotSettings->SetGameData('AlchemistsSecretGTBonusWin', 0);
                                $slotSettings->SetGameData('AlchemistsSecretGTFreeGames', 0);
                                $slotSettings->SetGameData('AlchemistsSecretGTCurrentFreeGame', 0);
                                $slotSettings->SetGameData('AlchemistsSecretGTTotalWin', 0);
                                $slotSettings->SetGameData('AlchemistsSecretGTFreeBalance', 0);
                                $slotSettings->SetGameData('AlchemistsSecretGTFreeStacked', [
                                    'false', 
                                    'false', 
                                    'false', 
                                    'false', 
                                ...
                                $slotSettings->SetGameData('AlchemistsSecretGTFreeSeries', 0);
                            ...
                            else
                            {
                                ...
                                $slotSettings->SetGameData('AlchemistsSecretGTCurrentFreeGame', $slotSettings->GetGameData('AlchemistsSecretGTCurrentFreeGame') + 1);
                                $bonusMpl = $slotSettings->slotFreeMpl;
                                if( $slotSettings->GetGameData('AlchemistsSecretGTCurrentFreeGame') == $slotSettings->GetGameData('AlchemistsSecretGTFreeGames') ) 
                                {
                            ...
                            for( $i = 0; $i <= 2000; $i++ ) 
                            {
                                ...
                                if( $postData['slotEvent'] == 'freespin' ) 
                                {
                                    ...
                                    for( $ii = 1; $ii <= 5; $ii++ ) 
                                    {
                                        if( $slotSettings->GetGameData('AlchemistsSecretGTFreeStacked')[$stackCount] == 'true' ) 
                                        {
                                    ...
                                    for( $j = 0; $j < count($slotSettings->SymbolGame); $j++ ) 
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            if( $s[0] == $csym || in_array($s[0], $wild) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":1,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('AlchemistsSecretGTBonusWin')) . ',"winReel1":[' . ($linesId[$k + 1][0] - 1) . ',"' . $s[0] . '"],"winReel2":["none","none"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":2,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('AlchemistsSecretGTBonusWin')) . ',"winReel1":[' . ($linesId[$k + 1][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k + 1][1] - 1) . ',"' . $s[1] . '"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            $s[0] = $reels['reel1'][$linesId[$k + 1][0] - 1];
                                            $s[1] = $reels['reel2'][$linesId[$k + 1][1] - 1];
                                            ...
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":3,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('AlchemistsSecretGTBonusWin')) . ',"winReel1":[' . ($linesId[$k + 1][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k + 1][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k + 1][2] - 1) . ',"' . $s[2] . '"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            $s[0] = $reels['reel1'][$linesId[$k + 1][0] - 1];
                                            $s[1] = $reels['reel2'][$linesId[$k + 1][1] - 1];
                                            ...
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) && ($s[3] == $csym || in_array($s[3], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":4,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('AlchemistsSecretGTBonusWin')) . ',"winReel1":[' . ($linesId[$k + 1][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k + 1][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k + 1][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k + 1][3] - 1) . ',"' . $s[3] . '"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            $s[0] = $reels['reel1'][$linesId[$k + 1][0] - 1];
                                            $s[1] = $reels['reel2'][$linesId[$k + 1][1] - 1];
                                            ...
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) && ($s[3] == $csym || in_array($s[3], $wild)) && ($s[4] == $csym || in_array($s[4], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":5,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('AlchemistsSecretGTBonusWin')) . ',"winReel1":[' . ($linesId[$k + 1][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k + 1][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k + 1][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k + 1][3] - 1) . ',"' . $s[3] . '"],"winReel5":[' . ($linesId[$k + 1][4] - 1) . ',"' . $s[4] . '"]}';
                                                }
                                                if( $isSlotJack ) 
                                                {
                                                    $tmpStringWin = '';
                            ...
                            if( $postData['slotEvent'] == 'freespin' && $slotSettings->GetGameData('AlchemistsSecretGTFreeGames') <= $slotSettings->GetGameData('AlchemistsSecretGTCurrentFreeGame') && $winType != 'bonus' && $slotSettings->GetGameData('AlchemistsSecretGTTotalWin') + $totalWin > 0 ) 
                            {
                                $slotSettings->SetBalance($slotSettings->GetGameData('AlchemistsSecretGTTotalWin') + $totalWin);
                            }
                            ...
                            if( $postData['slotEvent'] == 'freespin' ) 
                            {
                                $slotSettings->SetGameData('AlchemistsSecretGTBonusWin', $slotSettings->GetGameData('AlchemistsSecretGTBonusWin') + $totalWin);
                                $slotSettings->SetGameData('AlchemistsSecretGTTotalWin', $slotSettings->GetGameData('AlchemistsSecretGTTotalWin') + $totalWin);
                                $totalWin = $slotSettings->GetGameData('AlchemistsSecretGTBonusWin');
                                $Balance = $slotSettings->GetGameData('AlchemistsSecretGTFreeBalance');
                                $stackCount = 1;
                                $stackA = $slotSettings->GetGameData('AlchemistsSecretGTFreeStacked');
                                for( $i = 1; $i <= 5; $i++ ) 
                                {
                                ...
                                $slotSettings->SetGameData('AlchemistsSecretGTFreeStacked', $stackA);
                            }
                            else
                            {
                                $slotSettings->SetGameData('AlchemistsSecretGTTotalWin', $totalWin);
                            ...
                            if( $scattersCount >= 3 ) 
                            {
                                if( $slotSettings->GetGameData('AlchemistsSecretGTFreeGames') > 0 ) 
                                {
                                    $slotSettings->SetGameData('AlchemistsSecretGTFreeBalance', $Balance);
                                    $slotSettings->SetGameData('AlchemistsSecretGTBonusWin', $totalWin);
                                    $slotSettings->SetGameData('AlchemistsSecretGTFreeGames', $slotSettings->GetGameData('AlchemistsSecretGTFreeGames') + $slotSettings->slotFreeCount);
                                }
                                else
                                {
                                    $slotSettings->SetGameData('AlchemistsSecretGTFreeBalance', $Balance);
                                    $slotSettings->SetGameData('AlchemistsSecretGTBonusWin', $totalWin);
                                    $slotSettings->SetGameData('AlchemistsSecretGTFreeGames', $slotSettings->slotFreeCount);
                                    $stackCount = 1;
                                    $stackA = $slotSettings->GetGameData('AlchemistsSecretGTFreeStacked');
                                    for( $i = 1; $i <= 5; $i++ ) 
                                    {
                            ...
                            $response = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{"curSeq":' . json_encode($curSeq) . ',"slotLines":' . $postData['slotLines'] . ',"slotBet":' . $postData['slotBet'] . ',"slotJackpot":' . $slotSettings->slotJackpot[0] . ',"stackedWilds":[' . implode(',', $slotSettings->GetGameData('AlchemistsSecretGTFreeStacked')) . '],"totalFreeGames":' . $slotSettings->GetGameData('AlchemistsSecretGTFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('AlchemistsSecretGTCurrentFreeGame') . ',"Balance":' . $Balance . ',"afterBalance":' . $slotSettings->GetBalance() . ',"totalWin":' . $totalWin . ',"winLines":[' . $winString . '],"bonusInfo":' . $scattersStr . ',"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
                            $response_log = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{"curSeq":' . json_encode($curSeq) . ',"slotLines":' . $postData['slotLines'] . ',"slotBet":' . $postData['slotBet'] . ',"slotJackpot":' . $slotSettings->slotJackpot[0] . ',"stackedWilds":[' . implode(',', $slotSettings->GetGameData('AlchemistsSecretGTFreeStacked')) . '],"totalFreeGames":' . $slotSettings->GetGameData('AlchemistsSecretGTFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('AlchemistsSecretGTCurrentFreeGame') . ',"Balance":' . $Balance . ',"afterBalance":' . $slotSettings->GetBalance() . ',"totalWin":' . $totalWin . ',"winLines":[' . $winString . '],"bonusInfo":' . $scattersStr . ',"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
