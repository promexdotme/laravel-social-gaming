                    ...
                    try
                    {
                        ...
                        if( isset($postData['spinType']) ) 
                        {
                            ...
                            if( $postData['spinType'] == 'regular' ) 
                            {
                                ...
                                $bonusMpl = 1;
                                $slotSettings->SetGameData('DesertTreasurePTBonusWin', 0);
                                $slotSettings->SetGameData('DesertTreasurePTFreeGames', 0);
                                $slotSettings->SetGameData('DesertTreasurePTCurrentFreeGame', 0);
                                $slotSettings->SetGameData('DesertTreasurePTTotalWin', 0);
                                $slotSettings->SetGameData('DesertTreasurePTFreeBalance', 0);
                                $slotSettings->SetGameData('DesertTreasurePTFreeStartWin', 0);
                                $chosenTree = 0;
                                $startStick = 0;
                                $treeStep = [
                                    -1, 
                                ...
                                $slotSettings->SetGameData('DesertTreasurePTChosenTree', $chosenTree);
                                $slotSettings->SetGameData('DesertTreasurePTstartStick', $startStick);
                                $slotSettings->SetGameData('DesertTreasurePTtreeStep', $treeStep);
                                $slotSettings->SetGameData('DesertTreasurePTlastWins', $lastWins);
                            }
                            else if( $postData['spinType'] == 'free' ) 
                            {
                                $umid = '0';
                                $postData['slotEvent'] = 'freespin';
                                $slotSettings->SetGameData('DesertTreasurePTCurrentFreeGame', $slotSettings->GetGameData('DesertTreasurePTCurrentFreeGame') + 1);
                            ...
                            $slotSettings->SetGameData('DesertTreasurePTAllBet', $postData['bet']);
                            $slotSettings->SetGameData('DesertTreasurePTBetLine', $betLine);
                            for( $i = 0; $i <= 2000; $i++ ) 
                            {
                                $totalWin = 0;
                                $lineWins = [];
                                    ...
                                    for( $j = 0; $j < count($slotSettings->SymbolGame); $j++ ) 
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            if( $s[0] == $csym || in_array($s[0], $wild) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":1,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('DesertTreasurePTBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":["none","none"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":2,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('DesertTreasurePTBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":3,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('DesertTreasurePTBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) && ($s[3] == $csym || in_array($s[3], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":4,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('DesertTreasurePTBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) && ($s[3] == $csym || in_array($s[3], $wild)) && ($s[4] == $csym || in_array($s[4], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":5,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('DesertTreasurePTBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":[' . ($linesId[$k][4] - 1) . ',"' . $s[4] . '"]}';
                                                }
                                            }
                                            if( $csym == '2' ) 
                                            {
                            ...
                            if( $postData['slotEvent'] == 'freespin' ) 
                            {
                                $slotSettings->SetGameData('DesertTreasurePTBonusWin', $slotSettings->GetGameData('DesertTreasurePTBonusWin') + $totalWin);
                                $slotSettings->SetGameData('DesertTreasurePTTotalWin', $totalWin);
                            }
                            else
                            {
                                $slotSettings->SetGameData('DesertTreasurePTTotalWin', $totalWin);
                            ...
                            if( $scattersCount >= 3 ) 
                            {
                                if( $slotSettings->GetGameData('DesertTreasurePTFreeGames') > 0 ) 
                                {
                                    $slotSettings->SetGameData('DesertTreasurePTFreeGames', $slotSettings->GetGameData('DesertTreasurePTFreeGames') + $slotSettings->slotFreeCount);
                                }
                                else
                                {
                                    $slotSettings->SetGameData('DesertTreasurePTFreeStartWin', $totalWin);
                                    $slotSettings->SetGameData('DesertTreasurePTBonusWin', 0);
                                    $slotSettings->SetGameData('DesertTreasurePTFreeGames', $slotSettings->slotFreeCount);
                                }
                            }
                            ...
                            if( $eggBonusStart ) 
                            {
                                ...
                                $slotSettings->SetGameData('DesertTreasurePTWinValues', $eggResult['curValues']);
                                $slotSettings->SetGameData('DesertTreasurePTPickedCount', 0);
                                $slotSettings->SetGameData('DesertTreasurePTPickedCountArr', [
                                    0, 
                                    0, 
                                    0, 
                                    0, 
                                ...
                                $slotSettings->SetGameData('DesertTreasurePTeggBonusNum', $eggBonusNum);
                            }
                            $response = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{' . $bStr . '"allbet":' . $slotSettings->GetGameData('DesertTreasurePTAllBet') . ',"betLine":' . $slotSettings->GetGameData('DesertTreasurePTBetLine') . ',"linesArr":[' . implode(',', $postData['lines']) . '],"slotLines":' . $lines . ',"slotBet":' . $betLine . ',"totalFreeGames":' . $slotSettings->GetGameData('DesertTreasurePTFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('DesertTreasurePTCurrentFreeGame') . ',"Balance":' . $slotSettings->GetBalance() . ',"afterBalance":' . $slotSettings->GetBalance() . ',"bonusWin":' . $slotSettings->GetGameData('DesertTreasurePTBonusWin') . ',"freeStartWin":' . $slotSettings->GetGameData('DesertTreasurePTFreeStartWin') . ',"totalWin":' . $totalWin . ',"winLines":[' . $winString . '],"bonusInfo":' . $scattersStr . ',"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jmobdtin . '}}';
                            $slotSettings->SetGameData('DesertTreasurePTLastResponse', $response);
                            $slotSettings->SaveLogReport($response, $betLine, $lines, $reportWin, $postData['slotEvent']);
                        }
                        switch( $umid ) 
                        {
                            case '40230':
                                if( $postData['index'] >= 0 && $slotSettings->GetGameData('DesertTreasurePTPickedCount') < $slotSettings->GetGameData('DesertTreasurePTeggBonusNum') ) 
                                {
                                    $lr = json_decode($slotSettings->GetGameData('DesertTreasurePTLastResponse'));
                                    $values = $slotSettings->GetGameData('DesertTreasurePTWinValues');
                                    $pick = $slotSettings->GetGameData('DesertTreasurePTPickedCount');
                                    $pickArr = $slotSettings->GetGameData('DesertTreasurePTPickedCountArr');
                                    $reportWin = $values[$pick] * $slotSettings->GetGameData('DesertTreasurePTBetLine');
                                    $slotSettings->SetBalance($reportWin);
                                    $pick++;
                                    $pickArr[$postData['index']] = $reportWin;
                                    $slotSettings->SetGameData('DesertTreasurePTPickedCount', $pick);
                                    $slotSettings->SetGameData('DesertTreasurePTPickedCountArr', $pickArr);
                                    ...
                                    $slotSettings->SetGameData('DesertTreasurePTLastResponse', json_encode($lr));
                            ...
                            case '40036':
                                ...
                                if( $lastEvent != 'NULL' ) 
                                {
                                    ...
                                    $slotSettings->SetGameData('DesertTreasurePTLastResponse', json_encode($lastEvent));
                                    $slotSettings->SetGameData('DesertTreasurePTWinValues', $lastEvent->serverResponse->winValues);
                                    $slotSettings->SetGameData('DesertTreasurePTPickedCount', $lastEvent->serverResponse->PickedCount);
                                    $slotSettings->SetGameData('DesertTreasurePTPickedCountArr', $lastEvent->serverResponse->PickedCountArr);
                                    $slotSettings->SetGameData('DesertTreasurePTEggNum', $lastEvent->serverResponse->eggBonusNum);
                                    $slotSettings->SetGameData('DesertTreasurePTEeggBonusNum', $lastEvent->serverResponse->eggBonusNum);
                                    if( $slotSettings->GetGameData($slotSettings->slotId . 'CurrentFreeGame') < $slotSettings->GetGameData($slotSettings->slotId . 'FreeGames') && $slotSettings->GetGameData($slotSettings->slotId . 'FreeGames') > 0 ) 
                                    {
                                        $slotSettings->SetGameData($slotSettings->slotId . 'brokenGames', 'mobdt');
                                    }
                                    if( $lastEvent->responseType == 'egg_bonus' && $slotSettings->GetGameData('DesertTreasurePTPickedCount') < $slotSettings->GetGameData('DesertTreasurePTEeggBonusNum') ) 
                                    {
                                        $slotSettings->SetGameData($slotSettings->slotId . 'brokenGames', 'mobdt');
                                    }
                                    $slotSettings->SetGameData('DesertTreasurePTresponseType', $lastEvent->responseType);
                                }
                            ...
                            case '40030':
                                ...
                                {
                                    if( $slotSettings->GetGameData('DesertTreasurePTresponseType') == 'egg_bonus' ) 
                                    {
                                        $values = $slotSettings->GetGameData('DesertTreasurePTWinValues');
                                        $pick = $slotSettings->GetGameData('DesertTreasurePTPickedCount');
                                        $pickArr = $slotSettings->GetGameData('DesertTreasurePTPickedCountArr');
                                        $result_tmp[] = '3:::{"data":{"coinsPerLine":1,"numFreeSpins":0,"bonusTaken":[' . implode(',', $pickArr) . '],"coinage":' . ($slotSettings->GetGameData($slotSettings->slotId . 'Bet') * 100) . ',"bonusType":' . $slotSettings->GetGameData('DesertTreasurePTEggNum') . ',"freeSpinWin":0,"coins":0,"windowId":"r9Lq45"},"ID":40233,"umid":28}';
                                    }
                                    else
                                    {
