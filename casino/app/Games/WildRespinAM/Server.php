                    ...
                    switch( $gameData['slotEvent'] ) 
                    {
                        ...
                        case 'A/u25':
                            ...
                            if( $lastEvent != 'NULL' ) 
                            {
                                ...
                                $slotSettings->SetGameData('WildRespinAMLines', $curLines);
                                $freeMpl = '11';
                                $slotSettings->SetGameData('WildRespinAMBonusWin', $lastEvent->serverResponse->bonusWin);
                                $slotSettings->SetGameData('WildRespinAMFreeGames', $lastEvent->serverResponse->totalFreeGames);
                                $slotSettings->SetGameData('WildRespinAMCurrentFreeGame', $lastEvent->serverResponse->currentFreeGames);
                                $slotSettings->SetGameData('WildRespinAMTotalWin', 0);
                                $slotSettings->SetGameData('WildRespinAMFreeBalance', 0);
                                $slotSettings->SetGameData('WildRespinAMFreeStartWin', 0);
                                $tFree = dechex($slotSettings->GetGameData('WildRespinAMFreeGames'));
                                $cFree = dechex($slotSettings->GetGameData('WildRespinAMFreeGames') - $slotSettings->GetGameData('WildRespinAMCurrentFreeGame'));
                                $freeInfo = strlen($tFree) . $tFree . strlen($cFree) . $cFree;
                                $stateWin = $slotSettings->HexFormat($slotSettings->GetGameData('WildRespinAMBonusWin') * $floatBet);
                            }
                            else
                            {
                                $slotSettings->SetGameData('WildRespinAMLines', $fixedLinesFormated);
                                $slotState = '4';
                            ...
                            break;
                        case 'A/u250':
                            $fixedLinesFormated = $slotSettings->GetGameData('WildRespinAMLines');
                            $balanceFormated = $slotSettings->HexFormat(round($slotSettings->GetBalance() * $floatBet));
                            $lastEvent = $slotSettings->GetHistory();
                            if( $lastEvent != 'NULL' ) 
                            {
                        ...
                        case 'A/u251':
                            if( $postData['spinType'] == 'regular' && $slotSettings->GetGameData($slotSettings->slotId . 'FreeGames') <= $slotSettings->GetGameData($slotSettings->slotId . 'CurrentFreeGame') ) 
                            {
                                ...
                                $bonusMpl = 1;
                                $slotSettings->SetGameData('WildRespinAMRespinState', [
                                    [
                                        'f', 
                                        'f', 
                                        'f', 
                                ...
                                $slotSettings->SetGameData('WildRespinAMRSym', 'f');
                                $slotSettings->SetGameData('WildRespinAMBonusWin', 0);
                                $slotSettings->SetGameData('WildRespinAMFreeGames', 0);
                                $slotSettings->SetGameData('WildRespinAMCurrentFreeGame', 0);
                                $slotSettings->SetGameData('WildRespinAMTotalWin', 0);
                                $slotSettings->SetGameData('WildRespinAMFreeBalance', 0);
                                $slotSettings->SetGameData('WildRespinAMFreeStartWin', 0);
                            }
                            if( $slotSettings->GetGameData($slotSettings->slotId . 'CurrentFreeGame') < $slotSettings->GetGameData($slotSettings->slotId . 'FreeGames') ) 
                            {
                                ...
                                $slotSettings->SetGameData('WildRespinAMCurrentFreeGame', $slotSettings->GetGameData('WildRespinAMCurrentFreeGame') + 1);
                            ...
                            for( $i = 0; $i <= 2000; $i++ ) 
                            {
                                ...
                                $rsArr = $slotSettings->GetGameData('WildRespinAMRespinState');
                                $nextRespin = false;
                                if( $postData['slotEvent'] == 'freespin' ) 
                                {
                                    for( $r = 1; $r <= 5; $r++ ) 
                                    ...
                                    for( $r = 1; $r <= 5; $r++ ) 
                                    {
                                        for( $p = 0; $p <= 3; $p++ ) 
                                        {
                                            if( $reels['reel' . $r][$p] == $slotSettings->GetGameData('WildRespinAMRSym') || $reels['reel' . $r][$p] == '9' ) 
                                            {
                                                if( $rsArr[$p][$r - 1] != $slotSettings->GetGameData('WildRespinAMRSym') && $rsArr[$p][$r - 1] != '9' ) 
                                                {
                                                    $nextRespin = true;
                                                }
                                    ...
                                    for( $j = 0; $j < count($slotSettings->SymbolGame); $j++ ) 
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            if( $s[0] == $csym || in_array($s[0], $wild) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":1,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('WildRespinAMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":["none","none"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":2,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('WildRespinAMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":3,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('WildRespinAMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) && ($s[3] == $csym || in_array($s[3], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":4,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('WildRespinAMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) && ($s[3] == $csym || in_array($s[3], $wild)) && ($s[4] == $csym || in_array($s[4], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":5,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('WildRespinAMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":[' . ($linesId[$k][4] - 1) . ',"' . $s[4] . '"]}';
                                                }
                                            }
                                        }
                                    }
                            ...
                            {
                                $totalWin = 0;
                                $slotSettings->SetGameData('WildRespinAMFreeGames', $slotSettings->slotFreeCount);
                                $slotSettings->SetGameData('WildRespinAMCurrentFreeGame', 0);
                            }
                            ...
                            if( $postData['slotEvent'] == 'freespin' ) 
                            {
                                $slotSettings->SetGameData('WildRespinAMBonusWin', $slotSettings->GetGameData('WildRespinAMBonusWin') + $totalWin);
                                $slotSettings->SetGameData('WildRespinAMTotalWin', $totalWin);
                            }
                            else
                            {
                                $slotSettings->SetGameData('WildRespinAMTotalWin', $totalWin);
                            ...
                            if( $winType == 'bonus' ) 
                            {
                                ...
                                $slotSettings->SetGameData('WildRespinAMRSym', $reels['rsym']);
                                $slotSettings->SetGameData('WildRespinAMFreeStartWin', $totalWin);
                                $slotSettings->SetGameData('WildRespinAMBonusWin', $totalWin);
                                $slotSettings->SetGameData('WildRespinAMFreeGames', $slotSettings->slotFreeCount);
                                for( $r = 1; $r <= 5; $r++ ) 
                                {
                                    for( $p = 0; $p <= 3; $p++ ) 
                            ...
                            $response_log = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{"slotLines":' . $lines . ',"slotBet":' . $betCnt . ',"totalFreeGames":' . $slotSettings->GetGameData('WildRespinAMFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('WildRespinAMCurrentFreeGame') . ',"Balance":' . $slotSettings->GetBalance() . ',"afterBalance":' . $slotSettings->GetBalance() . ',"bonusWin":' . $slotSettings->GetGameData('WildRespinAMBonusWin') . ',"freeStartWin":' . $slotSettings->GetGameData('WildRespinAMFreeStartWin') . ',"totalWin":' . $totalWin . ',"winLines":[' . $winString . '],"bonusInfo":' . $scattersStr . ',"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
                            ...
                            $slotSettings->SetGameData('WildRespinAMRespinState', $rsArr);
                            $respinState = '0' . $slotSettings->GetGameData('WildRespinAMRSym') . '15' . implode('', $rsArr[0]) . '15' . implode('', $rsArr[1]) . '15' . implode('', $rsArr[2]) . '15' . implode('', $rsArr[3]);
                            $response = '1' . $gameState . '010' . $balanceFormated . $slotSettings->HexFormat(round($totalWin * 100)) . $reelSate . $bet_h . $ln_h . $freeInfo . $freeWinState . $slotSettings->HexFormat($bonusMpl) . '1010' . $reelSate . $fixedLinesFormated0 . $winLinesFormated . implode('', $slotSettings->GetGameData($slotSettings->slotId . 'Cards')) . '' . $respinState . '#' . $winType;
                            $response .= ('_' . json_encode($reels));
                            $slotSettings->SetGameData('WildRespinAMDoubleAnswer', $reelSate . $bet_h . $ln_h . '1010101010101010101010' . $fixedLinesFormated0 . $winLinesFormated);
                            $slotSettings->SetGameData('WildRespinAMDoubleBalance', $balanceFormated);
                            $slotSettings->SetGameData('WildRespinAMDoubleWin', $totalWin);
                            if( $postData['slotEvent'] == 'freespin' ) 
                            {
                            ...
                            $slotSettings->SetGameData('WildRespinAMCollectP0', $response_collect0);
                            $gameState = '04';
                            $balanceFormated = $slotSettings->HexFormat(round($slotSettings->GetBalance() * $floatBet));
                            ...
                            $slotSettings->SetGameData('WildRespinAMCollect', $response_collect);
                            break;
                        case 'A/u254':
                            $slotSettings->SetGameData($slotSettings->slotId . 'TotalWin', 0);
                            $response = $slotSettings->GetGameData('WildRespinAMCollect');
                            break;
                        case 'A/u257':
                            $doubleWin = rand(1, 2);
                            $winall = $slotSettings->GetGameData('WildRespinAMDoubleWin');
                            $dbet = $winall;
                            $daction = $tmpPar[1];
                            ...
                            $response = '107010' . $slotSettings->GetGameData('WildRespinAMDoubleBalance') . strlen($winall_h) . $winall_h . $slotSettings->GetGameData('WildRespinAMDoubleAnswer') . implode('', $slotSettings->GetGameData($slotSettings->slotId . 'Cards'));
                            $slotSettings->SetGameData('WildRespinAMDoubleWin', $winall);
                            $slotSettings->SetGameData('WildRespinAMTotalWin', $winall);
                            $balanceFormated = $slotSettings->HexFormat(round($slotSettings->GetBalance() * $floatBet));
                            $response_collect = '104010' . $balanceFormated . strlen($winall_h) . $winall_h . $slotSettings->GetGameData('WildRespinAMCollectP0');
                            $slotSettings->SetGameData('WildRespinAMCollect', $response_collect);
                        ...
                        case 'A/u258':
                            ...
                            $slotSettings->SetGameData('WildRespinAMDoubleBalance', $rtnBalance);
                            $winall = sprintf('%01.2f', $winall) * $floatBet;
                            $winall_h1 = str_replace('.', '', $winall . '');
                            $winall_h = dechex($winall_h1);
                            $doubleCards = '26280b2714161d0c';
                            $response = '108010' . $slotSettings->GetGameData('WildRespinAMDoubleBalance') . strlen($winall_h) . $winall_h . $slotSettings->GetGameData('WildRespinAMDoubleAnswer') . implode('', $slotSettings->GetGameData($slotSettings->slotId . 'Cards'));
                            break;
                    }
