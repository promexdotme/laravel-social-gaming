            ...
            function get_($request, $game)
            {
                \DB::transaction(function() use ($request, $game)
                {
                    try
                    {
                        ...
                        {
                            case 'create_session':
                                $slotSettings->SetGameData('MightyRexCTCards', [
                                    19, 
                                    44, 
                                    0, 
                                    37, 
                            ...
                            case 'init_game':
                                ...
                                $slotSettings->SetGameData('MightyRexCTBonusWin', 0);
                                $slotSettings->SetGameData('MightyRexCTFreeGames', 0);
                                $slotSettings->SetGameData('MightyRexCTCurrentFreeGame', 0);
                                $slotSettings->SetGameData('MightyRexCTCurrentFreeGame0', 0);
                                $slotSettings->SetGameData('MightyRexCTTotalWin', 0);
                                $slotSettings->SetGameData('MightyRexCTFreeBalance', 0);
                                ...
                                if( $lastEvent != 'NULL' ) 
                                {
                                    ...
                                    if( $slotSettings->GetGameData('MightyRexCTCurrentFreeGame') < $slotSettings->GetGameData('MightyRexCTFreeGames') && $slotSettings->GetGameData('MightyRexCTFreeGames') > 0 ) 
                                    {
                            ...
                            case 'poll':
                                ...
                                {
                                    $balanceInCents = sprintf('%01.2f', $slotSettings->GetBalance() - $slotSettings->GetGameData('MightyRexCTTotalWin')) * 100;
                                }
                            ...
                            case 'game_finished':
                                $slotSettings->SetGameData('MightyRexCTBonusWin', 0);
                                $slotSettings->SetGameData('MightyRexCTTotalWin', 0);
                                $responseData['game_finished'][0]['freeround_play'] = $slotSettings->GetGameData('MightyRexCTCurrentFreeGame0');
                            ...
                            case 'subgame_finished':
                                if( $slotSettings->GetGameData('MightyRexCTCurrentFreeGame0') < $slotSettings->GetGameData('MightyRexCTFreeGames') && $slotSettings->GetGameData('MightyRexCTFreeGames') > 0 ) 
                                {
                                    ...
                                    $response = '{"responseEvent":"spin","responseType":"freespin","serverResponse":{"result":' . json_encode($result) . ',"slotDenom":' . $slotSettings->GetGameData($slotSettings->slotId . 'Denom') . ',"slotLines":' . $lines . ',"slotBet":' . $betline . ',"totalFreeGames":' . $slotSettings->GetGameData('MightyRexCTFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('MightyRexCTCurrentFreeGame0') . ',"Balance":' . $slotSettings->GetGameData('MightyRexCTFreeBalance') . ',"afterBalance":' . $slotSettings->GetGameData('MightyRexCTFreeBalance') . ',"bonusWin":' . $slotSettings->GetGameData('MightyRexCTBonusWin') . ',"totalWin":' . $reportWin . ',"winLines":[],"Jackpots":[],"reelsSymbols":' . json_encode($slotSettings->GetGameData($slotSettings->slotId . 'Reels')) . '}}';
                                    if( $slotSettings->GetGameData('MightyRexCTFreeGames') <= $slotSettings->GetGameData('MightyRexCTCurrentFreeGame0') ) 
                                    {
                                        if( $reportWin > 0 ) 
                                        {
                                    ...
                                    $balanceInCents = $slotSettings->GetGameData('MightyRexCTFreeBalance');
                                    $responseData['subgame_finished'][0]['account_status']['credit'] = round($balanceInCents);
                                    $responseData['subgame_finished'][0]['freeround_play'] = $slotSettings->GetGameData('MightyRexCTCurrentFreeGame0');
                                    $responseData['subgame_finished'][1]['freeround_play'] = $slotSettings->GetGameData('MightyRexCTCurrentFreeGame0');
                            ...
                            case 'play':
                                ...
                                for( $spinLoop = 0; $spinLoop < $spinLoopLimit; $spinLoop++ ) 
                                {
                                    ...
                                    if( $postData['slotEvent'] != 'freespin' ) 
                                    {
                                        ...
                                        $slotSettings->SetGameData('MightyRexCTCurrentFreeGame0', 0);
                                        $slotSettings->SetGameData('MightyRexCTTotalWin', 0);
                                        $slotSettings->SetGameData('MightyRexCTFreeBalance', sprintf('%01.2f', $slotSettings->GetBalance()) * 100);
                                    ...
                                    {
                                        $slotSettings->SetGameData('MightyRexCTCurrentFreeGame', $slotSettings->GetGameData('MightyRexCTCurrentFreeGame') + 1);
                                    ...
                                    if( $postData['slotEvent'] == 'freespin' ) 
                                    {
                                        $slotSettings->SetGameData('MightyRexCTBonusWin', $slotSettings->GetGameData('MightyRexCTBonusWin') + $totalWin);
                                        $slotSettings->SetGameData('MightyRexCTTotalWin', $slotSettings->GetGameData('MightyRexCTTotalWin') + $totalWin);
                                        $balanceInCents = $slotSettings->GetGameData('MightyRexCTFreeBalance');
                                    }
                                    else
                                    {
                                        $slotSettings->SetGameData('MightyRexCTTotalWin', $totalWin);
                                    }
                                    $fs = 0;
                                    if( $scattersCount >= 3 ) 
                                    {
                                        if( $slotSettings->GetGameData('MightyRexCTFreeGames') > 0 ) 
                                        {
                                            $slotSettings->SetGameData('MightyRexCTFreeGames', $slotSettings->GetGameData('MightyRexCTFreeGames') + $slotSettings->slotFreeCount);
                                            $responseData['play'][0]['result'][$spinLoop] = (array)$responseData['free_result'];
                                        }
                                        else
                                        {
                                            $slotSettings->SetGameData('MightyRexCTFreeStartWin', $totalWin);
                                            $slotSettings->SetGameData('MightyRexCTBonusWin', $totalWin);
                                            $slotSettings->SetGameData('MightyRexCTFreeGames', $slotSettings->slotFreeCount);
                                            $responseData['play'][0]['result'][$spinLoop] = (array)$responseData['free_result'];
                                        }
                                        $fs = $slotSettings->GetGameData('MightyRexCTFreeGames');
                                        $responseData['play'][0]['result'][$spinLoop]['scatters_win'] = $scattersStr;
                                    ...
                                    $winstring = '';
                                    $slotSettings->SetGameData('MightyRexCTGambleStep', 5);
                                    $hist = $slotSettings->GetGameData('MightyRexCTCards');
                                    if( $postData['slotEvent'] == 'freespin' ) 
                                    {
                                        $state = 'freespin';
                                        ...
                                        if( $slotSettings->GetGameData($slotSettings->slotId . 'FreeGames') <= $slotSettings->GetGameData($slotSettings->slotId . 'CurrentFreeGame') && $slotSettings->GetGameData('MightyRexCTBonusWin') > 0 ) 
                                        {
                                            $responseData['play'][0]['result'][$spinLoop]['is_free'] = true;
                                    ...
                                    $responseData['play'][0]['result'][$spinLoop]['total_win'] = $slotSettings->GetGameData('MightyRexCTTotalWin') / $denom;
                                ...
                                $response = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{"result":' . json_encode($responseData['play'][0]['result']) . ',"slotDenom":' . $denom . ',"slotLines":' . $lines . ',"slotBet":' . $betline . ',"totalFreeGames":' . $slotSettings->GetGameData('MightyRexCTFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('MightyRexCTCurrentFreeGame0') . ',"Balance":' . $slotSettings->GetGameData($slotSettings->slotId . 'FreeBalance') . ',"afterBalance":' . $slotSettings->GetBalance() . ',"bonusWin":' . $slotSettings->GetGameData('MightyRexCTBonusWin') . ',"totalWin":' . $totalWin . ',"winLines":[],"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
                            ...
                            case 'gamble':
                                ...
                                $dealerCard = '';
                                $totalWin = $slotSettings->GetGameData('MightyRexCTTotalWin');
                                $gambleWin = 0;
                                $statBet = $totalWin;
                                ...
                                $hist = $slotSettings->GetGameData('MightyRexCTCards');
                                $slotSettings->SetGameData('MightyRexCTGambleStep', $slotSettings->GetGameData('MightyRexCTGambleStep') - 1);
                                if( $slotSettings->MaxWin < ($totalWin * $slotSettings->CurrentDenom) ) 
                                {
                                    $isGambleWin = 0;
                                }
                                ...
                                else
                                {
                                    ...
                                    $totalWin = 0;
                                    $slotSettings->SetGameData('MightyRexCTGambleStep', 0);
                                    if( $postData['continue_params']['double_key'] != 'red' && $postData['continue_params']['double_key'] != 'black' ) 
                                    {
                                        if( $postData['continue_params']['double_key'] == 'diamond' ) 
                                        {
                                ...
                                $slotSettings->SetGameData('MightyRexCTCards', $hist);
