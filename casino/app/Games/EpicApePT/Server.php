                    ...
                    try
                    {
                        ...
                        if( isset($postData['spinType']) ) 
                        {
                            ...
                            if( $postData['spinType'] == 'regular' ) 
                            {
                                ...
                                $bonusMpl = 1;
                                $slotSettings->SetGameData('EpicApePTBonusWin', 0);
                                $slotSettings->SetGameData('EpicApePTFreeGames', 0);
                                $slotSettings->SetGameData('EpicApePTCurrentFreeGame', 0);
                                $slotSettings->SetGameData('EpicApePTTotalWin', 0);
                                $slotSettings->SetGameData('EpicApePTFreeBalance', 0);
                                $slotSettings->SetGameData('EpicApePTFreeStartWin', 0);
                            }
                            else if( $postData['spinType'] == 'free' ) 
                            {
                                $umid = '0';
                                $postData['slotEvent'] = 'freespin';
                                $slotSettings->SetGameData('EpicApePTCurrentFreeGame', $slotSettings->GetGameData('EpicApePTCurrentFreeGame') + 1);
                                $tmpMpl = [
                                    2, 
                                    3, 
                                    5
                            ...
                            if( $postData['slotEvent'] == 'freespin' ) 
                            {
                                $slotSettings->SetGameData('EpicApePTBonusWin', $slotSettings->GetGameData('EpicApePTBonusWin') + $totalWin);
                                $slotSettings->SetGameData('EpicApePTTotalWin', $totalWin);
                                $sID = 47752;
                                $rI = 5;
                            }
                            else
                            ...
                            if( $scattersCount >= 2 ) 
                            {
                                if( $slotSettings->GetGameData('EpicApePTFreeGames') > 0 ) 
                                {
                                    $slotSettings->SetGameData('EpicApePTFreeGames', $slotSettings->GetGameData('EpicApePTFreeGames') + $slotSettings->slotFreeCountAdd[$scattersCount]);
                                }
                                else if( $scattersCount >= 3 ) 
                                {
                                    $slotSettings->SetGameData('EpicApePTFreeStartWin', $totalWin);
                                    $slotSettings->SetGameData('EpicApePTBonusWin', 0);
                                    $slotSettings->SetGameData('EpicApePTFreeGames', $slotSettings->slotFreeCount[$scattersCount]);
                                }
                            }
                            $balanceInCents = sprintf('%01.2f', $slotSettings->GetBalance()) * 100;
                            ...
                            $response = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{"linesArr":[4096],"slotLines":' . $lines . ',"slotBet":' . $betLine . ',"totalFreeGames":' . $slotSettings->GetGameData('EpicApePTFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('EpicApePTCurrentFreeGame') . ',"Balance":' . $slotSettings->GetBalance() . ',"afterBalance":' . $slotSettings->GetBalance() . ',"bonusWin":' . $slotSettings->GetGameData('EpicApePTBonusWin') . ',"freeStartWin":' . $slotSettings->GetGameData('EpicApePTFreeStartWin') . ',"totalWin":' . $totalWin . ',"winLines":[' . $winString . '],"bonusInfo":' . $scattersStr . ',"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
