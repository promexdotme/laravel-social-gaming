...
namespace VanguardLTE\Games\BullFiesta
{
    ...
    use VanguardLTE\Games\BullFiesta\PragmaticLib\Collect;
    use VanguardLTE\Games\BullFiesta\PragmaticLib\GameSettings;
    use VanguardLTE\Games\BullFiesta\PragmaticLib\Loader;
    use VanguardLTE\Games\BullFiesta\PragmaticLib\Log;
    use VanguardLTE\Games\BullFiesta\PragmaticLib\Spin;
    use VanguardLTE\Games\BullFiesta\PragmaticLib\DoMysteryScatter;
    use VanguardLTE\Games\BullFiesta\PragmaticLib\DoBonus;
