                    ...
                    switch( $gameData['slotEvent'] ) 
                    {
                        ...
                        case 'A/u25':
                            ...
                            if( $lastEvent != 'NULL' ) 
                            {
                                ...
                                $slotSettings->SetGameData('AllWaysWinAMLines', $curLines);
                                $freeMpl = '11';
                                $slotSettings->SetGameData('AllWaysWinAMBonusWin', $lastEvent->serverResponse->bonusWin);
                                $slotSettings->SetGameData('AllWaysWinAMFreeGames', $lastEvent->serverResponse->totalFreeGames);
                                $slotSettings->SetGameData('AllWaysWinAMCurrentFreeGame', $lastEvent->serverResponse->currentFreeGames);
                                $slotSettings->SetGameData('AllWaysWinAMTotalWin', 0);
                                $slotSettings->SetGameData('AllWaysWinAMFreeBalance', 0);
                                $slotSettings->SetGameData('AllWaysWinAMFreeStartWin', 0);
                                $tFree = dechex($slotSettings->GetGameData('AllWaysWinAMFreeGames'));
                                $cFree = dechex($slotSettings->GetGameData('AllWaysWinAMFreeGames') - $slotSettings->GetGameData('AllWaysWinAMCurrentFreeGame'));
                                $freeInfo = strlen($tFree) . $tFree . strlen($cFree) . $cFree;
                                $stateWin = $slotSettings->HexFormat($slotSettings->GetGameData('AllWaysWinAMBonusWin') * $floatBet);
                                if( $slotSettings->GetGameData('AllWaysWinAMCurrentFreeGame') < $slotSettings->GetGameData('AllWaysWinAMFreeGames') && $slotSettings->GetGameData('AllWaysWinAMFreeGames') > 0 ) 
                                {
                                    $slotState = '6';
                            ...
                            {
                                $slotSettings->SetGameData('AllWaysWinAMLines', $fixedLinesFormated);
                                $slotState = '4';
                            ...
                            break;
                        case 'A/u250':
                            $fixedLinesFormated = $slotSettings->GetGameData('AllWaysWinAMLines');
                            $balanceFormated = $slotSettings->HexFormat(round($slotSettings->GetBalance() * $floatBet));
                            $lastEvent = $slotSettings->GetHistory();
                            if( $lastEvent != 'NULL' ) 
                            {
                        ...
                        case 'A/u251':
                            if( $postData['spinType'] == 'regular' && $slotSettings->GetGameData($slotSettings->slotId . 'FreeGames') <= $slotSettings->GetGameData($slotSettings->slotId . 'CurrentFreeGame') ) 
                            {
                                ...
                                $bonusMpl = 1;
                                $slotSettings->SetGameData('AllWaysWinAMBonusWin', 0);
                                $slotSettings->SetGameData('AllWaysWinAMFreeGames', 0);
                                $slotSettings->SetGameData('AllWaysWinAMCurrentFreeGame', 0);
                                $slotSettings->SetGameData('AllWaysWinAMTotalWin', 0);
                                $slotSettings->SetGameData('AllWaysWinAMFreeBalance', 0);
                                $slotSettings->SetGameData('AllWaysWinAMFreeStartWin', 0);
                            }
                            if( $slotSettings->GetGameData($slotSettings->slotId . 'CurrentFreeGame') < $slotSettings->GetGameData($slotSettings->slotId . 'FreeGames') ) 
                            {
                                ...
                                $slotSettings->SetGameData('AllWaysWinAMCurrentFreeGame', $slotSettings->GetGameData('AllWaysWinAMCurrentFreeGame') + 1);
                            ...
                            if( $postData['slotEvent'] == 'freespin' && $slotSettings->GetGameData('AllWaysWinAMFreeGames') <= $slotSettings->GetGameData('AllWaysWinAMCurrentFreeGame') && $winType != 'bonus' && $slotSettings->GetGameData('AllWaysWinAMBonusWin') + $totalWin > 0 ) 
                            {
                                $slotSettings->SetBalance($slotSettings->GetGameData('AllWaysWinAMBonusWin') + $totalWin);
                            }
                            ...
                            if( $postData['slotEvent'] == 'freespin' ) 
                            {
                                $slotSettings->SetGameData('AllWaysWinAMBonusWin', $slotSettings->GetGameData('AllWaysWinAMBonusWin') + $totalWin);
                                $slotSettings->SetGameData('AllWaysWinAMTotalWin', $totalWin);
                            }
                            else
                            {
                                $slotSettings->SetGameData('AllWaysWinAMTotalWin', $totalWin);
                            ...
                            if( $scattersCount >= 3 ) 
                            {
                                ...
                                if( $slotSettings->GetGameData('AllWaysWinAMFreeGames') > 0 ) 
                                {
                                    $slotSettings->SetGameData('AllWaysWinAMFreeGames', $slotSettings->GetGameData('AllWaysWinAMFreeGames') + $slotSettings->slotFreeCount[$scattersCount]);
                                }
                                else
                                {
                                    $slotSettings->SetGameData('AllWaysWinAMFreeStartWin', $totalWin);
                                    $slotSettings->SetGameData('AllWaysWinAMBonusWin', $totalWin);
                                    $slotSettings->SetGameData('AllWaysWinAMFreeGames', $slotSettings->slotFreeCount[$scattersCount]);
                                }
                            }
                            $jsSpin = '' . json_encode($reels) . '';
                            $jsJack = '' . json_encode($slotSettings->Jackpots) . '';
                            $winString = implode(',', $lineWins);
                            $response_log = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{"symDouble":' . $symDouble . ',"slotLines":' . $lines . ',"slotBet":' . $betCnt . ',"totalFreeGames":' . $slotSettings->GetGameData('AllWaysWinAMFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('AllWaysWinAMCurrentFreeGame') . ',"Balance":' . $slotSettings->GetBalance() . ',"afterBalance":' . $slotSettings->GetBalance() . ',"bonusWin":' . $slotSettings->GetGameData('AllWaysWinAMBonusWin') . ',"freeStartWin":' . $slotSettings->GetGameData('AllWaysWinAMFreeStartWin') . ',"totalWin":' . $totalWin . ',"winLines":[' . $winString . '],"bonusInfo":' . $scattersStr . ',"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
                            ...
                            if( $postData['slotEvent'] == 'freespin' ) 
                            {
                                ...
                                $cFree = dechex($slotSettings->GetGameData('AllWaysWinAMFreeGames') - $slotSettings->GetGameData('AllWaysWinAMCurrentFreeGame'));
                                $gameState = '06';
                                if( $slotSettings->GetGameData('AllWaysWinAMFreeGames') <= $slotSettings->GetGameData('AllWaysWinAMCurrentFreeGame') ) 
                                {
                                    $gameState = '0c';
                                }
                                if( $scattersCount >= 3 ) 
                                ...
                                $totalWin = $slotSettings->GetGameData('AllWaysWinAMBonusWin');
                                $bonusMpl = $slotSettings->slotFreeMpl;
                            }
                            else
                            {
                            ...
                            $slotSettings->SetGameData('AllWaysWinAMDoubleAnswer', $reelSate . $bet_h . $ln_h . $freeInfo . $freeWinState . $slotSettings->HexFormat($bonusMpl) . '1010' . $reelSate . '0' . $symCountAll . $winLinesFormated);
                            $slotSettings->SetGameData('AllWaysWinAMDoubleBalance', $balanceFormated);
                            $slotSettings->SetGameData('AllWaysWinAMDoubleWin', $totalWin);
                            if( $postData['slotEvent'] == 'freespin' ) 
                            {
                            ...
                            $slotSettings->SetGameData('AllWaysWinAMCollectP0', $response_collect0);
                            $gameState = '04';
                            $balanceFormated = $slotSettings->HexFormat(round($slotSettings->GetBalance() * $floatBet));
                            ...
                            $slotSettings->SetGameData('AllWaysWinAMCollect', $response_collect);
                            break;
                        case 'A/u254':
                            $slotSettings->SetGameData($slotSettings->slotId . 'TotalWin', 0);
                            $response = $slotSettings->GetGameData('AllWaysWinAMCollect');
                            break;
                        case 'A/u257':
                            $doubleWin = rand(1, 2);
                            $winall = $slotSettings->GetGameData('AllWaysWinAMDoubleWin');
                            $dbet = $winall;
                            $daction = $tmpPar[1];
                            ...
                            $response = '107010' . $slotSettings->GetGameData('AllWaysWinAMDoubleBalance') . strlen($winall_h) . $winall_h . $slotSettings->GetGameData('AllWaysWinAMDoubleAnswer') . implode('', $slotSettings->GetGameData($slotSettings->slotId . 'Cards'));
                            $slotSettings->SetGameData('AllWaysWinAMDoubleWin', $winall);
                            $slotSettings->SetGameData('AllWaysWinAMTotalWin', $winall);
                            $balanceFormated = $slotSettings->HexFormat(round($slotSettings->GetBalance() * $floatBet));
                            $response_collect = '104010' . $balanceFormated . strlen($winall_h) . $winall_h . $slotSettings->GetGameData('AllWaysWinAMCollectP0');
                            $slotSettings->SetGameData('AllWaysWinAMCollect', $response_collect);
                        ...
                        case 'A/u258':
                            ...
                            $slotSettings->SetGameData('AllWaysWinAMDoubleBalance', $rtnBalance);
                            $winall = sprintf('%01.2f', $winall) * $floatBet;
                            $winall_h1 = str_replace('.', '', $winall . '');
                            $winall_h = dechex($winall_h1);
                            $doubleCards = '26280b2714161d0c';
                            $response = '108010' . $slotSettings->GetGameData('AllWaysWinAMDoubleBalance') . strlen($winall_h) . $winall_h . $slotSettings->GetGameData('AllWaysWinAMDoubleAnswer') . implode('', $slotSettings->GetGameData($slotSettings->slotId . 'Cards'));
                            break;
                    }
