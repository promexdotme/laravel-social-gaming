            ...
            function get_($request, $game)
            {
                \DB::transaction(function() use ($request, $game)
                {
                    try
                    {
                        ...
                        {
                            case 'create_session':
                                $slotSettings->SetGameData('BeetleStarCTCards', [
                                    19, 
                                    44, 
                                    0, 
                                    37, 
                            ...
                            case 'init_game':
                                ...
                                $slotSettings->SetGameData('BeetleStarCTBonusWin', 0);
                                $slotSettings->SetGameData('BeetleStarCTFreeGames', 0);
                                $slotSettings->SetGameData('BeetleStarCTCurrentFreeGame', 0);
                                $slotSettings->SetGameData('BeetleStarCTCurrentFreeGame0', 0);
                                $slotSettings->SetGameData('BeetleStarCTTotalWin', 0);
                                $slotSettings->SetGameData('BeetleStarCTFreeBalance', 0);
                                ...
                                if( $lastEvent != 'NULL' ) 
                                {
                                    ...
                                    if( $slotSettings->GetGameData('BeetleStarCTCurrentFreeGame') < $slotSettings->GetGameData('BeetleStarCTFreeGames') && $slotSettings->GetGameData('BeetleStarCTFreeGames') > 0 ) 
                                    {
                            ...
                            case 'poll':
                                ...
                                {
                                    $balanceInCents = sprintf('%01.2f', $slotSettings->GetBalance() - $slotSettings->GetGameData('BeetleStarCTTotalWin')) * 100;
                                }
                            ...
                            case 'game_finished':
                                $slotSettings->SetGameData('BeetleStarCTBonusWin', 0);
                                $slotSettings->SetGameData('BeetleStarCTTotalWin', 0);
                                $responseData['game_finished'][0]['freeround_play'] = $slotSettings->GetGameData('BeetleStarCTCurrentFreeGame0');
                            ...
                            case 'subgame_finished':
                                if( $slotSettings->GetGameData('BeetleStarCTCurrentFreeGame0') < $slotSettings->GetGameData('BeetleStarCTFreeGames') && $slotSettings->GetGameData('BeetleStarCTFreeGames') > 0 ) 
                                {
                                    ...
                                    $response = '{"responseEvent":"spin","responseType":"freespin","serverResponse":{"result":' . json_encode($result) . ',"slotDenom":' . $slotSettings->GetGameData($slotSettings->slotId . 'Denom') . ',"slotLines":' . $lines . ',"slotBet":' . $betline . ',"totalFreeGames":' . $slotSettings->GetGameData('BeetleStarCTFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('BeetleStarCTCurrentFreeGame0') . ',"Balance":' . $slotSettings->GetGameData('BeetleStarCTFreeBalance') . ',"afterBalance":' . $slotSettings->GetGameData('BeetleStarCTFreeBalance') . ',"bonusWin":' . $slotSettings->GetGameData('BeetleStarCTBonusWin') . ',"totalWin":' . $reportWin . ',"winLines":[],"Jackpots":[],"reelsSymbols":' . json_encode($slotSettings->GetGameData($slotSettings->slotId . 'Reels')) . '}}';
                                    if( $slotSettings->GetGameData('BeetleStarCTFreeGames') <= $slotSettings->GetGameData('BeetleStarCTCurrentFreeGame0') ) 
                                    {
                                        if( $reportWin > 0 ) 
                                        {
                                    ...
                                    $balanceInCents = $slotSettings->GetGameData('BeetleStarCTFreeBalance');
                                    $responseData['subgame_finished'][0]['account_status']['credit'] = round($balanceInCents);
                                    $responseData['subgame_finished'][0]['freeround_play'] = $slotSettings->GetGameData('BeetleStarCTCurrentFreeGame0');
                                    $responseData['subgame_finished'][1]['freeround_play'] = $slotSettings->GetGameData('BeetleStarCTCurrentFreeGame0');
                                ...
                                break;
                            case 'play':
                                if( !isset($postData['lines']) || !isset($postData['game_denom']) || !isset($postData['line_bet']) ) 
                                {
                                    $response = '{"responseEvent":"error","responseType":"' . $postData['command'] . '","serverResponse":"invalid bet request"}';
                                    exit( $response );
                                }
                                ...
                                for( $spinLoop = 0; $spinLoop < $spinLoopLimit; $spinLoop++ ) 
                                {
                                    ...
                                    if( $postData['slotEvent'] != 'freespin' ) 
                                    {
                                        ...
                                        $slotSettings->SetGameData('BeetleStarCTCurrentFreeGame0', 0);
                                        $slotSettings->SetGameData('BeetleStarCTTotalWin', 0);
                                        $slotSettings->SetGameData('BeetleStarCTFreeBalance', sprintf('%01.2f', $slotSettings->GetBalance()) * 100);
                                    ...
                                    {
                                        $slotSettings->SetGameData('BeetleStarCTCurrentFreeGame', $slotSettings->GetGameData('BeetleStarCTCurrentFreeGame') + 1);
                                    ...
                                    if( $postData['slotEvent'] == 'freespin' ) 
                                    {
                                        $slotSettings->SetGameData('BeetleStarCTBonusWin', $slotSettings->GetGameData('BeetleStarCTBonusWin') + $totalWin);
                                        $slotSettings->SetGameData('BeetleStarCTTotalWin', $slotSettings->GetGameData('BeetleStarCTTotalWin') + $totalWin);
                                        $balanceInCents = $slotSettings->GetGameData('BeetleStarCTFreeBalance');
                                    }
                                    else
                                    {
                                        $slotSettings->SetGameData('BeetleStarCTTotalWin', $totalWin);
                                    }
                                    $fs = 0;
                                    if( $scattersCount >= 2 ) 
                                    {
                                    ...
                                    $winstring = '';
                                    $slotSettings->SetGameData('BeetleStarCTGambleStep', 5);
                                    $hist = $slotSettings->GetGameData('BeetleStarCTCards');
                                    if( $postData['slotEvent'] == 'freespin' ) 
                                    {
                                        $state = 'freespin';
                                        ...
                                        if( $slotSettings->GetGameData($slotSettings->slotId . 'FreeGames') <= $slotSettings->GetGameData($slotSettings->slotId . 'CurrentFreeGame') && $slotSettings->GetGameData('BeetleStarCTBonusWin') > 0 ) 
                                        {
                                            $responseData['play'][0]['result'][$spinLoop]['is_free'] = true;
                                    ...
                                    $responseData['play'][0]['result'][$spinLoop]['total_win'] = $slotSettings->GetGameData('BeetleStarCTTotalWin') / $denom;
                                ...
                                $response = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{"result":' . json_encode($responseData['play'][0]['result']) . ',"slotDenom":' . $denom . ',"slotLines":' . $lines . ',"slotBet":' . $betline . ',"totalFreeGames":' . $slotSettings->GetGameData('BeetleStarCTFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('BeetleStarCTCurrentFreeGame0') . ',"Balance":' . $slotSettings->GetGameData($slotSettings->slotId . 'FreeBalance') . ',"afterBalance":' . $slotSettings->GetBalance() . ',"bonusWin":' . $slotSettings->GetGameData('BeetleStarCTBonusWin') . ',"totalWin":' . $totalWin . ',"winLines":[],"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
                            ...
                            case 'gamble':
                                ...
                                $dealerCard = '';
                                $totalWin = $slotSettings->GetGameData('BeetleStarCTTotalWin');
                                $gambleWin = 0;
                                $statBet = $totalWin;
                                ...
                                $hist = $slotSettings->GetGameData('BeetleStarCTCards');
                                $slotSettings->SetGameData('BeetleStarCTGambleStep', $slotSettings->GetGameData('BeetleStarCTGambleStep') - 1);
                                if( $slotSettings->MaxWin < ($totalWin * $slotSettings->CurrentDenom) ) 
                                {
                                    $isGambleWin = 0;
                                }
                                ...
                                else
                                {
                                    ...
                                    $totalWin = 0;
                                    $slotSettings->SetGameData('BeetleStarCTGambleStep', 0);
                                    if( $postData['continue_params']['double_key'] != 'red' && $postData['continue_params']['double_key'] != 'black' ) 
                                    {
                                        if( $postData['continue_params']['double_key'] == 'diamond' ) 
                                        {
                                ...
                                $slotSettings->SetGameData('BeetleStarCTCards', $hist);
