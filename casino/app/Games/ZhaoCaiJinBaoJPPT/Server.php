            ...
            function get_($request, $game)
            {
                \DB::transaction(function() use ($request, $game)
                {
                    try
                    {
                        ...
                        if( isset($postData['ID']) && $postData['ID'] == 41020 && $slotSettings->GetGameData('ZhaoCaiJinBaoJPPTBonusStart') ) 
                        {
                            $result_tmp = [];
                            if( $postData['type'] == 'spin' ) 
                            {
                                ...
                                if( $slotSettings->GetGameData('ZhaoCaiJinBaoJPPT_JP' . $curJID . 'Cnt') == 2 ) 
                                {
                                    $curJID = $gJackID + 1;
                                    if( $curJID == 1 ) 
                                    {
                                ...
                                $slotSettings->SetGameData('ZhaoCaiJinBaoJPPT_JP' . $curJID . 'Cnt', $slotSettings->GetGameData('ZhaoCaiJinBaoJPPT_JP' . $curJID . 'Cnt') + 1);
                                $jWin = 0;
                                if( $slotSettings->GetGameData('ZhaoCaiJinBaoJPPT_JP' . $curJID . 'Cnt') >= 3 ) 
                                {
                                ...
                                $rp->serverResponse->BonusStart = $slotSettings->GetGameData('ZhaoCaiJinBaoJPPTBonusStart');
                                $rp_s = json_encode($rp);
                                $slotSettings->SetGameData('ZhaoCaiJinBaoJPPTJackReport', $rp_s);
                                if( $slotSettings->GetGameData('ZhaoCaiJinBaoJPPT_JP' . $curJID . 'Cnt') >= 3 ) 
                                {
                        ...
                        if( isset($postData['index']) ) 
                        {
                            ...
                            if( $slotSettings->GetGameData('ZhaoCaiJinBaoJPPTBonusStep') == 0 ) 
                            {
                                ...
                                shuffle($WinArr);
                                $slotSettings->SetGameData('ZhaoCaiJinBaoJPPTBonusOpt', $WinArr);
                                $curWin = $WinArr[$postData['index']];
                                if( $curWin > 0 ) 
                                {
                                    $slotSettings->SetGameData('ZhaoCaiJinBaoJPPTFreeGames', $slotSettings->GetGameData('ZhaoCaiJinBaoJPPTFreeGames') + $curWin);
                                }
                                else
                                {
                                    $slotSettings->SetGameData('ZhaoCaiJinBaoJPPTFreeMpl', $slotSettings->GetGameData('ZhaoCaiJinBaoJPPTFreeMpl') + ($curWin * -1));
                                }
                            ...
                            {
                                $WinArr = $slotSettings->GetGameData('ZhaoCaiJinBaoJPPTBonusOpt');
                                $curWin = $WinArr[$postData['index']];
                                if( $curWin > 10 ) 
                                {
                                    $slotSettings->SetGameData('ZhaoCaiJinBaoJPPTFreeGames', $slotSettings->GetGameData('ZhaoCaiJinBaoJPPTFreeGames') + $curWin);
                        ...
                        if( isset($postData['spinType']) ) 
                        {
                            ...
                            else if( $postData['spinType'] == 'free' ) 
                            {
                                ...
                                $bonusMpl = $slotSettings->GetGameData('ZhaoCaiJinBaoJPPTFreeMpl');
                            }
                            $linesId = [];
                            $linesId[0] = [
                                2, 
                                    ...
                                    for( $j = 0; $j < count($slotSettings->SymbolGame); $j++ ) 
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            if( $s[4] == $csym || in_array($s[4], $wild) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":1,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('ZhaoCaiJinBaoJPPTBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":["none","none"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            ...
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":2,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('ZhaoCaiJinBaoJPPTBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            ...
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":3,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('ZhaoCaiJinBaoJPPTBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            ...
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) && ($s[3] == $csym || in_array($s[3], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":4,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('ZhaoCaiJinBaoJPPTBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            ...
                                            if( ($s[4] == $csym || in_array($s[4], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) && ($s[3] == $csym || in_array($s[3], $wild)) && ($s[4] == $csym || in_array($s[4], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":5,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('ZhaoCaiJinBaoJPPTBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":[' . ($linesId[$k][4] - 1) . ',"' . $s[4] . '"]}';
                                                }
                                            }
                                        }
                                    }
                            ...
                            $response = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{"BonusStart":' . json_encode($slotSettings->GetGameData('ZhaoCaiJinBaoJPPTBonusStart')) . ',"JackWinID":' . $slotSettings->GetGameData($slotSettings->slotId . 'JackWinID') . ',"jackpotReel":0,"jackpotSelected":[' . implode(',', $jackpotSelected) . '],"linesArr":[' . implode(',', $postData['lines']) . '],"slotLines":' . $lines . ',"slotBet":' . $betLine . ',"totalFreeGames":' . $slotSettings->GetGameData('ZhaoCaiJinBaoJPPTFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('ZhaoCaiJinBaoJPPTCurrentFreeGame') . ',"Balance":' . $slotSettings->GetBalance() . ',"afterBalance":' . $slotSettings->GetBalance() . ',"bonusWin":' . $slotSettings->GetGameData('ZhaoCaiJinBaoJPPTBonusWin') . ',"FreeMpl":' . $slotSettings->GetGameData('ZhaoCaiJinBaoJPPTFreeMpl') . ',"freeStartWin":' . $slotSettings->GetGameData('ZhaoCaiJinBaoJPPTFreeStartWin') . ',"totalWin":' . $totalWin . ',"winLines":[' . $winString . '],"bonusInfo":' . $scattersStr . ',"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
                            ...
                            case '40030':
                                ...
                                if( $slotSettings->GetGameData($slotSettings->slotId . 'brokenGames') != '' ) 
                                {
                                    ...
                                    if( $lastEvent != 'NULL' ) 
                                    {
                                        ...
                                        $slotSettings->SetGameData('ZhaoCaiJinBaoJPPT_JP4Cnt', $lastEvent->serverResponse->jackpotSelected[3]);
                                        $slotSettings->SetGameData('ZhaoCaiJinBaoJPPT_JPReel', $lastEvent->serverResponse->jackpotReel);
                                        $slotSettings->SetGameData('ZhaoCaiJinBaoJPPTBonusStart', $lastEvent->serverResponse->BonusStart);
                                        $slotSettings->SetGameData($slotSettings->slotId . 'BonusWin', $lastEvent->serverResponse->bonusWin);
                                        $slotSettings->SetGameData($slotSettings->slotId . 'FreeStartWin', $lastEvent->serverResponse->freeStartWin);
                                        $slotSettings->SetGameData($slotSettings->slotId . 'FreeGames', $lastEvent->serverResponse->totalFreeGames);
                                        $slotSettings->SetGameData($slotSettings->slotId . 'CurrentFreeGame', $lastEvent->serverResponse->currentFreeGames);
