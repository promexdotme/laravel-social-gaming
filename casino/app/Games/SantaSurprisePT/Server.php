                    ...
                    try
                    {
                        ...
                        if( isset($postData['spinType']) ) 
                        {
                            ...
                            if( $postData['spinType'] == 'regular' ) 
                            {
                                ...
                                $bonusMpl = 1;
                                $slotSettings->SetGameData('SantaSurprisePTBonusWin', 0);
                                $slotSettings->SetGameData('SantaSurprisePTFreeGames', 0);
                                $slotSettings->SetGameData('SantaSurprisePTCurrentFreeGame', 0);
                                $slotSettings->SetGameData('SantaSurprisePTTotalWin', 0);
                                $slotSettings->SetGameData('SantaSurprisePTFreeBalance', 0);
                                $slotSettings->SetGameData('SantaSurprisePTFreeStartWin', 0);
                                $chosenTree = 0;
                                $startStick = 0;
                                $treeStep = [
                                    -1, 
                                ...
                                $slotSettings->SetGameData('SantaSurprisePTChosenTree', $chosenTree);
                                $slotSettings->SetGameData('SantaSurprisePTstartStick', $startStick);
                                $slotSettings->SetGameData('SantaSurprisePTtreeStep', $treeStep);
                                $slotSettings->SetGameData('SantaSurprisePTlastWins', $lastWins);
                            }
                            else if( $postData['spinType'] == 'free' ) 
                            {
                                $umid = '0';
                                $postData['slotEvent'] = 'freespin';
                                $slotSettings->SetGameData('SantaSurprisePTCurrentFreeGame', $slotSettings->GetGameData('SantaSurprisePTCurrentFreeGame') + 1);
                            ...
                            $slotSettings->SetGameData('SantaSurprisePTAllBet', $postData['bet']);
                            $slotSettings->SetGameData('SantaSurprisePTBetLine', $betLine);
                                    ...
                                    for( $j = 0; $j < count($slotSettings->SymbolGame); $j++ ) 
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            if( $s[0] == $csym || in_array($s[0], $wild) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":1,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('SantaSurprisePTBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":["none","none"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":2,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('SantaSurprisePTBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":3,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('SantaSurprisePTBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) && ($s[3] == $csym || in_array($s[3], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":4,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('SantaSurprisePTBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) && ($s[3] == $csym || in_array($s[3], $wild)) && ($s[4] == $csym || in_array($s[4], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":5,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('SantaSurprisePTBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":[' . ($linesId[$k][4] - 1) . ',"' . $s[4] . '"]}';
                                                }
                                            }
                                            if( $csym == '9' ) 
                                            {
                            ...
                            if( $postData['slotEvent'] == 'freespin' ) 
                            {
                                $slotSettings->SetGameData('SantaSurprisePTBonusWin', $slotSettings->GetGameData('SantaSurprisePTBonusWin') + $totalWin);
                                $slotSettings->SetGameData('SantaSurprisePTTotalWin', $totalWin);
                            }
                            else
                            {
                                $slotSettings->SetGameData('SantaSurprisePTTotalWin', $totalWin);
                            ...
                            if( $scattersCount >= 3 ) 
                            {
                                if( $slotSettings->GetGameData('SantaSurprisePTFreeGames') > 0 ) 
                                {
                                    $slotSettings->SetGameData('SantaSurprisePTFreeGames', $slotSettings->GetGameData('SantaSurprisePTFreeGames') + $slotSettings->slotFreeCount);
                                }
                                else
                                {
                                    $slotSettings->SetGameData('SantaSurprisePTFreeStartWin', $totalWin);
                                    $slotSettings->SetGameData('SantaSurprisePTBonusWin', 0);
                                    $slotSettings->SetGameData('SantaSurprisePTFreeGames', $slotSettings->slotFreeCount);
                                }
                            }
                            ...
                            if( $prizeBonusStart ) 
                            {
                                ...
                                $slotSettings->SetGameData('SantaSurprisePTWinValues', $prizeResult['curValues']);
                                $slotSettings->SetGameData('SantaSurprisePTPickedCount', 0);
                                $slotSettings->SetGameData('SantaSurprisePTPickedCountArr', []);
                                $slotSettings->SetGameData('SantaSurprisePTprizeBonusNum', $prizeBonusNum);
                            }
                            $response = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{' . $bStr . '"allbet":' . $slotSettings->GetGameData('SantaSurprisePTAllBet') . ',"betLine":' . $slotSettings->GetGameData('SantaSurprisePTBetLine') . ',"linesArr":[' . implode(',', $postData['lines']) . '],"slotLines":' . $lines . ',"slotBet":' . $betLine . ',"totalFreeGames":' . $slotSettings->GetGameData('SantaSurprisePTFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('SantaSurprisePTCurrentFreeGame') . ',"Balance":' . $slotSettings->GetBalance() . ',"afterBalance":' . $slotSettings->GetBalance() . ',"bonusWin":' . $slotSettings->GetGameData('SantaSurprisePTBonusWin') . ',"freeStartWin":' . $slotSettings->GetGameData('SantaSurprisePTFreeStartWin') . ',"totalWin":' . $totalWin . ',"winLines":[' . $winString . '],"bonusInfo":' . $scattersStr . ',"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
                            $slotSettings->SetGameData('SantaSurprisePTLastResponse', $response);
                            $slotSettings->SaveLogReport($response, $betLine, $lines, $reportWin, $postData['slotEvent']);
                        }
                        switch( $umid ) 
                        {
                            case '40145':
                                if( $postData['pickIndex'] >= 0 && $slotSettings->GetGameData('SantaSurprisePTPickedCount') < $slotSettings->GetGameData('SantaSurprisePTprizeBonusNum') ) 
                                {
                                    $lr = json_decode($slotSettings->GetGameData('SantaSurprisePTLastResponse'));
                                    $values = $slotSettings->GetGameData('SantaSurprisePTWinValues');
                                    $pick = $slotSettings->GetGameData('SantaSurprisePTPickedCount');
                                    $pickArr = $slotSettings->GetGameData('SantaSurprisePTPickedCountArr');
                                    $reportWin = $values[$pick] * $slotSettings->GetGameData('SantaSurprisePTBetLine');
                                    $slotSettings->SetBalance($reportWin);
                                    $pick++;
                                    $pickArr[] = $postData['pickIndex'];
                                    $slotSettings->SetGameData('SantaSurprisePTPickedCount', $pick);
                                    $slotSettings->SetGameData('SantaSurprisePTPickedCountArr', $pickArr);
                                    ...
                                    $slotSettings->SetGameData('SantaSurprisePTLastResponse', json_encode($lr));
                                }
                            ...
                            case '40036':
                                ...
                                if( $lastEvent != 'NULL' ) 
                                {
                                    ...
                                    $slotSettings->SetGameData('SantaSurprisePTLastResponse', json_encode($lastEvent));
                                    $slotSettings->SetGameData('SantaSurprisePTWinValues', $lastEvent->serverResponse->winValues);
                                    $slotSettings->SetGameData('SantaSurprisePTPickedCount', $lastEvent->serverResponse->PickedCount);
                                    $slotSettings->SetGameData('SantaSurprisePTPickedCountArr', $lastEvent->serverResponse->PickedCountArr);
                                    $slotSettings->SetGameData('SantaSurprisePTPrizeNum', $lastEvent->serverResponse->prizeBonusNum);
                                    $slotSettings->SetGameData('SantaSurprisePTEprizeBonusNum', $lastEvent->serverResponse->prizeBonusNum);
                                    if( $slotSettings->GetGameData($slotSettings->slotId . 'CurrentFreeGame') < $slotSettings->GetGameData($slotSettings->slotId . 'FreeGames') && $slotSettings->GetGameData($slotSettings->slotId . 'FreeGames') > 0 ) 
                                    {
                                        $slotSettings->SetGameData($slotSettings->slotId . 'brokenGames', 'ssp');
                                    }
                                    if( $lastEvent->responseType == 'prize_bonus' && $slotSettings->GetGameData('SantaSurprisePTPickedCount') < $slotSettings->GetGameData('SantaSurprisePTEprizeBonusNum') ) 
                                    {
                                        $slotSettings->SetGameData($slotSettings->slotId . 'brokenGames', 'ssp');
                                    }
                                    $slotSettings->SetGameData('SantaSurprisePTresponseType', $lastEvent->responseType);
                                }
