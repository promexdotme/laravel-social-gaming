                ...
                try
                    ...
                    switch( $gameData['slotEvent'] ) 
                    {
                        ...
                        case 'A/u25':
                            ...
                            $slotSettings->SetGameData('DiamondCatsAMholdsLine0', [
                                '0', 
                                '0', 
                                '0', 
                                '0', 
                            ...
                            $slotSettings->SetGameData('DiamondCatsAMholdsLine1', [
                                '0', 
                                '0', 
                                '0', 
                                '0', 
                            ...
                            $slotSettings->SetGameData('DiamondCatsAMholdsLine2', [
                                '0', 
                                '0', 
                                '0', 
                                '0', 
                            ...
                            if( $lastEvent != 'NULL' ) 
                            {
                                ...
                                $slotSettings->SetGameData('DiamondCatsAMLines', $curLines);
                                $freeMpl = '11';
                                $slotSettings->SetGameData('DiamondCatsAMBonusWin', $lastEvent->serverResponse->bonusWin);
                                $slotSettings->SetGameData('DiamondCatsAMFreeGames', $lastEvent->serverResponse->totalFreeGames);
                                $slotSettings->SetGameData('DiamondCatsAMCurrentFreeGame', $lastEvent->serverResponse->currentFreeGames);
                                $slotSettings->SetGameData('DiamondCatsAMTotalWin', 0);
                                $slotSettings->SetGameData('DiamondCatsAMFreeBalance', 0);
                                $slotSettings->SetGameData('DiamondCatsAMFreeStartWin', 0);
                                $slotSettings->SetGameData($slotSettings->slotId . 'holdsLine0', $lastEvent->serverResponse->holdsLine0);
                                $slotSettings->SetGameData($slotSettings->slotId . 'holdsLine1', $lastEvent->serverResponse->holdsLine1);
                                $slotSettings->SetGameData($slotSettings->slotId . 'holdsLine2', $lastEvent->serverResponse->holdsLine2);
                                $slotSettings->SetGameData($slotSettings->slotId . 'CurrentSeq', $lastEvent->serverResponse->curSeq);
                                $tFree = dechex($slotSettings->GetGameData('DiamondCatsAMFreeGames'));
                                $cFree = dechex($slotSettings->GetGameData('DiamondCatsAMFreeGames') - $slotSettings->GetGameData('DiamondCatsAMCurrentFreeGame'));
                                $freeInfo = strlen($tFree) . $tFree . strlen($cFree) . $cFree;
                                $stateWin = $slotSettings->HexFormat($slotSettings->GetGameData('DiamondCatsAMBonusWin') * $floatBet);
                                if( $slotSettings->GetGameData('DiamondCatsAMCurrentFreeGame') < $slotSettings->GetGameData('DiamondCatsAMFreeGames') && $slotSettings->GetGameData('DiamondCatsAMFreeGames') > 0 ) 
                                {
                                    $slotState = '6';
                            ...
                            {
                                $slotSettings->SetGameData('DiamondCatsAMLines', $fixedLinesFormated);
                                $slotState = '4';
                            ...
                            $holdsLine0 = $slotSettings->GetGameData('DiamondCatsAMholdsLine0');
                            $holdsLine1 = $slotSettings->GetGameData('DiamondCatsAMholdsLine1');
                            $holdsLine2 = $slotSettings->GetGameData('DiamondCatsAMholdsLine2');
                            $response = '05' . $slotSettings->FormatReelStrips('') . '5' . $slotSettings->FormatReelStrips('Bonus') . '0' . $slotState . '0' . $reelSate . '10' . $balanceFormated . $stateWin . $curBet . $minBets . $maxBets . $fixedLinesFormated . $freeInfo . '1010101011' . $fixedLinesFormated . $fixedLinesFormated . '0a1000' . $reelSate . '0000000000000000' . $betsLength . $betString . '1510101010101010101010101010101010101010101015' . implode('', $holdsLine0) . '15' . implode('', $holdsLine1) . '15' . implode('', $holdsLine2) . '';
                            break;
                        case 'A/u250':
                            $fixedLinesFormated = $slotSettings->GetGameData('DiamondCatsAMLines');
                            $balanceFormated = $slotSettings->HexFormat(round($slotSettings->GetBalance() * $floatBet));
                            $lastEvent = $slotSettings->GetHistory();
                            if( $lastEvent != 'NULL' ) 
                            {
                        ...
                        case 'A/u251':
                            if( $postData['spinType'] == 'regular' && $slotSettings->GetGameData($slotSettings->slotId . 'FreeGames') <= $slotSettings->GetGameData($slotSettings->slotId . 'CurrentFreeGame') ) 
                            {
                                ...
                                $bonusMpl = 1;
                                $slotSettings->SetGameData('DiamondCatsAMBonusWin', 0);
                                $slotSettings->SetGameData('DiamondCatsAMFreeGames', 0);
                                $slotSettings->SetGameData('DiamondCatsAMCurrentFreeGame', 0);
                                $slotSettings->SetGameData('DiamondCatsAMTotalWin', 0);
                                $slotSettings->SetGameData('DiamondCatsAMFreeBalance', 0);
                                $slotSettings->SetGameData('DiamondCatsAMFreeStartWin', 0);
                                $slotSettings->SetGameData('DiamondCatsAMholdsLine0', [
                            ...
                            if( $slotSettings->GetGameData($slotSettings->slotId . 'CurrentFreeGame') < $slotSettings->GetGameData($slotSettings->slotId . 'FreeGames') ) 
                            {
                                ...
                                $slotSettings->SetGameData('DiamondCatsAMCurrentFreeGame', $slotSettings->GetGameData('DiamondCatsAMCurrentFreeGame') + 1);
                                    ...
                                    for( $j = 0; $j < count($slotSettings->SymbolGame); $j++ ) 
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            if( $s[0] == $csym || in_array($s[0], $wild) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":1,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('DiamondCatsAMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":["none","none"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":2,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('DiamondCatsAMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":3,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('DiamondCatsAMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) && ($s[3] == $csym || in_array($s[3], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":4,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('DiamondCatsAMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) && ($s[3] == $csym || in_array($s[3], $wild)) && ($s[4] == $csym || in_array($s[4], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":5,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('DiamondCatsAMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":[' . ($linesId[$k][4] - 1) . ',"' . $s[4] . '"]}';
                                                }
                                            }
                                        }
                                    }
                            ...
                            if( $postData['slotEvent'] == 'freespin' && $slotSettings->GetGameData('DiamondCatsAMFreeGames') <= $slotSettings->GetGameData('DiamondCatsAMCurrentFreeGame') && $winType != 'bonus' && $slotSettings->GetGameData('DiamondCatsAMBonusWin') + $totalWin > 0 ) 
                            {
                                $slotSettings->SetBalance($slotSettings->GetGameData('DiamondCatsAMBonusWin') + $totalWin);
                            }
                            ...
                            if( $postData['slotEvent'] == 'freespin' ) 
                            {
                                $slotSettings->SetGameData('DiamondCatsAMBonusWin', $slotSettings->GetGameData('DiamondCatsAMBonusWin') + $totalWin);
                                $slotSettings->SetGameData('DiamondCatsAMTotalWin', $totalWin);
                                for( $p = 0; $p <= 2; $p++ ) 
                                {
                                    for( $r = 1; $r <= 5; $r++ ) 
                                    {
                            ...
                            if( $scattersCount >= 3 ) 
                            {
                                ...
                                if( $slotSettings->GetGameData('DiamondCatsAMFreeGames') > 0 ) 
                                {
                                    $slotSettings->SetGameData('DiamondCatsAMFreeGames', $slotSettings->GetGameData('DiamondCatsAMFreeGames') + $slotSettings->slotFreeCount);
                                }
                                else
                                {
                                    $slotSettings->SetGameData('DiamondCatsAMFreeStartWin', $totalWin);
                                    $slotSettings->SetGameData('DiamondCatsAMBonusWin', $totalWin);
                                    $slotSettings->SetGameData('DiamondCatsAMFreeGames', $slotSettings->slotFreeCount);
                                }
                            }
                            $jsSpin = '' . json_encode($reels) . '';
                            $jsJack = '' . json_encode($slotSettings->Jackpots) . '';
                            $winString = implode(',', $lineWins);
                            $response_log = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{"curSeq":' . json_encode($curSeq) . ',"holdsLine0":' . json_encode($holdsLine0) . ',"holdsLine1":' . json_encode($holdsLine1) . ',"holdsLine2":' . json_encode($holdsLine2) . ',"slotLines":' . $lines . ',"slotBet":' . $betCnt . ',"totalFreeGames":' . $slotSettings->GetGameData('DiamondCatsAMFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('DiamondCatsAMCurrentFreeGame') . ',"Balance":' . $slotSettings->GetBalance() . ',"afterBalance":' . $slotSettings->GetBalance() . ',"bonusWin":' . $slotSettings->GetGameData('DiamondCatsAMBonusWin') . ',"freeStartWin":' . $slotSettings->GetGameData('DiamondCatsAMFreeStartWin') . ',"totalWin":' . $totalWin . ',"winLines":[' . $winString . '],"bonusInfo":' . $scattersStr . ',"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
                            ...
                            if( $postData['slotEvent'] == 'freespin' ) 
                            {
                                ...
                                $cFree = dechex($slotSettings->GetGameData('DiamondCatsAMFreeGames') - $slotSettings->GetGameData('DiamondCatsAMCurrentFreeGame'));
                                $gameState = '06';
                                if( $slotSettings->GetGameData('DiamondCatsAMFreeGames') <= $slotSettings->GetGameData('DiamondCatsAMCurrentFreeGame') ) 
                                {
                                    $gameState = '0c';
                                }
                                if( $scattersCount >= 3 ) 
                                ...
                                $totalWin = $slotSettings->GetGameData('DiamondCatsAMBonusWin');
                                $bonusMpl = $slotSettings->slotFreeMpl;
                            }
                            else
                            {
                            ...
                            $slotSettings->SetGameData('DiamondCatsAMholdsLine0', $holdsLine0);
                            $slotSettings->SetGameData('DiamondCatsAMholdsLine1', $holdsLine1);
                            $slotSettings->SetGameData('DiamondCatsAMholdsLine2', $holdsLine2);
                            $response = '1' . $gameState . '010' . $balanceFormated . $slotSettings->HexFormat(round($totalWin * 100)) . $reelSate . $bet_h . $ln_h . $freeInfo . $freeWinState . $slotSettings->HexFormat($bonusMpl) . '1010' . $reelSate . $fixedLinesFormated0 . $winLinesFormated . implode('', $slotSettings->GetGameData($slotSettings->slotId . 'Cards')) . '15' . implode('', $holdsLine0) . '15' . implode('', $holdsLine1) . '15' . implode('', $holdsLine2) . '#';
                            $response .= ('_' . json_encode($reels));
                            $slotSettings->SetGameData('DiamondCatsAMDoubleAnswer', $reelSate . $bet_h . $ln_h . '1010101010101010101010' . $fixedLinesFormated0 . $winLinesFormated);
                            $slotSettings->SetGameData('DiamondCatsAMDoubleBalance', $balanceFormated);
                            $slotSettings->SetGameData('DiamondCatsAMDoubleWin', $totalWin);
                            if( $postData['slotEvent'] == 'freespin' ) 
                            {
                            ...
                            $slotSettings->SetGameData('DiamondCatsAMCollectP0', $response_collect0);
                            $gameState = '04';
                            $balanceFormated = $slotSettings->HexFormat(round($slotSettings->GetBalance() * $floatBet));
                            ...
                            $slotSettings->SetGameData('DiamondCatsAMCollect', $response_collect);
                            break;
                        case 'A/u254':
                            $slotSettings->SetGameData($slotSettings->slotId . 'TotalWin', 0);
                            $response = $slotSettings->GetGameData('DiamondCatsAMCollect');
                            break;
                        case 'A/u257':
                            $doubleWin = rand(1, 2);
                            $winall = $slotSettings->GetGameData('DiamondCatsAMDoubleWin');
                            $dbet = $winall;
                            $daction = $tmpPar[1];
                            ...
                            $response = '107010' . $slotSettings->GetGameData('DiamondCatsAMDoubleBalance') . strlen($winall_h) . $winall_h . $slotSettings->GetGameData('DiamondCatsAMDoubleAnswer') . implode('', $slotSettings->GetGameData($slotSettings->slotId . 'Cards'));
                            $slotSettings->SetGameData('DiamondCatsAMDoubleWin', $winall);
                            $slotSettings->SetGameData('DiamondCatsAMTotalWin', $winall);
                            $balanceFormated = $slotSettings->HexFormat(round($slotSettings->GetBalance() * $floatBet));
                            $response_collect = '104010' . $balanceFormated . strlen($winall_h) . $winall_h . $slotSettings->GetGameData('DiamondCatsAMCollectP0');
                            $slotSettings->SetGameData('DiamondCatsAMCollect', $response_collect);
                        ...
                        case 'A/u258':
                            ...
                            $slotSettings->SetGameData('DiamondCatsAMDoubleBalance', $rtnBalance);
                            $winall = sprintf('%01.2f', $winall) * $floatBet;
                            $winall_h1 = str_replace('.', '', $winall . '');
                            $winall_h = dechex($winall_h1);
                            $doubleCards = '26280b2714161d0c';
                            $response = '108010' . $slotSettings->GetGameData('DiamondCatsAMDoubleBalance') . strlen($winall_h) . $winall_h . $slotSettings->GetGameData('DiamondCatsAMDoubleAnswer') . implode('', $slotSettings->GetGameData($slotSettings->slotId . 'Cards'));
                            break;
                    }
