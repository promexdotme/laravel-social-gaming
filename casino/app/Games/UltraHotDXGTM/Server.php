                ...
                \DB::transaction(function() use ($request, $game)
                {
                    try
                    {
                        ...
                        else if( $postData['slotEvent'] == 'gamble5GetUserCards' ) 
                        {
                            ...
                            $dealerCard = $slotSettings->GetGameData('UltraHotDXGTMDealerCard');
                            $totalWin = $slotSettings->GetGameData('UltraHotDXGTMTotalWin');
                            $gambleWin = 0;
                            ...
                            $slotSettings->SetGameData('UltraHotDXGTMTotalWin', $totalWin);
                        ...
                        else if( $postData['slotEvent'] == 'gamble5GetDealerCard' ) 
                        {
                            ...
                            $slotSettings->SetGameData('UltraHotDXGTMDealerCard', $tmpDc);
                        ...
                        else if( $postData['slotEvent'] == 'bet' || $postData['slotEvent'] == 'freespin' ) 
                        {
                            ...
                            if( $postData['slotEvent'] != 'freespin' ) 
                            {
                                ...
                                $bonusMpl = 1;
                                $slotSettings->SetGameData('UltraHotDXGTMBonusWin', 0);
                                $slotSettings->SetGameData('UltraHotDXGTMFreeGames', 0);
                                $slotSettings->SetGameData('UltraHotDXGTMCurrentFreeGame', 0);
                                $slotSettings->SetGameData('UltraHotDXGTMTotalWin', 0);
                                $slotSettings->SetGameData('UltraHotDXGTMFreeBalance', 0);
                            }
                            else
                            {
                                $slotSettings->SetGameData('UltraHotDXGTMCurrentFreeGame', $slotSettings->GetGameData('UltraHotDXGTMCurrentFreeGame') + 1);
                                    ...
                                    for( $j = 0; $j < count($slotSettings->SymbolGame); $j++ ) 
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            if( $s[0] == $csym || in_array($s[0], $wild) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":1,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('UltraHotDXGTMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":["none","none"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":2,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('UltraHotDXGTMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            $s[0] = $reels['reel1'][$linesId[$k][0] - 1];
                                            $s[1] = $reels['reel2'][$linesId[$k][1] - 1];
                                            ...
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":3,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('UltraHotDXGTMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                        }
                                    }
                            ...
                            if( $postData['slotEvent'] == 'freespin' && $slotSettings->GetGameData('UltraHotDXGTMFreeGames') <= $slotSettings->GetGameData('UltraHotDXGTMCurrentFreeGame') && $winType != 'bonus' && $slotSettings->GetGameData('UltraHotDXGTMTotalWin') + $totalWin > 0 ) 
                            {
                                $slotSettings->SetBalance($slotSettings->GetGameData('UltraHotDXGTMTotalWin') + $totalWin);
                            }
                            ...
                            if( $postData['slotEvent'] == 'freespin' ) 
                            {
                                $slotSettings->SetGameData('UltraHotDXGTMBonusWin', $slotSettings->GetGameData('UltraHotDXGTMBonusWin') + $totalWin);
                                $slotSettings->SetGameData('UltraHotDXGTMTotalWin', $slotSettings->GetGameData('UltraHotDXGTMTotalWin') + $totalWin);
                                $totalWin = $slotSettings->GetGameData('UltraHotDXGTMBonusWin');
                                $Balance = $slotSettings->GetGameData('UltraHotDXGTMFreeBalance');
                            }
                            else
                            {
                                $slotSettings->SetGameData('UltraHotDXGTMTotalWin', $totalWin);
                            ...
                            if( $scattersCount >= 3 ) 
                            {
                                if( $slotSettings->GetGameData('UltraHotDXGTMFreeGames') > 0 ) 
                                {
                                    $slotSettings->SetGameData('UltraHotDXGTMFreeBalance', $Balance);
                                    $slotSettings->SetGameData('UltraHotDXGTMBonusWin', $totalWin);
                                    $slotSettings->SetGameData('UltraHotDXGTMFreeGames', $slotSettings->GetGameData('UltraHotDXGTMFreeGames') + $slotSettings->slotFreeCount);
                                }
                                else
                                {
                                    $slotSettings->SetGameData('UltraHotDXGTMFreeBalance', $Balance);
                                    $slotSettings->SetGameData('UltraHotDXGTMBonusWin', $totalWin);
                                    $slotSettings->SetGameData('UltraHotDXGTMFreeGames', $slotSettings->slotFreeCount);
                                }
                            }
                            $X2Mode = 'false';
                            ...
                            $response = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{"slotLines":' . $postData['slotLines'] . ',"slotBet":' . $postData['slotBet'] . ',"X2":' . $X2Mode . ',"totalFreeGames":' . $slotSettings->GetGameData('UltraHotDXGTMFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('UltraHotDXGTMCurrentFreeGame') . ',"Balance":' . $Balance . ',"afterBalance":' . $slotSettings->GetBalance() . ',"totalWin":' . $totalWin . ',"winLines":[' . $winString . '],"bonusInfo":' . $scattersStr . ',"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
