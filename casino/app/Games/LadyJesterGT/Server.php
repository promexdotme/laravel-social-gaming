                    ...
                    try
                    {
                        ...
                        if( $postData['slotEvent'] == 'getSettings' ) 
                        {
                            ...
                            if( $lastEvent != 'NULL' ) 
                            {
                                ...
                                $LadyJesterGTStacked = $lastEvent->serverResponse->stackedWilds;
                                for( $i = 0; $i < 5; $i++ ) 
                                {
                                    $slotSettings->SetGameData('LadyJesterGTStacked.' . $i, $LadyJesterGTStacked[$i]);
                                }
                                for( $r = 1; $r <= 5; $r++ ) 
                                {
                                    if( $slotSettings->GetGameData('LadyJesterGTStacked.' . ($r - 1)) > 0 ) 
                                    {
                                        $slotSettings->SetGameData('LadyJesterGTStacked.' . ($r - 1), -1);
                                    }
                                    if( $slotSettings->GetGameData('LadyJesterGTStacked.' . ($r - 1)) == 0 ) 
                                    {
                                        $slotSettings->SetGameData('LadyJesterGTStacked.' . ($r - 1), 1);
                        ...
                        else if( $postData['slotEvent'] == 'gamble5GetUserCards' ) 
                        {
                            ...
                            $dealerCard = $slotSettings->GetGameData('LadyJesterGTDealerCard');
                            $totalWin = $slotSettings->GetGameData('LadyJesterGTTotalWin');
                            $gambleWin = 0;
                            ...
                            $slotSettings->SetGameData('LadyJesterGTTotalWin', $totalWin);
                        ...
                        else if( $postData['slotEvent'] == 'gamble5GetDealerCard' ) 
                        {
                            ...
                            $slotSettings->SetGameData('LadyJesterGTDealerCard', $tmpDc);
                        ...
                        else if( $postData['slotEvent'] == 'bet' || $postData['slotEvent'] == 'freespin' ) 
                        {
                            ...
                            if( $postData['slotEvent'] != 'freespin' ) 
                            {
                                ...
                                $bonusMpl = 1;
                                $slotSettings->SetGameData('LadyJesterGTBonusWin', 0);
                                $slotSettings->SetGameData('LadyJesterGTFreeGames', 0);
                                $slotSettings->SetGameData('LadyJesterGTCurrentFreeGame', 0);
                                $slotSettings->SetGameData('LadyJesterGTTotalWin', 0);
                                $slotSettings->SetGameData('LadyJesterGTFreeBalance', 0);
                                $slotSettings->SetGameData('LadyJesterGTIsJack', 0);
                                for( $i = 0; $i < 5; $i++ ) 
                                {
                                    $slotSettings->SetGameData('LadyJesterGTStacked.' . $i, -1);
                                }
                            }
                            else
                            {
                                $slotSettings->SetGameData('LadyJesterGTCurrentFreeGame', $slotSettings->GetGameData('LadyJesterGTCurrentFreeGame') + 1);
                                $bonusMpl = $slotSettings->slotFreeMpl;
                                if( $slotSettings->GetGameData('LadyJesterGTStacked.0') > 0 && $slotSettings->GetGameData('LadyJesterGTStacked.1') > 0 && $slotSettings->GetGameData('LadyJesterGTStacked.2') > 0 && $slotSettings->GetGameData('LadyJesterGTStacked.3') > 0 && $slotSettings->GetGameData('LadyJesterGTStacked.4') > 0 ) 
                                {
                            ...
                            for( $i = 0; $i <= 2000; $i++ ) 
                            {
                                ...
                                if( isset($jackState) && $jackState['isJackPay'] ) 
                                {
                                    ...
                                    $slotSettings->SetGameData('LadyJesterGTIsJack', 1);
                                    $winType = 'win';
                                    ...
                                    for( $j = 0; $j < count($slotSettings->SymbolGame); $j++ ) 
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            if( $s[0] == $csym || in_array($s[0], $wild) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":1,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('LadyJesterGTBonusWin')) . ',"winReel1":[' . ($linesId[$k + 1][0] - 1) . ',"' . $s[0] . '"],"winReel2":["none","none"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":2,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('LadyJesterGTBonusWin')) . ',"winReel1":[' . ($linesId[$k + 1][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k + 1][1] - 1) . ',"' . $s[1] . '"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            $s[0] = $reels['reel1'][$linesId[$k + 1][0] - 1];
                                            $s[1] = $reels['reel2'][$linesId[$k + 1][1] - 1];
                                            ...
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":3,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('LadyJesterGTBonusWin')) . ',"winReel1":[' . ($linesId[$k + 1][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k + 1][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k + 1][2] - 1) . ',"' . $s[2] . '"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            $s[0] = $reels['reel1'][$linesId[$k + 1][0] - 1];
                                            $s[1] = $reels['reel2'][$linesId[$k + 1][1] - 1];
                                            ...
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) && ($s[3] == $csym || in_array($s[3], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":4,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('LadyJesterGTBonusWin')) . ',"winReel1":[' . ($linesId[$k + 1][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k + 1][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k + 1][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k + 1][3] - 1) . ',"' . $s[3] . '"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            $s[0] = $reels['reel1'][$linesId[$k + 1][0] - 1];
                                            $s[1] = $reels['reel2'][$linesId[$k + 1][1] - 1];
                                            ...
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) && ($s[3] == $csym || in_array($s[3], $wild)) && ($s[4] == $csym || in_array($s[4], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":5,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('LadyJesterGTBonusWin')) . ',"winReel1":[' . ($linesId[$k + 1][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k + 1][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k + 1][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k + 1][3] - 1) . ',"' . $s[3] . '"],"winReel5":[' . ($linesId[$k + 1][4] - 1) . ',"' . $s[4] . '"]}';
                                                }
                                                if( $isSlotJack ) 
                                                {
                                                    $tmpStringWin = '';
                            ...
                            if( $postData['slotEvent'] == 'freespin' && $slotSettings->GetGameData('LadyJesterGTFreeGames') <= $slotSettings->GetGameData('LadyJesterGTCurrentFreeGame') && $winType != 'bonus' && $slotSettings->GetGameData('LadyJesterGTTotalWin') + $totalWin > 0 ) 
                            {
                                $slotSettings->SetBalance($slotSettings->GetGameData('LadyJesterGTTotalWin') + $totalWin);
                            }
                            ...
                            if( $postData['slotEvent'] == 'freespin' ) 
                            {
                                $slotSettings->SetGameData('LadyJesterGTBonusWin', $slotSettings->GetGameData('LadyJesterGTBonusWin') + $totalWin);
                                $slotSettings->SetGameData('LadyJesterGTTotalWin', $slotSettings->GetGameData('LadyJesterGTTotalWin') + $totalWin);
                                $totalWin = $slotSettings->GetGameData('LadyJesterGTBonusWin');
                                $Balance = $slotSettings->GetGameData('LadyJesterGTFreeBalance');
                                for( $r = 1; $r <= 5; $r++ ) 
                                {
                                    for( $p = 0; $p <= 3; $p++ ) 
                                    {
                                        if( $reels['reel' . $r][$p] == 'P_1' ) 
                                        {
                                            $slotSettings->SetGameData('LadyJesterGTStacked.' . ($r - 1), 0);
                                        }
                                    }
                                }
                            }
                            ...
                            if( $scattersCount >= 3 ) 
                            {
                                if( $slotSettings->GetGameData('LadyJesterGTFreeGames') > 0 ) 
                                {
                                    $slotSettings->SetGameData('LadyJesterGTFreeBalance', $Balance);
                                    $slotSettings->SetGameData('LadyJesterGTBonusWin', $totalWin);
                                    $slotSettings->SetGameData('LadyJesterGTFreeGames', $slotSettings->GetGameData('LadyJesterGTFreeGames') + $slotSettings->slotFreeCount);
                                }
                                else
                                {
                                    $slotSettings->SetGameData('LadyJesterGTFreeBalance', $Balance);
                                    $slotSettings->SetGameData('LadyJesterGTBonusWin', $totalWin);
                                    $slotSettings->SetGameData('LadyJesterGTFreeGames', $slotSettings->slotFreeCount);
                                }
                            }
                            $LadyJesterGTStacked = [];
                            for( $i = 0; $i < 5; $i++ ) 
                            {
                                if( $slotSettings->HasGameData('LadyJesterGTStacked.' . $i) ) 
                                {
                                    $LadyJesterGTStacked[] = $slotSettings->GetGameData('LadyJesterGTStacked.' . $i);
                                }
                            }
                            $jsSpin = '' . json_encode($reels) . '';
                            $jsJack = '' . json_encode($slotSettings->Jackpots) . '';
                            $winString = implode(',', $lineWins);
                            $stackedWilds = '"stackedWilds":[' . implode(',', $LadyJesterGTStacked) . ']';
                            $response = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{' . $stackedWilds . ',"slotJackpot":' . $slotSettings->slotJackpot[0] . ',"slotLines":' . $postData['slotLines'] . ',"slotBet":' . $postData['slotBet'] . ',"totalFreeGames":' . $slotSettings->GetGameData('LadyJesterGTFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('LadyJesterGTCurrentFreeGame') . ',"Balance":' . $Balance . ',"afterBalance":' . $slotSettings->GetBalance() . ',"totalWin":' . $totalWin . ',"winLines":[' . $winString . '],"bonusInfo":' . $scattersStr . ',"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
