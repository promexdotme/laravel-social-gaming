            ...
            \DB::transaction(function() use ($request, $game)
            {
                try
                {
                    ...
                    else if( $postData['slotEvent'] == 'gamble5GetUserCards' ) 
                    {
                        ...
                        $dealerCard = $slotSettings->GetGameData('QueenOfHeartsDealerCard');
                        $totalWin = $slotSettings->GetGameData('QueenOfHeartsTotalWin');
                        $gambleWin = 0;
                        ...
                        $slotSettings->SetGameData('QueenOfHeartsTotalWin', $totalWin);
                    ...
                    else if( $postData['slotEvent'] == 'gamble5GetDealerCard' ) 
                    {
                        ...
                        $slotSettings->SetGameData('QueenOfHeartsDealerCard', $tmpDc);
                    ...
                    else if( $postData['slotEvent'] == 'bet' || $postData['slotEvent'] == 'freespin' ) 
                    {
                        ...
                        if( $postData['slotEvent'] != 'freespin' ) 
                        {
                            ...
                            $bonusMpl = 1;
                            $slotSettings->SetGameData('QueenOfHeartsBonusWin', 0);
                            $slotSettings->SetGameData('QueenOfHeartsFreeGames', 0);
                            $slotSettings->SetGameData('QueenOfHeartsCurrentFreeGame', 0);
                            $slotSettings->SetGameData('QueenOfHeartsTotalWin', 0);
                            $slotSettings->SetGameData('QueenOfHeartsFreeBalance', 0);
                        }
                        else
                        {
                            $slotSettings->SetGameData('QueenOfHeartsCurrentFreeGame', $slotSettings->GetGameData('QueenOfHeartsCurrentFreeGame') + 1);
                        ...
                        for( $i = 0; $i <= 2000; $i++ ) 
                        {
                            ...
                            if( $postData['slotEvent'] == 'freespin' ) 
                            {
                                for( $row = 0; $row < 5; $row++ ) 
                                {
                                    ...
                                    if( $cCh == 1 ) 
                                    {
                                        ...
                                        shuffle($cwArr);
                                        shuffle($cCnt);
                                        for( $cell = 0; $cell <= $cCnt[0]; $cell++ ) 
                                        {
                                            $reelsTmp['reel' . ($row + 1)][$cwArr[$cell]] = $wild;
                                            $flyObj[] = [
                                                $row, 
                                                $cwArr[$cell]
                                            ];
                            ...
                            for( $k = 0; $k < $postData['slotLines']; $k++ ) 
                            {
                                ...
                                for( $j = 0; $j < count($slotSettings->SymbolGame); $j++ ) 
                                {
                                    ...
                                    {
                                        $s = [];
                                        $s[0] = $reelsTmp['reel1'][$linesId[$k][0] - 1];
                                        $s[1] = $reelsTmp['reel2'][$linesId[$k][1] - 1];
                                        $s[2] = $reelsTmp['reel3'][$linesId[$k][2] - 1];
                                        $s[3] = $reelsTmp['reel4'][$linesId[$k][3] - 1];
                                        $s[4] = $reelsTmp['reel5'][$linesId[$k][4] - 1];
                                        if( $s[0] == $wild ) 
                                        {
                                            $mpl = 1;
                                            $tmpWin = $slotSettings->Paytable[$wild][1] * $postData['slotBet'] * $mpl * $bonusMpl;
                                            if( $cWins[$k] < $tmpWin ) 
                                            {
                                                $cWins[$k] = $tmpWin;
                                                $tmpStringWin = '{"Count":1,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('QueenOfHeartsBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":["none","none"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                            }
                                        }
                                        if( ($s[0] == $csym || $s[0] == $wild) && ($s[1] == $csym || $s[1] == $wild) ) 
                                        {
                                            ...
                                            {
                                                $cWins[$k] = $tmpWin;
                                                $tmpStringWin = '{"Count":2,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('QueenOfHeartsBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                            }
                                        }
                                        if( ($s[0] == $csym || $s[0] == $wild) && ($s[1] == $csym || $s[1] == $wild) && ($s[2] == $csym || $s[2] == $wild) ) 
                                        {
                                            ...
                                            {
                                                $cWins[$k] = $tmpWin;
                                                $tmpStringWin = '{"Count":3,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('QueenOfHeartsBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                            }
                                        }
                                        if( ($s[0] == $csym || $s[0] == $wild) && ($s[1] == $csym || $s[1] == $wild) && ($s[2] == $csym || $s[2] == $wild) && ($s[3] == $csym || $s[3] == $wild) ) 
                                        {
                                            ...
                                            {
                                                $cWins[$k] = $tmpWin;
                                                $tmpStringWin = '{"Count":4,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('QueenOfHeartsBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":["none","none"]}';
                                            }
                                        }
                                        if( ($s[0] == $csym || $s[0] == $wild) && ($s[1] == $csym || $s[1] == $wild) && ($s[2] == $csym || $s[2] == $wild) && ($s[3] == $csym || $s[3] == $wild) && ($s[4] == $csym || $s[4] == $wild) ) 
                                        {
                                            ...
                                            {
                                                $cWins[$k] = $tmpWin;
                                                $tmpStringWin = '{"Count":5,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('QueenOfHeartsBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":[' . ($linesId[$k][4] - 1) . ',"' . $s[4] . '"]}';
                                            }
                                        }
                                    }
                                }
                        ...
                        if( $postData['slotEvent'] == 'freespin' && $slotSettings->GetGameData('QueenOfHeartsFreeGames') <= $slotSettings->GetGameData('QueenOfHeartsCurrentFreeGame') && $winType != 'bonus' && $slotSettings->GetGameData('QueenOfHeartsTotalWin') + $totalWin > 0 ) 
                        {
                            $slotSettings->SetBalance($slotSettings->GetGameData('QueenOfHeartsTotalWin') + $totalWin);
                        }
                        ...
                        if( $postData['slotEvent'] == 'freespin' ) 
                        {
                            $slotSettings->SetGameData('QueenOfHeartsBonusWin', $slotSettings->GetGameData('QueenOfHeartsBonusWin') + $totalWin);
                            $slotSettings->SetGameData('QueenOfHeartsTotalWin', $slotSettings->GetGameData('QueenOfHeartsTotalWin') + $totalWin);
                            $totalWin = $slotSettings->GetGameData('QueenOfHeartsBonusWin');
                            $Balance = $slotSettings->GetGameData('QueenOfHeartsFreeBalance');
                        }
                        else
                        {
                            $slotSettings->SetGameData('QueenOfHeartsTotalWin', $totalWin);
                        ...
                        if( $scattersCount >= 3 ) 
                        {
                            if( $slotSettings->GetGameData('QueenOfHeartsFreeGames') > 0 ) 
                            {
                                $slotSettings->SetGameData('QueenOfHeartsFreeBalance', $Balance);
                                $slotSettings->SetGameData('QueenOfHeartsBonusWin', $totalWin);
                                $slotSettings->SetGameData('QueenOfHeartsFreeGames', $slotSettings->GetGameData('QueenOfHeartsFreeGames') + $slotSettings->slotFreeCount[$scattersCount]);
                            }
                            else
                            {
                                $slotSettings->SetGameData('QueenOfHeartsFreeBalance', $Balance);
                                $slotSettings->SetGameData('QueenOfHeartsBonusWin', $totalWin);
                                $slotSettings->SetGameData('QueenOfHeartsFreeGames', $slotSettings->slotFreeCount[$scattersCount]);
                            }
                        }
                        ...
                        if( count($flyObj) ) 
                        {
                            $flyObjStr = '"flyObj":' . json_encode($flyObj) . ',';
                        }
                        else
                        {
                            $flyObjStr = '';
                        ...
                        $response = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{"slotLines":' . $postData['slotLines'] . ',"slotBet":' . $postData['slotBet'] . ',' . $flyObjStr . '"totalFreeGames":' . $slotSettings->GetGameData('QueenOfHeartsFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('QueenOfHeartsCurrentFreeGame') . ',"Balance":' . $Balance . ',"afterBalance":' . $slotSettings->GetBalance() . ',"totalWin":' . $totalWin . ',"winLines":[' . $winString . '],"bonusInfo":' . $scattersStr . ',"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
