                    ...
                    try
                    {
                        ...
                        if( isset($postData['spinType']) ) 
                        {
                            ...
                            if( $postData['spinType'] == 'regular' ) 
                            {
                                ...
                                $bonusMpl = 1;
                                $slotSettings->SetGameData('MedusaMonstersPTBonusWin', 0);
                                $slotSettings->SetGameData('MedusaMonstersPTFreeGames', 0);
                                $slotSettings->SetGameData('MedusaMonstersPTCurrentFreeGame', 0);
                                $slotSettings->SetGameData('MedusaMonstersPTTotalWin', 0);
                                $slotSettings->SetGameData('MedusaMonstersPTFreeBalance', 0);
                                $slotSettings->SetGameData('MedusaMonstersPTFreeStartWin', 0);
                                $slotSettings->SetGameData('MedusaMonstersPTFreeMpl', $slotSettings->slotFreeMpl);
                                $slotSettings->SetGameData('MedusaMonstersPTIncreaseMpl', 0);
                                ...
                                $slotSettings->SetGameData('MedusaMonstersPTstickySymbol', $stickySymbol);
                                $slotSettings->SetGameData('MedusaMonstersPTstickySymbolArr', $stickySymbolArr);
                                $slotSettings->SetGameData('MedusaMonstersPTwildRow', 6);
                            }
                            else if( $postData['spinType'] == 'free' ) 
                            {
                                $umid = '0';
                                $postData['slotEvent'] = 'freespin';
                                $slotSettings->SetGameData('MedusaMonstersPTCurrentFreeGame', $slotSettings->GetGameData('MedusaMonstersPTCurrentFreeGame') + 1);
                                $stickySymbol = $slotSettings->GetGameData('MedusaMonstersPTstickySymbol');
                                $stickySymbolArr = $slotSettings->GetGameData('MedusaMonstersPTstickySymbolArr');
                                $bonusMpl = 1;
                            }
                            $linesId = [];
                            $linesId[0] = [
                            ...
                            for( $i = 0; $i <= 2000; $i++ ) 
                            {
                                ...
                                if( $postData['slotEvent'] == 'freespin' && $slotSettings->GetGameData('MedusaMonstersPTwildRow') >= 1 ) 
                                {
                                    $wr = $slotSettings->GetGameData('MedusaMonstersPTwildRow');
                                    $reels['reel' . $wr][0] = '0';
                                    $reels['reel' . $wr][1] = '0';
                                    $reels['reel' . $wr][2] = '0';
                                    $reels['reel' . $wr][3] = '0';
                                    ...
                                    for( $j = 0; $j < count($slotSettings->SymbolGame); $j++ ) 
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            if( $s[0] == $csym || in_array($s[0], $wild) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":1,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('MedusaMonstersPTBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":["none","none"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":2,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('MedusaMonstersPTBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":3,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('MedusaMonstersPTBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) && ($s[3] == $csym || in_array($s[3], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":4,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('MedusaMonstersPTBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) && ($s[3] == $csym || in_array($s[3], $wild)) && ($s[4] == $csym || in_array($s[4], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":5,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('MedusaMonstersPTBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":[' . ($linesId[$k][4] - 1) . ',"' . $s[4] . '"]}';
                                                }
                                            }
                            ...
                            if( $postData['slotEvent'] == 'freespin' ) 
                            {
                                $slotSettings->SetGameData('MedusaMonstersPTBonusWin', $slotSettings->GetGameData('MedusaMonstersPTBonusWin') + $totalWin);
                                $slotSettings->SetGameData('MedusaMonstersPTTotalWin', $totalWin);
                                $slotSettings->SetGameData('MedusaMonstersPTstickySymbol', $stickySymbol);
                                $slotSettings->SetGameData('MedusaMonstersPTwildRow', $slotSettings->GetGameData('MedusaMonstersPTwildRow') - 1);
                            }
                            else
                            {
                                $slotSettings->SetGameData('MedusaMonstersPTTotalWin', $totalWin);
                            }
                            $slotSettings->SetGameData('MedusaMonstersPTBonusStart', false);
                            if( $scattersCount >= 3 ) 
                            {
                                $slotSettings->SetGameData('MedusaMonstersPTBonusStart', true);
                                $slotSettings->SetGameData('MedusaMonstersPTBonusStep', 0);
                                $wildReels = [];
                                $slotSettings->SetGameData('MedusaMonstersPTwildReels', $wildReels);
                                $slotSettings->SetGameData('MedusaMonstersPTIncreaseMpl', 0);
                                $slotSettings->SetGameData('MedusaMonstersPTFreeStartWin', $totalWin);
                                $slotSettings->SetGameData('MedusaMonstersPTBonusWin', 0);
                                $slotSettings->SetGameData('MedusaMonstersPTFreeGames', $slotSettings->slotFreeCount);
                            }
                            $balanceInCents = sprintf('%01.2f', $slotSettings->GetBalance()) * 100;
                            $spinState = 'REGULAR';
                            ...
                            $response = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{"stickySymbolArr":[' . implode(',', $stickySymbolArr) . '],"wildRow":' . $slotSettings->GetGameData('MedusaMonstersPTwildRow') . ',"stickySymbol":' . $stickySymbol . ',"IncreaseMpl":1,"linesArr":[' . implode(',', $postData['lines']) . '],"slotLines":' . $lines . ',"slotBet":' . $betLine . ',"totalFreeGames":' . $slotSettings->GetGameData('MedusaMonstersPTFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('MedusaMonstersPTCurrentFreeGame') . ',"Balance":' . $slotSettings->GetBalance() . ',"afterBalance":' . $slotSettings->GetBalance() . ',"bonusWin":' . $slotSettings->GetGameData('MedusaMonstersPTBonusWin') . ',"FreeMpl":' . $slotSettings->GetGameData('MedusaMonstersPTFreeMpl') . ',"freeStartWin":' . $slotSettings->GetGameData('MedusaMonstersPTFreeStartWin') . ',"totalWin":' . $totalWin . ',"winLines":[' . $winString . '],"bonusInfo":' . $scattersStr . ',"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
