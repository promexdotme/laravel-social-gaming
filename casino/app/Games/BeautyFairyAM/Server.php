                    ...
                    switch( $gameData['slotEvent'] ) 
                    {
                        ...
                        case 'A/u25':
                            ...
                            if( $lastEvent != 'NULL' ) 
                            {
                                ...
                                $reelSate = $slotSettings->HexFormat($reels->rp[0]) . $slotSettings->HexFormat($reels->rp[1]) . $slotSettings->HexFormat($reels->rp[2]) . $slotSettings->HexFormat($reels->rp[3]) . $slotSettings->HexFormat($reels->rp[4]) . $slotSettings->HexFormat($reels->rp[5]);
                                ...
                                $slotSettings->SetGameData('BeautyFairyAMLines', $curLines);
                                $freeMpl = '11';
                                $slotSettings->SetGameData('BeautyFairyAMBonusWin', $lastEvent->serverResponse->bonusWin);
                                $slotSettings->SetGameData('BeautyFairyAMFreeGames', $lastEvent->serverResponse->totalFreeGames);
                                $slotSettings->SetGameData('BeautyFairyAMCurrentFreeGame', $lastEvent->serverResponse->currentFreeGames);
                                $slotSettings->SetGameData('BeautyFairyAMTotalWin', 0);
                                $slotSettings->SetGameData('BeautyFairyAMFreeBalance', 0);
                                $slotSettings->SetGameData('BeautyFairyAMFreeStartWin', 0);
                                $slotSettings->SetGameData($slotSettings->slotId . 'CurrentSeq', $lastEvent->serverResponse->curSeq);
                                $tFree = dechex($slotSettings->GetGameData('BeautyFairyAMFreeGames'));
                                $cFree = dechex($slotSettings->GetGameData('BeautyFairyAMFreeGames') - $slotSettings->GetGameData('BeautyFairyAMCurrentFreeGame'));
                                $freeInfo = strlen($tFree) . $tFree . strlen($cFree) . $cFree;
                                $stateWin = $slotSettings->HexFormat($slotSettings->GetGameData('BeautyFairyAMBonusWin') * $floatBet);
                                if( $slotSettings->GetGameData('BeautyFairyAMCurrentFreeGame') < $slotSettings->GetGameData('BeautyFairyAMFreeGames') && $slotSettings->GetGameData('BeautyFairyAMFreeGames') > 0 ) 
                                {
                                    $slotState = '6';
                            ...
                            {
                                $slotSettings->SetGameData('BeautyFairyAMLines', $fixedLinesFormated);
                                $slotState = '4';
                        ...
                        case 'A/u251':
                            if( $postData['spinType'] == 'regular' && $slotSettings->GetGameData($slotSettings->slotId . 'FreeGames') <= $slotSettings->GetGameData($slotSettings->slotId . 'CurrentFreeGame') ) 
                            {
                                ...
                                $bonusMpl = 1;
                                $slotSettings->SetGameData('BeautyFairyAMBonusWin', 0);
                                $slotSettings->SetGameData('BeautyFairyAMFreeGames', 0);
                                $slotSettings->SetGameData('BeautyFairyAMCurrentFreeGame', 0);
                                $slotSettings->SetGameData('BeautyFairyAMTotalWin', 0);
                                $slotSettings->SetGameData('BeautyFairyAMFreeBalance', 0);
                                $slotSettings->SetGameData('BeautyFairyAMFreeStartWin', 0);
                                $slotSettings->SetGameData('BeautyFairyAMholdsLine0', [
                                    '0', 
                                    '0', 
                                    '0', 
                                    '0', 
                                ...
                                $slotSettings->SetGameData('BeautyFairyAMholdsLine1', [
                                    '0', 
                                    '0', 
                                    '0', 
                                    '0', 
                                ...
                                $slotSettings->SetGameData('BeautyFairyAMholdsLine2', [
                                    '0', 
                                    '0', 
                                    '0', 
                                    '0', 
                            ...
                            if( $slotSettings->GetGameData($slotSettings->slotId . 'CurrentFreeGame') < $slotSettings->GetGameData($slotSettings->slotId . 'FreeGames') ) 
                            {
                                ...
                                $slotSettings->SetGameData('BeautyFairyAMCurrentFreeGame', $slotSettings->GetGameData('BeautyFairyAMCurrentFreeGame') + 1);
                                $bonusMpl = $slotSettings->slotFreeMpl;
                            }
                            $holdsLine0 = $slotSettings->GetGameData('BeautyFairyAMholdsLine0');
                            $holdsLine1 = $slotSettings->GetGameData('BeautyFairyAMholdsLine1');
                            $holdsLine2 = $slotSettings->GetGameData('BeautyFairyAMholdsLine2');
                            $linesId[0] = [
                                2, 
                                2, 
                                2, 
                                    ...
                                    for( $j = 0; $j < count($slotSettings->SymbolGame); $j++ ) 
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            if( $s[0] == $csym || in_array($s[0], $wild) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":1,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('BeautyFairyAMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":["none","none"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":2,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('BeautyFairyAMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":3,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('BeautyFairyAMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[3] == $csym || in_array($s[3], $wild)) && ($s[4] == $csym || in_array($s[4], $wild)) && ($s[5] == $csym || in_array($s[5], $wild)) ) 
                                            {
                                                $mpl = 1;
                                                $tmpWin = $slotSettings->Paytable['SYM_' . $csym][3] * $betLine * $mpl * $bonusMpl;
                                                if( $cWins[$k] < $tmpWin ) 
                                            ...
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) && ($s[3] == $csym || in_array($s[3], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":4,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('BeautyFairyAMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[2] == $csym || in_array($s[2], $wild)) && ($s[3] == $csym || in_array($s[3], $wild)) && ($s[4] == $csym || in_array($s[4], $wild)) && ($s[5] == $csym || in_array($s[5], $wild)) ) 
                                            {
                                                $mpl = 1;
                                                $tmpWin = $slotSettings->Paytable['SYM_' . $csym][4] * $betLine * $mpl * $bonusMpl;
                                                if( $cWins[$k] < $tmpWin ) 
                                            ...
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) && ($s[3] == $csym || in_array($s[3], $wild)) && ($s[4] == $csym || in_array($s[4], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":5,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('BeautyFairyAMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":[' . ($linesId[$k][4] - 1) . ',"' . $s[4] . '"]}';
                                                }
                                            }
                                            if( ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) && ($s[3] == $csym || in_array($s[3], $wild)) && ($s[4] == $csym || in_array($s[4], $wild)) && ($s[5] == $csym || in_array($s[5], $wild)) ) 
                                            {
                                                $mpl = 1;
                                                if( in_array($s[0], $wild) && in_array($s[1], $wild) && in_array($s[2], $wild) && in_array($s[3], $wild) && in_array($s[4], $wild) ) 
                                                {
                                            ...
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) && ($s[3] == $csym || in_array($s[3], $wild)) && ($s[4] == $csym || in_array($s[4], $wild)) && ($s[5] == $csym || in_array($s[5], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":6,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('BeautyFairyAMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":[' . ($linesId[$k][4] - 1) . ',"' . $s[4] . '"]}';
                                                }
                                            }
                                        }
                                    }
                            ...
                            if( $postData['slotEvent'] == 'freespin' && $slotSettings->GetGameData('BeautyFairyAMFreeGames') <= $slotSettings->GetGameData('BeautyFairyAMCurrentFreeGame') && $winType != 'bonus' && $slotSettings->GetGameData('BeautyFairyAMBonusWin') + $totalWin > 0 ) 
                            {
                                $slotSettings->SetBalance($slotSettings->GetGameData('BeautyFairyAMBonusWin') + $totalWin);
                            }
                            ...
                            if( $postData['slotEvent'] == 'freespin' ) 
                            {
                                $slotSettings->SetGameData('BeautyFairyAMBonusWin', $slotSettings->GetGameData('BeautyFairyAMBonusWin') + $totalWin);
                                $slotSettings->SetGameData('BeautyFairyAMTotalWin', $totalWin);
                            }
                            else
                            {
                                $slotSettings->SetGameData('BeautyFairyAMTotalWin', $totalWin);
                            ...
                            if( $scattersCount >= 2 ) 
                            {
                                ...
                                if( $slotSettings->GetGameData('BeautyFairyAMFreeGames') > 0 ) 
                                {
                                    $slotSettings->SetGameData('BeautyFairyAMFreeGames', $slotSettings->GetGameData('BeautyFairyAMFreeGames') + $slotSettings->slotFreeCount);
                                }
                                else
                                {
                                    $slotSettings->SetGameData('BeautyFairyAMFreeStartWin', $totalWin);
                                    $slotSettings->SetGameData('BeautyFairyAMBonusWin', $totalWin);
                                    $slotSettings->SetGameData('BeautyFairyAMFreeGames', $slotSettings->slotFreeCount);
                                }
                            }
                            $jsSpin = '' . json_encode($reels) . '';
                            $jsJack = '' . json_encode($slotSettings->Jackpots) . '';
                            $winString = implode(',', $lineWins);
                            $response_log = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{"curSeq":' . json_encode($curSeq) . ',"holdsLine0":' . json_encode($holdsLine0) . ',"holdsLine1":' . json_encode($holdsLine1) . ',"holdsLine2":' . json_encode($holdsLine2) . ',"slotLines":' . $lines . ',"slotBet":' . $betCnt . ',"totalFreeGames":' . $slotSettings->GetGameData('BeautyFairyAMFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('BeautyFairyAMCurrentFreeGame') . ',"Balance":' . $slotSettings->GetBalance() . ',"afterBalance":' . $slotSettings->GetBalance() . ',"bonusWin":' . $slotSettings->GetGameData('BeautyFairyAMBonusWin') . ',"freeStartWin":' . $slotSettings->GetGameData('BeautyFairyAMFreeStartWin') . ',"totalWin":' . $totalWin . ',"winLines":[' . $winString . '],"bonusInfo":' . $scattersStr . ',"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
                            ...
                            if( $postData['slotEvent'] == 'freespin' ) 
                            {
                                ...
                                $gameState = '06';
                                if( $slotSettings->GetGameData('BeautyFairyAMFreeGames') <= $slotSettings->GetGameData('BeautyFairyAMCurrentFreeGame') ) 
                                {
                                    $gameState = '0e';
                                }
                                if( $scattersCount >= 3 ) 
                                ...
                                $totalWin = $slotSettings->GetGameData('BeautyFairyAMBonusWin');
                                $bonusMpl = $slotSettings->slotFreeMpl;
                            }
                            else
                            {
                            ...
                            $slotSettings->SetGameData('BeautyFairyAMholdsLine0', $holdsLine0);
                            $slotSettings->SetGameData('BeautyFairyAMholdsLine1', $holdsLine1);
                            $slotSettings->SetGameData('BeautyFairyAMholdsLine2', $holdsLine2);
                            $balanceFormated_ = $slotSettings->HexFormat(sprintf('%01.2f', $slotSettings->GetBalance()) * $floatBet);
                            $response = '1' . $gameState . '010' . $balanceFormated_ . $slotSettings->HexFormat(round($totalWin * 100)) . $reelSate . $bet_h . $ln_h . $freeInfo . $freeWinState . $slotSettings->HexFormat($bonusMpl) . '1010' . $reelSate . $fixedLinesFormated0 . $winLinesFormated . implode('', $slotSettings->GetGameData($slotSettings->slotId . 'Cards')) . '16' . implode('', $holdsLine0) . '16' . implode('', $holdsLine1) . '16' . implode('', $holdsLine2) . '#101010';
                            $response .= ('_' . json_encode($reels));
                            $slotSettings->SetGameData('BeautyFairyAMDoubleAnswer', $reelSate . $bet_h . $ln_h . '1010101010101010101010' . $fixedLinesFormated0 . $winLinesFormated);
                            $slotSettings->SetGameData('BeautyFairyAMDoubleBalance', $balanceFormated);
                            $slotSettings->SetGameData('BeautyFairyAMDoubleWin', $totalWin);
                            if( $postData['slotEvent'] == 'freespin' ) 
                            {
                            ...
                            $slotSettings->SetGameData('BeautyFairyAMCollectP0', $response_collect0);
                            $gameState = '04';
                            $balanceFormated = $slotSettings->HexFormat(round($slotSettings->GetBalance() * $floatBet));
                            ...
                            $slotSettings->SetGameData('BeautyFairyAMCollect', $response_collect);
                            break;
                        case 'A/u254':
                            $slotSettings->SetGameData($slotSettings->slotId . 'TotalWin', 0);
                            $response = $slotSettings->GetGameData('BeautyFairyAMCollect');
                            break;
                        case 'A/u257':
                            $doubleWin = rand(1, 2);
                            $winall = $slotSettings->GetGameData('BeautyFairyAMDoubleWin');
                            $dbet = $winall;
                            $daction = $tmpPar[1];
                            ...
                            $response = '107010' . $slotSettings->GetGameData('BeautyFairyAMDoubleBalance') . strlen($winall_h) . $winall_h . $slotSettings->GetGameData('BeautyFairyAMDoubleAnswer') . implode('', $slotSettings->GetGameData($slotSettings->slotId . 'Cards'));
                            $slotSettings->SetGameData('BeautyFairyAMDoubleWin', $winall);
                            $slotSettings->SetGameData('BeautyFairyAMTotalWin', $winall);
                            $balanceFormated = $slotSettings->HexFormat(round($slotSettings->GetBalance() * $floatBet));
                            $response_collect = '104010' . $balanceFormated . strlen($winall_h) . $winall_h . $slotSettings->GetGameData('BeautyFairyAMCollectP0');
                            $slotSettings->SetGameData('BeautyFairyAMCollect', $response_collect);
                        ...
                        case 'A/u258':
                            ...
                            $slotSettings->SetGameData('BeautyFairyAMDoubleBalance', $rtnBalance);
                            $winall = sprintf('%01.2f', $winall) * $floatBet;
                            $winall_h1 = str_replace('.', '', $winall . '');
                            $winall_h = dechex($winall_h1);
                            $doubleCards = '26280b2714161d0c';
                            $response = '108010' . $slotSettings->GetGameData('BeautyFairyAMDoubleBalance') . strlen($winall_h) . $winall_h . $slotSettings->GetGameData('BeautyFairyAMDoubleAnswer') . implode('', $slotSettings->GetGameData($slotSettings->slotId . 'Cards'));
                            break;
                    }
