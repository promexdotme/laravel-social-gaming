            ...
            function get_($request, $game)
            {
                \DB::transaction(function() use ($request, $game)
                {
                    try
                    {
                        ...
                        if( $postData['command'] == 'bet' && $postData['bet']['gameCommand'] == 'choice' ) 
                        {
                            $postData['command'] = 'choice';
                        }
                        ...
                        switch( $aid ) 
                        {
                            ...
                            case 'settings':
                                ...
                                $result_tmp[] = '{"complex":{"balance":' . $balanceInCents . ',"balanceRaw":' . round($balanceInCents * $slotSettings->CurrentDenom) . ',"paytableCoef":{"0":{"coef":[5,10,30],"multiplier":1},"1":{"coef":[5,20,50],"multiplier":1},"2":{"coef":[5,20,80],"multiplier":1},"3":{"coef":[5,25,100],"multiplier":1},"4":{"coef":[10,25,150],"multiplier":1},"5":{"coef":[10,50,200],"multiplier":1},"6":{"coef":[10,50,250],"multiplier":1},"7":{"coef":[2,25,50,400],"multiplier":1},"8":{"coef":[2,30,75,500],"multiplier":1},"9":{"coef":[5,50,200,1000],"multiplier":1},"10":{"coef":[5],"multiplier":1}},"bets":[' . implode(',', $gameBets) . '],"freespinFakeReels":[[1,3,0,0,5,4,3,3,3,4,1,4,2,5,0,3,3,0,3,1,6,2,5,5,4,2,5,4,2,5],[4,3,2,8,4,3,2,3,7,2,8,3,7,2,2,4,4,3,4,0,0,3,6,8,0,3,6,4,0,0],[1,5,0,8,1,5,0,2,6,1,8,2,6,1,7,3,1,8,7,3,1,2,6,4,1,1,1,5,0,6],[6,4,2,5,1,3,6,4,8,3,6,4,7,1,5,7,1,5,2,7,5,0,3,2,0,3,7,2,1,4],[7,2,6,0,0,0,7,3,0,6,6,6,2,7,1,6,0,0,0,3,6,0,2,6,1,7,2,3,6,0]],"jackpotMinBet":1,"jackpot":true,"mainFakeReels":[[5,2,4,10,0,9,1,1,7,2,3,0,4,1,2,4,0,5,3,2,10,6,9,4,0,2,2,4,10,3],[4,2,3,4,9,4,0,6,3,1,1,1,1,3,5,8,1,3,5,2,1,6,8,2,1,6,4,2,5,3],[10,6,9,5,1,1,5,7,3,2,8,7,3,2,5,10,0,4,6,8,0,4,6,1,6,0,10,0,5,2],[4,5,2,7,1,1,3,3,8,6,5,0,0,3,4,1,6,2,7,3,0,0,9,5,4,1,6,6,3,5],[5,2,6,4,10,3,1,7,1,7,2,0,4,2,4,10,6,3,3,2,1,6,2,4,0,10,9,2,4,1]],"jackpotMaxBet":100000,"denominations":[' . implode(',', $denoms) . ']},"gameIdentificationNumber":' . $postData['gameIdentificationNumber'] . ',"gameNumber":-1,"sessionKey":"41be9e65e0ff03a65e8c93576bf61130","msg":"success","messageId":"' . $postData['messageId'] . '","qName":"app.services.messages.response.GameResponse","command":"settings","eventTimestamp":' . time() . '}';
                                break;
                            case 'subscribe':
                                $hist = [
                                    78, 
                                ...
                                shuffle($hist);
                                $slotSettings->SetGameData('DragonSpiritEGTCards', $hist);
                                $lastEvent = $slotSettings->GetHistory();
                                $slotSettings->SetGameData('DragonSpiritEGTBonusWin', 0);
                                $slotSettings->SetGameData('DragonSpiritEGTFreeGames', 0);
                                $slotSettings->SetGameData('DragonSpiritEGTCurrentFreeGame', 0);
                                $slotSettings->SetGameData('DragonSpiritEGTTotalWin', 0);
                                $slotSettings->SetGameData('DragonSpiritEGTFreeBalance', 0);
                                $slotSettings->SetGameData($slotSettings->slotId . 'FreeHolds', []);
                                if( $lastEvent != 'NULL' ) 
                                {
                                    ...
                                    $slotSettings->SetGameData($slotSettings->slotId . 'BetLine', $lastEvent->serverResponse->slotBet);
                                    $slotSettings->SetGameData('DragonSpiritEGTCurrentSeq', $lastEvent->serverResponse->curSeq);
                                    $slotSettings->SetGameData('DragonSpiritEGTBankReserved', $lastEvent->serverResponse->BankReserved);
                                    ...
                                    $gtype = 1;
                                    if( $slotSettings->GetGameData('DragonSpiritEGTCurrentFreeGame') < $slotSettings->GetGameData('DragonSpiritEGTFreeGames') && $slotSettings->GetGameData('DragonSpiritEGTFreeGames') > 0 ) 
                                    {
                                        $slotSettings->SetGameData($slotSettings->slotId . 'FreeHolds', $lastEvent->serverResponse->FreeHolds);
                                        $gtype = 2;
                                    }
                                }
                                else
                                ...
                                {
                                    $state_ = 'freespin';
                                    if( $slotSettings->GetGameData('DragonSpiritEGTCurrentFreeGame') == 0 ) 
                                    {
                                        $state_ = 'choice';
                                    }
                                }
                            ...
                            case 'ping':
                                ...
                                break;
                            case 'choice':
                                if( $slotSettings->GetGameData('DragonSpiritEGTBankReserved') > 0 ) 
                                {
                                    $slotSettings->SetBank('bonus', $slotSettings->GetGameData('DragonSpiritEGTBankReserved'));
                                    $slotSettings->SetGameData('DragonSpiritEGTBankReserved', 0);
                                }
                                else
                                {
                                ...
                                if( $postData['bet']['choice'] == 0 ) 
                                {
                                    $slotSettings->slotFreeCount = 5;
                                    $holds = [
                                        0, 
                                        2, 
                                        4
                                ...
                                else if( $postData['bet']['choice'] == 1 ) 
                                {
                                    $slotSettings->slotFreeCount = 10;
                                    $holds = [
                                        1, 
                                        3
                                    ];
                                }
                                else if( $postData['bet']['choice'] == 2 ) 
                                {
                                    $holds = [2];
                                    $slotSettings->slotFreeCount = 15;
                                }
                                $lines = $slotSettings->GetGameData('DragonSpiritEGTLines');
                                $betline = $slotSettings->GetGameData('DragonSpiritEGTBetLine');
                                $slotSettings->SetGameData('DragonSpiritEGTFreeGames', $slotSettings->slotFreeCount);
                                $slotSettings->SetGameData('DragonSpiritEGTFreeHolds', $holds);
                                $curSeq = [];
                                $curSeqWin = 0;
                                $winLimitBonus = [
                                    500, 
                                ...
                                if( $wlb != 'NULL' ) 
                                {
                                    $presetData = json_decode(trim(file_get_contents(dirname(__FILE__) . '/presets/select_' . ($postData['bet']['choice'] + 1) . '/p_' . $wlb . '/preset_' . $lines . '.json')), true);
                                    $curSeq = $presetData[rand(0, count($presetData) - 1)];
                                    $curSeqWin = $curSeq['allWin'] * $betline;
                                    $slotSettings->SetGameData('DragonSpiritEGTCurrentSeq', $curSeq);
                                }
                                if( $curSeqWin > 0 ) 
                                {
                                    $slotSettings->SetBank('bonus', -1 * $curSeqWin);
                                }
                                $result_tmp[] = '{"complex":{"freespins":' . $slotSettings->slotFreeCount . ',"holdReels":[' . implode(',', $holds) . '],"gameCommand":"choice"},"state":"freespin","winAmount":' . ($slotSettings->GetGameData('DragonSpiritEGTBonusWin') * 100) . ',"gameIdentificationNumber":' . $postData['gameIdentificationNumber'] . ',"gameNumber":1786410455191,"sessionKey":"f5774618bc882d98fdf578c1ade432b4","msg":"success","messageId":"' . $postData['messageId'] . '","qName":"app.services.messages.response.GameEventResponse","command":"bet","eventTimestamp":' . time() . '}';
                                break;
                            case 'bet':
                                $linesId = [];
                                $linesId[0] = [
                                ...
                                if( $postData['slotEvent'] != 'freespin' ) 
                                {
                                    ...
                                    $slotSettings->SetGameData('DragonSpiritEGTCurrentFreeGame', 0);
                                    $slotSettings->SetGameData('DragonSpiritEGTTotalWin', 0);
                                    $slotSettings->SetGameData('DragonSpiritEGTFreeBalance', sprintf('%01.2f', $slotSettings->GetBalance()) * 100);
                                    $slotSettings->SetGameData('DragonSpiritEGTFreeHolds', []);
                                    $slotSettings->SetGameData('DragonSpiritEGTLines', $lines);
                                    $slotSettings->SetGameData('DragonSpiritEGTBetLine', $betline);
                                    $slotSettings->SetGameData('DragonSpiritEGTBankReserved', 0);
                                    $bonusMpl = 1;
                                }
                                else
                                {
                                    $slotSettings->SetGameData('DragonSpiritEGTCurrentFreeGame', $slotSettings->GetGameData('DragonSpiritEGTCurrentFreeGame') + 1);
                                    $bonusMpl = $slotSettings->slotFreeMpl;
                                }
                                $winTypeTmp = $slotSettings->GetSpinSettings($postData['slotEvent'], $allbet, $lines);
                                $winType = $winTypeTmp[0];
                                $spinWinLimit = $winTypeTmp[1];
                                if( $winType == 'bonus' && $spinWinLimit < ($allbet * 5 + ($betline * 500)) ) 
                                {
                                    $winType = 'none';
                                }
                                ...
                                for( $i = 0; $i <= 2000; $i++ ) 
                                {
                                    ...
                                    if( $postData['slotEvent'] == 'freespin' ) 
                                    {
                                        $curSeq = (array)$slotSettings->GetGameData('DragonSpiritEGTCurrentSeq');
                                        $curSeq['result'] = (array)$curSeq['result'];
                                        $curSeq['result'][$slotSettings->GetGameData('DragonSpiritEGTCurrentFreeGame') - 1] = (array)$curSeq['result'][$slotSettings->GetGameData('DragonSpiritEGTCurrentFreeGame') - 1];
                                        $curSeq['result'][$slotSettings->GetGameData('DragonSpiritEGTCurrentFreeGame') - 1]['reels'] = (array)$curSeq['result'][$slotSettings->GetGameData('DragonSpiritEGTCurrentFreeGame') - 1]['reels'];
                                        $reels = $curSeq['result'][$slotSettings->GetGameData('DragonSpiritEGTCurrentFreeGame') - 1]['reels'];
                                    }
                                    $holds = $slotSettings->GetGameData('DragonSpiritEGTFreeHolds');
                                    if( $postData['slotEvent'] == 'freespin' ) 
                                    {
                                        for( $r = 0; $r < 5; $r++ ) 
                                        {
                                    ...
                                    for( $r = 1; $r <= 5; $r++ ) 
                                    {
                                        for( $p = 0; $p <= 2; $p++ ) 
                                        {
                                            if( $reels['reel' . $r][$p] == '9' && !in_array($r - 1, $holds) ) 
                                            {
                                                $wlPos[] = '' . ($r - 1) . ',' . $p . '';
                                                break;
                                            }
                                ...
                                if( $postData['slotEvent'] == 'freespin' ) 
                                {
                                    $slotSettings->SetGameData('DragonSpiritEGTBonusWin', $slotSettings->GetGameData('DragonSpiritEGTBonusWin') + $totalWin);
                                    $slotSettings->SetGameData('DragonSpiritEGTTotalWin', $slotSettings->GetGameData('DragonSpiritEGTTotalWin') + $totalWin);
                                    $balanceInCents = $slotSettings->GetGameData('DragonSpiritEGTFreeBalance');
                                }
                                else
                                {
                                    $slotSettings->SetGameData('DragonSpiritEGTTotalWin', $totalWin);
                                }
                                $fs = 0;
                                if( $scattersCount >= 3 ) 
                                {
                                    if( $slotSettings->GetGameData('DragonSpiritEGTFreeGames') > 0 ) 
                                    {
                                        $slotSettings->SetGameData('DragonSpiritEGTFreeGames', $slotSettings->GetGameData('DragonSpiritEGTFreeGames') + $slotSettings->slotFreeCount);
                                    }
                                    else
                                    {
                                        $slotSettings->SetBank((isset($postData['slotEvent']) ? $postData['slotEvent'] : ''), -1 * ($betline * 500));
                                        $slotSettings->SetGameData('DragonSpiritEGTBankReserved', $betline * 500);
                                        $slotSettings->SetGameData('DragonSpiritEGTFreeHolds', [2]);
                                        $slotSettings->SetGameData('DragonSpiritEGTFreeStartWin', $totalWin);
                                        $slotSettings->SetGameData('DragonSpiritEGTBonusWin', $totalWin);
                                        $slotSettings->SetGameData('DragonSpiritEGTFreeGames', $slotSettings->slotFreeCount);
                                    }
                                    $fs = $slotSettings->GetGameData('DragonSpiritEGTFreeGames');
                                }
                                $winString = implode(',', $lineWins);
                                $jsSpin = '' . json_encode($reels) . '';
                                $jsJack = '' . json_encode($slotSettings->Jackpots) . '';
                                $response = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{"BankReserved":' . $slotSettings->GetGameData('DragonSpiritEGTBankReserved') . ',"curSeq":' . json_encode($curSeq) . ',"FreeHolds":[' . implode(',', $slotSettings->GetGameData('DragonSpiritEGTFreeHolds')) . '],"slotLines":' . $lines . ',"slotBet":' . $betline . ',"totalFreeGames":' . $slotSettings->GetGameData('DragonSpiritEGTFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('DragonSpiritEGTCurrentFreeGame') . ',"Balance":' . $balanceInCents . ',"afterBalance":' . $balanceInCents . ',"bonusWin":' . $slotSettings->GetGameData('DragonSpiritEGTBonusWin') . ',"totalWin":' . $totalWin . ',"winLines":[' . $winString . '],"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
                                $slotSettings->SaveLogReport($response, $allbet, $lines, $reportWin, $postData['slotEvent']);
                                $winstring = '';
                                $slotSettings->SetGameData('DragonSpiritEGTGambleStep', 5);
                                $hist = $slotSettings->GetGameData('DragonSpiritEGTCards');
                                $curReels = '' . rand(0, 6) . ',' . $reels['reel1'][0] . ',' . $reels['reel1'][1] . ',' . $reels['reel1'][2] . ',' . rand(0, 6);
                                $curReels .= (',' . rand(0, 6) . ',' . $reels['reel2'][0] . ',' . $reels['reel2'][1] . ',' . $reels['reel2'][2] . ',' . rand(0, 6));
                                $curReels .= (',' . rand(0, 6) . ',' . $reels['reel3'][0] . ',' . $reels['reel3'][1] . ',' . $reels['reel3'][2] . ',' . rand(0, 6));
                                $curReels .= (',' . rand(0, 6) . ',' . $reels['reel4'][0] . ',' . $reels['reel4'][1] . ',' . $reels['reel4'][2] . ',' . rand(0, 6));
                                ...
                                if( $jackRandom == 1 ) 
                                {
                                    $state = 'jackpot';
                                    $isJack = 'true';
                                    $slotSettings->SetGameData('DragonSpiritEGTJackSteps', [
                                        0, 
                                        0, 
                                        0, 
                                        0
                                ...
                                if( $postData['slotEvent'] == 'freespin' ) 
                                {
                                    $totalWin = $slotSettings->GetGameData('DragonSpiritEGTBonusWin');
                                    $state = 'freespin';
                                ...
                                $result_tmp[] = '{"complex":{"gambles":5,"reels":[' . $curReels . '],"holdReels":[' . implode(',', $holds) . '],"lines":[' . $winString . '],"scatters":[' . $scattersStr . '],"freespinScatters":[' . $scatter . '],"expand":[' . implode(',', $wldPos) . '],"specialExpand":[],"gambles":5,"freespins":' . $fs . ',"jackpot":' . $isJack . ',"gameCommand":"bet"},"state":"' . $state . '","winAmount":' . ($totalWin * 100) . ',"gameIdentificationNumber":' . $postData['gameIdentificationNumber'] . ',"gameNumber":"","balance":' . $balanceInCents . ',"sessionKey":"41be9e65e0ff03a65e8c93576bf61130","msg":"success","messageId":"' . $postData['messageId'] . '","qName":"app.services.messages.response.GameEventResponse","command":"bet","eventTimestamp":' . time() . '}';
                                ...
                                break;
                            case 'collect':
                                $result_tmp[] = '{"complex":{"gameCommand":"collect"},"state":"idle","winAmount":' . ($slotSettings->GetGameData('DragonSpiritEGTTotalWin') * 100) . ',"gameIdentificationNumber":' . $postData['gameIdentificationNumber'] . ',"gameNumber":"","balance":' . $balanceInCents . ',"sessionKey":"41be9e65e0ff03a65e8c93576bf61130","msg":"success","messageId":"' . $postData['messageId'] . '","qName":"app.services.messages.response.GameEventResponse","command":"bet","eventTimestamp":' . time() . '}';
                                $slotSettings->SetGameData('DragonSpiritEGTTotalWin', 0);
                                break;
                            case 'jackpot':
                                $jackStep = $slotSettings->GetGameData('DragonSpiritEGTJackSteps');
                                $jackWinID = $slotSettings->GetGameData($slotSettings->slotId . 'JackWinID');
                                if( $jackStep[0] >= 3 || $jackStep[1] >= 3 || $jackStep[2] >= 3 || $jackStep[3] >= 3 || !$slotSettings->HasGameData('DragonSpiritEGTJackSteps') ) 
                                {
                                    exit();
                                }
                                $winAmount = 0;
                                ...
                                $slotSettings->SetGameData('DragonSpiritEGTJackSteps', $jackStep);
                                break;
                            case 'gamble':
                                $Balance = $slotSettings->GetBalance();
                                $isGambleWin = rand(1, $slotSettings->GetGambleSettings());
                                $dealerCard = '';
                                $totalWin = $slotSettings->GetGameData('DragonSpiritEGTTotalWin');
                                $gambleWin = 0;
                                $statBet = $totalWin;
                                $slotSettings->SetGameData('DragonSpiritEGTGambleStep', $slotSettings->GetGameData('DragonSpiritEGTGambleStep') - 1);
                                ...
                                else
                                {
                                    ...
                                    $totalWin = 0;
                                    $slotSettings->SetGameData('DragonSpiritEGTGambleStep', 0);
                                    if( $postData['bet']['color'] == '1' ) 
                                    {
                                        $tmpCards = [
                                            '1', 
                                ...
                                $gtype = 1;
                                $gtype0 = 1;
                                if( $slotSettings->GetGameData('DragonSpiritEGTBonusStart') == 1 ) 
                                {
                                    $gtype0 = 2;
                                }
                                $result_tmp[] = '{"complex":{"gambles":' . $slotSettings->GetGameData('DragonSpiritEGTGambleStep') . ',"card":' . $dealerCard . ',"jackpot":false,"gameCommand":"gamble"},"state":"' . $gambleState . '","winAmount":' . ($totalWin * 100) . ',"gameIdentificationNumber":' . $postData['gameIdentificationNumber'] . ',"gameNumber":"","sessionKey":"88e2b82e6537db4a339e4e1b5ce462cd","msg":"success","messageId":"' . $postData['messageId'] . '","qName":"app.services.messages.response.GameEventResponse","command":"bet","eventTimestamp":' . time() . '}';
                                break;
                        }
