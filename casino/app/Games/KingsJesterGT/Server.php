                ...
                \DB::transaction(function() use ($request, $game)
                {
                    try
                    {
                        ...
                        else if( $postData['slotEvent'] == 'gamble5GetUserCards' ) 
                        {
                            ...
                            $dealerCard = $slotSettings->GetGameData('KingsJesterGTDealerCard');
                            $totalWin = $slotSettings->GetGameData('KingsJesterGTTotalWin');
                            $gambleWin = 0;
                            ...
                            $slotSettings->SetGameData('KingsJesterGTTotalWin', $totalWin);
                        ...
                        else if( $postData['slotEvent'] == 'gamble5GetDealerCard' ) 
                        {
                            ...
                            $slotSettings->SetGameData('KingsJesterGTDealerCard', $tmpDc);
                        ...
                        else if( $postData['slotEvent'] == 'bet' || $postData['slotEvent'] == 'freespin' ) 
                        {
                            ...
                            if( $postData['slotEvent'] != 'freespin' ) 
                            {
                                ...
                                $bonusMpl = 1;
                                $slotSettings->SetGameData('KingsJesterGTBonusWin', 0);
                                $slotSettings->SetGameData('KingsJesterGTFreeGames', 0);
                                $slotSettings->SetGameData('KingsJesterGTCurrentFreeGame', 0);
                                $slotSettings->SetGameData('KingsJesterGTTotalWin', 0);
                                $slotSettings->SetGameData('KingsJesterGTFreeBalance', 0);
                            }
                            else
                            {
                                $slotSettings->SetGameData('KingsJesterGTCurrentFreeGame', $slotSettings->GetGameData('KingsJesterGTCurrentFreeGame') + 1);
                            ...
                            for( $i = 0; $i <= 2000; $i++ ) 
                            {
                                ...
                                if( isset($jackState) && $jackState['isJackPay'] ) 
                                {
                                    ...
                                    for( $jl = 1; $jl <= 5; $jl++ ) 
                                    {
                                        ...
                                        {
                                            $jreel = $slotSettings->PutBonusToLine($jl, $linesId[$rline][$jl - 1], 'P_2');
                                            $reels['reel' . $jl] = [
                                                'P_2', 
                                                'P_2', 
                                                'P_2', 
                                ...
                                for( $k = 0; $k < $postData['slotLines']; $k++ ) 
                                {
                                    ...
                                    for( $j = 0; $j < count($slotSettings->SymbolGame); $j++ ) 
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            if( $s[0] == $csym || in_array($s[0], $wild) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":1,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('KingsJesterGTBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":["none","none"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) ) 
                                            {
                                                ...
                                                else if( in_array($s[0], $wildMpl) || in_array($s[1], $wildMpl) ) 
                                                {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":2,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('KingsJesterGTBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            $s[0] = $reels['reel1'][$linesId[$k][0] - 1];
                                            $s[1] = $reels['reel2'][$linesId[$k][1] - 1];
                                            ...
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) ) 
                                            {
                                                ...
                                                else if( in_array($s[0], $wildMpl) || in_array($s[1], $wildMpl) || in_array($s[2], $wildMpl) ) 
                                                {
                                                    $mpl = $slotSettings->slotWildMpl;
                                                }
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":3,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('KingsJesterGTBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            $s[0] = $reels['reel1'][$linesId[$k][0] - 1];
                                            $s[1] = $reels['reel2'][$linesId[$k][1] - 1];
                                            ...
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) && ($s[3] == $csym || in_array($s[3], $wild)) ) 
                                            {
                                                ...
                                                else if( in_array($s[0], $wildMpl) || in_array($s[1], $wildMpl) || in_array($s[2], $wildMpl) || in_array($s[3], $wildMpl) ) 
                                                {
                                                    $mpl = $slotSettings->slotWildMpl;
                                                }
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":4,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('KingsJesterGTBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            $s[0] = $reels['reel1'][$linesId[$k][0] - 1];
                                            $s[1] = $reels['reel2'][$linesId[$k][1] - 1];
                                            ...
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) && ($s[3] == $csym || in_array($s[3], $wild)) && ($s[4] == $csym || in_array($s[4], $wild)) ) 
                                            {
                                                ...
                                                else if( in_array($s[0], $wildMpl) || in_array($s[1], $wildMpl) || in_array($s[2], $wildMpl) || in_array($s[3], $wildMpl) || in_array($s[4], $wildMpl) ) 
                                                {
                                                    $mpl = $slotSettings->slotWildMpl;
                                                }
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":5,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('KingsJesterGTBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":[' . ($linesId[$k][4] - 1) . ',"' . $s[4] . '"]}';
                                                }
                                                if( $s[0] == 'P_1' && $s[1] == 'P_1' && $s[2] == 'P_1' && $s[3] == 'P_1' && $s[4] == 'P_1' ) 
                                                {
                                                    $isSlotJack = true;
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '';
                                                }
                                                else if( $s[0] == 'P_2' && $s[1] == 'P_2' && $s[2] == 'P_2' && $s[3] == 'P_2' && $s[4] == 'P_2' ) 
                                                {
                                                    $isSlotJack0 = true;
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '';
                                    ...
                                    if( $cWins[$k] > 0 && $tmpStringWin != '' && !$isSlotJack0 && !$isSlotJack ) 
                                    {
                            ...
                            if( $postData['slotEvent'] == 'freespin' && $slotSettings->GetGameData('KingsJesterGTFreeGames') <= $slotSettings->GetGameData('KingsJesterGTCurrentFreeGame') && $winType != 'bonus' && $slotSettings->GetGameData('KingsJesterGTTotalWin') + $totalWin > 0 ) 
                            {
                                $slotSettings->SetBalance($slotSettings->GetGameData('KingsJesterGTTotalWin') + $totalWin);
                            }
                            ...
                            if( $postData['slotEvent'] == 'freespin' ) 
                            {
                                $slotSettings->SetGameData('KingsJesterGTBonusWin', $slotSettings->GetGameData('KingsJesterGTBonusWin') + $totalWin);
                                $slotSettings->SetGameData('KingsJesterGTTotalWin', $slotSettings->GetGameData('KingsJesterGTTotalWin') + $totalWin);
                                $totalWin = $slotSettings->GetGameData('KingsJesterGTBonusWin');
                                $Balance = $slotSettings->GetGameData('KingsJesterGTFreeBalance');
                            }
                            else
                            {
                                $slotSettings->SetGameData('KingsJesterGTTotalWin', $totalWin);
                            ...
                            if( $scattersCount >= 3 ) 
                            {
                                if( $slotSettings->GetGameData('KingsJesterGTFreeGames') > 0 ) 
                                {
                                    $slotSettings->SetGameData('KingsJesterGTFreeBalance', $Balance);
                                    $slotSettings->SetGameData('KingsJesterGTBonusWin', $totalWin);
                                    $slotSettings->SetGameData('KingsJesterGTFreeGames', $slotSettings->GetGameData('KingsJesterGTFreeGames') + $slotSettings->slotFreeCount);
                                }
                                else
                                {
                                    $slotSettings->SetGameData('KingsJesterGTFreeBalance', $Balance);
                                    $slotSettings->SetGameData('KingsJesterGTBonusWin', $totalWin);
                                    $slotSettings->SetGameData('KingsJesterGTFreeGames', $slotSettings->slotFreeCount);
                                }
                            }
                            $jsSpin = '' . json_encode($reels) . '';
                            $jsJack = '' . json_encode($slotSettings->Jackpots) . '';
                            $winString = implode(',', $lineWins);
                            $response = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{"slotLines":' . $postData['slotLines'] . ',"slotBet":' . $postData['slotBet'] . ',"slotJackpot0":' . $slotSettings->slotJackpot[0] . ',"slotJackpot":' . $slotSettings->slotJackpot[1] . ',"totalFreeGames":' . $slotSettings->GetGameData('KingsJesterGTFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('KingsJesterGTCurrentFreeGame') . ',"Balance":' . $Balance . ',"afterBalance":' . $slotSettings->GetBalance() . ',"totalWin":' . $totalWin . ',"winLines":[' . $winString . '],"bonusInfo":' . $scattersStr . ',"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
