                    ...
                    try
                    {
                        ...
                        switch( $aid ) 
                        {
                            ...
                            case 'spin':
                                ...
                                {
                                    $acb = 2;
                                    $pickBonusData = ',"bpd":{"c":false,"s":false,"lt":0,"np":5,"msb":5,"w":0,"lpw":0,"nfw":0,"m":5,"mk":0,"m2":5,"m3":0,"csw":0}';
                                    $PickBonusWins = [
                                        1, 
                                        1, 
                                        1, 
                                    ...
                                    $PickBonusResult[] = $PickBonusWins[1] * 100;
                                    $PickBonusResult[] = $PickBonusWins[2] * 100;
                                    $PickBonusResult[] = $PickBonusWins[3] * 100;
                                    $PickBonusResult[] = $PickBonusWins[4] * 100;
                                    $PickBonusResult[] = $PickBonusWins[5] * 100;
                                    $PickBonusResult[] = $PickBonusWins[6] * 100;
                                    $PickBonusResult[] = $PickBonusWins[7] * 100;
                                    $PickBonusResult[] = $PickBonusWins[8] * 100;
                                    $PickBonusResult[] = $PickBonusWins[9] * 100;
                                    $PickBonusResult[] = $PickBonusWins[10] * 100;
                                    $PickBonusResult[] = $PickBonusWins[11] * 100;
                                    $PickBonusResult[] = $PickBonusWins[12] * 100;
                                    $PickBonusResult[] = $PickBonusWins[13] * 100;
                                    $PickBonusResult[] = $PickBonusWins[14] * 100;
                                    $PickBonusResult[] = $PickBonusWins[15] * 100;
                                    $PickBonusResult[] = $PickBonusWins[16] * 100;
                                    $PickBonusResult[] = $PickBonusWins[17] * 100;
                                    $PickBonusResult[] = $PickBonusWins[18] * 100;
                                    $PickBonusResult[] = $PickBonusWins[19] * 100;
                                    $PickBonusResult[] = $PickBonusWins[20] * 100;
                                    $PickBonusResult[] = $PickBonusWins[21] * 100;
                                    $PickBonusResult[] = $PickBonusWins[22] * 100;
                                    $PickBonusResult[] = $PickBonusWins[23] * 100;
                                    $PickBonusResult[] = $PickBonusWins[24] * 100;
                                    $PickBonusResult[] = $PickBonusWins[25] * 100;
                                    $PickBonusResult[] = $PickBonusWins[26] * 100;
                                ...
                                $result_tmp[0] = '{"sid":' . rand(0, 9999999) . ',"md":{"sid":' . rand(0, 9999999) . ',"tid":"00408750593c46449187c018d2f7b5a9","sel":' . $lines . ',"cps":5,"dn":0.01,"nd":0.01,"ncps":0,"atb":0,"v":true,"fs":' . $fs_ . ',"twg":' . ($lines * $betline * 100) . ',"swm":' . $swm . ',"sw":' . ($scattersWin * 100) . ',"swu":' . $swu . ',"tw":' . ($totalWin * 100) . ',"fsw":' . $fs . ',"fsr":' . ($slotSettings->GetGameData($slotSettings->slotId . 'FreeGames') - $slotSettings->GetGameData($slotSettings->slotId . 'CurrentFreeGame')) . ',"tfw":' . ($slotSettings->GetGameData($slotSettings->slotId . 'BonusWin') * 100) . ',"st":[' . $curReels . '],"swi":[' . implode(',', $cWinsStr) . '],"snm":[' . implode(',', $cWinsMpl) . '],"ssm":[' . implode(',', $cWinsCount) . ']' . $pickBonusData . ',"sm":[0],"acb":' . $acb . ',"rf":0,"as":[{"asi":363025538,"st":[' . $curReels . '],"swm":' . $swm . ',"sw":' . ($scattersWin * 100) . ',"swu":' . $swu . ',"fsw":' . $fs . ',"tw":' . ($totalWin * 100) . '}],"sp":15,"cr":"USD","sessionId":"788b51c017be4bb5897966e791396635","rd":0,"pbb":' . $balanceInCents . ',"obb":' . $balanceInCents2 . ',"mb":false,"pwa":0,"pac":{}},"pcr":' . $balanceInCents . ',"cr":' . $balanceInCents2 . ',"xp":0,"lvl":{"lvl":1,"xp":0,"bc":0,"cps":5,"sc":200,"wb":0},"dl":0,"cps":[1,2,3,5,10,15,20,25,30,50,75,100,150,250,500],"e":false,"ec":0,"cc":"EN"}';
                            ...
                            case 'bonusPick':
                                ...
                                $PickAnswer['md']['bpd']['m2'] = $m2[$PickBonusCount];
