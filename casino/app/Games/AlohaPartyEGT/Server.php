                    ...
                    try
                    {
                        ...
                        switch( $aid ) 
                        {
                            ...
                            case 'settings':
                                ...
                                $result_tmp[] = '{"complex":{"balance":' . $balanceInCents . ',"balanceRaw":' . round($balanceInCents * $slotSettings->CurrentDenom) . ',"paytableCoef":{"0":{"coef":[5,20,100],"multiplier":1},"1":{"coef":[5,20,100],"multiplier":1},"2":{"coef":[5,20,100],"multiplier":1},"3":{"coef":[5,25,125],"multiplier":1},"4":{"coef":[5,25,125],"multiplier":1},"5":{"coef":[15,40,200],"multiplier":1},"6":{"coef":[20,50,250],"multiplier":1},"7":{"coef":[20,50,250],"multiplier":1},"8":{"coef":[5,25,75,300],"multiplier":1},"9":{"coef":[5,50,100,500],"multiplier":1},"11":{"coef":[5,20,50],"multiplier":1}},"bets":[' . implode(',', $gameBets) . '],"jackpotMinBet":1,"lines":[1,5,10,20,40],"jackpot":true,"mainFakeReels":[[4,1,7,0,3,5,6,2,0,3,4,1,0,3,4,2,9,5,1,3,7,0,4,11,6,0,2,1,8,0],[9,4,1,5,7,4,0,5,6,1,9,5,10,2,1,3,4,9,2,5,7,3,11,5,6,1,5,6,0,2],[6,7,3,7,6,11,4,7,3,6,4,7,3,9,0,7,11,6,0,9,2,4,1,3,5,8,2,1,5,8],[4,3,6,1,9,5,6,1,11,2,6,1,9,3,6,10,0,1,2,0,8,2,9,0,6,3,9,0,8,2],[9,0,5,6,1,7,0,6,5,8,1,6,5,1,2,0,1,4,8,0,9,4,2,3,9,4,8,0,7,3]],"jackpotMaxBet":100000,"denominations":[' . implode(',', $denoms) . ']},"gameIdentificationNumber":884,"gameNumber":-1,"sessionKey":"8b52d67d1eeb6ea75569a3fdb03c1071","msg":"success","messageId":"' . $postData['messageId'] . '","qName":"app.services.messages.response.GameResponse","command":"settings","eventTimestamp":' . time() . '}';
                                break;
                            case 'subscribe':
                                $hist = [
                                    78, 
                                ...
                                shuffle($hist);
                                $slotSettings->SetGameData('AlohaPartyEGTCards', $hist);
                                $lastEvent = $slotSettings->GetHistory();
                                $slotSettings->SetGameData('AlohaPartyEGTBonusWin', 0);
                                $slotSettings->SetGameData('AlohaPartyEGTFreeGames', 0);
                                $slotSettings->SetGameData('AlohaPartyEGTCurrentFreeGame', 0);
                                $slotSettings->SetGameData('AlohaPartyEGTTotalWin', 0);
                                $slotSettings->SetGameData('AlohaPartyEGTFreeBalance', 0);
                                if( $lastEvent != 'NULL' ) 
                                {
                                    ...
                                    $gtype = 1;
                                    if( $slotSettings->GetGameData('AlohaPartyEGTCurrentFreeGame') < $slotSettings->GetGameData('AlohaPartyEGTFreeGames') && $slotSettings->GetGameData('AlohaPartyEGTFreeGames') > 0 ) 
                                    {
                                        $gtype = 2;
                                    }
                                }
                                ...
                                {
                                    $gtype = 1;
                                    $curReels = '' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . '';
                                    $lines = 10;
                            ...
                            case 'bet':
                                ...
                                if( $postData['slotEvent'] != 'freespin' ) 
                                {
                                    ...
                                    $slotSettings->SetGameData('AlohaPartyEGTCurrentFreeGame', 0);
                                    $slotSettings->SetGameData('AlohaPartyEGTTotalWin', 0);
                                    $slotSettings->SetGameData('AlohaPartyEGTFreeBalance', sprintf('%01.2f', $slotSettings->GetBalance()) * 100);
                                    $bonusMpl = 1;
                                }
                                else
                                {
                                    $slotSettings->SetGameData('AlohaPartyEGTCurrentFreeGame', $slotSettings->GetGameData('AlohaPartyEGTCurrentFreeGame') + 1);
                                    ...
                                    for( $j = 0; $j < count($slotSettings->SymbolGame); $j++ ) 
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            if( $wsym[0] > 0 && $wsym[1] > 0 ) 
                                            {
                                                ...
                                                $tWin = $slotSettings->Paytable['SYM_' . $csym][2] * $betline * $sMpl * $wildsymmpl;
                                                $tWin0 = $slotSettings->Paytable['SYM_' . $csym][2] * $betline;
                                                if( $cWin < $tWin ) 
                                                {
                                                    $cWin = $tWin;
                                                    $tmpStringWin = '{"card":' . $csym . ',"len":2,"count":' . $sMpl . ',"winPerCount":' . ($tWin0 * 100) . ',"multiplier":' . $wildsymmpl . ',"winAmount":' . round($cWin / ($sMpl * $wildsymmpl) * 100) . ',"cells":[' . implode(',', $cells) . ']}';
                                                }
                                            }
                                            if( $wsym[0] > 0 && $wsym[1] > 0 && $wsym[2] > 0 ) 
                                            {
                                                ...
                                                {
                                                    $cWin = $tWin;
                                                    $tmpStringWin = '{"card":' . $csym . ',"len":3,"count":' . $sMpl . ',"winPerCount":' . ($tWin0 * 100) . ',"multiplier":' . $wildsymmpl . ',"winAmount":' . round($cWin / ($sMpl * $wildsymmpl) * 100) . ',"cells":[' . implode(',', $cells) . ']}';
                                                }
                                            }
                                            if( $wsym[0] > 0 && $wsym[1] > 0 && $wsym[2] > 0 && $wsym[3] > 0 ) 
                                            {
                                                ...
                                                {
                                                    $cWin = $tWin;
                                                    $tmpStringWin = '{"card":' . $csym . ',"len":4,"count":' . $sMpl . ',"winPerCount":' . ($tWin0 * 100) . ',"multiplier":' . $wildsymmpl . ',"winAmount":' . round($cWin / ($sMpl * $wildsymmpl) * 100) . ',"cells":[' . implode(',', $cells) . ']}';
                                                }
                                            }
                                            if( $wsym[0] > 0 && $wsym[1] > 0 && $wsym[2] > 0 && $wsym[3] > 0 && $wsym[4] > 0 ) 
                                            {
                                                ...
                                                {
                                                    $cWin = $tWin;
                                                    $tmpStringWin = '{"card":' . $csym . ',"len":5,"count":' . $sMpl . ',"winPerCount":' . ($tWin0 * 100) . ',"multiplier":' . $wildsymmpl . ',"winAmount":' . round($cWin / ($sMpl * $wildsymmpl) * 100) . ',"cells":[' . implode(',', $cells) . ']}';
                                                }
                                            }
                                            $totalWin += $cWin;
                                            $cWins[$j] = $cWin;
                                ...
                                if( $postData['slotEvent'] == 'freespin' ) 
                                {
                                    $slotSettings->SetGameData('AlohaPartyEGTBonusWin', $slotSettings->GetGameData('AlohaPartyEGTBonusWin') + $totalWin);
                                    $slotSettings->SetGameData('AlohaPartyEGTTotalWin', $slotSettings->GetGameData('AlohaPartyEGTTotalWin') + $totalWin);
                                    $balanceInCents = $slotSettings->GetGameData('AlohaPartyEGTFreeBalance');
                                }
                                else
                                {
                                    $slotSettings->SetGameData('AlohaPartyEGTTotalWin', $totalWin);
                                }
                                $fs = 0;
                                if( $scattersCount >= 3 ) 
                                {
                                    if( $slotSettings->GetGameData('AlohaPartyEGTFreeGames') > 0 ) 
                                    {
                                        $slotSettings->SetGameData('AlohaPartyEGTFreeGames', $slotSettings->GetGameData('AlohaPartyEGTFreeGames') + $slotSettings->slotFreeCount);
                                    }
                                    else
                                    {
                                        $slotSettings->SetGameData('AlohaPartyEGTFreeStartWin', $totalWin);
                                        $slotSettings->SetGameData('AlohaPartyEGTBonusWin', $totalWin);
                                        $slotSettings->SetGameData('AlohaPartyEGTFreeGames', $slotSettings->slotFreeCount);
                                    }
                                    $fs = $slotSettings->GetGameData('AlohaPartyEGTFreeGames');
                                }
                                $curReels = '' . rand(0, 6) . ',' . $reels['reel1'][0] . ',' . $reels['reel1'][1] . ',' . $reels['reel1'][2] . ',' . $reels['reel1'][3] . ',' . rand(0, 6);
                                $curReels .= (',' . rand(0, 6) . ',' . $reels['reel2'][0] . ',' . $reels['reel2'][1] . ',' . $reels['reel2'][2] . ',' . $reels['reel2'][3] . ',' . rand(0, 6));
                                $curReels .= (',' . rand(0, 6) . ',' . $reels['reel3'][0] . ',' . $reels['reel3'][1] . ',' . $reels['reel3'][2] . ',' . $reels['reel3'][3] . ',' . rand(0, 6));
                                ...
                                $response = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{"slotLines":' . $lines . '' . $lines . '' . $slotSettings->GetGameData($slotSettings->slotId . 'FirstSpin') . ',"slotBet":' . $betline . ',"totalFreeGames":' . $slotSettings->GetGameData('AlohaPartyEGTFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('AlohaPartyEGTCurrentFreeGame') . ',"Balance":' . $balanceInCents . ',"afterBalance":' . $balanceInCents . ',"bonusWin":' . $slotSettings->GetGameData('AlohaPartyEGTBonusWin') . ',"totalWin":' . $totalWin . ',"winLines":[' . $winString . '],"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
                                $slotSettings->SaveLogReport($response, $allbet, $lines, $reportWin, $postData['slotEvent']);
                                $winstring = '';
                                $slotSettings->SetGameData('AlohaPartyEGTGambleStep', 5);
                                $hist = $slotSettings->GetGameData('AlohaPartyEGTCards');
                                if( $jackRandom == 1 ) 
                                {
                                    $state = 'jackpot';
                                    $isJack = 'true';
                                    $slotSettings->SetGameData('AlohaPartyEGTJackSteps', [
                                        0, 
                                        0, 
                                        0, 
                                        0
                                ...
                                if( $postData['slotEvent'] == 'freespin' ) 
                                {
                                    $totalWin = $slotSettings->GetGameData('AlohaPartyEGTBonusWin');
                                    $state = 'freespin';
                                ...
                                break;
                            case 'collect':
                                $result_tmp[] = '{"complex":{"gameCommand":"collect"},"state":"idle","winAmount":' . ($slotSettings->GetGameData('AlohaPartyEGTTotalWin') * 100) . ',"gameIdentificationNumber":' . $postData['gameIdentificationNumber'] . ',"gameNumber":"","balance":' . $balanceInCents . ',"sessionKey":"41be9e65e0ff03a65e8c93576bf61130","msg":"success","messageId":"' . $postData['messageId'] . '","qName":"app.services.messages.response.GameEventResponse","command":"bet","eventTimestamp":' . time() . '}';
                                $slotSettings->SetGameData('AlohaPartyEGTTotalWin', 0);
                                break;
                            case 'jackpot':
                                $jackStep = $slotSettings->GetGameData('AlohaPartyEGTJackSteps');
                                $jackWinID = $slotSettings->GetGameData($slotSettings->slotId . 'JackWinID');
                                if( $jackStep[0] >= 3 || $jackStep[1] >= 3 || $jackStep[2] >= 3 || $jackStep[3] >= 3 || !$slotSettings->HasGameData('AlohaPartyEGTJackSteps') ) 
                                {
                                    exit();
                                }
                                $winAmount = 0;
                                ...
                                $slotSettings->SetGameData('AlohaPartyEGTJackSteps', $jackStep);
                                break;
                            case 'gamble':
                                $Balance = $slotSettings->GetBalance();
                                $isGambleWin = rand(1, $slotSettings->GetGambleSettings());
                                $dealerCard = '';
                                $totalWin = $slotSettings->GetGameData('AlohaPartyEGTTotalWin');
                                $gambleWin = 0;
                                $statBet = $totalWin;
                                $slotSettings->SetGameData('AlohaPartyEGTGambleStep', $slotSettings->GetGameData('AlohaPartyEGTGambleStep') - 1);
                                ...
                                else
                                {
                                    ...
                                    $totalWin = 0;
                                    $slotSettings->SetGameData('AlohaPartyEGTGambleStep', 0);
                                    if( $postData['bet']['color'] == '1' ) 
                                    {
                                        $tmpCards = [
                                            '1', 
                                ...
                                $gtype = 1;
                                $gtype0 = 1;
                                if( $slotSettings->GetGameData('AlohaPartyEGTBonusStart') == 1 ) 
                                {
                                    $gtype0 = 2;
                                }
                                $result_tmp[] = '{"complex":{"gambles":' . $slotSettings->GetGameData('AlohaPartyEGTGambleStep') . ',"card":' . $dealerCard . ',"jackpot":false,"gameCommand":"gamble"},"state":"' . $gambleState . '","winAmount":' . ($totalWin * 100) . ',"gameIdentificationNumber":' . $postData['gameIdentificationNumber'] . ',"gameNumber":"","sessionKey":"88e2b82e6537db4a339e4e1b5ce462cd","msg":"success","messageId":"' . $postData['messageId'] . '","qName":"app.services.messages.response.GameEventResponse","command":"bet","eventTimestamp":' . time() . '}';
                                break;
                        }
