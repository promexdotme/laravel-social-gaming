                    ...
                    try
                    {
                        ...
                        switch( $aid ) 
                        {
                            ...
                            case 'settings':
                                ...
                                $result_tmp[] = '{"complex":{"balance":' . $balanceInCents . ',"balanceRaw":' . round($balanceInCents * $slotSettings->CurrentDenom) . ',"paytableCoef":{"0":{"coef":[5,20,50,200],"multiplier":1},"1":{"coef":[20,50,200],"multiplier":1},"2":{"coef":[20,50,200],"multiplier":1},"3":{"coef":[20,50,200],"multiplier":1},"4":{"coef":[50,200,500],"multiplier":1},"5":{"coef":[50,200,500],"multiplier":1},"6":{"coef":[200,4000,20000],"multiplier":1},"7":{"coef":[2,10,50],"multiplier":1}},"bets":[' . implode(',', $gameBets) . '],"jackpotMinBet":1,"jackpot":true,"mainFakeReels":[[6,2,2,1,1,0,0,0,3,3,4,4,4,2,2,2,7,5,5,5],[4,4,6,0,0,0,3,3,3,1,1,7,4,4,2,2,2,5,5,5],[3,3,6,2,2,2,3,3,3,4,4,4,7,0,0,5,5,5,1,1],[6,5,5,3,3,3,7,5,5,4,4,4,1,1,1,2,2,0,0,0],[6,3,3,5,5,5,0,0,3,3,3,4,4,2,2,2,7,1,1,1]],"jackpotMaxBet":100000,"denominations":[' . implode(',', $denoms) . ']},"gameIdentificationNumber":544,"gameNumber":"","sessionKey":"219963e59e235e2dfcc566fad7ede54c","msg":"success","messageId":"' . $postData['messageId'] . '","qName":"app.services.messages.response.GameResponse","command":"settings","eventTimestamp":' . time() . '}';
                                break;
                            case 'subscribe':
                                $hist = [
                                    78, 
                                ...
                                shuffle($hist);
                                $slotSettings->SetGameData('DazzlingHot20EGTCards', $hist);
                                $lastEvent = $slotSettings->GetHistory();
                                $slotSettings->SetGameData('DazzlingHot20EGTBonusWin', 0);
                                $slotSettings->SetGameData('DazzlingHot20EGTFreeGames', 0);
                                $slotSettings->SetGameData('DazzlingHot20EGTCurrentFreeGame', 0);
                                $slotSettings->SetGameData('DazzlingHot20EGTTotalWin', 0);
                                $slotSettings->SetGameData('DazzlingHot20EGTFreeBalance', 0);
                                if( $lastEvent != 'NULL' ) 
                                {
                                    ...
                                    $gtype = 1;
                                    if( $slotSettings->GetGameData('DazzlingHot20EGTCurrentFreeGame') < $slotSettings->GetGameData('DazzlingHot20EGTFreeGames') && $slotSettings->GetGameData('DazzlingHot20EGTFreeGames') > 0 ) 
                                    {
                                        $gtype = 2;
                                    }
                                }
                                ...
                                {
                                    $gtype = 1;
                                    $curReels = '' . rand(0, 6) . ',' . rand(0, 8) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . ',' . rand(0, 6) . '';
                                    $lines = 10;
                                }
                                $result_tmp[] = '{"complex":{"currentState":{"gamblesUsed":0,"freespinsUsed":0,"previousGambles":[],"bet":100,"numberOfLines":20,"denomination":100,"state":"idle","winAmount":0,"reels":[' . $curReels . '],"lines":[],"scatters":[],"expand":[],"specialExpand":[],"gambles":5,"freespins":0,"jackpot":false},"jackpotState":{"levelI":' . ($slotSettings->slotJackpot[0] * 100) . ',"levelII":' . ($slotSettings->slotJackpot[1] * 100) . ',"levelIII":' . ($slotSettings->slotJackpot[2] * 100) . ',"levelIV":' . ($slotSettings->slotJackpot[3] * 100) . ',"winsLevelI":19185,"largestWinLevelI":12792000,"largestWinDateLevelI":"Jan 18, 2019 9:23:21 PM","largestWinUserLevelI":"player","lastWinLevelI":5438200,"lastWinDateLevelI":"Jul 24, 2019 7:07:32 AM","lastWinUserLevelI":"player","winsLevelII":9566,"largestWinLevelII":25566700,"largestWinDateLevelII":"Nov 30, 2018 10:28:39 AM","largestWinUserLevelII":"player","lastWinLevelII":2228600,"lastWinDateLevelII":"Jul 24, 2019 7:04:50 AM","lastWinUserLevelII":"player","winsLevelIII":2628,"largestWinLevelIII":107521900,"largestWinDateLevelIII":"Dec 15, 2018 7:11:49 AM","largestWinUserLevelIII":"player","lastWinLevelIII":12916000,"lastWinDateLevelIII":"Jul 23, 2019 11:29:37 PM","lastWinUserLevelIII":"player","winsLevelIV":976,"largestWinLevelIV":261827300,"largestWinDateLevelIV":"Jan 9, 2019 12:08:47 AM","largestWinUserLevelIV":"player","lastWinLevelIV":47503200,"lastWinDateLevelIV":"Jul 24, 2019 2:34:56 AM","lastWinUserLevelIV":"player"}},"gameIdentificationNumber":544,"gameNumber":"","sessionKey":"41be9e65e0ff03a65e8c93576bf61130","msg":"success","messageId":"' . $postData['messageId'] . '","qName":"app.services.messages.response.GameEventResponse","command":"subscribe","eventTimestamp":' . time() . '}';
                                break;
                            case 'ping':
                                $cashBackBtn = 0;
                            ...
                            case 'bet':
                                ...
                                $response = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{"slotLines":' . $lines . ',"slotBet":' . $betline . ',"totalFreeGames":' . $slotSettings->GetGameData('DazzlingHot20EGTFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('DazzlingHot20EGTCurrentFreeGame') . ',"Balance":' . $slotSettings->GetBalance() . ',"afterBalance":' . $slotSettings->GetBalance() . ',"bonusWin":' . $slotSettings->GetGameData('DazzlingHot20EGTBonusWin') . ',"totalWin":' . $totalWin . ',"winLines":[' . $winString . '],"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
                                $slotSettings->SaveLogReport($response, $allbet, $lines, $reportWin, $postData['slotEvent']);
                                $winstring = '';
                                $slotSettings->SetGameData('DazzlingHot20EGTTotalWin', $totalWin);
                                $slotSettings->SetGameData('DazzlingHot20EGTGambleStep', 5);
                                $hist = $slotSettings->GetGameData('DazzlingHot20EGTCards');
                                $curReels = '' . rand(0, 6) . ',' . $reels['reel1'][0] . ',' . $reels['reel1'][1] . ',' . $reels['reel1'][2] . ',' . rand(0, 6);
                                $curReels .= (',' . rand(0, 6) . ',' . $reels['reel2'][0] . ',' . $reels['reel2'][1] . ',' . $reels['reel2'][2] . ',' . rand(0, 6));
                                $curReels .= (',' . rand(0, 6) . ',' . $reels['reel3'][0] . ',' . $reels['reel3'][1] . ',' . $reels['reel3'][2] . ',' . rand(0, 6));
                                $curReels .= (',' . rand(0, 6) . ',' . $reels['reel4'][0] . ',' . $reels['reel4'][1] . ',' . $reels['reel4'][2] . ',' . rand(0, 6));
                                ...
                                if( $jackRandom == 1 ) 
                                {
                                    $state = 'jackpot';
                                    $isJack = 'true';
                                    $slotSettings->SetGameData('DazzlingHot20EGTJackSteps', [
                                        0, 
                                        0, 
                                        0, 
                                        0
                                ...
                                $result_tmp[] = '{"complex":{"gambles":5,"reels":[' . $curReels . '],"lines":[' . $winString . '],"scatters":[' . $scattersStr . '],"freespinScatters":[' . $scatter . '],"expand":[],"specialExpand":[],"gambles":5,"freespins":0,"jackpot":' . $isJack . ',"gameCommand":"bet"},"state":"' . $state . '","winAmount":' . ($totalWin * 100) . ',"gameIdentificationNumber":544,"gameNumber":"","balance":' . $balanceInCents . ',"sessionKey":"41be9e65e0ff03a65e8c93576bf61130","msg":"success","messageId":"' . $postData['messageId'] . '","qName":"app.services.messages.response.GameEventResponse","command":"bet","eventTimestamp":' . time() . '}';
                                ...
                                break;
                            case 'collect':
                                $result_tmp[] = '{"complex":{"gameCommand":"collect"},"state":"idle","winAmount":' . ($slotSettings->GetGameData('DazzlingHot20EGTTotalWin') * 100) . ',"gameIdentificationNumber":544,"gameNumber":"","balance":' . $balanceInCents . ',"sessionKey":"41be9e65e0ff03a65e8c93576bf61130","msg":"success","messageId":"' . $postData['messageId'] . '","qName":"app.services.messages.response.GameEventResponse","command":"bet","eventTimestamp":' . time() . '}';
                                $slotSettings->SetGameData('DazzlingHot20EGTTotalWin', 0);
                                break;
                            case 'jackpot':
                                $jackStep = $slotSettings->GetGameData('DazzlingHot20EGTJackSteps');
                                $jackWinID = $slotSettings->GetGameData($slotSettings->slotId . 'JackWinID');
                                if( $jackStep[0] >= 3 || $jackStep[1] >= 3 || $jackStep[2] >= 3 || $jackStep[3] >= 3 || !$slotSettings->HasGameData('DazzlingHot20EGTJackSteps') ) 
                                {
                                    exit();
                                }
                                $winAmount = 0;
                                ...
                                $slotSettings->SetGameData('DazzlingHot20EGTJackSteps', $jackStep);
                                break;
                            case 'gamble':
                                $Balance = $slotSettings->GetBalance();
                                $isGambleWin = rand(1, $slotSettings->GetGambleSettings());
                                $dealerCard = '';
                                $totalWin = $slotSettings->GetGameData('DazzlingHot20EGTTotalWin');
                                $gambleWin = 0;
                                $statBet = $totalWin;
                                $slotSettings->SetGameData('DazzlingHot20EGTGambleStep', $slotSettings->GetGameData('DazzlingHot20EGTGambleStep') - 1);
                                ...
                                else
                                {
                                    ...
                                    $totalWin = 0;
                                    $slotSettings->SetGameData('DazzlingHot20EGTGambleStep', 0);
                                    if( $postData['bet']['color'] == '1' ) 
                                    {
                                        $tmpCards = [
                                            '1', 
                                ...
                                $gtype = 1;
                                $gtype0 = 1;
                                if( $slotSettings->GetGameData('DazzlingHot20EGTBonusStart') == 1 ) 
                                {
                                    $gtype0 = 2;
                                }
                                $result_tmp[] = '{"complex":{"gambles":' . $slotSettings->GetGameData('DazzlingHot20EGTGambleStep') . ',"card":' . $dealerCard . ',"jackpot":false,"gameCommand":"gamble"},"state":"' . $gambleState . '","winAmount":' . ($totalWin * 100) . ',"gameIdentificationNumber":544,"gameNumber":"","sessionKey":"88e2b82e6537db4a339e4e1b5ce462cd","msg":"success","messageId":"' . $postData['messageId'] . '","qName":"app.services.messages.response.GameEventResponse","command":"bet","eventTimestamp":' . time() . '}';
                                break;
                        }
