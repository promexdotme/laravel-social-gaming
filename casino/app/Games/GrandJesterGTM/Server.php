                    ...
                    try
                    {
                        ...
                        if( $postData['slotEvent'] == 'getSettings' ) 
                        {
                            ...
                            if( $lastEvent != 'NULL' ) 
                            {
                                ...
                                $GrandJesterGTMStacked = $lastEvent->serverResponse->stackedWilds;
                                for( $i = 0; $i < 5; $i++ ) 
                                {
                                    $slotSettings->SetGameData($slotSettings->slotId . 'Stacked.' . $i, $GrandJesterGTMStacked[$i]);
                                }
                                for( $r = 1; $r <= 5; $r++ ) 
                                {
                                    if( $slotSettings->GetGameData('GrandJesterGTMStacked.' . ($r - 1)) > 0 ) 
                                    {
                                        $slotSettings->SetGameData('GrandJesterGTMStacked.' . ($r - 1), -1);
                                    }
                                    if( $slotSettings->GetGameData('GrandJesterGTMStacked.' . ($r - 1)) == 0 ) 
                                    {
                                        $slotSettings->SetGameData('GrandJesterGTMStacked.' . ($r - 1), 1);
                        ...
                        else if( $postData['slotEvent'] == 'gamble5GetUserCards' ) 
                        {
                            ...
                            $dealerCard = $slotSettings->GetGameData('GrandJesterGTMDealerCard');
                            $totalWin = $slotSettings->GetGameData('GrandJesterGTMTotalWin');
                            $gambleWin = 0;
                            ...
                            $slotSettings->SetGameData('GrandJesterGTMTotalWin', $totalWin);
                        ...
                        else if( $postData['slotEvent'] == 'gamble5GetDealerCard' ) 
                        {
                            ...
                            $slotSettings->SetGameData('GrandJesterGTMDealerCard', $tmpDc);
                        ...
                        else if( $postData['slotEvent'] == 'bet' || $postData['slotEvent'] == 'freespin' ) 
                        {
                            ...
                            if( $postData['slotEvent'] != 'freespin' ) 
                            {
                                ...
                                $bonusMpl = 1;
                                $slotSettings->SetGameData('GrandJesterGTMBonusWin', 0);
                                $slotSettings->SetGameData('GrandJesterGTMFreeGames', 0);
                                $slotSettings->SetGameData('GrandJesterGTMCurrentFreeGame', 0);
                                $slotSettings->SetGameData('GrandJesterGTMTotalWin', 0);
                                $slotSettings->SetGameData('GrandJesterGTMFreeBalance', 0);
                                $slotSettings->SetGameData('GrandJesterGTMIsJack', 0);
                                for( $i = 0; $i < 5; $i++ ) 
                                {
                                    $slotSettings->SetGameData('GrandJesterGTMStacked.' . $i, -1);
                                }
                            }
                            else
                            {
                                $slotSettings->SetGameData('GrandJesterGTMCurrentFreeGame', $slotSettings->GetGameData('GrandJesterGTMCurrentFreeGame') + 1);
                                $bonusMpl = $slotSettings->slotFreeMpl;
                                if( $slotSettings->GetGameData('GrandJesterGTMStacked.0') > 0 && $slotSettings->GetGameData('GrandJesterGTMStacked.1') > 0 && $slotSettings->GetGameData('GrandJesterGTMStacked.2') > 0 && $slotSettings->GetGameData('GrandJesterGTMStacked.3') > 0 && $slotSettings->GetGameData('GrandJesterGTMStacked.4') > 0 ) 
                                {
                            ...
                            for( $i = 0; $i <= 2000; $i++ ) 
                            {
                                ...
                                if( isset($jackState) && $jackState['isJackPay'] ) 
                                {
                                    ...
                                    $slotSettings->SetGameData('GrandJesterGTMIsJack', 1);
                                    $winType = 'win';
                                    ...
                                    for( $j = 0; $j < count($slotSettings->SymbolGame); $j++ ) 
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            if( $s[0] == $csym || in_array($s[0], $wild) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":1,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('GrandJesterGTMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":["none","none"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":2,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('GrandJesterGTMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            $s[0] = $reels['reel1'][$linesId[$k][0] - 1];
                                            $s[1] = $reels['reel2'][$linesId[$k][1] - 1];
                                            ...
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":3,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('GrandJesterGTMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            $s[0] = $reels['reel1'][$linesId[$k][0] - 1];
                                            $s[1] = $reels['reel2'][$linesId[$k][1] - 1];
                                            ...
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) && ($s[3] == $csym || in_array($s[3], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":4,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('GrandJesterGTMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            $s[0] = $reels['reel1'][$linesId[$k][0] - 1];
                                            $s[1] = $reels['reel2'][$linesId[$k][1] - 1];
                                            ...
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) && ($s[3] == $csym || in_array($s[3], $wild)) && ($s[4] == $csym || in_array($s[4], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":5,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('GrandJesterGTMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":[' . ($linesId[$k][4] - 1) . ',"' . $s[4] . '"]}';
                                                }
                                                if( $isSlotJack ) 
                                                {
                                                    $tmpStringWin = '';
                            ...
                            if( $postData['slotEvent'] == 'freespin' && $slotSettings->GetGameData('GrandJesterGTMFreeGames') <= $slotSettings->GetGameData('GrandJesterGTMCurrentFreeGame') && $winType != 'bonus' && $slotSettings->GetGameData('GrandJesterGTMTotalWin') + $totalWin > 0 ) 
                            {
                                $slotSettings->SetBalance($slotSettings->GetGameData('GrandJesterGTMTotalWin') + $totalWin);
                            }
                            ...
                            if( $postData['slotEvent'] == 'freespin' ) 
                            {
                                $slotSettings->SetGameData('GrandJesterGTMBonusWin', $slotSettings->GetGameData('GrandJesterGTMBonusWin') + $totalWin);
                                $slotSettings->SetGameData('GrandJesterGTMTotalWin', $slotSettings->GetGameData('GrandJesterGTMTotalWin') + $totalWin);
                                $totalWin = $slotSettings->GetGameData('GrandJesterGTMBonusWin');
                                $Balance = $slotSettings->GetGameData('GrandJesterGTMFreeBalance');
                                for( $r = 1; $r <= 5; $r++ ) 
                                {
                                    for( $p = 0; $p <= 3; $p++ ) 
                                    {
                                        if( $reels['reel' . $r][$p] == 'P_1' ) 
                                        {
                                            $slotSettings->SetGameData('GrandJesterGTMStacked.' . ($r - 1), 0);
                                        }
                                    }
                                }
                            }
                            ...
                            if( $scattersCount >= 3 ) 
                            {
                                if( $slotSettings->GetGameData('GrandJesterGTMFreeGames') > 0 ) 
                                {
                                    $slotSettings->SetGameData('GrandJesterGTMFreeBalance', $Balance);
                                    $slotSettings->SetGameData('GrandJesterGTMBonusWin', $totalWin);
                                    $slotSettings->SetGameData('GrandJesterGTMFreeGames', $slotSettings->GetGameData('GrandJesterGTMFreeGames') + $slotSettings->slotFreeCount);
                                }
                                else
                                {
                                    $slotSettings->SetGameData('GrandJesterGTMFreeBalance', $Balance);
                                    $slotSettings->SetGameData('GrandJesterGTMBonusWin', $totalWin);
                                    $slotSettings->SetGameData('GrandJesterGTMFreeGames', $slotSettings->slotFreeCount);
                                }
                            }
                            $GrandJesterGTMStacked = [];
                            for( $i = 0; $i < 5; $i++ ) 
                            {
                                if( $slotSettings->HasGameData('GrandJesterGTMStacked.' . $i) ) 
                                {
                                    $GrandJesterGTMStacked[] = $slotSettings->GetGameData('GrandJesterGTMStacked.' . $i);
                                }
                            }
                            $jsSpin = '' . json_encode($reels) . '';
                            $jsJack = '' . json_encode($slotSettings->Jackpots) . '';
                            $winString = implode(',', $lineWins);
                            $stackedWilds = '"stackedWilds":[' . implode(',', $GrandJesterGTMStacked) . ']';
                            $response = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{' . $stackedWilds . ',"slotJackpot":' . $slotSettings->slotJackpot[0] . ',"slotLines":' . $postData['slotLines'] . ',"slotBet":' . $postData['slotBet'] . ',"totalFreeGames":' . $slotSettings->GetGameData('GrandJesterGTMFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('GrandJesterGTMCurrentFreeGame') . ',"Balance":' . $Balance . ',"afterBalance":' . $slotSettings->GetBalance() . ',"totalWin":' . $totalWin . ',"winLines":[' . $winString . '],"bonusInfo":' . $scattersStr . ',"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
