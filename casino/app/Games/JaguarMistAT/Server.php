            ...
            function get_($request, $game)
            {
                \DB::transaction(function() use ($request, $game)
                {
                    try
                    {
                        ...
                        {
                            $response = '{"status":"success","microtime":0.0026731491088867,"dateTime":"2020-02-13 13:23:32","error":"","content":{"cmd":"sessionInfo","serverMathematics":"\/game\/JaguarMistAT\/server","serverResources":"","sessionId":"54594109_4133a64673d3883d42cd003ee905ba3e","exitUlt":"\/","exitUrl":"\/","id":"341","name":"GameName","currency":"ALL","language":"en","type":"aristocrat","systemName":"jaguar_mist","version":"2","mobile":"1"}}';
                        }
                        ...
                        else if( $postData['slotEvent'] == 'gamePick' ) 
                        {
                            ...
                            if( $_POST['pick'] == 0 ) 
                            {
                                $slotSettings->SetGameData('JaguarMistATMpl', 10);
                                $slotSettings->SetGameData('JaguarMistATCurrentFreeGame', 0);
                                $slotSettings->SetGameData('JaguarMistATFreeGames', 5);
                            }
                            else if( $_POST['pick'] == 1 ) 
                            {
                                $slotSettings->SetGameData('JaguarMistATMpl', 5);
                                $slotSettings->SetGameData('JaguarMistATCurrentFreeGame', 0);
                                $slotSettings->SetGameData('JaguarMistATFreeGames', 10);
                            }
                            else if( $_POST['pick'] == 2 ) 
                            {
                                $slotSettings->SetGameData('JaguarMistATMpl', 3);
                                $slotSettings->SetGameData('JaguarMistATCurrentFreeGame', 0);
                                $slotSettings->SetGameData('JaguarMistATFreeGames', 15);
                            }
                            else if( $_POST['pick'] == 3 ) 
                            {
                                $slotSettings->SetGameData('JaguarMistATMpl', 2);
                                $slotSettings->SetGameData('JaguarMistATCurrentFreeGame', 0);
                                $slotSettings->SetGameData('JaguarMistATFreeGames', 20);
                            }
                            $response = '{"status":"success","microtime":0.0093810558319092,"dateTime":"2020-02-15 14:26:21","error":"","content":{"session":"54990161_9709e13bca7763b46396cda1868d2e7e","cmd":"gamePick","balance":' . $balanceInCents . ',"win":0,"symbols":{"1":{"1":"symbol_6","2":"symbol_9","3":"symbol_13"},"2":{"1":"symbol_10","2":"symbol_5","3":"symbol_8"},"3":{"1":"symbol_10","2":"symbol_13","3":"symbol_11"},"4":{"1":"symbol_13","2":"symbol_10","3":"symbol_6"},"5":{"1":"symbol_3","2":"symbol_8","3":"symbol_1"}},"winLines":[],"freeSpin":{"id":"54990161_20200215132548","current":0,"add":' . $slotSettings->GetGameData('JaguarMistATFreeGames') . ',"total":' . $slotSettings->GetGameData('JaguarMistATFreeGames') . ',"totalWin":' . ($slotSettings->GetGameData('JaguarMistATBonusWin') * 100) . ',"multiplayer":' . $slotSettings->GetGameData('JaguarMistATMpl') . ',"pick":' . $_POST['pick'] . '},"actionId":"54990161_10_60","hash":"1ace145628d930d28bdf38789a28a9d7"}}';
                        }
                        else if( $postData['slotEvent'] == 'slotGamble' ) 
                        {
                            ...
                            $dealerCard = '';
                            $totalWin = $slotSettings->GetGameData('JaguarMistATTotalWin');
                            $gambleWin = 0;
                            $statBet = $totalWin;
                            ...
                            $slotSettings->SetGameData('JaguarMistATTotalWin', $totalWin);
                        ...
                        else if( $postData['slotEvent'] == 'bet' || $postData['slotEvent'] == 'freespin' ) 
                        {
                            ...
                            if( $postData['slotEvent'] != 'freespin' ) 
                            {
                                ...
                                $bonusMpl = 1;
                                $slotSettings->SetGameData('JaguarMistATBonusWin', 0);
                                $slotSettings->SetGameData('JaguarMistATFreeGames', 0);
                                $slotSettings->SetGameData('JaguarMistATCurrentFreeGame', 0);
                                $slotSettings->SetGameData('JaguarMistATTotalWin', 0);
                                $slotSettings->SetGameData('JaguarMistATFreeBalance', 0);
                                $slotSettings->SetGameData('JaguarMistATMpl', 1);
                            }
                            else
                            {
                                $slotSettings->SetGameData('JaguarMistATCurrentFreeGame', $slotSettings->GetGameData('JaguarMistATCurrentFreeGame') + 1);
                                $bonusMpl = $slotSettings->GetGameData('JaguarMistATMpl');
                            }
                            $Balance = $slotSettings->GetBalance();
                            ...
                            if( $postData['slotEvent'] == 'freespin' ) 
                            {
                                $slotSettings->SetGameData('JaguarMistATBonusWin', $slotSettings->GetGameData('JaguarMistATBonusWin') + $totalWin);
                                $slotSettings->SetGameData('JaguarMistATTotalWin', $slotSettings->GetGameData('JaguarMistATTotalWin') + $totalWin);
                                $freeStateStr = '"id":"54594109_20200214110301","current":' . $slotSettings->GetGameData('JaguarMistATCurrentFreeGame') . ',"multiplayer":' . $slotSettings->GetGameData('JaguarMistATMpl') . ',"xWin":[' . implode(',', $wildsMplArr) . '],"add":0,"total":' . $slotSettings->GetGameData('JaguarMistATFreeGames') . ',"totalWin":' . ($slotSettings->GetGameData('JaguarMistATBonusWin') * 100) . '';
                            }
                            else
                            {
                                $slotSettings->SetGameData('JaguarMistATTotalWin', $totalWin);
                            ...
                            if( $scattersCount >= 3 ) 
                            {
                                if( $slotSettings->GetGameData('JaguarMistATFreeGames') > 0 ) 
                                {
                                    $slotSettings->SetGameData('JaguarMistATFreeGames', $slotSettings->GetGameData('JaguarMistATFreeGames') + $slotSettings->slotFreeCount[$scattersCount]);
                                    $freeStateStr = '"id":"54594109_20200214110301","current":' . $slotSettings->GetGameData('JaguarMistATCurrentFreeGame') . ',"multiplayer":' . $slotSettings->GetGameData('JaguarMistATMpl') . ',"add":' . $slotSettings->slotFreeCount[$scattersCount] . ',"total":' . $slotSettings->GetGameData('JaguarMistATFreeGames') . ',"xWin":[' . implode(',', $wildsMplArr) . '],"totalWin":' . ($slotSettings->GetGameData('JaguarMistATBonusWin') * 100) . '';
                                }
                                else
                                {
                                    $slotSettings->SetGameData('JaguarMistATFreeBalance', $Balance);
                                    $slotSettings->SetGameData('JaguarMistATBonusWin', $totalWin);
                                    $slotSettings->SetGameData('JaguarMistATFreeGames', $slotSettings->slotFreeCount[$scattersCount]);
                                    $freeStateStr = '"id":"54594109_20200214110301","current":' . $slotSettings->GetGameData('JaguarMistATCurrentFreeGame') . ',"multiplayer":' . $slotSettings->GetGameData('JaguarMistATMpl') . ',"add":' . $slotSettings->slotFreeCount[$scattersCount] . ',"total":' . $slotSettings->GetGameData('JaguarMistATFreeGames') . ',"xWin":[' . implode(',', $wildsMplArr) . '],"totalWin":' . ($slotSettings->GetGameData('JaguarMistATBonusWin') * 100) . '';
                                }
                            }
                            ...
                            $response_log = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{"slotLines":' . $postData['slotLines'] . ',"slotBet":' . $postData['slotBet'] . ',"totalFreeGames":' . $slotSettings->GetGameData('JaguarMistATFreeGames') . ',"Mpl":' . $slotSettings->GetGameData('JaguarMistATMpl') . ',"currentFreeGames":' . $slotSettings->GetGameData('JaguarMistATCurrentFreeGame') . ',"Balance":' . $Balance . ',"afterBalance":' . $slotSettings->GetBalance() . ',"totalWin":' . $totalWin . ',"winLines":[' . $winString . '],"bonusInfo":{},"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
                            $reelStrArr = [];
                            for( $i = 1; $i <= 5; $i++ ) 
                            {
