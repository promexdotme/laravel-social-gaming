                    ...
                    try
                    {
                        ...
                        switch( $aid ) 
                        {
                            ...
                            case 'playerControl.tableHandler.searchTableAndJoin':
                                $slotSettings->SetGameData('AirCombatKABullets', []);
                                $slotSettings->SetGameData('AirCombatKAFishes', []);
                                $slotSettings->SetGameData('AirCombatKAWaveTime', time());
                                $slotSettings->SetGameData('AirCombatKACurScene', 0);
                                $slotSettings->SetGameData('AirCombatKAIsGroupFish', 0);
                                $slotSettings->SetGameData('AirCombatKAGamePause', time());
                                if( $postData['query']['level'] == 0 ) 
                                {
                                    $slotSettings->SetGameData('AirCombatKABet', 0.01);
                                    $slotSettings->SetGameData('AirCombatKABetCnt', 0);
                                    $slotSettings->SetGameData('AirCombatKABetArr', [
                                        0.01, 
                                        0.02, 
                                        0.03, 
                                        0.05, 
                                ...
                                {
                                    $slotSettings->SetGameData('AirCombatKABet', 0.1);
                                    $slotSettings->SetGameData('AirCombatKABetCnt', 0);
                                    $slotSettings->SetGameData('AirCombatKABetArr', [
                                        0.1, 
                                        0.2, 
                                ...
                                {
                                    $slotSettings->SetGameData('AirCombatKABet', 1);
                                    $slotSettings->SetGameData('AirCombatKABetCnt', 0);
                                    $slotSettings->SetGameData('AirCombatKABetArr', [
                                        1, 
                                        2, 
                                ...
                                $fishesArr = [];
                                $fishes = $slotSettings->GetGameData('AirCombatKAFishes');
                                if( !is_array($fishes) ) 
                                {
                                    $fishes = [];
                                }
                                ...
                                $slotSettings->SetGameData('AirCombatKAFishes', $fishes);
                            ...
                            case 'connector.accountHandler.onPingBalance':
                                $bullets = '';
                                $Bet = $slotSettings->GetGameData('AirCombatKABet');
                                $BetCnt = $slotSettings->GetGameData('AirCombatKABetCnt');
                                $BetArr = $slotSettings->GetGameData('AirCombatKABetArr');
                                $BetLevel = $slotSettings->GetGameData('AirCombatKABetLevel');
                            ...
                            case 'connector.accountHandler.onPingBalance_2':
                                ...
                                $BetArr = $slotSettings->GetGameData('AirCombatKABetArr');
                                $BetLevel = $slotSettings->GetGameData('AirCombatKABetLevel');
                                if( time() < $slotSettings->GetGameData('AirCombatKAGamePause') ) 
                                {
                                    $result_tmp[0] = '{"answerType":"game.fire","responseView":[4,0,0,0,6,' . strlen('game.fire') . '],"msg":{"player":{"nickName":"' . $slotSettings->username . '","gender":1,"avatarUrl":"","gameServerId":"player-server-3","connectorId":"connector-server-3","teamId":"","gameId":"10007","tableId":"2ba04cc50c285a21b223e1043993456918e041415cac8ce29e72d3dc948474be-connector-server-3","gameState":"playing","id":"9dab0ea6-0cb0-4b8c-951a-e10077945f2b","areaId":"7909d963c43c6df71d7f7ee17bfc4b5133809d80342e2f645d01e16119eec1ad-connector-server-3","gold":100,"delta":' . ($Bet * 100) . ',"gain":0,"cost":' . ($Bet * 100) . ',"ratio":1,"rmpRatioCredit":' . $balanceInCents . ',"denom":0.01},"areaPlayer":{"id":"13879583b6558342be4b011cf849ee29989667afd2eb4c993a7f06371e78a2d4","areaId":"7909d963c43c6df71d7f7ee17bfc4b5133809d80342e2f645d01e16119eec1ad-connector-server-3","playerId":"d607e29f-99cc-48bc-a37d-5590b80fa0f6","cannonLevel":' . $BetCnt . ',"cannonCost":' . ($Bet * 100) . ',"cannonMaxLen":18,"skin":1,"lockTargetId":0,"chairId":2}' . $bullets . '}}';
                                    break;
                                }
                                ...
                                if( time() - $slotSettings->GetGameData('AirCombatKAWaveTime') >= 300 ) 
                                {
                                    $slotSettings->SetGameData('AirCombatKAFishes', []);
                                    $curScene = $slotSettings->GetGameData('AirCombatKACurScene');
                                    $curScene++;
                                    if( $curScene > 3 ) 
                                    {
                                        $curScene = 0;
                                    ...
                                    $slotSettings->SetGameData('AirCombatKAWaveTime', time());
                                    $slotSettings->SetGameData('AirCombatKACurScene', $curScene);
                                    $slotSettings->SetGameData('AirCombatKAIsGroupFish', 1);
                                }
                                else
                                {
                                    $result_tmp[0] = '{"answerType":"game.fire","responseView":[4,0,0,0,6,' . strlen('game.fire') . '],"msg":{"player":{"nickName":"' . $slotSettings->username . '","gender":1,"avatarUrl":"","gameServerId":"player-server-3","connectorId":"connector-server-3","teamId":"","gameId":"10007","tableId":"2ba04cc50c285a21b223e1043993456918e041415cac8ce29e72d3dc948474be-connector-server-3","gameState":"playing","id":"9dab0ea6-0cb0-4b8c-951a-e10077945f2b","areaId":"7909d963c43c6df71d7f7ee17bfc4b5133809d80342e2f645d01e16119eec1ad-connector-server-3","gold":100,"delta":' . ($Bet * 100) . ',"gain":0,"cost":' . ($Bet * 100) . ',"ratio":1,"rmpRatioCredit":' . $balanceInCents . ',"denom":0.01},"areaPlayer":{"id":"13879583b6558342be4b011cf849ee29989667afd2eb4c993a7f06371e78a2d4","areaId":"7909d963c43c6df71d7f7ee17bfc4b5133809d80342e2f645d01e16119eec1ad-connector-server-3","playerId":"d607e29f-99cc-48bc-a37d-5590b80fa0f6","cannonLevel":' . $BetCnt . ',"cannonCost":' . ($Bet * 100) . ',"cannonMaxLen":18,"skin":1,"lockTargetId":0,"chairId":2}' . $bullets . '}}';
                                    ...
                                    if( $slotSettings->GetGameData('AirCombatKAIsGroupFish') == 0 ) 
                                    {
                                        $answerType = 'game.onSpawnFishes';
                                        $gr = '';
                                        $rfish = rand(10, 30);
                                    ...
                                    $slotSettings->SetGameData('AirCombatKAFishes', $fishesArrNew);
                                }
                                break;
                            case 'playerControl.areaHandler.onCollider':
                                ...
                                $fishes = $slotSettings->GetGameData('AirCombatKAFishes');
                                $bulletsArr = $slotSettings->GetGameData('AirCombatKABullets');
                                $allbet = $slotSettings->GetGameData('AirCombatKABet');
                                $die = 'false';
                                $results = '';
                                $totalWin = 0;
                                $pause = '';
                                ...
                                if( isset($fishes[$fid]) ) 
                                {
                                    ...
                                    else if( $totalWin <= $bank && rand(1, 5) == 1 && $totalWin > 0 && $fishes[$fid]['state'] != 'bomb' ) 
                                    {
                                        ...
                                        if( $fishes[$fid]['fishView'] == 'Fish_01' ) 
                                        {
                                            ...
                                            $slotSettings->SetGameData('AirCombatKAGamePause', time() + 10);
                                ...
                                {
                                    $result_tmp[0] = '{"answerType":"game.colliderResult","Win":' . ($totalWin * 100) . ',"Balance":0.0,"curBet":' . $slotSettings->GetGameData('AirCombatKABet') . ',"responseView":[4,0,0,0,6,' . strlen('game.colliderResult') . '],"msg":{"player":{"id":"d607e29f-99cc-48bc-a37d-5590b80fa0f6","gold":' . ($totalWin * 100) . ',"delta":0,"gain":0,"cost":' . ($Bet * 100) . ',"rmpRatioCredit":0.1,"ratio":1},"result":[' . $results . ']}}';
                                }
                                else
                                {
                            ...
                            case 'fishHunter.areaHandler.onUpdateCannon':
                                ...
                                $BetArr = $slotSettings->GetGameData('AirCombatKABetArr');
                                $BetLevel = $slotSettings->GetGameData('AirCombatKABetLevel');
                                $cnLevel = $slotSettings->GetGameData('AirCombatKABetLevel') * 6;
                            ...
                            case 'fishHunter.areaHandler.onFire':
                                $bulletsArr = $slotSettings->GetGameData('AirCombatKABullets');
                                $bulletBet = $slotSettings->GetGameData('AirCombatKABet');
                                $allbet = $bulletBet;
                                $Bet = $slotSettings->GetGameData('AirCombatKABet');
                                $BetCnt = $slotSettings->GetGameData('AirCombatKABetCnt');
                                $BetArr = $slotSettings->GetGameData('AirCombatKABetArr');
                                ...
                                else
                                {
                                    ...
                                    $slotSettings->SetGameData('AirCombatKABullets', $bulletsArr);
