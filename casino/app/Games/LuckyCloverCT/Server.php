            ...
            function get_($request, $game)
            {
                \DB::transaction(function() use ($request, $game)
                {
                    try
                    {
                        ...
                        {
                            case 'create_session':
                                $slotSettings->SetGameData('LuckyCloverCTCards', [
                                    19, 
                                    44, 
                                    0, 
                                    37, 
                            ...
                            case 'init_game':
                                ...
                                $slotSettings->SetGameData('LuckyCloverCTBonusWin', 0);
                                $slotSettings->SetGameData('LuckyCloverCTFreeGames', 0);
                                $slotSettings->SetGameData('LuckyCloverCTCurrentFreeGame', 0);
                                $slotSettings->SetGameData('LuckyCloverCTCurrentFreeGame0', 0);
                                $slotSettings->SetGameData('LuckyCloverCTTotalWin', 0);
                                $slotSettings->SetGameData('LuckyCloverCTFreeBalance', 0);
                                ...
                                if( $lastEvent != 'NULL' ) 
                                {
                                    ...
                                    if( $slotSettings->GetGameData('LuckyCloverCTCurrentFreeGame') < $slotSettings->GetGameData('LuckyCloverCTFreeGames') && $slotSettings->GetGameData('LuckyCloverCTFreeGames') > 0 ) 
                                    {
                            ...
                            case 'poll':
                                ...
                                {
                                    $balanceInCents = sprintf('%01.2f', $slotSettings->GetBalance() - $slotSettings->GetGameData('LuckyCloverCTTotalWin')) * 100;
                                }
                            ...
                            case 'game_finished':
                                $slotSettings->SetGameData('LuckyCloverCTBonusWin', 0);
                                $slotSettings->SetGameData('LuckyCloverCTTotalWin', 0);
                                $responseData['game_finished'][0]['freeround_play'] = $slotSettings->GetGameData('LuckyCloverCTCurrentFreeGame0');
                            ...
                            case 'subgame_finished':
                                if( $slotSettings->GetGameData('LuckyCloverCTCurrentFreeGame0') < $slotSettings->GetGameData('LuckyCloverCTFreeGames') && $slotSettings->GetGameData('LuckyCloverCTFreeGames') > 0 ) 
                                {
                                    ...
                                    $response = '{"responseEvent":"spin","responseType":"freespin","serverResponse":{"result":' . json_encode($result) . ',"slotDenom":' . $slotSettings->GetGameData($slotSettings->slotId . 'Denom') . ',"slotLines":' . $lines . ',"slotBet":' . $betline . ',"totalFreeGames":' . $slotSettings->GetGameData('LuckyCloverCTFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('LuckyCloverCTCurrentFreeGame0') . ',"Balance":' . $slotSettings->GetGameData('LuckyCloverCTFreeBalance') . ',"afterBalance":' . $slotSettings->GetGameData('LuckyCloverCTFreeBalance') . ',"bonusWin":' . $slotSettings->GetGameData('LuckyCloverCTBonusWin') . ',"totalWin":' . $reportWin . ',"winLines":[],"Jackpots":[],"reelsSymbols":' . json_encode($slotSettings->GetGameData($slotSettings->slotId . 'Reels')) . '}}';
                                    if( $slotSettings->GetGameData('LuckyCloverCTFreeGames') <= $slotSettings->GetGameData('LuckyCloverCTCurrentFreeGame0') ) 
                                    {
                                        if( $reportWin > 0 ) 
                                        {
                                    ...
                                    $balanceInCents = $slotSettings->GetGameData('LuckyCloverCTFreeBalance');
                                    $responseData['subgame_finished'][0]['account_status']['credit'] = round($balanceInCents);
                                    $responseData['subgame_finished'][0]['freeround_play'] = $slotSettings->GetGameData('LuckyCloverCTCurrentFreeGame0');
                                    $responseData['subgame_finished'][1]['freeround_play'] = $slotSettings->GetGameData('LuckyCloverCTCurrentFreeGame0');
                            ...
                            case 'play':
                                ...
                                for( $spinLoop = 0; $spinLoop < $spinLoopLimit; $spinLoop++ ) 
                                {
                                    ...
                                    if( $postData['slotEvent'] != 'freespin' ) 
                                    {
                                        ...
                                        $slotSettings->SetGameData('LuckyCloverCTCurrentFreeGame0', 0);
                                        $slotSettings->SetGameData('LuckyCloverCTTotalWin', 0);
                                        $slotSettings->SetGameData('LuckyCloverCTFreeBalance', sprintf('%01.2f', $slotSettings->GetBalance()) * 100);
                                    ...
                                    {
                                        $slotSettings->SetGameData('LuckyCloverCTCurrentFreeGame', $slotSettings->GetGameData('LuckyCloverCTCurrentFreeGame') + 1);
                                    ...
                                    if( $postData['slotEvent'] == 'freespin' ) 
                                    {
                                        $slotSettings->SetGameData('LuckyCloverCTBonusWin', $slotSettings->GetGameData('LuckyCloverCTBonusWin') + $totalWin);
                                        $slotSettings->SetGameData('LuckyCloverCTTotalWin', $slotSettings->GetGameData('LuckyCloverCTTotalWin') + $totalWin);
                                        $balanceInCents = $slotSettings->GetGameData('LuckyCloverCTFreeBalance');
                                    }
                                    else
                                    {
                                        $slotSettings->SetGameData('LuckyCloverCTTotalWin', $totalWin);
                                    }
                                    $fs = 0;
                                    if( $scattersCount >= 3 ) 
                                    {
                                    ...
                                    $winstring = '';
                                    $slotSettings->SetGameData('LuckyCloverCTGambleStep', 5);
                                    $hist = $slotSettings->GetGameData('LuckyCloverCTCards');
                                    if( $postData['slotEvent'] == 'freespin' ) 
                                    {
                                        $state = 'freespin';
                                        ...
                                        if( $slotSettings->GetGameData($slotSettings->slotId . 'FreeGames') <= $slotSettings->GetGameData($slotSettings->slotId . 'CurrentFreeGame') && $slotSettings->GetGameData('LuckyCloverCTBonusWin') > 0 ) 
                                        {
                                            $responseData['play'][0]['result'][$spinLoop]['is_free'] = true;
                                    ...
                                    $responseData['play'][0]['result'][$spinLoop]['total_win'] = $slotSettings->GetGameData('LuckyCloverCTTotalWin') / $denom;
                                ...
                                $response = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{"result":' . json_encode($responseData['play'][0]['result']) . ',"slotDenom":' . $denom . ',"slotLines":' . $lines . ',"slotBet":' . $betline . ',"totalFreeGames":' . $slotSettings->GetGameData('LuckyCloverCTFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('LuckyCloverCTCurrentFreeGame0') . ',"Balance":' . $slotSettings->GetGameData($slotSettings->slotId . 'FreeBalance') . ',"afterBalance":' . $slotSettings->GetBalance() . ',"bonusWin":' . $slotSettings->GetGameData('LuckyCloverCTBonusWin') . ',"totalWin":' . $totalWin . ',"winLines":[],"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
                            ...
                            case 'gamble':
                                ...
                                $dealerCard = '';
                                $totalWin = $slotSettings->GetGameData('LuckyCloverCTTotalWin');
                                $gambleWin = 0;
                                $statBet = $totalWin;
                                ...
                                $hist = $slotSettings->GetGameData('LuckyCloverCTCards');
                                $slotSettings->SetGameData('LuckyCloverCTGambleStep', $slotSettings->GetGameData('LuckyCloverCTGambleStep') - 1);
                                if( $slotSettings->MaxWin < ($totalWin * $slotSettings->CurrentDenom) ) 
                                {
                                    $isGambleWin = 0;
                                }
                                ...
                                else
                                {
                                    ...
                                    $totalWin = 0;
                                    $slotSettings->SetGameData('LuckyCloverCTGambleStep', 0);
                                    if( $postData['continue_params']['double_key'] != 'red' && $postData['continue_params']['double_key'] != 'black' ) 
                                    {
                                        if( $postData['continue_params']['double_key'] == 'diamond' ) 
                                        {
                                ...
                                $slotSettings->SetGameData('LuckyCloverCTCards', $hist);
