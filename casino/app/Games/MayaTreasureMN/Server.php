                    ...
                    try
                    {
                        ...
                        switch( $aid ) 
                        {
                            ...
                            case 'Act18':
                                if( isset($postData['reqDat']) ) 
                                {
                                    ...
                                    for( $i = 0; $i <= 2000; $i++ ) 
                                    {
                                        ...
                                        if( $scattersCount1 >= 3 ) 
                                        {
                                            ...
                                            $scattersWin0 = rand(10, 100) * $allbet;
                                        }
                                        $totalWin += $scattersWin0;
                                        if( $i > 1000 ) 
                                        {
                                            $winType = 'none';
                                        }
                                ...
                                $result_tmp[0] = '{"action":"' . $aid . '","gameid":28,"serverResponse":' . json_encode($postData) . ',"nickName":"' . $slotSettings->username . '","currency":"' . $slotSettings->slotCurrency . '","Credit":' . $balanceInCents . ',"Denom":' . ($slotSettings->CurrentDenom * 100) . '}';
                                break;
                        }
