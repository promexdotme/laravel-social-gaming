                ...
                \DB::transaction(function() use ($request, $game)
                {
                    try
                    {
                        ...
                        else if( $postData['slotEvent'] == 'gamble5GetUserCards' ) 
                        {
                            ...
                            $dealerCard = $slotSettings->GetGameData('LuckyLadysCharmDX6GTMDealerCard');
                            $totalWin = $slotSettings->GetGameData('LuckyLadysCharmDX6GTMTotalWin');
                            $gambleWin = 0;
                            ...
                            $slotSettings->SetGameData('LuckyLadysCharmDX6GTMTotalWin', $totalWin);
                        ...
                        else if( $postData['slotEvent'] == 'gamble5GetDealerCard' ) 
                        {
                            ...
                            $slotSettings->SetGameData('LuckyLadysCharmDX6GTMDealerCard', $tmpDc);
                        ...
                        else if( $postData['slotEvent'] == 'slotGamble' ) 
                        {
                            ...
                            $dealerCard = '';
                            $totalWin = $slotSettings->GetGameData('LuckyLadysCharmDX6GTMTotalWin');
                            $slotSettings->SetGameData('LuckyLadysCharmDX6GTMBonusWin', $slotSettings->GetGameData('LuckyLadysCharmDX6GTMBonusWin') - $totalWin);
                            $gambleWin = 0;
                            $statBet = $totalWin;
                            if( $slotSettings->MaxWin < ($totalWin * $slotSettings->CurrentDenom) ) 
                            {
                            ...
                            $slotSettings->SetBank((isset($postData['slotEvent']) ? $postData['slotEvent'] : ''), $gambleWin * -1);
                            $afterBalance = $slotSettings->GetBalance();
                            $jsSet = '{"bonusWin":' . $slotSettings->GetGameData('LuckyLadysCharmDX6GTMBonusWin') . ',"dealerCard":"' . $dealerCard . '","gambleState":"' . $gambleState . '","totalWin":' . $totalWin . ',"afterBalance":' . $afterBalance . ',"Balance":' . $Balance . '}';
                        ...
                        else if( $postData['slotEvent'] == 'bet' || $postData['slotEvent'] == 'freespin' ) 
                        {
                            ...
                            if( $postData['slotEvent'] != 'freespin' ) 
                            {
                                ...
                                $bonusMpl = 1;
                                $slotSettings->SetGameData('LuckyLadysCharmDX6GTMExpSymbol', 'NONE');
                                $slotSettings->SetGameData('LuckyLadysCharmDX6GTMBonusWin', 0);
                                $slotSettings->SetGameData('LuckyLadysCharmDX6GTMFreeGames', 0);
                                $slotSettings->SetGameData('LuckyLadysCharmDX6GTMCurrentFreeGame', 0);
                                $slotSettings->SetGameData('LuckyLadysCharmDX6GTMTotalWin', 0);
                                $slotSettings->SetGameData('LuckyLadysCharmDX6GTMFreeBalance', 0);
                            }
                            else
                            {
                                $slotSettings->SetGameData('LuckyLadysCharmDX6GTMCurrentFreeGame', $slotSettings->GetGameData('LuckyLadysCharmDX6GTMCurrentFreeGame') + 1);
                            ...
                            if( $postData['slotEvent'] == 'freespin' && $slotSettings->GetGameData('LuckyLadysCharmDX6GTMFreeGames') <= $slotSettings->GetGameData('LuckyLadysCharmDX6GTMCurrentFreeGame') && $winType != 'bonus' && $slotSettings->GetGameData('LuckyLadysCharmDX6GTMTotalWin') + $totalWin > 0 ) 
                            {
                                $slotSettings->SetBalance($slotSettings->GetGameData('LuckyLadysCharmDX6GTMTotalWin') + $totalWin);
                            }
                            ...
                            if( $scattersCount >= 3 ) 
                            {
                                if( $slotSettings->GetGameData('LuckyLadysCharmDX6GTMFreeGames') > 0 ) 
                                {
                                    $slotSettings->SetGameData('LuckyLadysCharmDX6GTMFreeBalance', $Balance);
                                    $slotSettings->SetGameData('LuckyLadysCharmDX6GTMBonusWin', $totalWin);
                                    $slotSettings->SetGameData('LuckyLadysCharmDX6GTMFreeGames', $slotSettings->GetGameData('LuckyLadysCharmDX6GTMFreeGames') + $slotSettings->slotFreeCount);
                                }
                                else
                                {
                                    $slotSettings->SetGameData('LuckyLadysCharmDX6GTMExpSymbol', $slotSettings->SymbolGameExp[0]);
                                    $slotSettings->SetGameData('LuckyLadysCharmDX6GTMBonusWin', $totalWin);
                                    $slotSettings->SetGameData('LuckyLadysCharmDX6GTMFreeGames', $slotSettings->slotFreeCount);
                                }
                            }
                            $reels = $tmpReels;
                            ...
                            if( $slotSettings->GetGameData('LuckyLadysCharmDX6GTMExpSymbol') != 'NONE' ) 
                            {
                                $expSymbol = '"expSymbol":"' . $slotSettings->GetGameData('LuckyLadysCharmDX6GTMExpSymbol') . '",';
                            }
                            else
                            {
                                $expSymbol = '';
                            }
                            $response = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{"slotLines":' . $postData['slotLines'] . ',"slotBet":' . $postData['slotBet'] . ',"slotExtraBet":"' . $postData['slotExtraBet'] . '","bonusWin":' . $slotSettings->GetGameData('LuckyLadysCharmDX6GTMBonusWin') . ',"totalFreeGames":' . $slotSettings->GetGameData('LuckyLadysCharmDX6GTMFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('LuckyLadysCharmDX6GTMCurrentFreeGame') . ',"Balance":' . $Balance . ',"afterBalance":' . $slotSettings->GetBalance() . ',"totalWin":' . $totalWin . ',"winLines":[' . $winString . '],"bonusInfo":' . $scattersStr . ',"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
