                    ...
                    try
                    {
                        ...
                        switch( $aid ) 
                        {
                            ...
                            case 'settings':
                                ...
                                $result_tmp[] = '{"complex":{"balance":' . $balanceInCents . ',"balanceRaw":' . round($balanceInCents * $slotSettings->CurrentDenom) . ',"paytableCoef":{"0":{"coef":[5,20,100],"multiplier":1},"1":{"coef":[5,20,100],"multiplier":1},"2":{"coef":[5,20,100],"multiplier":1},"3":{"coef":[10,25,150],"multiplier":1},"4":{"coef":[15,30,200],"multiplier":1},"5":{"coef":[15,30,200],"multiplier":1},"6":{"coef":[25,75,250],"multiplier":1},"7":{"coef":[25,100,500],"multiplier":1},"8":{"coef":[5,50,200,1000],"multiplier":1},"9":{"coef":[0,0,0],"multiplier":1},"10":{"coef":[],"multiplier":1},"11":{"coef":[],"multiplier":1}},"bets":[' . implode(',', $gameBets) . '],"jackpotMinBet":1,"jackpot":true,"freespinFakeReels":[[1,4,3,2,8,8,8,6,0,11,7,3,0,5,3,2,4,6,3,0],[10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10],[7,2,3,8,8,8,2,6,1,2,4,1,2,7,1,0,4,2,3,5],[1,6,4,3,5,2,4,0,5,3,8,8,8,2,4,0,6,3,4,0],[1,3,4,0,1,8,8,8,0,2,7,0,1,6,0,1,7,2,1,3]],"jackpotMinBet":1,"jackpot":true,"mainFakeReels":[[6,1,4,3,0,7,1,4,2,5,0,6,1,3,8,2,0,7,2,5],[3,4,2,9,0,7,2,5,3,9,2,4,1,10,0,1,3,5,2,1],[2,5,3,7,1,6,0,5,2,10,1,5,0,4,3,9,2,7,0,8],[5,3,4,0,8,6,3,5,0,9,2,4,0,9,1,7,2,6,10,7],[6,2,7,1,4,2,5,0,6,1,5,3,8,2,4,0,7,1,5,3]],"jackpotMaxBet":100000,"denominations":[' . implode(',', $denoms) . ']},"gameIdentificationNumber":' . $postData['gameIdentificationNumber'] . ',"gameNumber":-1,"sessionKey":"41be9e65e0ff03a65e8c93576bf61130","msg":"success","messageId":"' . $postData['messageId'] . '","qName":"app.services.messages.response.GameResponse","command":"settings","eventTimestamp":' . time() . '}';
                                break;
                            case 'subscribe':
                                $hist = [
                                    78, 
                                ...
                                shuffle($hist);
                                $slotSettings->SetGameData('RouteOfMexicoEGTCards', $hist);
                                $lastEvent = $slotSettings->GetHistory();
                                $slotSettings->SetGameData('RouteOfMexicoEGTBonusWin', 0);
                                $slotSettings->SetGameData('RouteOfMexicoEGTFreeGames', 0);
                                $slotSettings->SetGameData('RouteOfMexicoEGTCurrentFreeGame', 0);
                                $slotSettings->SetGameData('RouteOfMexicoEGTTotalWin', 0);
                                $slotSettings->SetGameData('RouteOfMexicoEGTFreeBalance', 0);
                                if( $lastEvent != 'NULL' ) 
                                {
                                    ...
                                    $slotSettings->SetGameData('RouteOfMexicoEGTCurrentSeq', $lastEvent->serverResponse->curSeq);
                                    ...
                                    $gtype = 1;
                                    if( $slotSettings->GetGameData('RouteOfMexicoEGTCurrentFreeGame') < $slotSettings->GetGameData('RouteOfMexicoEGTFreeGames') && $slotSettings->GetGameData('RouteOfMexicoEGTFreeGames') > 0 ) 
                                    {
                                        $gtype = 2;
                                    }
                                }
                            ...
                            case 'bet':
                                ...
                                if( $postData['slotEvent'] != 'freespin' ) 
                                {
                                    ...
                                    $slotSettings->SetGameData('RouteOfMexicoEGTCurrentFreeGame', 0);
                                    $slotSettings->SetGameData('RouteOfMexicoEGTTotalWin', 0);
                                    $slotSettings->SetGameData('RouteOfMexicoEGTFreeBalance', sprintf('%01.2f', $slotSettings->GetBalance()) * 100);
                                    $bonusMpl = 1;
                                }
                                else
                                {
                                    $slotSettings->SetGameData('RouteOfMexicoEGTCurrentFreeGame', $slotSettings->GetGameData('RouteOfMexicoEGTCurrentFreeGame') + 1);
                                ...
                                if( $winType == 'bonus' ) 
                                {
                                    ...
                                    if( $wlb != 'NULL' ) 
                                    {
                                        ...
                                        $slotSettings->SetGameData('RouteOfMexicoEGTCurrentSeq', $curSeq);
                                        if( $curSeqWin > 0 ) 
                                        {
                                ...
                                for( $i = 0; $i <= 2000; $i++ ) 
                                {
                                    ...
                                    {
                                        $curSeq = (array)$slotSettings->GetGameData('RouteOfMexicoEGTCurrentSeq');
                                        $curSeq['result'] = (array)$curSeq['result'];
                                        $curSeq['result'][$slotSettings->GetGameData('RouteOfMexicoEGTCurrentFreeGame')] = (array)$curSeq['result'][$slotSettings->GetGameData('RouteOfMexicoEGTCurrentFreeGame')];
                                        $curSeq['result'][$slotSettings->GetGameData('RouteOfMexicoEGTCurrentFreeGame')]['reels'] = (array)$curSeq['result'][$slotSettings->GetGameData('RouteOfMexicoEGTCurrentFreeGame')]['reels'];
                                        $reels = $curSeq['result'][$slotSettings->GetGameData('RouteOfMexicoEGTCurrentFreeGame')]['reels'];
                                    }
                                    if( $postData['slotEvent'] == 'freespin' ) 
                                    {
                                        $cf = $slotSettings->GetGameData('RouteOfMexicoEGTCurrentFreeGame');
                                        if( $cf == 1 ) 
                                        {
                                            $holdReels = '1,2';
                                            $reels['reel2'][0] = '10';
                                ...
                                if( $postData['slotEvent'] == 'freespin' ) 
                                {
                                    $slotSettings->SetGameData('RouteOfMexicoEGTBonusWin', $slotSettings->GetGameData('RouteOfMexicoEGTBonusWin') + $totalWin);
                                    $slotSettings->SetGameData('RouteOfMexicoEGTTotalWin', $slotSettings->GetGameData('RouteOfMexicoEGTTotalWin') + $totalWin);
                                    $balanceInCents = $slotSettings->GetGameData('RouteOfMexicoEGTFreeBalance');
                                }
                                else
                                {
                                    $slotSettings->SetGameData('RouteOfMexicoEGTTotalWin', $totalWin);
                                }
                                $fs = 0;
                                if( $scattersCount >= 3 ) 
                                {
                                    if( $slotSettings->GetGameData('RouteOfMexicoEGTFreeGames') > 0 ) 
                                    {
                                        $slotSettings->SetGameData('RouteOfMexicoEGTFreeGames', $slotSettings->GetGameData('RouteOfMexicoEGTFreeGames') + $slotSettings->slotFreeCount);
                                    }
                                    else
                                    {
                                        $slotSettings->SetGameData('RouteOfMexicoEGTFreeStartWin', $totalWin);
                                        $slotSettings->SetGameData('RouteOfMexicoEGTBonusWin', $totalWin);
                                        $slotSettings->SetGameData('RouteOfMexicoEGTFreeGames', $slotSettings->slotFreeCount);
                                    }
                                    $fs = $slotSettings->GetGameData('RouteOfMexicoEGTFreeGames');
                                }
                                $curReels = '' . rand(0, 6) . ',' . $reels['reel1'][0] . ',' . $reels['reel1'][1] . ',' . $reels['reel1'][2] . ',' . rand(0, 6);
                                $curReels .= (',' . rand(0, 6) . ',' . $reels['reel2'][0] . ',' . $reels['reel2'][1] . ',' . $reels['reel2'][2] . ',' . rand(0, 6));
                                $curReels .= (',' . rand(0, 6) . ',' . $reels['reel3'][0] . ',' . $reels['reel3'][1] . ',' . $reels['reel3'][2] . ',' . rand(0, 6));
                                ...
                                $response = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{"curSeq":' . json_encode($curSeq) . ',"slotLines":' . $lines . '' . $slotSettings->GetGameData($slotSettings->slotId . 'FirstSpin') . ',"slotBet":' . $betline . ',"totalFreeGames":' . $slotSettings->GetGameData('RouteOfMexicoEGTFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('RouteOfMexicoEGTCurrentFreeGame') . ',"Balance":' . $balanceInCents . ',"afterBalance":' . $balanceInCents . ',"bonusWin":' . $slotSettings->GetGameData('RouteOfMexicoEGTBonusWin') . ',"totalWin":' . $totalWin . ',"winLines":[' . $winString . '],"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
                                $slotSettings->SaveLogReport($response, $allbet, $lines, $reportWin, $postData['slotEvent']);
                                $winstring = '';
                                $slotSettings->SetGameData('RouteOfMexicoEGTGambleStep', 5);
                                $hist = $slotSettings->GetGameData('RouteOfMexicoEGTCards');
                                if( $jackRandom == 1 ) 
                                {
                                    $state = 'jackpot';
                                    $isJack = 'true';
                                    $slotSettings->SetGameData('RouteOfMexicoEGTJackSteps', [
                                        0, 
                                        0, 
                                        0, 
                                        0
                                ...
                                if( $postData['slotEvent'] == 'freespin' ) 
                                {
                                    $totalWin = $slotSettings->GetGameData('RouteOfMexicoEGTBonusWin');
                                    $state = 'freespin';
                                ...
                                break;
                            case 'collect':
                                $result_tmp[] = '{"complex":{"gameCommand":"collect"},"state":"idle","winAmount":' . ($slotSettings->GetGameData('RouteOfMexicoEGTTotalWin') * 100) . ',"gameIdentificationNumber":' . $postData['gameIdentificationNumber'] . ',"gameNumber":"","balance":' . $balanceInCents . ',"sessionKey":"41be9e65e0ff03a65e8c93576bf61130","msg":"success","messageId":"' . $postData['messageId'] . '","qName":"app.services.messages.response.GameEventResponse","command":"bet","eventTimestamp":' . time() . '}';
                                $slotSettings->SetGameData('RouteOfMexicoEGTTotalWin', 0);
                                break;
                            case 'jackpot':
                                $jackStep = $slotSettings->GetGameData('RouteOfMexicoEGTJackSteps');
                                $jackWinID = $slotSettings->GetGameData($slotSettings->slotId . 'JackWinID');
                                if( $jackStep[0] >= 3 || $jackStep[1] >= 3 || $jackStep[2] >= 3 || $jackStep[3] >= 3 || !$slotSettings->HasGameData('RouteOfMexicoEGTJackSteps') ) 
                                {
                                    exit();
                                }
                                $winAmount = 0;
                                ...
                                $slotSettings->SetGameData('RouteOfMexicoEGTJackSteps', $jackStep);
                                break;
                            case 'gamble':
                                $Balance = $slotSettings->GetBalance();
                                $isGambleWin = rand(1, $slotSettings->GetGambleSettings());
                                $dealerCard = '';
                                $totalWin = $slotSettings->GetGameData('RouteOfMexicoEGTTotalWin');
                                $gambleWin = 0;
                                $statBet = $totalWin;
                                $slotSettings->SetGameData('RouteOfMexicoEGTGambleStep', $slotSettings->GetGameData('RouteOfMexicoEGTGambleStep') - 1);
                                ...
                                else
                                {
                                    ...
                                    $totalWin = 0;
                                    $slotSettings->SetGameData('RouteOfMexicoEGTGambleStep', 0);
                                    if( $postData['bet']['color'] == '1' ) 
                                    {
                                        $tmpCards = [
                                            '1', 
                                ...
                                $gtype = 1;
                                $gtype0 = 1;
                                if( $slotSettings->GetGameData('RouteOfMexicoEGTBonusStart') == 1 ) 
                                {
                                    $gtype0 = 2;
                                }
                                $result_tmp[] = '{"complex":{"gambles":' . $slotSettings->GetGameData('RouteOfMexicoEGTGambleStep') . ',"card":' . $dealerCard . ',"jackpot":false,"gameCommand":"gamble"},"state":"' . $gambleState . '","winAmount":' . ($totalWin * 100) . ',"gameIdentificationNumber":' . $postData['gameIdentificationNumber'] . ',"gameNumber":"","sessionKey":"88e2b82e6537db4a339e4e1b5ce462cd","msg":"success","messageId":"' . $postData['messageId'] . '","qName":"app.services.messages.response.GameEventResponse","command":"bet","eventTimestamp":' . time() . '}';
                                break;
                        }
