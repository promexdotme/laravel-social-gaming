            ...
            \DB::transaction(function() use ($request, $game)
            {
                try
                {
                    ...
                    else if( $postData['slotEvent'] == 'gamble5GetUserCards' ) 
                    {
                        ...
                        $dealerCard = $slotSettings->GetGameData('GreatRhinoPMDealerCard');
                    ...
                    else if( $postData['slotEvent'] == 'gamble5GetDealerCard' ) 
                    {
                        ...
                        $slotSettings->SetGameData('GreatRhinoPMDealerCard', $tmpDc);
                    ...
                    else if( $postData['slotEvent'] == 'doSpin' ) 
                    {
                        ...
                        if( $postData['slotEvent'] == 'freespin' ) 
                        {
                            ...
                            {
                                $spinType = 'c';
                                $winString .= ('&fs_total=' . $slotSettings->GetGameData('GreatRhinoPMFreeGames') . '&fsmul_total=' . $slotSettings->GetGameData('GreatRhinoPMBonusMpl') . '&fswin_total=' . $slotSettings->GetGameData('GreatRhinoPMBonusWin') . '&fsres_total=' . $slotSettings->GetGameData('GreatRhinoPMBonusWin') . '');
                            }
                            else
                            {
                                $winString .= ('&fsmul=' . $slotSettings->GetGameData('GreatRhinoPMBonusMpl') . '&fsmax=' . $slotSettings->GetGameData('GreatRhinoPMFreeGames') . '&fswin=' . $slotSettings->GetGameData('GreatRhinoPMTotalWin') . '&fs=' . $slotSettings->GetGameData('GreatRhinoPMCurrentFreeGame') . '&fsres=' . $slotSettings->GetGameData('GreatRhinoPMBonusWin'));
                            }
                        ...
                        $response_log = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{"BonusMpl":' . $slotSettings->GetGameData('GreatRhinoPMBonusMpl') . ',"lines":' . $postData['slotLines'] . ',"bet":' . $postData['slotBet'] . ',"totalFreeGames":' . $slotSettings->GetGameData('GreatRhinoPMFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('GreatRhinoPMCurrentFreeGame') . ',"Balance":' . $Balance . ',"afterBalance":' . $slotSettings->GetBalance() . ',"totalWin":' . $totalWin . ',"bonusWin":' . $slotSettings->GetGameData('GreatRhinoPMBonusWin') . ',"winLines":[],"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
