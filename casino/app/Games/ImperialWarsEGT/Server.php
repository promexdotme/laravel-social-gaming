                    ...
                    try
                    {
                        ...
                        switch( $aid ) 
                        {
                            ...
                            case 'settings':
                                ...
                                $result_tmp[] = '{"complex":{"balance":' . $balanceInCents . ',"balanceRaw":' . round($balanceInCents * $slotSettings->CurrentDenom) . ',"paytableCoef":{"0":{"coef":[5,20,100],"multiplier":1},"1":{"coef":[5,20,100],"multiplier":1},"2":{"coef":[5,20,100],"multiplier":1},"3":{"coef":[10,25,150],"multiplier":1},"4":{"coef":[10,25,150],"multiplier":1},"5":{"coef":[10,50,200],"multiplier":1},"6":{"coef":[10,50,250],"multiplier":1},"7":{"coef":[15,100,500],"multiplier":1},"8":{"coef":[15,150,1000],"multiplier":1},"9":{"coef":[0,0],"multiplier":1},"10":{"coef":[25,200,2000],"multiplier":1},"11":{"coef":[],"multiplier":1}},"bets":[' . implode(',', $gameBets) . '],"jackpotMinBet":1,"jackpot":true,"mainFakeReels":[[2,4,10,3,2,7,0,6,3,4,9,0,5,6,1,2,10,4,5,8],[7,8,0,1,3,3,4,6,0,5,7,0,9,1,5,0,7,2,5,1],[0,3,9,7,1,0,6,3,0,8,3,0,6,1,4,6,2,7,4,5],[3,6,0,3,7,0,4,8,0,2,6,8,5,7,3,6,10,4,10,2],[2,10,3,0,10,7,0,5,6,2,4,4,7,3,4,6,5,1,8,4]],"jackpotMaxBet":100000,"denominations":[' . implode(',', $denoms) . ']},"gameIdentificationNumber":' . $postData['gameIdentificationNumber'] . ',"gameNumber":-1,"sessionKey":"41be9e65e0ff03a65e8c93576bf61130","msg":"success","messageId":"' . $postData['messageId'] . '","qName":"app.services.messages.response.GameResponse","command":"settings","eventTimestamp":' . time() . '}';
                                break;
                            case 'subscribe':
                                $hist = [
                                    78, 
                                ...
                                shuffle($hist);
                                $slotSettings->SetGameData('ImperialWarsEGTCards', $hist);
                                $lastEvent = $slotSettings->GetHistory();
                                $slotSettings->SetGameData('ImperialWarsEGTBonusWin', 0);
                                $slotSettings->SetGameData('ImperialWarsEGTFreeGames', 0);
                                $slotSettings->SetGameData('ImperialWarsEGTCurrentFreeGame', 0);
                                $slotSettings->SetGameData('ImperialWarsEGTTotalWin', 0);
                                $slotSettings->SetGameData('ImperialWarsEGTFreeBalance', 0);
                                if( $lastEvent != 'NULL' ) 
                                {
                                    ...
                                    $slotSettings->SetGameData('ImperialWarsEGTCurrentSeq', $lastEvent->serverResponse->curSeq);
                                    ...
                                    $gtype = 1;
                                    if( $slotSettings->GetGameData('ImperialWarsEGTCurrentFreeGame') < $slotSettings->GetGameData('ImperialWarsEGTFreeGames') && $slotSettings->GetGameData('ImperialWarsEGTFreeGames') > 0 ) 
                                    {
                                        $gtype = 2;
                                    }
                                }
                            ...
                            case 'bet':
                                ...
                                if( $postData['slotEvent'] != 'freespin' ) 
                                {
                                    ...
                                    $slotSettings->SetGameData('ImperialWarsEGTCurrentFreeGame', 0);
                                    $slotSettings->SetGameData('ImperialWarsEGTTotalWin', 0);
                                    $slotSettings->SetGameData('ImperialWarsEGTFreeBalance', sprintf('%01.2f', $slotSettings->GetBalance()) * 100);
                                    $bonusMpl = 1;
                                }
                                else
                                {
                                    $slotSettings->SetGameData('ImperialWarsEGTCurrentFreeGame', $slotSettings->GetGameData('ImperialWarsEGTCurrentFreeGame') + 1);
                                    $bonusMpl = $slotSettings->slotFreeMpl;
                                }
                                $winTypeTmp = $slotSettings->GetSpinSettings($postData['slotEvent'], $allbet, $lines);
                                $winType = $winTypeTmp[0];
                                $spinWinLimit = $winTypeTmp[1];
                                if( $winType == 'bonus' && $slotSettings->GetBank((isset($postData['slotEvent']) ? $postData['slotEvent'] : '')) < (50 * $betline * $lines * 5) ) 
                                {
                                    $winType = 'none';
                                }
                                $balanceInCents = sprintf('%01.2f', $slotSettings->GetBalance()) * 100;
                                ...
                                if( $winType == 'bonus' ) 
                                {
                                    ...
                                    if( $wlb != 'NULL' ) 
                                    {
                                        ...
                                        $slotSettings->SetGameData('ImperialWarsEGTCurrentSeq', $curSeq);
                                        if( $curSeqWin > 0 ) 
                                        {
                                ...
                                for( $i = 0; $i <= 2000; $i++ ) 
                                {
                                    ...
                                    {
                                        $curSeq = (array)$slotSettings->GetGameData('ImperialWarsEGTCurrentSeq');
                                        $curSeq['result'] = (array)$curSeq['result'];
                                        $curSeq['result'][$slotSettings->GetGameData('ImperialWarsEGTCurrentFreeGame')] = (array)$curSeq['result'][$slotSettings->GetGameData('ImperialWarsEGTCurrentFreeGame')];
                                        $curSeq['result'][$slotSettings->GetGameData('ImperialWarsEGTCurrentFreeGame')]['reels'] = (array)$curSeq['result'][$slotSettings->GetGameData('ImperialWarsEGTCurrentFreeGame')]['reels'];
                                        $reels = $curSeq['result'][$slotSettings->GetGameData('ImperialWarsEGTCurrentFreeGame')]['reels'];
                                    }
                                    if( $postData['slotEvent'] == 'freespin' ) 
                                    {
                                        $reels['reel1'][0] = '10';
                                ...
                                if( $postData['slotEvent'] == 'freespin' ) 
                                {
                                    $slotSettings->SetGameData('ImperialWarsEGTBonusWin', $slotSettings->GetGameData('ImperialWarsEGTBonusWin') + $totalWin);
                                    $slotSettings->SetGameData('ImperialWarsEGTTotalWin', $slotSettings->GetGameData('ImperialWarsEGTTotalWin') + $totalWin);
                                    $balanceInCents = $slotSettings->GetGameData('ImperialWarsEGTFreeBalance');
                                }
                                else
                                {
                                    $slotSettings->SetGameData('ImperialWarsEGTTotalWin', $totalWin);
                                }
                                $fs = 0;
                                if( $scattersCount >= 3 ) 
                                {
                                    if( $slotSettings->GetGameData('ImperialWarsEGTFreeGames') > 0 ) 
                                    {
                                        $slotSettings->SetGameData('ImperialWarsEGTFreeGames', $slotSettings->GetGameData('ImperialWarsEGTFreeGames') + $slotSettings->slotFreeCount);
                                    }
                                    else
                                    {
                                        $slotSettings->SetGameData('ImperialWarsEGTFreeStartWin', $totalWin);
                                        $slotSettings->SetGameData('ImperialWarsEGTBonusWin', $totalWin);
                                        $slotSettings->SetGameData('ImperialWarsEGTFreeGames', $slotSettings->slotFreeCount);
                                    }
                                    $fs = $slotSettings->GetGameData('ImperialWarsEGTFreeGames');
                                }
                                $curReels = '' . rand(0, 6) . ',' . $reels['reel1'][0] . ',' . $reels['reel1'][1] . ',' . $reels['reel1'][2] . ',' . rand(0, 6);
                                $curReels .= (',' . rand(0, 6) . ',' . $reels['reel2'][0] . ',' . $reels['reel2'][1] . ',' . $reels['reel2'][2] . ',' . rand(0, 6));
                                $curReels .= (',' . rand(0, 6) . ',' . $reels['reel3'][0] . ',' . $reels['reel3'][1] . ',' . $reels['reel3'][2] . ',' . rand(0, 6));
                                ...
                                $response = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{"curSeq":' . json_encode($curSeq) . ',"slotLines":' . $lines . '' . $slotSettings->GetGameData($slotSettings->slotId . 'FirstSpin') . ',"slotBet":' . $betline . ',"totalFreeGames":' . $slotSettings->GetGameData('ImperialWarsEGTFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('ImperialWarsEGTCurrentFreeGame') . ',"Balance":' . $balanceInCents . ',"afterBalance":' . $balanceInCents . ',"bonusWin":' . $slotSettings->GetGameData('ImperialWarsEGTBonusWin') . ',"totalWin":' . $totalWin . ',"winLines":[' . $winString . '],"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
                                $slotSettings->SaveLogReport($response, $allbet, $lines, $reportWin, $postData['slotEvent']);
                                $winstring = '';
                                $slotSettings->SetGameData('ImperialWarsEGTGambleStep', 5);
                                $hist = $slotSettings->GetGameData('ImperialWarsEGTCards');
                                if( $jackRandom == 1 ) 
                                {
                                    $state = 'jackpot';
                                    $isJack = 'true';
                                    $slotSettings->SetGameData('ImperialWarsEGTJackSteps', [
                                        0, 
                                        0, 
                                        0, 
                                        0
                                ...
                                if( $postData['slotEvent'] == 'freespin' ) 
                                {
                                    $totalWin = $slotSettings->GetGameData('ImperialWarsEGTBonusWin');
                                    $state = 'freespin';
                                    $holdReels = '0,1,2';
                                ...
                                break;
                            case 'collect':
                                $result_tmp[] = '{"complex":{"gameCommand":"collect"},"state":"idle","winAmount":' . ($slotSettings->GetGameData('ImperialWarsEGTTotalWin') * 100) . ',"gameIdentificationNumber":' . $postData['gameIdentificationNumber'] . ',"gameNumber":"","balance":' . $balanceInCents . ',"sessionKey":"41be9e65e0ff03a65e8c93576bf61130","msg":"success","messageId":"' . $postData['messageId'] . '","qName":"app.services.messages.response.GameEventResponse","command":"bet","eventTimestamp":' . time() . '}';
                                $slotSettings->SetGameData('ImperialWarsEGTTotalWin', 0);
                                break;
                            case 'jackpot':
                                $jackStep = $slotSettings->GetGameData('ImperialWarsEGTJackSteps');
                                $jackWinID = $slotSettings->GetGameData($slotSettings->slotId . 'JackWinID');
                                if( $jackStep[0] >= 3 || $jackStep[1] >= 3 || $jackStep[2] >= 3 || $jackStep[3] >= 3 || !$slotSettings->HasGameData('ImperialWarsEGTJackSteps') ) 
                                {
                                    exit();
                                }
                                $winAmount = 0;
                                ...
                                $slotSettings->SetGameData('ImperialWarsEGTJackSteps', $jackStep);
                                break;
                            case 'gamble':
                                $Balance = $slotSettings->GetBalance();
                                $isGambleWin = rand(1, $slotSettings->GetGambleSettings());
                                $dealerCard = '';
                                $totalWin = $slotSettings->GetGameData('ImperialWarsEGTTotalWin');
                                $gambleWin = 0;
                                $statBet = $totalWin;
                                $slotSettings->SetGameData('ImperialWarsEGTGambleStep', $slotSettings->GetGameData('ImperialWarsEGTGambleStep') - 1);
                                ...
                                else
                                {
                                    ...
                                    $totalWin = 0;
                                    $slotSettings->SetGameData('ImperialWarsEGTGambleStep', 0);
                                    if( $postData['bet']['color'] == '1' ) 
                                    {
                                        $tmpCards = [
                                            '1', 
                                ...
                                $gtype = 1;
                                $gtype0 = 1;
                                if( $slotSettings->GetGameData('ImperialWarsEGTBonusStart') == 1 ) 
                                {
                                    $gtype0 = 2;
                                }
                                $result_tmp[] = '{"complex":{"gambles":' . $slotSettings->GetGameData('ImperialWarsEGTGambleStep') . ',"card":' . $dealerCard . ',"jackpot":false,"gameCommand":"gamble"},"state":"' . $gambleState . '","winAmount":' . ($totalWin * 100) . ',"gameIdentificationNumber":' . $postData['gameIdentificationNumber'] . ',"gameNumber":"","sessionKey":"88e2b82e6537db4a339e4e1b5ce462cd","msg":"success","messageId":"' . $postData['messageId'] . '","qName":"app.services.messages.response.GameEventResponse","command":"bet","eventTimestamp":' . time() . '}';
                                break;
                        }
