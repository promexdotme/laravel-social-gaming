                    ...
                    try
                    {
                        ...
                        if( isset($postData['spinType']) ) 
                        {
                            ...
                            if( $postData['spinType'] == 'regular' ) 
                            {
                                ...
                                $bonusMpl = 1;
                                $slotSettings->SetGameData('BermudaTrianglePTMMBonusWin', 0);
                                $slotSettings->SetGameData('BermudaTrianglePTMMFreeGames', 0);
                                $slotSettings->SetGameData('BermudaTrianglePTMMCurrentFreeGame', 0);
