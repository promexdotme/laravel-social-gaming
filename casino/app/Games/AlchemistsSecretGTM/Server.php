                ...
                \DB::transaction(function() use ($request, $game)
                {
                    try
                    {
                        ...
                        else if( $postData['slotEvent'] == 'gamble5GetUserCards' ) 
                        {
                            ...
                            $dealerCard = $slotSettings->GetGameData('AlchemistsSecretGTMDealerCard');
                            $totalWin = $slotSettings->GetGameData('AlchemistsSecretGTMTotalWin');
                            $gambleWin = 0;
                            ...
                            $slotSettings->SetGameData('AlchemistsSecretGTMTotalWin', $totalWin);
                        ...
                        else if( $postData['slotEvent'] == 'gamble5GetDealerCard' ) 
                        {
                            ...
                            $slotSettings->SetGameData('AlchemistsSecretGTMDealerCard', $tmpDc);
                        ...
                        else if( $postData['slotEvent'] == 'bet' || $postData['slotEvent'] == 'freespin' ) 
                        {
                            ...
                            if( $postData['slotEvent'] != 'freespin' ) 
                            {
                                ...
                                $bonusMpl = 1;
                                $slotSettings->SetGameData('AlchemistsSecretGTMBonusWin', 0);
                                $slotSettings->SetGameData('AlchemistsSecretGTMFreeGames', 0);
                                $slotSettings->SetGameData('AlchemistsSecretGTMCurrentFreeGame', 0);
                                $slotSettings->SetGameData('AlchemistsSecretGTMTotalWin', 0);
                                $slotSettings->SetGameData('AlchemistsSecretGTMFreeBalance', 0);
                                $slotSettings->SetGameData('AlchemistsSecretGTMFreeStacked', [
                                    'false', 
                                    'false', 
                                    'false', 
                                    'false', 
                                ...
                                $slotSettings->SetGameData('AlchemistsSecretGTMFreeSeries', 0);
                            ...
                            else
                            {
                                ...
                                $slotSettings->SetGameData('AlchemistsSecretGTMCurrentFreeGame', $slotSettings->GetGameData('AlchemistsSecretGTMCurrentFreeGame') + 1);
                                $bonusMpl = $slotSettings->slotFreeMpl;
                                if( $slotSettings->GetGameData('AlchemistsSecretGTMCurrentFreeGame') == $slotSettings->GetGameData('AlchemistsSecretGTMFreeGames') ) 
                                {
                            ...
                            for( $i = 0; $i <= 2000; $i++ ) 
                            {
                                ...
                                if( $postData['slotEvent'] == 'freespin' ) 
                                {
                                    ...
                                    for( $ii = 1; $ii <= 5; $ii++ ) 
                                    {
                                        if( $slotSettings->GetGameData('AlchemistsSecretGTMFreeStacked')[$stackCount] == 'true' ) 
                                        {
                                    ...
                                    for( $j = 0; $j < count($slotSettings->SymbolGame); $j++ ) 
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            if( $s[0] == $csym || in_array($s[0], $wild) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":1,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('AlchemistsSecretGTMBonusWin')) . ',"winReel1":[' . ($linesId[$k + 1][0] - 1) . ',"' . $s[0] . '"],"winReel2":["none","none"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":2,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('AlchemistsSecretGTMBonusWin')) . ',"winReel1":[' . ($linesId[$k + 1][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k + 1][1] - 1) . ',"' . $s[1] . '"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            $s[0] = $reels['reel1'][$linesId[$k + 1][0] - 1];
                                            $s[1] = $reels['reel2'][$linesId[$k + 1][1] - 1];
                                            ...
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":3,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('AlchemistsSecretGTMBonusWin')) . ',"winReel1":[' . ($linesId[$k + 1][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k + 1][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k + 1][2] - 1) . ',"' . $s[2] . '"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            $s[0] = $reels['reel1'][$linesId[$k + 1][0] - 1];
                                            $s[1] = $reels['reel2'][$linesId[$k + 1][1] - 1];
                                            ...
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) && ($s[3] == $csym || in_array($s[3], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":4,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('AlchemistsSecretGTMBonusWin')) . ',"winReel1":[' . ($linesId[$k + 1][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k + 1][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k + 1][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k + 1][3] - 1) . ',"' . $s[3] . '"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            $s[0] = $reels['reel1'][$linesId[$k + 1][0] - 1];
                                            $s[1] = $reels['reel2'][$linesId[$k + 1][1] - 1];
                                            ...
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) && ($s[3] == $csym || in_array($s[3], $wild)) && ($s[4] == $csym || in_array($s[4], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":5,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('AlchemistsSecretGTMBonusWin')) . ',"winReel1":[' . ($linesId[$k + 1][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k + 1][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k + 1][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k + 1][3] - 1) . ',"' . $s[3] . '"],"winReel5":[' . ($linesId[$k + 1][4] - 1) . ',"' . $s[4] . '"]}';
                                                }
                                                if( $isSlotJack ) 
                                                {
                                                    $tmpStringWin = '';
                            ...
                            if( $postData['slotEvent'] == 'freespin' && $slotSettings->GetGameData('AlchemistsSecretGTMFreeGames') <= $slotSettings->GetGameData('AlchemistsSecretGTMCurrentFreeGame') && $winType != 'bonus' && $slotSettings->GetGameData('AlchemistsSecretGTMTotalWin') + $totalWin > 0 ) 
                            {
                                $slotSettings->SetBalance($slotSettings->GetGameData('AlchemistsSecretGTMTotalWin') + $totalWin);
                            }
                            ...
                            if( $postData['slotEvent'] == 'freespin' ) 
                            {
                                $slotSettings->SetGameData('AlchemistsSecretGTMBonusWin', $slotSettings->GetGameData('AlchemistsSecretGTMBonusWin') + $totalWin);
                                $slotSettings->SetGameData('AlchemistsSecretGTMTotalWin', $slotSettings->GetGameData('AlchemistsSecretGTMTotalWin') + $totalWin);
                                $totalWin = $slotSettings->GetGameData('AlchemistsSecretGTMBonusWin');
                                $Balance = $slotSettings->GetGameData('AlchemistsSecretGTMFreeBalance');
                                $stackCount = 1;
                                $stackA = $slotSettings->GetGameData('AlchemistsSecretGTMFreeStacked');
                                for( $i = 1; $i <= 5; $i++ ) 
                                {
                                    if( $reels['reel' . $i][0] == 'SCAT' ) 
                                    {
                                        $stackA[$stackCount] = true;
                                    }
                                    $stackCount++;
                                ...
                                $slotSettings->SetGameData('AlchemistsSecretGTMFreeStacked', $stackA);
                            }
                            else
                            {
                                $slotSettings->SetGameData('AlchemistsSecretGTMTotalWin', $totalWin);
                            ...
                            if( $scattersCount >= 3 ) 
                            {
                                if( $slotSettings->GetGameData('AlchemistsSecretGTMFreeGames') > 0 ) 
                                {
                                    $slotSettings->SetGameData('AlchemistsSecretGTMFreeBalance', $Balance);
                                    $slotSettings->SetGameData('AlchemistsSecretGTMBonusWin', $totalWin);
                                    $slotSettings->SetGameData('AlchemistsSecretGTMFreeGames', $slotSettings->GetGameData('AlchemistsSecretGTMFreeGames') + $slotSettings->slotFreeCount);
                                }
                                else
                                {
                                    $slotSettings->SetGameData('AlchemistsSecretGTMFreeBalance', $Balance);
                                    $slotSettings->SetGameData('AlchemistsSecretGTMBonusWin', $totalWin);
                                    $slotSettings->SetGameData('AlchemistsSecretGTMFreeGames', $slotSettings->slotFreeCount);
                                    $stackCount = 1;
                                    $stackA = $slotSettings->GetGameData('AlchemistsSecretGTMFreeStacked');
                                    for( $i = 1; $i <= 5; $i++ ) 
                                    {
                            ...
                            $response = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{"curSeq":' . json_encode($curSeq) . ',"slotLines":' . $postData['slotLines'] . ',"slotBet":' . $postData['slotBet'] . ',"slotJackpot":' . $slotSettings->slotJackpot[0] . ',"stackedWilds":[' . implode(',', $slotSettings->GetGameData('AlchemistsSecretGTMFreeStacked')) . '],"totalFreeGames":' . $slotSettings->GetGameData('AlchemistsSecretGTMFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('AlchemistsSecretGTMCurrentFreeGame') . ',"Balance":' . $Balance . ',"afterBalance":' . $slotSettings->GetBalance() . ',"totalWin":' . $totalWin . ',"winLines":[' . $winString . '],"bonusInfo":' . $scattersStr . ',"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
                            $response_log = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{"curSeq":' . json_encode($curSeq) . ',"slotLines":' . $postData['slotLines'] . ',"slotBet":' . $postData['slotBet'] . ',"slotJackpot":' . $slotSettings->slotJackpot[0] . ',"stackedWilds":[' . implode(',', $slotSettings->GetGameData('AlchemistsSecretGTMFreeStacked')) . '],"totalFreeGames":' . $slotSettings->GetGameData('AlchemistsSecretGTMFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('AlchemistsSecretGTMCurrentFreeGame') . ',"Balance":' . $Balance . ',"afterBalance":' . $slotSettings->GetBalance() . ',"totalWin":' . $totalWin . ',"winLines":[' . $winString . '],"bonusInfo":' . $scattersStr . ',"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
