                ...
                \DB::transaction(function() use ($request, $game)
                {
                    try
                    {
                        ...
                        else if( $postData['slotEvent'] == 'gamble5GetUserCards' ) 
                        {
                            ...
                            $dealerCard = $slotSettings->GetGameData('KingsTreasureGTMDealerCard');
                            $totalWin = $slotSettings->GetGameData('KingsTreasureGTMTotalWin');
                            $gambleWin = 0;
                            ...
                            $slotSettings->SetGameData('KingsTreasureGTMTotalWin', $totalWin);
                        ...
                        else if( $postData['slotEvent'] == 'gamble5GetDealerCard' ) 
                        {
                            ...
                            $slotSettings->SetGameData('KingsTreasureGTMDealerCard', $tmpDc);
                        ...
                        else if( $postData['slotEvent'] == 'bet' || $postData['slotEvent'] == 'freespin' ) 
                        {
                            ...
                            if( $postData['slotEvent'] != 'freespin' ) 
                            {
                                ...
                                $bonusMpl = 1;
                                $slotSettings->SetGameData('KingsTreasureGTMBonusWin', 0);
                                $slotSettings->SetGameData('KingsTreasureGTMFreeGames', 0);
                                $slotSettings->SetGameData('KingsTreasureGTMCurrentFreeGame', 0);
                                $slotSettings->SetGameData('KingsTreasureGTMTotalWin', 0);
                                $slotSettings->SetGameData('KingsTreasureGTMFreeBalance', 0);
                            }
                            else
                            {
                                $slotSettings->SetGameData('KingsTreasureGTMCurrentFreeGame', $slotSettings->GetGameData('KingsTreasureGTMCurrentFreeGame') + 1);
                                    ...
                                    for( $j = 0; $j < count($slotSettings->SymbolGame); $j++ ) 
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            if( $s[0] == $csym || in_array($s[0], $wild) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":1,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('KingsTreasureGTMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":["none","none"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":2,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('KingsTreasureGTMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            $s[0] = $reels['reel1'][$linesId[$k][0] - 1];
                                            $s[1] = $reels['reel2'][$linesId[$k][1] - 1];
                                            ...
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":3,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('KingsTreasureGTMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            $s[0] = $reels['reel1'][$linesId[$k][0] - 1];
                                            $s[1] = $reels['reel2'][$linesId[$k][1] - 1];
                                            ...
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) && ($s[3] == $csym || in_array($s[3], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":4,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('KingsTreasureGTMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            $s[0] = $reels['reel1'][$linesId[$k][0] - 1];
                                            $s[1] = $reels['reel2'][$linesId[$k][1] - 1];
                                            ...
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) && ($s[3] == $csym || in_array($s[3], $wild)) && ($s[4] == $csym || in_array($s[4], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":5,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('KingsTreasureGTMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":[' . ($linesId[$k][4] - 1) . ',"' . $s[4] . '"]}';
                                                }
                                                if( $csym == 'P_1' ) 
                                                {
                                                    $isSlotJack = true;
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":5,"Line":' . $k . ',"Win":"JACK","stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('KingsTreasureGTMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":[' . ($linesId[$k][4] - 1) . ',"' . $s[4] . '"]}';
                                                }
                                            }
                                        }
                                    }
                            ...
                            if( $postData['slotEvent'] == 'freespin' && $slotSettings->GetGameData('KingsTreasureGTMFreeGames') <= $slotSettings->GetGameData('KingsTreasureGTMCurrentFreeGame') && $winType != 'bonus' && $slotSettings->GetGameData('KingsTreasureGTMTotalWin') + $totalWin > 0 ) 
                            {
                                $slotSettings->SetBalance($slotSettings->GetGameData('KingsTreasureGTMTotalWin') + $totalWin);
                            }
                            ...
                            if( $postData['slotEvent'] == 'freespin' ) 
                            {
                                $slotSettings->SetGameData('KingsTreasureGTMBonusWin', $slotSettings->GetGameData('KingsTreasureGTMBonusWin') + $totalWin);
                                $slotSettings->SetGameData('KingsTreasureGTMTotalWin', $slotSettings->GetGameData('KingsTreasureGTMTotalWin') + $totalWin);
                                $totalWin = $slotSettings->GetGameData('KingsTreasureGTMBonusWin');
                                $Balance = $slotSettings->GetGameData('KingsTreasureGTMFreeBalance');
                            }
                            else
                            {
                                $slotSettings->SetGameData('KingsTreasureGTMTotalWin', $totalWin);
                            }
                            $ClLOmJbJVbjmyHqNurOwcCUCaAiO4 = 0;
                            if( $scattersCount >= 3 ) 
                            {
                                if( $slotSettings->GetGameData('KingsTreasureGTMFreeGames') > 0 ) 
                                {
                                    $slotSettings->SetGameData('KingsTreasureGTMFreeBalance', $Balance);
                                    $slotSettings->SetGameData('KingsTreasureGTMBonusWin', $totalWin);
                                    $slotSettings->SetGameData('KingsTreasureGTMFreeGames', $slotSettings->GetGameData('KingsTreasureGTMFreeGames') + $slotSettings->slotFreeCount[$scattersCount]);
                                    $ClLOmJbJVbjmyHqNurOwcCUCaAiO4 = $slotSettings->slotFreeCount[$scattersCount];
                                }
                                else
                                {
                                    $slotSettings->SetGameData('KingsTreasureGTMFreeBalance', $Balance);
                                    $slotSettings->SetGameData('KingsTreasureGTMBonusWin', $totalWin);
                                    $slotSettings->SetGameData('KingsTreasureGTMFreeGames', $slotSettings->slotFreeCount[$scattersCount]);
                                    $ClLOmJbJVbjmyHqNurOwcCUCaAiO4 = $slotSettings->slotFreeCount[$scattersCount];
                                }
                            }
                            ...
                            $response = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{"slotLines":' . $postData['slotLines'] . ',"slotBet":' . $postData['slotBet'] . ',"slotCurrentFree":' . $ClLOmJbJVbjmyHqNurOwcCUCaAiO4 . ',"slotJackpot":' . $slotSettings->slotJackpot[0] . ',"totalFreeGames":' . $slotSettings->GetGameData('KingsTreasureGTMFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('KingsTreasureGTMCurrentFreeGame') . ',"Balance":' . $Balance . ',"afterBalance":' . $slotSettings->GetBalance() . ',"totalWin":' . $totalWin . ',"winLines":[' . $winString . '],"bonusInfo":' . $scattersStr . ',"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
