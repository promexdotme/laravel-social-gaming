                    ...
                    try
                    {
                        ...
                        if( isset($postData['spinType']) ) 
                        {
                            ...
                            if( $postData['spinType'] == 'regular' ) 
                            {
                                ...
                                $bonusMpl = 1;
                                $slotSettings->SetGameData('HalloweenFortunePTBonusWin', 0);
                                $slotSettings->SetGameData('HalloweenFortunePTFreeGames', 0);
                                $slotSettings->SetGameData('HalloweenFortunePTCurrentFreeGame', 0);
                                $slotSettings->SetGameData('HalloweenFortunePTTotalWin', 0);
                                $slotSettings->SetGameData('HalloweenFortunePTFreeBalance', 0);
                                $slotSettings->SetGameData('HalloweenFortunePTFreeStartWin', 0);
                                $slotSettings->SetGameData('HalloweenFortunePTFreeMpl', 0);
                            }
                            else if( $postData['spinType'] == 'free' ) 
                            {
                                $umid = '0';
                                $postData['slotEvent'] = 'freespin';
                                $slotSettings->SetGameData('HalloweenFortunePTCurrentFreeGame', $slotSettings->GetGameData('HalloweenFortunePTCurrentFreeGame') + 1);
                                $bonusMpl = $slotSettings->GetGameData('HalloweenFortunePTFreeMpl');
                            }
                            $linesId[0] = [
                                2, 
                                2, 
                                    ...
                                    for( $j = 0; $j < count($slotSettings->SymbolGame); $j++ ) 
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            if( $s[0] == $csym || in_array($s[0], $wild) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":1,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('HalloweenFortunePTBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":["none","none"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":2,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('HalloweenFortunePTBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":3,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('HalloweenFortunePTBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) && ($s[3] == $csym || in_array($s[3], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":4,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('HalloweenFortunePTBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) && ($s[3] == $csym || in_array($s[3], $wild)) && ($s[4] == $csym || in_array($s[4], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":5,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('HalloweenFortunePTBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":[' . ($linesId[$k][4] - 1) . ',"' . $s[4] . '"]}';
                                                }
                                            }
                                        }
                                    }
                            ...
                            if( $postData['slotEvent'] == 'freespin' ) 
                            {
                                $slotSettings->SetGameData('HalloweenFortunePTBonusWin', $slotSettings->GetGameData('HalloweenFortunePTBonusWin') + $totalWin);
                                $slotSettings->SetGameData('HalloweenFortunePTTotalWin', $totalWin);
                            }
                            else
                            {
                                $slotSettings->SetGameData('HalloweenFortunePTTotalWin', $totalWin);
                            ...
                            if( $scattersCount >= 2 ) 
                            {
                                if( $slotSettings->GetGameData('HalloweenFortunePTFreeGames') > 0 ) 
                                {
                                    $winValuesAll = [
                                        1, 
                                        2, 
                                    ...
                                    $slotSettings->SetGameData('HalloweenFortunePTFreeGames', $slotSettings->GetGameData('HalloweenFortunePTFreeGames') + $winValues[0]);
                                }
                                else
                                {
                                    $slotSettings->SetGameData('HalloweenFortunePTFreeStartWin', $totalWin);
                                    $slotSettings->SetGameData('HalloweenFortunePTBonusWin', 0);
                                    $slotSettings->SetGameData('HalloweenFortunePTFreeGames', $slotSettings->slotFreeCount);
                                    $winValuesAll = [
                                        1, 
                                        2, 
                                        3, 
                                    ...
                                    $result_tmp[] = '3:::{"data":{"winValues":[' . implode(',', $winValues) . ',' . implode(',', $mplValues) . '],"pickWitches":[' . implode(',', $winValues) . '],"pickPotions":[' . implode(',', $mplValues) . '],"windowId":"Ud95Li"},"ID":40204,"umid":1664}';
                                    $slotSettings->SetGameData('HalloweenFortunePTFreeGames', $winValues[0]);
                                    $slotSettings->SetGameData('HalloweenFortunePTFreeMpl', $mplValues[0]);
                                }
                            }
                            $balanceInCents = sprintf('%01.2f', $slotSettings->GetBalance()) * 100;
                            ...
                            $response = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{"FreeMpl":' . $slotSettings->GetGameData('HalloweenFortunePTFreeMpl') . ',"linesArr":[' . implode(',', $postData['lines']) . '],"slotLines":' . $lines . ',"slotBet":' . $betLine . ',"totalFreeGames":' . $slotSettings->GetGameData('HalloweenFortunePTFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('HalloweenFortunePTCurrentFreeGame') . ',"Balance":' . $slotSettings->GetBalance() . ',"afterBalance":' . $slotSettings->GetBalance() . ',"bonusWin":' . $slotSettings->GetGameData('HalloweenFortunePTBonusWin') . ',"freeStartWin":' . $slotSettings->GetGameData('HalloweenFortunePTFreeStartWin') . ',"totalWin":' . $totalWin . ',"winLines":[' . $winString . '],"bonusInfo":' . $scattersStr . ',"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
