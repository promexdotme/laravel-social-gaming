                    ...
                    try
                    {
                        ...
                        switch( $aid ) 
                        {
                            ...
                            case 'settings':
                                ...
                                $result_tmp[] = '{"complex":{"balance":' . $balanceInCents . ',"balanceRaw":' . round($balanceInCents * $slotSettings->CurrentDenom) . ',"paytableCoef":{"0":{"coef":[5,20,100],"multiplier":2},"1":{"coef":[5,20,100],"multiplier":2},"2":{"coef":[5,20,100],"multiplier":2},"3":{"coef":[10,50,200],"multiplier":2},"4":{"coef":[10,50,200],"multiplier":2},"5":{"coef":[20,125,400],"multiplier":2},"6":{"coef":[5,25,150,500],"multiplier":2},"7":{"coef":[5,25,150,500],"multiplier":2},"8":{"coef":[10,100,500,1000],"multiplier":1},"9":{"coef":[2],"multiplier":1}},"bets":[' . implode(',', $gameBets) . '],"jackpotMinBet":1,"jackpot":true,"freespinFakeReels":[[1,4,5,2,0,8,1,2,7,0,1,5,4,6,3,2,7,1,3,6],[4,5,2,8,1,7,4,9,3,5,1,9,2,6,0,3,9,5,6,1],[7,3,1,0,1,2,5,9,2,6,3,1,6,2,9,3,5,8,4,0],[5,6,3,2,5,4,0,9,3,2,1,0,1,7,4,2,8,3,4,7],[7,4,2,8,1,6,5,0,4,3,6,5,7,1,4,0,8,3,4,1]],"jackpotMinBet":1,"jackpot":true,"mainFakeReels":[[1,4,5,2,0,8,1,2,7,0,1,5,4,6,3,2,7,1,3,6],[4,5,2,8,1,7,4,9,3,5,1,9,2,6,0,3,9,5,6,1],[7,3,1,0,1,2,5,9,2,6,3,1,6,2,9,3,5,8,4,0],[5,6,3,2,5,4,0,9,3,2,1,0,1,7,4,2,8,3,4,7],[7,4,2,8,1,6,10,0,4,3,6,5,7,1,4,0,8,3,4,10]],"jackpotMaxBet":100000,"denominations":[' . implode(',', $denoms) . ']},"gameIdentificationNumber":' . $postData['gameIdentificationNumber'] . ',"gameNumber":-1,"sessionKey":"41be9e65e0ff03a65e8c93576bf61130","msg":"success","messageId":"' . $postData['messageId'] . '","qName":"app.services.messages.response.GameResponse","command":"settings","eventTimestamp":' . time() . '}';
                                break;
                            case 'subscribe':
                                $hist = [
                                    78, 
                                ...
                                shuffle($hist);
                                $slotSettings->SetGameData('CatsRoyalEGTCards', $hist);
                                $lastEvent = $slotSettings->GetHistory();
                                $slotSettings->SetGameData('CatsRoyalEGTBonusWin', 0);
                                $slotSettings->SetGameData('CatsRoyalEGTFreeGames', 0);
                                $slotSettings->SetGameData('CatsRoyalEGTCurrentFreeGame', 0);
                                $slotSettings->SetGameData('CatsRoyalEGTTotalWin', 0);
                                $slotSettings->SetGameData('CatsRoyalEGTFreeBalance', 0);
                                $slotSettings->SetGameData('CatsRoyalEGTFreeMultiplier', 1);
                                if( $lastEvent != 'NULL' ) 
                                {
                                    ...
                                    $slotSettings->SetGameData($slotSettings->slotId . 'FreeMultiplier', $lastEvent->serverResponse->FreeMultiplier + 1);
                                    ...
                                    $gtype = 1;
                                    if( $slotSettings->GetGameData('CatsRoyalEGTCurrentFreeGame') < $slotSettings->GetGameData('CatsRoyalEGTFreeGames') && $slotSettings->GetGameData('CatsRoyalEGTFreeGames') > 0 ) 
                                    {
                                        $gtype = 2;
                                    }
                                }
                            ...
                            case 'bet':
                                ...
                                if( $postData['slotEvent'] != 'freespin' ) 
                                {
                                    ...
                                    $slotSettings->SetGameData('CatsRoyalEGTTotalWin', 0);
                                    $slotSettings->SetGameData('CatsRoyalEGTFreeMultiplier', 1);
                                    $slotSettings->SetGameData('CatsRoyalEGTFreeBalance', sprintf('%01.2f', $slotSettings->GetBalance()) * 100);
                                    $bonusMpl = 1;
                                }
                                else
                                {
                                    $slotSettings->SetGameData('CatsRoyalEGTCurrentFreeGame', $slotSettings->GetGameData('CatsRoyalEGTCurrentFreeGame') + 1);
                                ...
                                $balanceInCents = sprintf('%01.2f', $slotSettings->GetBalance()) * 100;
                                $bonusMpl = $slotSettings->GetGameData('CatsRoyalEGTFreeMultiplier');
                                ...
                                for( $i = 0; $i <= 2000; $i++ ) 
                                {
                                    ...
                                    $multiplierCoords = [];
                                    $bonusMpl = 1;
                                    if( $postData['slotEvent'] != 'freespin' && ($reels['reel5'][0] == '10' || $reels['reel5'][1] == '10' || $reels['reel5'][2] == '10') ) 
                                    {
                                        if( $reels['reel5'][0] == '10' ) 
                                        {
                                            $multiplierCoords[0] = 4;
                                            $multiplierCoords[1] = 0;
                                        }
                                        if( $reels['reel5'][1] == '10' ) 
                                        {
                                            $multiplierCoords[0] = 4;
                                            $multiplierCoords[1] = 1;
                                        }
                                        if( $reels['reel5'][2] == '10' ) 
                                        {
                                            $multiplierCoords[0] = 4;
                                            $multiplierCoords[1] = 2;
                                        }
                                        $baseMpl = rand(2, 20);
                                        $bonusMpl = $baseMpl;
                                    }
                                        ...
                                        for( $j = 0; $j < count($slotSettings->SymbolGame); $j++ ) 
                                        {
                                            ...
                                            else
                                            {
                                                ...
                                                if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) ) 
                                                {
                                                    ...
                                                    {
                                                        $cWins[$k] = $tmpWin;
                                                        $tmpStringWin = '{"line":' . $k . ',"multiplier":' . $bonusMpl . ',"winAmount":' . ($cWins[$k] * 100) . ',"cells":[0,' . ($linesId[$k][0] - 1) . ',1,' . ($linesId[$k][1] - 1) . '],"freespins":0,"card":' . $csym . '}';
                                                    }
                                                }
                                                if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) ) 
                                                {
                                                    ...
                                                    {
                                                        $cWins[$k] = $tmpWin;
                                                        $tmpStringWin = '{"line":' . $k . ',"multiplier":' . $bonusMpl . ',"winAmount":' . ($cWins[$k] * 100) . ',"cells":[0,' . ($linesId[$k][0] - 1) . ',1,' . ($linesId[$k][1] - 1) . ',2,' . ($linesId[$k][2] - 1) . '],"freespins":0,"card":' . $csym . '}';
                                                    }
                                                }
                                                if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) && ($s[3] == $csym || in_array($s[3], $wild)) ) 
                                                {
                                                    ...
                                                    {
                                                        $cWins[$k] = $tmpWin;
                                                        $tmpStringWin = '{"line":' . $k . ',"multiplier":' . $bonusMpl . ',"winAmount":' . ($cWins[$k] * 100) . ',"cells":[0,' . ($linesId[$k][0] - 1) . ',1,' . ($linesId[$k][1] - 1) . ',2,' . ($linesId[$k][2] - 1) . ',3,' . ($linesId[$k][3] - 1) . '],"freespins":0,"card":' . $csym . '}';
                                                    }
                                                }
                                                if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) && ($s[3] == $csym || in_array($s[3], $wild)) && ($s[4] == $csym || in_array($s[4], $wild)) ) 
                                                {
                                                    ...
                                                    {
                                                        $cWins[$k] = $tmpWin;
                                                        $tmpStringWin = '{"line":' . $k . ',"multiplier":' . $bonusMpl . ',"winAmount":' . ($cWins[$k] * 100) . ',"cells":[0,' . ($linesId[$k][0] - 1) . ',1,' . ($linesId[$k][1] - 1) . ',2,' . ($linesId[$k][2] - 1) . ',3,' . ($linesId[$k][3] - 1) . ',4,' . ($linesId[$k][4] - 1) . '],"freespins":0,"card":' . $csym . '}';
                                                    }
                                                }
                                            }
                                        }
                                ...
                                if( $postData['slotEvent'] == 'freespin' ) 
                                {
                                    $slotSettings->SetGameData('CatsRoyalEGTBonusWin', $slotSettings->GetGameData('CatsRoyalEGTBonusWin') + $totalWin);
                                    $slotSettings->SetGameData('CatsRoyalEGTTotalWin', $slotSettings->GetGameData('CatsRoyalEGTTotalWin') + $totalWin);
                                    $balanceInCents = $slotSettings->GetGameData('CatsRoyalEGTFreeBalance');
                                }
                                else
                                {
                                    $slotSettings->SetGameData('CatsRoyalEGTTotalWin', $totalWin);
                                }
                                $fs = 0;
                                if( $scattersCount >= 3 ) 
                                {
                                    if( $slotSettings->GetGameData('CatsRoyalEGTFreeGames') > 0 ) 
                                    {
                                        $slotSettings->SetGameData('CatsRoyalEGTFreeGames', $slotSettings->GetGameData('CatsRoyalEGTFreeGames') + $slotSettings->slotFreeCount);
                                    }
                                    else
                                    {
                                        $slotSettings->SetGameData('CatsRoyalEGTFreeStartWin', $totalWin);
                                        $slotSettings->SetGameData('CatsRoyalEGTBonusWin', $totalWin);
                                        $slotSettings->SetGameData('CatsRoyalEGTFreeGames', $slotSettings->slotFreeCount);
                                    }
                                    $fs = $slotSettings->GetGameData('CatsRoyalEGTFreeGames');
                                }
                                $winString = implode(',', $lineWins);
                                $jsSpin = '' . json_encode($reels) . '';
                                $jsJack = '' . json_encode($slotSettings->Jackpots) . '';
                                $response = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{"FreeMultiplier":' . $slotSettings->GetGameData('CatsRoyalEGTFreeMultiplier') . ',"slotLines":' . $lines . ',"slotBet":' . $betline . ',"totalFreeGames":' . $slotSettings->GetGameData('CatsRoyalEGTFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('CatsRoyalEGTCurrentFreeGame') . ',"Balance":' . $balanceInCents . ',"afterBalance":' . $balanceInCents . ',"bonusWin":' . $slotSettings->GetGameData('CatsRoyalEGTBonusWin') . ',"totalWin":' . $totalWin . ',"winLines":[' . $winString . '],"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
                                $slotSettings->SaveLogReport($response, $allbet, $lines, $reportWin, $postData['slotEvent']);
                                $winstring = '';
                                $slotSettings->SetGameData('CatsRoyalEGTGambleStep', 5);
                                $hist = $slotSettings->GetGameData('CatsRoyalEGTCards');
                                $curReels = '' . rand(0, 6) . ',' . $reels['reel1'][0] . ',' . $reels['reel1'][1] . ',' . $reels['reel1'][2] . ',' . rand(0, 6);
                                $curReels .= (',' . rand(0, 6) . ',' . $reels['reel2'][0] . ',' . $reels['reel2'][1] . ',' . $reels['reel2'][2] . ',' . rand(0, 6));
                                $curReels .= (',' . rand(0, 6) . ',' . $reels['reel3'][0] . ',' . $reels['reel3'][1] . ',' . $reels['reel3'][2] . ',' . rand(0, 6));
                                $curReels .= (',' . rand(0, 6) . ',' . $reels['reel4'][0] . ',' . $reels['reel4'][1] . ',' . $reels['reel4'][2] . ',' . rand(0, 6));
                                ...
                                if( $jackRandom == 1 ) 
                                {
                                    $state = 'jackpot';
                                    $isJack = 'true';
                                    $slotSettings->SetGameData('CatsRoyalEGTJackSteps', [
                                        0, 
                                        0, 
                                        0, 
                                        0
                                ...
                                if( $postData['slotEvent'] == 'freespin' ) 
                                {
                                    $slotSettings->SetGameData('CatsRoyalEGTFreeMultiplier', $slotSettings->GetGameData('CatsRoyalEGTFreeMultiplier') + 1);
                                    $totalWin = $slotSettings->GetGameData('CatsRoyalEGTBonusWin');
                                    $state = 'freespin';
                                ...
                                $result_tmp[] = '{"complex":{"gambles":5,"reels":[' . $curReels . '],"lines":[' . $winString . '],"scatters":[' . $scattersStr . '],"freespinScatters":[' . $scatter . '],"expand":[],"multiplierCoords": [' . implode(',', $multiplierCoords) . '],"multiplier":' . $bonusMpl . ',"specialExpand":[],"gambles":5,"freespins":' . $fs . ',"jackpot":' . $isJack . ',"gameCommand":"bet"},"state":"' . $state . '","winAmount":' . ($totalWin * 100) . ',"gameIdentificationNumber":' . $postData['gameIdentificationNumber'] . ',"gameNumber":"","balance":' . $balanceInCents . ',"sessionKey":"41be9e65e0ff03a65e8c93576bf61130","msg":"success","messageId":"' . $postData['messageId'] . '","qName":"app.services.messages.response.GameEventResponse","command":"bet","eventTimestamp":' . time() . '}';
                                ...
                                break;
                            case 'collect':
                                $result_tmp[] = '{"complex":{"gameCommand":"collect"},"state":"idle","winAmount":' . ($slotSettings->GetGameData('CatsRoyalEGTTotalWin') * 100) . ',"gameIdentificationNumber":' . $postData['gameIdentificationNumber'] . ',"gameNumber":"","balance":' . $balanceInCents . ',"sessionKey":"41be9e65e0ff03a65e8c93576bf61130","msg":"success","messageId":"' . $postData['messageId'] . '","qName":"app.services.messages.response.GameEventResponse","command":"bet","eventTimestamp":' . time() . '}';
                                $slotSettings->SetGameData('CatsRoyalEGTTotalWin', 0);
                                break;
                            case 'jackpot':
                                $jackStep = $slotSettings->GetGameData('CatsRoyalEGTJackSteps');
                                $jackWinID = $slotSettings->GetGameData($slotSettings->slotId . 'JackWinID');
                                if( $jackStep[0] >= 3 || $jackStep[1] >= 3 || $jackStep[2] >= 3 || $jackStep[3] >= 3 || !$slotSettings->HasGameData('CatsRoyalEGTJackSteps') ) 
                                {
                                    exit();
                                }
                                $winAmount = 0;
                                ...
                                $slotSettings->SetGameData('CatsRoyalEGTJackSteps', $jackStep);
                                break;
                            case 'gamble':
                                $Balance = $slotSettings->GetBalance();
                                $isGambleWin = rand(1, $slotSettings->GetGambleSettings());
                                $dealerCard = '';
                                $totalWin = $slotSettings->GetGameData('CatsRoyalEGTTotalWin');
                                $gambleWin = 0;
                                $statBet = $totalWin;
                                $slotSettings->SetGameData('CatsRoyalEGTGambleStep', $slotSettings->GetGameData('CatsRoyalEGTGambleStep') - 1);
                                ...
                                else
                                {
                                    ...
                                    $totalWin = 0;
                                    $slotSettings->SetGameData('CatsRoyalEGTGambleStep', 0);
                                    if( $postData['bet']['color'] == '1' ) 
                                    {
                                        $tmpCards = [
                                            '1', 
                                ...
                                $gtype = 1;
                                $gtype0 = 1;
                                if( $slotSettings->GetGameData('CatsRoyalEGTBonusStart') == 1 ) 
                                {
                                    $gtype0 = 2;
                                }
                                $result_tmp[] = '{"complex":{"gambles":' . $slotSettings->GetGameData('CatsRoyalEGTGambleStep') . ',"card":' . $dealerCard . ',"jackpot":false,"gameCommand":"gamble"},"state":"' . $gambleState . '","winAmount":' . ($totalWin * 100) . ',"gameIdentificationNumber":' . $postData['gameIdentificationNumber'] . ',"gameNumber":"","sessionKey":"88e2b82e6537db4a339e4e1b5ce462cd","msg":"success","messageId":"' . $postData['messageId'] . '","qName":"app.services.messages.response.GameEventResponse","command":"bet","eventTimestamp":' . time() . '}';
                                break;
                        }
