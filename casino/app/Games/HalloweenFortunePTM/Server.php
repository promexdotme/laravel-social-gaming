                    ...
                    try
                    {
                        ...
                        if( isset($postData['spinType']) ) 
                        {
                            ...
                            if( $postData['spinType'] == 'regular' ) 
                            {
                                ...
                                $bonusMpl = 1;
                                $slotSettings->SetGameData('HalloweenFortunePTMBonusWin', 0);
                                $slotSettings->SetGameData('HalloweenFortunePTMFreeGames', 0);
                                $slotSettings->SetGameData('HalloweenFortunePTMCurrentFreeGame', 0);
                                $slotSettings->SetGameData('HalloweenFortunePTMTotalWin', 0);
                                $slotSettings->SetGameData('HalloweenFortunePTMFreeBalance', 0);
                                $slotSettings->SetGameData('HalloweenFortunePTMFreeStartWin', 0);
                                $slotSettings->SetGameData('HalloweenFortunePTMFreeMpl', 0);
                            }
                            else if( $postData['spinType'] == 'free' ) 
                            {
                                $umid = '0';
                                $postData['slotEvent'] = 'freespin';
                                $slotSettings->SetGameData('HalloweenFortunePTMCurrentFreeGame', $slotSettings->GetGameData('HalloweenFortunePTMCurrentFreeGame') + 1);
                                $bonusMpl = $slotSettings->GetGameData('HalloweenFortunePTMFreeMpl');
                            }
                            $linesId[0] = [
                                2, 
                                2, 
                            ...
                            for( $i = 0; $i <= 2000; $i++ ) 
                            {
                                    ...
                                    for( $j = 0; $j < count($slotSettings->SymbolGame); $j++ ) 
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            if( $s[0] == $csym || in_array($s[0], $wild) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":1,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('HalloweenFortunePTMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":["none","none"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":2,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('HalloweenFortunePTMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":["none","none"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":3,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('HalloweenFortunePTMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":["none","none"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) && ($s[3] == $csym || in_array($s[3], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":4,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('HalloweenFortunePTMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":["none","none"]}';
                                                }
                                            }
                                            if( ($s[0] == $csym || in_array($s[0], $wild)) && ($s[1] == $csym || in_array($s[1], $wild)) && ($s[2] == $csym || in_array($s[2], $wild)) && ($s[3] == $csym || in_array($s[3], $wild)) && ($s[4] == $csym || in_array($s[4], $wild)) ) 
                                            {
                                                ...
                                                {
                                                    $cWins[$k] = $tmpWin;
                                                    $tmpStringWin = '{"Count":5,"Line":' . $k . ',"Win":' . $cWins[$k] . ',"stepWin":' . ($cWins[$k] + $totalWin + $slotSettings->GetGameData('HalloweenFortunePTMBonusWin')) . ',"winReel1":[' . ($linesId[$k][0] - 1) . ',"' . $s[0] . '"],"winReel2":[' . ($linesId[$k][1] - 1) . ',"' . $s[1] . '"],"winReel3":[' . ($linesId[$k][2] - 1) . ',"' . $s[2] . '"],"winReel4":[' . ($linesId[$k][3] - 1) . ',"' . $s[3] . '"],"winReel5":[' . ($linesId[$k][4] - 1) . ',"' . $s[4] . '"]}';
                                                }
                                            }
                                        }
                                    }
                                ...
                                for( $r = 1; $r <= 5; $r++ ) 
                                {
                                    for( $p = 0; $p <= 3; $p++ ) 
                                    {
                                        ...
                                        {
                                            $scattersCount2++;
                                            $scattersStr .= ('"winReel' . $r . '":[' . $p . ',"' . $scatter2 . '"],');
                                        }
                                    }
                                }
                            ...
                            if( $postData['slotEvent'] == 'freespin' ) 
                            {
                                $slotSettings->SetGameData('HalloweenFortunePTMBonusWin', $slotSettings->GetGameData('HalloweenFortunePTMBonusWin') + $totalWin);
                                $slotSettings->SetGameData('HalloweenFortunePTMTotalWin', $totalWin);
                            }
                            else
                            {
                                $slotSettings->SetGameData('HalloweenFortunePTMTotalWin', $totalWin);
                            ...
                            if( $scattersCount >= 2 ) 
                            {
                                if( $slotSettings->GetGameData('HalloweenFortunePTMFreeGames') > 0 ) 
                                {
                                    $winValuesAll = [
                                        1, 
                                        2, 
                                    ...
                                    $result_tmp[] = '3:::{"data":{"winValues":[' . implode(',', $winValues) . ',' . implode(',', $mplValues) . '],"pickWitches":[' . implode(',', $winValues) . '],"pickPotions":[' . implode(',', $mplValues) . '],"windowId":"Ud95Li"},"ID":40204,"umid":1664}';
                                    $slotSettings->SetGameData('HalloweenFortunePTMFreeGames', $slotSettings->GetGameData('HalloweenFortunePTMFreeGames') + $winValues[0]);
                                }
                                else
                                {
                                    $slotSettings->SetGameData('HalloweenFortunePTMFreeStartWin', $totalWin);
                                    $slotSettings->SetGameData('HalloweenFortunePTMBonusWin', 0);
                                    $slotSettings->SetGameData('HalloweenFortunePTMFreeGames', $slotSettings->slotFreeCount);
                                    $winValuesAll = [
                                        1, 
                                        2, 
                                        3, 
                                    ...
                                    $result_tmp[] = '3:::{"data":{"winValues":[' . implode(',', $winValues) . ',' . implode(',', $mplValues) . '],"pickWitches":[' . implode(',', $winValues) . '],"pickPotions":[' . implode(',', $mplValues) . '],"windowId":"Ud95Li"},"ID":40204,"umid":1664}';
                                    $slotSettings->SetGameData('HalloweenFortunePTMFreeGames', $winValues[0]);
                                    $slotSettings->SetGameData('HalloweenFortunePTMFreeMpl', $mplValues[0]);
                                }
                            }
                            $balanceInCents = sprintf('%01.2f', $slotSettings->GetBalance()) * 100;
                            ...
                            $response = '{"responseEvent":"spin","responseType":"' . $postData['slotEvent'] . '","serverResponse":{"FreeMpl":' . $slotSettings->GetGameData('HalloweenFortunePTMFreeMpl') . ',"linesArr":[' . implode(',', $postData['lines']) . '],"slotLines":' . $lines . ',"slotBet":' . $betLine . ',"totalFreeGames":' . $slotSettings->GetGameData('HalloweenFortunePTMFreeGames') . ',"currentFreeGames":' . $slotSettings->GetGameData('HalloweenFortunePTMCurrentFreeGame') . ',"Balance":' . $slotSettings->GetBalance() . ',"afterBalance":' . $slotSettings->GetBalance() . ',"bonusWin":' . $slotSettings->GetGameData('HalloweenFortunePTMBonusWin') . ',"freeStartWin":' . $slotSettings->GetGameData('HalloweenFortunePTMFreeStartWin') . ',"totalWin":' . $totalWin . ',"winLines":[' . $winString . '],"bonusInfo":' . $scattersStr . ',"Jackpots":' . $jsJack . ',"reelsSymbols":' . $jsSpin . '}}';
                        ...
                        switch( $umid ) 
                        {
                            ...
                            case '40066':
                                ...
                                $result_tmp[] = '3:::{"data":{"funNoticeGames":0,"funNoticePayouts":0,"gameGroup":"hlf","minBet":0,"maxBet":0,"minPosBet":0,"maxPosBet":50000,"coinSizes":[' . implode(',', $gameBets) . ']},"ID":40025,"umid":21}';
                                break;
                            case '40036':
                                ...
                                if( $lastEvent != 'NULL' ) 
                                {
                                    ...
                                    {
                                        $slotSettings->SetGameData($slotSettings->slotId . 'brokenGames', 'hlf');
                                    }
                                }
                            ...
                            case '40020':
                                ...
                                break;
                            case '40203':
                                $result_tmp[] = '3:::{"data":{"windowId":"VhhrGs"},"ID":40204,"umid":32}';
                                break;
                            case '40030':
                                $result_tmp[] = '3:::{"data":{"typeBalance":2,"balanceInCents":0},"ID":40085}';
                                $result_tmp[] = '3:::{"data":{"typeBalance":1,"balanceInCents":0},"ID":40085}';
